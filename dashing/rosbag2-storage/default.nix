...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/dashing/rosbag2_storage/0.1.6-1.tar.gz";
    name = "0.1.6-1.tar.gz";
    sha256 = "94af3f7327af82639158a6a36b61041813e02e53d502e9275e10bedf5f92788d";
  };
