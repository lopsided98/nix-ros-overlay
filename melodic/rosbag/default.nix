...
buildRosPackage {
  ...
  propagatedBuildInputs = [ rosbag-storage std-srvs rosconsole boost pythonPackages.rospkg roscpp pythonPackages.pycrypto roslib pythonPackages.python-gnupg xmlrpcpp rospy topic-tools genmsg genpy ];
