...
{ lib, buildRosPackage, fetchurl, moveit-ros-planning, moveit-resources, pluginlib, orocos-kdl, catkin, tf2-kdl, pythonPackages, rostest, tf2, moveit-core, xmlrpcpp, eigen, roscpp }:
buildRosPackage {
  ...
  nativeBuildInputs = [ moveit-ros-planning orocos-kdl pluginlib catkin tf2-kdl tf2 moveit-core eigen roscpp ];
