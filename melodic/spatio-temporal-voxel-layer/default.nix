...
buildRosPackage {
  ...
  propagatedBuildInputs = [ costmap-2d openexr pluginlib tf2-geometry-msgs sensor-msgs message-filters roscpp tf2-ros tbb laser-geometry pcl-ros std-msgs dynamic-reconfigure visualization-msgs pcl-conversions geometry-msgs openvdb ];
