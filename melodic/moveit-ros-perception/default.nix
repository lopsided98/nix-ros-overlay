...
buildRosPackage {
  ...
  nativeBuildInputs = [ rosconsole tf2-geometry-msgs cv-bridge catkin tf2-ros freeglut octomap urdf libGLU moveit-msgs roscpp eigen pluginlib image-transport sensor-msgs message-filters tf2 moveit-core tf2-eigen object-recognition-msgs glew libGL ];
