...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/mavlink/mavros-release/archive/release/melodic/test_mavros/0.33.0-1.tar.gz";
    name = "0.33.0-1.tar.gz";
    sha256 = "4273f813bb7415feae16331ce3bebe5e6df127f42c7c22aeb1fd1d1866b5f0e7";
  };
