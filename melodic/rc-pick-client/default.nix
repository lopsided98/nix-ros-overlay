...
buildRosPackage {
  ...
  propagatedBuildInputs = [ shape-msgs std-srvs rc-common-msgs tf2-geometry-msgs rcdiscover roscpp curl visualization-msgs dynamic-reconfigure message-runtime tf geometry-msgs ];
