...
{ lib, buildRosPackage, fetchurl, costmap-2d, roslint, nav-grid, pluginlib, tf, nav-core2, catkin, nav-core, nav-2d-msgs, dwb-plugins, dwb-critics, rostest, nav-2d-utils, nav-msgs, visualization-msgs, dwb-local-planner, geometry-msgs }:
buildRosPackage {
  ...
  nativeBuildInputs = [ costmap-2d pluginlib nav-grid nav-core2 nav-core catkin nav-2d-utils nav-msgs visualization-msgs tf nav-2d-msgs geometry-msgs ];
