...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/at-wat/neonavigation-release/archive/release/melodic/costmap_cspace/0.4.2-1.tar.gz";
    name = "0.4.2-1.tar.gz";
    sha256 = "905d415a806a67609877241b9ea5554e7edf272b19c4cff98e57e5c772e12452";
  };
