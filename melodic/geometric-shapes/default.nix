...
buildRosPackage {
  ...
  nativeBuildInputs = [ shape-msgs boost eigen-stl-containers qhull catkin random-numbers pkg-config assimp console-bridge octomap resource-retriever eigen visualization-msgs ];
