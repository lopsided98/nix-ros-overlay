...
buildRosPackage {
  ...
  propagatedBuildInputs = [ python moveit-ros-planning moveit-ros-move-group rosconsole tf2-geometry-msgs moveit-ros-manipulation eigenpy tf2-ros tf2 moveit-ros-warehouse tf2-eigen actionlib rospy moveit-msgs roscpp geometry-msgs ];
