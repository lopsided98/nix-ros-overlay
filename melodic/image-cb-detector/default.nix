...
{ lib, buildRosPackage, fetchurl, actionlib-msgs, image-transport, sensor-msgs, catkin, cv-bridge, message-filters, message-generation, message-runtime, actionlib, std-msgs, roscpp, geometry-msgs, calibration-msgs }:
buildRosPackage {
  ...
  nativeBuildInputs = [ actionlib-msgs image-transport sensor-msgs cv-bridge message-filters catkin message-generation actionlib std-msgs roscpp geometry-msgs calibration-msgs ];
