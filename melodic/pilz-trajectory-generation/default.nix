...
buildRosPackage {
  ...
  buildInputs = [ moveit-ros-planning kdl-conversions moveit-ros-move-group pluginlib tf2-geometry-msgs orocos-kdl pilz-extensions pilz-testutils roscpp tf2 moveit-core tf2-eigen moveit-msgs eigen-conversions pilz-msgs moveit-ros-planning-interface ];
