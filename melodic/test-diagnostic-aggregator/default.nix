...
{ lib, buildRosPackage, fetchurl, diagnostic-aggregator, diagnostic-msgs, pluginlib, catkin, roscpp, rospy, rostest }:
buildRosPackage {
  ...
  buildType = "catkin";
  buildInputs = [ diagnostic-aggregator diagnostic-msgs pluginlib roscpp rospy rostest ];
