...
{ lib, buildRosPackage, fetchurl, catkin, dynamic-reconfigure, gazebo-dev, gazebo-ros, gazeboSimulator, geometry-msgs, message-generation, message-runtime, nav-msgs, roscpp, std-msgs, std-srvs, tf }:
buildRosPackage {
