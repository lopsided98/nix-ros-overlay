...
buildRosPackage {
  ...
  src = fetchurl {
    url = https://github.com/ros-gbp/ros_controllers-release/archive/release/melodic/joint_trajectory_controller/0.14.3-0.tar.gz;
    sha256 = "bf731b8b86b30eca8a8e567a113a812dcf4eb25a352be14b1edb776782a5b522";
  };
