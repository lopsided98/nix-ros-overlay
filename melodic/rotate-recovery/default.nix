...
{ lib, buildRosPackage, fetchurl, costmap-2d, pluginlib, base-local-planner, tf2-geometry-msgs, cmake-modules, nav-core, catkin, tf2-ros, tf2, angles, roscpp, geometry-msgs, eigen }:
buildRosPackage {
  ...
  nativeBuildInputs = [ costmap-2d cmake-modules base-local-planner pluginlib tf2-geometry-msgs nav-core catkin tf2-ros tf2 angles roscpp geometry-msgs eigen ];
