...
self: super: {
 ...
 apriltag2-node = self.callPackage ./apriltag2-node {};
 ...
 ets-cpp-client = self.callPackage ./ets-cpp-client {};

 ets-msgs = self.callPackage ./ets-msgs {};

 ets-plugin = self.callPackage ./ets-plugin {};
 ...
 keystroke = self.callPackage ./keystroke {};
 ...
 nav2-mission-executor = self.callPackage ./nav2-mission-executor {};

 nav2-motion-primitives = self.callPackage ./nav2-motion-primitives {};

 nav2-msgs = self.callPackage ./nav2-msgs {};

 nav2-navfn-planner = self.callPackage ./nav2-navfn-planner {};

 nav2-robot = self.callPackage ./nav2-robot {};

 nav2-simple-navigator = self.callPackage ./nav2-simple-navigator {};

 nav2-tasks = self.callPackage ./nav2-tasks {};
 ...
 rosidl-actions = self.callPackage ./rosidl-actions {};
