...
{ lib, buildRosPackage, fetchurl, ament-cmake, ament-lint-common, fastrtps, rmw-fastrtps-shared-cpp, rosidl-typesupport-introspection-c, rosidl-typesupport-introspection-cpp, ament-cmake-ros, fastcdr, ament-lint-auto, rcutils, fastrtps-cmake-module, rmw, rosidl-generator-c }:
buildRosPackage {
  ...
  propagatedBuildInputs = [ ament-cmake fastrtps rmw-fastrtps-shared-cpp rosidl-typesupport-introspection-c rosidl-typesupport-introspection-cpp fastcdr rcutils fastrtps-cmake-module rmw rosidl-generator-c ];
