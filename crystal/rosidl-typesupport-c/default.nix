...
{ lib, buildRosPackage, fetchurl, poco, rosidl-typesupport-interface, ament-lint-common, ament-lint-auto, poco-vendor, rosidl-typesupport-introspection-c, rmw-implementation, rosidl-typesupport-connext-c, ament-cmake-ros, rosidl-typesupport-opensplice-c, rosidl-generator-c }:
buildRosPackage {
  ...
  propagatedBuildInputs = [ poco rosidl-typesupport-interface poco-vendor rmw-implementation rosidl-generator-c ];
