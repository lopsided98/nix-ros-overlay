...
{ lib, buildRosPackage, fetchurl, std-srvs, cmake-modules, geometry-msgs, tf, catkin, tinyxml, gazebo-dev, rosgraph-msgs, roslib, dynamic-reconfigure, std-msgs, roscpp, gazebo-msgs }:
buildRosPackage {
