...
buildRosPackage {
  ...
  propagatedBuildInputs = [ kdl-conversions kdl-parser orocos-kdl actionlib-msgs control-msgs trajectory-msgs sensor-msgs roscpp rospy move-base-msgs tf2-ros message-runtime actionlib tf-conversions angles tf geometry-msgs ];
