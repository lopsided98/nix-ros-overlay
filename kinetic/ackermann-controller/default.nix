...
buildRosPackage {
  ...
  propagatedBuildInputs = [ hardware-interface control-msgs tf control-toolbox realtime-tools roscpp nav-msgs urdf controller-interface angles forward-command-controller ];
