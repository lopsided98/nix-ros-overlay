...
{ lib, buildRosPackage, fetchurl, roslisp, tf, catkin, cl-transforms-stamped, cl-transforms }:
buildRosPackage {
  ...
  buildType = "catkin";
  propagatedBuildInputs = [ tf cl-transforms cl-transforms-stamped roslisp ];
