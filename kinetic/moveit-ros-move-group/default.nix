...
{ lib, buildRosPackage, fetchurl, moveit-resources, std-srvs, moveit-ros-planning, pluginlib, moveit-kinematics, catkin, rostest, moveit-core, actionlib, tf }:
buildRosPackage {
  ...
  nativeBuildInputs = [ moveit-ros-planning std-srvs moveit-core pluginlib actionlib catkin tf ];
