...
buildRosPackage {
  ...
  src = fetchurl {
    url = https://github.com/ipa320/cob_control-release/archive/release/kinetic/cob_twist_controller/0.7.6-1.tar.gz;
    sha256 = "78484d8e5567802fc0c88808a16a640968642dbc7c1df857a5672a869abe4cf3";
  };
