...
{ lib, buildRosPackage, fetchurl, tf, sensor-msgs, catkin, roscpp, move-base-msgs, visualization-msgs, actionlib, std-msgs, roslib, geometry-msgs }:
buildRosPackage {
  ...
  nativeBuildInputs = [ tf sensor-msgs catkin roscpp move-base-msgs roslib actionlib std-msgs visualization-msgs geometry-msgs ];
