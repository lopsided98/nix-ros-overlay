...
{ lib, buildRosPackage, fetchurl, microstrain-3dmgx2-imu, nmea-navsat-driver, husky-control, um6, husky-base, catkin, pythonPackages, tf2-ros, husky-description, lms1xx, robot-localization, nmea-comms, robot-upstart, roslaunch, tf, imu-filter-madgwick, imu-transformer, um7 }:
buildRosPackage {
