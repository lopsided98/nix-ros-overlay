...
{ lib, buildRosPackage, fetchurl, catkin, urdfdom, rostest, urdf, kobuki-description, turtlebot-description, xacro }:
buildRosPackage {
  ...
  checkInputs = [ turtlebot-description rostest kobuki-description urdfdom ];
