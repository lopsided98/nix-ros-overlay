...
{ lib, buildRosPackage, fetchurl, pluginlib, tf2-geometry-msgs, sensor-msgs, catkin, message-filters, tf2-ros, tf2, nodelet, dynamic-reconfigure, roscpp, rosunit, geometry-msgs }:
buildRosPackage {
  ...
  nativeBuildInputs = [ pluginlib tf2-geometry-msgs sensor-msgs catkin message-filters roscpp tf2-ros tf2 dynamic-reconfigure nodelet geometry-msgs ];
