...
{ lib, buildRosPackage, fetchurl, catkin, rtt-roscomm, rtt-std-msgs, rosgraph-msgs }:
buildRosPackage {
  ...
  buildType = "catkin";
  buildInputs = [ rtt-roscomm rtt-std-msgs rosgraph-msgs ];
  propagatedBuildInputs = [ rtt-roscomm rtt-std-msgs rosgraph-msgs ];
