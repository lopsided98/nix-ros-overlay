...
{ lib, buildRosPackage, fetchurl, dbw-mkz-joystick-demo, dbw-mkz-description, dbw-mkz-can, catkin, dbw-mkz-msgs }:
buildRosPackage {
  ...
  buildType = "catkin";
  propagatedBuildInputs = [ dbw-mkz-msgs dbw-mkz-joystick-demo dbw-mkz-description dbw-mkz-can ];
