...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/mavlink/mavlink-gbp-release/archive/release/kinetic/mavlink/2019.10.10-1.tar.gz";
    name = "2019.10.10-1.tar.gz";
    sha256 = "9408367d33a7c676b8142376fdf06bab3efce3bc341a8dc48be793e19574bca0";
  };
