...
{ lib, buildRosPackage, fetchurl, pr2-hardware-interface, pluginlib, pr2-controller-interface, realtime-tools, control-toolbox, catkin, sensor-msgs, robot-mechanism-controllers, urdf, std-msgs, roscpp, pr2-mechanism-model }:
buildRosPackage {
  ...
  nativeBuildInputs = [ pr2-hardware-interface pluginlib pr2-controller-interface realtime-tools control-toolbox sensor-msgs catkin robot-mechanism-controllers urdf std-msgs roscpp pr2-mechanism-model ];
