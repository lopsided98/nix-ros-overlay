...
{ lib, buildRosPackage, fetchurl, cmake-modules, pluginlib, boost, catkin, object-recognition-msgs, rostest, geometric-shapes, rostopic, visualization-msgs, actionlib, object-recognition-core, ecto, ecto-ros, ecto-image-pipeline }:
buildRosPackage {
  ...
  nativeBuildInputs = [ cmake-modules pluginlib boost object-recognition-core catkin geometric-shapes actionlib object-recognition-msgs ecto ecto-ros ecto-image-pipeline ];
