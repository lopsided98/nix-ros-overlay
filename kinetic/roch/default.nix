...
{ lib, buildRosPackage, fetchurl, roch-navigation, roch-teleop, roch-follower, catkin, roch-rapps }:
buildRosPackage {
  ...
  buildType = "catkin";
  propagatedBuildInputs = [ roch-rapps roch-navigation roch-follower roch-teleop ];
