...
{ lib, buildRosPackage, fetchurl, std-srvs, kobuki-msgs, catkin, yocs-velocity-smoother, ecl-threads, ecl-exceptions, ecl-time, std-msgs, yocs-cmd-vel-mux, roscpp, geometry-msgs }:
buildRosPackage {
  ...
  nativeBuildInputs = [ std-srvs kobuki-msgs catkin ecl-time ecl-exceptions ecl-threads std-msgs roscpp geometry-msgs ];
