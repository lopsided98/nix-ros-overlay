...
{ lib, buildRosPackage, fetchurl, swri-math-util, pluginlib, tf, mapviz, cv-bridge, catkin, libqt-core, gps-common, qt-qmake, swri-yaml-util, rospy, libqt-dev, libqt-opengl-dev, libqt-opengl, roscpp, swri-transform-util }:
buildRosPackage {
  ...
  nativeBuildInputs = [ swri-math-util pluginlib mapviz cv-bridge catkin roscpp gps-common qt-qmake swri-yaml-util libqt-dev libqt-opengl-dev tf swri-transform-util ];
