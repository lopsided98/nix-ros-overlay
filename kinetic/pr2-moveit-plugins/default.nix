...
buildRosPackage {
  ...
  propagatedBuildInputs = [ pr2-controllers-msgs pr2-mechanism-msgs kdl-parser pluginlib control-msgs urdf moveit-core actionlib tf-conversions angles eigen-conversions roscpp ];
