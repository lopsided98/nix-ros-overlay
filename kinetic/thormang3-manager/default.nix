...
buildRosPackage {
  ...
  propagatedBuildInputs = [ thormang3-gripper-module thormang3-description thormang3-base-module thormang3-head-control-module robotis-controller thormang3-feet-ft-module thormang3-walking-module thormang3-manipulation-module roscpp thormang3-imu-3dm-gx4 thormang3-action-module ];
