...
{ lib, buildRosPackage, fetchurl, controller-manager, soem, hardware-interface, trajectory-msgs, joint-limits-interface, catkin, realtime-tools, tinyxml, sensor-msgs, ethercat-manager, diagnostic-updater, rostest, roslaunch, transmission-interface }:
buildRosPackage {
  ...
  nativeBuildInputs = [ controller-manager soem hardware-interface realtime-tools trajectory-msgs sensor-msgs joint-limits-interface tinyxml ethercat-manager catkin diagnostic-updater transmission-interface ];
