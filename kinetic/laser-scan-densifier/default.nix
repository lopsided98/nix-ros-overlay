...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_driver-release/archive/release/kinetic/laser_scan_densifier/0.7.1-1.tar.gz";
    name = "0.7.1-1.tar.gz";
    sha256 = "ca20189038745888c59d0adf5c0b4b1c9f59e0155924788a7943c9c831eec939";
  };
