...
{ lib, buildRosPackage, fetchurl, pr2-controllers-msgs, pr2-mechanism-controllers, actionlib-msgs, pr2-gripper-sensor-controller, catkin, robot-mechanism-controllers, pr2-gripper-sensor-msgs, message-generation, message-runtime, actionlib, pr2-machine, roscpp, pr2-mechanism-model }:
buildRosPackage {
  ...
  nativeBuildInputs = [ pr2-controllers-msgs pr2-mechanism-controllers actionlib-msgs pr2-gripper-sensor-controller catkin robot-mechanism-controllers pr2-gripper-sensor-msgs message-generation actionlib pr2-machine roscpp pr2-mechanism-model ];
