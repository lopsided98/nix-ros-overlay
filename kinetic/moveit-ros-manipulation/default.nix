...
buildRosPackage {
  ...
  nativeBuildInputs = [ moveit-ros-planning moveit-ros-move-group pluginlib rosconsole catkin roscpp actionlib moveit-core dynamic-reconfigure moveit-msgs tf eigen ];
