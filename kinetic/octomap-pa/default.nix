...
buildRosPackage {
  ...
  propagatedBuildInputs = [ std-srvs pcl sensor-msgs parameter-pa roscpp octomap-msgs laser-geometry nav-msgs octomap-ros message-runtime pcl-ros std-msgs tf pcl-conversions geometry-msgs ];
