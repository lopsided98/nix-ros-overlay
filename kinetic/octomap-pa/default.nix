...
{ lib, buildRosPackage, fetchurl, std-srvs, pcl, parameter-pa, catkin, sensor-msgs, roscpp, octomap-msgs, laser-geometry, nav-msgs, message-generation, octomap-ros, message-runtime, pcl-ros, std-msgs, tf, pcl-conversions, geometry-msgs }:
buildRosPackage {
  ...
  buildInputs = [ std-srvs tf pcl parameter-pa sensor-msgs roscpp octomap-msgs message-generation nav-msgs octomap-ros pcl-ros std-msgs laser-geometry pcl-conversions geometry-msgs ];
