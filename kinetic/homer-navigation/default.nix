...
buildRosPackage {
  ...
  nativeBuildInputs = [ cmake-modules homer-ptu-msgs trajectory-msgs sensor-msgs catkin roscpp homer-mapnav-msgs roslib nav-msgs homer-robbie-architecture actionlib std-msgs homer-tts tf homer-nav-libs eigen ];
