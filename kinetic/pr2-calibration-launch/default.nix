...
buildRosPackage {
  ...
  nativeBuildInputs = [ catkin robot-mechanism-controllers laser-joint-processor rospy image-view geometry-msgs stereo-image-proc pr2-dense-laser-snapshotter kdl-parser laser-cb-detector laser-joint-projector sensor-msgs monocam-settler python-orocos-kdl image-cb-detector calibration-launch pr2-teleop rostest message-generation calibration-estimation calibration-msgs ];
