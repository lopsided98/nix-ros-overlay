...
{ lib, buildRosPackage, fetchurl, message-runtime, std-msgs, catkin, rospy, actionlib-msgs, message-generation }:
buildRosPackage {
  ...
  buildType = "catkin";
  buildInputs = [ std-msgs rospy message-generation actionlib-msgs ];
