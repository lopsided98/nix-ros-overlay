...
{ lib, buildRosPackage, fetchurl, kobuki-description, xacro, urdf, catkin, create-description }:
buildRosPackage {
  ...
  propagatedBuildInputs = [ kobuki-description create-description xacro urdf ];
