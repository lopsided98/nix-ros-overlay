...
{ lib, buildRosPackage, fetchurl, pr2-gripper-sensor-action, pr2-gripper-sensor-msgs, pr2-gripper-sensor-controller, catkin }:
buildRosPackage {
  ...
  propagatedBuildInputs = [ pr2-gripper-sensor-action pr2-gripper-sensor-msgs pr2-gripper-sensor-controller ];
