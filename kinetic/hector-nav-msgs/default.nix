...
{ lib, buildRosPackage, fetchurl, catkin, message-generation, nav-msgs, message-runtime, geometry-msgs }:
buildRosPackage {
  ...
  nativeBuildInputs = [ catkin nav-msgs message-generation geometry-msgs ];
