...
buildRosPackage {
  ...
  nativeBuildInputs = [ pythonPackages.numpy pythonPackages.pyserial pythonPackages.scipy catkin pythonPackages.pyyaml message-generation rospy std-msgs roscpp ];
