...
buildRosPackage {
  ...
  propagatedBuildInputs = [ roseus jsk-pcl-ros jsk-footstep-msgs jsk-topic-tools jsk-rviz-plugins jsk-interactive-marker jsk-recognition-utils dynamic-reconfigure jsk-recognition-msgs visualization-msgs roscpp pcl-ros geometry-msgs ];
