...
buildRosPackage {
  ...
  nativeBuildInputs = [ std-srvs armadillo control-msgs katana-msgs trajectory-msgs sensor-msgs catkin roscpp roslib kni urdf actionlib moveit-msgs tf geometry-msgs ];
