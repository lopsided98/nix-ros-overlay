...
{ lib, buildRosPackage, fetchurl, moveit-ros-planning, prbt-moveit-config, pilz-msgs, prbt-ikfast-manipulator-plugin, pilz-extensions, pilz-testutils, prbt-pg70-support, pilz-industrial-motion-testutils, moveit-core, message-runtime, eigen-conversions, moveit-ros-planning-interface, panda-moveit-config, orocos-kdl, prbt-support, tf2-geometry-msgs, catkin, moveit-commander, moveit-msgs, roscpp, moveit-ros-move-group, cmake-modules, pluginlib, rostest, tf2, abb-irb2400-moveit-config, tf2-eigen, code-coverage, rosunit }:
buildRosPackage {
  ...
  nativeBuildInputs = [ moveit-ros-planning moveit-ros-move-group pluginlib tf2-geometry-msgs orocos-kdl pilz-extensions pilz-testutils catkin roscpp tf2 moveit-core tf2-eigen moveit-msgs eigen-conversions pilz-msgs moveit-ros-planning-interface ];
