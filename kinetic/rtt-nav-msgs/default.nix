...
{ lib, buildRosPackage, fetchurl, nav-msgs, rtt-actionlib-msgs, catkin, rtt-geometry-msgs, rtt-roscomm, rtt-std-msgs }:
buildRosPackage {
  ...
  buildType = "catkin";
  buildInputs = [ nav-msgs rtt-actionlib-msgs rtt-geometry-msgs rtt-roscomm rtt-std-msgs ];
