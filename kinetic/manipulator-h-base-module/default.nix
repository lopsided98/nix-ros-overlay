...
buildRosPackage {
  ...
  nativeBuildInputs = [ cmake-modules boost geometry-msgs manipulator-h-kinematics-dynamics libyamlcpp catkin roscpp roslib robotis-math manipulator-h-base-module-msgs eigen std-msgs robotis-controller-msgs robotis-framework-common ];
