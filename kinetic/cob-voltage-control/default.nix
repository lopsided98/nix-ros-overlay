...
buildRosPackage {
  ...
  buildInputs = [ dynamic-reconfigure std-msgs cob-msgs roscpp cob-phidgets ];
  propagatedBuildInputs = [ pythonPackages.tkinter dynamic-reconfigure std-msgs cob-msgs roscpp cob-phidgets rospy ];
