...
{ lib, buildRosPackage, fetchurl, actionlib-msgs, trajectory-msgs, sensor-msgs, catkin, message-generation, nav-msgs, message-runtime, std-msgs, genmsg, geometry-msgs }:
buildRosPackage {
  ...
  buildInputs = [ message-generation nav-msgs actionlib-msgs std-msgs trajectory-msgs sensor-msgs genmsg geometry-msgs ];
