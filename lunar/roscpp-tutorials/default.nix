...
buildRosPackage {
  pname = "ros-lunar-roscpp-tutorials";
  version = "0.8.1";

  src = fetchurl {
    url = https://github.com/ros-gbp/ros_tutorials-release/archive/release/lunar/roscpp_tutorials/0.8.1-0.tar.gz;
    sha256 = "5bdadf81ecfc4be9dbbcfad7462569326471dd0e7a24ed94a9adbb112f5b1604";
  };
