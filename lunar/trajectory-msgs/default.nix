...
buildRosPackage {
  pname = "ros-lunar-trajectory-msgs";
  version = "1.12.7";

  src = fetchurl {
    url = https://github.com/ros-gbp/common_msgs-release/archive/release/lunar/trajectory_msgs/1.12.7-0.tar.gz;
    sha256 = "9f875a3a45f305b0bb44f0610aeb6410c34eb71f2020034a303acc0cccb98584";
  };
