...
buildRosPackage {
  pname = "ros-lunar-rtt-sensor-msgs";
  version = "2.9.2-r1";

  src = fetchurl {
    url = https://github.com/orocos-gbp/rtt_ros_integration-release/archive/release/lunar/rtt_sensor_msgs/2.9.2-1.tar.gz;
    sha256 = "ab5f68d00ea927467a91e21b49c8cb8d0e62f424804ad5d063b40130776e7806";
  };
