...
buildRosPackage {
  ...
  buildInputs = [ rosconsole nav-msgs pcl-ros std-msgs rospy dynamic-reconfigure roscpp tf pcl-conversions visualization-msgs eigen geometry-msgs costmap-2d cmake-modules pluginlib pcl nav-core voxel-grid message-generation angles ];
  checkInputs = [ rosunit ];
