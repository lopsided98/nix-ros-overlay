...
buildRosPackage {
  pname = "ros-lunar-geometry";
  version = "1.11.9";

  src = fetchurl {
    url = https://github.com/ros-gbp/geometry-release/archive/release/lunar/geometry/1.11.9-0.tar.gz;
    sha256 = "5cf136d087facac2aadb2762084d398740d762638e55834c0153cbafad52c17c";
  };
