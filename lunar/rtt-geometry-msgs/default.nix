...
buildRosPackage {
  pname = "ros-lunar-rtt-geometry-msgs";
  version = "2.9.2-r1";

  src = fetchurl {
    url = https://github.com/orocos-gbp/rtt_ros_integration-release/archive/release/lunar/rtt_geometry_msgs/2.9.2-1.tar.gz;
    sha256 = "a0b867fa8dd2f7843f6a8023c3f222e1e073efeb7583383c5d13b777770a24c3";
  };
