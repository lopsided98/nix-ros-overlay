...
{ lib, buildRosPackage, fetchurl, costmap-2d, pluginlib, cmake-modules, base-local-planner, pcl, nav-core, catkin, roscpp, nav-msgs, eigen, dynamic-reconfigure, tf, pcl-conversions }:
buildRosPackage {
  ...
  buildInputs = [ costmap-2d cmake-modules pluginlib base-local-planner pcl nav-core roscpp nav-msgs dynamic-reconfigure tf pcl-conversions eigen ];
