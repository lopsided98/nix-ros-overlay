...
{ lib, buildRosPackage, fetchurl, rotate-recovery, actionlib, clear-costmap-recovery, rospy, tf, geometry-msgs, message-generation, message-runtime, std-srvs, navfn, catkin, move-base-msgs, nav-msgs, roscpp, visualization-msgs, costmap-2d, cmake-modules, base-local-planner, pluginlib, nav-core, dynamic-reconfigure }:
buildRosPackage {
  ...
  buildInputs = [ rotate-recovery actionlib rospy clear-costmap-recovery tf geometry-msgs message-generation std-srvs navfn move-base-msgs nav-msgs roscpp visualization-msgs costmap-2d cmake-modules base-local-planner pluginlib nav-core dynamic-reconfigure ];
