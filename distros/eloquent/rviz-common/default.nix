...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/eloquent/rviz_common/7.0.7-1.tar.gz";
    name = "7.0.7-1.tar.gz";
    sha256 = "fad4832798969f062b72fc11ff24d468c846b450c2fbde89d1380963aa98ff94";
  };
