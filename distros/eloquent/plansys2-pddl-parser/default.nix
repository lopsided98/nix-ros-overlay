...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/IntelligentRoboticsLabs/ros2_planning_system-release/archive/release/eloquent/plansys2_pddl_parser/0.0.7-1.tar.gz";
    name = "0.0.7-1.tar.gz";
    sha256 = "785067e87b151e869ebe2d78b46c475755c94959285ce8329292fa739c567d4b";
  };
