...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/eloquent/nav2_recoveries/0.3.5-1.tar.gz";
    name = "0.3.5-1.tar.gz";
    sha256 = "8382ea7de1f149c62570603b7b455f01bc51e513b06dfc756cbaa817f58613ad";
  };
