...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_robot_monitor-release/archive/release/eloquent/rqt_robot_monitor/1.0.4-1.tar.gz";
    name = "1.0.4-1.tar.gz";
    sha256 = "3fed2d45e24067f337c45484ba64b9486cce45d10e43b4b42c86201163a4d0e4";
  };
