...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/eloquent/ros2srv/0.8.8-1.tar.gz";
    name = "0.8.8-1.tar.gz";
    sha256 = "38924748c69399bc1865a11eace3ceb3060fc4764dc2edf5bff0dc4df3bb5719";
  };
