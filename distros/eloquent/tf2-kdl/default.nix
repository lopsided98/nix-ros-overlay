...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/eloquent/tf2_kdl/0.12.6-1.tar.gz";
    name = "0.12.6-1.tar.gz";
    sha256 = "760782e87b9292a941a291a25814c82a24775be6518941d8cf07c978ca687e96";
  };
