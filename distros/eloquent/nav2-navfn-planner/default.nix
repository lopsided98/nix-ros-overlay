...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/eloquent/nav2_navfn_planner/0.3.5-1.tar.gz";
    name = "0.3.5-1.tar.gz";
    sha256 = "c1e393d376515b9a887b75bfa0c8c9aa0ce5fab8a15f3ec763d84131aae17a0a";
  };
