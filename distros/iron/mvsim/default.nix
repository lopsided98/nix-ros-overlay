...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mvsim-release/archive/release/iron/mvsim/0.9.3-1.tar.gz";
    name = "0.9.3-1.tar.gz";
    sha256 = "f7434ad7f3c1710fbaaacd047af74fb54101b6c086a219cee9324b5204e8980b";
  };
