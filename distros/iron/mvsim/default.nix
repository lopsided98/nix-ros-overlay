...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mvsim-release/archive/release/iron/mvsim/0.10.0-1.tar.gz";
    name = "0.10.0-1.tar.gz";
    sha256 = "f1c7d10c5cffdc7da065ed2ccb7124bd644fa630263c34f05badc60eacd50017";
  };
