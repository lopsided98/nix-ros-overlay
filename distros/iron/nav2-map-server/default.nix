...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_map_server/1.2.9-1.tar.gz";
    name = "1.2.9-1.tar.gz";
    sha256 = "dad36da0198cd2eee79e386b50b9dd1843212d168e74b7954fe5fcb2950aa62e";
  };
