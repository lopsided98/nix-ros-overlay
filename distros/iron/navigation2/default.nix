...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/iron/navigation2/1.2.8-1.tar.gz";
    name = "1.2.8-1.tar.gz";
    sha256 = "78cd394542de86264df07fb0744be6cf24233df91c130b7ad6de9e67abf68e2b";
  };
