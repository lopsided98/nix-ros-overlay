...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/iron/navigation2/1.2.10-1.tar.gz";
    name = "1.2.10-1.tar.gz";
    sha256 = "44d46dbe1fdeac1b5edf7e1474318da6a9f779a3a182a01b6c2b2b822bd2edf0";
  };
