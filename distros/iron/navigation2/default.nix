...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/iron/navigation2/1.2.9-1.tar.gz";
    name = "1.2.9-1.tar.gz";
    sha256 = "674d65df76fdc3598ee441f70ed34babad3efdeb0e46d679b5c971526cded69b";
  };
