...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_system_tests/1.2.8-1.tar.gz";
    name = "1.2.8-1.tar.gz";
    sha256 = "67540405c8ffc36e09696f9b7d43ece2ed594b3be6b213295f2488e00b8c3dc3";
  };
