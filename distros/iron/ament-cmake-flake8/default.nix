...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/iron/ament_cmake_flake8/0.14.1-2.tar.gz";
    name = "0.14.1-2.tar.gz";
    sha256 = "f55eee47f97238eae0e62a244ca176ffb6c42786332b8a3ffffc62c9cb69465e";
  };
