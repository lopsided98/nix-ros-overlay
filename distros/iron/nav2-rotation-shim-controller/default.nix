...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_rotation_shim_controller/1.2.9-1.tar.gz";
    name = "1.2.9-1.tar.gz";
    sha256 = "240dec14f6bac6cfab0a2e9c5c7d3c039ae20a160d732fdf9447483da8deaa58";
  };
