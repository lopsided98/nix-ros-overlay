...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/slam_toolbox-release/archive/release/iron/slam_toolbox/2.7.4-1.tar.gz";
    name = "2.7.4-1.tar.gz";
    sha256 = "930ce8b6c7f3f58cbd4fa9e312af36bfa944c827028ab7833cd512a4f0d5f6a2";
  };
