...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/octomap_mapping-release/archive/release/iron/octomap_server/2.0.0-4.tar.gz";
    name = "2.0.0-4.tar.gz";
    sha256 = "369cbf787114b038b9d5966854a79d23471a67ab9cdb6c5ca14311406be9aab9";
  };
