...
buildRosPackage {
  pname = "ros-iron-system-modes-msgs";
  version = "0.9.0-r5";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/system_modes-release/archive/release/iron/system_modes_msgs/0.9.0-5.tar.gz";
    name = "0.9.0-5.tar.gz";
    sha256 = "339f3f84de412cb81e5b10144c2a4301ced531ca53b72c559d57453f88ee8d59";
  };
