...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/iron/controller_manager/3.27.0-1.tar.gz";
    name = "3.27.0-1.tar.gz";
    sha256 = "d2319e512e9220aa45de30d616ebd67f9d7a921418ea2258c4c3c12246a95eb9";
  };
