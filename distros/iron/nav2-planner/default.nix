...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_planner/1.2.8-1.tar.gz";
    name = "1.2.8-1.tar.gz";
    sha256 = "6f4011076bb460bced2bb698b8d61fe01917c5f72c7ff6b57efe23a0f00862b5";
  };
