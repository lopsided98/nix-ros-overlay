...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/iron/mola/1.0.5-1.tar.gz";
    name = "1.0.5-1.tar.gz";
    sha256 = "b1e6f6633584f7bccd9387e7e57a42804b5a8e24177cb90287ff7a40d8e7fccc";
  };
