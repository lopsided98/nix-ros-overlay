...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_core/1.2.8-1.tar.gz";
    name = "1.2.8-1.tar.gz";
    sha256 = "745813fa59ac61de63c1cd693470dad463eb08ff3833887dee0241a85722288c";
  };
