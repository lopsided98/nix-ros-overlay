...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_core/1.2.10-1.tar.gz";
    name = "1.2.10-1.tar.gz";
    sha256 = "e4a34a1959dcec2a5fcb332483e37986b24ad47640912060398dbbdaad5fefc6";
  };
