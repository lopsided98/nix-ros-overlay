...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/microstrain_inertial-release/archive/release/iron/microstrain_inertial_driver/3.0.1-3.tar.gz";
    name = "3.0.1-3.tar.gz";
    sha256 = "cc51aefe27ac994e83c5880960f8a351912b5bd6fe596fbb714f5555e5ee7a19";
  };
