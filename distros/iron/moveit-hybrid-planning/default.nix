...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/iron/moveit_hybrid_planning/2.7.4-1.tar.gz";
    name = "2.7.4-1.tar.gz";
    sha256 = "d3e87c5a1362c4e33e4b73e9673e930b1eab0ba89fa8516e047dcd0c33f5cea0";
  };
