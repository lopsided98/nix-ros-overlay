...
buildRosPackage {
  pname = "ros-iron-moveit-hybrid-planning";
  version = "2.8.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/iron/moveit_hybrid_planning/2.8.0-1.tar.gz";
    name = "2.8.0-1.tar.gz";
    sha256 = "c27635bf988766f53b3b303b17fcf80fe2875835c362f1f8fd9bd97d0d7a20b1";
  };
