...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/iron/bicycle_steering_controller/3.26.0-1.tar.gz";
    name = "3.26.0-1.tar.gz";
    sha256 = "8f6c4eb7b7e2a4637dbcc3dae6caa1c4c612ecada926aecbdc509ee2d2353fec";
  };
