...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/iron/ur_robot_driver/2.3.8-1.tar.gz";
    name = "2.3.8-1.tar.gz";
    sha256 = "675f9eb9ca4944a1caf484941cb60aa6b718de97b90ff6d25034bd87ad846803";
  };
