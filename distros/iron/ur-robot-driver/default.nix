...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/iron/ur_robot_driver/2.3.7-1.tar.gz";
    name = "2.3.7-1.tar.gz";
    sha256 = "eb92c2ffbf812452d3310f0da429bdc1d2ba9d5209be9d7b77d7204ae5978970";
  };
