...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/iron/ur_robot_driver/2.3.9-1.tar.gz";
    name = "2.3.9-1.tar.gz";
    sha256 = "6758bd488d8cc8219d9ae88b70a10afdd5034c15e409b7fbc11deb1a59a3fc82";
  };
