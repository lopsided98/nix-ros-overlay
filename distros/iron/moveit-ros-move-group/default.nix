...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/iron/moveit_ros_move_group/2.7.4-1.tar.gz";
    name = "2.7.4-1.tar.gz";
    sha256 = "47d144fab25c308b7ac75c6de359f5ec9ffc1931bfe400688991785bd9af8e44";
  };
