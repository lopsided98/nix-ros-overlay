...
buildRosPackage {
  pname = "ros-iron-ecl-formatters";
  version = "1.2.1-r4";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/iron/ecl_formatters/1.2.1-4.tar.gz";
    name = "1.2.1-4.tar.gz";
    sha256 = "f3b1767480003de90b59bf96d8cc13c19779ab4110a0d3dca41567cebcb13b6d";
  };
