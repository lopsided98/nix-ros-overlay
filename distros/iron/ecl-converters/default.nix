...
buildRosPackage {
  pname = "ros-iron-ecl-converters";
  version = "1.2.1-r4";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/iron/ecl_converters/1.2.1-4.tar.gz";
    name = "1.2.1-4.tar.gz";
    sha256 = "1b7415aba20f5c17cd7c4426082ba3027c0543f228f6ad0df241da88718a1590";
  };
