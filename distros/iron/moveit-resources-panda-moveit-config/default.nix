...
buildRosPackage {
  pname = "ros-iron-moveit-resources-panda-moveit-config";
  version = "2.1.1-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit_resources-release/archive/release/iron/moveit_resources_panda_moveit_config/2.1.1-1.tar.gz";
    name = "2.1.1-1.tar.gz";
    sha256 = "d2cf0c1da5e867efcd55578cc5ef36055aad2890eca995aa327d4adbb9be94b7";
  };
