...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_controller/1.2.8-1.tar.gz";
    name = "1.2.8-1.tar.gz";
    sha256 = "dde4aaa5b7670b84eeacec14e8faf95a7a3ac85c4863e9e8aaba2db0cb151c76";
  };
