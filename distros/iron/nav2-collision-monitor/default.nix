...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_collision_monitor/1.2.9-1.tar.gz";
    name = "1.2.9-1.tar.gz";
    sha256 = "7b9dd381633614ae7e157adead3046e498ca79a11d0d2e739f71ec24c25d5700";
  };
