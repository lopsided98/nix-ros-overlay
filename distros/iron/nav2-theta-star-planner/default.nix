...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_theta_star_planner/1.2.9-1.tar.gz";
    name = "1.2.9-1.tar.gz";
    sha256 = "62cdee7f47482e9fbcd4c393caeb5847054f4e29de17d0aafe8da3119ac8d77c";
  };
