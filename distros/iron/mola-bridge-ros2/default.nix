...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/iron/mola_bridge_ros2/1.0.4-1.tar.gz";
    name = "1.0.4-1.tar.gz";
    sha256 = "9236821c54163beb2f4a8e40d3761d66c4a8b5226fec7644f403b3178a0f0fea";
  };
