...
buildRosPackage {
  pname = "ros-iron-ecl-core-apps";
  version = "1.2.1-r4";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/iron/ecl_core_apps/1.2.1-4.tar.gz";
    name = "1.2.1-4.tar.gz";
    sha256 = "3f37cfa79b5b0664af4106ccb93f1817ef963ed3a4b9beb6ff0ec483f7057207";
  };
