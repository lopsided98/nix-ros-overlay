...
buildRosPackage {
  pname = "ros-iron-geometric-shapes";
  version = "2.1.3-r4";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometric_shapes-release/archive/release/iron/geometric_shapes/2.1.3-4.tar.gz";
    name = "2.1.3-4.tar.gz";
    sha256 = "42c0c871a172f2209e45290b319d4cb92dc0590364c58d904da724235ce854a6";
  };
