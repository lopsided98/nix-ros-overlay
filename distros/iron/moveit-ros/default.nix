...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/iron/moveit_ros/2.7.4-1.tar.gz";
    name = "2.7.4-1.tar.gz";
    sha256 = "8a7fdcf777fa9789a1a03af59a35ef25066ca28ee4bdd984f9bb8dbf6f4d344e";
  };
