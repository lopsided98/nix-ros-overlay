...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/iron/ros2_controllers/3.20.1-1.tar.gz";
    name = "3.20.1-1.tar.gz";
    sha256 = "ecfb409f91c53deef40306d7f4d3a77cdd84aa902f2085ca8c8fd926b86e50be";
  };
