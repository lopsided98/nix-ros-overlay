...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/iron/ros2_controllers/3.26.1-1.tar.gz";
    name = "3.26.1-1.tar.gz";
    sha256 = "24a67da0890d799d7b5dbd6057b64f6f5ea25d6b83334399deef47f8b7b62ee4";
  };
