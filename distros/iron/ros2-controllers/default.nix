...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/iron/ros2_controllers/3.26.2-1.tar.gz";
    name = "3.26.2-1.tar.gz";
    sha256 = "1a38c802460b89e90fc75c35d94825ea1bcddee42ccec5ae035d97fb627fa041";
  };
