...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/iron/ros2_controllers/3.24.0-1.tar.gz";
    name = "3.24.0-1.tar.gz";
    sha256 = "c1bf9ce52a2c710aba7b7f0dbd7bec1af3bc25cc909053b83459c584b6af4886";
  };
