...
buildRosPackage {
  pname = "ros-iron-moveit-ros-control-interface";
  version = "2.8.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/iron/moveit_ros_control_interface/2.8.0-1.tar.gz";
    name = "2.8.0-1.tar.gz";
    sha256 = "4e104f08aa69856b71112cac1fb841dee7e2b6d127a0cbabb868ee929235d246";
  };
