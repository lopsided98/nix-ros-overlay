...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/iron/tricycle_controller/3.26.0-1.tar.gz";
    name = "3.26.0-1.tar.gz";
    sha256 = "2d1bd1ca6869112d10d56bcc17a839334b2c00bcb51c5bf61d0c069db182f589";
  };
