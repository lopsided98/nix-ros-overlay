...
buildRosPackage {
  pname = "ros-iron-rcss3d-agent";
  version = "0.4.1-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcss3d_agent-release/archive/release/iron/rcss3d_agent/0.4.1-3.tar.gz";
    name = "0.4.1-3.tar.gz";
    sha256 = "99df434eb1f5284afd0d17bc71df71eb88be72a18a0cd4c6ddd9472854de1a82";
  };
