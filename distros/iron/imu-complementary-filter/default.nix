...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/imu_tools-release/archive/release/iron/imu_complementary_filter/2.1.5-1.tar.gz";
    name = "2.1.5-1.tar.gz";
    sha256 = "57a6df31aca97cb419334966ad6a63adc03c79481729021e7ad325e8096d6f74";
  };
