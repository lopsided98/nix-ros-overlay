...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/iron/range_sensor_broadcaster/3.19.2-1.tar.gz";
    name = "3.19.2-1.tar.gz";
    sha256 = "08e2bd8f667dec311878188ed0c9daf519ccdc6b7236f6880648865a6c2308a2";
  };
