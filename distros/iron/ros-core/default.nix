...
buildRosPackage {
  pname = "ros-iron-ros-core";
  version = "0.10.0-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/variants-release/archive/release/iron/ros_core/0.10.0-3.tar.gz";
    name = "0.10.0-3.tar.gz";
    sha256 = "cb306b744c981d8052d61687af3d7e3ab823f0a30dc2d6adc0afb901c9299240";
  };
