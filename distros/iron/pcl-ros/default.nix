...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/perception_pcl-release/archive/release/iron/pcl_ros/2.5.2-1.tar.gz";
    name = "2.5.2-1.tar.gz";
    sha256 = "f22ae5538ed8fc4f9c0b20a65a305053816576eb3be281982f3df36dde9525b1";
  };
