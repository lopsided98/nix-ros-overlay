...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_ros2-release/archive/release/iron/rmf_fleet_adapter/2.2.4-1.tar.gz";
    name = "2.2.4-1.tar.gz";
    sha256 = "2d9daf9893f3990d50c310e9d1c9ab8a0be2f84a46de2d9e936ef9228b761bf6";
  };
