...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/iron/mola_metric_maps/1.0.5-1.tar.gz";
    name = "1.0.5-1.tar.gz";
    sha256 = "467e599408d784935f8c2a875e6520e712a90a7ed17a25252db0d70cb116e133";
  };
