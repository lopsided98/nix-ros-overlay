...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/iron/mola_metric_maps/1.0.4-1.tar.gz";
    name = "1.0.4-1.tar.gz";
    sha256 = "e1423aebc454e67bce33ca85b3c1b502ead79ae7c9ba0c03a50845645d9a9d0b";
  };
