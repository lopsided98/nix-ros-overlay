...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt2-release/archive/release/iron/mrpt2/2.13.0-1.tar.gz";
    name = "2.13.0-1.tar.gz";
    sha256 = "acfdbc73462d163aced2bb53468e83db353731cf193cd8e049483454ab9e20cb";
  };
