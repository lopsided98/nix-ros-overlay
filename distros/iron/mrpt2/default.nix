...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt2-release/archive/release/iron/mrpt2/2.13.1-1.tar.gz";
    name = "2.13.1-1.tar.gz";
    sha256 = "ef904d63e94d5816d797ba88f9aed68e07cb468a5eb649a0fde57d8a50088ee2";
  };
