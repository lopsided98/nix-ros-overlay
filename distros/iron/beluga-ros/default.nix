...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/beluga-release/archive/release/iron/beluga_ros/2.0.1-1.tar.gz";
    name = "2.0.1-1.tar.gz";
    sha256 = "6941341d5dd0126d96cf731e3d58e5d0f93106c1880272f125e5575fb6ed9a32";
  };
