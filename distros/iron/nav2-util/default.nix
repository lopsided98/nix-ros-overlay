...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_util/1.2.9-1.tar.gz";
    name = "1.2.9-1.tar.gz";
    sha256 = "ca04c2b3f989ff9aa4bcb844e0da2c3d992dd7683f37156a68bd3e715e6edfe3";
  };
