...
buildRosPackage {
  pname = "ros-iron-rqt-plot";
  version = "1.2.3-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_plot-release/archive/release/iron/rqt_plot/1.2.3-1.tar.gz";
    name = "1.2.3-1.tar.gz";
    sha256 = "e1d981c3db13f5482a0cc7469bfde4724d66e0c7c61da3fdf18a77b83d28d792";
  };
