...
buildRosPackage {
  pname = "ros-iron-battery-state-broadcaster";
  version = "1.0.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_battery_monitoring-release/archive/release/iron/battery_state_broadcaster/1.0.0-1.tar.gz";
    name = "1.0.0-1.tar.gz";
    sha256 = "9e50d3c7e76a55b9538f8259301e320cd2e8d40d493315cefd05b1dc26dc150f";
  };
