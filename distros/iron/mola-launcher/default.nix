...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/iron/mola_launcher/1.0.5-1.tar.gz";
    name = "1.0.5-1.tar.gz";
    sha256 = "bc9571ff8d6f9d131fa74e341e517e7013e2071092c464a257c37ba1971abee3";
  };
