...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/iron/ackermann_steering_controller/3.26.3-1.tar.gz";
    name = "3.26.3-1.tar.gz";
    sha256 = "a48f5e88a0d3f2c2d43d7f2efc74e2c940f821129b6c945cb1bdbb221ccca12a";
  };
