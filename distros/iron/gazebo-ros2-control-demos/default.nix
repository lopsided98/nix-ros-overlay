...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gazebo_ros2_control-release/archive/release/iron/gazebo_ros2_control_demos/0.6.6-1.tar.gz";
    name = "0.6.6-1.tar.gz";
    sha256 = "406311435b506b7782793eb11319ada1038f9d8c646a9ff67aa452e1984a1c35";
  };
