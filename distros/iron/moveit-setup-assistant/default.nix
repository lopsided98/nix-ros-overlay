...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/iron/moveit_setup_assistant/2.7.4-1.tar.gz";
    name = "2.7.4-1.tar.gz";
    sha256 = "f779386976889e2ae85b0e230a666414ec3b356600c28aadb3ea5786ebb74496";
  };
