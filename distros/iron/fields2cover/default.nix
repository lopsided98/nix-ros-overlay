...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fields2cover-release/archive/release/iron/fields2cover/2.0.0-3.tar.gz";
    name = "2.0.0-3.tar.gz";
    sha256 = "ab2a4ca44319442184ccc34de0a67dc2b982af0a18748d9c3750cfd999be8997";
  };
