...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fields2cover-release/archive/release/iron/fields2cover/2.0.0-5.tar.gz";
    name = "2.0.0-5.tar.gz";
    sha256 = "9900b9d560d192e6e6012908599282e42424ea08ce2a2c92c663170cb8ac3f35";
  };
