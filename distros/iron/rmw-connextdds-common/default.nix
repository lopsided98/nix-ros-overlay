...
buildRosPackage {
  pname = "ros-iron-rmw-connextdds-common";
  version = "0.14.1-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_connextdds-release/archive/release/iron/rmw_connextdds_common/0.14.1-1.tar.gz";
    name = "0.14.1-1.tar.gz";
    sha256 = "23d5879cc2389bd8f943b14ddbf03c17bc61bef3d32a33894ab5e66920744f10";
  };
