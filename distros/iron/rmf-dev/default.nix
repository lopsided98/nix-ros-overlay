...
buildRosPackage {
  pname = "ros-iron-rmf-dev";
  version = "0.0.1-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_variants-release/archive/release/iron/rmf_dev/0.0.1-1.tar.gz";
    name = "0.0.1-1.tar.gz";
    sha256 = "3240a42339982f102bfd4da06282b6dafd3e870e427f22a0b0d09f7cbbaa684e";
  };
