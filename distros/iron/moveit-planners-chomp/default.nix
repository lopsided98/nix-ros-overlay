...
buildRosPackage {
  pname = "ros-iron-moveit-planners-chomp";
  version = "2.8.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/iron/moveit_planners_chomp/2.8.0-1.tar.gz";
    name = "2.8.0-1.tar.gz";
    sha256 = "b4d3149c0851d9744ee0399e1b87c50161fce473bfa760c8f047df692d9b8bb5";
  };
