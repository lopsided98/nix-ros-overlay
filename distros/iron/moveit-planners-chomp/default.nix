...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/iron/moveit_planners_chomp/2.7.4-1.tar.gz";
    name = "2.7.4-1.tar.gz";
    sha256 = "343b27f43e484f7b107dce9de17764050ccf6bfca8031ce9147987e567387389";
  };
