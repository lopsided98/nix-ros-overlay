...
buildRosPackage {
  pname = "ros-iron-moveit-resources-prbt-moveit-config";
  version = "2.8.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/iron/moveit_resources_prbt_moveit_config/2.8.0-1.tar.gz";
    name = "2.8.0-1.tar.gz";
    sha256 = "3c630044488b158ecaaf4a97c46fc25392af8b3c5240826ff42349f1c3ed5706";
  };
