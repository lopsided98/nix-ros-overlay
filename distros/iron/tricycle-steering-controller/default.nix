...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/iron/tricycle_steering_controller/3.24.0-1.tar.gz";
    name = "3.24.0-1.tar.gz";
    sha256 = "3ad0faa3f432be996ea42d1feb34ef5f98a6cd78bd8ff8e5692a6f33f657bdff";
  };
