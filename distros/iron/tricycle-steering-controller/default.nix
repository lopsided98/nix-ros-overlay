...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/iron/tricycle_steering_controller/3.26.0-1.tar.gz";
    name = "3.26.0-1.tar.gz";
    sha256 = "c50bab922e8ef3c60d20c146e5d54308f36fdc4a3a2c48e8a191d46804ab2c91";
  };
