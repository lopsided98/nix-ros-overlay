...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_velocity_smoother/1.2.8-1.tar.gz";
    name = "1.2.8-1.tar.gz";
    sha256 = "4fa27efec2daccd47150f2223c647dc260022d75df0a34a298627df4f9c83291";
  };
