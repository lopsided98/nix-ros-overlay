...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_navfn_planner/1.2.8-1.tar.gz";
    name = "1.2.8-1.tar.gz";
    sha256 = "b7af76b2d6d415dbca405324c0ff73d3e2e096c49f28cf2c890fb292a7f63e6f";
  };
