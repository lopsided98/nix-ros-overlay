...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/iron/swri_image_util/3.6.1-1.tar.gz";
    name = "3.6.1-1.tar.gz";
    sha256 = "2a84baae02d05b6d84d3f8387ff185c095000a6d011bfc13180357d8634030fb";
  };
