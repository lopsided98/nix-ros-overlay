...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/iron/dwb_core/1.2.8-1.tar.gz";
    name = "1.2.8-1.tar.gz";
    sha256 = "ad92e7f47f2ab35d09450c13183488d016214f5be292c2e821fe85783173d6af";
  };
