...
buildRosPackage {
  pname = "ros-iron-rqt-common-plugins";
  version = "1.2.0-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_common_plugins-release/archive/release/iron/rqt_common_plugins/1.2.0-3.tar.gz";
    name = "1.2.0-3.tar.gz";
    sha256 = "6d7ca62f1b8fe190ed19f748504c09780baed582d40b624c3d0d4f0c1771f0e6";
  };
