...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/iron/nav2_rviz_plugins/1.2.9-1.tar.gz";
    name = "1.2.9-1.tar.gz";
    sha256 = "115cbe6a5b8558bc5484b6192eb7744f1cae2c6e40266d9178544ab4f70fd20e";
  };
