...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_visualization-release/archive/release/iron/rmf_visualization_schedule/2.1.2-1.tar.gz";
    name = "2.1.2-1.tar.gz";
    sha256 = "33ebeaf955259202a909749aa4ff132837cca2234eac9cc9087d38b3b6fd4ba0";
  };
