...
buildRosPackage {
  pname = "ros-iron-ecl-streams";
  version = "1.2.1-r4";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/iron/ecl_streams/1.2.1-4.tar.gz";
    name = "1.2.1-4.tar.gz";
    sha256 = "8110f59a0632927503ec56b8f08cb41da30ebb53b56e1b1b75704e2d5746968a";
  };
