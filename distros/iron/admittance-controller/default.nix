...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/iron/admittance_controller/3.26.0-1.tar.gz";
    name = "3.26.0-1.tar.gz";
    sha256 = "89588cd83cbdece847600daa04ad26ac93f18fa5f27e2136e7b1ea53b4ff1b52";
  };
