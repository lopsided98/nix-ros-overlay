...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/iron/admittance_controller/3.26.1-1.tar.gz";
    name = "3.26.1-1.tar.gz";
    sha256 = "6dde40acd63c92203e1ac50e21c166d1dfd1b9285e9c1314bdc3cc99d781f1e7";
  };
