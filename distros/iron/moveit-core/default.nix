...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/iron/moveit_core/2.7.4-1.tar.gz";
    name = "2.7.4-1.tar.gz";
    sha256 = "a7fc40388a46101bd18d523378c3747edf994de08b673c4b615cbf6b9007567c";
  };
