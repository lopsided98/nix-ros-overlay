...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/iron/diff_drive_controller/3.26.2-1.tar.gz";
    name = "3.26.2-1.tar.gz";
    sha256 = "ad299c88e26ba840ac773c62e365eddf5259acdca958585b5648d930ffcdf30a";
  };
