...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/iron/diff_drive_controller/3.20.1-1.tar.gz";
    name = "3.20.1-1.tar.gz";
    sha256 = "fb831fe8c74c7a23261fb938cd0f2075e363406794575b0674589916b5f6f569";
  };
