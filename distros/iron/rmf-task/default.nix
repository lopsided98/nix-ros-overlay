...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_task-release/archive/release/iron/rmf_task/2.2.4-1.tar.gz";
    name = "2.2.4-1.tar.gz";
    sha256 = "f1202623793e3936cc303e784573289e4fb2baafb7d6a887ac7eb35ffa14da46";
  };
