...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gazebo_ros2_control-release/archive/release/iron/gazebo_ros2_control/0.6.6-1.tar.gz";
    name = "0.6.6-1.tar.gz";
    sha256 = "b11c9859a8061ed34f6823b9b22eb9337b1cbae9487611b8eda671604c395f19";
  };
