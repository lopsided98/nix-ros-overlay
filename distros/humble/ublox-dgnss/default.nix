...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/humble/ublox_dgnss/0.7.0-1.tar.gz";
    name = "0.7.0-1.tar.gz";
    sha256 = "929a47629bbe07f3c7c710c335f22cc2efbe30e7bfbe51d531c2e45aa392eb98";
  };
