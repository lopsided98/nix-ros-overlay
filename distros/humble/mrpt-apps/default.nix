...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_apps/2.15.15-1.tar.gz";
    name = "2.15.15-1.tar.gz";
    sha256 = "cc6e32eeaa319c18b6adab8a877127f6c1d07569c96a2ccb8cb9350096c5a15f";
  };
