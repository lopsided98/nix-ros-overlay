...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/humble/image_publisher/3.0.9-1.tar.gz";
    name = "3.0.9-1.tar.gz";
    sha256 = "d074758e7a7166b2850b381bb1f4006d5489e8f9222dcaf31e8eec71f465ebf3";
  };
