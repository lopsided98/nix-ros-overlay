...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/humble/rosidl_parser/3.1.7-1.tar.gz";
    name = "3.1.7-1.tar.gz";
    sha256 = "cc32ef38a88ef441a249f382cc5e627e607d90ab1d03d712dd2b90bcdf0bcbb6";
  };
