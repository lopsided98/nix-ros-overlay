...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/apriltag-release/archive/release/humble/apriltag/3.4.5-1.tar.gz";
    name = "3.4.5-1.tar.gz";
    sha256 = "844e2416816b8029486729e7cbb60084320ceb335178f18ccf7f2b324ce3fe05";
  };
