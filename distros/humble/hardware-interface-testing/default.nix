...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/humble/hardware_interface_testing/2.54.1-1.tar.gz";
    name = "2.54.1-1.tar.gz";
    sha256 = "344eef56910c993a1e9b570bb355af7640acad206f6fe86b8b0ebc7db8cd67bb";
  };
