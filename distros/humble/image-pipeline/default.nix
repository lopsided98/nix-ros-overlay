...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/humble/image_pipeline/3.0.9-1.tar.gz";
    name = "3.0.9-1.tar.gz";
    sha256 = "21ad2cbadade3a8e695b0acfa65431fbd5a2a92fe5bba9b7f0684d0e7564cbb3";
  };
