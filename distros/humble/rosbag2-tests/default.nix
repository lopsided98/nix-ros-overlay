...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_tests/0.15.15-1.tar.gz";
    name = "0.15.15-1.tar.gz";
    sha256 = "2466e6300abdb08f1a8cdc1908586b056cd9bc1014dfad554d35d5dcce2ed05b";
  };
