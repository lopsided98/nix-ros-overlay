...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_tests/0.15.9-1.tar.gz";
    name = "0.15.9-1.tar.gz";
    sha256 = "786b47f6acb301bd853c5e49edab90fb169a7f23984db7dcfc3dcc87be964292";
  };
