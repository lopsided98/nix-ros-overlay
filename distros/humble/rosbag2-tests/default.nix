...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_tests/0.15.5-1.tar.gz";
    name = "0.15.5-1.tar.gz";
    sha256 = "8cce5f94e1db7c8c92d458b8d2e66143f13691a33a4616567687dca9724d4a09";
  };
