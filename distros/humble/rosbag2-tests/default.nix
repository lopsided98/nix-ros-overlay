...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_tests/0.15.4-2.tar.gz";
    name = "0.15.4-2.tar.gz";
    sha256 = "c9f107d0a3d6419fe469b40c6660f3fbc97c6db8d2580702b8deef5945ecab96";
  };
