...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/humble/swri_route_util/3.7.6-1.tar.gz";
    name = "3.7.6-1.tar.gz";
    sha256 = "f7da3b2edc4251ce1e4e5563a0ee085211d9e8636df0e8c9f4527bb575253bf3";
  };
