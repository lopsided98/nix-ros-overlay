...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav_2d_utils/1.1.15-1.tar.gz";
    name = "1.1.15-1.tar.gz";
    sha256 = "72b1372adcebf5b7f944cfe19f691cf9ea33896f2e50a047fcac62e85c591dfc";
  };
