...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/humble/mapviz/2.4.9-1.tar.gz";
    name = "2.4.9-1.tar.gz";
    sha256 = "31040fbe9d243054db3d1429d07c284b890a648dab3dc73835bc92a5984ac10c";
  };
