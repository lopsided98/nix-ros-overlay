...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/event_camera_tools-release/archive/release/humble/event_camera_tools/3.1.1-1.tar.gz";
    name = "3.1.1-1.tar.gz";
    sha256 = "f1e46271fc0cac79d28cea9062fa30fb696475b51aa597a109e529b3113d23d1";
  };
