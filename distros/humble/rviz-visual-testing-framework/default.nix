...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_visual_testing_framework/11.2.19-1.tar.gz";
    name = "11.2.19-1.tar.gz";
    sha256 = "348d76785e904c0368a70400fed895d9de9ef2b375b6021c1928d4fa17cc5a37";
  };
