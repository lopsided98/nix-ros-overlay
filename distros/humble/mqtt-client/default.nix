...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mqtt_client-release/archive/release/humble/mqtt_client/2.4.2-1.tar.gz";
    name = "2.4.2-1.tar.gz";
    sha256 = "8e21e57eb26354e3f43fe2a2a4ee5425fa694e51134de943da8c2249ee485715";
  };
