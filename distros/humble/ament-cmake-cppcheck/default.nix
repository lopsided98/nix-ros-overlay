...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_cmake_cppcheck/0.12.13-1.tar.gz";
    name = "0.12.13-1.tar.gz";
    sha256 = "b62ca11318a18dc8c436fa68141fadcef553eb3c1cd28dd10a58efc30b4a1b24";
  };
