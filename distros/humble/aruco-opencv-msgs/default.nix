...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/aruco_opencv-release/archive/release/humble/aruco_opencv_msgs/2.4.1-1.tar.gz";
    name = "2.4.1-1.tar.gz";
    sha256 = "bbb819f35b5be99643bc6a70b635da171ee2df459df99767e4491bb1fa1ceab1";
  };
