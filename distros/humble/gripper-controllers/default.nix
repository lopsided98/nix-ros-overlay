...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/gripper_controllers/2.17.2-1.tar.gz";
    name = "2.17.2-1.tar.gz";
    sha256 = "86c26dcfa406c897dc5a107ae272c4b4105827592f1284e779c50303cdf57160";
  };
