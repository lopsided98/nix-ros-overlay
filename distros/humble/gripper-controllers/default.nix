...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/gripper_controllers/2.49.0-1.tar.gz";
    name = "2.49.0-1.tar.gz";
    sha256 = "6df1999174b05c998b30f938ef89e91d8fbcddda91681fa70933970a7ebe5b1e";
  };
