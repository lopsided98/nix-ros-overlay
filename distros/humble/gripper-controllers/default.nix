...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/gripper_controllers/2.48.0-1.tar.gz";
    name = "2.48.0-1.tar.gz";
    sha256 = "6a48683a3169fa569415625b1fcfbdb81c83d7d43290ddd3777e63fa9adcd22b";
  };
