...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/gripper_controllers/2.52.0-1.tar.gz";
    name = "2.52.0-1.tar.gz";
    sha256 = "04a682eacee4213a255a86283339e56d0e63470f08bae1b739070a2cda9f152d";
  };
