...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/humble/yasmin_viewer/4.0.2-1.tar.gz";
    name = "4.0.2-1.tar.gz";
    sha256 = "ccaae7bdb04ead2234cfd51b5199fc3085aba0d909b4749a2a3140382a37109d";
  };
