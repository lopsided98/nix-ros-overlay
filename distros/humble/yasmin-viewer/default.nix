...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/humble/yasmin_viewer/4.2.3-1.tar.gz";
    name = "4.2.3-1.tar.gz";
    sha256 = "4aa6226761ae781318816fddbe9012a5d952aeef192a98b573fc5162c2de4930";
  };
