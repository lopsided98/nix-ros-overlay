...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/humble/yasmin_viewer/4.0.0-1.tar.gz";
    name = "4.0.0-1.tar.gz";
    sha256 = "bc5755cac84fa5c09e849f758db74ac77451b5f810bb63619d3875524d44aca9";
  };
