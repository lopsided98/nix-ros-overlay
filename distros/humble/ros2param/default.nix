...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2param/0.18.16-1.tar.gz";
    name = "0.18.16-1.tar.gz";
    sha256 = "ff106f96153b17e090b4eecee574dfb927fb05bae022b13bb02f217f518914f3";
  };
