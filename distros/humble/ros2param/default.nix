...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2param/0.18.18-1.tar.gz";
    name = "0.18.18-1.tar.gz";
    sha256 = "9d9cb041babae22199610956c63f05b18a2b14a12c452025eb180495f7cf141c";
  };
