...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2param/0.18.7-1.tar.gz";
    name = "0.18.7-1.tar.gz";
    sha256 = "061b63778470f6f2cdf652b7fb97682fcbf06ced53ca7e90de9538d8263f6b1f";
  };
