...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2param/0.18.19-1.tar.gz";
    name = "0.18.19-1.tar.gz";
    sha256 = "be4254faa5cfc18d4893210bb8e68c37aafd36714a626b926a80a3ef44a2ac85";
  };
