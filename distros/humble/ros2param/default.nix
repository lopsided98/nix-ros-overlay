...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2param/0.18.5-1.tar.gz";
    name = "0.18.5-1.tar.gz";
    sha256 = "79a135f324372693e627b4f22bbf4421f05aafd2fb557476351c2ea2fe75a7eb";
  };
