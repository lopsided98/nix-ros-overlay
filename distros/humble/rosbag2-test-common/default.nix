...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_test_common/0.15.17-1.tar.gz";
    name = "0.15.17-1.tar.gz";
    sha256 = "3da4d36b7ce75f23bf1ac35cbe0746f993bd2deefea9477440a483433700a377";
  };
