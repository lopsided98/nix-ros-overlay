...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_waypoint_follower/1.1.20-1.tar.gz";
    name = "1.1.20-1.tar.gz";
    sha256 = "20ad6ae8d17f5b3b7444805a829a5dd08daa933c31c14eb9c433f298fa4db4da";
  };
