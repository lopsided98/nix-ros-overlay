...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/python_qt_binding-release/archive/release/humble/python_qt_binding/1.1.3-1.tar.gz";
    name = "1.1.3-1.tar.gz";
    sha256 = "3d3d11774f36f89f184f8cf61adec2a4534ac14e377db87b482e797703a97bb3";
  };
