...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/libcaer_driver-release/archive/release/humble/libcaer_driver/1.5.1-1.tar.gz";
    name = "1.5.1-1.tar.gz";
    sha256 = "0b0af91a7c76655374f61fcf53377a6179355684092790a3a0c2e199416cfe80";
  };
