...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/pal-gbp/tiago_robot-release/archive/release/humble/tiago_bringup/4.0.27-1.tar.gz";
    name = "4.0.27-1.tar.gz";
    sha256 = "ec7586fc32576a49c6de68ed194f29cac2bbad302218d6b37b2156ecb2c28731";
  };
