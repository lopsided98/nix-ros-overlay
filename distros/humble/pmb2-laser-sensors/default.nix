...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/pal-gbp/pmb2_navigation-gbp/archive/release/humble/pmb2_laser_sensors/4.18.2-1.tar.gz";
    name = "4.18.2-1.tar.gz";
    sha256 = "8b4f48a3368af475aa345107670a5e55e3f21a587ebce943b2e9a33a62383231";
  };
