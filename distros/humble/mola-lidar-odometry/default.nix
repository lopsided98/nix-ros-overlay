...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_lidar_odometry-release/archive/release/humble/mola_lidar_odometry/1.2.2-1.tar.gz";
    name = "1.2.2-1.tar.gz";
    sha256 = "15129a78117590d19efc8423de4771f7ffd181e254ff9c58f1296d192a11599a";
  };
