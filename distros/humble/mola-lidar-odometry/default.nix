...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_lidar_odometry-release/archive/release/humble/mola_lidar_odometry/0.5.4-1.tar.gz";
    name = "0.5.4-1.tar.gz";
    sha256 = "ddda33fb416861aef1ce418cf918f3fb89ef17d8afc21eed4538423184502eaa";
  };
