...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_lidar_odometry-release/archive/release/humble/mola_lidar_odometry/0.8.0-1.tar.gz";
    name = "0.8.0-1.tar.gz";
    sha256 = "79e3631453ec4c31ddeae1dffccd2a38c66cb2202624d2995f2310beb8f812b8";
  };
