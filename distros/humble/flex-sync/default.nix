...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/flex_sync-release/archive/release/humble/flex_sync/2.0.1-1.tar.gz";
    name = "2.0.1-1.tar.gz";
    sha256 = "dc1054f6de5c554665fc88897fae01b2023e8b5846596f3806dabf9bc54184ec";
  };
