...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/range_sensor_broadcaster/2.52.1-1.tar.gz";
    name = "2.52.1-1.tar.gz";
    sha256 = "0ca78c2d3b052a1675dd89a8c349d84646ed258c3fb5aef45e8f78b0f2f107e5";
  };
