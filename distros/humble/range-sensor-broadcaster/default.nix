...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/range_sensor_broadcaster/2.49.0-1.tar.gz";
    name = "2.49.0-1.tar.gz";
    sha256 = "7dfc44216d4754fe49ec9fea196cd4e0bf89e9894359d721536677389f0a928e";
  };
