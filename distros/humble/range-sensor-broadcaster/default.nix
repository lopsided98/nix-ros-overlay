...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/range_sensor_broadcaster/2.54.0-1.tar.gz";
    name = "2.54.0-1.tar.gz";
    sha256 = "157a471ce3c14f54c02bf4ad3db25d4fde7fbd6f0a972196bcc29e56af226771";
  };
