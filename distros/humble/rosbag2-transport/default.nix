...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_transport/0.15.17-1.tar.gz";
    name = "0.15.17-1.tar.gz";
    sha256 = "3c3e491da27ddd4f047980dcd4d08934affa3206e13db74f5d2e377c4f8bb609";
  };
