...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_transport/0.15.15-1.tar.gz";
    name = "0.15.15-1.tar.gz";
    sha256 = "95913c58c213a6f1fd4e72128a75efbfc763cc61d01b10e122486aea9e58e74a";
  };
