...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_transport/0.15.2-1.tar.gz";
    name = "0.15.2-1.tar.gz";
    sha256 = "27edcbe254033966fd3f4943ce1eb72ff23f0dca45cf3d3605884a90a9f2ba26";
  };
