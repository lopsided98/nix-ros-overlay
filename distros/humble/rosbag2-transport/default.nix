...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_transport/0.15.5-1.tar.gz";
    name = "0.15.5-1.tar.gz";
    sha256 = "91992ee8500a30566ebdbcd8b7426feea0a5abc911f3780c588ee50060227755";
  };
