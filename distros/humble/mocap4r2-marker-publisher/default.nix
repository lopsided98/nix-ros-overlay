...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/MOCAP4ROS2-Project/mocap4r2-release/archive/release/humble/mocap4r2_marker_publisher/0.0.6-1.tar.gz";
    name = "0.0.6-1.tar.gz";
    sha256 = "ae57e7583d547b442e306e9d42d83c2c8648e65212f3ce0ca14c2406b09b7aca";
  };
