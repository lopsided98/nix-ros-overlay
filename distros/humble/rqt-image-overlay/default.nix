...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_image_overlay-release/archive/release/humble/rqt_image_overlay/0.1.2-1.tar.gz";
    name = "0.1.2-1.tar.gz";
    sha256 = "b2db7858e6ee3ee3c7f519901f99d16abbb0804074bc2829b41f9a2c05d1f02a";
  };
