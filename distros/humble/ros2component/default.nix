...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2component/0.18.18-1.tar.gz";
    name = "0.18.18-1.tar.gz";
    sha256 = "8838ee68caa98bc80c5c03f89da98a8d58ca79be38f2ea9099b78ea65ad2654d";
  };
