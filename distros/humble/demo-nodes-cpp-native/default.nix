...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/humble/demo_nodes_cpp_native/0.20.10-1.tar.gz";
    name = "0.20.10-1.tar.gz";
    sha256 = "af1bfdd7649fd6b8796bdef951e1cace6e8735eb63e8272eecdabe862d5b218b";
  };
