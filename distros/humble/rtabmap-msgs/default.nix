...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/introlab/rtabmap_ros-release/archive/release/humble/rtabmap_msgs/0.22.0-1.tar.gz";
    name = "0.22.0-1.tar.gz";
    sha256 = "eb315bae18f736e2fe3a707e351225e42854ad88ffb0ccff1eb43ada75e9bc64";
  };
