...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/humble/webots_ros2_tests/2022.1.0-1.tar.gz";
    name = "2022.1.0-1.tar.gz";
    sha256 = "f456f4caa4ec129698b2d38eca5d032c938b7290192a2172f9a9fa8cb26fe152";
  };
