...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/pal-gbp/play_motion2-release/archive/release/humble/play_motion2/1.8.1-1.tar.gz";
    name = "1.8.1-1.tar.gz";
    sha256 = "127d1161a536a75b319209d3d264c9d269bbcf40b8f310cfc16a954d30a872d1";
  };
