...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/play_motion2-release/archive/release/humble/play_motion2/1.8.3-1.tar.gz";
    name = "1.8.3-1.tar.gz";
    sha256 = "e069f91f23c43248cfa3fd4b520f549a518bd8423be169aaa96e32a929035292";
  };
