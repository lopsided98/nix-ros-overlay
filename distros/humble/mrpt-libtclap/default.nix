...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libtclap/2.15.15-1.tar.gz";
    name = "2.15.15-1.tar.gz";
    sha256 = "bf3b90af420c72fcb0a70001707d76694b3cc14d90305169c098bbebd16c3b51";
  };
