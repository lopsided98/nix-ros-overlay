...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp_action/16.0.16-1.tar.gz";
    name = "16.0.16-1.tar.gz";
    sha256 = "adbfce2b7d97dcd6ca7b856da8151888bf836495a80b683182fb5e42d22ecfe3";
  };
