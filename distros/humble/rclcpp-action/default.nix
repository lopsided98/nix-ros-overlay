...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp_action/16.0.19-1.tar.gz";
    name = "16.0.19-1.tar.gz";
    sha256 = "eecd13eb766f0f8a63a9d44e2bbea51ad10799520783e007548307c533b05895";
  };
