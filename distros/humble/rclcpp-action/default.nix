...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp_action/16.0.18-1.tar.gz";
    name = "16.0.18-1.tar.gz";
    sha256 = "c1a1fe55699c74a6d0d69beb2f3d7e60f00e414a54b7309c087285109f14b6e5";
  };
