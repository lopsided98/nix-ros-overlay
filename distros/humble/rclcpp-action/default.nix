...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp_action/16.0.17-1.tar.gz";
    name = "16.0.17-1.tar.gz";
    sha256 = "301b42549432bf8542005c6dcd3a12321fbad5c5407acb992ef18c6c9d847d3b";
  };
