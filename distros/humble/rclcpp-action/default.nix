...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp_action/16.0.8-1.tar.gz";
    name = "16.0.8-1.tar.gz";
    sha256 = "6b60f47a51c229365eb346f906067cf0999f9dd01626cc5da13a8f41fba5fc71";
  };
