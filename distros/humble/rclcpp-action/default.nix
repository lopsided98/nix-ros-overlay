...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp_action/16.0.13-1.tar.gz";
    name = "16.0.13-1.tar.gz";
    sha256 = "1f954ce146dd3028e714bafa138ffb5c41f80c1da56ad3339460aa81f9223a59";
  };
