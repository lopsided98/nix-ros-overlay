...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp_action/16.0.21-1.tar.gz";
    name = "16.0.21-1.tar.gz";
    sha256 = "f9f8e32a2a54c87ac3ab9abb432812113fb411dbe9612871986b2d6d796617d0";
  };
