...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_system_tests/1.1.15-1.tar.gz";
    name = "1.1.15-1.tar.gz";
    sha256 = "d4e0ef8e7c08fdc10ba2f3a50ec4a310b3782490e8da546bffa7aeb95eb09d45";
  };
