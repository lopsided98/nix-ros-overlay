...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/humble/webots_ros2_importer/1.2.3-1.tar.gz";
    name = "1.2.3-1.tar.gz";
    sha256 = "ad78a59ba1d2a953b1475f07f1ba7da5f25201192bdc4081850624af2a619bea";
  };
