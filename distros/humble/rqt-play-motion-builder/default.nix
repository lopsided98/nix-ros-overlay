...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/play_motion_builder-release/archive/release/humble/rqt_play_motion_builder/1.4.1-1.tar.gz";
    name = "1.4.1-1.tar.gz";
    sha256 = "a675d48cb33aec39b9020f9c92a7013825fd25623a0575799bc655327fb3e5ec";
  };
