...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libobs/2.15.21-2.tar.gz";
    name = "2.15.21-2.tar.gz";
    sha256 = "7bbbfeaeef890091f9453214d77e6ec4f567970d90042597b3d72ff5e628a177";
  };
