...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mujoco_ros2_control-release/archive/release/humble/mujoco_ros2_control_plugins/0.1.2-1.tar.gz";
    name = "0.1.2-1.tar.gz";
    sha256 = "8655b33a924b5e1494f97b4e7fb13cdbc9cdfe896d7ec5e32f35167afb6481b3";
  };
