...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/imu_sensor_broadcaster/2.19.0-1.tar.gz";
    name = "2.19.0-1.tar.gz";
    sha256 = "fb1aead747467c9702bf79a75e7378ae3e6d808653c00f06e4c41fd95032f96a";
  };
