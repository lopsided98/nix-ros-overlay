...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/imu_sensor_broadcaster/2.31.0-1.tar.gz";
    name = "2.31.0-1.tar.gz";
    sha256 = "af55977f411b566f5c1f7cdde45e49b8a767516c05e8709a9fec02423351d35a";
  };
