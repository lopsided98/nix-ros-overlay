...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/imu_sensor_broadcaster/2.47.0-1.tar.gz";
    name = "2.47.0-1.tar.gz";
    sha256 = "447bd636880354c85db3bf9132f834f1a5400029650e5b9c278f5466cf92fb3a";
  };
