...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/imu_sensor_broadcaster/2.30.0-1.tar.gz";
    name = "2.30.0-1.tar.gz";
    sha256 = "5ad8c88200ecef4fa1f5a7587a808849a0a861f16ea47c1dcf0f4445329f396b";
  };
