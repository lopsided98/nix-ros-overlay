...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/imu_sensor_broadcaster/2.54.0-1.tar.gz";
    name = "2.54.0-1.tar.gz";
    sha256 = "9402f73f8209bf2d657bfd492100ddce962e2605f9c29fb2ce0ef63fee0f8116";
  };
