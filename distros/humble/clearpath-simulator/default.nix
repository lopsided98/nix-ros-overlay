...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_simulator-release/archive/release/humble/clearpath_simulator/0.2.5-1.tar.gz";
    name = "0.2.5-1.tar.gz";
    sha256 = "7f1089c4bd0fb6687d561bee2d0c78019259738b106278b354eeb729a3abd60f";
  };
