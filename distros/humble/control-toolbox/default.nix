...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/control_toolbox-release/archive/release/humble/control_toolbox/3.0.0-1.tar.gz";
    name = "3.0.0-1.tar.gz";
    sha256 = "074ed26a34080066411fffc58617f092085ca1521fd37ae76ae89cb0bfb0a7ed";
  };
