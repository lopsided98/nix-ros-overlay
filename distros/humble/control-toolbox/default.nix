...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/control_toolbox-release/archive/release/humble/control_toolbox/3.6.3-1.tar.gz";
    name = "3.6.3-1.tar.gz";
    sha256 = "05c22d43fa5efa5cff69863a027dfbabe383aa4a6846e0492bb1d961a13dcb3b";
  };
