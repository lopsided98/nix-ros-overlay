...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libslam/2.15.15-1.tar.gz";
    name = "2.15.15-1.tar.gz";
    sha256 = "22cdb9759d1a6178df8756e884ce49212977b8800ca6f9be8dad75362aa97457";
  };
