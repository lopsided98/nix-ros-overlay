...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libslam/2.15.21-2.tar.gz";
    name = "2.15.21-2.tar.gz";
    sha256 = "87e04a04379abbeca32cea23f69980d686a08ca884345b924997d2036094fb35";
  };
