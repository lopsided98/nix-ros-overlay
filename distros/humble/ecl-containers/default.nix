...
buildRosPackage {
  pname = "ros-humble-ecl-containers";
  version = "1.2.1-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/humble/ecl_containers/1.2.1-1.tar.gz";
    name = "1.2.1-1.tar.gz";
    sha256 = "360d5a24188e1c96f739e895836004673828812836df4292922bfae8813b8bc9";
  };
