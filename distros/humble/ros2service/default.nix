...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2service/0.18.4-1.tar.gz";
    name = "0.18.4-1.tar.gz";
    sha256 = "9777f6c67ab66330f2979eed4f83dbaa37fd82a9e426674d384d8b361638d583";
  };
