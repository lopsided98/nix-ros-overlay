...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2service/0.18.19-1.tar.gz";
    name = "0.18.19-1.tar.gz";
    sha256 = "f24c0a3f437c32f1175b85a317fc7ece8c7bfa422b0d258b38a364473b0a56d0";
  };
