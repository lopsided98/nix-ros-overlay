...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2service/0.18.20-1.tar.gz";
    name = "0.18.20-1.tar.gz";
    sha256 = "b5cd6bfeb6bf259cc3c6741523daa8e4704279d56b803f165e58cf0f7be15ed4";
  };
