...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2service/0.18.18-1.tar.gz";
    name = "0.18.18-1.tar.gz";
    sha256 = "b978a7ecdc9f41b1b150c37288b9134cf138f25a946ff2653b05ea1f5c0045f7";
  };
