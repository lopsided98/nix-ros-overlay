...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2service/0.18.7-1.tar.gz";
    name = "0.18.7-1.tar.gz";
    sha256 = "4ecdf5130b7f2805b6f5efb7403a1098fb5bd0f8b143346a04dffed2070e8223";
  };
