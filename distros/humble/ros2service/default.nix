...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2service/0.18.15-1.tar.gz";
    name = "0.18.15-1.tar.gz";
    sha256 = "97bc7f06f925c8cd49e4cb411e1001efd08ba55a5eb684543be371095314e4f7";
  };
