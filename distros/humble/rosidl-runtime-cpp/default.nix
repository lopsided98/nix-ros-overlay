...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/humble/rosidl_runtime_cpp/3.1.7-1.tar.gz";
    name = "3.1.7-1.tar.gz";
    sha256 = "9350a9e5241a4803ce0945d854803c0342233513370b66abae49862b51e55ceb";
  };
