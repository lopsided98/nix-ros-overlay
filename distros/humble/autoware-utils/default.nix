...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/humble/autoware_utils/1.5.0-2.tar.gz";
    name = "1.5.0-2.tar.gz";
    sha256 = "2950878e2c35b7c16a2546708fdc3626dbfcfb3407e73233deaaf3497e0f45ee";
  };
