...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mp2p_icp-release/archive/release/humble/mp2p_icp/2.9.1-1.tar.gz";
    name = "2.9.1-1.tar.gz";
    sha256 = "48d04ee8d6845ee9bcc33f6bf3dc7fce7b9b110d8bc60d76bedd2a3ab0115f91";
  };
