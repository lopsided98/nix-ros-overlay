...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mp2p_icp-release/archive/release/humble/mp2p_icp/2.7.0-1.tar.gz";
    name = "2.7.0-1.tar.gz";
    sha256 = "a5bc5aa1e70b187c9e2352d046ea278028bf44769c75d4df46700f9cbe339493";
  };
