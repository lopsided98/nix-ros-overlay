...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/manankharwar/fusioncore-release/archive/release/humble/fusioncore_core/0.3.5-1.tar.gz";
    name = "0.3.5-1.tar.gz";
    sha256 = "cb6676154f20a8547e92afd34a5b0bcd39d0c561e7c1702ce4b2dca50714d59a";
  };
