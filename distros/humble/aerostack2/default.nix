...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/aerostack2-release/archive/release/humble/aerostack2/1.1.3-1.tar.gz";
    name = "1.1.3-1.tar.gz";
    sha256 = "883e54bde3e66c0c360507b32e7d9cc99c14623fc1378fa06507241e126f37a9";
  };
