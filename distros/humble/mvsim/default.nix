...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mvsim-release/archive/release/humble/mvsim/0.13.2-1.tar.gz";
    name = "0.13.2-1.tar.gz";
    sha256 = "a4d331d0a1005a6f8d357ecc87f3fcfe065540267b93dcb6187c1b833ef1738c";
  };
