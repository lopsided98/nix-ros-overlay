...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mvsim-release/archive/release/humble/mvsim/0.9.3-1.tar.gz";
    name = "0.9.3-1.tar.gz";
    sha256 = "267e35d0f832e173c73898ef5a2f9593eeec689af0a85ed9c55f4662660e4143";
  };
