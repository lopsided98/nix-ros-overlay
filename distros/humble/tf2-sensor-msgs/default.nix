...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_sensor_msgs/0.25.11-1.tar.gz";
    name = "0.25.11-1.tar.gz";
    sha256 = "a9f36757d269d811a219b37d6c97dc325cdee088eb2b01d6c309b5e0f31248ee";
  };
