...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_sensor_msgs/0.25.17-1.tar.gz";
    name = "0.25.17-1.tar.gz";
    sha256 = "a3dca9ee0cad6f368d6ae6ed94b1bea6bd1a8f4286890f9cb72aa3fffadae936";
  };
