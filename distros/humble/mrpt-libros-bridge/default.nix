...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros_bridge-release/archive/release/humble/mrpt_libros_bridge/3.5.3-1.tar.gz";
    name = "3.5.3-1.tar.gz";
    sha256 = "b825747d43da87d6e2f5683a3a51ef8768f2a452fd2de95d5f4587f23e9bcfd0";
  };
