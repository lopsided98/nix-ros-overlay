...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/humble/swri_geometry_util/3.8.7-1.tar.gz";
    name = "3.8.7-1.tar.gz";
    sha256 = "987f2e7cc83a62d7e25540285a22476c98c4e718612a4fc7ff768b76805f20b1";
  };
