...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libposes/2.15.21-2.tar.gz";
    name = "2.15.21-2.tar.gz";
    sha256 = "201d2b1b3f8dc0014d82413738216eef82e967a04201ce6ba81f6e5e663b28f2";
  };
