...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libposes/2.15.15-1.tar.gz";
    name = "2.15.15-1.tar.gz";
    sha256 = "7fd6bb3f695dc5c86008c0eae94f81b7ae634483e0b8175cff5e89d2cdae3679";
  };
