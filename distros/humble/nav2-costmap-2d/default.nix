...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_costmap_2d/1.1.20-1.tar.gz";
    name = "1.1.20-1.tar.gz";
    sha256 = "20a5d7cb7380d7ef2ee5c5e2377894e576aba25b44523aa652314c34de50015b";
  };
