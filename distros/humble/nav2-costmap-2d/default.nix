...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_costmap_2d/1.1.15-1.tar.gz";
    name = "1.1.15-1.tar.gz";
    sha256 = "262283d9e6c0db1f4b7baedb12904fb9a0166ea504e87b27afa7b3fe47befb91";
  };
