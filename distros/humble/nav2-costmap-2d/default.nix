...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_costmap_2d/1.1.6-1.tar.gz";
    name = "1.1.6-1.tar.gz";
    sha256 = "b01166822655ba70616faa553d209b6b60dd4ef210e7517202b1fc8b138ea214";
  };
