...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/pose_cov_ops-release/archive/release/humble/pose_cov_ops/0.4.0-1.tar.gz";
    name = "0.4.0-1.tar.gz";
    sha256 = "a0f196a6e40f74173df7b718921157fa0a84b8ac9d62ce1f875119fab86eea80";
  };
