...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_amcl/1.1.20-1.tar.gz";
    name = "1.1.20-1.tar.gz";
    sha256 = "edcf7de833acd052f6cf4ae3cb702459437be5886f9b2fc3fb169587c0f1e38a";
  };
