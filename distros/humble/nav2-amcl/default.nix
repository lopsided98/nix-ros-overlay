...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_amcl/1.1.15-1.tar.gz";
    name = "1.1.15-1.tar.gz";
    sha256 = "197b988095ab880682d1df7db2d26d2769e1960c6f5e9642a48c86af626aa241";
  };
