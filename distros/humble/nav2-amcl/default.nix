...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_amcl/1.1.6-1.tar.gz";
    name = "1.1.6-1.tar.gz";
    sha256 = "46cb61a342c8405b45455a33491a21771782982afeb1dd979ea6cf4fb6d750ee";
  };
