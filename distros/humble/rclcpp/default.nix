...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp/16.0.13-1.tar.gz";
    name = "16.0.13-1.tar.gz";
    sha256 = "fc7aa76f5cbeb3c9bd5e59974ce915693aaabc9a945aec1964ce6aa62e9ca367";
  };
