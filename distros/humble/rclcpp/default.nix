...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp/16.0.8-1.tar.gz";
    name = "16.0.8-1.tar.gz";
    sha256 = "189493e6932bad7c9d00332eed9548a3984c07233edf0c0262847cdcbf9044ee";
  };
