...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp/16.0.19-1.tar.gz";
    name = "16.0.19-1.tar.gz";
    sha256 = "8989943bcf8b40fe449130c36af451c16ebad0f5137cf29b28fbb9fe09b1c083";
  };
