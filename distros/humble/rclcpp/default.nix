...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp/16.0.3-1.tar.gz";
    name = "16.0.3-1.tar.gz";
    sha256 = "0072f0eb073e0d83a3d944145cd463abf5bef9107bedd6d478e1e608d1e44928";
  };
