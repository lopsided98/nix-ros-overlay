...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp/16.0.18-1.tar.gz";
    name = "16.0.18-1.tar.gz";
    sha256 = "25e4472aae4aab09de8910f12f737aefd82c5f56a02c6cea965bed2e2b24623d";
  };
