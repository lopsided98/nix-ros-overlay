...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp/16.0.20-1.tar.gz";
    name = "16.0.20-1.tar.gz";
    sha256 = "95c4ea0d527ab376ab85be9c582a903e41a90dad2399d859257e4f0151688aee";
  };
