...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp/16.0.21-1.tar.gz";
    name = "16.0.21-1.tar.gz";
    sha256 = "9f60801d54c65220325cd9c8b2940160a8870e3711848f452d3ac9d4a86e5141";
  };
