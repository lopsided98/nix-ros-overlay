...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/humble/ament_cmake_auto/1.3.14-1.tar.gz";
    name = "1.3.14-1.tar.gz";
    sha256 = "b6923ef9cd2ec729c4c16cea6e88bb75e45604fe0b476a14031d1c74cb130b86";
  };
