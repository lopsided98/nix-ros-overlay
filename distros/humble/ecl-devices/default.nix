...
buildRosPackage {
  pname = "ros-humble-ecl-devices";
  version = "1.2.1-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/humble/ecl_devices/1.2.1-1.tar.gz";
    name = "1.2.1-1.tar.gz";
    sha256 = "c83ff6c570c1bbf012615d184e15fa0c2c4239570750366f848fec1c2fc410f0";
  };
