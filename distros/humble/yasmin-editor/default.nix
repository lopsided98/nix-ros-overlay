...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/humble/yasmin_editor/6.1.1-1.tar.gz";
    name = "6.1.1-1.tar.gz";
    sha256 = "8dc0704e109bd8b03c44745445a5a95346df4fd6555caffc857e72c810815fd5";
  };
