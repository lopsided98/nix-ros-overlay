...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/apriltag_ros-release/archive/release/humble/apriltag_ros/3.2.1-1.tar.gz";
    name = "3.2.1-1.tar.gz";
    sha256 = "62be0dbe567e230ab462e89d54ef640c77083b214d7c4b4969150a70fe2aaa9b";
  };
