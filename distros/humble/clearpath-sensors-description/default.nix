...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/humble/clearpath_sensors_description/1.3.4-1.tar.gz";
    name = "1.3.4-1.tar.gz";
    sha256 = "6c4ed0af36b59373a637bca9f3776d23c0105c10c652994babd3fa7a4be6cb03";
  };
