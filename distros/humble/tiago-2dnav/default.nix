...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/pal-gbp/tiago_navigation-release/archive/release/humble/tiago_2dnav/4.0.17-1.tar.gz";
    name = "4.0.17-1.tar.gz";
    sha256 = "3db8bb441da24280563c5008cb3f388b00b9018482f0113f0cb071036f00f48a";
  };
