...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/humble/yasmin_ros/3.4.0-1.tar.gz";
    name = "3.4.0-1.tar.gz";
    sha256 = "45bf005ede7087c65422c12e6ef0d31ecceff4e97d4a2e9b91ae1a88875105e4";
  };
