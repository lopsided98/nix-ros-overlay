...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rig_reconfigure-release/archive/release/humble/rig_reconfigure/1.6.0-1.tar.gz";
    name = "1.6.0-1.tar.gz";
    sha256 = "317a30ce7bf9bb07cc38be66a4fe3e612b78b45fe44e0a31f53b2c82797c8ce4";
  };
