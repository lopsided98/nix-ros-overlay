...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libmaps/2.15.15-1.tar.gz";
    name = "2.15.15-1.tar.gz";
    sha256 = "b56e88e62e4aef83b9f4409ac6f6888267e43470ca8590d038724f4f43b7a700";
  };
