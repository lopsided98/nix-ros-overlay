...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/humble/autoware_utils_visualization/1.7.2-2.tar.gz";
    name = "1.7.2-2.tar.gz";
    sha256 = "cff9885f71147d89d4ac8518091db66a04cc0b148bf28f46da719358f0aac774";
  };
