...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/septentrio_gnss_driver_ros2-release/archive/release/humble/septentrio_gnss_driver/1.4.4-1.tar.gz";
    name = "1.4.4-1.tar.gz";
    sha256 = "21d8b0b04177bf4aba50b040c8a7899765d5eff429bb4b4ba9eaed32a3f8b1ce";
  };
