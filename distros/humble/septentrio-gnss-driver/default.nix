...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/septentrio_gnss_driver_ros2-release/archive/release/humble/septentrio_gnss_driver/1.4.5-1.tar.gz";
    name = "1.4.5-1.tar.gz";
    sha256 = "b34b48aa46f28d2f9fe51f2dcc680b109f398c5d3bb35d862f23478e5e630fb6";
  };
