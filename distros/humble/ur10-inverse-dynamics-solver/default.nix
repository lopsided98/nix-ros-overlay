...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/inverse_dynamics_solver-release/archive/release/humble/ur10_inverse_dynamics_solver/1.0.3-1.tar.gz";
    name = "1.0.3-1.tar.gz";
    sha256 = "8bd4764f11cb7e997f87793390a7f3d2d074d8248c2f93bedd6bf40d5742849f";
  };
