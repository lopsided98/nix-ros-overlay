...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/mecanum_drive_controller/2.48.0-1.tar.gz";
    name = "2.48.0-1.tar.gz";
    sha256 = "0b214022fc04ea975cbc13dfaebdd64e3d8a452103611aa6e92bad11cc3e6f18";
  };
