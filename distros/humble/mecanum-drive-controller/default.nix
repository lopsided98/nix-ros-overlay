...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/mecanum_drive_controller/2.47.0-1.tar.gz";
    name = "2.47.0-1.tar.gz";
    sha256 = "fc7e9144f5ebf433995b39591c9ea7d54969ff8a932ef16975e1ae93f15c7313";
  };
