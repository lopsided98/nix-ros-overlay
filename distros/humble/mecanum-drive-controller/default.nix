...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/mecanum_drive_controller/2.52.1-1.tar.gz";
    name = "2.52.1-1.tar.gz";
    sha256 = "809bdbbf66acc06cc6d5c3c2c30d4db8fe10d9432423c9fda3edd1ce6ca3ceec";
  };
