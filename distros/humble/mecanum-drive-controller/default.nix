...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/mecanum_drive_controller/2.52.0-1.tar.gz";
    name = "2.52.0-1.tar.gz";
    sha256 = "efeeeaca26f78909e42b7556d87d50a7e2269d293908ec636fb14b7233870478";
  };
