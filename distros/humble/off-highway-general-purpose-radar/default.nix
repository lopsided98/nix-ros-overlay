...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/off_highway_sensor_drivers-release/archive/release/humble/off_highway_general_purpose_radar/0.6.2-1.tar.gz";
    name = "0.6.2-1.tar.gz";
    sha256 = "88083b0af0a534295effbc8e052c0f153d13cca26372438f4569191ce939b8c7";
  };
