...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/off_highway_sensor_drivers-release/archive/release/humble/off_highway_general_purpose_radar/0.12.0-1.tar.gz";
    name = "0.12.0-1.tar.gz";
    sha256 = "9053aa5cac5899709ef894a3af5a0eb1bdd35a196de7bca02e342825cbab5eed";
  };
