...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/off_highway_sensor_drivers-release/archive/release/humble/off_highway_general_purpose_radar/0.6.0-2.tar.gz";
    name = "0.6.0-2.tar.gz";
    sha256 = "144d4c0993ed69f0287ff6be3e3b26b8f7f3d02c0a84d3818bbeaf8a63dde3d7";
  };
