...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_ros/2.5.8-1.tar.gz";
    name = "2.5.8-1.tar.gz";
    sha256 = "bf27047a227047332648dedc4f5731b8bf71bff313978e646f58b162074de682";
  };
