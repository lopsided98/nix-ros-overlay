...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_lifecycle_manager/1.1.15-1.tar.gz";
    name = "1.1.15-1.tar.gz";
    sha256 = "af949d1338de3817f90dd4f7819fdf6af905a9075f4a769b8665da4553f9f561";
  };
