...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_lifecycle_manager/1.1.20-1.tar.gz";
    name = "1.1.20-1.tar.gz";
    sha256 = "20dd83d82ffbd6647aad31062e46d3c4c08a62888845713fc91a6045282c8da3";
  };
