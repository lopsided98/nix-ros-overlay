...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_ros_robot_interaction/2.5.9-1.tar.gz";
    name = "2.5.9-1.tar.gz";
    sha256 = "0f9f17a10bf0140892b743a08f4457a1d18480f95dc50061570bceec545aa002";
  };
