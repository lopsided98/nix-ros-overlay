...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_ros_robot_interaction/2.5.10-1.tar.gz";
    name = "2.5.10-1.tar.gz";
    sha256 = "9fe868c5a52f51fa2a9c3055cfceb999c29502709baf5bf164474b408d76254f";
  };
