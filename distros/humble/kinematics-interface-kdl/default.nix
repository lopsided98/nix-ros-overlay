...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/kinematics_interface-release/archive/release/humble/kinematics_interface_kdl/0.4.2-1.tar.gz";
    name = "0.4.2-1.tar.gz";
    sha256 = "1ba4a7d72043cddeb9cb239fa47dd8061276f33a003ca133a73ec5c8f53f6c8a";
  };
