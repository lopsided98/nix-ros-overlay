...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/omni_base_robot-release/archive/release/humble/omni_base_controller_configuration/2.18.0-1.tar.gz";
    name = "2.18.0-1.tar.gz";
    sha256 = "f189e4af2a89d16f825bbe6531a220f14d388e86c54cba8452a542efa802d194";
  };
