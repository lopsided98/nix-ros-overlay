...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_state_estimation-release/archive/release/humble/mola_state_estimation_smoother/2.0.1-1.tar.gz";
    name = "2.0.1-1.tar.gz";
    sha256 = "38e3efae20f32223ab31e33315b7435e16a6bc64e68b779c7a28a00c8b600fd7";
  };
