...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_state_estimation-release/archive/release/humble/mola_state_estimation_smoother/1.8.1-1.tar.gz";
    name = "1.8.1-1.tar.gz";
    sha256 = "647fe0b5a2a377ebedb391ab3f950676ab3caee772ebf864b2e266da152ec362";
  };
