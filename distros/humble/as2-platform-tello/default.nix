...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/aerostack2-release/archive/release/humble/as2_platform_tello/1.0.0-1.tar.gz";
    name = "1.0.0-1.tar.gz";
    sha256 = "87160b6806b47e93f971be1f1a51be37c3832c8a3c15635c7c0a56443c956195";
  };
