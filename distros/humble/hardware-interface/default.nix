...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/humble/hardware_interface/2.54.2-1.tar.gz";
    name = "2.54.2-1.tar.gz";
    sha256 = "683d526438bacceb8ccde438c74eb0c022400d60c334599c119761d21dd821c2";
  };
