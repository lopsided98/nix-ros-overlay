...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/joint_state_broadcaster/2.14.0-1.tar.gz";
    name = "2.14.0-1.tar.gz";
    sha256 = "6ecf5584f1854ef53aba154650f571895449c6227670de1e868f24c8bd9a1159";
  };
