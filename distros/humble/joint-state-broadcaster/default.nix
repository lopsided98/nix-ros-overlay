...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/joint_state_broadcaster/2.35.0-1.tar.gz";
    name = "2.35.0-1.tar.gz";
    sha256 = "fc26cec633904a5aa37c1553a813cc404c93741f84db438d56c3ca2622c411e9";
  };
