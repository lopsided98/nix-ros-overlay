...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_bridge_ros2/1.0.5-1.tar.gz";
    name = "1.0.5-1.tar.gz";
    sha256 = "8e3a8cab7d1b68e2687c9fb36cd8a86506d38ecaa2a94c29bb7dcab58321944c";
  };
