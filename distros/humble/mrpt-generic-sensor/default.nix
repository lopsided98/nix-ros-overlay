...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/humble/mrpt_generic_sensor/0.2.0-1.tar.gz";
    name = "0.2.0-1.tar.gz";
    sha256 = "52994ffdc3aa39ccfe5a8dcb55e030226de916435139dbf2ca01e23d03af5bdf";
  };
