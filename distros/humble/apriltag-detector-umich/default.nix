...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/apriltag_detector-release/archive/release/humble/apriltag_detector_umich/3.0.3-1.tar.gz";
    name = "3.0.3-1.tar.gz";
    sha256 = "2dc55958073d10a50812e55b8306d04df495b89e8624687b51907db85e070634";
  };
