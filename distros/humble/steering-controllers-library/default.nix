...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/steering_controllers_library/2.37.0-1.tar.gz";
    name = "2.37.0-1.tar.gz";
    sha256 = "75cf1bfff568450c37ef733cd4f7fefec04e81f0f7fa402cd0ae67f994221e87";
  };
