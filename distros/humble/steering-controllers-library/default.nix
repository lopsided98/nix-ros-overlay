...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/steering_controllers_library/2.47.0-1.tar.gz";
    name = "2.47.0-1.tar.gz";
    sha256 = "2c1cf485dd7460cdbd2c0e700f670f0179f78ecbbf89abc03e49e4fccb27ed51";
  };
