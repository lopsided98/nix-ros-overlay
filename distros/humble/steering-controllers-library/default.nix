...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/steering_controllers_library/2.46.0-1.tar.gz";
    name = "2.46.0-1.tar.gz";
    sha256 = "aee79ae67abaad55de179e2c59779306be57e765e95efd1797f7d677500e64ec";
  };
