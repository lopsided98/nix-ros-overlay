...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/steering_controllers_library/2.31.0-1.tar.gz";
    name = "2.31.0-1.tar.gz";
    sha256 = "14116da237a863bb8262ebb47fc732c065a381ead47541b61858790f1a8e3610";
  };
