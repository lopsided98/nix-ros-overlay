...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/forward_command_controller/2.51.0-1.tar.gz";
    name = "2.51.0-1.tar.gz";
    sha256 = "2dffbdecadcbddb18c56c419253c7f8914961f54c74168b729093adf1600b434";
  };
