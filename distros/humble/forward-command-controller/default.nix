...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/forward_command_controller/2.14.0-1.tar.gz";
    name = "2.14.0-1.tar.gz";
    sha256 = "78c43176acac43d9a182ba8def1c3a3ab28e552a0f9732430d207e712c64d037";
  };
