...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/forward_command_controller/2.52.0-1.tar.gz";
    name = "2.52.0-1.tar.gz";
    sha256 = "deb27df1ac507404a025a1d18942f21c87b1ab094c3e2ae5fc3566efc887bbea";
  };
