...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/manankharwar/fusioncore-release/archive/release/humble/fusioncore_ros/0.3.8-1.tar.gz";
    name = "0.3.8-1.tar.gz";
    sha256 = "fb15b1866bba34a16a374af0eb7376e3d91374c325a8364ac5bcf2f63cb61ff9";
  };
