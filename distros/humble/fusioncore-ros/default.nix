...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/manankharwar/fusioncore-release/archive/release/humble/fusioncore_ros/0.3.7-1.tar.gz";
    name = "0.3.7-1.tar.gz";
    sha256 = "bda73a2d9b38233b3112e3dc9575cbf047b4cbefd1cc4fb970f5b0d07f3c7424";
  };
