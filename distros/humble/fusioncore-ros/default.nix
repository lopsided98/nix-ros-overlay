...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/manankharwar/fusioncore-release/archive/release/humble/fusioncore_ros/0.4.0-1.tar.gz";
    name = "0.4.0-1.tar.gz";
    sha256 = "f447e03c27c2bccdcd3d635640a3887bd22bd046d6e03b55f388bd7d6633793f";
  };
