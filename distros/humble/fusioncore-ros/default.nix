...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/manankharwar/fusioncore-release/archive/release/humble/fusioncore_ros/0.3.9-1.tar.gz";
    name = "0.3.9-1.tar.gz";
    sha256 = "16826726f5f54fec363e4361acbd3bd752c6036ae0ceea90c50d93b5c2a7709d";
  };
