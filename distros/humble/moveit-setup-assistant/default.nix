...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_setup_assistant/2.5.10-1.tar.gz";
    name = "2.5.10-1.tar.gz";
    sha256 = "e058416241e2bc0013b7620e68f8471c600172b212462fc72211b6b5f081f359";
  };
