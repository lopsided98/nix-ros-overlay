...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_cmake-release/archive/release/humble/autoware_lint_common/1.1.0-1.tar.gz";
    name = "1.1.0-1.tar.gz";
    sha256 = "fa6b2ee52b186704e60c6cee996237e6469e968811dfce3c9bd4952e8ae89658";
  };
