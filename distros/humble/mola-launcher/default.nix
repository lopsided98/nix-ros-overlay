...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_launcher/1.0.4-1.tar.gz";
    name = "1.0.4-1.tar.gz";
    sha256 = "e50e565df3e148ab8b2fed9a799031ca69a0ae00c8e73ec8a384d87dac148251";
  };
