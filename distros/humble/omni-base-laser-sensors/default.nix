...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/omni_base_navigation-release/archive/release/humble/omni_base_laser_sensors/2.24.2-1.tar.gz";
    name = "2.24.2-1.tar.gz";
    sha256 = "9c2377c06ec29040dd93ebaa502bf39077c7936846846595c341e4b747bed576";
  };
