...
buildRosPackage {
  pname = "ros-humble-eventdispatch-ros2";
  version = "0.2.29-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_eventdispatch-release/archive/release/humble/eventdispatch_ros2/0.2.29-1.tar.gz";
    name = "0.2.29-1.tar.gz";
    sha256 = "8169890ad5442736ab8fc7e958ab36741fe44ec87cd145515b224af6e33d447d";
  };
