...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_core-release/archive/release/humble/autoware_core_planning/1.8.0-3.tar.gz";
    name = "1.8.0-3.tar.gz";
    sha256 = "be74f88c37e149ca9083e08d2a902edc8ea698fc01a154f21458592b7c0f2282";
  };
