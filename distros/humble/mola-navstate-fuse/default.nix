...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_navstate_fuse/1.0.5-1.tar.gz";
    name = "1.0.5-1.tar.gz";
    sha256 = "d1dcb7bacd26c719e2424d0295c396958eb55d7fe2e135d50fdb058b4f66c988";
  };
