...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2action/0.18.5-1.tar.gz";
    name = "0.18.5-1.tar.gz";
    sha256 = "37632780f668e395a9e82889de3af0b8b98ed8b707eb7356de60dc8f467135d7";
  };
