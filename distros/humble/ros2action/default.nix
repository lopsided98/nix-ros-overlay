...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2action/0.18.15-1.tar.gz";
    name = "0.18.15-1.tar.gz";
    sha256 = "3140b34fcf3ffd3fd4977268b974d4e7371de3c3c548718e90806b8d2ecd8464";
  };
