...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2action/0.18.17-1.tar.gz";
    name = "0.18.17-1.tar.gz";
    sha256 = "531612917541c5269b96bd36c169a054c26849a394d4be3e92c837dcec9f7bd7";
  };
