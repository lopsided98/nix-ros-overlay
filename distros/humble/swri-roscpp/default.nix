...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/humble/swri_roscpp/3.8.4-1.tar.gz";
    name = "3.8.4-1.tar.gz";
    sha256 = "c44867ba4386f30d773f7eb71d6df8f344df85a54d59c626b2e42f0eff78b27b";
  };
