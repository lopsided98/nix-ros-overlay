...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_mppi_controller/1.1.15-1.tar.gz";
    name = "1.1.15-1.tar.gz";
    sha256 = "5f48205f1fa175a013bb694763a57a19ea1d70fd1e2ae826d51d672215ec2d3e";
  };
