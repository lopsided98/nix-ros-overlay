...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_mppi_controller/1.1.20-1.tar.gz";
    name = "1.1.20-1.tar.gz";
    sha256 = "7e97b8d22fd666b23fec510dbf106ea1d4f727fb19042a885ad7f55ee37953e5";
  };
