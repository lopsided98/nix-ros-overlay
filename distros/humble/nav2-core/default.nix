...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_core/1.1.6-1.tar.gz";
    name = "1.1.6-1.tar.gz";
    sha256 = "bc64b38c8ce0a63c7005454832d05ec9e677740f8494497204ab3d3bca1fc4ff";
  };
