...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_core/1.1.20-1.tar.gz";
    name = "1.1.20-1.tar.gz";
    sha256 = "88ee3b95d16dfee32f17fab1b35a00c86844b21c16b8f3dbedb125519cfc44b6";
  };
