...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/qt_gui_core-release/archive/release/humble/qt_gui_cpp/2.2.5-1.tar.gz";
    name = "2.2.5-1.tar.gz";
    sha256 = "bedd8ebd50fc723e23cc8dd632d61a854d1ad3620e6750ed3e0eb38b44a1fb73";
  };
