...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_python-release/archive/release/humble/rosidl_generator_py/0.14.6-1.tar.gz";
    name = "0.14.6-1.tar.gz";
    sha256 = "0df23093f6e4fa3c388ee25a594fbebb88d164f90b7abf3d061dba8d08cf3e2c";
  };
