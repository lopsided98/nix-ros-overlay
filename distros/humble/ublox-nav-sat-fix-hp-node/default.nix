...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/humble/ublox_nav_sat_fix_hp_node/0.7.1-1.tar.gz";
    name = "0.7.1-1.tar.gz";
    sha256 = "12d5f81137a44887789970a8d13f2f9dd006e505e340f9b1b9c199edf3809868";
  };
