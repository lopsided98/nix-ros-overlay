...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/humble/ublox_nav_sat_fix_hp_node/0.7.2-1.tar.gz";
    name = "0.7.2-1.tar.gz";
    sha256 = "23d6f1f9643f09e20371c71f379ed35d415478eda447d396268499160e875d35";
  };
