...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/humble/ament_cmake_gtest/1.3.14-1.tar.gz";
    name = "1.3.14-1.tar.gz";
    sha256 = "1e48a5f4bcb6bedecbceafbd93b84331dd7ee5ffa7353f91128e8beaf90b2c77";
  };
