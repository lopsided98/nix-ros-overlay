...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/tuw-robotics/tuw_msgs-release/archive/release/humble/tuw_geometry_msgs/0.2.6-1.tar.gz";
    name = "0.2.6-1.tar.gz";
    sha256 = "83812f1246ea160ab2c172e00de15d01252d0a445d80de34889fd5bc4f1afd1f";
  };
