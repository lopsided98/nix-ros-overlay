...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/humble/multires_image/2.5.8-1.tar.gz";
    name = "2.5.8-1.tar.gz";
    sha256 = "216eab254bc013d0bbd06ba3af68d80850ae77910a94e2a1e698a3caf200315d";
  };
