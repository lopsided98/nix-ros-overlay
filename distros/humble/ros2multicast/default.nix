...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2multicast/0.18.18-1.tar.gz";
    name = "0.18.18-1.tar.gz";
    sha256 = "37b05be05a0bc928d3e05a24125be4dee76bbb0962b63ae4d016f4ad78c4f5f3";
  };
