...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2multicast/0.18.20-1.tar.gz";
    name = "0.18.20-1.tar.gz";
    sha256 = "5dbab2a4c86b09635ecdb4685b873515082f290c44c77727e2563a800ccd4c07";
  };
