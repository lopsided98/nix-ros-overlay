...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2multicast/0.18.17-1.tar.gz";
    name = "0.18.17-1.tar.gz";
    sha256 = "db0a59ea2c0c036996a1157ff572a3fbadc297b1d2923af39f9502304c386643";
  };
