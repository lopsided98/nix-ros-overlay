...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2multicast/0.18.7-1.tar.gz";
    name = "0.18.7-1.tar.gz";
    sha256 = "09c856a9c9b0b369cf5265ded068d23815d9c968d3daa4e2b9c785bf32e95ee2";
  };
