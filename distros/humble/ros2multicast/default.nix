...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2multicast/0.18.4-1.tar.gz";
    name = "0.18.4-1.tar.gz";
    sha256 = "55eb9b77618af35ca205c3d9244fc479561ffd6ff31303a1cbc9626e56f184a0";
  };
