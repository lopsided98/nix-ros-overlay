...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2multicast/0.18.5-1.tar.gz";
    name = "0.18.5-1.tar.gz";
    sha256 = "795ca5605916d61535b61516e3c2a041fda83e09a85701902167f0b0313799ea";
  };
