...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2multicast/0.18.16-1.tar.gz";
    name = "0.18.16-1.tar.gz";
    sha256 = "ecfa4026eca2d99bb0dc40abb4b0ce2287f7fa9905c8087d0b39fc213e091e1c";
  };
