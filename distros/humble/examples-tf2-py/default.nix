...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/examples_tf2_py/0.25.21-1.tar.gz";
    name = "0.25.21-1.tar.gz";
    sha256 = "a8f18c04c573a044d692ca286286af2d2248aa4e45dff397b649b96a93246b45";
  };
