...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/humble/swri_cli_tools/3.11.0-1.tar.gz";
    name = "3.11.0-1.tar.gz";
    sha256 = "e2c09ea414a2e73e54babf7334e0f0c088d7ca92f92a0110b0b1a89077ab3bcb";
  };
