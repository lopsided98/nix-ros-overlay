...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/humble/swri_cli_tools/3.8.7-1.tar.gz";
    name = "3.8.7-1.tar.gz";
    sha256 = "204547304c237fa1d8b77d9e725fa496a6e0bde4416f64ad0e75d40da162723d";
  };
