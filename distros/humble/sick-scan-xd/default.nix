...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/sick_scan_xd-release/archive/release/humble/sick_scan_xd/3.7.0-7.tar.gz";
    name = "3.7.0-7.tar.gz";
    sha256 = "baa57474ed6fb7914841828b9ad8eedae4871cac177d754dfa76877917794262";
  };
