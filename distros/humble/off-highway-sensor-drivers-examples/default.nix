...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/off_highway_sensor_drivers-release/archive/release/humble/off_highway_sensor_drivers_examples/0.6.2-1.tar.gz";
    name = "0.6.2-1.tar.gz";
    sha256 = "e19c361499366e8a44c2e84694daa06f28cc170f8dfe25f6a1efb9c5f29be6c0";
  };
