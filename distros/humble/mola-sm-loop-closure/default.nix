...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_sm_loop_closure-release/archive/release/humble/mola_sm_loop_closure/1.2.2-1.tar.gz";
    name = "1.2.2-1.tar.gz";
    sha256 = "e8008665c5a7abde219fb5f0093d34ef6140617da9ca0ba85ffdab12b40af81a";
  };
