...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_ros_visualization/2.5.10-1.tar.gz";
    name = "2.5.10-1.tar.gz";
    sha256 = "ebd31f504ffe4d16b2602654b983160008b7c30edb07333ece50a6d3b4430705";
  };
