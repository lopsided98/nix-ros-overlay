...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/humble/swri_transform_util/3.8.7-1.tar.gz";
    name = "3.8.7-1.tar.gz";
    sha256 = "8829c271246b40675734c0584109527e033f09b198b37a2385c811558f682fea";
  };
