...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/humble/swri_transform_util/3.7.6-1.tar.gz";
    name = "3.7.6-1.tar.gz";
    sha256 = "dce5ae1a0bf7ac399142a4adc21d82b70104ef875a0caf006df504ed776883ed";
  };
