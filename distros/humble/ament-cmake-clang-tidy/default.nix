...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_cmake_clang_tidy/0.12.15-1.tar.gz";
    name = "0.12.15-1.tar.gz";
    sha256 = "12f146db14ba03f663f630fe75b3df1daf3dab194df89d3da89239b22725d495";
  };
