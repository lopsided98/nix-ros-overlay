...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/humble/yasmin/4.2.3-1.tar.gz";
    name = "4.2.3-1.tar.gz";
    sha256 = "dcfdef2529eaecfd0ae4691d3954ed8b126a3d90e07089bb6c52d592a37799fb";
  };
