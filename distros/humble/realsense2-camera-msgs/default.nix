...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/realsense-ros-release/archive/release/humble/realsense2_camera_msgs/4.57.7-1.tar.gz";
    name = "4.57.7-1.tar.gz";
    sha256 = "76ec15415c9dba30db29fe4a4b0f3e0a66d5cbcae7388085c6eaed64fa4ebadc";
  };
