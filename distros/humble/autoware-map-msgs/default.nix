...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_msgs-release/archive/release/humble/autoware_map_msgs/1.11.0-1.tar.gz";
    name = "1.11.0-1.tar.gz";
    sha256 = "cb8413f519b2fc3ad5b786112d38e298f52f76b5dbdd518bb8caa768fe7d7dcf";
  };
