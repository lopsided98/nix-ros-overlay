...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/aruco_opencv-release/archive/release/humble/aruco_opencv/2.4.2-1.tar.gz";
    name = "2.4.2-1.tar.gz";
    sha256 = "6f787938ca6e6c6ef88fc9a88056355c0bdc4eddb7c6c43cdb2fc5a17138e948";
  };
