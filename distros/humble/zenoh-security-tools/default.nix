...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_zenoh-release/archive/release/humble/zenoh_security_tools/0.1.8-1.tar.gz";
    name = "0.1.8-1.tar.gz";
    sha256 = "469264e68e1b7ff6802644e1f30ff02ba89bd4cd3758213b621a120b297d44ed";
  };
