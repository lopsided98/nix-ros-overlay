...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_zenoh-release/archive/release/humble/zenoh_security_tools/0.1.4-1.tar.gz";
    name = "0.1.4-1.tar.gz";
    sha256 = "32f4ad96fee4879ceea5dec1d6db6f01ff72176640704e01ca3799357d2eac15";
  };
