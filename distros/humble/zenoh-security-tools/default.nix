...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_zenoh-release/archive/release/humble/zenoh_security_tools/0.1.10-1.tar.gz";
    name = "0.1.10-1.tar.gz";
    sha256 = "3b655ae79fd13ad8ca6330d4c133d6c2664577b59bd96a30c647196996e344fc";
  };
