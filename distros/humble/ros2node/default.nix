...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2node/0.18.18-1.tar.gz";
    name = "0.18.18-1.tar.gz";
    sha256 = "904885e686b5ac35dc74b5c1bc8e723dbabcc6502e9c7b1eeee286c79dedc95b";
  };
