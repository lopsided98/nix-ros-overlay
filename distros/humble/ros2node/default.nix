...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2node/0.18.15-1.tar.gz";
    name = "0.18.15-1.tar.gz";
    sha256 = "c112e0bfdb3ecd0bc502b0f4d44aff0f95141591e05027e286890fae21398664";
  };
