...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2node/0.18.20-1.tar.gz";
    name = "0.18.20-1.tar.gz";
    sha256 = "861927760c26c8707d1857267a37a3d7233f64be118f824d39b24b60deddd121";
  };
