...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2node/0.18.4-1.tar.gz";
    name = "0.18.4-1.tar.gz";
    sha256 = "d8e2375d98e35fa45ce39a963edfe0c7dc976ddc98eb3b5ab2311173067ce156";
  };
