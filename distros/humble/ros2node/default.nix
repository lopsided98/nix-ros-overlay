...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2node/0.18.5-1.tar.gz";
    name = "0.18.5-1.tar.gz";
    sha256 = "bb59a996e90e90cc36744a2f9672dcbd61af9b3f38f29f8b916ef33c3bdd873c";
  };
