...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mujoco_ros2_control-release/archive/release/humble/mujoco_ros2_control_demos/0.1.2-1.tar.gz";
    name = "0.1.2-1.tar.gz";
    sha256 = "91c57a52783b6d07e8ed232b0af970992d2a2fdbb0010dcb63abda3164baa95d";
  };
