...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_viz_imgui/3.0.0-1.tar.gz";
    name = "3.0.0-1.tar.gz";
    sha256 = "124099f3cf14f1981a70f9449b7bc3d5253f739796a72a3c8a09840846c9723b";
  };
