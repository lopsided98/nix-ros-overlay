...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/pose_broadcaster/2.47.0-1.tar.gz";
    name = "2.47.0-1.tar.gz";
    sha256 = "8af2b72ff09d3b43b52f62da5f1423e1e386816c94087fcf60fb537beff1d3c6";
  };
