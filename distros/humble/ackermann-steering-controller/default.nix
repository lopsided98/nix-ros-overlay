...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/ackermann_steering_controller/2.52.0-1.tar.gz";
    name = "2.52.0-1.tar.gz";
    sha256 = "627b4c436c31538c07cd4425da8d4baf574c4ce31bfe8a23c702a900eb7b4b0a";
  };
