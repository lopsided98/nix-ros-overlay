...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/ackermann_steering_controller/2.54.0-1.tar.gz";
    name = "2.54.0-1.tar.gz";
    sha256 = "12ce0cc98d62e835e7358e64e215eb49221c0d2d42cfead596187ab26d37d8f4";
  };
