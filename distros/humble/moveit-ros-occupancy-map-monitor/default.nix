...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_ros_occupancy_map_monitor/2.5.9-1.tar.gz";
    name = "2.5.9-1.tar.gz";
    sha256 = "14e63d8ad7aa98bc2f3234b5c4b242a3453a7aaf88b81dc06da28b027619b134";
  };
