...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/humble/clearpath_generator_common/1.3.8-1.tar.gz";
    name = "1.3.8-1.tar.gz";
    sha256 = "06758b37b2c9f7b246f011151d638edf9bb99d41edf9e986f21cd4200b12eb02";
  };
