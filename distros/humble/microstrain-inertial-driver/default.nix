...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/microstrain_inertial-release/archive/release/humble/microstrain_inertial_driver/2.7.0-1.tar.gz";
    name = "2.7.0-1.tar.gz";
    sha256 = "5e480f7a16e5c3d9a353c1ff91e55f1150b86c19f35bdc38f11870ed718f11c2";
  };
