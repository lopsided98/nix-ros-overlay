...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/microstrain_inertial-release/archive/release/humble/microstrain_inertial_driver/3.0.1-1.tar.gz";
    name = "3.0.1-1.tar.gz";
    sha256 = "3a7353c6805b543ec5453d2eeea57bfb13a3c5093ca96d4c9fae7ddf7f53fd40";
  };
