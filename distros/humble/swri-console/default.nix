...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/swri_console-release/archive/release/humble/swri_console/2.0.3-2.tar.gz";
    name = "2.0.3-2.tar.gz";
    sha256 = "771ce61a17eaa23c6433c622383862f79ff317ca305936fc11fe61d287de88af";
  };
