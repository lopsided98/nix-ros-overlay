...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_planners_ompl/2.5.10-1.tar.gz";
    name = "2.5.10-1.tar.gz";
    sha256 = "090204b09abfcdeff925326750fc60717722fab0c7957a07a09837eb8947b413";
  };
