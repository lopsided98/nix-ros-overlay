...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/humble/stereo_image_proc/3.0.9-1.tar.gz";
    name = "3.0.9-1.tar.gz";
    sha256 = "f143e7601e8d891ca63e149baa47a7578c2c941eadfd61ff0378ca6163eadf92";
  };
