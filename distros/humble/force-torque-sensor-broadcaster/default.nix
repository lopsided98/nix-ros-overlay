...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/force_torque_sensor_broadcaster/2.19.0-1.tar.gz";
    name = "2.19.0-1.tar.gz";
    sha256 = "980f4cc0bfed64c4f227d26be586627cf7b7f2c8e01c5eafdc83fa9a703dde22";
  };
