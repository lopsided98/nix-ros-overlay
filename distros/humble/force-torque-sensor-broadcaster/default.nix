...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/force_torque_sensor_broadcaster/2.47.0-1.tar.gz";
    name = "2.47.0-1.tar.gz";
    sha256 = "59f8d1a92dad43498754d82d255e418142b53e8117f8cadebb714bc2a7c629c8";
  };
