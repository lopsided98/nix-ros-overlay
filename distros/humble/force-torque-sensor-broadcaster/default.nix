...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/force_torque_sensor_broadcaster/2.13.0-1.tar.gz";
    name = "2.13.0-1.tar.gz";
    sha256 = "8285acf68615183df69aa62f9286e09db477fc59f8be067b431cd4e04b047adc";
  };
