...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/force_torque_sensor_broadcaster/2.17.2-1.tar.gz";
    name = "2.17.2-1.tar.gz";
    sha256 = "fc2ac8b8c301927938fc6df9ba191d69812b918bd538185ea94d32b06e486bff";
  };
