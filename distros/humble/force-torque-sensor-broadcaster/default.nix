...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/force_torque_sensor_broadcaster/2.31.0-1.tar.gz";
    name = "2.31.0-1.tar.gz";
    sha256 = "4b321a5961b44581deaff10adaba255bdb5f6f8e9b1410b80953670e012a8195";
  };
