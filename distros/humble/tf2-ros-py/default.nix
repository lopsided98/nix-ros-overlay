...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_ros_py/0.25.11-1.tar.gz";
    name = "0.25.11-1.tar.gz";
    sha256 = "7ea18eaf80ac83142156903f8b215e291cbd2230871490f87874829663296075";
  };
