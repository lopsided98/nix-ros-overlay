...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_ros_py/0.25.17-1.tar.gz";
    name = "0.25.17-1.tar.gz";
    sha256 = "64c73d57ee9fabf996612eda60ffc501995a75a9208c9bfdc06d9a1fcd14d3ef";
  };
