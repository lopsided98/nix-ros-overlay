...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/manankharwar/fusioncore-release/archive/release/humble/fusioncore_gazebo/0.3.7-1.tar.gz";
    name = "0.3.7-1.tar.gz";
    sha256 = "2623ff89a0f7a4e63f793402726f5fa798b7230840f73a920766ab61c0d1b093";
  };
