...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/admittance_controller/2.49.0-1.tar.gz";
    name = "2.49.0-1.tar.gz";
    sha256 = "1d963fdb57d3670195eda478b713ce7915acc7cd697ff472b5ba1e5e95b8e657";
  };
