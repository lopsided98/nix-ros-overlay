...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/admittance_controller/2.19.0-1.tar.gz";
    name = "2.19.0-1.tar.gz";
    sha256 = "52496a9e0a48ca4a9a404aae7e448f67cc782e4064a8f499385ffb0da54c9c45";
  };
