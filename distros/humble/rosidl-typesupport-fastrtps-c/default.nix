...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_typesupport_fastrtps-release/archive/release/humble/rosidl_typesupport_fastrtps_c/2.2.4-1.tar.gz";
    name = "2.2.4-1.tar.gz";
    sha256 = "a99402750b964fd04ed680dc4904c45149cfca18efa498804754c99b14921909";
  };
