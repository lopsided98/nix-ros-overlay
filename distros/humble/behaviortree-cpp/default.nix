...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/behaviortree_cpp_v4-release/archive/release/humble/behaviortree_cpp/4.5.0-1.tar.gz";
    name = "4.5.0-1.tar.gz";
    sha256 = "f57e580f0bd8f6f67eb674486fe208594837869269f2a5f8fcb33a39eac5f9db";
  };
