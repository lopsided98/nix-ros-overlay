...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/gpio_controllers/2.52.0-1.tar.gz";
    name = "2.52.0-1.tar.gz";
    sha256 = "effb64d81ee74d2aa267a79aae8fc70f1f70a38f83ebea21a1aedb4a828741fe";
  };
