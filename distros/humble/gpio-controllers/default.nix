...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/gpio_controllers/2.47.0-1.tar.gz";
    name = "2.47.0-1.tar.gz";
    sha256 = "e81ed3768efda633c75af58497bd38bf973ba79ba7b53458316d93f39ebf8938";
  };
