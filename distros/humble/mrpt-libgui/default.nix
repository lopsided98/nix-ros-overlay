...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libgui/2.15.15-1.tar.gz";
    name = "2.15.15-1.tar.gz";
    sha256 = "de029d1ae2edde27ed07a48093b614296f756e90e0f04087a9ef0cae8893ceed";
  };
