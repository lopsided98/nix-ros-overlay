...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/octomap_ros-release/archive/release/humble/octomap_ros/0.4.4-1.tar.gz";
    name = "0.4.4-1.tar.gz";
    sha256 = "297dd6bd1070f0cebbd86d50c8b3c603b98153ef1f4f97df8b91dc2332a1226e";
  };
