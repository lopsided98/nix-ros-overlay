...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/humble/ros2launch/0.19.14-1.tar.gz";
    name = "0.19.14-1.tar.gz";
    sha256 = "46c19b90743c30e37a089899d995a75843c2e823ab372b95bc4b52d011093a84";
  };
