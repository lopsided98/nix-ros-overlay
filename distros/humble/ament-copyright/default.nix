...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_copyright/0.12.9-1.tar.gz";
    name = "0.12.9-1.tar.gz";
    sha256 = "d658129c8134a02600d3d03a025a9d7ff43d2f2b89a01fbbf9200781d375575f";
  };
