...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2pkg/0.18.16-1.tar.gz";
    name = "0.18.16-1.tar.gz";
    sha256 = "7cb68bf1ffc32721316b819b30389755dbba58b51d266b35741a2be6ba4b9e12";
  };
