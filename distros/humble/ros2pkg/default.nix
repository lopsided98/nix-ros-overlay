...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2pkg/0.18.18-1.tar.gz";
    name = "0.18.18-1.tar.gz";
    sha256 = "19dbbc92ee610f8ef8f652686dff7e5153e68ac08687ac7d10e69c0d00945ec1";
  };
