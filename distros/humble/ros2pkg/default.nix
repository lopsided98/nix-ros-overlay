...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2pkg/0.18.7-1.tar.gz";
    name = "0.18.7-1.tar.gz";
    sha256 = "878c4afb8d84ff4099da38e64efe7b634178b4d4315dcce34797c90e986f38ee";
  };
