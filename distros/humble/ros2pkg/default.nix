...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2pkg/0.18.17-1.tar.gz";
    name = "0.18.17-1.tar.gz";
    sha256 = "f08b4ec291247ae11664b4b29ead54b4646e42f31360ae51e38107b0b97a575d";
  };
