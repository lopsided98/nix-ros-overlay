...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_common/11.2.27-1.tar.gz";
    name = "11.2.27-1.tar.gz";
    sha256 = "085ff23b328af59481151d957b707622191751975af4e9df2659bbece1a7fff8";
  };
