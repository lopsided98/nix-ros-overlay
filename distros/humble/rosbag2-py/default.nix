...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_py/0.15.5-1.tar.gz";
    name = "0.15.5-1.tar.gz";
    sha256 = "231c44b1dc5e9bc4be0efa50e8f144913ce922766f482113ff4f04517df33445";
  };
