...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/humble/ament_cmake_target_dependencies/1.3.3-1.tar.gz";
    name = "1.3.3-1.tar.gz";
    sha256 = "d82a5e7491ccaa05ba68a160c94d5fad33de4244da7c7eebae966785e3ddbf28";
  };
