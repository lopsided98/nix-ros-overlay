...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/humble/ament_cmake_target_dependencies/1.3.6-1.tar.gz";
    name = "1.3.6-1.tar.gz";
    sha256 = "babac362bdcae78aefd9d5f4d6a596b60ba5b7c95d6d7ce18d31e97c524f12b3";
  };
