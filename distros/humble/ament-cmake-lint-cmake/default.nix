...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_cmake_lint_cmake/0.12.9-1.tar.gz";
    name = "0.12.9-1.tar.gz";
    sha256 = "fcf4dafd29531f7d3d9452385096be7b50af9122e07591886f3a4407d78aae0f";
  };
