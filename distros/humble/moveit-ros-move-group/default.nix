...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_ros_move_group/2.5.10-1.tar.gz";
    name = "2.5.10-1.tar.gz";
    sha256 = "e70fd6ff077904dae68b9b2ab2cd950dd3b7365e8c7b5cbc2309c8610b229651";
  };
