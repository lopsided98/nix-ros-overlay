...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/humble/rosbridge_library/2.0.4-1.tar.gz";
    name = "2.0.4-1.tar.gz";
    sha256 = "30a7ad9db921fc0d98a66324be391d6513c0f3aeae0f361dd0ffbec3b2abe474";
  };
