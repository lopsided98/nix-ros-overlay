...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/pal-gbp/pmb2_robot-gbp/archive/release/humble/pmb2_description/5.0.20-1.tar.gz";
    name = "5.0.20-1.tar.gz";
    sha256 = "865a1556ed2f639a25110f3aa77beb30b1dbedff30cb9867e98da2fff54aa0b4";
  };
