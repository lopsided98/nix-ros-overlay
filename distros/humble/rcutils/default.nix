...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcutils-release/archive/release/humble/rcutils/5.1.7-1.tar.gz";
    name = "5.1.7-1.tar.gz";
    sha256 = "f8c1a589cf28de3185515cf99f5cd73afc08c6da745a9ea0d71997ca9f65f7ad";
  };
