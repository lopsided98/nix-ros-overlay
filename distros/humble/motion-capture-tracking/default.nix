...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/motion_capture_tracking-release/archive/release/humble/motion_capture_tracking/1.0.9-1.tar.gz";
    name = "1.0.9-1.tar.gz";
    sha256 = "dc4f9e62917353d3bfdade95df5a9c34ec28e7f3bf75cc08eedd29caf2e88971";
  };
