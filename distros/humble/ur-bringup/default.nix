...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/humble/ur_bringup/2.11.0-1.tar.gz";
    name = "2.11.0-1.tar.gz";
    sha256 = "49d5b57c412bd8cb1c6d426d2807544fdd96aa8b34316f2f24a72df26a74b149";
  };
