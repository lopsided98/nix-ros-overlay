...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/humble/clearpath_common/0.2.9-1.tar.gz";
    name = "0.2.9-1.tar.gz";
    sha256 = "92b2a54fc8f9113d27c880bd3c3472879ba02ee5bf9f5f8545b6a51a8cce158b";
  };
