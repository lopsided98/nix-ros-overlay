...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/humble/ntrip_client_node/0.6.1-1.tar.gz";
    name = "0.6.1-1.tar.gz";
    sha256 = "00f53926476c017c69f21a94fb4c18a53815f12f064b1db58bcc473ddaaaa06b";
  };
