...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_theta_star_planner/1.1.15-1.tar.gz";
    name = "1.1.15-1.tar.gz";
    sha256 = "8fd2ea20b34418eea75e1cbd2fc8f3cd1cef3cd109ecd5ae8914a69ffaa051a3";
  };
