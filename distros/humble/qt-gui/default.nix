...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/qt_gui_core-release/archive/release/humble/qt_gui/2.2.5-1.tar.gz";
    name = "2.2.5-1.tar.gz";
    sha256 = "b9c2beb3b0b718c282c6571250d2b280f5d48ed40a997af7cd5d1fca5ad58b0a";
  };
