...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_cpp/0.15.17-1.tar.gz";
    name = "0.15.17-1.tar.gz";
    sha256 = "9006723782d4ce84e8447029056c41c12668ad867b4383bce717751a50ec9ce1";
  };
