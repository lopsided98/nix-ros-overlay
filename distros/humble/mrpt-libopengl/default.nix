...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libopengl/2.15.21-2.tar.gz";
    name = "2.15.21-2.tar.gz";
    sha256 = "d6dafce2bd898763313ad2c4dc8ac987305d467279c8e16909f138bf7af9ed77";
  };
