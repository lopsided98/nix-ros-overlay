...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/tricycle_steering_controller/2.46.0-1.tar.gz";
    name = "2.46.0-1.tar.gz";
    sha256 = "0501b4e3a7c57fbc89829aeff9d80bcc84d33778e1bc06449dcfefa01f792b0c";
  };
