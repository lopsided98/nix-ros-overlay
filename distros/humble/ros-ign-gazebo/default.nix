...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_ign_gazebo/0.244.11-1.tar.gz";
    name = "0.244.11-1.tar.gz";
    sha256 = "11beae5cd60655630a818175833fe7b1d9366f128e7c643aafc09de8898e6f2b";
  };
