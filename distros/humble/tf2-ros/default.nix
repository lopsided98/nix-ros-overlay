...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_ros/0.25.20-2.tar.gz";
    name = "0.25.20-2.tar.gz";
    sha256 = "bbab74a783e687f7849c250c46eeeddb57927350af9dbb88986f3c3514309955";
  };
