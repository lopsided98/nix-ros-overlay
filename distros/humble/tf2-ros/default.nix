...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_ros/0.25.15-1.tar.gz";
    name = "0.25.15-1.tar.gz";
    sha256 = "ef20cb43a78bd660fbcd75c7ec0f8b89df849b50984b35ed70d7d09611d01066";
  };
