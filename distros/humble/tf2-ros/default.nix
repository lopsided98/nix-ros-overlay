...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_ros/0.25.22-1.tar.gz";
    name = "0.25.22-1.tar.gz";
    sha256 = "ff66ab0491794d56481b2017dcae3714d945015c59fb2d422874c75ad9feb0d1";
  };
