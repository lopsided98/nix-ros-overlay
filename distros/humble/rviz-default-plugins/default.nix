...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_default_plugins/11.2.19-1.tar.gz";
    name = "11.2.19-1.tar.gz";
    sha256 = "26678cf63895db6b73e8f50358a863062e251158e6781f14fe92faa9091d29bf";
  };
