...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_default_plugins/11.2.3-1.tar.gz";
    name = "11.2.3-1.tar.gz";
    sha256 = "05e941c24efc644b17d5c2be6b292e21def8b340ece0b693b494f7d828c927fc";
  };
