...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_default_plugins/11.2.29-1.tar.gz";
    name = "11.2.29-1.tar.gz";
    sha256 = "c6385a45eafcb3352bae037e566df0909fadb1bdc9d16081f63dd79422307426";
  };
