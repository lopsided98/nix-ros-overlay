...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_rviz_plugins/1.1.6-1.tar.gz";
    name = "1.1.6-1.tar.gz";
    sha256 = "cd262d1c11cc2dab60a9c3e9112eb68072f3e3b0b888b4c4f88b03a26b010edd";
  };
