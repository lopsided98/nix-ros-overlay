...
buildRosPackage {
  pname = "ros-humble-trackdlo-core";
  version = "2.0.0-r2";

  src = fetchurl {
    url = "https://github.com/HayatoShimada/trackdlo_perception-release/archive/release/humble/trackdlo_core/2.0.0-2.tar.gz";
    name = "2.0.0-2.tar.gz";
    sha256 = "03d6389e5f15b636b09339bae27b1e4defaaa2bb3d3a4b329ac5202948463fc2";
  };
