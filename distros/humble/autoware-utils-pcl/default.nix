...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/humble/autoware_utils_pcl/1.5.0-2.tar.gz";
    name = "1.5.0-2.tar.gz";
    sha256 = "368ed0fcf581c2d7b47fc8422f039d8a2c03ab5c443001801327ad3e9744a98d";
  };
