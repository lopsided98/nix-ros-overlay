...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/humble/autoware_utils_pcl/1.7.2-2.tar.gz";
    name = "1.7.2-2.tar.gz";
    sha256 = "973d1f1cf41fde9fff1018e5416664c9652cb0fdb0d31b9593f473c9bc849f02";
  };
