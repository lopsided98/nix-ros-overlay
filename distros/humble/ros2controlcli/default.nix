...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/humble/ros2controlcli/2.16.0-1.tar.gz";
    name = "2.16.0-1.tar.gz";
    sha256 = "1e6b81cd644647394e1115b21d71f7f513bf8cd2be8e27c04ddd91a3402372f4";
  };
