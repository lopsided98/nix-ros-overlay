...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_zenoh-release/archive/release/humble/rmw_zenoh_cpp/0.1.4-1.tar.gz";
    name = "0.1.4-1.tar.gz";
    sha256 = "373397ebda34e32fa0ba0c1924336873e52463b6b974badc23f53eeb5b08f70a";
  };
