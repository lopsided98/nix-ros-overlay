...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/off_highway_sensor_drivers-release/archive/release/humble/off_highway_sensor_drivers/0.12.0-1.tar.gz";
    name = "0.12.0-1.tar.gz";
    sha256 = "d76487ac1e3bd4d1ac6814fc9aa82eadb055f384857c8575ebffa6c1753a622a";
  };
