...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_xmllint/0.12.9-1.tar.gz";
    name = "0.12.9-1.tar.gz";
    sha256 = "184a98a560d3bf436a14132ec9ad7957ca1702b89eddf17cd2824e5de7c94b5b";
  };
