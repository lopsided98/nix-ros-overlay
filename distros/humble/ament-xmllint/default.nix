...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_xmllint/0.12.10-1.tar.gz";
    name = "0.12.10-1.tar.gz";
    sha256 = "6e4dd33120b40a86369b226329bcdef580c3e8e2fd77abebf2b103f0b0e746ed";
  };
