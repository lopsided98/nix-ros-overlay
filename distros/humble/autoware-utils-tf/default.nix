...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/humble/autoware_utils_tf/1.7.2-2.tar.gz";
    name = "1.7.2-2.tar.gz";
    sha256 = "9fb961212b4b1e5b1ed2c3497f38dd1faf6ec905c3b2d687bf978a0a6a8e9888";
  };
