...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2interface/0.18.7-1.tar.gz";
    name = "0.18.7-1.tar.gz";
    sha256 = "d0d8746d8a89737ff045d1fa5f50494e0d66982272381b10dd06df99ac151c42";
  };
