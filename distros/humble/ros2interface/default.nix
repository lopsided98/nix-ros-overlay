...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2interface/0.18.5-1.tar.gz";
    name = "0.18.5-1.tar.gz";
    sha256 = "6dc617022caa6313cf2b950a8e5e683c8f34a8004e2a36850098470e9d6ec380";
  };
