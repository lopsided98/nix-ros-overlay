...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2interface/0.18.16-1.tar.gz";
    name = "0.18.16-1.tar.gz";
    sha256 = "97eca7bfda95820deb01d3e23695141ad859a26a6f170d1aaf31a7c909845ab2";
  };
