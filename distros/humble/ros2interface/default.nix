...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2interface/0.18.17-1.tar.gz";
    name = "0.18.17-1.tar.gz";
    sha256 = "69ab96e9513cda7aaed682181a89f1b0f30026637bd178e6f1da5c233bfe60f0";
  };
