...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2interface/0.18.18-1.tar.gz";
    name = "0.18.18-1.tar.gz";
    sha256 = "cf86a56454c88422437197ec63fab9930450a3ab2010b6ba6cbb2abb95f4c670";
  };
