...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2interface/0.18.20-1.tar.gz";
    name = "0.18.20-1.tar.gz";
    sha256 = "89037f8d5277628dad0c949ec9ddffebb22fd9ede3c79f6b521cd252f2085365";
  };
