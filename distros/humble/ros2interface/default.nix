...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2interface/0.18.15-1.tar.gz";
    name = "0.18.15-1.tar.gz";
    sha256 = "d9cbaf5a415cb04f8a56b0978cb0422ee85e14c6a2f279b30eac198981f76f33";
  };
