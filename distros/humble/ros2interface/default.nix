...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2interface/0.18.4-1.tar.gz";
    name = "0.18.4-1.tar.gz";
    sha256 = "05b0748f6cc9f08101ad0000d84dfc54d435c8e1ecb782b6fb39f31176cd7829";
  };
