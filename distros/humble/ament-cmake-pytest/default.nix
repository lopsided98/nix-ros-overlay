...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/humble/ament_cmake_pytest/1.3.6-1.tar.gz";
    name = "1.3.6-1.tar.gz";
    sha256 = "b877ee81b28de3a414702d5751928ab4c8f6189332b1e9a271202e78894e0bb6";
  };
