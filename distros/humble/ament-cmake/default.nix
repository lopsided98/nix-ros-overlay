...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/humble/ament_cmake/1.3.14-1.tar.gz";
    name = "1.3.14-1.tar.gz";
    sha256 = "d4338a8249baaa82ad54953b0fb88119f005c1ce9f7607209aa8ea387656370d";
  };
