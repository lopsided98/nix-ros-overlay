...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/humble/ament_cmake/1.3.2-1.tar.gz";
    name = "1.3.2-1.tar.gz";
    sha256 = "bf1f74357d8444972c571b931ce7d55671e2676757585008ae718eb4a7348aae";
  };
