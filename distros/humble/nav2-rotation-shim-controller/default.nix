...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_rotation_shim_controller/1.1.5-1.tar.gz";
    name = "1.1.5-1.tar.gz";
    sha256 = "12841ba5ceb4300bc0b78f5c84142c6b0e7d797b7ab4d7bbdd397d7c884ce6aa";
  };
