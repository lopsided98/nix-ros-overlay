...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_kinematics/2.5.10-1.tar.gz";
    name = "2.5.10-1.tar.gz";
    sha256 = "bbc6d9efddeacd485fdb3d9149f141aa136eace1e0dc74d7771bc276df714295";
  };
