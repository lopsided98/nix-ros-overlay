...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/humble/etsi_its_denm_conversion/3.4.0-1.tar.gz";
    name = "3.4.0-1.tar.gz";
    sha256 = "583574eee6970206ffce587bae579e96bb9bcd8e4c62598aa663962362bc805a";
  };
