...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/humble/image_tools/0.20.7-1.tar.gz";
    name = "0.20.7-1.tar.gz";
    sha256 = "958d55bf78816d7ab1cf021bd602c307130ca124e6161a6d5905b94fde6fa30b";
  };
