...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/pal-gbp/pal_statistics-release/archive/release/humble/pal_statistics/2.1.5-1.tar.gz";
    name = "2.1.5-1.tar.gz";
    sha256 = "b81315d83d977dcfaef838e3cc35daf35f5ee93f332d342c58217a95ad30490c";
  };
