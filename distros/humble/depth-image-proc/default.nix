...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/humble/depth_image_proc/3.0.9-1.tar.gz";
    name = "3.0.9-1.tar.gz";
    sha256 = "2d35fb9c198bc2f0cce2b863220f596a2ecfa1813f191603f720b42c535a3c71";
  };
