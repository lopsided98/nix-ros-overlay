...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_simulator-release/archive/release/humble/clearpath_gz/0.2.5-1.tar.gz";
    name = "0.2.5-1.tar.gz";
    sha256 = "9c14690e4d18696ce903b6ee8fd4a3a6c1bc6d199ceeab1c4a35c3f008cee984";
  };
