...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_smoother/1.1.20-1.tar.gz";
    name = "1.1.20-1.tar.gz";
    sha256 = "53f8f0537446f24d12635a750b80fa65bd8b7a4bfd6dd84d86069e61f7ef4a7c";
  };
