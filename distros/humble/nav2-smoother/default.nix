...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_smoother/1.1.15-1.tar.gz";
    name = "1.1.15-1.tar.gz";
    sha256 = "5b547b466050eebe6ec7813f9d1998d8aab85f08da56919a54dea434b62cb4e7";
  };
