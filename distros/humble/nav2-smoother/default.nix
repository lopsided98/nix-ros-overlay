...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_smoother/1.1.6-1.tar.gz";
    name = "1.1.6-1.tar.gz";
    sha256 = "90153368710852aaf48a19d7beb492e946246a903054533a1fa35c2b5ffc85d0";
  };
