...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_ros_perception/2.5.10-1.tar.gz";
    name = "2.5.10-1.tar.gz";
    sha256 = "e5a16107e2574fdd956133e98c946961e6f186c63c867b1999f2c85bdb062ea0";
  };
