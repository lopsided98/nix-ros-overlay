...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_babel_fish-release/archive/release/humble/ros_babel_fish_test_msgs/0.25.120-1.tar.gz";
    name = "0.25.120-1.tar.gz";
    sha256 = "6f93cdbed59d01da57f13bf24483913513c5332454a894f5359e532931261822";
  };
