...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2lifecycle/0.18.19-1.tar.gz";
    name = "0.18.19-1.tar.gz";
    sha256 = "6062bba44b2c739e5a3269875fd3ff7733adedd1ad47b5dcd89a94b7df6af55a";
  };
