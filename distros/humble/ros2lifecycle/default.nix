...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2lifecycle/0.18.15-1.tar.gz";
    name = "0.18.15-1.tar.gz";
    sha256 = "ca2872ded386c12330fe804c7208b98c3bfcee99b9b83067739022a4e71ad878";
  };
