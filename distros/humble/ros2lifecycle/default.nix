...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2lifecycle/0.18.5-1.tar.gz";
    name = "0.18.5-1.tar.gz";
    sha256 = "ca6842faaadc4e072d5a26d8f5b3a82fae1a5a12f9fee2a70bfa0dab1db4e4de";
  };
