...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2lifecycle/0.18.18-1.tar.gz";
    name = "0.18.18-1.tar.gz";
    sha256 = "e8ae0be4eff3010e12dc7c76aa88e167b34b72f1aa6fc745a59b5d5e7571986e";
  };
