...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/crazyswarm2-release/archive/release/humble/crazyflie_sim/1.0.0-1.tar.gz";
    name = "1.0.0-1.tar.gz";
    sha256 = "0248a770374dafdc4fe787a121ebf7e37175be64faa81db84860ef48a5f63070";
  };
