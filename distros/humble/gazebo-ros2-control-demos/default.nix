...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gazebo_ros2_control-release/archive/release/humble/gazebo_ros2_control_demos/0.4.5-1.tar.gz";
    name = "0.4.5-1.tar.gz";
    sha256 = "79e66fd91035fadd71cc2d01b2ea90afcbd9b882abcb1dd3dfb33ae11749b9c6";
  };
