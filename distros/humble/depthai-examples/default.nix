...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/luxonis/depthai-ros-release/archive/release/humble/depthai_examples/2.6.4-1.tar.gz";
    name = "2.6.4-1.tar.gz";
    sha256 = "9d8f499516ca92149856950f39f4cae30093f6085f37a3e7f1cd3c0252272f3c";
  };
