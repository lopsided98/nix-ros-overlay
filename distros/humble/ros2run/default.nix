...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2run/0.18.20-1.tar.gz";
    name = "0.18.20-1.tar.gz";
    sha256 = "56bac7a5f67cf6610d030c8695e4602efedea0845a57dacbcf5b07d161e31ec1";
  };
