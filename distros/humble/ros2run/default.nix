...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2run/0.18.19-1.tar.gz";
    name = "0.18.19-1.tar.gz";
    sha256 = "0198199072fc44f289423e6cbbe8c8329961e6dafb667d62c517b95c18a2709c";
  };
