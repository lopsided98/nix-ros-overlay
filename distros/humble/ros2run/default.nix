...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2run/0.18.18-1.tar.gz";
    name = "0.18.18-1.tar.gz";
    sha256 = "11661aef5744f22be65b3be8e82c97e484d4320d6283153b82e0e1edbd57beb6";
  };
