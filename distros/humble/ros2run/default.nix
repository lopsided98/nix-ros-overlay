...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2run/0.18.17-1.tar.gz";
    name = "0.18.17-1.tar.gz";
    sha256 = "a74ef1f03f39c084ec098c8fe570de7bd315f84c3893615abc062e63cf107ae9";
  };
