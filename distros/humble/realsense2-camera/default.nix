...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/realsense-ros-release/archive/release/humble/realsense2_camera/4.58.2-1.tar.gz";
    name = "4.58.2-1.tar.gz";
    sha256 = "89c3121660a61f8c1f0577ed481021aa14d17418250225fa36000c4e19cb62f8";
  };
