...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/humble/webots_ros2_driver/1.2.3-1.tar.gz";
    name = "1.2.3-1.tar.gz";
    sha256 = "31de5686c3a17ca5b2c6fade216b93dd7b62414e736f69b0baba79064b8ea4c2";
  };
