...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/humble/webots_ros2_driver/2022.1.3-1.tar.gz";
    name = "2022.1.3-1.tar.gz";
    sha256 = "3f21bce3a116960d70ef0995f2d4edcd618d32f2f252206e7e902075aa78f311";
  };
