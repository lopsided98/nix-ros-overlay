...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/ros2_controllers/2.46.0-1.tar.gz";
    name = "2.46.0-1.tar.gz";
    sha256 = "e1fada31523d565500345c8cc2535f04a5af1abd5fc466dbe39d0297da24b050";
  };
