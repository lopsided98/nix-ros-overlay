...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_cmake_flake8/0.12.9-1.tar.gz";
    name = "0.12.9-1.tar.gz";
    sha256 = "d0d7612cb367044937cdfc891fd37e96452246ed61099ca728aa6e2c336d01a2";
  };
