...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2cli/0.18.5-1.tar.gz";
    name = "0.18.5-1.tar.gz";
    sha256 = "23d48df8ab8e225cab104d5e7a0ee5781cc1b3ea4fba2197c23bd81ed85afcad";
  };
