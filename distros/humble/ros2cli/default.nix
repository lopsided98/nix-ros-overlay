...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2cli/0.18.20-1.tar.gz";
    name = "0.18.20-1.tar.gz";
    sha256 = "97fa5b1e079b9e8b4490543435909baa8bef595c5997c7ce1b88f754cbc7d515";
  };
