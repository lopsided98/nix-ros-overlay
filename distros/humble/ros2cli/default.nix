...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2cli/0.18.18-1.tar.gz";
    name = "0.18.18-1.tar.gz";
    sha256 = "a8b4f57c2f592c08c0f8a522cfd444e74a17b9927773387502b363878d173f16";
  };
