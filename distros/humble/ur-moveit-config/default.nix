...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/humble/ur_moveit_config/2.2.13-1.tar.gz";
    name = "2.2.13-1.tar.gz";
    sha256 = "ece302ad623625638644f35012ce3e654ddd60f332d1964d48d0bf2a950e092c";
  };
