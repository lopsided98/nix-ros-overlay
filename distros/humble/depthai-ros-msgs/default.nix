...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/luxonis/depthai-ros-release/archive/release/humble/depthai_ros_msgs/2.12.2-1.tar.gz";
    name = "2.12.2-1.tar.gz";
    sha256 = "f099e440080c6519b7befc73e09efd58c4ef7a0c7e1e960f6d8d3f50d5af04e5";
  };
