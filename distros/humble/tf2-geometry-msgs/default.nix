...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_geometry_msgs/0.25.19-1.tar.gz";
    name = "0.25.19-1.tar.gz";
    sha256 = "c7ea506286f7b2a151c601c403866ab9234a254798a51e8a3c724169a78c860b";
  };
