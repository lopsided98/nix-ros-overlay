...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_geometry_msgs/0.25.16-1.tar.gz";
    name = "0.25.16-1.tar.gz";
    sha256 = "f8dcd113c33cf74d8719fb191d1a7c1406a7445259c09191094e0c5c66950e07";
  };
