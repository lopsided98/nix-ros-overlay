...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_geometry_msgs/0.25.24-1.tar.gz";
    name = "0.25.24-1.tar.gz";
    sha256 = "fc039e118a3428561889a42d6f71ecd3bdeaa8cf36d0e02dfe3c0cc062648fe4";
  };
