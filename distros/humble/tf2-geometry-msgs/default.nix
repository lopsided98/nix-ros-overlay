...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_geometry_msgs/0.25.22-1.tar.gz";
    name = "0.25.22-1.tar.gz";
    sha256 = "fd76eb15177a5f46622ce9166c40abe1d9e3b33c01c3d31d1a0b8fed1b20de14";
  };
