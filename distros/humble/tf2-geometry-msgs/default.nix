...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_geometry_msgs/0.25.23-1.tar.gz";
    name = "0.25.23-1.tar.gz";
    sha256 = "d13084771188f49adb281c6cea4cb16e07cf0ad4989d04b7a23f0b5d486ca503";
  };
