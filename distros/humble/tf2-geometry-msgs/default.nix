...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_geometry_msgs/0.25.14-1.tar.gz";
    name = "0.25.14-1.tar.gz";
    sha256 = "b80c90255bc9283ed481a4ebcd5ed52a01678510c07a193d5b51b21e4586a7de";
  };
