...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_geometry_msgs/0.25.15-1.tar.gz";
    name = "0.25.15-1.tar.gz";
    sha256 = "b50cb63d1325ce24bd85ed47dd38f33ea2feee0014afc252e534bbf809e06328";
  };
