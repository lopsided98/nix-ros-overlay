...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_geometry_msgs/0.25.11-1.tar.gz";
    name = "0.25.11-1.tar.gz";
    sha256 = "4dfe317aef71a629c27eef8415f7f4c758d2d1af66b3a06c211b8b42135849f5";
  };
