...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_geometry_msgs/0.25.0-2.tar.gz";
    name = "0.25.0-2.tar.gz";
    sha256 = "5db610803937f6f5e8673eb0c420090e0d5d4238566ee04159260abb9eef9f2c";
  };
