...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_geometry_msgs/0.25.18-1.tar.gz";
    name = "0.25.18-1.tar.gz";
    sha256 = "ca12ecec912bfa204e1cd25250fb68c89796c61ca25b4fe44c9eecb2a19394c2";
  };
