...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_lint_common/0.12.14-1.tar.gz";
    name = "0.12.14-1.tar.gz";
    sha256 = "075f9fc7f9a7084fbb3e12a56b7731f4162c818b574c8768c69abee2738d0329";
  };
