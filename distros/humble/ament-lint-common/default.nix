...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_lint_common/0.12.13-1.tar.gz";
    name = "0.12.13-1.tar.gz";
    sha256 = "e87d6f83d65a21e56dc5f0c94db8aace654f122db164367365e965ddff7f80ea";
  };
