...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_planners_chomp/2.5.10-1.tar.gz";
    name = "2.5.10-1.tar.gz";
    sha256 = "ecdfea7302d589c7f86ff6dff258924392097a25684c195e425d70407e80795c";
  };
