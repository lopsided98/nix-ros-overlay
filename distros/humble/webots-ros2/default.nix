...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/humble/webots_ros2/2023.0.3-1.tar.gz";
    name = "2023.0.3-1.tar.gz";
    sha256 = "56f6b09ab43ba8129d5f60523608c1a6ccf79e8486720901ebe9d18cf8951c12";
  };
