...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/humble/automatika_ros_sugar/0.6.0-1.tar.gz";
    name = "0.6.0-1.tar.gz";
    sha256 = "9a40b564ec349792f029040d6604aba8bf3e884c4c61ad9be2e4092c7ce86f1e";
  };
