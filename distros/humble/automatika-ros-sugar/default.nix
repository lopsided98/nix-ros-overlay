...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/humble/automatika_ros_sugar/0.3.1-1.tar.gz";
    name = "0.3.1-1.tar.gz";
    sha256 = "177e0600abef50df8a0b910e4223376ec9dcdf6896c2095620f230927bf03084";
  };
