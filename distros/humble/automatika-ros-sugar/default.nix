...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/humble/automatika_ros_sugar/0.3.2-1.tar.gz";
    name = "0.3.2-1.tar.gz";
    sha256 = "17c3190b5bd0c5650796458ed006cd63f23232896d5892dc27e2b17c84969515";
  };
