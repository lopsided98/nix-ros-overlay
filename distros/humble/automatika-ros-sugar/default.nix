...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/humble/automatika_ros_sugar/0.6.1-1.tar.gz";
    name = "0.6.1-1.tar.gz";
    sha256 = "4e08e1055110320302f9040a13fa6d685965f5d06301c0398254e025cfc1ccec";
  };
