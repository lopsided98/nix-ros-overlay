...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/humble/automatika_ros_sugar/0.4.1-1.tar.gz";
    name = "0.4.1-1.tar.gz";
    sha256 = "51e7e6f2a08537ddee910ba38a5dbb56b0c0cf4f12530af40c5bf8e34d495af7";
  };
