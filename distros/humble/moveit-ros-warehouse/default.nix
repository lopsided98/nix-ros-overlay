...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_ros_warehouse/2.5.10-1.tar.gz";
    name = "2.5.10-1.tar.gz";
    sha256 = "87db608cf9581b5cb2bcaebc5f31786642b6603780c9debc50d417fd57ff5250";
  };
