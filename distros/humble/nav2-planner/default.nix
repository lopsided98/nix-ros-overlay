...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_planner/1.1.5-1.tar.gz";
    name = "1.1.5-1.tar.gz";
    sha256 = "c0e9e637b9f246a8a773fdf3fca47d54cbd37d6fee200b37b26ddc5442546c44";
  };
