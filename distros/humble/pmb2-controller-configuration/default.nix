...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/pmb2_robot-release/archive/release/humble/pmb2_controller_configuration/5.12.2-1.tar.gz";
    name = "5.12.2-1.tar.gz";
    sha256 = "8ff8260a477fc3de1bc484217649d2c1f80de950ea523d41b9a8b96bf1de6b3d";
  };
