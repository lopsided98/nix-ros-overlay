...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/pal-gbp/pmb2_robot-gbp/archive/release/humble/pmb2_controller_configuration/5.0.20-1.tar.gz";
    name = "5.0.20-1.tar.gz";
    sha256 = "8b8974d494feda53a0340c0c71cc970a9ca9893f2ccdd5c35eb8227a7eed5c8c";
  };
