...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/humble/webots_ros2_msgs/1.2.3-1.tar.gz";
    name = "1.2.3-1.tar.gz";
    sha256 = "88abcf2005575eb01f8a43a6b9a4b23e37c995da20bdb757a17b9cb7b450c38c";
  };
