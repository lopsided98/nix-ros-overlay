...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/humble/webots_ros2_msgs/2022.1.0-2.tar.gz";
    name = "2022.1.0-2.tar.gz";
    sha256 = "b451c87876d0947a981544d15743d25aac523d1c72104947c814ec2a9c251fc9";
  };
