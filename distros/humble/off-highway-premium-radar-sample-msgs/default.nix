...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/off_highway_sensor_drivers-release/archive/release/humble/off_highway_premium_radar_sample_msgs/0.6.2-1.tar.gz";
    name = "0.6.2-1.tar.gz";
    sha256 = "f438ae020a948003814d2228d56d4d4493adfcea7d9185a938d90637ee452b3a";
  };
