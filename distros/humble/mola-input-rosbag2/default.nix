...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_input_rosbag2/1.0.5-1.tar.gz";
    name = "1.0.5-1.tar.gz";
    sha256 = "d49811950be55113f9da6b325fe0073bb9f0441092fde03b57b09f9edfcac137";
  };
