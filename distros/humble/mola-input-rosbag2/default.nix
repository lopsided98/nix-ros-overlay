...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/humble/mola_input_rosbag2/1.0.4-1.tar.gz";
    name = "1.0.4-1.tar.gz";
    sha256 = "c32b838c94307e7aba0b3643ca25dbbf28c884d69abc2f1ef6a0c17708c63aab";
  };
