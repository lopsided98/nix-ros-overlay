...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/humble/ur_controllers/2.2.13-1.tar.gz";
    name = "2.2.13-1.tar.gz";
    sha256 = "4d8d3ab616d6acd8bb4526b84a86afdd185f6392487d142775f862e5131a77f0";
  };
