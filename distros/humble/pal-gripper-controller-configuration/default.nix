...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/pal-gbp/pal_gripper-release/archive/release/humble/pal_gripper_controller_configuration/3.0.7-1.tar.gz";
    name = "3.0.7-1.tar.gz";
    sha256 = "6fe3c989806a759fe3e6266c09c159a2f962dee6059308c610c96d18ec5e2412";
  };
