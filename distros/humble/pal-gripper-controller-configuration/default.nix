...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/pal-gbp/pal_gripper-release/archive/release/humble/pal_gripper_controller_configuration/3.2.0-1.tar.gz";
    name = "3.2.0-1.tar.gz";
    sha256 = "c43cf753bb7baa25f54ce60151f8a16f784cfb03c12bbea8037b7d980e8c7c6a";
  };
