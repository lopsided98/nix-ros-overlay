...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_behaviors/1.1.6-1.tar.gz";
    name = "1.1.6-1.tar.gz";
    sha256 = "5c8b865fa06915a44361a89282b60163d0217ff806bd5b4b11b10b740cc4c958";
  };
