...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_behaviors/1.1.20-1.tar.gz";
    name = "1.1.20-1.tar.gz";
    sha256 = "fcae89dc6ebe505bfb3e9e01de15b95d8fe903397372088aa982b8ad32fd8fce";
  };
