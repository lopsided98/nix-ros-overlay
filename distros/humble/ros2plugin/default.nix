...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/pluginlib-release/archive/release/humble/ros2plugin/5.1.3-1.tar.gz";
    name = "5.1.3-1.tar.gz";
    sha256 = "1d9070ea1141fd72316601156d08209fb2444cd42577895d817fa0f2cade920e";
  };
