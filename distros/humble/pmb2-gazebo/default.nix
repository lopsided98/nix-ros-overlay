...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/pal-gbp/pmb2_simulation-release/archive/release/humble/pmb2_gazebo/4.0.11-1.tar.gz";
    name = "4.0.11-1.tar.gz";
    sha256 = "6aec6d342896916c6e64c67f02682734b0e8ae473da4d97c4360cf6697e8f037";
  };
