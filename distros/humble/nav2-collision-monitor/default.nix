...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_collision_monitor/1.1.20-1.tar.gz";
    name = "1.1.20-1.tar.gz";
    sha256 = "bf7e235c2452a14877d1251b3b9a67cf20f42d41e1d5a149f2a3a2ff1896fd55";
  };
