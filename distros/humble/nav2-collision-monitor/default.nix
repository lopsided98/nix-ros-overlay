...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_collision_monitor/1.1.15-1.tar.gz";
    name = "1.1.15-1.tar.gz";
    sha256 = "7a2be672f00c0fda6f401e12660a4d24600aa728723f6d694837710538fa7728";
  };
