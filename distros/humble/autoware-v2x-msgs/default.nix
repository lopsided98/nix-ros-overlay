...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_msgs-release/archive/release/humble/autoware_v2x_msgs/1.12.0-1.tar.gz";
    name = "1.12.0-1.tar.gz";
    sha256 = "ba39e40650875471c7e8b4c1245201398e1bf4bd333702956dd0aa564d3e6f74";
  };
