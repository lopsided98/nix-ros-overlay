...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/openeb_vendor-release/archive/release/humble/openeb_vendor/1.1.2-1.tar.gz";
    name = "1.1.2-1.tar.gz";
    sha256 = "1bae3fb5d9dcae89354f0f5a326c5f64ef71d2ad6007039b8da7cf2e3f3ca308";
  };
