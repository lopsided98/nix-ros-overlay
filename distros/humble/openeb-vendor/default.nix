...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/openeb_vendor-release/archive/release/humble/openeb_vendor/1.1.1-1.tar.gz";
    name = "1.1.1-1.tar.gz";
    sha256 = "31d3b6a6c7ce3bcee18adac561abd33dc748a5bb1c768e32a5f270dcbb185bfb";
  };
