...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2doctor/0.18.18-1.tar.gz";
    name = "0.18.18-1.tar.gz";
    sha256 = "e357f7a0c53b59111e02ead0b15c1338bfa77e47d03831a3b01b7301cb289a97";
  };
