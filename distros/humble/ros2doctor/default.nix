...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2doctor/0.18.20-1.tar.gz";
    name = "0.18.20-1.tar.gz";
    sha256 = "8588369e8a5b4d6606b88778d04a3762bb9aa7d3de8fcbb6a743c3f4cb6d12b0";
  };
