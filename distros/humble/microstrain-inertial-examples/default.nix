...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/microstrain_inertial-release/archive/release/humble/microstrain_inertial_examples/3.0.0-1.tar.gz";
    name = "3.0.0-1.tar.gz";
    sha256 = "c4081b4be0d3743eec7ffb0ad7b22a4ca8716716cdfac6795250a8a44f80a21f";
  };
