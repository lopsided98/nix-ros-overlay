...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/microstrain_inertial-release/archive/release/humble/microstrain_inertial_examples/3.0.1-1.tar.gz";
    name = "3.0.1-1.tar.gz";
    sha256 = "898190338926fe38d52a5f1613ce3a4de56da9d14f888f0fce8d19d62bf2bae2";
  };
