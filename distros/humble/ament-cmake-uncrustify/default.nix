...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_cmake_uncrustify/0.12.15-1.tar.gz";
    name = "0.12.15-1.tar.gz";
    sha256 = "90a4cec49016f40c219562c5c9a8b964852cf9196a88c3727c21b0283587a1df";
  };
