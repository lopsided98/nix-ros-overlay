...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_ign/0.244.19-1.tar.gz";
    name = "0.244.19-1.tar.gz";
    sha256 = "a74e236ae012d18c122417900bea26f326d917a4ffbb1cf54659acc84f4c760b";
  };
