...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_ign/0.244.26-1.tar.gz";
    name = "0.244.26-1.tar.gz";
    sha256 = "47af1c874de927c2669b62ab8bd343ebf6a8bc2e87b184acceadaa0c4bb8dbf8";
  };
