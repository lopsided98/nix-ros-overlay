...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_setup_controllers/2.5.9-1.tar.gz";
    name = "2.5.9-1.tar.gz";
    sha256 = "2a12434ca49f008125459f8c44dc7846e04e1f095fc833064fc39bd1f90092d7";
  };
