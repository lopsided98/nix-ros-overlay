...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rko_lio-release/archive/release/humble/rko_lio/0.4.0-1.tar.gz";
    name = "0.4.0-1.tar.gz";
    sha256 = "3c88cb60defd51c0ef369213f435acc604a1dddd5274cf9de33a43e14308ea60";
  };
