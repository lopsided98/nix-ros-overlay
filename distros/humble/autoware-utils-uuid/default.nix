...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/humble/autoware_utils_uuid/1.5.0-2.tar.gz";
    name = "1.5.0-2.tar.gz";
    sha256 = "3fdffe5ade1240a2ec6b1c8a7b8d86f1ff9bb23815199bbcb446cfd32feb66ba";
  };
