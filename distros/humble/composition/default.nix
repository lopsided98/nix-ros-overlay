...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/humble/composition/0.20.8-1.tar.gz";
    name = "0.20.8-1.tar.gz";
    sha256 = "0bace0a29e64d8c28786a3c9268242fa794908cd5eb8ea315c9e65adca4c0308";
  };
