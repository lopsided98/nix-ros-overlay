...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_uncrustify/0.12.13-1.tar.gz";
    name = "0.12.13-1.tar.gz";
    sha256 = "f3c884c5d5a3cc498a31b73ae0483518e4335900dde00e9c40572d3fcd2f484b";
  };
