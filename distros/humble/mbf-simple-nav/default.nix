...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/move_base_flex-release/archive/release/humble/mbf_simple_nav/1.0.1-2.tar.gz";
    name = "1.0.1-2.tar.gz";
    sha256 = "41858ccebe06ac6f9b2620337e26450010cbe435e25e203e854ec5b00f9e7104";
  };
