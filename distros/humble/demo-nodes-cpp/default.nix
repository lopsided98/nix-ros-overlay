...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/humble/demo_nodes_cpp/0.20.7-1.tar.gz";
    name = "0.20.7-1.tar.gz";
    sha256 = "02f6fcc1a1bf8d3d777edf79fb4edf8d032409e93ede744cacc758e77bccf7aa";
  };
