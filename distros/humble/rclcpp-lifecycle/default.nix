...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/humble/rclcpp_lifecycle/16.0.19-1.tar.gz";
    name = "16.0.19-1.tar.gz";
    sha256 = "356565b09cd8a889877ae895042968dafcb68f246ac15a5cec7dbb817a9bb43c";
  };
