...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/humble/phidgets_motors/2.3.4-1.tar.gz";
    name = "2.3.4-1.tar.gz";
    sha256 = "54b0f690066d4918f4778d6dc4e85ccf00d1bad05420341221ee9cd081069a77";
  };
