...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/humble/pilz_industrial_motion_planner_testutils/2.5.9-1.tar.gz";
    name = "2.5.9-1.tar.gz";
    sha256 = "0b6a4da790ed618d420399961dcf135c2d29ca735c40d2b4ce15acfae99842cd";
  };
