...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/humble/rosapi/2.0.8-1.tar.gz";
    name = "2.0.8-1.tar.gz";
    sha256 = "131578adea4de1b5b68de62bf36c0527300210813838e9575eadc719aa5b8dca";
  };
