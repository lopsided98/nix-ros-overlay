...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/event_camera_codecs-release/archive/release/humble/event_camera_codecs/2.0.1-1.tar.gz";
    name = "2.0.1-1.tar.gz";
    sha256 = "b66bed8e84b9d0017573aa11897f158e2299e0ada8f716f5176d89fdc7d3d829";
  };
