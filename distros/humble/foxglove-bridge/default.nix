...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/foxglove_bridge-release/archive/release/humble/foxglove_bridge/0.7.7-1.tar.gz";
    name = "0.7.7-1.tar.gz";
    sha256 = "50e73f4b7faccca79c7e5a648ee6dae41977cec542d2c4128940724e0de95bc2";
  };
