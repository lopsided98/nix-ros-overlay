...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/foxglove_bridge-release/archive/release/humble/foxglove_bridge/3.2.6-1.tar.gz";
    name = "3.2.6-1.tar.gz";
    sha256 = "a3e472c1bf57717cf31d6f23427eeaf904f32f487ea85194050c8b637d6ced6b";
  };
