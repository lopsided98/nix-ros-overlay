...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/foxglove_bridge-release/archive/release/humble/foxglove_bridge/3.2.4-1.tar.gz";
    name = "3.2.4-1.tar.gz";
    sha256 = "3ef050e6cb3676f46026a8b846a5d8c2a08773b3f8828c14f95c1666733f249d";
  };
