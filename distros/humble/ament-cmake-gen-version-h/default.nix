...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/humble/ament_cmake_gen_version_h/1.3.6-1.tar.gz";
    name = "1.3.6-1.tar.gz";
    sha256 = "3bd18a4573af8213d84ce550a63c5bfaddd56069112bcb4b4ec921748750b6e4";
  };
