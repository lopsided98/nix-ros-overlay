...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/humble/ament_cmake_gen_version_h/1.3.12-1.tar.gz";
    name = "1.3.12-1.tar.gz";
    sha256 = "cf748b333d13a7cd443b61e1fa504a8ea54ca649e6de829fb00f602e049c406a";
  };
