...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/humble/mapviz_plugins/2.5.6-1.tar.gz";
    name = "2.5.6-1.tar.gz";
    sha256 = "60510d94fd767a3977e65ab970e5dcbd77325617131ff9b612343692df73da83";
  };
