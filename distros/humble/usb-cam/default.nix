...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/usb_cam-release/archive/release/humble/usb_cam/0.4.2-1.tar.gz";
    name = "0.4.2-1.tar.gz";
    sha256 = "d393c849c4c3d18ff61151d7a8770f5ef5420b6f582e46ad2c2c38d72314bc73";
  };
