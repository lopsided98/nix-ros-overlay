...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/humble/ament_cmake_google_benchmark/1.3.2-1.tar.gz";
    name = "1.3.2-1.tar.gz";
    sha256 = "97c20a8dd345b8c873bec8f374ba0293ff4f8d5aad96a6977f527015eb8e0673";
  };
