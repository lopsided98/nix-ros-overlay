...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/warehouse_ros-release/archive/release/humble/warehouse_ros/2.0.9-1.tar.gz";
    name = "2.0.9-1.tar.gz";
    sha256 = "dd063409b95609f628a65d23f505633c429033a69cd83b77be4d7349c8a11475";
  };
