...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/turtlebot3-release/archive/release/humble/turtlebot3/2.3.3-1.tar.gz";
    name = "2.3.3-1.tar.gz";
    sha256 = "4cfa4e26793a8c279325a4f477bd22b9f7239faadbd6970f38efecd2fb3f8d5a";
  };
