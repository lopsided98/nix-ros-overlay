...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/turtlebot3-release/archive/release/humble/turtlebot3/2.3.6-1.tar.gz";
    name = "2.3.6-1.tar.gz";
    sha256 = "ffaf81b48ddcc1b86dbd2e12b9f3b724c5aa0021beda0e78df6585b592f6d82f";
  };
