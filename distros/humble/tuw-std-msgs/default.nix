...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/tuw_msgs-release/archive/release/humble/tuw_std_msgs/0.2.3-1.tar.gz";
    name = "0.2.3-1.tar.gz";
    sha256 = "5b6fe89ead184d491abb6128d5c165ff3c3fc63036110b5962358adb6c8d7f1d";
  };
