...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/laser_geometry-release/archive/release/humble/laser_geometry/2.4.1-1.tar.gz";
    name = "2.4.1-1.tar.gz";
    sha256 = "4e7ff0857dd81f9759bdb06c303489f2539600cc076d7e639118865401dc9d3d";
  };
