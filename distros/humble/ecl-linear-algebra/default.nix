...
buildRosPackage {
  pname = "ros-humble-ecl-linear-algebra";
  version = "1.2.1-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/humble/ecl_linear_algebra/1.2.1-1.tar.gz";
    name = "1.2.1-1.tar.gz";
    sha256 = "fc486096134dbb35574e53f8853e873de0f3c76e574ce0758c1a1da5e8365d34";
  };
