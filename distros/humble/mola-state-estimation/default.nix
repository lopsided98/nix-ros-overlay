...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_state_estimation-release/archive/release/humble/mola_state_estimation/1.8.1-1.tar.gz";
    name = "1.8.1-1.tar.gz";
    sha256 = "df73ce14b993eeed12c64975101c75145019aeb322b7967a3b54e3fff80cf139";
  };
