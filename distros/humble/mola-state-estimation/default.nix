...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_state_estimation-release/archive/release/humble/mola_state_estimation/2.0.1-1.tar.gz";
    name = "2.0.1-1.tar.gz";
    sha256 = "4f281446168ce865676f64476ec8417eb9aa0cc3076de799c0e55078a8411ad0";
  };
