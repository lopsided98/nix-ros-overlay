...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt-release/archive/release/humble/rqt/1.1.5-2.tar.gz";
    name = "1.1.5-2.tar.gz";
    sha256 = "c31811071043b0c141f5fae913cee215b5e676ae11198782b946ab8ea9e30c27";
  };
