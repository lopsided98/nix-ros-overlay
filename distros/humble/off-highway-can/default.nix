...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/off_highway_sensor_drivers-release/archive/release/humble/off_highway_can/0.11.0-1.tar.gz";
    name = "0.11.0-1.tar.gz";
    sha256 = "51e2afe494e7689a9f1c001270832490ab7bdfaf6a52d5464272b2a88a0071b1";
  };
