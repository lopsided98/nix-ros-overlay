...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/off_highway_sensor_drivers-release/archive/release/humble/off_highway_can/0.6.1-1.tar.gz";
    name = "0.6.1-1.tar.gz";
    sha256 = "fcb96f826de5bf7b9434d77b1d5b365266a25fdea0b3bee418a1e48a53e55d95";
  };
