...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/humble/swri_opencv_util/3.12.0-1.tar.gz";
    name = "3.12.0-1.tar.gz";
    sha256 = "6f8406e4bd9118f93976469c6a4454fb1b5aa713e4e46853413155eaaabdbced";
  };
