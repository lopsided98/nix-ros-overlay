...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mujoco_ros2_control-release/archive/release/humble/mujoco_ros2_control/0.0.2-1.tar.gz";
    name = "0.0.2-1.tar.gz";
    sha256 = "8ccc2f53c3cfd5d3d3851f059854bb4306190dc1310274c201d32f354824c8b9";
  };
