...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/humble/mrpt_msgs_bridge/2.2.3-1.tar.gz";
    name = "2.2.3-1.tar.gz";
    sha256 = "4eafd36c57a42b00b14697c48e3dddb9d43321643a9b01ce46ba3820090e012e";
  };
