...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/humble/topic_monitor/0.20.10-1.tar.gz";
    name = "0.20.10-1.tar.gz";
    sha256 = "b990a6b7a8d24b9d0b5a031c82c1a36b2d2bd4cabd4a0d29fc29acb40851e7cf";
  };
