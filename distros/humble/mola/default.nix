...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/humble/mola/1.0.4-1.tar.gz";
    name = "1.0.4-1.tar.gz";
    sha256 = "b1449d2e9dfe7625bd0887bf09500f4ba1b52b693ac248665b220bdf147a4a5f";
  };
