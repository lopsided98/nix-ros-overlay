...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/humble/mola/1.0.5-1.tar.gz";
    name = "1.0.5-1.tar.gz";
    sha256 = "eaac42c5ff2d0b0ba01352d4f2a8836d2a7b5a0f96b6e5d3bc1885350b16b8f0";
  };
