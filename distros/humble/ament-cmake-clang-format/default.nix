...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_cmake_clang_format/0.12.10-1.tar.gz";
    name = "0.12.10-1.tar.gz";
    sha256 = "739d2394dd8befc383e6045793451e75ea4f5aaa859627910a1768e196648d1f";
  };
