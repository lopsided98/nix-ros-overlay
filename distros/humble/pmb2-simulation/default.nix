...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/pal-gbp/pmb2_simulation-release/archive/release/humble/pmb2_simulation/4.0.11-1.tar.gz";
    name = "4.0.11-1.tar.gz";
    sha256 = "8ef18675ecf03f6c712fe65e59c7e3904ebb08fc6a89491e439201c8df284048";
  };
