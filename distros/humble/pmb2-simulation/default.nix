...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/pmb2_simulation-release/archive/release/humble/pmb2_simulation/4.14.0-1.tar.gz";
    name = "4.14.0-1.tar.gz";
    sha256 = "4850d4eb7fbaa5c62ddfc3e1a7b8c52ff2ef1dde13ebb376326325dc044e2f3b";
  };
