...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/humble/rcl_action/5.3.7-1.tar.gz";
    name = "5.3.7-1.tar.gz";
    sha256 = "6f7ff71c5675b606737e135071cfe5e3ac2a608e9cf717e32ffaae4313553957";
  };
