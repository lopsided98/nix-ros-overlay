...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/humble/launch_ros/0.19.13-1.tar.gz";
    name = "0.19.13-1.tar.gz";
    sha256 = "7e621f1a208990d35c22bc4bb3dc902d9ad0043e8ad2dd96acf4588f251ff1dd";
  };
