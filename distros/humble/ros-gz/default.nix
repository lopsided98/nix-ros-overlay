...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_gz/0.244.11-1.tar.gz";
    name = "0.244.11-1.tar.gz";
    sha256 = "6c05f08b4bf6bd41a58d518e5b153dec209bb3e57a34bf7c90bef0bb96827eeb";
  };
