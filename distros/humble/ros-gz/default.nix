...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_gz/0.244.21-1.tar.gz";
    name = "0.244.21-1.tar.gz";
    sha256 = "560bfd47fcb131dfe9bbdd3cca711203fa3c1cf2d72294ad2f8d174c1b239fce";
  };
