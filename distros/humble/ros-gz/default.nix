...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/humble/ros_gz/0.244.23-1.tar.gz";
    name = "0.244.23-1.tar.gz";
    sha256 = "5469d84a29ed0d852c3c6cffeac0b12bda46e3a30a2eecfffb317c2640912b01";
  };
