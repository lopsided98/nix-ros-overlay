...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch-release/archive/release/humble/launch_testing/1.0.11-1.tar.gz";
    name = "1.0.11-1.tar.gz";
    sha256 = "36bc0932d4e79bf98524349c9ff750db4587bbe741abb31e36043eaa276001c7";
  };
