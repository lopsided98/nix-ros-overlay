...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch-release/archive/release/humble/launch_testing/1.0.13-1.tar.gz";
    name = "1.0.13-1.tar.gz";
    sha256 = "8dc19c7021039944060a3927c465f167ade5726e03789cefa40d2f55aca8380a";
  };
