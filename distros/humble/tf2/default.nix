...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2/0.25.18-1.tar.gz";
    name = "0.25.18-1.tar.gz";
    sha256 = "d5085eaaff3ee9b4fdae1926debec34406ef9195ee4fbbc063501deb6e0fd140";
  };
