...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2/0.25.20-2.tar.gz";
    name = "0.25.20-2.tar.gz";
    sha256 = "f67333e1fcf3bbbff8c632784c59d645f2e1944642179f76de79d882715ad063";
  };
