...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2/0.25.23-1.tar.gz";
    name = "0.25.23-1.tar.gz";
    sha256 = "718902fb2df34b0dd4bd365498fec619d2b55c4a65d59c52401d0c4655f45d16";
  };
