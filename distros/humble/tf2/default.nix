...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2/0.25.17-1.tar.gz";
    name = "0.25.17-1.tar.gz";
    sha256 = "078b8aa0714b4534388c0830d4d4986d50971230c3e064535173a49f353df5b1";
  };
