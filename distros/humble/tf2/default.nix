...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2/0.25.19-1.tar.gz";
    name = "0.25.19-1.tar.gz";
    sha256 = "828c96a783b60eb0ef82d18c5a9a98747c7b40a7f601935273be462a3ed2e5ed";
  };
