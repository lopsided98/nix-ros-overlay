...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/event_camera_msgs-release/archive/release/humble/event_camera_msgs/2.0.1-1.tar.gz";
    name = "2.0.1-1.tar.gz";
    sha256 = "fd132dcfc4a511ac95506b8370ae47d67a4daddb2ebb4275d9d91f419162f54c";
  };
