...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_bag-release/archive/release/humble/rqt_bag_plugins/1.1.6-1.tar.gz";
    name = "1.1.6-1.tar.gz";
    sha256 = "7414d1f230d68a6de242e8e004a020521dbeae055c28ab90e1abb11896312d39";
  };
