...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/pal_urdf_utils-release/archive/release/humble/pal_urdf_utils/2.11.1-1.tar.gz";
    name = "2.11.1-1.tar.gz";
    sha256 = "bfb953a05c91b964d2b0105e67eb3992970516cb455e59462ce11d968ae787ee";
  };
