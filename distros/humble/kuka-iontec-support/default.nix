...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/kuka_robot_descriptions-release/archive/release/humble/kuka_iontec_support/1.1.2-1.tar.gz";
    name = "1.1.2-1.tar.gz";
    sha256 = "80e129940c59e2c127f0f5ff9de72683bae295260b510ae77cd6e72970a257db";
  };
