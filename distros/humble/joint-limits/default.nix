...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/humble/joint_limits/2.54.0-1.tar.gz";
    name = "2.54.0-1.tar.gz";
    sha256 = "632896eade52ffdd74b5ed0d7146415cc0987f3269268e3d63c3252b227b62be";
  };
