...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/humble/joint_limits/2.53.0-1.tar.gz";
    name = "2.53.0-1.tar.gz";
    sha256 = "023de0958b3be670829e146452fee9c12b57a3aa1273099eaa8962349e021940";
  };
