...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/humble/joint_limits/2.53.1-1.tar.gz";
    name = "2.53.1-1.tar.gz";
    sha256 = "487f6fb617800215786e72cb39fe0b64fb5f6f6152976962025131377163f96e";
  };
