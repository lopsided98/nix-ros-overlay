...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mp2p_icp-release/archive/release/humble/mp2p_icp_core/2.14.1-1.tar.gz";
    name = "2.14.1-1.tar.gz";
    sha256 = "689a78536e7dc1bfb418db3d3ed887c95859d40d78b4054b4ffbe9f6200e9ca5";
  };
