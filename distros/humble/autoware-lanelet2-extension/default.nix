...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_lanelet2_extension-release/archive/release/humble/autoware_lanelet2_extension/0.10.0-1.tar.gz";
    name = "0.10.0-1.tar.gz";
    sha256 = "a885c29073a3deae8a097aaee4270c9dafbea8deda168dcb4e343cf102a897b2";
  };
