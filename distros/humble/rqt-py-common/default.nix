...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt-release/archive/release/humble/rqt_py_common/1.1.9-1.tar.gz";
    name = "1.1.9-1.tar.gz";
    sha256 = "954549b5be351d05f66d975ae33212c51817cea2e1def2c3f98e9f56f5e9609e";
  };
