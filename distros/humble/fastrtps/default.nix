...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fastdds-release/archive/release/humble/fastrtps/2.6.12-1.tar.gz";
    name = "2.6.12-1.tar.gz";
    sha256 = "432299137ed144705131e7a16267f788ebdd760be5c77370a7911bb72efb7511";
  };
