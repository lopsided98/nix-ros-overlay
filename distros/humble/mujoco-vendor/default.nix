...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mujoco_vendor-release/archive/release/humble/mujoco_vendor/0.1.0-1.tar.gz";
    name = "0.1.0-1.tar.gz";
    sha256 = "37b448c4fc49d1c76e39999f8dd2da9f0aceba0287615cc280312cc9e01dbf6c";
  };
