...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/pmb2_robot-release/archive/release/humble/pmb2_robot/5.12.2-1.tar.gz";
    name = "5.12.2-1.tar.gz";
    sha256 = "f717f64c9e13394b170685d367ee96cb0df132fb3dbeaa2e17dbb7aaf443a0a0";
  };
