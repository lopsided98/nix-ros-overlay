...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/pal-gbp/pmb2_robot-gbp/archive/release/humble/pmb2_robot/5.0.20-1.tar.gz";
    name = "5.0.20-1.tar.gz";
    sha256 = "ecfe003db22d087b0d3e2b5e68e62bdb4ae66d8732291589b99ed3aed75dadea";
  };
