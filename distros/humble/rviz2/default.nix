...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz2/11.2.24-1.tar.gz";
    name = "11.2.24-1.tar.gz";
    sha256 = "cd9872feb73f002bed4eaff459f739b44620998dce703ac4ead6acc369a96d51";
  };
