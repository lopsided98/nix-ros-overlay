...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz2/11.2.28-1.tar.gz";
    name = "11.2.28-1.tar.gz";
    sha256 = "e3ab19e12dcf949ecb5235728068574253051d825a943d1fe3c60e6fc1a6fe91";
  };
