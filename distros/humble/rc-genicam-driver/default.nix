...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rc_genicam_driver_ros2-release/archive/release/humble/rc_genicam_driver/0.4.0-1.tar.gz";
    name = "0.4.0-1.tar.gz";
    sha256 = "0926a9942b33b75c8c495b3cf9b4ae879daa7ff1323e4c0c9accb195d56bb3cd";
  };
