...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_compression_zstd/0.15.15-1.tar.gz";
    name = "0.15.15-1.tar.gz";
    sha256 = "b3deefe8153f16ce7f008c2bf7406a37ca646c2686f916290f8a7afd6b659f9d";
  };
