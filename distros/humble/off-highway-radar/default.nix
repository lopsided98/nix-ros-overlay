...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/off_highway_sensor_drivers-release/archive/release/humble/off_highway_radar/0.9.0-1.tar.gz";
    name = "0.9.0-1.tar.gz";
    sha256 = "04f4f6c6a380330ec2c73b614587abbaaec7571225d2d22b8dd061d7f8eef397";
  };
