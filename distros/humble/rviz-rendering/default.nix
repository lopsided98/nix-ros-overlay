...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_rendering/11.2.4-1.tar.gz";
    name = "11.2.4-1.tar.gz";
    sha256 = "f86fca75d9f67c1aafe4cddd7b18842a94c080746fe12b3f51da1e1c7ff067da";
  };
