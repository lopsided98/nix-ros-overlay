...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_rendering/11.2.28-1.tar.gz";
    name = "11.2.28-1.tar.gz";
    sha256 = "da417fec669e17715377a1eef13579e5668cc768316d4766ea4e0a586efe1a9d";
  };
