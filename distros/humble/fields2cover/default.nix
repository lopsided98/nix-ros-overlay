...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fields2cover-release/archive/release/humble/fields2cover/2.1.1-1.tar.gz";
    name = "2.1.1-1.tar.gz";
    sha256 = "677cfc681ab85702340295febd83469516ae232a063261dc22f17f85deeeed80";
  };
