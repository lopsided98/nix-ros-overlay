...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/aerostack2-release/archive/release/humble/as2_alphanumeric_viewer/1.1.3-1.tar.gz";
    name = "1.1.3-1.tar.gz";
    sha256 = "116bd1cd587cdb2dc5208f42ee174958a10052cbe9dc60008f549fbb076f46df";
  };
