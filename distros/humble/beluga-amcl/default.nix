...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/beluga-release/archive/release/humble/beluga_amcl/2.0.1-1.tar.gz";
    name = "2.0.1-1.tar.gz";
    sha256 = "e200f4575418e62ea7ae2318242014bfd815ca9a218cc41bfc968b38651d4643";
  };
