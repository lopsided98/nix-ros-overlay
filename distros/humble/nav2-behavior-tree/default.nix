...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_behavior_tree/1.1.20-1.tar.gz";
    name = "1.1.20-1.tar.gz";
    sha256 = "3d7a2d91115b192eaff8b608babafa300fd72279eb616b1ce3837e22cfa81480";
  };
