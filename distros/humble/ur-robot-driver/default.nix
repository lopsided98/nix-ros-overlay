...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/humble/ur_robot_driver/2.2.13-1.tar.gz";
    name = "2.2.13-1.tar.gz";
    sha256 = "a62266e145d29cc4d454e562022906937dbaab5788fd6a814544200ed2718c16";
  };
