...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/humble/ur_robot_driver/2.2.16-5.tar.gz";
    name = "2.2.16-5.tar.gz";
    sha256 = "6d81ff8e90fc3678f21e9d3820d2e5264602db4ed99e2fbb72d4064d1df1b5f2";
  };
