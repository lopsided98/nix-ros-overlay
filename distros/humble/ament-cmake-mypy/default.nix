...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/humble/ament_cmake_mypy/0.12.13-1.tar.gz";
    name = "0.12.13-1.tar.gz";
    sha256 = "94058fa66aaeb93b43e0a4c6cdcb2e4b13107e195028d4a5d161b97715ed6274";
  };
