...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/humble/rmw_fastrtps_cpp/6.2.5-1.tar.gz";
    name = "6.2.5-1.tar.gz";
    sha256 = "69dd85b7038fb9268fecb2b03dbe0573933fed760fff27f9a8790b21bb6a6121";
  };
