...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2topic/0.18.16-1.tar.gz";
    name = "0.18.16-1.tar.gz";
    sha256 = "05657c1d5e911f35b6279377e51fa1a3b624586109f444fc3fc5348fa15cdc86";
  };
