...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2topic/0.18.5-1.tar.gz";
    name = "0.18.5-1.tar.gz";
    sha256 = "6eb11880928a496882ac62dee434d1d93287dae7f85ee054c29b2c349d855255";
  };
