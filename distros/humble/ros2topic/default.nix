...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2topic/0.18.19-1.tar.gz";
    name = "0.18.19-1.tar.gz";
    sha256 = "042da9043d57d6bc095a6be8f82510d6b00c4442636ad362bba8710da18fdfa8";
  };
