...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/humble/ros2topic/0.18.15-1.tar.gz";
    name = "0.18.15-1.tar.gz";
    sha256 = "c5786da08dd03b8e5c978ce74fa541c38a7ed48d9e1b59575be464613de1a924";
  };
