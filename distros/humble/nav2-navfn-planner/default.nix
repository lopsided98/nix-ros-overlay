...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/humble/nav2_navfn_planner/1.1.20-1.tar.gz";
    name = "1.1.20-1.tar.gz";
    sha256 = "a4fc4bf18a0ed2eb6b066617933781f8df156b867eb2ca74fbb7fd4ee7dd02ad";
  };
