...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/apriltag_detector-release/archive/release/humble/apriltag_tools/3.0.2-1.tar.gz";
    name = "3.0.2-1.tar.gz";
    sha256 = "5d251a2c4ef4414437689fb2367d10cca7e3c55d22a83b26f9a5df45a4e72ed1";
  };
