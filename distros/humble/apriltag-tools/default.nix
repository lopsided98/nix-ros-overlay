...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/apriltag_detector-release/archive/release/humble/apriltag_tools/3.0.3-1.tar.gz";
    name = "3.0.3-1.tar.gz";
    sha256 = "4adce49049fb16a83375960cad474453cc2ecbc8dc219a80649eb44f241eff60";
  };
