...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros_bridge-release/archive/release/humble/rosbag2rawlog/3.5.3-1.tar.gz";
    name = "3.5.3-1.tar.gz";
    sha256 = "a455c1acff12ce757d40a18eee26221c9dffe0f08602a25e5ec828cd14c0dc2e";
  };
