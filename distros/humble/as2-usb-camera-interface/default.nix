...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/aerostack2-release/archive/release/humble/as2_usb_camera_interface/1.1.3-1.tar.gz";
    name = "1.1.3-1.tar.gz";
    sha256 = "12cb76863cdb330641b76bd9dc5d041a9ebbd4c28e6084cf75f07fc434669c60";
  };
