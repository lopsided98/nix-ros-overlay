...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_rendering_tests/11.2.25-1.tar.gz";
    name = "11.2.25-1.tar.gz";
    sha256 = "0002a15ccbd1a030141ebc0ee4efded074e39f722925b942ecb18c425aa4271a";
  };
