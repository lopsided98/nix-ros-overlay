...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_rendering_tests/11.2.2-1.tar.gz";
    name = "11.2.2-1.tar.gz";
    sha256 = "262c129b44db75ab265fb78898bffe0fa2359a10baecb400c704daf498e51078";
  };
