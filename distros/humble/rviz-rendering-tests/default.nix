...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_rendering_tests/11.2.26-1.tar.gz";
    name = "11.2.26-1.tar.gz";
    sha256 = "83999ae9f272c3a5e30bde853af47fb788e55fbf7a0a6a70d1cefcd3683eab53";
  };
