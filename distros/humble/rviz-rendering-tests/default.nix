...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/humble/rviz_rendering_tests/11.2.29-1.tar.gz";
    name = "11.2.29-1.tar.gz";
    sha256 = "bdeede896ab13d715f27673442bc835870555c3951f77194bb7259cd0ed28a55";
  };
