...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/pal-gbp/tiago_simulation-release/archive/release/humble/tiago_gazebo/4.0.3-1.tar.gz";
    name = "4.0.3-1.tar.gz";
    sha256 = "cd76db0b1dec5859f564534edc86ffb19afc01bf1f6c4bcfa93793fd37c07361";
  };
