...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/pal-gbp/tiago_simulation-release/archive/release/humble/tiago_gazebo/4.1.6-1.tar.gz";
    name = "4.1.6-1.tar.gz";
    sha256 = "16dd2cda1ddf1b2263051b156040119c81ee39ed290a6dfe4932232253e2ea51";
  };
