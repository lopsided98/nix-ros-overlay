...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/tiago_simulation-release/archive/release/humble/tiago_gazebo/4.13.0-1.tar.gz";
    name = "4.13.0-1.tar.gz";
    sha256 = "5b0decebecc1cbf1fb0ac4ac4abce8db42801869401eda472a0fa35ead14043f";
  };
