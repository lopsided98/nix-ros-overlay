...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_storage_mcap/0.15.9-1.tar.gz";
    name = "0.15.9-1.tar.gz";
    sha256 = "d13bf642260aaee1911e71c5828ed476a6f330c142139495dc037b195cde2925";
  };
