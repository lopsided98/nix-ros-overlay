...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_storage_mcap/0.15.17-1.tar.gz";
    name = "0.15.17-1.tar.gz";
    sha256 = "7879cf2d8474d5ec43c82895efb3f0ec610e3bef901268e284b2baa2642412cf";
  };
