...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2_storage_mcap-release/archive/release/humble/rosbag2_storage_mcap/0.6.0-1.tar.gz";
    name = "0.6.0-1.tar.gz";
    sha256 = "8f8f48cd3a3e2b3f0b71420794b9c8bf769663ff7adf391a5a4157f335822b39";
  };
