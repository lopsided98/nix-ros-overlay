...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_storage_mcap/0.15.5-1.tar.gz";
    name = "0.15.5-1.tar.gz";
    sha256 = "68307b213850524e9eba80285f189b7931f8efd9884e0cccdecec13487eb0bb1";
  };
