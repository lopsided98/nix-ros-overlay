...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/pal-gbp/tiago_robot-release/archive/release/humble/tiago_description/4.0.6-1.tar.gz";
    name = "4.0.6-1.tar.gz";
    sha256 = "3ec0ecac55075b04168c94b49a82c1396797f88a142620fce90a646612814d42";
  };
