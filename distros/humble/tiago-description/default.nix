...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/pal-gbp/tiago_robot-release/archive/release/humble/tiago_description/4.0.7-1.tar.gz";
    name = "4.0.7-1.tar.gz";
    sha256 = "89f8cd7193516cb9268eaafa5ddf3106e1b3eee9200895215cef5f2801993ae7";
  };
