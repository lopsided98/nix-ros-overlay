...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/pal-gbp/tiago_robot-release/archive/release/humble/tiago_description/4.22.0-1.tar.gz";
    name = "4.22.0-1.tar.gz";
    sha256 = "607a29998a16ab58b5ed478c996ea90e5d2e4aaa7a6e3b164a3921532adfce58";
  };
