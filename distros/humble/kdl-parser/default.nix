...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/kdl_parser-release/archive/release/humble/kdl_parser/2.6.2-2.tar.gz";
    name = "2.6.2-2.tar.gz";
    sha256 = "a820e616e4ea626e1aeb2b97d4135b48228158b3fb56b4406b1b26aff44566eb";
  };
