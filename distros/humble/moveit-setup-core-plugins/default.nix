...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/humble/moveit_setup_core_plugins/2.5.10-1.tar.gz";
    name = "2.5.10-1.tar.gz";
    sha256 = "1d960c827946cc6e9cfe65b3d485c1b23bd6bdd15ced0fa6e164accf4a5e9bb2";
  };
