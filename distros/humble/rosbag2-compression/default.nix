...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_compression/0.15.16-1.tar.gz";
    name = "0.15.16-1.tar.gz";
    sha256 = "acc645f52ed8fdc95cb6685ad7db49ee2102c2a900c3423b9c082c675e044831";
  };
