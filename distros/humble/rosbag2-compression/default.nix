...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2_compression/0.15.5-1.tar.gz";
    name = "0.15.5-1.tar.gz";
    sha256 = "70017a5143a3042cb258502b07bbaf1c9cb678940fbaa8713b4f34a7d7bfdd02";
  };
