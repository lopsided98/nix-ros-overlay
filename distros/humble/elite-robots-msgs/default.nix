...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/EliteRobots/Elite_Robots_CS_ROS2_Driver-release/archive/release/humble/elite_robots_msgs/1.0.3-1.tar.gz";
    name = "1.0.3-1.tar.gz";
    sha256 = "b55b923c11b95f10bc27cc82cf74b4bc258505b3cdcdf09bc1bd191473d1c2ab";
  };
