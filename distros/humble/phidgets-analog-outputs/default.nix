...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/humble/phidgets_analog_outputs/2.3.4-1.tar.gz";
    name = "2.3.4-1.tar.gz";
    sha256 = "f26d4b9434d03e5379a8d0535624f7572a9acb24847130e696befb56ac685ceb";
  };
