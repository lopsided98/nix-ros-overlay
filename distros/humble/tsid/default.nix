...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/tsid-release/archive/release/humble/tsid/1.10.0-1.tar.gz";
    name = "1.10.0-1.tar.gz";
    sha256 = "0910ab96770cdf1888481c2b16a20d816c9b716712cbd0667ac10d458288230f";
  };
