...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/joint_trajectory_controller/2.48.0-1.tar.gz";
    name = "2.48.0-1.tar.gz";
    sha256 = "a490f066a18d3e0f6579322f069b2e655a98fbd1abf91596ec9dad231eb3aec5";
  };
