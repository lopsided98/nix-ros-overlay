...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/joint_trajectory_controller/2.47.0-1.tar.gz";
    name = "2.47.0-1.tar.gz";
    sha256 = "c2ddf24349908885dbf38aed8a23a2f235a66e71b2bb41139971b4a676c886ec";
  };
