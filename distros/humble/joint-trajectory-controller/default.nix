...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/joint_trajectory_controller/2.17.3-1.tar.gz";
    name = "2.17.3-1.tar.gz";
    sha256 = "4ecdc9c6569b86f3dd8a90204de71bea19fb1b756f69033ef02e763876360a8a";
  };
