...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/joint_trajectory_controller/2.50.2-1.tar.gz";
    name = "2.50.2-1.tar.gz";
    sha256 = "0af8771b679d5e164139122a0ef0b97ed87837b7af870fe6b93c52b1b8a0d8cd";
  };
