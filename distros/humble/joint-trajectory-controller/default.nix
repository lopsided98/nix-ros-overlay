...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/joint_trajectory_controller/2.14.0-1.tar.gz";
    name = "2.14.0-1.tar.gz";
    sha256 = "e83c7818090c9f9025e8ded62596f9b6081009a5ed3d6a2ad604ce8754ec7a9f";
  };
