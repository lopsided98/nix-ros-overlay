...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/joint_trajectory_controller/2.35.0-1.tar.gz";
    name = "2.35.0-1.tar.gz";
    sha256 = "e469090954068b29c4abeb4eda3afa92d883d4d0bb103ea6782e545cb0e4ea4b";
  };
