...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/joint_trajectory_controller/2.31.0-1.tar.gz";
    name = "2.31.0-1.tar.gz";
    sha256 = "03d14c83457099c94c1dc9eca0b12eabc012c0645f8ac0252329886fc500f415";
  };
