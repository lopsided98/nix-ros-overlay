...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/joint_trajectory_controller/2.49.0-1.tar.gz";
    name = "2.49.0-1.tar.gz";
    sha256 = "701862b0fb20315bbce7d658e140eeca7256f151391eeeef42ff95b4dda5bcc0";
  };
