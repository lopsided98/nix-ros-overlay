...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/pal-gbp/tiago_robot-release/archive/release/humble/tiago_robot/4.2.13-1.tar.gz";
    name = "4.2.13-1.tar.gz";
    sha256 = "f1670f34c81d2e4adc34ded40576eaf60282fdeedd2d9ec72398e7228f7df17d";
  };
