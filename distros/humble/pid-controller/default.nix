...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/pid_controller/2.37.1-1.tar.gz";
    name = "2.37.1-1.tar.gz";
    sha256 = "a575579874d56b24cc4a6a53d82d79d01837ba8c44bb30044909ec0548f7f4be";
  };
