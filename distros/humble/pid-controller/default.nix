...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/pid_controller/2.51.0-1.tar.gz";
    name = "2.51.0-1.tar.gz";
    sha256 = "d8fbf2dff6c72777de79ee1e6c75a891edb71446048e319dc9698787c6c65888";
  };
