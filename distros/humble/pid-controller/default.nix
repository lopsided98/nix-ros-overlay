...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/humble/pid_controller/2.50.2-1.tar.gz";
    name = "2.50.2-1.tar.gz";
    sha256 = "b53d84656b8b3d8a4bcb21505a0fb8949047636e0fd7a4f6c5a1e4da26015798";
  };
