...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/humble/mrpt_libbase/2.15.15-1.tar.gz";
    name = "2.15.15-1.tar.gz";
    sha256 = "7ae43797cb2963dc3557dca8ea110289c69e51642972495f35a6ba50c7b35944";
  };
