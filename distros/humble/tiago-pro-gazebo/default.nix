...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/tiago_pro_simulation-release/archive/release/humble/tiago_pro_gazebo/1.19.0-1.tar.gz";
    name = "1.19.0-1.tar.gz";
    sha256 = "9708524ccb62d0ffe70221a0496e684d69372b76c31286616f3984788f9ee2e8";
  };
