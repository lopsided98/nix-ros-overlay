...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/off_highway_sensor_drivers-release/archive/release/humble/off_highway_premium_radar_sample/0.6.1-1.tar.gz";
    name = "0.6.1-1.tar.gz";
    sha256 = "268a1cf4d7be4ff00ccd7023ae9b7f50e1e85c48d06db98e7a18138d2072a053";
  };
