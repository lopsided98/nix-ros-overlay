...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_state_estimation-release/archive/release/humble/mola_gtsam_factors/2.0.1-1.tar.gz";
    name = "2.0.1-1.tar.gz";
    sha256 = "7364ce064bfc19dc35ae49ffac56e6f61e0eea5886f885d1a00d4a807a17a92b";
  };
