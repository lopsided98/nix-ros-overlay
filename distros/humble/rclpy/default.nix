...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclpy-release/archive/release/humble/rclpy/3.3.18-1.tar.gz";
    name = "3.3.18-1.tar.gz";
    sha256 = "2cea93edeaa99098efc6d6762728b55cd1625ff5239aedc0490b8af2507c0d96";
  };
