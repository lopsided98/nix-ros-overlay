...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclpy-release/archive/release/humble/rclpy/3.3.17-1.tar.gz";
    name = "3.3.17-1.tar.gz";
    sha256 = "bca737b407702c544fda24714a091f466f4fc0c373bb2964ab89b34ef1586251";
  };
