...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt2-release/archive/release/humble/mrpt2/2.13.1-1.tar.gz";
    name = "2.13.1-1.tar.gz";
    sha256 = "b25e08257d8412f570e9ed6955c99189752f3b75bb44651b5bd7c6062210d522";
  };
