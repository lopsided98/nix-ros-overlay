...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/humble/tf2_msgs/0.25.15-1.tar.gz";
    name = "0.25.15-1.tar.gz";
    sha256 = "998448f6d0eb9f629c3d4dc55a95bef742bf13e7d90de095983625a35477445a";
  };
