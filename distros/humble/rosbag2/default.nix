...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2/0.15.9-1.tar.gz";
    name = "0.15.9-1.tar.gz";
    sha256 = "91395c3c05b5606042eda61df65cf32b6a8d0aea1340eac48c5e9fe289d60228";
  };
