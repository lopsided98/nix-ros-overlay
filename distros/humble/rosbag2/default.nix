...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2/0.15.6-1.tar.gz";
    name = "0.15.6-1.tar.gz";
    sha256 = "62cf0df52841a7098a31fcb81c7962797826837f67565c0fc63a61d5600236af";
  };
