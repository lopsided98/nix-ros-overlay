...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/humble/rosbag2/0.15.4-2.tar.gz";
    name = "0.15.4-2.tar.gz";
    sha256 = "ecd29e09678ca364e5e8050dfdd2c439790ad2b02fe328e838418ccb868d06f6";
  };
