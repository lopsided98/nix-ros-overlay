...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/dashing/rosidl_parser/0.7.10-1.tar.gz";
    name = "0.7.10-1.tar.gz";
    sha256 = "6e9ed94438dea7d64fc94589c2b725404ac49ce668bb2d7d77ae9794e4c4af55";
  };
