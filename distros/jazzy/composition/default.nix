...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/jazzy/composition/0.33.3-1.tar.gz";
    name = "0.33.3-1.tar.gz";
    sha256 = "d53cbae29be950d9461c2d6d81a94cbfccc5279984504f7d858f333f890fb71d";
  };
