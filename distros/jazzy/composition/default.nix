...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/jazzy/composition/0.33.8-1.tar.gz";
    name = "0.33.8-1.tar.gz";
    sha256 = "3ea18d93566003c09d2f662a4a9a4b36ff61e814525dcaddfe27eb799cb2dd0d";
  };
