...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/examples_tf2_py/0.36.13-1.tar.gz";
    name = "0.36.13-1.tar.gz";
    sha256 = "de9274e0971b32bc3169698f5cf3772a7dc5eb70137dd0f5d8d7cd2dca265f8e";
  };
