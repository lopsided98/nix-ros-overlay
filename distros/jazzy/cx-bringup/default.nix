...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/clips_executive-release/archive/release/jazzy/cx_bringup/0.1.3-1.tar.gz";
    name = "0.1.3-1.tar.gz";
    sha256 = "5de2f498dc5ff48356b874ae3174c13bde7c7535de2b44aa6da341d91c512176";
  };
