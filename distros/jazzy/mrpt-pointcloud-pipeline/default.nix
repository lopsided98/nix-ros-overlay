...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/jazzy/mrpt_pointcloud_pipeline/2.2.3-1.tar.gz";
    name = "2.2.3-1.tar.gz";
    sha256 = "02b9af7435246f2f309434e7f4feedcd2ab86e3922a4ae3b6aa6b8a50f34bc99";
  };
