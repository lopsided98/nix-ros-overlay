...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_cmake_uncrustify/0.17.0-2.tar.gz";
    name = "0.17.0-2.tar.gz";
    sha256 = "1fe2092c97cfb1a09d95036284f39584fc711ca7a08f1d8623e72b3e657d2f9b";
  };
