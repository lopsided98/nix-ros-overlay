...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/jazzy/rosbag2_storage/0.26.8-1.tar.gz";
    name = "0.26.8-1.tar.gz";
    sha256 = "fb794e4d903509f012dbd56dd1d4e167a24d7f7ba7a5ac6d32acb804394c4788";
  };
