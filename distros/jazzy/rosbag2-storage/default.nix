...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/jazzy/rosbag2_storage/0.26.6-1.tar.gz";
    name = "0.26.6-1.tar.gz";
    sha256 = "636bf92a30defd2610a4cc0f27cb0f3a0ab7a4a5407aea9ef5d509b269e7cec8";
  };
