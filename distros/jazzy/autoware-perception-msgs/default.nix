...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_msgs-release/archive/release/jazzy/autoware_perception_msgs/1.12.0-1.tar.gz";
    name = "1.12.0-1.tar.gz";
    sha256 = "91b12d442889f6fecf2fa57dcc8ae90e150a8ce1a5738ea17345c16f8ba75874";
  };
