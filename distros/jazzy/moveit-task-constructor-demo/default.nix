...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit_task_constructor-release/archive/release/jazzy/moveit_task_constructor_demo/0.1.4-1.tar.gz";
    name = "0.1.4-1.tar.gz";
    sha256 = "69964b836333f6b2cf16e91ac82e0a5e8ba99cd41d08c067b71f21ef97a284cc";
  };
