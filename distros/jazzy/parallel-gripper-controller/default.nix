...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/parallel_gripper_controller/4.29.0-1.tar.gz";
    name = "4.29.0-1.tar.gz";
    sha256 = "121a596abb4a068a2057ff5b8d7d886a9e6f84d82778a9072f4d3dd2e395a76a";
  };
