...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/mecanum_drive_controller/4.40.1-1.tar.gz";
    name = "4.40.1-1.tar.gz";
    sha256 = "9bdbed5fc21520bb2741a41c278c49818d0c73085c0efebb65edb6d25f945d66";
  };
