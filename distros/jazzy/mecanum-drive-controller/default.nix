...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/mecanum_drive_controller/4.17.0-1.tar.gz";
    name = "4.17.0-1.tar.gz";
    sha256 = "0907d2ee5cdcd0b1e0da805cb47df8058bd8bee01c015bf6cd71e35a637eb080";
  };
