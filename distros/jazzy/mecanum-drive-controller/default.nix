...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/mecanum_drive_controller/4.41.0-1.tar.gz";
    name = "4.41.0-1.tar.gz";
    sha256 = "1f1f25f431681192cbaedc0551ae81573ba16d18b6174b2776c75cf108f565e2";
  };
