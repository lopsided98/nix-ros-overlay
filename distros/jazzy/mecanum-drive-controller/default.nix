...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/mecanum_drive_controller/4.26.0-1.tar.gz";
    name = "4.26.0-1.tar.gz";
    sha256 = "e9394006d1644552bc624141d8a041647a2ff923a01a156d676c7083afd6e748";
  };
