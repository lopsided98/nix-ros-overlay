...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/jazzy/clearpath_control/2.9.3-1.tar.gz";
    name = "2.9.3-1.tar.gz";
    sha256 = "e0fbea5a830fbcd6b4e28838aa808d2f960014a649a7924ee91e934dda9bb8f9";
  };
