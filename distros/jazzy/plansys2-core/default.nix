...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_planning_system-release/archive/release/jazzy/plansys2_core/2.0.15-1.tar.gz";
    name = "2.0.15-1.tar.gz";
    sha256 = "91f8c54691096f62f417d96b69282577e4efacab602ed6c8e8be36b8ad0dd687";
  };
