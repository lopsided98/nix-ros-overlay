...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/audio_common-release/archive/release/jazzy/audio_capture/0.4.0-2.tar.gz";
    name = "0.4.0-2.tar.gz";
    sha256 = "809e434835570c8e4b126e9958753569da18e7b44d19e61d8ca0e064666badcc";
  };
