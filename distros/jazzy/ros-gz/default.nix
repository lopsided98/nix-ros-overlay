...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/jazzy/ros_gz/1.0.22-1.tar.gz";
    name = "1.0.22-1.tar.gz";
    sha256 = "6d09d50e03d68e479b32ca75e37fc55aefd6fa45381b6f4ffc5a1f4544b046a2";
  };
