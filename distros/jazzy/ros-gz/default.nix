...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/jazzy/ros_gz/1.0.19-1.tar.gz";
    name = "1.0.19-1.tar.gz";
    sha256 = "a3e5ba4cd60f84e37e75491135164f758e7ed89a71e7e46007186ef500a1d2e6";
  };
