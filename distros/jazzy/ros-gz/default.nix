...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/jazzy/ros_gz/1.0.15-1.tar.gz";
    name = "1.0.15-1.tar.gz";
    sha256 = "1dc9e654dedc83458b4552c3d0d30d8b468f9858cd0bdef4c1f9e95478f0b628";
  };
