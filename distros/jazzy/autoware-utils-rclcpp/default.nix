...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/jazzy/autoware_utils_rclcpp/1.7.2-1.tar.gz";
    name = "1.7.2-1.tar.gz";
    sha256 = "4b6fb916bdd0d68854aac95cedacf7a1b0edaa298273f5176895906be2cdd486";
  };
