...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/jazzy/open_manipulator_gui/4.1.3-1.tar.gz";
    name = "4.1.3-1.tar.gz";
    sha256 = "ce5d8ba4847da9eeb4f2455cc61a5769ffbb2f7d73ebe3d36f793ab304ccd9a0";
  };
