...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-drivers-gbp/flir_ptu-release/archive/release/jazzy/flir_ptu_viz/1.0.2-1.tar.gz";
    name = "1.0.2-1.tar.gz";
    sha256 = "a0daafbbfa0618118aa08c352043323bb39e1eee6e48ee669c6f2e0e0ea1ea0e";
  };
