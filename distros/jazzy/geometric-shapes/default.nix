...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometric_shapes-release/archive/release/jazzy/geometric_shapes/2.1.3-5.tar.gz";
    name = "2.1.3-5.tar.gz";
    sha256 = "48dce574a1a1496033a5e501cc9f94c50fe03833749d553f46222445d204910c";
  };
