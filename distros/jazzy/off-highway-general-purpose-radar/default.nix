...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/off_highway_sensor_drivers-release/archive/release/jazzy/off_highway_general_purpose_radar/1.1.0-1.tar.gz";
    name = "1.1.0-1.tar.gz";
    sha256 = "8d908b6dd87038bf27019fccdeed3b18452e63742e7c91f39eac4e39dd0fe260";
  };
