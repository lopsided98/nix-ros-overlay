...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/gps_sensor_broadcaster/4.33.0-1.tar.gz";
    name = "4.33.0-1.tar.gz";
    sha256 = "ebf68fd4f36a614a8fe0db4758005b49794bd27dcbf2127c9897f34e5f050f56";
  };
