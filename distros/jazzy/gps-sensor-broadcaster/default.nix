...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/gps_sensor_broadcaster/4.30.1-1.tar.gz";
    name = "4.30.1-1.tar.gz";
    sha256 = "f39446dc8134fb4b72c8630f69e7741227e98fa7d633a8554ab928e3b6e6df59";
  };
