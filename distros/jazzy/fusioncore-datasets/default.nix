...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/manankharwar/fusioncore-release/archive/release/jazzy/fusioncore_datasets/0.3.8-1.tar.gz";
    name = "0.3.8-1.tar.gz";
    sha256 = "c9de9098f8a9eca8889ba38da28e9e4d62378a3800b425dd60c555ed23fecc95";
  };
