...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/jazzy/swri_transform_util/3.11.0-1.tar.gz";
    name = "3.11.0-1.tar.gz";
    sha256 = "adf65433c16529cea9fa2f585bf161e4b86e91354d833178371393fe30562560";
  };
