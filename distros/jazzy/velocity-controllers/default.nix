...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/velocity_controllers/4.26.0-1.tar.gz";
    name = "4.26.0-1.tar.gz";
    sha256 = "26f79034b6d53a65f18b319a4104184f4448292a92dbe06ca4370301ac794388";
  };
