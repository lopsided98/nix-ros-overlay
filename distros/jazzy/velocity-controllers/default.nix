...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/velocity_controllers/4.28.0-1.tar.gz";
    name = "4.28.0-1.tar.gz";
    sha256 = "035f7806b81c1d0d1fec005e9ed596ccf9d2b5b57166d7e966e97493f5829b35";
  };
