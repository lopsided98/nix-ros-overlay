...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/velocity_controllers/4.41.0-1.tar.gz";
    name = "4.41.0-1.tar.gz";
    sha256 = "84ea0384e785a388077af3564eacb10d10cf080cc200dc924833f38356adad81";
  };
