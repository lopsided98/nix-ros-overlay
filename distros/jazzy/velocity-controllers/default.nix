...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/velocity_controllers/4.29.0-1.tar.gz";
    name = "4.29.0-1.tar.gz";
    sha256 = "4034b01c954c50225459bd44d18c4c082d1b30097618ece9aad9037a5523ff11";
  };
