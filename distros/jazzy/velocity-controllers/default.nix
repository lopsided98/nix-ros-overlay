...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/velocity_controllers/4.30.0-1.tar.gz";
    name = "4.30.0-1.tar.gz";
    sha256 = "60a34395f9e7f577f3ce2c04db7c8879d1b60b211117e8cf1b7a86b00b09b4b1";
  };
