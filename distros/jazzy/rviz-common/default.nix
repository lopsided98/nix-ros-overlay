...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_common/14.1.17-1.tar.gz";
    name = "14.1.17-1.tar.gz";
    sha256 = "4e525e1668a1e42fd2171667c57a9b0db3e199d0825e3f000acbdb35cf0ded35";
  };
