...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_common/14.1.13-1.tar.gz";
    name = "14.1.13-1.tar.gz";
    sha256 = "828fbab9e54604f4d6a5044783904e3edc9bfb02d228136633fb7d528f688751";
  };
