...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/septentrio_gnss_driver_ros2-release/archive/release/jazzy/septentrio_gnss_driver/1.4.3-1.tar.gz";
    name = "1.4.3-1.tar.gz";
    sha256 = "4813f1bd3ee9e28316c243fc1c7d5caa2c1a11b2fc00e2024c8e7a26b12995c7";
  };
