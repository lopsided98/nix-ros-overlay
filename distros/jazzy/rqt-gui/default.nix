...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt-release/archive/release/jazzy/rqt_gui/1.6.2-2.tar.gz";
    name = "1.6.2-2.tar.gz";
    sha256 = "ea4c690c98aa1e3239e905acde6ddaf7eb698bdc34ad50a43168978520b17e06";
  };
