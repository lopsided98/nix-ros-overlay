...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_lint_common/0.17.3-1.tar.gz";
    name = "0.17.3-1.tar.gz";
    sha256 = "3c658ae89f38ee6102bab02dc0717d6c9904a43ae5e5e41ffa7293bb72ba0908";
  };
