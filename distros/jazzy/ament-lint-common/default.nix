...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_lint_common/0.17.5-1.tar.gz";
    name = "0.17.5-1.tar.gz";
    sha256 = "8b9ce8ff5ec90527efcccacf71efa1cd5d270875d548a747f74bc65701720c14";
  };
