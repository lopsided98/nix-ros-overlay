...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola/1.0.2-2.tar.gz";
    name = "1.0.2-2.tar.gz";
    sha256 = "9b007363b5a6343cf281f09a1bbcd7851e908403182f782d0240a82b578793f6";
  };
