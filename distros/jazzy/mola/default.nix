...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola/1.0.5-1.tar.gz";
    name = "1.0.5-1.tar.gz";
    sha256 = "01b25d04a6ed28e05976a498692818a904eb19ffb33fdfa4e1b01193e5b74fc7";
  };
