...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_setup_framework/2.12.4-1.tar.gz";
    name = "2.12.4-1.tar.gz";
    sha256 = "9b23a26278c583531bf4e217f2a0de3ecd9b0240a941a5c526657325ed79ae00";
  };
