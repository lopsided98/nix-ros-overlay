...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/facontidavide/cloudini-release/archive/release/jazzy/cloudini_ros/1.0.0-1.tar.gz";
    name = "1.0.0-1.tar.gz";
    sha256 = "90fde17f1fbe971b68daf2f88308e9b481b034a9bb021d8548f738d10b974a75";
  };
