...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_ros/2.12.4-1.tar.gz";
    name = "2.12.4-1.tar.gz";
    sha256 = "7564a93e213c79ad41e371b0a2f575a1159bd6448070861e068c6afef0b41054";
  };
