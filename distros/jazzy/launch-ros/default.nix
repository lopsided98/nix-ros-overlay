...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/jazzy/launch_ros/0.26.10-1.tar.gz";
    name = "0.26.10-1.tar.gz";
    sha256 = "2d5a2dc29edb0ed4d4b733cfd8cf9a75e9d1bc96174269626ea42cc126d12b93";
  };
