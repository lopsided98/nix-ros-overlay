...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/jazzy/launch_ros/0.26.13-1.tar.gz";
    name = "0.26.13-1.tar.gz";
    sha256 = "60f9dadebf183ed26210ceb8cb5cde9d2784f4c56470f723c6886a0604f87856";
  };
