...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/state_interfaces_broadcaster/4.36.0-1.tar.gz";
    name = "4.36.0-1.tar.gz";
    sha256 = "ba018796328c577e479e5593ebede0ebc24a493d5e629e668fe277dbba1bd495";
  };
