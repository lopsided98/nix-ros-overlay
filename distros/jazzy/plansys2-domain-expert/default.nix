...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_planning_system-release/archive/release/jazzy/plansys2_domain_expert/2.0.15-1.tar.gz";
    name = "2.0.15-1.tar.gz";
    sha256 = "dde9af9a4f1b8578b04157edd8db981356ec6ad48727e3172fc85dcd3c5ab218";
  };
