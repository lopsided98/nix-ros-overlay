...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/jazzy/swri_roscpp/3.7.6-1.tar.gz";
    name = "3.7.6-1.tar.gz";
    sha256 = "e6bd0cf3223affe1048b438ba2d25c020f060e65015762b0f2af6a892687c56e";
  };
