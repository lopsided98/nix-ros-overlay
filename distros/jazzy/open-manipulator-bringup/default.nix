...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/jazzy/open_manipulator_bringup/4.0.6-1.tar.gz";
    name = "4.0.6-1.tar.gz";
    sha256 = "9e51050846e4c99a5ac25f60de568a9532bfce270af87acf890a77fcd7d5d6ba";
  };
