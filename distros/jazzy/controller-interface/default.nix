...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/controller_interface/4.30.0-1.tar.gz";
    name = "4.30.0-1.tar.gz";
    sha256 = "a0c9a8248db55cb9fb307f1134f29d283740539b4b2dabbc6ac243dfa1aa091d";
  };
