...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/catch_ros2-release/archive/release/jazzy/catch_ros2/0.2.2-1.tar.gz";
    name = "0.2.2-1.tar.gz";
    sha256 = "0f3262e39d7aa9b1f0d37d9c7fb2d2d4cae93da4dd7e66570ee31406c991f61c";
  };
