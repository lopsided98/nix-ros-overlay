...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/jazzy/ffw_description/1.1.21-1.tar.gz";
    name = "1.1.21-1.tar.gz";
    sha256 = "95bcc944a854bb16612c8c505fd0377adeb4729cd5844b9bc141beb3dfce3026";
  };
