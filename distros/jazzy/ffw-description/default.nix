...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/jazzy/ffw_description/1.1.9-1.tar.gz";
    name = "1.1.9-1.tar.gz";
    sha256 = "da6f595eaf081d71b6e3b3c10c956d28e5e40f17704baa8ab55f9a9e48abfb28";
  };
