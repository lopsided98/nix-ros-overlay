...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/navigation2/1.3.5-1.tar.gz";
    name = "1.3.5-1.tar.gz";
    sha256 = "46b9560e06258c86bef3c8d92d471571263a7419a6db31dfdf81e6fdf68a2713";
  };
