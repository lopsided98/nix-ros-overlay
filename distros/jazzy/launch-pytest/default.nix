...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch-release/archive/release/jazzy/launch_pytest/3.4.7-1.tar.gz";
    name = "3.4.7-1.tar.gz";
    sha256 = "a79ae7e34cf16c4cee3ce831e1074b6c97bfa4999dee80a4a083a4e8eb383769";
  };
