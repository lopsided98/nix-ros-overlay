...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_velocity_smoother/1.3.7-1.tar.gz";
    name = "1.3.7-1.tar.gz";
    sha256 = "1a290cbd4d35b85773558b6a4b5fbb9514f3f0e5c29021508db202cf1161ff72";
  };
