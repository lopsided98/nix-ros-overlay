...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_velocity_smoother/1.3.4-1.tar.gz";
    name = "1.3.4-1.tar.gz";
    sha256 = "80c0bcb0985ca6278cf8a8511ecceda9ca58fec7e0b3cf36022d6d4c84f650f3";
  };
