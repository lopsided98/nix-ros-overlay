...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/libcamera-release/archive/release/jazzy/libcamera/0.6.0-1.tar.gz";
    name = "0.6.0-1.tar.gz";
    sha256 = "4fd92b97d6c0400bec7c95543be1b3bac2a5cb9e8cc35853723df4aa524804c1";
  };
