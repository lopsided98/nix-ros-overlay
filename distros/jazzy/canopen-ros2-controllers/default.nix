...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_canopen-release/archive/release/jazzy/canopen_ros2_controllers/0.3.0-1.tar.gz";
    name = "0.3.0-1.tar.gz";
    sha256 = "5aafd460f9934ea8152b8d43b432efb98062490a7560e0330c1ff61a10d1257f";
  };
