...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mvsim-release/archive/release/jazzy/mvsim/0.14.2-1.tar.gz";
    name = "0.14.2-1.tar.gz";
    sha256 = "e65f6a1cb91c0eaee3c1e24fb9a408e98b01dbc574272844e7279df86969c633";
  };
