...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mvsim-release/archive/release/jazzy/mvsim/0.15.0-1.tar.gz";
    name = "0.15.0-1.tar.gz";
    sha256 = "b4f8936d04ed656a31b47628dfc3205a378d9ceaa4059eb12ec884b53250f7b3";
  };
