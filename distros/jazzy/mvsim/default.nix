...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mvsim-release/archive/release/jazzy/mvsim/0.14.0-1.tar.gz";
    name = "0.14.0-1.tar.gz";
    sha256 = "9fd48d40a0178d7a6cd1cb60b02f28cc4073e614ce42c7d6c980d2c2e695e670";
  };
