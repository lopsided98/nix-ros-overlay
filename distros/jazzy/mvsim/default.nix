...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mvsim-release/archive/release/jazzy/mvsim/0.9.4-1.tar.gz";
    name = "0.9.4-1.tar.gz";
    sha256 = "e458eb864fd9d4d0d226b24f9d6dc1d38d7a614e0eecbe018c3265e236764fbc";
  };
