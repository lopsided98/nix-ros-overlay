...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/jazzy/mapviz/2.4.8-1.tar.gz";
    name = "2.4.8-1.tar.gz";
    sha256 = "fc055bc6962a669ded3963bc56dd913a716b331f76d5fa1997ce75e4401021c0";
  };
