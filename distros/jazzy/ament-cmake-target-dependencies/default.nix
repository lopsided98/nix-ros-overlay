...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/jazzy/ament_cmake_target_dependencies/2.5.4-1.tar.gz";
    name = "2.5.4-1.tar.gz";
    sha256 = "5c312ac38abd38e1d7253ec984b9bd2e47843b7a28558a550653bfa0ba354cd7";
  };
