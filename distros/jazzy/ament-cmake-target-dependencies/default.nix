...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/jazzy/ament_cmake_target_dependencies/2.5.2-1.tar.gz";
    name = "2.5.2-1.tar.gz";
    sha256 = "31ae0adc056dea403e4ba4d21b486b2770f8b27edd7f56373532308dd6d2d4a0";
  };
