...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_costmap_2d/1.3.12-1.tar.gz";
    name = "1.3.12-1.tar.gz";
    sha256 = "89fe85faf180a058fa9cd45cf711acf52facedf3e93bda70a7b781503c42b44e";
  };
