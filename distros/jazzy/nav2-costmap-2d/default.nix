...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_costmap_2d/1.3.6-1.tar.gz";
    name = "1.3.6-1.tar.gz";
    sha256 = "4033750a6f8931f736f48faff38f78c0f5b01b20dec680f8de6984a0004d8cdf";
  };
