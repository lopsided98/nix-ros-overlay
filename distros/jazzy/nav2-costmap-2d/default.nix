...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_costmap_2d/1.3.11-1.tar.gz";
    name = "1.3.11-1.tar.gz";
    sha256 = "3850997bf44fc649daacc8c654f4cd9737a379e78bdc5ca6822d2d0c6aa53e52";
  };
