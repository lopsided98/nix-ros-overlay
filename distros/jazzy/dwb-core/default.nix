...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/dwb_core/1.3.10-1.tar.gz";
    name = "1.3.10-1.tar.gz";
    sha256 = "b81ab8edcced37f9710e7f5193d19bb832fa2a02f2e363e1178d105e34cbad04";
  };
