...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/dwb_core/1.3.11-1.tar.gz";
    name = "1.3.11-1.tar.gz";
    sha256 = "eb9a1df19115bc309bdd265575e6cd6d43f55792f7008483a6aaf4414e1acec1";
  };
