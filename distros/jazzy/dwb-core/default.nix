...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/dwb_core/1.3.12-1.tar.gz";
    name = "1.3.12-1.tar.gz";
    sha256 = "a2bb9af90ac9461c45b8f680885bc4be7741c6290196501a9ba15bc22b1e05ce";
  };
