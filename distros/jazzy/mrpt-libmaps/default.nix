...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libmaps/2.15.15-1.tar.gz";
    name = "2.15.15-1.tar.gz";
    sha256 = "36622cdbbbb31ffb2c744ad62631557fac2c699e288b4589cbdb8bd0da67440d";
  };
