...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/jazzy/ffw/1.0.8-1.tar.gz";
    name = "1.0.8-1.tar.gz";
    sha256 = "98449ca81a7f4a98a6ccf971e629b3dcacad41cb5271893d3ce8da469b8314de";
  };
