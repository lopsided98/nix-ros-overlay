...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/jazzy/ffw/1.1.8-1.tar.gz";
    name = "1.1.8-1.tar.gz";
    sha256 = "07b17482c252b448a0232101e3050b327ec80c0bfcab92c7830a779f63db02c1";
  };
