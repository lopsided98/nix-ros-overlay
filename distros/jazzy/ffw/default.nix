...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/jazzy/ffw/1.1.21-1.tar.gz";
    name = "1.1.21-1.tar.gz";
    sha256 = "9eaf9889173d49c064d8172798164529d613bd6b2921c55e90767cb522565fd1";
  };
