...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fuse-release/archive/release/jazzy/fuse_constraints/1.1.2-1.tar.gz";
    name = "1.1.2-1.tar.gz";
    sha256 = "caad124bb0436c1b83ffc3cb9c27ebc94860a370081552d77e830cd6e72c0239";
  };
