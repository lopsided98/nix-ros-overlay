...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_default_plugins/14.1.23-1.tar.gz";
    name = "14.1.23-1.tar.gz";
    sha256 = "1144b345f94ec6ee9913df4ab013940deaea8dbea335bad882b66c6bfbda71fb";
  };
