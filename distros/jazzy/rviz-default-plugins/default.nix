...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_default_plugins/14.1.13-1.tar.gz";
    name = "14.1.13-1.tar.gz";
    sha256 = "809a5e793631f059d3e744e20357b20c964cc40598751f607ab02948ef0ba65e";
  };
