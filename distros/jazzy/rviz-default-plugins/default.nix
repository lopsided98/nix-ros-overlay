...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_default_plugins/14.1.1-1.tar.gz";
    name = "14.1.1-1.tar.gz";
    sha256 = "2231711227eceb5f1510e96329aa6d45c0954aff9355f9272d4d031105eddf3a";
  };
