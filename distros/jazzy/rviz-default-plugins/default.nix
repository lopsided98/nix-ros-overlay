...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_default_plugins/14.1.18-1.tar.gz";
    name = "14.1.18-1.tar.gz";
    sha256 = "a876c624fdad9877f704cd70002d1243ce34f144b70f9a8bc5c822a3f2f6adc7";
  };
