...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_default_plugins/14.1.19-1.tar.gz";
    name = "14.1.19-1.tar.gz";
    sha256 = "a682de27be22000eb9603af6db3d543c05e8feabb6cbf694ff313c992ab7173f";
  };
