...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2/0.36.15-1.tar.gz";
    name = "0.36.15-1.tar.gz";
    sha256 = "34afc68099ce56b4a0ff84da7cbcc46af7d58609448b58bf5badb193fa6decca";
  };
