...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2/0.36.18-1.tar.gz";
    name = "0.36.18-1.tar.gz";
    sha256 = "646b90d6550876893e7ec555d8b6540728b6c87f82b8daf85fa009980330befc";
  };
