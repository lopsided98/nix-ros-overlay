...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2/0.36.22-1.tar.gz";
    name = "0.36.22-1.tar.gz";
    sha256 = "03586e924ebf8f60e8addca99078cef79a428edd78d9b5464a5f36488d3bea24";
  };
