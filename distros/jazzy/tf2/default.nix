...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2/0.36.10-1.tar.gz";
    name = "0.36.10-1.tar.gz";
    sha256 = "e50697a18326aed6a342768e34b0ed52e87867a2cd827dcac458c7dab1570266";
  };
