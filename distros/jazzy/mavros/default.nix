...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mavros-release/archive/release/jazzy/mavros/2.6.0-3.tar.gz";
    name = "2.6.0-3.tar.gz";
    sha256 = "0da4ae5f0aa77aa83901eca8d93cd7a0242400379f558bea4ffb86d425fbd975";
  };
