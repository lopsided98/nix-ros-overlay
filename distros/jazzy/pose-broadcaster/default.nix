...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/pose_broadcaster/4.17.0-1.tar.gz";
    name = "4.17.0-1.tar.gz";
    sha256 = "581604a1a86b0e5cba0938aac2f2d3ebb9f5a191f2598fd63adee690567f0006";
  };
