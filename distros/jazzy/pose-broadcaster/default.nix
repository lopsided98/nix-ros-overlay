...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/pose_broadcaster/4.28.0-1.tar.gz";
    name = "4.28.0-1.tar.gz";
    sha256 = "368e7126e79e13c852ea8fd0617d8e0b5f84b3247c6b34b9f75ccaeb4d5c602d";
  };
