...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/pose_broadcaster/4.30.1-1.tar.gz";
    name = "4.30.1-1.tar.gz";
    sha256 = "120ecdf5373436659c4a262c67c3fc52f3a412ac989a1d27bbc72c08880dd739";
  };
