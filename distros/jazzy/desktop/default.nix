...
buildRosPackage {
  pname = "ros-jazzy-desktop";
  version = "0.11.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/variants-release/archive/release/jazzy/desktop/0.11.0-1.tar.gz";
    name = "0.11.0-1.tar.gz";
    sha256 = "76d78e610b268db2f746f28fcce5b87f12361fd49ea123042c26e230c6feb1cf";
  };
