...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/ros2controlcli/4.30.0-1.tar.gz";
    name = "4.30.0-1.tar.gz";
    sha256 = "bd6f5abedb61fd6f5d786e9f4071a770a4b6b20aa251014a48dc8760992576a9";
  };
