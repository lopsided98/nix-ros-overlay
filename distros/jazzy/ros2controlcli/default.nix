...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/ros2controlcli/4.47.0-1.tar.gz";
    name = "4.47.0-1.tar.gz";
    sha256 = "8609d267f56fac2bda46c81ca53ba3dfea2e1bc24011406f135659e5ad2c1c73";
  };
