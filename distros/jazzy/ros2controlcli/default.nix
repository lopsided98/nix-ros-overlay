...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/ros2controlcli/4.40.0-1.tar.gz";
    name = "4.40.0-1.tar.gz";
    sha256 = "229ef5402c7f4fc631a400451bd20dbb4b721c0ece19d0d1f15f45e7ec08452d";
  };
