...
buildRosPackage {
  pname = "ros-jazzy-kuka-iontec-support";
  version = "2.0.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/kuka_robot_descriptions-release/archive/release/jazzy/kuka_iontec_support/2.0.0-1.tar.gz";
    name = "2.0.0-1.tar.gz";
    sha256 = "907a8429fb8b212081bdad4d2156b9f6486befd3d2c52e7957ed8d75b2589d86";
  };
