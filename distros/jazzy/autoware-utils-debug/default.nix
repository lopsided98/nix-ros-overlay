...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/jazzy/autoware_utils_debug/1.4.2-2.tar.gz";
    name = "1.4.2-2.tar.gz";
    sha256 = "166b729ce4b161bf00c0bacb871a51fc4d5a5ca7618123bddfbdf12be64e4966";
  };
