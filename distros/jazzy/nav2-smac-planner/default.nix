...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_smac_planner/1.3.5-1.tar.gz";
    name = "1.3.5-1.tar.gz";
    sha256 = "4f0b99e4e3a004e2a47d5155a844a535c911f2e90d0d87c95d2f1854d4d186fd";
  };
