...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_smac_planner/1.3.6-1.tar.gz";
    name = "1.3.6-1.tar.gz";
    sha256 = "ba8c6972ccefeacb32af6ab4de225eb6239307490462523bf79f14a18abc35d3";
  };
