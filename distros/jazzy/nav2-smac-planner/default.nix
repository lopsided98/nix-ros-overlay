...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_smac_planner/1.3.4-1.tar.gz";
    name = "1.3.4-1.tar.gz";
    sha256 = "f312788949395063afbccbb3aff802d4fd94c9776665dfd4682db543eab37a2b";
  };
