...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_behaviors/1.3.4-1.tar.gz";
    name = "1.3.4-1.tar.gz";
    sha256 = "8bcf8206a5a2e6dd88d84a3960595f381c0bbbf3cf62e5b839039673adb8c1a3";
  };
