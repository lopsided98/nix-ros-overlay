...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_ogre_vendor/14.1.17-1.tar.gz";
    name = "14.1.17-1.tar.gz";
    sha256 = "d1ea239f34dee54dec07b667fa381efda859ced724bdff260c53f430fb02eaef";
  };
