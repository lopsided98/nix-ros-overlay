...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_ogre_vendor/14.1.5-1.tar.gz";
    name = "14.1.5-1.tar.gz";
    sha256 = "0b1e3b40ef3983309973cb3fa352ce13bf8140e711b0c4375b682302adac6c69";
  };
