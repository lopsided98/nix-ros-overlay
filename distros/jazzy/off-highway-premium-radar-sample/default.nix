...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/off_highway_sensor_drivers-release/archive/release/jazzy/off_highway_premium_radar_sample/1.1.0-1.tar.gz";
    name = "1.1.0-1.tar.gz";
    sha256 = "df913560b665ada585cae9fe61cfab51cc0a63522ceb110f3468943fbe825be9";
  };
