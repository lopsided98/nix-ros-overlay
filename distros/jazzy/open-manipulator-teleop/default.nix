...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/jazzy/open_manipulator_teleop/3.2.4-1.tar.gz";
    name = "3.2.4-1.tar.gz";
    sha256 = "d6c90cc9a8b730ea1693a32068802cea7adb94438a79a890b40f87e0781c47c4";
  };
