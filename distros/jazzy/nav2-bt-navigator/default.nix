...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_bt_navigator/1.3.4-1.tar.gz";
    name = "1.3.4-1.tar.gz";
    sha256 = "615ae97c474a9749b9c4fef4138ea1d469d61a92fd8913265afc1b961502720b";
  };
