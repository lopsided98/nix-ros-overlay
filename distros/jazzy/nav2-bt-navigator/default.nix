...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_bt_navigator/1.3.10-1.tar.gz";
    name = "1.3.10-1.tar.gz";
    sha256 = "3c0824c20ac05ee799de0973782928cf5f24ffb16b69d871ba9b7ffaeaee7590";
  };
