...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_bt_navigator/1.3.11-1.tar.gz";
    name = "1.3.11-1.tar.gz";
    sha256 = "9ec87bf5e372f1b294ebc6cef94bc240708d2c6530ac94baef7487f27107992a";
  };
