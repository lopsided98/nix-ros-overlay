...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/tobas-release/archive/release/jazzy/tobas_rosbag_recorder/2.16.2-2.tar.gz";
    name = "2.16.2-2.tar.gz";
    sha256 = "e213460df305194ff3b27605a5a6b77614c06c95fa444e65d9302de032b96cfb";
  };
