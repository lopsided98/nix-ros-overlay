...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/jazzy/camera_calibration/5.0.13-1.tar.gz";
    name = "5.0.13-1.tar.gz";
    sha256 = "25d9275ac42e3bc17ff2c0f463a7f9b52f91c5cd5584b668d5715b95ea25fa0a";
  };
