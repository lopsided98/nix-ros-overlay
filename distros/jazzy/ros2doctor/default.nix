...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2doctor/0.32.11-1.tar.gz";
    name = "0.32.11-1.tar.gz";
    sha256 = "b7dc787230462c669bb7968d643ed9909debb3a5c1c9b599a5a9dfc3b3a0405d";
  };
