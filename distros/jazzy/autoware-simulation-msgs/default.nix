...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_msgs-release/archive/release/jazzy/autoware_simulation_msgs/1.13.0-1.tar.gz";
    name = "1.13.0-1.tar.gz";
    sha256 = "3912c42ed7ec2c2a18e836a11391d46ed52844b1a5ff9d54ebe5ecb21bea5ef1";
  };
