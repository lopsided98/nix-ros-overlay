...
buildRosPackage {
  pname = "ros-jazzy-autoware-motion-velocity-planner";
  version = "1.8.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_core-release/archive/release/jazzy/autoware_motion_velocity_planner/1.8.0-1.tar.gz";
    name = "1.8.0-1.tar.gz";
    sha256 = "9cd68114bc275d4bc1967c107ab0fc57463b3b416d8c0accdf4e50a44df4b784";
  };
