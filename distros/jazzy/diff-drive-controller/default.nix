...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/diff_drive_controller/4.38.0-1.tar.gz";
    name = "4.38.0-1.tar.gz";
    sha256 = "bd55af667f7f0877ead9cf3150c0d69735f3f1e155a4d0b362dfeaa2e129f3e9";
  };
