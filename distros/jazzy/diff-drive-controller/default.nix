...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/diff_drive_controller/4.26.0-1.tar.gz";
    name = "4.26.0-1.tar.gz";
    sha256 = "ff28a67ed91b28309bd121999a5e501a8cf55b99350e9629e600826f53a355c0";
  };
