...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/diff_drive_controller/4.12.0-1.tar.gz";
    name = "4.12.0-1.tar.gz";
    sha256 = "a6eacddd22d065b3c9de742208d9029550c7baabcc99ba6484436f6e5c8f7e37";
  };
