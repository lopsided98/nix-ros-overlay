...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/jazzy/swri_cli_tools/3.11.0-1.tar.gz";
    name = "3.11.0-1.tar.gz";
    sha256 = "6430fa554f2f99c5365089ec43ca4c68d8cd6583f07f6331302b1f747f138a5f";
  };
