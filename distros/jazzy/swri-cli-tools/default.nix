...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/jazzy/swri_cli_tools/3.12.0-1.tar.gz";
    name = "3.12.0-1.tar.gz";
    sha256 = "fbb4e7ca9ceb3cab093a05427a80c843807a0f388762f2f9427d315ec6ec6435";
  };
