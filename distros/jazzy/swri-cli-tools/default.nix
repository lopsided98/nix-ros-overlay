...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/jazzy/swri_cli_tools/3.8.5-1.tar.gz";
    name = "3.8.5-1.tar.gz";
    sha256 = "a1608fa08e0eb3a0c33f034fb957c7a18223c7c103f808c8d8c47a2bdcfd525a";
  };
