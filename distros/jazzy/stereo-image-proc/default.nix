...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/jazzy/stereo_image_proc/5.0.1-2.tar.gz";
    name = "5.0.1-2.tar.gz";
    sha256 = "cb8c006a8a8acd8a49be9c56e5dc66816000e5f93dc0d589cdf0eab4ab3a342a";
  };
