...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/jazzy/stereo_image_proc/5.0.1-3.tar.gz";
    name = "5.0.1-3.tar.gz";
    sha256 = "12a53f60fa009da94fb4311dd42e96df4e9196283d5363f09c0bff304c3d76d6";
  };
