...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/jazzy/stereo_image_proc/5.0.6-1.tar.gz";
    name = "5.0.6-1.tar.gz";
    sha256 = "5f0371d8f20f3abcdc3fbb122d4022532b5d8484db33acd3f70a9ea9043e3f89";
  };
