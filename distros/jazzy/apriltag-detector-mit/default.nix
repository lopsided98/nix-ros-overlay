...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/apriltag_detector-release/archive/release/jazzy/apriltag_detector_mit/3.0.3-1.tar.gz";
    name = "3.0.3-1.tar.gz";
    sha256 = "de82a7ae98b4970a0a7eb815c401a5790becef80c183d031cbe5a059dec27a62";
  };
