...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/jazzy/rosbridge_server/2.7.1-1.tar.gz";
    name = "2.7.1-1.tar.gz";
    sha256 = "da8b1ceb8a17edbac147b4c1d58174ee1b81b57f5445dc8f671d041e3b7f3d18";
  };
