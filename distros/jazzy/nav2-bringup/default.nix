...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_bringup/1.3.11-1.tar.gz";
    name = "1.3.11-1.tar.gz";
    sha256 = "9e804899474c3e7e5c0142e80c91308e232b25774ca1f00bb1bf529af154b6c1";
  };
