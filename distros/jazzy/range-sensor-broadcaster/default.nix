...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/range_sensor_broadcaster/4.30.0-1.tar.gz";
    name = "4.30.0-1.tar.gz";
    sha256 = "4a8b87e77ab88b08f53ecb58fafd4a63bfe2f243fcd35b87440b21f57d6ccffe";
  };
