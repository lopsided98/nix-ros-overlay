...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/range_sensor_broadcaster/4.38.0-1.tar.gz";
    name = "4.38.0-1.tar.gz";
    sha256 = "0e8b879aaa5d299cf72409ec43128c7891a362a7b1764cf186f0a04ded8e7947";
  };
