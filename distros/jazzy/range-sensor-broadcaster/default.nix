...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/range_sensor_broadcaster/4.29.0-1.tar.gz";
    name = "4.29.0-1.tar.gz";
    sha256 = "4da25c65043297e5916cf57561226ce7312dd66ff6b804c720e9f5cf16c6d038";
  };
