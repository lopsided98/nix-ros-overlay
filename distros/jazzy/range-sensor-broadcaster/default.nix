...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/range_sensor_broadcaster/4.26.0-1.tar.gz";
    name = "4.26.0-1.tar.gz";
    sha256 = "0b8d964610e2da3257481a8be5c0201cfcde38d91ac2986e6dffcac8c26e8741";
  };
