...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/range_sensor_broadcaster/4.27.0-1.tar.gz";
    name = "4.27.0-1.tar.gz";
    sha256 = "522579f2db4ae4cd511cd527c83a351ae60a8ce445adf9efb746c6a2249a742a";
  };
