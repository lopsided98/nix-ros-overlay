...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/range_sensor_broadcaster/4.35.0-1.tar.gz";
    name = "4.35.0-1.tar.gz";
    sha256 = "6da075c3e25235a91c7c1304d7c36a149bdedca958e22f7274d0e800c86e5d51";
  };
