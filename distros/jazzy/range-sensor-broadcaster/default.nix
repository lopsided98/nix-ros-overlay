...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/range_sensor_broadcaster/4.28.0-1.tar.gz";
    name = "4.28.0-1.tar.gz";
    sha256 = "826f11a1a68d9ebf9aaa52303623c7872e28a0bae5d639c990d3835ec3072df9";
  };
