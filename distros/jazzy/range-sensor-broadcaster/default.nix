...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/range_sensor_broadcaster/4.9.0-1.tar.gz";
    name = "4.9.0-1.tar.gz";
    sha256 = "66c1cc33fb134f998182a4ea22e8ce9121cf82c45123984ef110b5b705f8a647";
  };
