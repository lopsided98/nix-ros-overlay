...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/jazzy/ur_controllers/3.6.0-1.tar.gz";
    name = "3.6.0-1.tar.gz";
    sha256 = "b31bfa9daa0f8f5713946cd562fd2b1ee2e4bb1335fc3493f721a622d00dd4e8";
  };
