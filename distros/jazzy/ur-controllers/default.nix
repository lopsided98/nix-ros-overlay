...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/jazzy/ur_controllers/2.4.5-1.tar.gz";
    name = "2.4.5-1.tar.gz";
    sha256 = "a4954d8f0ff3c04878bb70ab4616be0ad177fac4d8e2a2b6fef522b2dd95382d";
  };
