...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/jazzy/mrpt_sensor_gnss_novatel/0.2.1-1.tar.gz";
    name = "0.2.1-1.tar.gz";
    sha256 = "a5a5d05219719c7cb599cda50859bddd779a61667bf5e28fbd62fd1490dfc075";
  };
