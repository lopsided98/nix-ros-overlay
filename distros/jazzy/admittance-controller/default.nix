...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/admittance_controller/4.25.0-1.tar.gz";
    name = "4.25.0-1.tar.gz";
    sha256 = "c5829d47fc9c4a696cb53a1a5fcea78d68ccf30cca695f6703e5fa551e56c6c7";
  };
