...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/admittance_controller/4.28.0-1.tar.gz";
    name = "4.28.0-1.tar.gz";
    sha256 = "151352b48eb728748b4a53b9d7e07c6f781e6ca45fd3395c9e4cd0fba044174d";
  };
