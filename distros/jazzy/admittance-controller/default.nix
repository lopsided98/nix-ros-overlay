...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/admittance_controller/4.30.0-1.tar.gz";
    name = "4.30.0-1.tar.gz";
    sha256 = "a2a0a191226f49ebee40b121083d1df741e65a5c9bf31a5344f07cf727f4a9cc";
  };
