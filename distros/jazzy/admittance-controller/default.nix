...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/admittance_controller/4.27.0-1.tar.gz";
    name = "4.27.0-1.tar.gz";
    sha256 = "15da4eed841a3707b8626feda0235e1d080a96a655976da83f744cea8ca4bb0d";
  };
