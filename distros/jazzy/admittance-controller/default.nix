...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/admittance_controller/4.26.0-1.tar.gz";
    name = "4.26.0-1.tar.gz";
    sha256 = "cb023c9d0102a7e71db44f2488619da6d9a1b9a2e34c613161a300f8afec5bcb";
  };
