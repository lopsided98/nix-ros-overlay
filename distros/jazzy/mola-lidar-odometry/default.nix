...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_lidar_odometry-release/archive/release/jazzy/mola_lidar_odometry/1.2.2-1.tar.gz";
    name = "1.2.2-1.tar.gz";
    sha256 = "6d3af0c76e375e1dce8999782a887629bfe0546c5ada7f70eb749f049c7bec68";
  };
