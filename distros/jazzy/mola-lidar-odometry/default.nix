...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_lidar_odometry-release/archive/release/jazzy/mola_lidar_odometry/3.0.0-1.tar.gz";
    name = "3.0.0-1.tar.gz";
    sha256 = "b8f867b1f48ad983cc4a09d46a675b39a564de2474ba05b6f02f5f0d4bf1ab73";
  };
