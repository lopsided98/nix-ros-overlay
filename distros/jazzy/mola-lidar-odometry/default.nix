...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_lidar_odometry-release/archive/release/jazzy/mola_lidar_odometry/0.7.3-1.tar.gz";
    name = "0.7.3-1.tar.gz";
    sha256 = "699ccc80dac17bca07825f01ebd82ca7256556caadec347efea69f8c5af5412d";
  };
