...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_lidar_odometry-release/archive/release/jazzy/mola_lidar_odometry/0.5.4-1.tar.gz";
    name = "0.5.4-1.tar.gz";
    sha256 = "895251055cda6de32b7fd3a2b3ec6d13683e33c22b5ce4e4854e443e6e4918bf";
  };
