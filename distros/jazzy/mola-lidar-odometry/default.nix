...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_lidar_odometry-release/archive/release/jazzy/mola_lidar_odometry/1.0.0-1.tar.gz";
    name = "1.0.0-1.tar.gz";
    sha256 = "59ba41f2746e92b0c36be626583a3f6bbd07eee6e0fb28e9f73f6d63a9154b69";
  };
