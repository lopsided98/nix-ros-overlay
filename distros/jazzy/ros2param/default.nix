...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2param/0.32.3-1.tar.gz";
    name = "0.32.3-1.tar.gz";
    sha256 = "5027d77cc053981c282cde9f88119cd04a9430443eecb835446539122e92e791";
  };
