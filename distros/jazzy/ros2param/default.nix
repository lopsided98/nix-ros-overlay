...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2param/0.32.12-1.tar.gz";
    name = "0.32.12-1.tar.gz";
    sha256 = "049d6a308376213eec1a109ff42b50764cdcee9f065e96777d036ce7198139e4";
  };
