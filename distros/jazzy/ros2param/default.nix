...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2param/0.32.7-1.tar.gz";
    name = "0.32.7-1.tar.gz";
    sha256 = "bfca46cb2f8b3047690ccf6c7ceb36770c737c0362d47f3b269ae5e229356fda";
  };
