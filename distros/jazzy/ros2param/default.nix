...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2param/0.32.11-1.tar.gz";
    name = "0.32.11-1.tar.gz";
    sha256 = "26bf2a68d7e565454abbc353b88debc3a88b0c117fa2d715b937d7c5b6728b59";
  };
