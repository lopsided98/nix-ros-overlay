...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/bicycle_steering_controller/4.28.0-1.tar.gz";
    name = "4.28.0-1.tar.gz";
    sha256 = "6083eedfd9fcef39adbb37cbd4f23ffddc8093d1e1f8b4a809c29ea01fa228c4";
  };
