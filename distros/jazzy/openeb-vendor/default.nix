...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/openeb_vendor-release/archive/release/jazzy/openeb_vendor/2.0.3-1.tar.gz";
    name = "2.0.3-1.tar.gz";
    sha256 = "aafb2a3f8a98f8164ec49ddcc71f740d998fd723570931d86b3e2ac679023ce7";
  };
