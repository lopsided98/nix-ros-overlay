...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_amcl/1.3.4-1.tar.gz";
    name = "1.3.4-1.tar.gz";
    sha256 = "fdc127536ebf5f3500c75480d3c7e35c461a21cd69d5c5f8df6d0080ca8f7690";
  };
