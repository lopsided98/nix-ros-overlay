...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_amcl/1.3.5-1.tar.gz";
    name = "1.3.5-1.tar.gz";
    sha256 = "4574ecf53354872255d91f40aafc569e061cd203a43debf5afdaf407daf5b559";
  };
