...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_amcl/1.3.10-1.tar.gz";
    name = "1.3.10-1.tar.gz";
    sha256 = "c7721898566726be077bc7e3d9e308cf9911621ca571101fdd543ead1d4be9a2";
  };
