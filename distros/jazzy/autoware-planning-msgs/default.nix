...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_msgs-release/archive/release/jazzy/autoware_planning_msgs/1.1.0-1.tar.gz";
    name = "1.1.0-1.tar.gz";
    sha256 = "2f71ecc3ac4bcd5a17ddd34976b27528bda58c67b31f2df83535812ae3a7a2f2";
  };
