...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/jazzy/mapviz_plugins/2.6.3-1.tar.gz";
    name = "2.6.3-1.tar.gz";
    sha256 = "d43fa9c7b79fa05af92da14e411d3ac8fd5f23101d5e338a1d71276ed1a56bbd";
  };
