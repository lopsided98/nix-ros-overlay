...
buildRosPackage {
  pname = "ros-jazzy-rmf-dev";
  version = "0.1.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_variants-release/archive/release/jazzy/rmf_dev/0.1.0-1.tar.gz";
    name = "0.1.0-1.tar.gz";
    sha256 = "86dd8cc21c4f6ce9e5587aeff56783f1776cec4520a71d5c1da896475851f08a";
  };
