...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/clips_executive-release/archive/release/jazzy/cx_tutorial_agents/0.1.3-1.tar.gz";
    name = "0.1.3-1.tar.gz";
    sha256 = "0254a0a6dd273051105bbfa749bc52587c4e41ebdfa22af6f6b7e1f1dd6b914f";
  };
