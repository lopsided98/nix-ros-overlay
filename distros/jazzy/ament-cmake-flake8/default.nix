...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_cmake_flake8/0.17.0-2.tar.gz";
    name = "0.17.0-2.tar.gz";
    sha256 = "b5c7b7fed73ee175761fb82c83027a964d1cb430ef725e187ee6b1a5441b79ea";
  };
