...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_cmake_flake8/0.17.4-1.tar.gz";
    name = "0.17.4-1.tar.gz";
    sha256 = "3fbf1754b67b3ffdd394bf0e710eaeec52df7ecd0ff49da8829507e3a810128a";
  };
