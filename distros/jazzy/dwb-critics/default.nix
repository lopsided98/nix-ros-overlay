...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/dwb_critics/1.3.6-1.tar.gz";
    name = "1.3.6-1.tar.gz";
    sha256 = "3db0e30fb170496cf2f25f70895a2f8b0b94ec530cb9711c992cbbd96315c904";
  };
