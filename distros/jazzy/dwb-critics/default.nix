...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/dwb_critics/1.3.10-1.tar.gz";
    name = "1.3.10-1.tar.gz";
    sha256 = "bc99c15632d05dd5fce386e5b4175d8fcae151dba90243f3adec8ae103c4774f";
  };
