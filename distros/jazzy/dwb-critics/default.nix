...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/dwb_critics/1.3.5-1.tar.gz";
    name = "1.3.5-1.tar.gz";
    sha256 = "be06f9212f7f7031efd8a0a4d2a45abca017b6e348958d9623b1445a6c37cbe8";
  };
