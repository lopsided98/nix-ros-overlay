...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/jazzy/clearpath_bt_joy/2.6.4-1.tar.gz";
    name = "2.6.4-1.tar.gz";
    sha256 = "5c06177d73cc2c80f1d8417995fd507c2b7de432a81b975477c3f678cda495ab";
  };
