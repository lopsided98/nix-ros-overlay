...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/jazzy/clearpath_bt_joy/2.9.3-1.tar.gz";
    name = "2.9.3-1.tar.gz";
    sha256 = "fa0b6c7c23cc7ce11650d51f6b68d6a30d8988312f679f881e519b93475ecad4";
  };
