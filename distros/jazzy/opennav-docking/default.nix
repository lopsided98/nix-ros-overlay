...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/opennav_docking/1.3.4-1.tar.gz";
    name = "1.3.4-1.tar.gz";
    sha256 = "b95f7a82b0ad4ffdc1de1687600f809cf3c6e59919cec155afe9c2a2ce2a0590";
  };
