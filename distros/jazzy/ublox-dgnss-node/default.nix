...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/jazzy/ublox_dgnss_node/0.7.2-1.tar.gz";
    name = "0.7.2-1.tar.gz";
    sha256 = "6121b65f5b4438575fd3bb9dbcdb219914f0d85962a03203c69bf1c43cb689cc";
  };
