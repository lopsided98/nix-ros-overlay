...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/jazzy/ublox_dgnss_node/0.7.0-1.tar.gz";
    name = "0.7.0-1.tar.gz";
    sha256 = "e7516d8877de2a11d2e08b791607417aafccbdb642c7f69882c127eb70241847";
  };
