...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_smoother/1.3.11-1.tar.gz";
    name = "1.3.11-1.tar.gz";
    sha256 = "3ea473c6abde20110f108bc2cc74e3991c32b74543fdae4c85d8df91f7da9095";
  };
