...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_smoother/1.3.5-1.tar.gz";
    name = "1.3.5-1.tar.gz";
    sha256 = "20520da1cfb4bcc732c8f339775972faf3ae6e1990aec2623afc1406b50356ef";
  };
