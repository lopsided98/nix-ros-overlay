...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/controller_manager/4.47.0-1.tar.gz";
    name = "4.47.0-1.tar.gz";
    sha256 = "8981da18b2badf4350ce03ff522af2c93070961ea4401036c1120792781ae959";
  };
