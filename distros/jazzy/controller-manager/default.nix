...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/controller_manager/4.16.1-1.tar.gz";
    name = "4.16.1-1.tar.gz";
    sha256 = "645e63127245f3bd9060ce74a822b08f5ede2b56c39b565027da56f772dfa05a";
  };
