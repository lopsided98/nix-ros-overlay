...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/controller_manager/4.42.2-1.tar.gz";
    name = "4.42.2-1.tar.gz";
    sha256 = "18665536d50acc232359b50eadaf0f814c760b6a75d0d5f826287328e7455fa9";
  };
