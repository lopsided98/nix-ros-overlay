...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/controller_manager/4.34.0-1.tar.gz";
    name = "4.34.0-1.tar.gz";
    sha256 = "d1a8cb50a36d576d80f3e1cf9e9fa34b80e0ad6814ee2a4ec00f5d2846a24303";
  };
