...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/controller_manager/4.39.0-1.tar.gz";
    name = "4.39.0-1.tar.gz";
    sha256 = "a4a7abca32079c547f6c091ac467b70dff2206f93e9e1225a0cec0bad8330ef6";
  };
