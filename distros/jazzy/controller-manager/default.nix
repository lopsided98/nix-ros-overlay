...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/controller_manager/4.42.1-1.tar.gz";
    name = "4.42.1-1.tar.gz";
    sha256 = "d481220045c00c15ebb4dc73bc8a59e97bf7e24f0da85a6af34a9b46305ed88e";
  };
