...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/controller_manager/4.11.0-1.tar.gz";
    name = "4.11.0-1.tar.gz";
    sha256 = "3fcee54ccf5131bea6e38059c4fe966268663a4a2861cd5e924ca1d7a144c7ef";
  };
