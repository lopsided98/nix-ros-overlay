...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/jazzy/rosbag2_storage_mcap/0.26.6-1.tar.gz";
    name = "0.26.6-1.tar.gz";
    sha256 = "f76fe2968a705ede20cc62ae4e1324ef5b486b1cb4c7ca3632e9867a54558751";
  };
