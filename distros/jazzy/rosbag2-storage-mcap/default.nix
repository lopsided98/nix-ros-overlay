...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/jazzy/rosbag2_storage_mcap/0.26.5-1.tar.gz";
    name = "0.26.5-1.tar.gz";
    sha256 = "938376d07f4b641b692cfea1c53bcda96afb18e1b0b4ab02751fbe02cf255872";
  };
