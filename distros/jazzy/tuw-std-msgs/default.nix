...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/tuw_msgs-release/archive/release/jazzy/tuw_std_msgs/0.2.5-1.tar.gz";
    name = "0.2.5-1.tar.gz";
    sha256 = "37650b34ae3a379bba6198354edc5dbd80b1d8f2a61e36b6bfdcf2e7138598d9";
  };
