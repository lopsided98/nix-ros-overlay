...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/jazzy/rosbag2_cpp/0.26.8-1.tar.gz";
    name = "0.26.8-1.tar.gz";
    sha256 = "2a6d300939572a36cbd548776926e285b83f0ab84c0c00b74722d28350cd6bae";
  };
