...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_hybrid_planning/2.12.0-1.tar.gz";
    name = "2.12.0-1.tar.gz";
    sha256 = "f9221a6276b4d65c369848c70b401477d7dbe3a0beddd3f607a8867a24c0258b";
  };
