...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/joint_state_broadcaster/4.30.0-1.tar.gz";
    name = "4.30.0-1.tar.gz";
    sha256 = "50be93f257c2a82ad1dd4f69afba398b97672e0e4080cc9d35689ef9b3a36bdc";
  };
