...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/joint_state_broadcaster/4.33.0-1.tar.gz";
    name = "4.33.0-1.tar.gz";
    sha256 = "af011e02814be30799a1166e4760f14c57c7d410686e05d23fc9ec92c1454f0a";
  };
