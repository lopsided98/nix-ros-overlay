...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/off_highway_sensor_drivers-release/archive/release/jazzy/off_highway_sensor_drivers/1.1.0-1.tar.gz";
    name = "1.1.0-1.tar.gz";
    sha256 = "c6590dc98fef57ef6795d33767770c41fb7fcad13ea9b7edbba89117111da1c7";
  };
