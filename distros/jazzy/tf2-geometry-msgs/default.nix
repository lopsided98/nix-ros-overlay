...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_geometry_msgs/0.36.18-1.tar.gz";
    name = "0.36.18-1.tar.gz";
    sha256 = "41aa23b15b701b7809bc952854f4153e6e2c733a06759f18f8eee468b06d6d3d";
  };
