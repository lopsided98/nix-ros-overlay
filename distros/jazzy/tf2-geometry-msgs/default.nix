...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_geometry_msgs/0.36.19-1.tar.gz";
    name = "0.36.19-1.tar.gz";
    sha256 = "4e2653726c8943f58c2579bf35caaa2a5eb30e8415cd473cf0199ee164f242fe";
  };
