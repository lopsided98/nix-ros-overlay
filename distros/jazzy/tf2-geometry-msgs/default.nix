...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_geometry_msgs/0.36.13-1.tar.gz";
    name = "0.36.13-1.tar.gz";
    sha256 = "325bed6d1671dbf34ce30a031f1d99c14fb1571cbe543d686889f9e1b3b29c82";
  };
