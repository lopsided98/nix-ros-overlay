...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_geometry_msgs/0.36.15-1.tar.gz";
    name = "0.36.15-1.tar.gz";
    sha256 = "b4789b93f6ac2f91a0b002ee74615e8437c6041e6074de62355b0f2afc853f73";
  };
