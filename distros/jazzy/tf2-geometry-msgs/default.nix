...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_geometry_msgs/0.36.22-1.tar.gz";
    name = "0.36.22-1.tar.gz";
    sha256 = "258a3c6e4ca08bcf1c622907e39c4612e88a580bb607e7bc613f86a4abf38508";
  };
