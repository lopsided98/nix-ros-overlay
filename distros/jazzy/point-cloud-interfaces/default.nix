...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/point_cloud_transport_plugins-release/archive/release/jazzy/point_cloud_interfaces/4.0.4-1.tar.gz";
    name = "4.0.4-1.tar.gz";
    sha256 = "2a86cc8b3fef4dc6b70517a8a4b669320a15ad527245570163fdb11fbadbd0e1";
  };
