...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/jazzy/clearpath_generator_common/2.6.3-1.tar.gz";
    name = "2.6.3-1.tar.gz";
    sha256 = "a29dd62dd51b896343a5bea7f1002768cfb194085dd605c9ca925eca9f6af769";
  };
