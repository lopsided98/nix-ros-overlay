...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/jazzy/clearpath_generator_common/2.6.4-1.tar.gz";
    name = "2.6.4-1.tar.gz";
    sha256 = "6b82d8ad00b6f46751af5068606e38b0c0016545bb91591f1518424be1e2d50c";
  };
