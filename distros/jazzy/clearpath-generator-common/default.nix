...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/jazzy/clearpath_generator_common/2.5.1-1.tar.gz";
    name = "2.5.1-1.tar.gz";
    sha256 = "e32f3a20ad763f669caf0c9b1a7da140f6a8da26f0080ad6658c2a1d54c24595";
  };
