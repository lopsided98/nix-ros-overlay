...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/jazzy/clearpath_generator_common/2.6.2-1.tar.gz";
    name = "2.6.2-1.tar.gz";
    sha256 = "b050fa50f5271008318f986a9c70824b452a682ff36525d4d0ebcd9b20591670";
  };
