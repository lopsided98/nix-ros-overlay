...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/jazzy/clearpath_generator_common/2.9.2-1.tar.gz";
    name = "2.9.2-1.tar.gz";
    sha256 = "e8a848dabbe4ade288710c12dffa883b1fbcc6aaaa50915581e2a7f104bf33f4";
  };
