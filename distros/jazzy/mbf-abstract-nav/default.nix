...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/move_base_flex-release/archive/release/jazzy/mbf_abstract_nav/1.0.5-1.tar.gz";
    name = "1.0.5-1.tar.gz";
    sha256 = "bdfe2fb32a80274929d53b5fab78264c704a350dc59fb95a44bc43e5afab692a";
  };
