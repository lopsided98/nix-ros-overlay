...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/jazzy/image_rotate/5.0.1-3.tar.gz";
    name = "5.0.1-3.tar.gz";
    sha256 = "a4df787d51f411a6abfc9dc9f1e9f24b0a8299da4507526ac5ef1de6bd140b28";
  };
