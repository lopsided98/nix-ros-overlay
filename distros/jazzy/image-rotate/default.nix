...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/jazzy/image_rotate/5.0.13-1.tar.gz";
    name = "5.0.13-1.tar.gz";
    sha256 = "fa6491b7270cb00e598067ba2b620b344aac06f7c9f3a5f0895921c2503d3307";
  };
