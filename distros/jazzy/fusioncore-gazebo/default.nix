...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/manankharwar/fusioncore-release/archive/release/jazzy/fusioncore_gazebo/0.3.2-1.tar.gz";
    name = "0.3.2-1.tar.gz";
    sha256 = "fdb3402053cd3803ea2ce57bb0e935ec2c1b1569f0fc178e464f52f595396ef5";
  };
