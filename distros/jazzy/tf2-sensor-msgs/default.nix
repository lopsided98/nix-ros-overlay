...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_sensor_msgs/0.36.6-1.tar.gz";
    name = "0.36.6-1.tar.gz";
    sha256 = "7d4a3e6a80ad6faea746b7e2f6224242442dca4c711034e0c3bf23a429a49a97";
  };
