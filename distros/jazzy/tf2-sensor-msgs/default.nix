...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_sensor_msgs/0.36.13-1.tar.gz";
    name = "0.36.13-1.tar.gz";
    sha256 = "da1a18c9aa295612d30126b14814702c2eb105da1b6e0720cd6fc8eafdd07ded";
  };
