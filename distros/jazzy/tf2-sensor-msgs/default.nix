...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_sensor_msgs/0.36.14-1.tar.gz";
    name = "0.36.14-1.tar.gz";
    sha256 = "a953c4b434911b785719bbdbc72fe7823da885f25c1d93294b41e8dc3365fff5";
  };
