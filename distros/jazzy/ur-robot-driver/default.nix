...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/jazzy/ur_robot_driver/2.4.8-1.tar.gz";
    name = "2.4.8-1.tar.gz";
    sha256 = "8a07b5e80de9381cf939178f091fa329f3b12475e6e40bac4e4b123150910936";
  };
