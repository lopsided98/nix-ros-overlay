...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/jazzy/ur_robot_driver/2.4.13-1.tar.gz";
    name = "2.4.13-1.tar.gz";
    sha256 = "2233c79cba78b5866223777dc9cec7857157d300734edcb6c54b4776b634fbeb";
  };
