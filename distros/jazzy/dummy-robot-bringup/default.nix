...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/jazzy/dummy_robot_bringup/0.33.8-1.tar.gz";
    name = "0.33.8-1.tar.gz";
    sha256 = "b27a6bcbb06c7b9e8ef1a3ff351abbda28589c13969b9351d1b3d72a4cd9eb69";
  };
