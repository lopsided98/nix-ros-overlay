...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/jazzy/ros_gz_sim/1.0.24-1.tar.gz";
    name = "1.0.24-1.tar.gz";
    sha256 = "ba030d854fa1dcfb8b7f19ac16b6b593e5895ebd65b0aa6f649aea3048964411";
  };
