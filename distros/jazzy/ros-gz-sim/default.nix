...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/jazzy/ros_gz_sim/1.0.23-1.tar.gz";
    name = "1.0.23-1.tar.gz";
    sha256 = "2d4ae95f9992f748ee41ae31b83f3eb3e93ed535e24080fd30cbf364edb0d1b2";
  };
