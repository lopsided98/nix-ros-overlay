...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/force_torque_sensor_broadcaster/4.27.1-1.tar.gz";
    name = "4.27.1-1.tar.gz";
    sha256 = "51fbd8969d5ca1743f38dd01d2b7a1165de06fee4e18ac1a8656aa37d601af0d";
  };
