...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/force_torque_sensor_broadcaster/4.28.0-1.tar.gz";
    name = "4.28.0-1.tar.gz";
    sha256 = "67bc1ab9deac3a569f18f4ea325710beadd362da393b882ee8c29445363d6a0d";
  };
