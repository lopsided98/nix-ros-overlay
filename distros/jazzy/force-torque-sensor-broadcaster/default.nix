...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/force_torque_sensor_broadcaster/4.35.0-1.tar.gz";
    name = "4.35.0-1.tar.gz";
    sha256 = "17983f64b9fcf0a0dc17dbdbe2f8c0f3ea1696be9e418fbbe9d050062b5e77cb";
  };
