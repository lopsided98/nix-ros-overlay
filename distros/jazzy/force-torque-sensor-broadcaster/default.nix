...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/force_torque_sensor_broadcaster/4.26.0-1.tar.gz";
    name = "4.26.0-1.tar.gz";
    sha256 = "ccfffc25b6e5dc011f2d60be8855dcd9e8c564fb0d33594806c6cfa99683b492";
  };
