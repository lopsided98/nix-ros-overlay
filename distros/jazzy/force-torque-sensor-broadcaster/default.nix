...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/force_torque_sensor_broadcaster/4.33.1-1.tar.gz";
    name = "4.33.1-1.tar.gz";
    sha256 = "72a341830531510ebde0bfce81908860a725b836c6780480769d3d95f80a535b";
  };
