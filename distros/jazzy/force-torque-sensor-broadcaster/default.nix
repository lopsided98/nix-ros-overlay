...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/force_torque_sensor_broadcaster/4.30.0-1.tar.gz";
    name = "4.30.0-1.tar.gz";
    sha256 = "2e18aadcce030555008750bcda40ce6d1e753d8a05887e1b346e71f943426c62";
  };
