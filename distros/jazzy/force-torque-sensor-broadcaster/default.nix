...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/force_torque_sensor_broadcaster/4.29.0-1.tar.gz";
    name = "4.29.0-1.tar.gz";
    sha256 = "6d1293c5869f5fd60113e1bb4422b08f54fdcc1e58c0e74442b2b046e2960a97";
  };
