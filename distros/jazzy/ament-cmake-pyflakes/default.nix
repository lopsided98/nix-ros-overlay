...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_cmake_pyflakes/0.17.5-1.tar.gz";
    name = "0.17.5-1.tar.gz";
    sha256 = "af3d03415d875b01892c3145f943b79750085e7351bbd13acf8f7c1e0ac063fc";
  };
