...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit_task_constructor-release/archive/release/jazzy/moveit_task_constructor_core/0.1.4-1.tar.gz";
    name = "0.1.4-1.tar.gz";
    sha256 = "43a42be1c725d99581aa6672ea208f433b8258681e0c5a031b8376b50c18ba6c";
  };
