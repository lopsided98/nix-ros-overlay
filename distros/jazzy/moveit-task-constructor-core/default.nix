...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit_task_constructor-release/archive/release/jazzy/moveit_task_constructor_core/0.1.5-1.tar.gz";
    name = "0.1.5-1.tar.gz";
    sha256 = "733e84d8cc93b54c40b40be8ed4d4139f514aeaff39166201a86596791d16b68";
  };
