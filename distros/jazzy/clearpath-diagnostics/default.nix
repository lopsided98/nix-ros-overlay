...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/jazzy/clearpath_diagnostics/2.9.1-1.tar.gz";
    name = "2.9.1-1.tar.gz";
    sha256 = "880585791b8904d4dad9eebb711da94fc86ab3a84c94e4fc87b2120227764b88";
  };
