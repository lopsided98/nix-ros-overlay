...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/jazzy/clearpath_diagnostics/2.6.4-1.tar.gz";
    name = "2.6.4-1.tar.gz";
    sha256 = "d3925b457ec3f3c2a06030db86e2ce6a2919568c0eedfcb50b8427c3a6fc5a55";
  };
