...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/pid_controller/4.29.0-1.tar.gz";
    name = "4.29.0-1.tar.gz";
    sha256 = "b0fe1368c729b6542aeaef5281a537d1cdcbe50ab3e8e9a8da430247a00991f4";
  };
