...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/pid_controller/4.42.1-1.tar.gz";
    name = "4.42.1-1.tar.gz";
    sha256 = "158757ffd6fbf7ead77694b84b26dfdb5cb4fb5bfab9b6f982526fc3f09ecb0b";
  };
