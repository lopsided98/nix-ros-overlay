...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/pid_controller/4.33.1-1.tar.gz";
    name = "4.33.1-1.tar.gz";
    sha256 = "d937ca5014fed0e96f44e96935cafdf1704d7710dd962dc8a0b5bcf6dfd5db80";
  };
