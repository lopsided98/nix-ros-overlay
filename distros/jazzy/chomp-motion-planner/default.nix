...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/chomp_motion_planner/2.12.4-1.tar.gz";
    name = "2.12.4-1.tar.gz";
    sha256 = "cbf8eae2911e770607f44d31f78f2d704061b0c798da578064096cf70e404f89";
  };
