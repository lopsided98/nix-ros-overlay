...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav_2d_utils/1.3.4-1.tar.gz";
    name = "1.3.4-1.tar.gz";
    sha256 = "c8eb1cb40a503bcad5961d2ae4315b9c33fe33677b7a57c46e34d057e946c797";
  };
