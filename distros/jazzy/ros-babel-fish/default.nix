...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_babel_fish-release/archive/release/jazzy/ros_babel_fish/2.25.11-1.tar.gz";
    name = "2.25.11-1.tar.gz";
    sha256 = "58dc7e95e70325f2a4ca512364014c38f4a3e982e0309422149c17203cfdc4c2";
  };
