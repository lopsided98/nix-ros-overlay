...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/jazzy/ament_cmake/2.5.6-2.tar.gz";
    name = "2.5.6-2.tar.gz";
    sha256 = "dd53f066d93b452fddcf6eb2935e847bd031dd44ee9f883c9b2600caedadb5a9";
  };
