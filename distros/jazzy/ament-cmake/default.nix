...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/jazzy/ament_cmake/2.5.5-1.tar.gz";
    name = "2.5.5-1.tar.gz";
    sha256 = "a424fbee5ea7957b0934f7a8baac80641e82d632e6d4e1f3e700882d350d3eda";
  };
