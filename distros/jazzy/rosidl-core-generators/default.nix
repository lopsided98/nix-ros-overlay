...
buildRosPackage {
  pname = "ros-jazzy-rosidl-core-generators";
  version = "0.2.0-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_core-release/archive/release/jazzy/rosidl_core_generators/0.2.0-3.tar.gz";
    name = "0.2.0-3.tar.gz";
    sha256 = "75324ee6e7a33632ed13b927707e0404fe8775b9277203020732e5c7ba5124bc";
  };
