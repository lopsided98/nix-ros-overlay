...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2node/0.32.12-1.tar.gz";
    name = "0.32.12-1.tar.gz";
    sha256 = "2b020841034d0a3e677e70b692f502c7b73169ccd5f3c63506f1367005329cce";
  };
