...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/event_camera_py-release/archive/release/jazzy/event_camera_py/1.3.5-1.tar.gz";
    name = "1.3.5-1.tar.gz";
    sha256 = "231d2559e2ca0cb50f58a4a43e999af667698cae7aefefe18cd050fd4dadee10";
  };
