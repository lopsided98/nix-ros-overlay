...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/event_camera_py-release/archive/release/jazzy/event_camera_py/1.0.4-3.tar.gz";
    name = "1.0.4-3.tar.gz";
    sha256 = "e4fd054a830f3761b3cce37359c536a0e1511b4c366dca4a7fa05a48e49f2f15";
  };
