...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/joint_trajectory_controller/4.30.0-1.tar.gz";
    name = "4.30.0-1.tar.gz";
    sha256 = "d24c00baf74139b50517227c2e4ad94fc760bc15d76fb5cd40a9192dd91ff00e";
  };
