...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/joint_trajectory_controller/4.28.0-1.tar.gz";
    name = "4.28.0-1.tar.gz";
    sha256 = "b26c49b79bf20fd5e8bf047f8fd031b56529424c25c45f68fb3310d6afff40b9";
  };
