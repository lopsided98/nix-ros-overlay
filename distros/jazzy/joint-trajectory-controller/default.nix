...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/joint_trajectory_controller/4.17.0-1.tar.gz";
    name = "4.17.0-1.tar.gz";
    sha256 = "b7784182422bcda674938f6c747621314c4eb4aea4aee78f2fbe2cd94d0426d1";
  };
