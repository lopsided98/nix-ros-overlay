...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/joint_trajectory_controller/4.29.0-1.tar.gz";
    name = "4.29.0-1.tar.gz";
    sha256 = "5a2f48c890956d6215471f5cb33fad12098791250bff8012b88c51614ff17ae0";
  };
