...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/joint_trajectory_controller/4.12.0-1.tar.gz";
    name = "4.12.0-1.tar.gz";
    sha256 = "d88f93528e9be5914dee0b6a92a09069be5358a53022df4c8fa3cfa4b14dade0";
  };
