...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/jazzy/rosbag2_storage_sqlite3/0.26.3-1.tar.gz";
    name = "0.26.3-1.tar.gz";
    sha256 = "815d5b4eb1fda883ec44a488826c5296508439c9c763ffa7bf319fbcce06b4aa";
  };
