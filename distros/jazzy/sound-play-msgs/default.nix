...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/audio_common-release/archive/release/jazzy/sound_play_msgs/0.4.0-2.tar.gz";
    name = "0.4.0-2.tar.gz";
    sha256 = "32bb56208ce94e891e016fe41200ddcc73f145d3ce1278fbdd71aa109fbb6b02";
  };
