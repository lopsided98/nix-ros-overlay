...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/jazzy/topic_monitor/0.33.9-1.tar.gz";
    name = "0.33.9-1.tar.gz";
    sha256 = "31eee9a937966b62bfefeda02eadf1aaa680f18019ba68c18224e93d1e885349";
  };
