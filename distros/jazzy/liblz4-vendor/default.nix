...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/jazzy/liblz4_vendor/0.26.5-1.tar.gz";
    name = "0.26.5-1.tar.gz";
    sha256 = "e70d6e1c0716685e36df456dfe576c34b3306d339f8fa566ad1b7c99fa5a6297";
  };
