...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_core/1.3.12-1.tar.gz";
    name = "1.3.12-1.tar.gz";
    sha256 = "a4747e21833a6bdc07bf7a538369d03e68080d3aada4182037a888fdd81fb503";
  };
