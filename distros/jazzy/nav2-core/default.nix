...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_core/1.3.4-1.tar.gz";
    name = "1.3.4-1.tar.gz";
    sha256 = "54cf35a8ba14ce13a7ca6b4cb370dd5b3b620bb3cc2d321f85b6b6210dbdab8b";
  };
