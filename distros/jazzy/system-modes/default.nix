...
buildRosPackage {
  pname = "ros-jazzy-system-modes";
  version = "0.9.0-r6";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/system_modes-release/archive/release/jazzy/system_modes/0.9.0-6.tar.gz";
    name = "0.9.0-6.tar.gz";
    sha256 = "bf8221bd4de93dda127693e2584bec8acfe3b30d12eab7562b4a7ba87bcabb43";
  };
