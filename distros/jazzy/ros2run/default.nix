...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2run/0.32.4-1.tar.gz";
    name = "0.32.4-1.tar.gz";
    sha256 = "a29b3926938877d994369ee4e10a22a89be7e2874aaef27e82820b4c1a88e2f1";
  };
