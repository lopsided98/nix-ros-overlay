...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2run/0.32.12-1.tar.gz";
    name = "0.32.12-1.tar.gz";
    sha256 = "faebccc6cccb522511165b8dc0dc297b3c21c51ba4d8d11963065a75ec29712f";
  };
