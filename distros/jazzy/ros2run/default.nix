...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2run/0.32.3-1.tar.gz";
    name = "0.32.3-1.tar.gz";
    sha256 = "f1fbaf428a444cd777067d1095d3fcd4e838729dc6e777e136c3636552a0cc81";
  };
