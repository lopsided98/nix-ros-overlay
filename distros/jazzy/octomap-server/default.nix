...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/octomap_mapping-release/archive/release/jazzy/octomap_server/2.3.1-1.tar.gz";
    name = "2.3.1-1.tar.gz";
    sha256 = "2d8ff17a6b3362a0b69ef90ca8201b4e0934a48a02d93e8dc8a929c69376e880";
  };
