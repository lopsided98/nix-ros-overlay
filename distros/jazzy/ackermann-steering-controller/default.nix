...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/ackermann_steering_controller/4.41.0-1.tar.gz";
    name = "4.41.0-1.tar.gz";
    sha256 = "ff552fd19483d44706f33fbdeddfbdaaa157abb3be31cc97dde90e3aa845fb95";
  };
