...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/ackermann_steering_controller/4.9.0-1.tar.gz";
    name = "4.9.0-1.tar.gz";
    sha256 = "926a19bcb46999ff6f1a073e98a3fd1f37e680dec2f6262c5e63134d2fad9dab";
  };
