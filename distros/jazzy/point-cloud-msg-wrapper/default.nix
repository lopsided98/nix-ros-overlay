...
buildRosPackage {
  pname = "ros-jazzy-point-cloud-msg-wrapper";
  version = "1.0.7-r5";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/point_cloud_msg_wrapper-release/archive/release/jazzy/point_cloud_msg_wrapper/1.0.7-5.tar.gz";
    name = "1.0.7-5.tar.gz";
    sha256 = "e19b5c61d8bbbee2544a3fe0ba459bd4f961f29220ff4db3c49684df1ad5a0aa";
  };
