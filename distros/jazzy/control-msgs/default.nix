...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/control_msgs-release/archive/release/jazzy/control_msgs/5.6.0-1.tar.gz";
    name = "5.6.0-1.tar.gz";
    sha256 = "df50d4c8c2874e823611e8428fd9b11d3034c8875106da28481f7d695268aecd";
  };
