...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/control_msgs-release/archive/release/jazzy/control_msgs/5.7.0-1.tar.gz";
    name = "5.7.0-1.tar.gz";
    sha256 = "8be870f63c1c092479b5c5c71783b50785232b4c47aa5d675c89f7ef4d74ac14";
  };
