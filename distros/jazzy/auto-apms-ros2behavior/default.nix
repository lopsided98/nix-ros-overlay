...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoapms-release/archive/release/jazzy/auto_apms_ros2behavior/1.4.2-1.tar.gz";
    name = "1.4.2-1.tar.gz";
    sha256 = "2ad95b53ff20b1e7ff620c60d35f101878c489981f9b4045006c9eefe2c49688";
  };
