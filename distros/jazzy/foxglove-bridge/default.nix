...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/foxglove_bridge-release/archive/release/jazzy/foxglove_bridge/0.7.7-1.tar.gz";
    name = "0.7.7-1.tar.gz";
    sha256 = "8242f61d66a0580d90a5078c0eeef48c8dffd1ac7fe89de83885c6cf26076205";
  };
