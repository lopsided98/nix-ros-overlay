...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/foxglove_bridge-release/archive/release/jazzy/foxglove_bridge/3.2.4-1.tar.gz";
    name = "3.2.4-1.tar.gz";
    sha256 = "c62688b3879db9d6400047c27d191e4a11a59958dfbe53b84eef681b882c1f30";
  };
