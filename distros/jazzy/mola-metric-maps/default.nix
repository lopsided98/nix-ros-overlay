...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_metric_maps/1.0.5-1.tar.gz";
    name = "1.0.5-1.tar.gz";
    sha256 = "e84a4d7b36de9ac19e942ca55bd6554ac1f2ee50ae2338063b37d65a2c0340d4";
  };
