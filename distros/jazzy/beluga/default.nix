...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/beluga-release/archive/release/jazzy/beluga/2.0.1-1.tar.gz";
    name = "2.0.1-1.tar.gz";
    sha256 = "d5deddea75abc3ca51493dac991eb8d68755fd53ea782b1d1e9c417892554b72";
  };
