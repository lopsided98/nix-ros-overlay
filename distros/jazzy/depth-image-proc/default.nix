...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/jazzy/depth_image_proc/5.0.6-1.tar.gz";
    name = "5.0.6-1.tar.gz";
    sha256 = "e07645817ab215433428f6eadec12c6c51fab3287300594eab8a4b8da2bcdc60";
  };
