...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/jazzy/depth_image_proc/5.0.1-3.tar.gz";
    name = "5.0.1-3.tar.gz";
    sha256 = "e40b5c29d77cdec22a5726115b4e319dc4bec3be1b81b40d2e4f10c7d797e178";
  };
