...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2interface/0.32.1-1.tar.gz";
    name = "0.32.1-1.tar.gz";
    sha256 = "83bca068eb138b73227990a3e566b8e73befeeb7d2331458972064d99430bdc6";
  };
