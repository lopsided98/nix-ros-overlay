...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2interface/0.32.8-1.tar.gz";
    name = "0.32.8-1.tar.gz";
    sha256 = "b3d3669a4ff49146b2981e0fd8bec56ea2f40d68c53873859b8549083f2f8678";
  };
