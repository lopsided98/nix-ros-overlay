...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2interface/0.32.7-1.tar.gz";
    name = "0.32.7-1.tar.gz";
    sha256 = "fada0fca6bce56b57606dd654dfd30b3efa464d3eb0f9b66f053384236f40fe6";
  };
