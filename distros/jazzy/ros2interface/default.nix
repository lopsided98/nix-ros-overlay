...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2interface/0.32.4-1.tar.gz";
    name = "0.32.4-1.tar.gz";
    sha256 = "667bd7c58ea56abb0c0c4b2661085b8a7daadcd584aebc9dc610ff14b60256fa";
  };
