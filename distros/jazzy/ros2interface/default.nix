...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2interface/0.32.12-1.tar.gz";
    name = "0.32.12-1.tar.gz";
    sha256 = "58e367ae2c8e07a0a98092b4c54a868a7e5389b5985e2bc32198a2541b85424b";
  };
