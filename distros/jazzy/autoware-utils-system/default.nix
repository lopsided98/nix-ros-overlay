...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/jazzy/autoware_utils_system/1.4.2-1.tar.gz";
    name = "1.4.2-1.tar.gz";
    sha256 = "26ad92a4e2eeb9db2df95c2c6dc5676a60fceb8628d732a2b11c29a3fd45962b";
  };
