...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2topic/0.32.8-1.tar.gz";
    name = "0.32.8-1.tar.gz";
    sha256 = "a8b38f068edcdeb37c26eb43ed0622cc5473acf6706bd3d28fb1e6420710c743";
  };
