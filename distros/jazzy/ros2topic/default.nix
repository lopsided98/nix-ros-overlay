...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2topic/0.32.2-1.tar.gz";
    name = "0.32.2-1.tar.gz";
    sha256 = "d55c9b0725115792e1e657753badf40f799cba8fb39b05878eb7407234623887";
  };
