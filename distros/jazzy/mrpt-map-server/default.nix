...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/jazzy/mrpt_map_server/2.2.3-1.tar.gz";
    name = "2.2.3-1.tar.gz";
    sha256 = "ee78e088b3e9f0dea63cfc8cdda66ace0e4d7d642ac71725765dc25fb1ae7fef";
  };
