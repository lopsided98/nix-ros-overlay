...
buildRosPackage {
  pname = "ros-jazzy-ecl-converters";
  version = "1.2.1-r5";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/jazzy/ecl_converters/1.2.1-5.tar.gz";
    name = "1.2.1-5.tar.gz";
    sha256 = "a161466c831d6f52a9ff344bd4a66df342f962ec191e880739a839741123a58a";
  };
