...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_kortex-release/archive/release/jazzy/kinova_gen3_lite_moveit_config/0.2.6-1.tar.gz";
    name = "0.2.6-1.tar.gz";
    sha256 = "f2020ad6936460658c596fcb0e9082c77421f966dee1c27fb5ea4fd11b84a2f2";
  };
