...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/crazyswarm2-release/archive/release/jazzy/crazyflie_server_py/1.0.4-1.tar.gz";
    name = "1.0.4-1.tar.gz";
    sha256 = "e6f95329b6550331f9b4812f68219e60331850485d88991261c065f8ec50043d";
  };
