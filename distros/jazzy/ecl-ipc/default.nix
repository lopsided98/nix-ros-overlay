...
buildRosPackage {
  pname = "ros-jazzy-ecl-ipc";
  version = "1.2.1-r5";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/jazzy/ecl_ipc/1.2.1-5.tar.gz";
    name = "1.2.1-5.tar.gz";
    sha256 = "04770875b3a759ca757b67dfa999c1c2aa509ad09c5b0c37ed04edefda2fcc6e";
  };
