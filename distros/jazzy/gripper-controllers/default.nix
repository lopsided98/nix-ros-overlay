...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/gripper_controllers/4.28.0-1.tar.gz";
    name = "4.28.0-1.tar.gz";
    sha256 = "ddb199ede2ab5002b8e7901c205991e33c3526b78c3c2bacdc623e7d7b3e4e4b";
  };
