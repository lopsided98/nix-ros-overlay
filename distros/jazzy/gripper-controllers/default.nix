...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/gripper_controllers/4.9.0-1.tar.gz";
    name = "4.9.0-1.tar.gz";
    sha256 = "59ad5623a76203ec4cb25b5def7713df141c6c50abe969cdaf8e1691e2cd4547";
  };
