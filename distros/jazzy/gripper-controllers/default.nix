...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/gripper_controllers/4.13.0-1.tar.gz";
    name = "4.13.0-1.tar.gz";
    sha256 = "b06ec8cd4600736f95ee1c81f873f787aea04e0e0c2dcb5a9ab87c0c330f7ecf";
  };
