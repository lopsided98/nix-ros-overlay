...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/gripper_controllers/4.41.0-1.tar.gz";
    name = "4.41.0-1.tar.gz";
    sha256 = "040ebaea1c8bce5d9b8a0db56ec3c5d2f5ce54fe9b8854b002a34f715016be2e";
  };
