...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_lifecycle_manager/1.3.6-1.tar.gz";
    name = "1.3.6-1.tar.gz";
    sha256 = "6421ccf0f800138614cf281c0ac17572afc15504e81ca4e4780b299a7bd8f656";
  };
