...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_lifecycle_manager/1.3.4-1.tar.gz";
    name = "1.3.4-1.tar.gz";
    sha256 = "a25268689f537e916707d34aa87dd121a7ea97d862d8457bcd9315a81619de2f";
  };
