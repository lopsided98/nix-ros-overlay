...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_lifecycle_manager/1.3.10-1.tar.gz";
    name = "1.3.10-1.tar.gz";
    sha256 = "5c590db458ebfa5edb912034902424cd8ae692c8aadec5fa1ca06871e8099dc0";
  };
