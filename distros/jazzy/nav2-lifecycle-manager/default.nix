...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_lifecycle_manager/1.3.7-1.tar.gz";
    name = "1.3.7-1.tar.gz";
    sha256 = "d98c61475889889375d51631e03a5c59e87067138bdba86fe32db8947a3e0046";
  };
