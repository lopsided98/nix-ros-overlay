...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_kdl/0.36.15-1.tar.gz";
    name = "0.36.15-1.tar.gz";
    sha256 = "cb3a600e9227d12e2119501c1deff4693c80e03ab43924226a88e0d13acef047";
  };
