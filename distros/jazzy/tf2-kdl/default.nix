...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_kdl/0.36.13-1.tar.gz";
    name = "0.36.13-1.tar.gz";
    sha256 = "e4609b55022e77c047d297e891d1e7c377cc1cb7dcaab793a0e3e27515c6c0e1";
  };
