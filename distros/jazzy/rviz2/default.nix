...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz2/14.1.8-1.tar.gz";
    name = "14.1.8-1.tar.gz";
    sha256 = "f1ccff4d7d6702da2446eb56359689a8a4f584d73174e9bcbdb3dcd602b6216f";
  };
