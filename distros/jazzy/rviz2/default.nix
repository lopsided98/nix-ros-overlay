...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz2/14.1.19-1.tar.gz";
    name = "14.1.19-1.tar.gz";
    sha256 = "d67d8afbc4eae411ac7e294142cece7edec51ee8f14ec948d7b6c459ba25ea88";
  };
