...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/transmission_interface/4.35.0-1.tar.gz";
    name = "4.35.0-1.tar.gz";
    sha256 = "498c8073decdc51accab06e8f36082a920c24ef2f56a806ee69424f45def72df";
  };
