...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/transmission_interface/4.30.0-1.tar.gz";
    name = "4.30.0-1.tar.gz";
    sha256 = "704e7c1790ab036b25a9a6afeaa3df621b2b7ce86cc67c96f4ddb94c8e1fbac7";
  };
