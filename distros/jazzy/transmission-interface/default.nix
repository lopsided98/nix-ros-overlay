...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/transmission_interface/4.46.0-1.tar.gz";
    name = "4.46.0-1.tar.gz";
    sha256 = "724b5a5a881e2f7156895d569f5609a43a8c2f209af1974629aaee1f33adfded";
  };
