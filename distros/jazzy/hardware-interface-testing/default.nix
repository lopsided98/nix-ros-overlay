...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/hardware_interface_testing/4.34.0-1.tar.gz";
    name = "4.34.0-1.tar.gz";
    sha256 = "c1d13ba688b4156f8794e9e47e89a872f3d5d857cb38bb579b44d4863020faae";
  };
