...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/hardware_interface_testing/4.32.0-1.tar.gz";
    name = "4.32.0-1.tar.gz";
    sha256 = "3d046aa63e797ecf86ad8221a5dce98280088ea1dd10ef6ce22a4af123ac75db";
  };
