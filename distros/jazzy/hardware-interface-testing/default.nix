...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/hardware_interface_testing/4.30.0-1.tar.gz";
    name = "4.30.0-1.tar.gz";
    sha256 = "dbdd3e360c349423bacf1800f1a1e4da923f571df4f994c584f8bae75f383ee3";
  };
