...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/jazzy/test_ros_gz_bridge/1.0.0-1.tar.gz";
    name = "1.0.0-1.tar.gz";
    sha256 = "2a69c378111233216a4fb2e9a954fbd7eb74d96bbc165ac7bd2a0e076b06c4ad";
  };
