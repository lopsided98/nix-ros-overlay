...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/jazzy/test_ros_gz_bridge/1.0.15-1.tar.gz";
    name = "1.0.15-1.tar.gz";
    sha256 = "27e4490607a07aeac8917aedf07217dc65ac16ff6503adfc95c3a7c522430e0d";
  };
