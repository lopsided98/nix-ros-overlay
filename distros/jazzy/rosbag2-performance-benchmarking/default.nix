...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/jazzy/rosbag2_performance_benchmarking/0.26.5-1.tar.gz";
    name = "0.26.5-1.tar.gz";
    sha256 = "28adedf084550780575bd1d23f09498a832970f2e6e2117ec1b5113cf1fef362";
  };
