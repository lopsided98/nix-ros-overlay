...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/jazzy/rosbag2_performance_benchmarking/0.26.6-1.tar.gz";
    name = "0.26.6-1.tar.gz";
    sha256 = "4d2ceedbd94dce23304b50b7b30b322d6509937bae5cd1fbd5c2a62da696fb23";
  };
