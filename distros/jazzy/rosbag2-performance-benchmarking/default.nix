...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/jazzy/rosbag2_performance_benchmarking/0.26.3-1.tar.gz";
    name = "0.26.3-1.tar.gz";
    sha256 = "5cad03418496b560371b8943ebb832f4460365edaeca32a96d6a24d2bdf0d7e9";
  };
