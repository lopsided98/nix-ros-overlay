...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/foxglove_bridge-release/archive/release/jazzy/foxglove_msgs/3.4.3-1.tar.gz";
    name = "3.4.3-1.tar.gz";
    sha256 = "569c0783014cbd80d7299e1313b4303db6014ee632cee11c604923f8e53be761";
  };
