...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/foxglove_bridge-release/archive/release/jazzy/foxglove_msgs/3.2.2-1.tar.gz";
    name = "3.2.2-1.tar.gz";
    sha256 = "048744c6f2d4a0677fc9805402c96e69938016d152ede34bb3acbf979680e49d";
  };
