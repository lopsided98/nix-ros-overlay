...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/foxglove_bridge-release/archive/release/jazzy/foxglove_msgs/3.2.4-1.tar.gz";
    name = "3.2.4-1.tar.gz";
    sha256 = "013a462d004f6cface959c8b6274936515f48aec849f69c3184cd51858a7d70d";
  };
