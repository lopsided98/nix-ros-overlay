...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/foxglove_bridge-release/archive/release/jazzy/foxglove_msgs/3.2.3-1.tar.gz";
    name = "3.2.3-1.tar.gz";
    sha256 = "9ad79e48f1563981c0039acdeb2e53bc475591bb224295e6e860499d435006a7";
  };
