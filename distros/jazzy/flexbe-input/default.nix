...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/flexbe_behavior_engine-release/archive/release/jazzy/flexbe_input/3.0.3-1.tar.gz";
    name = "3.0.3-1.tar.gz";
    sha256 = "988d41c3bb56a7b37031a1e5285de3af1ac0da53724b0e51d30ea309193f6360";
  };
