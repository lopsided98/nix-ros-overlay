...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2pkg/0.32.4-1.tar.gz";
    name = "0.32.4-1.tar.gz";
    sha256 = "892d603805e2752470a76014497432c64983ffb6458d3b2f84bc8e0edad63f4b";
  };
