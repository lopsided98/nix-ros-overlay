...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2pkg/0.32.1-1.tar.gz";
    name = "0.32.1-1.tar.gz";
    sha256 = "a55125a9ad385eae8a686e6f11f66312e707bc2d8af221cbd88d15b26dfbc981";
  };
