...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2pkg/0.32.11-1.tar.gz";
    name = "0.32.11-1.tar.gz";
    sha256 = "f69ab80f842e33013473a7056cfd61b406a4ea574b0269cbffb4d2a18354e9a5";
  };
