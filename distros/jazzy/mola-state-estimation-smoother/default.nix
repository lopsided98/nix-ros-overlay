...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_state_estimation-release/archive/release/jazzy/mola_state_estimation_smoother/2.4.2-1.tar.gz";
    name = "2.4.2-1.tar.gz";
    sha256 = "a5cd062c62856eaa560c2805426767db0f28773f505d045aef05ca3a742b78b8";
  };
