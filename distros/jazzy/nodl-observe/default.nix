...
buildRosPackage {
  pname = "ros-jazzy-nodl-observe";
  version = "2.0.3-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/nodl-release/archive/release/jazzy/nodl_observe/2.0.3-1.tar.gz";
    name = "2.0.3-1.tar.gz";
    sha256 = "21d38ecc568f27e3b843a02292f34cf22336a854f2e8bdb33549e6a3d4e9a872";
  };
