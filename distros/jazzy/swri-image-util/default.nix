...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/jazzy/swri_image_util/3.8.9-1.tar.gz";
    name = "3.8.9-1.tar.gz";
    sha256 = "9b717660ecac821e74356c6732a9ef8e938cf909d5b900849c079df391e22839";
  };
