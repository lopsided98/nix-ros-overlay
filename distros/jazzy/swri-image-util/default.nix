...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/jazzy/swri_image_util/3.7.6-1.tar.gz";
    name = "3.7.6-1.tar.gz";
    sha256 = "f27572c1359972401c7b3cbcabbe4b857e10bb46794eb1122981de39beb61feb";
  };
