...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mp2p_icp-release/archive/release/jazzy/mp2p_icp/2.1.2-1.tar.gz";
    name = "2.1.2-1.tar.gz";
    sha256 = "30053b145555a4212ed4309bcbd28ec65fac29bb44a6289720b302b9255e7d94";
  };
