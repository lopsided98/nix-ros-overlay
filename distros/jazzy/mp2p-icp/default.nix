...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mp2p_icp-release/archive/release/jazzy/mp2p_icp/2.14.0-1.tar.gz";
    name = "2.14.0-1.tar.gz";
    sha256 = "70bbd52da967371dc850feee51de2481531c3c559c0bbcd8069f310acccaa81f";
  };
