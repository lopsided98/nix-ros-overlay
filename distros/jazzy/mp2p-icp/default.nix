...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mp2p_icp-release/archive/release/jazzy/mp2p_icp/2.7.1-1.tar.gz";
    name = "2.7.1-1.tar.gz";
    sha256 = "d5d9c51aef273e684415a245c734940ac5d46c5f657747132253e08573fb5f7b";
  };
