...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mp2p_icp-release/archive/release/jazzy/mp2p_icp/2.10.1-1.tar.gz";
    name = "2.10.1-1.tar.gz";
    sha256 = "ae7bde19758150916fa467cf0a2599b0016faef95da2da829afe26113e00ba88";
  };
