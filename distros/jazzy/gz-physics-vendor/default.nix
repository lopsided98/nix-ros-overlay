...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gz_physics_vendor-release/archive/release/jazzy/gz_physics_vendor/0.0.6-1.tar.gz";
    name = "0.0.6-1.tar.gz";
    sha256 = "ca86d0f467f696eb06c2dbb425b957850d625e066d936f4abe524306586cbf72";
  };
  ...
  meta = {
    description = "Vendor package for: gz-physics7 7.5.0
