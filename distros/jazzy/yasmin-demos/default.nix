...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/jazzy/yasmin_demos/4.0.0-1.tar.gz";
    name = "4.0.0-1.tar.gz";
    sha256 = "ce151952539b4ce4b3b136430e63f0dd068587f0653180ee9e08ca1031dd3fc9";
  };
