...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/introlab/rtabmap_ros-release/archive/release/jazzy/rtabmap_ros/0.21.9-1.tar.gz";
    name = "0.21.9-1.tar.gz";
    sha256 = "30b933bf0768929142d934b21837ef618d9780561f9904bb8621ec1771b0ec79";
  };
