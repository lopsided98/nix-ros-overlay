...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/plotjuggler-release/archive/release/jazzy/plotjuggler/3.10.6-1.tar.gz";
    name = "3.10.6-1.tar.gz";
    sha256 = "3322e0da0aa0b725427dbb428b582c759912cadb356c9f01b0fb8bae9bf1bad5";
  };
