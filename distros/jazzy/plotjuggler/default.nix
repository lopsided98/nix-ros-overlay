...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/plotjuggler-release/archive/release/jazzy/plotjuggler/3.10.10-1.tar.gz";
    name = "3.10.10-1.tar.gz";
    sha256 = "8d2deda34431374af6ea57a2150cae2b9363e32358fb0b02fb848d8a2b1a5449";
  };
