...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/plotjuggler-release/archive/release/jazzy/plotjuggler/3.14.2-1.tar.gz";
    name = "3.14.2-1.tar.gz";
    sha256 = "19d8fa0675aadb3bf612bb0589c26d133e18216f372a62a7da6e7e25e3535a30";
  };
