...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/pluginlib-release/archive/release/jazzy/ros2plugin/5.4.5-1.tar.gz";
    name = "5.4.5-1.tar.gz";
    sha256 = "ceb51edb09071db0624e8bfc388a2e20d2893cc730fe3d956ee5cbfcbad567ee";
  };
