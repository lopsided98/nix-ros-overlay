...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/pluginlib-release/archive/release/jazzy/ros2plugin/5.4.6-1.tar.gz";
    name = "5.4.6-1.tar.gz";
    sha256 = "f4d3298888829154da861a99c6b8c94d1768525c87b23a012124a2a3630a40df";
  };
