...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch-release/archive/release/jazzy/launch_testing/3.4.12-1.tar.gz";
    name = "3.4.12-1.tar.gz";
    sha256 = "2f7420c9089922585a95708592fc6ec400212a2b006dc544011761c6db643802";
  };
