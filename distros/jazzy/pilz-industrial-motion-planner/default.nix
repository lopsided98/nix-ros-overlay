...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/pilz_industrial_motion_planner/2.12.0-1.tar.gz";
    name = "2.12.0-1.tar.gz";
    sha256 = "5cf7654fc6b952a0483ba9df67d9c6f795d60850fe55351eeb33aaa856199eb2";
  };
