...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_ros_visualization/2.12.4-1.tar.gz";
    name = "2.12.4-1.tar.gz";
    sha256 = "c6b2e31a1b3bd31d189ebf9ad4c97cb8db620e65a0deb8cdb9c9f338f1499204";
  };
