...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libgui/2.15.15-1.tar.gz";
    name = "2.15.15-1.tar.gz";
    sha256 = "31f32a6395d6e23a7f9719e5342dab8f4888d160c5def8f9a442abdf051c13e2";
  };
