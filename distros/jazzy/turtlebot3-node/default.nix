...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/turtlebot3-release/archive/release/jazzy/turtlebot3_node/2.3.3-1.tar.gz";
    name = "2.3.3-1.tar.gz";
    sha256 = "2313640fd9bcdd4c573f0c500c0e4b0d1557c1b81fb4d8fbe290e6f868113ee1";
  };
