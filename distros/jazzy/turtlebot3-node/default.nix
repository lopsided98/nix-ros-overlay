...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/turtlebot3-release/archive/release/jazzy/turtlebot3_node/2.3.6-1.tar.gz";
    name = "2.3.6-1.tar.gz";
    sha256 = "e5b40241ba1ddf125c90e58763ade003b8d52ee2b0187892e4f87e792768ad84";
  };
