...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/jazzy/ament_cmake_vendor_package/2.5.4-1.tar.gz";
    name = "2.5.4-1.tar.gz";
    sha256 = "cd52b2b742b70bfb86e9f8e9d7d011a97561f7529b47c6e1041b60b0a3db0d30";
  };
