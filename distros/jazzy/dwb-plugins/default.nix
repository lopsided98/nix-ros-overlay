...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/dwb_plugins/1.3.5-1.tar.gz";
    name = "1.3.5-1.tar.gz";
    sha256 = "0420b1221a3b8968cd42e9f01de1a316133b0979cac8cc604d60e3487eb3d402";
  };
