...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_rotation_shim_controller/1.3.6-1.tar.gz";
    name = "1.3.6-1.tar.gz";
    sha256 = "67e9388cc9510e41acf2294082071c08876722ac5c773048ad6bebde5bb135a0";
  };
