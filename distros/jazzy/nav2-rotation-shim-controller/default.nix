...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_rotation_shim_controller/1.3.4-1.tar.gz";
    name = "1.3.4-1.tar.gz";
    sha256 = "90413986a9263b77819d63d9439edd0818415dbe043a30c8f72cbabc749ed176";
  };
