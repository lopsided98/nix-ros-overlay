...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/jazzy/ffw_robot_manager/1.1.9-1.tar.gz";
    name = "1.1.9-1.tar.gz";
    sha256 = "a506ca180976704ff6666ced1bab2efae425a6ed9812e1ef3487bdc669101243";
  };
