...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/jazzy/ffw_robot_manager/1.1.10-1.tar.gz";
    name = "1.1.10-1.tar.gz";
    sha256 = "324399faa1f12b9ad5eff0b9913beb376d538ba7ff046a1eade49496c1fc7d31";
  };
