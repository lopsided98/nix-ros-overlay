...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libmath/2.15.15-1.tar.gz";
    name = "2.15.15-1.tar.gz";
    sha256 = "27c104b12e56c57683fe688cc82c5108ca293fd47628982ffaf58a0b08d44936";
  };
