...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/tuw_msgs-release/archive/release/jazzy/tuw_nav_msgs/0.2.6-1.tar.gz";
    name = "0.2.6-1.tar.gz";
    sha256 = "f516b059ef9ffe917151d4243ac58d1afa716a7eb9f5e2ede9279d7ec81d512b";
  };
