...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/teleop_twist_joy-release/archive/release/jazzy/teleop_twist_joy/2.6.5-1.tar.gz";
    name = "2.6.5-1.tar.gz";
    sha256 = "c8aff92b5739cfbd4cbdd8043d8ef7505beb90d4ee7c5ef9e5d3837e7931f79d";
  };
