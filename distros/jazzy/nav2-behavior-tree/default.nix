...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_behavior_tree/1.3.12-1.tar.gz";
    name = "1.3.12-1.tar.gz";
    sha256 = "aedfc428f42906bf8e6ba458762d8229d99baaa88fb51d04c874ce347a701ed1";
  };
