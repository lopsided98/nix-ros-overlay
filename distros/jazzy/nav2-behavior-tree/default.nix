...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_behavior_tree/1.3.4-1.tar.gz";
    name = "1.3.4-1.tar.gz";
    sha256 = "85cc13dd69db5cf13af466e699c03c9fc29b6da6d71d0800cb75d03aa52714a2";
  };
