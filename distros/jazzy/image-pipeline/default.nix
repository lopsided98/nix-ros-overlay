...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/jazzy/image_pipeline/5.0.10-1.tar.gz";
    name = "5.0.10-1.tar.gz";
    sha256 = "572d2e318a24ce35e2f815b9a694c4f9e1a421a1569b6b22648438386c6d6097";
  };
