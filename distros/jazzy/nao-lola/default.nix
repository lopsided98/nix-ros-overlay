...
buildRosPackage {
  pname = "ros-jazzy-nao-lola";
  version = "1.3.0-r2";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/nao_lola-release/archive/release/jazzy/nao_lola/1.3.0-2.tar.gz";
    name = "1.3.0-2.tar.gz";
    sha256 = "82d3d7b600b9e844fc05e295b0466435253bbdff438bb200238562a8e1eaa79a";
  };
