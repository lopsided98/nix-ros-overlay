...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/jazzy/multires_image/4.0.3-1.tar.gz";
    name = "4.0.3-1.tar.gz";
    sha256 = "7dba170ff7e28f1ed8cc232a3f981454364cf8dbab127203eccd322a241f1a46";
  };
