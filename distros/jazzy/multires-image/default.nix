...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/jazzy/multires_image/2.6.2-1.tar.gz";
    name = "2.6.2-1.tar.gz";
    sha256 = "450dd06c2fb3c744e8a2c7e0e1de760a1e9ee496b314b095eeaef90526a21287";
  };
