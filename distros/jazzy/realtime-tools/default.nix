...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/realtime_tools-release/archive/release/jazzy/realtime_tools/3.10.0-1.tar.gz";
    name = "3.10.0-1.tar.gz";
    sha256 = "ccaa1a029e2d1a508484bcb560983440249caf49b2f5e10fbd6a4d93e583e096";
  };
