...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/realtime_tools-release/archive/release/jazzy/realtime_tools/3.10.1-1.tar.gz";
    name = "3.10.1-1.tar.gz";
    sha256 = "d03bb4f99562fd47a806a1655c07ea47cb28bcb10eb661a820da371fad422b31";
  };
