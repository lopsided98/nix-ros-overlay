...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_controller/1.3.10-1.tar.gz";
    name = "1.3.10-1.tar.gz";
    sha256 = "bda0c70ed2762c75729d3180b6bd73a488e141d150d2c80461b8e0ccaa029012";
  };
