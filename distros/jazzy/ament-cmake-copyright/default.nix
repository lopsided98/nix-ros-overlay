...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_cmake_copyright/0.17.0-2.tar.gz";
    name = "0.17.0-2.tar.gz";
    sha256 = "8e7f83ae54c5e4a96a12d0c7aff060fd70e9bf852017d1e6399dac68e8d4ceed";
  };
