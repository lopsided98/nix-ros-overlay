...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_cmake_pep257/0.17.3-1.tar.gz";
    name = "0.17.3-1.tar.gz";
    sha256 = "b37949381a7862a7805651c3cbb54c88d232946fc893ef8ef84e0985133f7ea1";
  };
