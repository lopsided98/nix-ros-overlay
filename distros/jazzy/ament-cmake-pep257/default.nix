...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_cmake_pep257/0.17.4-1.tar.gz";
    name = "0.17.4-1.tar.gz";
    sha256 = "a71feb602648bd5b7714d579a22cae1069639865c3a4072b43624a973e83befd";
  };
