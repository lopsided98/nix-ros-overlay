...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/jazzy/mrpt_sensor_bumblebee_stereo/0.2.1-1.tar.gz";
    name = "0.2.1-1.tar.gz";
    sha256 = "cf2cb22c18247f2753cedc5df74c18d3640c4686833b63bd526f217bb674e833";
  };
