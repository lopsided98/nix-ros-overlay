...
buildRosPackage {
  pname = "ros-jazzy-broll";
  version = "0.1.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2_broll-release/archive/release/jazzy/broll/0.1.0-1.tar.gz";
    name = "0.1.0-1.tar.gz";
    sha256 = "5443a639816cbdb7d2ff35eb0fb759b5c6e7a9f3181a12b44f4d182545ff7a92";
  };
