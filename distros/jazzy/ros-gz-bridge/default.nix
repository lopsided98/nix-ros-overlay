...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/jazzy/ros_gz_bridge/1.0.19-1.tar.gz";
    name = "1.0.19-1.tar.gz";
    sha256 = "2aad50d5bff5f4a69a7cc50e1e41243003e89a2e25e6673f8582f31d4b005f77";
  };
