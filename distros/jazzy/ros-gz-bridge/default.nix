...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/jazzy/ros_gz_bridge/1.0.23-1.tar.gz";
    name = "1.0.23-1.tar.gz";
    sha256 = "e7bbbf5e574fc60c6d92e138f31e58fa2b6c3f45356df2ce8f4c010ca79527e9";
  };
