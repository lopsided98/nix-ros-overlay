...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/jazzy/ros_gz_bridge/1.0.21-1.tar.gz";
    name = "1.0.21-1.tar.gz";
    sha256 = "b97b35eebb17b6a722ea09c5bdc9afeff545380bc0d5dd5050f1f92a1aadca89";
  };
