...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/jazzy/ros_gz_bridge/1.0.22-1.tar.gz";
    name = "1.0.22-1.tar.gz";
    sha256 = "c2a2935d16b24e9eb9dfb4f5eb2293e4dd38c96547516f4743dbba0758ee24e6";
  };
