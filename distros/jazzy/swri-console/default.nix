...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/swri_console-release/archive/release/jazzy/swri_console/2.0.8-1.tar.gz";
    name = "2.0.8-1.tar.gz";
    sha256 = "684c4f6aaa48ed75935e59055bb92c415d3e6fe24d4eaa42704e6d57c4ff064a";
  };
