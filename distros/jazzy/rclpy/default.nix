...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclpy-release/archive/release/jazzy/rclpy/7.1.1-2.tar.gz";
    name = "7.1.1-2.tar.gz";
    sha256 = "b629b58c28a2991b20234eef09430339cd09ce6ed7901fbc3399d47d0dff9916";
  };
