...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_cmake_cppcheck/0.17.4-1.tar.gz";
    name = "0.17.4-1.tar.gz";
    sha256 = "02de7846532ac736f957447af0e03422a1bc5e99b94caf0cbed9d7f71a5fc31d";
  };
