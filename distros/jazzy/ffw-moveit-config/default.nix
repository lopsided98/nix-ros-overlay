...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/jazzy/ffw_moveit_config/1.1.9-1.tar.gz";
    name = "1.1.9-1.tar.gz";
    sha256 = "508e67171dc4a65d5bb2f0d48c2b06dda1f27b432ff8b84b468462b3c663d6d9";
  };
