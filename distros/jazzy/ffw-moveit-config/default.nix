...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/jazzy/ffw_moveit_config/1.1.8-1.tar.gz";
    name = "1.1.8-1.tar.gz";
    sha256 = "49b77b0721523f7015f4f3bb72148a20892870e7a9d9ccc79215c3d59a68bdb7";
  };
