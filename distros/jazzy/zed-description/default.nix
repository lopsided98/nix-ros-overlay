...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/zed-ros2-description-release/archive/release/jazzy/zed_description/0.1.4-1.tar.gz";
    name = "0.1.4-1.tar.gz";
    sha256 = "ba0573798925ee85680137fe0a1b5c57de508493bf7d6d0047862bbf787773e7";
  };
