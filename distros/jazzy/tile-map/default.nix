...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/jazzy/tile_map/2.5.8-1.tar.gz";
    name = "2.5.8-1.tar.gz";
    sha256 = "151719dcc869dd773318dec41c7d34a40317e48424cf454ceeb3b511d00daa57";
  };
