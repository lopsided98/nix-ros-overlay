...
buildRosPackage {
  pname = "ros-jazzy-agni-tf-tools";
  version = "1.0.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/agni_tf_tools-release/archive/release/jazzy/agni_tf_tools/1.0.0-1.tar.gz";
    name = "1.0.0-1.tar.gz";
    sha256 = "474f8a14bc0c07cb5a353aff432ff8b37b6091f55b361503cfd92609b03ca747";
  };
