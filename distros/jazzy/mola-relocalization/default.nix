...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_relocalization/1.0.5-1.tar.gz";
    name = "1.0.5-1.tar.gz";
    sha256 = "359ffbf2cb1e74e2e2fa5f76a6ad384e28e0ed9602bb2fa0c0f020d2b3770aca";
  };
