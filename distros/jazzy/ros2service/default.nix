...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2service/0.32.1-1.tar.gz";
    name = "0.32.1-1.tar.gz";
    sha256 = "9a4bbd0cecd3d6caec0c6da88f23e30676ccea7776dcce727e944ff63a3b8fbd";
  };
