...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2service/0.32.7-1.tar.gz";
    name = "0.32.7-1.tar.gz";
    sha256 = "99e460e867a428f197bbc9643bcede6654bb19bd81b148836102c00efb5e3ce1";
  };
