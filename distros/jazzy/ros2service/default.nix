...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2service/0.32.2-1.tar.gz";
    name = "0.32.2-1.tar.gz";
    sha256 = "64155750f787448d70074ba474c9580ff2a0241db09125dd7ad08025452d9b85";
  };
