...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/jazzy/mola_input_rosbag2/1.0.2-2.tar.gz";
    name = "1.0.2-2.tar.gz";
    sha256 = "a9997cbacc8b6015b35df4e7957901dd8879c5dbc5c9b23c5cc04fceb8144f27";
  };
