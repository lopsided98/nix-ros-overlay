...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_canopen-release/archive/release/jazzy/canopen_master_driver/0.2.9-2.tar.gz";
    name = "0.2.9-2.tar.gz";
    sha256 = "f57c9815ec55f610673c11bc9842aecaa3de2b7a9bdc3d2587bf4cbe80746c18";
  };
