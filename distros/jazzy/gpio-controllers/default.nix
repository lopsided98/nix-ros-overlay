...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/gpio_controllers/4.27.1-1.tar.gz";
    name = "4.27.1-1.tar.gz";
    sha256 = "421d5b99ed297e429485b17b65118ff54e21702f7256ce595ff85c0ac531f213";
  };
