...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/gpio_controllers/4.26.0-1.tar.gz";
    name = "4.26.0-1.tar.gz";
    sha256 = "5a9e4fc2466bc43d24a50294a908a51396a4e1220b4bdf585f2ce42d34a8e28c";
  };
