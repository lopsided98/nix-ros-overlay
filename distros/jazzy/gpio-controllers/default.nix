...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/gpio_controllers/4.25.0-1.tar.gz";
    name = "4.25.0-1.tar.gz";
    sha256 = "83c3721a37c6fb27367e44deb97ab03068817a26f7c07091fc5f095956831b9a";
  };
