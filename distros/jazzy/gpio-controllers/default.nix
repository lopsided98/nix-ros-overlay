...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/gpio_controllers/4.28.0-1.tar.gz";
    name = "4.28.0-1.tar.gz";
    sha256 = "186bb30d9fe74d9563d0373004bb6aa1939ddfeed6d639aeb56db727ebd2aae4";
  };
