...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/gpio_controllers/4.30.1-1.tar.gz";
    name = "4.30.1-1.tar.gz";
    sha256 = "1e2dad5cc979b02450cc28cecac4ff0ed31d8c9fd3b1a195a84d1b7c90459748";
  };
