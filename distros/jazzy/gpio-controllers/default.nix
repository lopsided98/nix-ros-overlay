...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/gpio_controllers/4.29.0-1.tar.gz";
    name = "4.29.0-1.tar.gz";
    sha256 = "005d91c08118c5204a05f7e470858837dd7a5d0da268be0f3e75dd6c16881ae3";
  };
