...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/gpio_controllers/4.33.1-1.tar.gz";
    name = "4.33.1-1.tar.gz";
    sha256 = "eb26ce467b71bbe224b8d6940779a3dc13f03842f1fbbfeba332ce32b831e021";
  };
