...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/jazzy/ffw_swerve_drive_controller/1.1.10-1.tar.gz";
    name = "1.1.10-1.tar.gz";
    sha256 = "58c6ec9fc697a5d9f1c5b492f0b21c783a08c0f3581be41285fce82aa82c70b5";
  };
