...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw-release/archive/release/jazzy/rmw/7.3.4-1.tar.gz";
    name = "7.3.4-1.tar.gz";
    sha256 = "da562b376de852a56ee2cb272318becdf65d01fefd4f60121078588531aa7480";
  };
