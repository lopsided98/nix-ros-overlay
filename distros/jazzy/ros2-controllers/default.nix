...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/ros2_controllers/4.30.0-1.tar.gz";
    name = "4.30.0-1.tar.gz";
    sha256 = "e072f31a5795ee1a9607bc86003ff9832f87026e00b14de9c88bd8ec32151dd2";
  };
