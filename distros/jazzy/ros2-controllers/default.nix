...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/ros2_controllers/4.9.0-1.tar.gz";
    name = "4.9.0-1.tar.gz";
    sha256 = "d7d2bd3173850e33bc9b24aded200dee624815bd11834559e2bdc2a258872b75";
  };
