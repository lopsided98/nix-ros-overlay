...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2action/0.32.7-1.tar.gz";
    name = "0.32.7-1.tar.gz";
    sha256 = "f550f8ab7603eeeb807fd2974cd8f1d4bdcb665d50778e8c7dc3e3e1d0a7f6f2";
  };
