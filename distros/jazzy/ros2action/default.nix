...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2action/0.32.11-1.tar.gz";
    name = "0.32.11-1.tar.gz";
    sha256 = "fcad8e6426c3d69ed35212c92f6582f985e64561f97f562497ba4752e44b1219";
  };
