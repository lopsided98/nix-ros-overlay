...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_setup_assistant/2.12.0-1.tar.gz";
    name = "2.12.0-1.tar.gz";
    sha256 = "90ccdce072aed53614f272d3370b84882cc03825fa203d42e42357885d52e585";
  };
