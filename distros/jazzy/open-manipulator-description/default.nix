...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/jazzy/open_manipulator_description/4.0.6-1.tar.gz";
    name = "4.0.6-1.tar.gz";
    sha256 = "a39746e0ee9c3cc68ec160c839a370e6970890f13bc495033efae16fa02e3676";
  };
