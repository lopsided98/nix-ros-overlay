...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fuse-release/archive/release/jazzy/fuse_variables/1.1.2-1.tar.gz";
    name = "1.1.2-1.tar.gz";
    sha256 = "d17a2a37762bb55932e4b2ee6966819429a8e7ce5a2b4f77c4b8856fa78fb295";
  };
