...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_assimp_vendor/14.1.13-1.tar.gz";
    name = "14.1.13-1.tar.gz";
    sha256 = "8d92d7908a9ac09e847547fffae14e4613c93ff40dea0f7e839a038244e03265";
  };
