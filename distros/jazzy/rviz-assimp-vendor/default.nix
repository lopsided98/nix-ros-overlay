...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_assimp_vendor/14.1.19-1.tar.gz";
    name = "14.1.19-1.tar.gz";
    sha256 = "d3dbb5d4bcb23e4cc33b7ce510e9a578257fe74e6c6ae8f24d589a8d4f0717e9";
  };
