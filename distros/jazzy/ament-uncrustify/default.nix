...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_uncrustify/0.17.5-1.tar.gz";
    name = "0.17.5-1.tar.gz";
    sha256 = "3e35ec2465d3c2b26df15439023737d203c096946f96c359d81ddd01031d7ecc";
  };
