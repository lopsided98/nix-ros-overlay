...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_uncrustify/0.17.1-1.tar.gz";
    name = "0.17.1-1.tar.gz";
    sha256 = "66d5565a4edd2f6fd6511d225b5138687ee762feff66dbad86622205cff3892d";
  };
