...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/manankharwar/fusioncore-release/archive/release/jazzy/fusioncore_core/0.3.9-1.tar.gz";
    name = "0.3.9-1.tar.gz";
    sha256 = "b0936adf41b79b93c6009caf67678583df2447ba927180b1c7c63c517bbb07ed";
  };
