...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/create3_sim-release/archive/release/jazzy/irobot_create_gz_plugins/3.0.3-1.tar.gz";
    name = "3.0.3-1.tar.gz";
    sha256 = "84948a74b74dd1d114e8723b26584c4b5a64d15d84a8252f6ae71a1362f576a6";
  };
