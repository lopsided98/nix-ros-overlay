...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/lanelet2-release/archive/release/jazzy/lanelet2_validation/1.2.3-1.tar.gz";
    name = "1.2.3-1.tar.gz";
    sha256 = "7d9fd584b28ca642cb1a16555d33ed08ea9f5350b314c8c9fe187a98eefb9682";
  };
