...
{ lib, buildRosPackage, fetchurl, bzip2, cmake, doxygen, eigen, libjpeg, liblapack, libpng, libv4l, libx11, libxml2, opencv }:
buildRosPackage {
  pname = "ros-jazzy-visp";
  version = "3.5.0-r4";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/visp-release/archive/release/jazzy/visp/3.5.0-4.tar.gz";
    name = "3.5.0-4.tar.gz";
    sha256 = "28bb92737eadc9c152972a7975f4ff959def3be4500cbd400186a59482a0cbf9";
  };

  buildType = "cmake";
  buildInputs = [ bzip2 cmake doxygen ];
  propagatedBuildInputs = [ eigen libjpeg liblapack libpng libv4l libx11 libxml2 opencv opencv.cxxdev ];
