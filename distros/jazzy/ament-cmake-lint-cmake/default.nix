...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_cmake_lint_cmake/0.17.5-1.tar.gz";
    name = "0.17.5-1.tar.gz";
    sha256 = "92c38418a5f4441c9b360c24b70362defdb036e33929f1abdd0351818bdd93bc";
  };
