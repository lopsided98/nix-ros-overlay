...
buildRosPackage {
  pname = "ros-jazzy-autoware-map-projection-loader";
  version = "1.8.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_core-release/archive/release/jazzy/autoware_map_projection_loader/1.8.0-1.tar.gz";
    name = "1.8.0-1.tar.gz";
    sha256 = "b8daa0e96a94ce69de3c33ad128155463ff80fb2502e504b68d375879e91a9cc";
  };
