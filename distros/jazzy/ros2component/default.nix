...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2component/0.32.12-1.tar.gz";
    name = "0.32.12-1.tar.gz";
    sha256 = "0f56d2bb21cc6be22330bde0190489459cca1539219e139a8de092f62f13e42b";
  };
