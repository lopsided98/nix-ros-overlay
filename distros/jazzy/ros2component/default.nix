...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2component/0.32.1-1.tar.gz";
    name = "0.32.1-1.tar.gz";
    sha256 = "66fd7f0af85a992ae6f512b73d65e420829f7bb5059afded667e5412660b0cef";
  };
