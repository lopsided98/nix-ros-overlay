...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/event_camera_renderer-release/archive/release/jazzy/event_camera_renderer/3.0.0-1.tar.gz";
    name = "3.0.0-1.tar.gz";
    sha256 = "ac5b426c1e92d1c832d8f812415732c21161797265d47078dc8be601accae640";
  };
