...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/compass-release/archive/release/jazzy/magnetometer_compass/4.0.1-1.tar.gz";
    name = "4.0.1-1.tar.gz";
    sha256 = "cfb472122d1db5aec5d1d62ac26ef9756a17b0bf788a367587820f88b0122514";
  };
