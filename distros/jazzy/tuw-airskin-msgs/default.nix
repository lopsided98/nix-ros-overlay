...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/tuw_msgs-release/archive/release/jazzy/tuw_airskin_msgs/0.2.6-1.tar.gz";
    name = "0.2.6-1.tar.gz";
    sha256 = "5e679bd840513779fe0b8b1f451d5e0b35832f1802aa0fa92d7b906bfc4c1b9b";
  };
