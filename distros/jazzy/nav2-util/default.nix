...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_util/1.3.4-1.tar.gz";
    name = "1.3.4-1.tar.gz";
    sha256 = "156b5feb5ac2c0ce89410782af06c3236c7fd40ea1ded2c824e6971868ac4a54";
  };
