...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_util/1.3.10-1.tar.gz";
    name = "1.3.10-1.tar.gz";
    sha256 = "0742a1fff8de44e81f81362ad7164ec95cd18c12fba3d8c4486f9acfb77e692e";
  };
