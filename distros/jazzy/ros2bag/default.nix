...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/jazzy/ros2bag/0.26.6-1.tar.gz";
    name = "0.26.6-1.tar.gz";
    sha256 = "0631e73daa7a8374fa06500d2621f2a6d2254cb2f381241f05558026249fb73d";
  };
