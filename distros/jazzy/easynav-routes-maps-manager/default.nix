...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/EasyNavigation/easynav_plugins-release/archive/release/jazzy/easynav_routes_maps_manager/0.4.0-1.tar.gz";
    name = "0.4.0-1.tar.gz";
    sha256 = "3352814df2a08f21564bffa44a65b4914002c3bcaf7ef6d85530cf79a2647fe4";
  };
