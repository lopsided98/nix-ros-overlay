...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/xacro-release/archive/release/jazzy/xacro/2.1.1-1.tar.gz";
    name = "2.1.1-1.tar.gz";
    sha256 = "0e58c450bf4d629c2ca95cfe46c5528a5f4d96af95de26f21124f82cd4307fd8";
  };
