...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch-release/archive/release/jazzy/launch/3.4.7-1.tar.gz";
    name = "3.4.7-1.tar.gz";
    sha256 = "55541cb564ab3999a956d54bde575ea3dd81cdeffce94a1a8ae7825c2094d473";
  };
