...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch-release/archive/release/jazzy/launch/3.4.12-1.tar.gz";
    name = "3.4.12-1.tar.gz";
    sha256 = "102da69394fd0b64ffce0eb1ad4160938e6b19629913126dfbdae2c47bac5758";
  };
