...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/DataspeedInc-release/dataspeed_can-release/archive/release/jazzy/dataspeed_can/2.0.8-1.tar.gz";
    name = "2.0.8-1.tar.gz";
    sha256 = "43711ca1e10fba7b12ebc31355c507f782aef27c68c7446aec89f59109ab007b";
  };
