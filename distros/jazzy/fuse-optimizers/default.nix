...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fuse-release/archive/release/jazzy/fuse_optimizers/1.1.3-1.tar.gz";
    name = "1.1.3-1.tar.gz";
    sha256 = "a8359df12f395d4ec9d059539b3ffc3634c48c32c578427373ef84e406eb18e0";
  };
