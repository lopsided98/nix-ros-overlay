...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fuse-release/archive/release/jazzy/fuse_optimizers/1.1.2-1.tar.gz";
    name = "1.1.2-1.tar.gz";
    sha256 = "82682783000aeadc28a78bd8a2e792f5d9432898715babbfc4f79ffa4df9f972";
  };
