...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/tuw_msgs-release/archive/release/jazzy/tuw_geometry_msgs/0.2.3-1.tar.gz";
    name = "0.2.3-1.tar.gz";
    sha256 = "5b29ae418d68ba0fe84d74b683d74b314cbb50dca06b59fa82dba4748d7253cd";
  };
