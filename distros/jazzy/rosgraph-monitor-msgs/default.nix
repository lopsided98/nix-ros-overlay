...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/graph_monitor-release/archive/release/jazzy/rosgraph_monitor_msgs/0.2.2-1.tar.gz";
    name = "0.2.2-1.tar.gz";
    sha256 = "621fe1fddaed6b312cbede72314a318ed22c12e8aaf3a39778a7ac1290707b4e";
  };
