...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/steering_controllers_library/4.40.1-1.tar.gz";
    name = "4.40.1-1.tar.gz";
    sha256 = "305952bd59ecee98d4ca01c703db53730ad0dec7f42df2c9b408d819b5fe3f01";
  };
