...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/steering_controllers_library/4.29.0-1.tar.gz";
    name = "4.29.0-1.tar.gz";
    sha256 = "ff013c84e11a32b69f374eccf3c4f1f864ce91aef1c64a8315ca61216924f711";
  };
