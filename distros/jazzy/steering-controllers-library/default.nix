...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/steering_controllers_library/4.17.0-1.tar.gz";
    name = "4.17.0-1.tar.gz";
    sha256 = "1c7757b2d01ec4facde8df7eaf1d758c53c6c1272ef87f086c7ab0bb9acff565";
  };
