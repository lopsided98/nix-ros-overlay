...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/steering_controllers_library/4.9.0-1.tar.gz";
    name = "4.9.0-1.tar.gz";
    sha256 = "747e531f96e4710eee2a31e2cbf42a49b74f58e3f270e9eaf8f81ed732620839";
  };
