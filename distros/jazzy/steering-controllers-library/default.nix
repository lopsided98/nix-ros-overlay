...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/steering_controllers_library/4.33.0-1.tar.gz";
    name = "4.33.0-1.tar.gz";
    sha256 = "b9edf5424cf2061e51a48baae27beed251522021613556861e1cc41ff2b83587";
  };
