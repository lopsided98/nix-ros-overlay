...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/steering_controllers_library/4.28.0-1.tar.gz";
    name = "4.28.0-1.tar.gz";
    sha256 = "817b8e7077ba158792116c5a4b5a7077de58dd2ba48b0208d691ab4107f40fbf";
  };
