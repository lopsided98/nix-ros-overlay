...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/jazzy/swri_geometry_util/3.7.6-1.tar.gz";
    name = "3.7.6-1.tar.gz";
    sha256 = "5828e1e8dfeb987fe28397077f677e3bb610ea3956b545604ccebc99afe1488e";
  };
