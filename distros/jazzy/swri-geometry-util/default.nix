...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/jazzy/swri_geometry_util/3.8.9-1.tar.gz";
    name = "3.8.9-1.tar.gz";
    sha256 = "b5e097a62e5cecfe4cc73c37e874f5086f8b4b0f5a07e1cea12bb62d59256e73";
  };
