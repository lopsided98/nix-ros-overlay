...
buildRosPackage {
  pname = "ros-jazzy-usb-cam";
  version = "0.8.1-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/usb_cam-release/archive/release/jazzy/usb_cam/0.8.1-1.tar.gz";
    name = "0.8.1-1.tar.gz";
    sha256 = "f013c908171179c14895c06454a4ff0fd99e685f82d4285e71b3eb76067e4be9";
  };
