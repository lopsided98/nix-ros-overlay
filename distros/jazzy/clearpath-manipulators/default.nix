...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/jazzy/clearpath_manipulators/2.9.4-1.tar.gz";
    name = "2.9.4-1.tar.gz";
    sha256 = "beff4c5bdae3638d6fcb3c414f6c2dfb4580507c1ee5350fba40f4e65bc1878a";
  };
