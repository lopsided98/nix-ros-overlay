...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/jazzy/clearpath_manipulators/2.6.3-1.tar.gz";
    name = "2.6.3-1.tar.gz";
    sha256 = "38d8a3e3af9b769254f8e580a788d2b073bb1d840c61afeebec5bcf9a31df590";
  };
