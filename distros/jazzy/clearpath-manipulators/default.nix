...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/jazzy/clearpath_manipulators/2.6.1-1.tar.gz";
    name = "2.6.1-1.tar.gz";
    sha256 = "78794698989f42fb74b3ed24fed640191194a7edd51c6878ea3492cf5d27991d";
  };
