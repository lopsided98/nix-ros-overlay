...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/pose_cov_ops-release/archive/release/jazzy/pose_cov_ops/0.3.11-3.tar.gz";
    name = "0.3.11-3.tar.gz";
    sha256 = "103a5f11596283664f0391b084be3607c0ba42f62c1034abbbfee63f64494666";
  };
