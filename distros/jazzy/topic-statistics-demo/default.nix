...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/jazzy/topic_statistics_demo/0.33.8-1.tar.gz";
    name = "0.33.8-1.tar.gz";
    sha256 = "876601a740b0759f3889196bac24d44c5e428a38105b688d4b84b6fed513fece";
  };
