...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_system_tests/1.3.5-1.tar.gz";
    name = "1.3.5-1.tar.gz";
    sha256 = "ddfe516d9d85af2e1ae69f548b7778d70cc197d91c7d53edea1401c12abad8e9";
  };
