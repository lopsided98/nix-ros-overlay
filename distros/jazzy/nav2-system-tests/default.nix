...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_system_tests/1.3.11-1.tar.gz";
    name = "1.3.11-1.tar.gz";
    sha256 = "1e00a4b6af4693e39b385f0cfb77a18333781c52e1ee00927678706eb84946c9";
  };
