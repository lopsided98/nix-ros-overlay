...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_system_tests/1.3.10-1.tar.gz";
    name = "1.3.10-1.tar.gz";
    sha256 = "4361f6e4812135645bc4eeb1f1f4d682a1f3c76798f7a348b410f6998e19f423";
  };
