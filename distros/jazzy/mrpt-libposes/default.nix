...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libposes/2.15.15-1.tar.gz";
    name = "2.15.15-1.tar.gz";
    sha256 = "00b4830edc50cf70bc42822a9722b9ee6ce82e7e0410c39c75baae7423f2fdc6";
  };
