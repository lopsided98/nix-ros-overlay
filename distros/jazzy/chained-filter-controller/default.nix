...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/chained_filter_controller/4.40.1-1.tar.gz";
    name = "4.40.1-1.tar.gz";
    sha256 = "fbdf2b966d2f359355148724e74e36c56051618fb0c17807144633b3b1c38da6";
  };
