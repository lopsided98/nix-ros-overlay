...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_embodied_agents-release/archive/release/jazzy/automatika_embodied_agents/0.7.1-1.tar.gz";
    name = "0.7.1-1.tar.gz";
    sha256 = "d567c98649bd0fed1046957e11fd7d2cc694420cfcb459c7aba791e3e7751f7e";
  };
