...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_embodied_agents-release/archive/release/jazzy/automatika_embodied_agents/0.7.4-1.tar.gz";
    name = "0.7.4-1.tar.gz";
    sha256 = "6e6bfc26bb2a8aad342acc5720c60fc0fbb77a6f648816188d0350558251a9d6";
  };
