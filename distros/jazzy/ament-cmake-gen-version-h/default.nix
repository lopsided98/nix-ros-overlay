...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/jazzy/ament_cmake_gen_version_h/2.5.4-1.tar.gz";
    name = "2.5.4-1.tar.gz";
    sha256 = "c6acf17499fa75e82650d47597d823512c4a6f895b7d6811adeeb408c33fd047";
  };
