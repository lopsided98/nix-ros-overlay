...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/jazzy/ament_cmake_gen_version_h/2.5.0-2.tar.gz";
    name = "2.5.0-2.tar.gz";
    sha256 = "b6cf9f5b815ac84cec3c537c3da01066c0729bbfea47346c9bc2af19035e8004";
  };
