...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/jazzy/yasmin_editor/4.2.4-1.tar.gz";
    name = "4.2.4-1.tar.gz";
    sha256 = "dc4dfe24cd049c7527cdec490164e9ff2cba393c01e7da51a65f3112d6c51184";
  };
