...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/jazzy/ament_cmake_gmock/2.5.5-1.tar.gz";
    name = "2.5.5-1.tar.gz";
    sha256 = "9fcfed564110cb8d7e426255002d7e167ed629ded9a8c5fa3db2ffe03b89ba71";
  };
