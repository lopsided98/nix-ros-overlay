...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/jazzy/ament_cmake_gmock/2.5.4-1.tar.gz";
    name = "2.5.4-1.tar.gz";
    sha256 = "792a73ea51bac61aa3ff0a295c64eb4805d27263c7dab6a9c424b07aef08a410";
  };
