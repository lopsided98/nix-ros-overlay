...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/jazzy/ament_cmake_gmock/2.5.6-2.tar.gz";
    name = "2.5.6-2.tar.gz";
    sha256 = "fddb550815f345ad68aee00dfffa2ee0393e6e77b5133f0cc739e64cf0c4a91d";
  };
