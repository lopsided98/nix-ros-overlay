...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/jazzy/yasmin_factory/4.2.2-1.tar.gz";
    name = "4.2.2-1.tar.gz";
    sha256 = "4c4e21c084b95373b8f38cb05433ef6044f652b85246e65a6728178dda4850f5";
  };
