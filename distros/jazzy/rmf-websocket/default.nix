...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_ros2-release/archive/release/jazzy/rmf_websocket/2.6.0-2.tar.gz";
    name = "2.6.0-2.tar.gz";
    sha256 = "ae6a7af0a5d59ce94208833694de8449aaee62fbb4cdd5caa7b89fffcf348697";
  };
