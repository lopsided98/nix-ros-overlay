...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/jazzy/ffw_joint_trajectory_command_broadcaster/1.1.10-1.tar.gz";
    name = "1.1.10-1.tar.gz";
    sha256 = "c9fd5e3881325bfb8a6b281c357a84c871037f04dd4fe75d37e7f785c7fcdd27";
  };
