...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/jazzy/ffw_joint_trajectory_command_broadcaster/1.1.16-1.tar.gz";
    name = "1.1.16-1.tar.gz";
    sha256 = "9fe690e9e583a9a70adcc8477673fcdff1c2540b804908dceb26c3efc0a2dccf";
  };
