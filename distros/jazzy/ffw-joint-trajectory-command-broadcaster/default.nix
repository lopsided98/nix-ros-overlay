...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/jazzy/ffw_joint_trajectory_command_broadcaster/1.1.7-1.tar.gz";
    name = "1.1.7-1.tar.gz";
    sha256 = "4a68c9b4a90c8feb35e2a69eebe851976523e7b130d35b89123ac4f81c9cfbea";
  };
