...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/jazzy/ffw_joint_trajectory_command_broadcaster/1.1.8-1.tar.gz";
    name = "1.1.8-1.tar.gz";
    sha256 = "7efa127e480057a917cd6c284d334e53bcf235a25c12c7f6c2433e71b5c9be1c";
  };
