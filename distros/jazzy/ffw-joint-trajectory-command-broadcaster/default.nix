...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/jazzy/ffw_joint_trajectory_command_broadcaster/1.0.9-1.tar.gz";
    name = "1.0.9-1.tar.gz";
    sha256 = "98f1a4ccd7c914059ca2b258e63ac1a56bc4764fb1a6d0cc5323909b2f534b94";
  };
