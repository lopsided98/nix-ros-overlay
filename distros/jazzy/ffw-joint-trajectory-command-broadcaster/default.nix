...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/jazzy/ffw_joint_trajectory_command_broadcaster/1.1.14-1.tar.gz";
    name = "1.1.14-1.tar.gz";
    sha256 = "e25550488c89ee92fc2c758da67c66d023e8ffc07db1bd07d3d1a863c3ecde85";
  };
