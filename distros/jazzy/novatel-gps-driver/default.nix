...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/novatel_gps_driver-release/archive/release/jazzy/novatel_gps_driver/4.1.2-5.tar.gz";
    name = "4.1.2-5.tar.gz";
    sha256 = "a72915e012099e06cc86593613cd5926939a2f9371129234eaaa512928fce366";
  };
