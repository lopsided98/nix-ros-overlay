...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/lanelet2-release/archive/release/jazzy/lanelet2_examples/1.2.3-1.tar.gz";
    name = "1.2.3-1.tar.gz";
    sha256 = "41a2ded342dc26b51d2f9c8718f9f739fe143a42b6c2f40c934a3913b8cdcd36";
  };
