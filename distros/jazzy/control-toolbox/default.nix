...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/control_toolbox-release/archive/release/jazzy/control_toolbox/4.6.0-1.tar.gz";
    name = "4.6.0-1.tar.gz";
    sha256 = "fc78ea227089bb53e6c610a71a636f6035581ae17d10914be6725a4e33501006";
  };
