...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2multicast/0.32.1-1.tar.gz";
    name = "0.32.1-1.tar.gz";
    sha256 = "5223e3de1971c6628c863f9b433d1828ce8099296b9045bfa781ce80bda197c1";
  };
