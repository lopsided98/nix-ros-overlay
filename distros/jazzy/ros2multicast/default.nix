...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2multicast/0.32.8-1.tar.gz";
    name = "0.32.8-1.tar.gz";
    sha256 = "1143252a78af59659da7f9a52ded9f575b8e809523b3d5da4e11fd2a4e0baa29";
  };
