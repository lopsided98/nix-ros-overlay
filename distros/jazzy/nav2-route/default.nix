...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_route/1.3.11-1.tar.gz";
    name = "1.3.11-1.tar.gz";
    sha256 = "99d95fa89b0efc76e87b009df0d0fb27b0971659fd738cec230e4cd077a72eb0";
  };
