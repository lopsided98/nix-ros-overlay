...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_route/1.3.12-1.tar.gz";
    name = "1.3.12-1.tar.gz";
    sha256 = "a885ad9b879fb616793cd77fd3bb1c9ae7ee86d4cbc24a0fbe0fd4feb8ba58fc";
  };
