...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/generate_parameter_library-release/archive/release/jazzy/parameter_traits/0.6.0-1.tar.gz";
    name = "0.6.0-1.tar.gz";
    sha256 = "4410fec9dcc57037a3dd6f14910f3f2f31a25c49b975ae06128cda8155de71ed";
  };
