...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/jazzy/moveit_runtime/2.12.0-1.tar.gz";
    name = "2.12.0-1.tar.gz";
    sha256 = "00d2e8a5879ab557ee498c372f666227036d67d674317d20192d7dfcd826a385";
  };
