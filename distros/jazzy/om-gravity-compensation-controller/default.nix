...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/jazzy/om_gravity_compensation_controller/4.1.2-1.tar.gz";
    name = "4.1.2-1.tar.gz";
    sha256 = "8fbd94f6dae103c0aa5c82539eda9231a5506eedd16d2fdbc58d49dc8dd43365";
  };
