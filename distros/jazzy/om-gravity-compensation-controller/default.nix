...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/jazzy/om_gravity_compensation_controller/4.1.3-1.tar.gz";
    name = "4.1.3-1.tar.gz";
    sha256 = "1f6aaedebc405aef0f02d24bb0c2e709d007c062d328be7383c344c657ab7bf2";
  };
