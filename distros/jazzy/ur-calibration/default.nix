...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/jazzy/ur_calibration/3.0.0-1.tar.gz";
    name = "3.0.0-1.tar.gz";
    sha256 = "8b2290aa1cdbd9c457c40c3909317e6a73a342868c289927b07e1e34a1573c67";
  };
