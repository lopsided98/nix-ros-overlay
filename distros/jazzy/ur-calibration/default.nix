...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/jazzy/ur_calibration/2.4.5-1.tar.gz";
    name = "2.4.5-1.tar.gz";
    sha256 = "184618df03f13b49ef124427a1efff451c5efe7d7c637ede214ada94dd82174c";
  };
