...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/jazzy/swri_route_util/3.11.0-1.tar.gz";
    name = "3.11.0-1.tar.gz";
    sha256 = "141211f9be275adc766ec01b351fae5748708fcedfc638a86ce336f041dba377";
  };
