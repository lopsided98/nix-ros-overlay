...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/jazzy/swri_route_util/3.8.4-1.tar.gz";
    name = "3.8.4-1.tar.gz";
    sha256 = "c298e99d2042ed1eec42d276431479f94b52fba55b720a9d05910320d135d9ee";
  };
