...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/jazzy/swri_route_util/3.7.1-1.tar.gz";
    name = "3.7.1-1.tar.gz";
    sha256 = "136dc019b1907a5fa36d2419eba3e6e373843364ff39883e04b1fa663ff650e8";
  };
