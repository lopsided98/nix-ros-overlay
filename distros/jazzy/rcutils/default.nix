...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcutils-release/archive/release/jazzy/rcutils/6.7.3-1.tar.gz";
    name = "6.7.3-1.tar.gz";
    sha256 = "aedcc04bc0095125e4cbba12ba08299904be3787935d7fc1d7024f1020cf21b6";
  };
