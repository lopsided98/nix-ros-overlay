...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/examples-release/archive/release/jazzy/examples_rclpy_minimal_action_client/0.19.7-1.tar.gz";
    name = "0.19.7-1.tar.gz";
    sha256 = "99cfd7e4f8347d91a616ac511a40e285667320d82c0cc15cc8fbefe780f2b8d6";
  };
