...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/jazzy/ros_gz_sim_demos/1.0.21-1.tar.gz";
    name = "1.0.21-1.tar.gz";
    sha256 = "a328bb7fd14da4a838e84dd32a3d42b2b702fcc3a710b6a9ffdb164ef2b41931";
  };
