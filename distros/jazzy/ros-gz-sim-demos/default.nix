...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/jazzy/ros_gz_sim_demos/1.0.0-1.tar.gz";
    name = "1.0.0-1.tar.gz";
    sha256 = "29b3fff1cdb10a0e0087a3d039ad28f695e576033a295336a1493e218f78b313";
  };
