...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/jazzy/ros_gz_sim_demos/1.0.22-1.tar.gz";
    name = "1.0.22-1.tar.gz";
    sha256 = "69be79b6b9640f628b84a8a9e278202796ff7e84c6943ca9184e4c87f2e7ae91";
  };
