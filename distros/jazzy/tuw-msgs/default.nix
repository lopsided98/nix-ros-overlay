...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/tuw_msgs-release/archive/release/jazzy/tuw_msgs/0.2.6-1.tar.gz";
    name = "0.2.6-1.tar.gz";
    sha256 = "0d591d9119ab360ab87fb5a17ccb3146400cdb7a9b0f3785ceb9a6a3a76ae856";
  };
