...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/jazzy/ament_cmake_auto/2.5.6-2.tar.gz";
    name = "2.5.6-2.tar.gz";
    sha256 = "79390e29c01cdc027c61a4581536271e11ff52128c31c838cc040128a1f09094";
  };
