...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/jazzy/clearpath_sensors_description/2.9.9-1.tar.gz";
    name = "2.9.9-1.tar.gz";
    sha256 = "35ad6706145ef26f05acf96f80f101426469225950f3d0ac2f9c805080810bd7";
  };
