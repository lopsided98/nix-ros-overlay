...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/clearpath_common-release/archive/release/jazzy/clearpath_sensors_description/2.9.3-1.tar.gz";
    name = "2.9.3-1.tar.gz";
    sha256 = "7e2b4aae3400e043114e063ac110961527c2a05b6a18d6ada3c52c6c970d0de9";
  };
