...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_map_server/1.3.7-1.tar.gz";
    name = "1.3.7-1.tar.gz";
    sha256 = "efe7ded7e40f3506c4f347d720903b75f5a0612228b6fbeb56b34feaa199e64c";
  };
