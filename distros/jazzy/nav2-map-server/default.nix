...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_map_server/1.3.6-1.tar.gz";
    name = "1.3.6-1.tar.gz";
    sha256 = "63d5afcab3039421fedcfbb2797fdccbcefe7e16d95ca2e6bb0f05553db780f2";
  };
