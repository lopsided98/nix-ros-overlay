...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_map_server/1.3.10-1.tar.gz";
    name = "1.3.10-1.tar.gz";
    sha256 = "2f67e630759080421d8d0c7592cc1623dbfeee9c059f2a3fb4b29efb5cda2c8d";
  };
