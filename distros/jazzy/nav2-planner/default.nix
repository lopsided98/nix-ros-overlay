...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_planner/1.3.5-1.tar.gz";
    name = "1.3.5-1.tar.gz";
    sha256 = "0b9a696b9e8e2697f1529e2115b3c549eaca4190660e3d8a07cab312c6c2fbca";
  };
