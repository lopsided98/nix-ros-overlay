...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_planner/1.3.12-1.tar.gz";
    name = "1.3.12-1.tar.gz";
    sha256 = "f0c4c8e4e2bcf0d2d795bed6714e9377b88b06cab04446fe7ac531c6ddb784cf";
  };
