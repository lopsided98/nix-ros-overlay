...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_planner/1.3.6-1.tar.gz";
    name = "1.3.6-1.tar.gz";
    sha256 = "b0d3d5102cf76e651f5deba930fe41b9a4ead717b3ca0af27f59e096d4faaa84";
  };
