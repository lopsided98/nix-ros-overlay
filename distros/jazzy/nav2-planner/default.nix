...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_planner/1.3.4-1.tar.gz";
    name = "1.3.4-1.tar.gz";
    sha256 = "3e43d6d9884e3138f7cc31c586f36eea9ce59b1854a0f2302d0fec2e3e392fd0";
  };
