...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_navfn_planner/1.3.7-1.tar.gz";
    name = "1.3.7-1.tar.gz";
    sha256 = "a68aaa1238c17d59fc13728fbb323febd5641620cadd4116ca4ab616f1aadcb6";
  };
