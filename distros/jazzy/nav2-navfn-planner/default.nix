...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_navfn_planner/1.3.6-1.tar.gz";
    name = "1.3.6-1.tar.gz";
    sha256 = "6ec4d92bc3ec4e8a848941627a20c0651e521ec052c51b56ef860d2dd48d80c4";
  };
