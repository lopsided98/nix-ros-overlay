...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/orbbec/orbbec_camera_v1-release/archive/release/jazzy/orbbec_camera/1.5.14-1.tar.gz";
    name = "1.5.14-1.tar.gz";
    sha256 = "ecf579d6e58817534e78ffcbe3417f870769c435739112fef9c16b16bd44b843";
  };
