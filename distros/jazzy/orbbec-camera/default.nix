...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/orbbec_camera_v2-release/archive/release/jazzy/orbbec_camera/2.9.3-2.tar.gz";
    name = "2.9.3-2.tar.gz";
    sha256 = "e7a3d02a01d90bb08dbcd018e0d826efc95c74428788b576e125b3e280e78931";
  };
