...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/web_video_server-release/archive/release/jazzy/web_video_server/2.1.1-1.tar.gz";
    name = "2.1.1-1.tar.gz";
    sha256 = "37b85d8c4d5816e304f99352533ce7dc68a0481fc99e6b6ec5cc5e3a72c4bb74";
  };
