...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_theta_star_planner/1.3.4-1.tar.gz";
    name = "1.3.4-1.tar.gz";
    sha256 = "c65695bea701054bfc7c363c6ba0162802f4a6190448b73f470a6ef0c423a8da";
  };
