...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_rendering_tests/14.1.12-1.tar.gz";
    name = "14.1.12-1.tar.gz";
    sha256 = "b24de55a0a2c439a5f172f822a59902741e7dd3fe105fab7d2678710ce5e50bd";
  };
