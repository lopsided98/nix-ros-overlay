...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_rendering_tests/14.1.5-1.tar.gz";
    name = "14.1.5-1.tar.gz";
    sha256 = "408a55b657fc009fc72c43d15c3cf815adece05d32ab4a314b63620a25660569";
  };
