...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_rendering_tests/14.1.13-1.tar.gz";
    name = "14.1.13-1.tar.gz";
    sha256 = "67e973fcfad9a55b2aa8808a9937a0e256e6d493303318840adda438596cf33a";
  };
