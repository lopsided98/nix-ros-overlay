...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/zed-ros2-interfaces-release/archive/release/jazzy/zed_msgs/5.0.1-1.tar.gz";
    name = "5.0.1-1.tar.gz";
    sha256 = "a7781864f2614bde63d912005230d563da6cf2316db5811c0f629ed5b252cd7e";
  };
