...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/jazzy/mrpt_libhwdrivers/2.15.15-1.tar.gz";
    name = "2.15.15-1.tar.gz";
    sha256 = "92987abd503e40fbcbf9691a0aa82e21343ccb6ddc2b513ed361d5432641bb14";
  };
