...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/ros2_controllers_test_nodes/4.29.0-1.tar.gz";
    name = "4.29.0-1.tar.gz";
    sha256 = "1fd6f25e684edf6553be3a89ebacbd530d7e3b2a631f8cadb352b56f98e5a7d8";
  };
