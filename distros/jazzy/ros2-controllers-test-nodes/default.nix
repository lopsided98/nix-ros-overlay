...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/ros2_controllers_test_nodes/4.30.1-1.tar.gz";
    name = "4.30.1-1.tar.gz";
    sha256 = "23888dfbc0ac1a0901e8dc577f5132248aa922328352eb4df7e0c3edec320aac";
  };
