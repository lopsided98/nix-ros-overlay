...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/ros2_controllers_test_nodes/4.26.0-1.tar.gz";
    name = "4.26.0-1.tar.gz";
    sha256 = "1be1b4931b106eaab9c7a166ad852f6dff164cd1fdcea49cb28c947ea1bd2146";
  };
