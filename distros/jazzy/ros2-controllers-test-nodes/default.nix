...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/ros2_controllers_test_nodes/4.28.0-1.tar.gz";
    name = "4.28.0-1.tar.gz";
    sha256 = "ab4ffa6816b03977e09fddd2751811559f83e68b47a839cbee896180e258347a";
  };
