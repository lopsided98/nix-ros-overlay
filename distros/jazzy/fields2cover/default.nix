...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fields2cover-release/archive/release/jazzy/fields2cover/2.1.1-1.tar.gz";
    name = "2.1.1-1.tar.gz";
    sha256 = "c4dd77832fdaa268266cf4da05fb6649f253a3a7fc13f7473c1fc7535356e661";
  };
