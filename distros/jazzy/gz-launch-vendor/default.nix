...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gz_launch_vendor-release/archive/release/jazzy/gz_launch_vendor/0.0.6-1.tar.gz";
    name = "0.0.6-1.tar.gz";
    sha256 = "e6918f6e88b6775d5565dc402bdac94f12cef1ee25e707a1e7c2935023a2f5c8";
  };
