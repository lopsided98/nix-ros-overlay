...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/jazzy/tf2_tools/0.36.23-1.tar.gz";
    name = "0.36.23-1.tar.gz";
    sha256 = "4fac86526b50a71cb408daf19df2a6e51e0c05c2affb09f8add0280e58aefdc9";
  };
