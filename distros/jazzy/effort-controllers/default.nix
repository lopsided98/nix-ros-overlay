...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/effort_controllers/4.30.0-1.tar.gz";
    name = "4.30.0-1.tar.gz";
    sha256 = "7d48d7a988ebbf6a1dc57d8671a0f5937bf41a7a88a2d117db70f96d27e5b24b";
  };
