...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/effort_controllers/4.26.0-1.tar.gz";
    name = "4.26.0-1.tar.gz";
    sha256 = "7ccf391fe97428ccb8791a1ef1519c835299630a54e12f486add800bd3f891dd";
  };
