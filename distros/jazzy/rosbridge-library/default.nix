...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/jazzy/rosbridge_library/2.7.1-1.tar.gz";
    name = "2.7.1-1.tar.gz";
    sha256 = "76eedaf1fc302d32cd61a6f9414c89c3bda697fa3b7b6bc5a06988cf0e8c7a42";
  };
