...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/jazzy/ffw_joystick_controller/1.0.8-1.tar.gz";
    name = "1.0.8-1.tar.gz";
    sha256 = "5acdfca003a68055115761c8a1e1059b5039068bc66ffac79b8f4c94bd119af6";
  };
