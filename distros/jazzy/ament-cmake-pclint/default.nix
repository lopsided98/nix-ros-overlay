...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/jazzy/ament_cmake_pclint/0.17.4-1.tar.gz";
    name = "0.17.4-1.tar.gz";
    sha256 = "d4a6ac0bc730030d281d733db2681679fabc94c086f363d0f8947cb3af8d0e3e";
  };
