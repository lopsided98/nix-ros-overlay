...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/jazzy/image_publisher/5.0.11-1.tar.gz";
    name = "5.0.11-1.tar.gz";
    sha256 = "952dd790c195d13d0321b865676faa369c6f40e44eedb5efa0fe727c4ea71f9f";
  };
