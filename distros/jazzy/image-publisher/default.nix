...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/jazzy/image_publisher/5.0.10-1.tar.gz";
    name = "5.0.10-1.tar.gz";
    sha256 = "0c794272315aa584106b9409d7426d814474cfc541b7f04951a104e50286db60";
  };
