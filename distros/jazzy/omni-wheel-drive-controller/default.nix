...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/omni_wheel_drive_controller/4.30.1-1.tar.gz";
    name = "4.30.1-1.tar.gz";
    sha256 = "4b2a6ae5b7c47b64ce919c9bdec7945a8a4ff871e198edac80785a8cbfe1a944";
  };
