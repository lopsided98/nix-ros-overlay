...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/omni_wheel_drive_controller/4.30.0-1.tar.gz";
    name = "4.30.0-1.tar.gz";
    sha256 = "5f6904ea19120a8819076e8961325431c231950621fa254cd9e264461b30cc54";
  };
