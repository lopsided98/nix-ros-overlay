...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/examples-release/archive/release/jazzy/examples_rclcpp_cbg_executor/0.19.7-1.tar.gz";
    name = "0.19.7-1.tar.gz";
    sha256 = "6664624d95c0b8b9b08632c9196286c0ea0bcbba9abbfe84ab0bd81112c6f2bd";
  };
