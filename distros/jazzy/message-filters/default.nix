...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_message_filters-release/archive/release/jazzy/message_filters/4.11.7-1.tar.gz";
    name = "4.11.7-1.tar.gz";
    sha256 = "8d92deb6ecce96ea00502d7f9991d48b58e9b65a2cf7edb4fbe231ad93e36dd1";
  };
