...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/position_controllers/4.30.0-1.tar.gz";
    name = "4.30.0-1.tar.gz";
    sha256 = "ac26e0201fec51455ca6207d440003ef8a90e4e604441d6b92f01c1d80168383";
  };
