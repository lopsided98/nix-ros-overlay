...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/position_controllers/4.42.1-1.tar.gz";
    name = "4.42.1-1.tar.gz";
    sha256 = "a6e372afac310efffc254b7ca79f2807c81a0aa86e1651b761b13efed83baf63";
  };
