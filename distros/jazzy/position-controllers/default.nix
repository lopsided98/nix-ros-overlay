...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/position_controllers/4.29.0-1.tar.gz";
    name = "4.29.0-1.tar.gz";
    sha256 = "dadfd922da6fb4f2c3f002d4a56ebf7af74b879a2ec1055b4a423c9934d2a6a9";
  };
