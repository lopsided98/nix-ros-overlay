...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/nobleo/rviz_satellite-release/archive/release/jazzy/rviz_satellite/4.0.0-1.tar.gz";
    name = "4.0.0-1.tar.gz";
    sha256 = "5ce4383c40adffc475fb291b1aec110d547e554cdb0772642f5764ee2ba14880";
  };
