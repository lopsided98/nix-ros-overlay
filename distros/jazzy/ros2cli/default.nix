...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/jazzy/ros2cli/0.32.11-1.tar.gz";
    name = "0.32.11-1.tar.gz";
    sha256 = "78d75d63705a59fe5a5144dc2168adfdff77df0826cd82fac046e9f402031acb";
  };
