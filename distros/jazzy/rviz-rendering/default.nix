...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_rendering/14.1.19-1.tar.gz";
    name = "14.1.19-1.tar.gz";
    sha256 = "def28db459ce27a908f9be18a521eaa10317325523b46f301eb462705c08edfc";
  };
