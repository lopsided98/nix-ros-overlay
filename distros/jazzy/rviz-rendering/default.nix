...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_rendering/14.1.1-1.tar.gz";
    name = "14.1.1-1.tar.gz";
    sha256 = "6a71d9a52e1c783b99c276e6ce7efb419453f0150bce3d9b0f198bd715837fe0";
  };
