...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/lanelet2-release/archive/release/jazzy/lanelet2/1.2.3-1.tar.gz";
    name = "1.2.3-1.tar.gz";
    sha256 = "9112da0b684a9fd862867c934960dda4459a17c0d88aeada5811deed15b808f7";
  };
