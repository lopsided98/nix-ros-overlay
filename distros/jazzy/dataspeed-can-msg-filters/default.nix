...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/DataspeedInc-release/dataspeed_can-release/archive/release/jazzy/dataspeed_can_msg_filters/2.0.7-1.tar.gz";
    name = "2.0.7-1.tar.gz";
    sha256 = "41a8c093ab40d214c85957dc56bbc5b2e7643a80f0ee965d4756a9e894dd0cc9";
  };
