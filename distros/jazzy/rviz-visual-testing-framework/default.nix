...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_visual_testing_framework/14.1.18-1.tar.gz";
    name = "14.1.18-1.tar.gz";
    sha256 = "652df3917293d4c2b15cecbf3277bf4561e72988ea6669ec6e45570bb78aa6ba";
  };
