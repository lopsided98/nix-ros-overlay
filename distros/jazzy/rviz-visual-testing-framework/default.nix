...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_visual_testing_framework/14.1.13-1.tar.gz";
    name = "14.1.13-1.tar.gz";
    sha256 = "cd44f4038206f2ebaadba6b04b369eda019889d261106f58698d232c5d768408";
  };
