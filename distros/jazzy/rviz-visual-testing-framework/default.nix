...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_visual_testing_framework/14.1.17-1.tar.gz";
    name = "14.1.17-1.tar.gz";
    sha256 = "40ea6b4323f20ea780be34b6628805a39132344f6fd2cc116cd81517d88fafbb";
  };
