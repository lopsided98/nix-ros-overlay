...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/jazzy/rviz_visual_testing_framework/14.1.12-1.tar.gz";
    name = "14.1.12-1.tar.gz";
    sha256 = "91b9f1d1b0db4158643e7b9a7b0f1f7ce008b30d75779ee2c6567a7d25d84ea4";
  };
