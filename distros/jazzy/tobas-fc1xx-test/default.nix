...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/tobas-release/archive/release/jazzy/tobas_fc1xx_test/2.16.2-2.tar.gz";
    name = "2.16.2-2.tar.gz";
    sha256 = "813890c1075076ea69605d16edca6a4aa347b39b044256104f011487fc9b10e7";
  };
