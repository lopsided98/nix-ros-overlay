...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/hardware_interface/4.30.0-1.tar.gz";
    name = "4.30.0-1.tar.gz";
    sha256 = "d2686b4aacecd1a1bcc166202c32cb3cfeaa91fa0044d42117782cdca0eb39ce";
  };
