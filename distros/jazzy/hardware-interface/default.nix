...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/hardware_interface/4.39.0-1.tar.gz";
    name = "4.39.0-1.tar.gz";
    sha256 = "bccfa28024c810fd0efaab69c5a1a7add31772b98dda71e7a92f53cc38b082a2";
  };
