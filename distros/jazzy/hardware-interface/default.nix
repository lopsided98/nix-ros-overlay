...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/hardware_interface/4.47.0-1.tar.gz";
    name = "4.47.0-1.tar.gz";
    sha256 = "3c45acc33cdef506f9dc4c5fc000f6af12fce042b6f24adb93434ac391b779d3";
  };
