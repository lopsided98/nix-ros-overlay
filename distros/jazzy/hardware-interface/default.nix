...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/hardware_interface/4.40.0-1.tar.gz";
    name = "4.40.0-1.tar.gz";
    sha256 = "40bb3588ffb6f61507e0d2597f05d9ea051b52fd9e12ee9cbacb1bd468ec9dc3";
  };
