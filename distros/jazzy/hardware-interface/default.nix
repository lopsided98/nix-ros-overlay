...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/hardware_interface/4.35.0-1.tar.gz";
    name = "4.35.0-1.tar.gz";
    sha256 = "cc6fbe9591d4276daf4e1402206030c362835ae7d4dc8486d45d6de530f78a42";
  };
