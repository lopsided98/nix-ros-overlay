...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/sick_safetyscanners2-release/archive/release/jazzy/sick_safetyscanners2/1.0.5-1.tar.gz";
    name = "1.0.5-1.tar.gz";
    sha256 = "f5ec28d2e3eb300e68303b87bb12222de4126d1f03758fe72af4f1226473676f";
  };
