...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit_task_constructor-release/archive/release/jazzy/moveit_task_constructor_visualization/0.1.8-1.tar.gz";
    name = "0.1.8-1.tar.gz";
    sha256 = "ade3047f35f436553c2f3333b2a14743d6ece0ffbbc6fd28d53cc35c8545a87a";
  };
