...
buildRosPackage {
  pname = "ros-jazzy-ecl-geometry";
  version = "1.2.1-r5";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/jazzy/ecl_geometry/1.2.1-5.tar.gz";
    name = "1.2.1-5.tar.gz";
    sha256 = "7254c9d333e756c50bc6355ca8381e97889d08de6291c011c83b93c05b1746e7";
  };
