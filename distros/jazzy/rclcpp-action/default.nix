...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/jazzy/rclcpp_action/28.1.17-3.tar.gz";
    name = "28.1.17-3.tar.gz";
    sha256 = "751398afb29dc468a2d1dcc93823c36aafe81a185deeb6e35f9c5d8808c73258";
  };
