...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/point_cloud_transport-release/archive/release/jazzy/point_cloud_transport_py/4.0.1-1.tar.gz";
    name = "4.0.1-1.tar.gz";
    sha256 = "1c6bdbf757e522abf21ff5114518935d50dc93a19db5906e7b601f9cdc025e91";
  };
