...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_constrained_smoother/1.3.7-1.tar.gz";
    name = "1.3.7-1.tar.gz";
    sha256 = "4784b4335f06cf3b4116f10e90403d777acda0ec2809b0d7fe4d6aedb64f4bea";
  };
