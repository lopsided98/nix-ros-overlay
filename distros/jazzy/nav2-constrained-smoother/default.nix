...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_constrained_smoother/1.3.11-1.tar.gz";
    name = "1.3.11-1.tar.gz";
    sha256 = "adecde694c3a0bd8750f0ac7c54d46b158e73e0aa3b133efa926f42d001a1de6";
  };
