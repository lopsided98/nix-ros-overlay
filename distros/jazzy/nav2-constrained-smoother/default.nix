...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_constrained_smoother/1.3.10-1.tar.gz";
    name = "1.3.10-1.tar.gz";
    sha256 = "858ff51cd31be8a0e8bd693096e92b55cc02ac2b13e0fd53bda35151c2ecb1fa";
  };
