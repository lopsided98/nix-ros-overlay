...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_constrained_smoother/1.3.5-1.tar.gz";
    name = "1.3.5-1.tar.gz";
    sha256 = "e9c499cf57d0e632aa71630efcd80b764375b8473ba4babb082e95a02a102ece";
  };
