...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/imu_sensor_broadcaster/4.30.0-1.tar.gz";
    name = "4.30.0-1.tar.gz";
    sha256 = "02c1e4c876ec73f4267d8401faf177c44e35b5f05c1ff4eb010612e6d82650da";
  };
