...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/imu_sensor_broadcaster/4.26.0-1.tar.gz";
    name = "4.26.0-1.tar.gz";
    sha256 = "e5079d1838f4744d453de8eb3ee21dcae42e3617867c6decbcfe8bb3e66f6cce";
  };
