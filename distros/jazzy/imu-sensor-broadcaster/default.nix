...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/imu_sensor_broadcaster/4.35.0-1.tar.gz";
    name = "4.35.0-1.tar.gz";
    sha256 = "48ca7c80850bcfca456e10d6701ba0dc33d9acea8d976170ed3d2bdbc37ecced";
  };
