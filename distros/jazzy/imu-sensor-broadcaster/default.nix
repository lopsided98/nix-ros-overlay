...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/imu_sensor_broadcaster/4.13.0-1.tar.gz";
    name = "4.13.0-1.tar.gz";
    sha256 = "f49a7f39d2de550e4e6b16c992a3a4d5bdefb8106662e6a11f8541debec0d395";
  };
