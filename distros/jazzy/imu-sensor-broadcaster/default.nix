...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/imu_sensor_broadcaster/4.27.1-1.tar.gz";
    name = "4.27.1-1.tar.gz";
    sha256 = "88cae7d649ad9515bc803acf88d500d013f9f953e92190290469612afa0886bb";
  };
