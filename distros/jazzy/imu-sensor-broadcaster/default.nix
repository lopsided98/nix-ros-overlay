...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/imu_sensor_broadcaster/4.28.0-1.tar.gz";
    name = "4.28.0-1.tar.gz";
    sha256 = "ac2adb264ddfc5d0b2a1d2c60f8ef2f6e81d628d08755e72d6d6c5b2a20bbe92";
  };
