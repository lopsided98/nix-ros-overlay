...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/imu_sensor_broadcaster/4.17.0-1.tar.gz";
    name = "4.17.0-1.tar.gz";
    sha256 = "5cb33f9a29e9cf8f46b93f96ecced790b43f6ff888f794a148f885b1deab264d";
  };
