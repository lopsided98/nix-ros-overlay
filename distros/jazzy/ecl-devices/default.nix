...
buildRosPackage {
  pname = "ros-jazzy-ecl-devices";
  version = "1.2.1-r5";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/jazzy/ecl_devices/1.2.1-5.tar.gz";
    name = "1.2.1-5.tar.gz";
    sha256 = "1dad2eae3a8a9062f01f0ff819474c96fb0feabf4d8b19a177bd6d0d83e77b5e";
  };
