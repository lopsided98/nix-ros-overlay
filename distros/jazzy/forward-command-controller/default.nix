...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/forward_command_controller/4.27.1-1.tar.gz";
    name = "4.27.1-1.tar.gz";
    sha256 = "b6d24d5a9df408c76f201dee87cbcbee60b91dcb7debd062fc2c0540505bcb6f";
  };
