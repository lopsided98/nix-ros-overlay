...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/forward_command_controller/4.34.0-1.tar.gz";
    name = "4.34.0-1.tar.gz";
    sha256 = "4d0c6881ad8fbeb6551f9f1edee7109e3da51d6e06c25d81f8015895f3e53832";
  };
