...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/forward_command_controller/4.26.0-1.tar.gz";
    name = "4.26.0-1.tar.gz";
    sha256 = "125f08ba95da501eb8c36b8b4c368a072060599131d9ebc6df643b7f8c656b30";
  };
