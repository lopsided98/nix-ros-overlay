...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/forward_command_controller/4.27.0-1.tar.gz";
    name = "4.27.0-1.tar.gz";
    sha256 = "c342b6b16b3c94b6e19ae040b62f56b504bfe570b635cc021e0120a58bf5c4c1";
  };
