...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/jazzy/forward_command_controller/4.35.0-1.tar.gz";
    name = "4.35.0-1.tar.gz";
    sha256 = "2833e69b7ee56c1efc6466ac78c28f30cef3c5cbb10842071120bbaf87f5dd66";
  };
