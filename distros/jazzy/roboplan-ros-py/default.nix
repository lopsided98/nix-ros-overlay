...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/roboplan_ros-release/archive/release/jazzy/roboplan_ros_py/0.6.1-1.tar.gz";
    name = "0.6.1-1.tar.gz";
    sha256 = "7bff57aa4ec92ea87d6be2edde4d8a6bc94f4efd3c6211e03b718a857e41f858";
  };
