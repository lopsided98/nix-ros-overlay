...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_regulated_pure_pursuit_controller/1.3.10-1.tar.gz";
    name = "1.3.10-1.tar.gz";
    sha256 = "9c949282fc9db8c0a106fd9da5624256f2d3e2ecc9faff5fc3ae5905c5ac4b91";
  };
