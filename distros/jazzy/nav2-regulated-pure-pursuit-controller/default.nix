...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_regulated_pure_pursuit_controller/1.3.6-1.tar.gz";
    name = "1.3.6-1.tar.gz";
    sha256 = "544d60e81ed055943a0361dea682f84d9499d849457270cec2bed136870670ff";
  };
