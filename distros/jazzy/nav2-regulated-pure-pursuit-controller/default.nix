...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_regulated_pure_pursuit_controller/1.3.11-1.tar.gz";
    name = "1.3.11-1.tar.gz";
    sha256 = "9c5a00d5ec670a83cbb0226fb2ca010d31bc2321fc4e0e3467d4b47302217f26";
  };
