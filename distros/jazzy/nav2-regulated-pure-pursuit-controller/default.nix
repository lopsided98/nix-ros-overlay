...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_regulated_pure_pursuit_controller/1.3.12-1.tar.gz";
    name = "1.3.12-1.tar.gz";
    sha256 = "7682e4bb3c20f31c090eb0d65807c3a0220f548302614bb0a943fa991a43b1db";
  };
