...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/jazzy/nav2_regulated_pure_pursuit_controller/1.3.7-1.tar.gz";
    name = "1.3.7-1.tar.gz";
    sha256 = "41b823bc31d61fae15138c9db061db8d4a5e679fafbf437e817609df5b7aaa76";
  };
