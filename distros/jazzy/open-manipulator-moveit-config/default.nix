...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/jazzy/open_manipulator_moveit_config/4.0.1-1.tar.gz";
    name = "4.0.1-1.tar.gz";
    sha256 = "1be8e1a93053ad9e9ca41217fe6143ee76e38ee71e90add651efa01d4dcc0bb0";
  };
