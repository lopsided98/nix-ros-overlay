...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/jazzy/open_manipulator_moveit_config/4.0.6-1.tar.gz";
    name = "4.0.6-1.tar.gz";
    sha256 = "232ac6fe579591d7365b0df3cf7cefd7b24ab0749a300adb2d8c556a2574086a";
  };
