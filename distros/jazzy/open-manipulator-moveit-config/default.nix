...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/jazzy/open_manipulator_moveit_config/4.0.5-1.tar.gz";
    name = "4.0.5-1.tar.gz";
    sha256 = "62f12f47436da040cd4ce0e340a9009319ccbb8bdf9d89bea7675dc28b9ef0b8";
  };
