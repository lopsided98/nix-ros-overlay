...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/jazzy/open_manipulator_moveit_config/4.1.3-1.tar.gz";
    name = "4.1.3-1.tar.gz";
    sha256 = "c7ae2eef6e9b9f530907807757b2909a36199e4c8e0cb548fdeb6bb83dd40e36";
  };
