...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/jazzy/rclcpp/28.1.16-1.tar.gz";
    name = "28.1.16-1.tar.gz";
    sha256 = "f87b542c337f53ec10b833a35bc39f144a2d618a9af52e1b32a4b753400c3100";
  };
