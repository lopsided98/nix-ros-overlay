...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/jazzy/rclcpp/28.1.10-1.tar.gz";
    name = "28.1.10-1.tar.gz";
    sha256 = "a46c53d261743d9843b4e0dd2d6dd7654a2240affadb3640f4b2420a68c8beb8";
  };
