...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/jazzy/rclcpp/28.1.9-1.tar.gz";
    name = "28.1.9-1.tar.gz";
    sha256 = "b793807b52adbe0c8912d6917fc9ff47a21e93bc6752b94009f8a9a2acc25a72";
  };
