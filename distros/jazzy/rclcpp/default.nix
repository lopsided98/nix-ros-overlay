...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/jazzy/rclcpp/28.1.15-1.tar.gz";
    name = "28.1.15-1.tar.gz";
    sha256 = "317fd6a2b4cbc0b1f56a576a4bba32f96715f7aafa241ff8f001f5884c4eff4e";
  };
