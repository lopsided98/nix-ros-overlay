...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/jazzy/rclcpp/28.1.8-1.tar.gz";
    name = "28.1.8-1.tar.gz";
    sha256 = "786b0cc527c74f4d0787fc32f1fe282318ae4e7c41a607feac5a3284f6418ab1";
  };
