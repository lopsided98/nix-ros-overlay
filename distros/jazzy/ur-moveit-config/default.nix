...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/jazzy/ur_moveit_config/3.8.0-1.tar.gz";
    name = "3.8.0-1.tar.gz";
    sha256 = "d7a833eb726883dc48eb13313e5bc539d4628266e1fb3b83907c5a3871b32f9f";
  };
