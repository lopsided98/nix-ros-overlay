...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/jazzy/ur_moveit_config/2.4.13-1.tar.gz";
    name = "2.4.13-1.tar.gz";
    sha256 = "74676d5ef231f7ebae558466356e2ebf7273752b43dc994ca6c4ed5c1cf4f1bb";
  };
