...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/jazzy/ur_moveit_config/3.3.1-1.tar.gz";
    name = "3.3.1-1.tar.gz";
    sha256 = "a22f60cf74ff981fccb428888dab324d96e24fb05434899d73fc43f1864cf79a";
  };
