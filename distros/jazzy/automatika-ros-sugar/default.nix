...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/jazzy/automatika_ros_sugar/0.4.3-1.tar.gz";
    name = "0.4.3-1.tar.gz";
    sha256 = "d038af99e0da44d3c81bbf90745712d8a567dafa774d399397d8c2fab5423634";
  };
