...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/jazzy/automatika_ros_sugar/0.4.0-1.tar.gz";
    name = "0.4.0-1.tar.gz";
    sha256 = "18c0375ab367a4a993e4144362c13bd83bac9dc17b267ee030763033365551d0";
  };
