...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/jazzy/automatika_ros_sugar/0.4.1-1.tar.gz";
    name = "0.4.1-1.tar.gz";
    sha256 = "6f73a313ef7626aa3117daae362c1db3675a7d4c718b2c49b6100ac5506a9f06";
  };
