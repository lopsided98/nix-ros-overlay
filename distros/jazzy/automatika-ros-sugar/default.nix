...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/jazzy/automatika_ros_sugar/0.3.1-1.tar.gz";
    name = "0.3.1-1.tar.gz";
    sha256 = "12be9247161f0ffd36585b59f5ebad6112e4ff5004e9a3e621cd12cb871fd9c1";
  };
