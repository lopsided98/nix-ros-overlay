...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/jazzy/automatika_ros_sugar/0.7.1-1.tar.gz";
    name = "0.7.1-1.tar.gz";
    sha256 = "6cbc9b7ed5319179fd9bdf0be75da81a66381eba180140cb2007bcb68e3c46a6";
  };
