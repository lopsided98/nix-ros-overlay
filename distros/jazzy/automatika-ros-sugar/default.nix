...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/jazzy/automatika_ros_sugar/0.6.0-1.tar.gz";
    name = "0.6.0-1.tar.gz";
    sha256 = "200c56d8d69084516d23703f6c0b536fdd7580f936a70a8ee185f3e8a11cf566";
  };
