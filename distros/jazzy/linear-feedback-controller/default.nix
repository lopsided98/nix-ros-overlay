...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/linear-feedback-controller-release/archive/release/jazzy/linear_feedback_controller/4.0.1-1.tar.gz";
    name = "4.0.1-1.tar.gz";
    sha256 = "cdec2dc1300a0a292227d05e1ff44a2fb1273452e589bdff04da017ed3eb2a35";
  };
