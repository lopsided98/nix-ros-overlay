...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoapms-release/archive/release/jazzy/auto_apms_behavior_tree_core/1.5.1-1.tar.gz";
    name = "1.5.1-1.tar.gz";
    sha256 = "257b47fa0ff79dfa5919250b9633758036300962029080c6c94224633112fcaa";
  };
