...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/joint_limits/4.30.0-1.tar.gz";
    name = "4.30.0-1.tar.gz";
    sha256 = "898c98dff4617d92d98453474903944fe08c479cadc01e54c1fff70846d1cfda";
  };
