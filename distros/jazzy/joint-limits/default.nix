...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/joint_limits/4.46.0-1.tar.gz";
    name = "4.46.0-1.tar.gz";
    sha256 = "585a033b71c545838733d472bd059dad988580ea6c4c9edb1b03e94bbba60ed9";
  };
