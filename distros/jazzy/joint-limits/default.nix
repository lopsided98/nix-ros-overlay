...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/joint_limits/4.21.0-1.tar.gz";
    name = "4.21.0-1.tar.gz";
    sha256 = "c9e0adb72705ec1830a41d97a102ec1561010dbf835821b60aad7d0418044a2c";
  };
