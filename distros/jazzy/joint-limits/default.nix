...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/joint_limits/4.38.0-1.tar.gz";
    name = "4.38.0-1.tar.gz";
    sha256 = "21436a828abda9a56932f8da0b37c12b4a568170b82b18c4a80e8dcae937a79f";
  };
