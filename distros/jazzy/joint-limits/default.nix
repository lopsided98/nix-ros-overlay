...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/joint_limits/4.34.0-1.tar.gz";
    name = "4.34.0-1.tar.gz";
    sha256 = "5f0adc58e5201d963d7ed530f78805699463eebba7f31cdbe700e7a0d2fd5b36";
  };
