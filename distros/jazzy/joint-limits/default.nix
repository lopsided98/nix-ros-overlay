...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/jazzy/joint_limits/4.32.0-1.tar.gz";
    name = "4.32.0-1.tar.gz";
    sha256 = "a46fac08b3156abed702fb4f53e74f388c29ed7de20e3b11ea2a8f89a9a88c60";
  };
