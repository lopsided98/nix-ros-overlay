...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/jazzy/image_proc/5.0.12-1.tar.gz";
    name = "5.0.12-1.tar.gz";
    sha256 = "1979cd2d09226452d7f07487c8360e0497ded70276aa239cd6528abc22124c01";
  };
