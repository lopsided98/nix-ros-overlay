...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/play_motion2-release/archive/release/jazzy/play_motion2_cli/1.8.3-1.tar.gz";
    name = "1.8.3-1.tar.gz";
    sha256 = "0ea42663ecf6ad1fc0aa8caa723c487b43737bbcda17d53352d29afaa8983641";
  };
