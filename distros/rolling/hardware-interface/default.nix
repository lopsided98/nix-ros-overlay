...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/hardware_interface/6.7.1-1.tar.gz";
    name = "6.7.1-1.tar.gz";
    sha256 = "001118162b647dae4c6ba9221ea82ef1a580fb2382b99e22f9254380b37f77cf";
  };
