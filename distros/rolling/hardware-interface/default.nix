...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/hardware_interface/5.2.0-1.tar.gz";
    name = "5.2.0-1.tar.gz";
    sha256 = "312037258673db8878d90afd91421127d5b3f79e4ac3a811a058965551b9fdf2";
  };
