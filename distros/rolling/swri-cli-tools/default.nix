...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/rolling/swri_cli_tools/3.11.0-1.tar.gz";
    name = "3.11.0-1.tar.gz";
    sha256 = "e252521c7516419d07c6dbe503910cd75ec18d24152fbdf1522ee10ae066c937";
  };
