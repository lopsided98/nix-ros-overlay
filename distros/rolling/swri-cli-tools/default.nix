...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/rolling/swri_cli_tools/3.7.4-1.tar.gz";
    name = "3.7.4-1.tar.gz";
    sha256 = "09c2ab2a1c44793939c377661e3735310d5ee7e20e17f71f764eb927a9a1711a";
  };
