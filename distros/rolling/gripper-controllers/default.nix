...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/gripper_controllers/4.7.0-1.tar.gz";
    name = "4.7.0-1.tar.gz";
    sha256 = "69686ad52da7601ef86670e437eea6a0fd54036735a5b415164c5eb03af84d34";
  };
