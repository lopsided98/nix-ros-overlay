...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/gripper_controllers/4.6.0-2.tar.gz";
    name = "4.6.0-2.tar.gz";
    sha256 = "d118e33e3d9ea1478fff2c23c33d32e6039e372ccea7bed9846fac3714bc7443";
  };
