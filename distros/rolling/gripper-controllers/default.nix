...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/gripper_controllers/4.9.0-1.tar.gz";
    name = "4.9.0-1.tar.gz";
    sha256 = "87381d330da38d0fdab5188330ca0ad15edfe362af45390be51cb015c5d4fbf3";
  };
