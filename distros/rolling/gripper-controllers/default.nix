...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/gripper_controllers/3.6.0-1.tar.gz";
    name = "3.6.0-1.tar.gz";
    sha256 = "dd41718c63c3655b4fa275e1b66c2567a73791b0779c3f60ea640fc3d794e328";
  };
