...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_gmock/2.8.1-1.tar.gz";
    name = "2.8.1-1.tar.gz";
    sha256 = "13c50bca30a3856c6875afb82bd1e02d9ea77a807d488355683947c45451d290";
  };
