...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_gmock/2.9.1-1.tar.gz";
    name = "2.9.1-1.tar.gz";
    sha256 = "a5ad7fe78fb14b7aac9f79e62f1ef7fff310360826a70229b1786aecaf32d2b3";
  };
