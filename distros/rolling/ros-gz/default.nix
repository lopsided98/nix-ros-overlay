...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz/3.0.7-1.tar.gz";
    name = "3.0.7-1.tar.gz";
    sha256 = "0e892a61706ec2e4d6a7f02e88585b74747c2d3107c6d55c6520582b6d471220";
  };
