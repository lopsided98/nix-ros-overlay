...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz/3.0.2-1.tar.gz";
    name = "3.0.2-1.tar.gz";
    sha256 = "6edab77a312282a62fd5a6e7fab8ea66393a621382bf5fad2a066bb1517a80a5";
  };
