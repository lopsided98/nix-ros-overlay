...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz/2.1.4-1.tar.gz";
    name = "2.1.4-1.tar.gz";
    sha256 = "c47d244745d638a86317f056ddd2e08c0327ec5ab04292f2c4fcf5b0ac4bb164";
  };
