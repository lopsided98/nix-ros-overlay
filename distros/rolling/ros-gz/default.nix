...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz/3.0.6-1.tar.gz";
    name = "3.0.6-1.tar.gz";
    sha256 = "b13d1cb471af2fe858fa9e5a5ff92a4c7b4a672fcf5f2967163989dfe7f59b5f";
  };
