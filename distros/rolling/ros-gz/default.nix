...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz/3.0.8-1.tar.gz";
    name = "3.0.8-1.tar.gz";
    sha256 = "2d6e2f91be7b9a585c2c920a77fac86bf32611b1307e3526ee12e2d9b4818d13";
  };
