...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/rolling/webots_ros2_tests/2025.0.1-2.tar.gz";
    name = "2025.0.1-2.tar.gz";
    sha256 = "16cb00d00c22b9d6e684af3975ac0fef31fb03fe23e169ddfba2e19cfda8d8c2";
  };
