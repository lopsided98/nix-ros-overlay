...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/velocity_controllers/6.6.0-2.tar.gz";
    name = "6.6.0-2.tar.gz";
    sha256 = "4bf60d538b980e210217b6d54a12b948954a5755bfd68c09bd76440254dff8a9";
  };
