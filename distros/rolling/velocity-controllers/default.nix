...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/velocity_controllers/6.2.0-1.tar.gz";
    name = "6.2.0-1.tar.gz";
    sha256 = "a5db80ac65d01ca2b4e9ee3ae8b30dc9c80bb8faded5e96fe8eee926f72aa00b";
  };
