...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/octomap_rviz_plugins-release/archive/release/rolling/octomap_rviz_plugins/2.1.1-1.tar.gz";
    name = "2.1.1-1.tar.gz";
    sha256 = "140d9c66fe611bdecbc75570ccd13ac910422f884e6ae06c06b1aefc52cdf68e";
  };
