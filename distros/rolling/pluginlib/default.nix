...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/pluginlib-release/archive/release/rolling/pluginlib/5.2.2-1.tar.gz";
    name = "5.2.2-1.tar.gz";
    sha256 = "a0029e5edd02592789e31ae4ea28403246a045db3121ea02ef49c9d94670fedc";
  };
