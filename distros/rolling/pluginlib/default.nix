...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/pluginlib-release/archive/release/rolling/pluginlib/5.8.4-1.tar.gz";
    name = "5.8.4-1.tar.gz";
    sha256 = "f69631325da82f54dc471bbba02480e9266331c778c79687bc60f8a387d19888";
  };
