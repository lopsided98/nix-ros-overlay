...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/rolling/ublox_nav_sat_fix_hp_node/0.5.7-1.tar.gz";
    name = "0.5.7-1.tar.gz";
    sha256 = "cfbcb55bc50fa9f02412623f6f9c7ff9d2d8b487c77dfcbad5529f6143cc9bc9";
  };
