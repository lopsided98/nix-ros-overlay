...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/rolling/ublox_nav_sat_fix_hp_node/0.7.6-1.tar.gz";
    name = "0.7.6-1.tar.gz";
    sha256 = "bd37490fd53a733f9ade6cb55c0d09aacf07222c6bd3bf21727ece2c9893e697";
  };
