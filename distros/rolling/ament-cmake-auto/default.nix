...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_auto/2.8.4-1.tar.gz";
    name = "2.8.4-1.tar.gz";
    sha256 = "c5af8754e3cb7ac4288499446440d0f587f70b22dde5499a51d26e5bdaf61c00";
  };
