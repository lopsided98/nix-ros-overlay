...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_auto/2.8.1-1.tar.gz";
    name = "2.8.1-1.tar.gz";
    sha256 = "43e24e5efabe710e1e2931a9adddfc6e1e6642cb35daa66ac8a7cf5ea12aa083";
  };
