...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/rolling/rclcpp_action/21.1.0-1.tar.gz";
    name = "21.1.0-1.tar.gz";
    sha256 = "fc6d8718bad75f4c2a6aab0b56e8901d63b2d3cf812e15df11995f0079b6156a";
  };
