...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/rolling/rclcpp_action/30.0.0-1.tar.gz";
    name = "30.0.0-1.tar.gz";
    sha256 = "614bf6c5a48ff2429f84e2a36cd7457941b9bdc07f07451bdcd3b3cb54c448d0";
  };
