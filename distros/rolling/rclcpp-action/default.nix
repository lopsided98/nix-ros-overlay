...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/rolling/rclcpp_action/30.1.4-1.tar.gz";
    name = "30.1.4-1.tar.gz";
    sha256 = "634b914b94f0f9fe6226677ed0c30e6f6bf65ea154cb3e850247a30782ff2b41";
  };
