...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/rolling/rclcpp_action/28.3.0-1.tar.gz";
    name = "28.3.0-1.tar.gz";
    sha256 = "6390367bcf7e97866c9831acc11e10704862ef9bc830db638a355107221ed3fc";
  };
