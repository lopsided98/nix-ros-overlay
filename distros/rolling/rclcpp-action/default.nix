...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/rolling/rclcpp_action/28.1.0-1.tar.gz";
    name = "28.1.0-1.tar.gz";
    sha256 = "5a171b4212aba9687dae5dc9eb1df982515c32a6e7785f25654e0d5df73e8cd7";
  };
