...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_kdl/0.37.1-1.tar.gz";
    name = "0.37.1-1.tar.gz";
    sha256 = "ac923162149f09080e979439778c1c5f4b90f1bd6947b094ed3d431621f8a84a";
  };
