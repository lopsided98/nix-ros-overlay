...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_kdl/0.45.7-2.tar.gz";
    name = "0.45.7-2.tar.gz";
    sha256 = "a01a4a627858b00a65bfc001138c6d8b42c93036eb14d43de704bf62834febdd";
  };
