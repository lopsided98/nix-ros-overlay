...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_kdl/0.38.0-1.tar.gz";
    name = "0.38.0-1.tar.gz";
    sha256 = "f9ec99abf8469249be5ee15581de500a7b863997336e1907b4dcadd337339bd9";
  };
