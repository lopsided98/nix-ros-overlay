...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_concepts/1.2.1-4.tar.gz";
    name = "1.2.1-4.tar.gz";
    sha256 = "7c8ef9f61c9de97e253a1dd6b60ed1ac744eb5f83acb11d345339a7b00b64278";
  };
