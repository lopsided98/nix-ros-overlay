...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/microstrain_inertial-release/archive/release/rolling/microstrain_inertial_examples/4.5.0-1.tar.gz";
    name = "4.5.0-1.tar.gz";
    sha256 = "83190970fe061f17a476f89a62d3492685d5bcd1ad0954370df43c76e97c9270";
  };
