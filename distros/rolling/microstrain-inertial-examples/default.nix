...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/microstrain_inertial-release/archive/release/rolling/microstrain_inertial_examples/4.7.0-1.tar.gz";
    name = "4.7.0-1.tar.gz";
    sha256 = "7e539a4caf47d6cb53f43b1a39c646860daf05bff099d1ddb5b31a9cc7525669";
  };
