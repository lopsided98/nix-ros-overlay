...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_graph-release/archive/release/rolling/rqt_graph/2.0.3-1.tar.gz";
    name = "2.0.3-1.tar.gz";
    sha256 = "c6486c8a8de177a2948206c5b251218ea7a2f18c95ba181d85633256ed25ea31";
  };
