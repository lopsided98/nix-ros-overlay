...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/rolling/autoware_utils_geometry/1.4.1-1.tar.gz";
    name = "1.4.1-1.tar.gz";
    sha256 = "8eb41c54eb25eaaf777f8d75c27cae8162637141d23703e4ff2bb25dad519c1a";
  };
