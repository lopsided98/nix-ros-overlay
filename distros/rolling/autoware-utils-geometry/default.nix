...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/rolling/autoware_utils_geometry/1.7.2-1.tar.gz";
    name = "1.7.2-1.tar.gz";
    sha256 = "6b4e7d0cc6c3bc78133d8a2c47b5db64eeffd342a4977e66aedd3b8eab3387bc";
  };
