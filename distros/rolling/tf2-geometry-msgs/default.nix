...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_geometry_msgs/0.43.1-1.tar.gz";
    name = "0.43.1-1.tar.gz";
    sha256 = "c68b1e03ef4edf8920823652525eaaf46defe91edcd3dd24dd87dd2f3d0808a5";
  };
