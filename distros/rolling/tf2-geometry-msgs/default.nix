...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_geometry_msgs/0.46.1-1.tar.gz";
    name = "0.46.1-1.tar.gz";
    sha256 = "be9a76e64af09fa50fee479bf6d21c193028f5e30169082a50037452b0477448";
  };
