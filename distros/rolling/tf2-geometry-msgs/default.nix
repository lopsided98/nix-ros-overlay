...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_geometry_msgs/0.42.2-1.tar.gz";
    name = "0.42.2-1.tar.gz";
    sha256 = "ae23916f09e679c8b9989de5b01ebb27b76b668f2e605da34c1738e279d25712";
  };
