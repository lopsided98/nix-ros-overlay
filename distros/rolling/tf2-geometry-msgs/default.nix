...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_geometry_msgs/0.32.0-1.tar.gz";
    name = "0.32.0-1.tar.gz";
    sha256 = "0ed7dcfbca55fc2096ba34a4e5b06ff1492f98912d81bb216c8a6b3269f9b14d";
  };
