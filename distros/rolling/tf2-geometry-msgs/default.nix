...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_geometry_msgs/0.45.7-2.tar.gz";
    name = "0.45.7-2.tar.gz";
    sha256 = "961bcc416babcec66bd5f9cadcbac91a589d15bf661080b0e48d012ce13354fd";
  };
