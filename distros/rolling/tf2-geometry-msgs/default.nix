...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_geometry_msgs/0.38.0-1.tar.gz";
    name = "0.38.0-1.tar.gz";
    sha256 = "146f9e2fc0d91f2c5060bcd62874cdea6d844120d8d4944547955648f66e0e10";
  };
