...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_geometry_msgs/0.45.6-1.tar.gz";
    name = "0.45.6-1.tar.gz";
    sha256 = "7234e42b58e5cf1b997f066f3b39b4bc527301fe570257476150eb21c816add1";
  };
