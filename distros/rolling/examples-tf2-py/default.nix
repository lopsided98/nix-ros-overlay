...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/examples_tf2_py/0.46.1-1.tar.gz";
    name = "0.46.1-1.tar.gz";
    sha256 = "25d97517deef598bcaf7152350c95424a45a75d4099cade93ea54e2effbf98d6";
  };
