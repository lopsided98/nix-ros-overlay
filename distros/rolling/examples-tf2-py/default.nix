...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/examples_tf2_py/0.45.5-1.tar.gz";
    name = "0.45.5-1.tar.gz";
    sha256 = "b38ee377c79e5f600d38c17a456b1e8b9b0b4dbb54451dc7db412ad3af7668df";
  };
