...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/examples_tf2_py/0.43.1-1.tar.gz";
    name = "0.43.1-1.tar.gz";
    sha256 = "cec41f5c41ed5890951a2a6d66503a2531deba5d1c11985ac5cbd60f84f1493a";
  };
