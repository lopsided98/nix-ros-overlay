...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/examples_tf2_py/0.45.7-1.tar.gz";
    name = "0.45.7-1.tar.gz";
    sha256 = "a093b8353f1e539ac39655c1c76935ce112dc3137605932eec8d7eb69733ff42";
  };
