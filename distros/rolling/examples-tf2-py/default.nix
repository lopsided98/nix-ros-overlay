...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/examples_tf2_py/0.45.2-1.tar.gz";
    name = "0.45.2-1.tar.gz";
    sha256 = "182983e45392744c50b67af147c2c8af172dc2b7b8bc26ad096a2736ca6dd938";
  };
