...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_demos-release/archive/release/rolling/rmf_demos_maps/2.8.2-3.tar.gz";
    name = "2.8.2-3.tar.gz";
    sha256 = "c83579db5d145863699f2623c676fa7115e24034ccf0cdc2063d7dcbc4cab77b";
  };
