...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/admittance_controller/4.17.0-1.tar.gz";
    name = "4.17.0-1.tar.gz";
    sha256 = "4b0d5c1de1c8450121aa5856e23c507aa51e33bcc06a9d948ef87c69339a57d8";
  };
