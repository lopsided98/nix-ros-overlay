...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/admittance_controller/6.3.0-1.tar.gz";
    name = "6.3.0-1.tar.gz";
    sha256 = "08d6240e1f20f67770818f0f9371eb8da11b81bbacbc94aa1d5d6d05e40d945e";
  };
