...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/admittance_controller/5.2.0-1.tar.gz";
    name = "5.2.0-1.tar.gz";
    sha256 = "4539274c78f96aa4f080d43dfa107e3e552aeab0d4438773c52c7fc869894c83";
  };
