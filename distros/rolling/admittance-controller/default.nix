...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/admittance_controller/4.9.0-1.tar.gz";
    name = "4.9.0-1.tar.gz";
    sha256 = "aa11a5f2514a2ddb4067cc27a0b0370ed13098f9f27e87a20fb56c4f8808e3c0";
  };
