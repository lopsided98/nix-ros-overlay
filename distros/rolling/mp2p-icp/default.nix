...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mp2p_icp-release/archive/release/rolling/mp2p_icp/2.7.0-1.tar.gz";
    name = "2.7.0-1.tar.gz";
    sha256 = "b881cfa2128792164f072d04198bcafc47ad707a30e8f97830fea4fac1a1b72b";
  };
