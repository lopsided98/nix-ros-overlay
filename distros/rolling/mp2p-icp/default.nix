...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mp2p_icp-release/archive/release/rolling/mp2p_icp/2.14.0-1.tar.gz";
    name = "2.14.0-1.tar.gz";
    sha256 = "4590149c91978817593252b41069406d79c1df6def3006d7d0c51bcb68da4a5d";
  };
