...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mp2p_icp-release/archive/release/rolling/mp2p_icp/2.7.1-1.tar.gz";
    name = "2.7.1-1.tar.gz";
    sha256 = "b30c70e50bd7d117d5eac0d86a2e9fd1ce359aab1b0de1e8fa328e21c197a7bb";
  };
