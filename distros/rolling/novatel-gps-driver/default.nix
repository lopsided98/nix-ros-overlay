...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/novatel_gps_driver-release/archive/release/rolling/novatel_gps_driver/4.1.0-3.tar.gz";
    name = "4.1.0-3.tar.gz";
    sha256 = "1738e058696ae05be9a87b6bf12c5fbeed110fb5aa551a968cbdd84338fe6671";
  };
