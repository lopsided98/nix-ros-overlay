...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fuse-release/archive/release/rolling/fuse_models/1.3.1-2.tar.gz";
    name = "1.3.1-2.tar.gz";
    sha256 = "512fb3cc2d1b213716a8c128fe3c4c0e4d2be567f69bafea222006f7b93fdbf2";
  };
