...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl_logging-release/archive/release/rolling/rcl_logging_spdlog/3.3.1-1.tar.gz";
    name = "3.3.1-1.tar.gz";
    sha256 = "d6b85ac0694c2e32b1923721879933f62cf9d4234d0ae1b6699abd21a7d660c5";
  };
