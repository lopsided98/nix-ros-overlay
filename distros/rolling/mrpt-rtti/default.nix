...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt3-release/archive/release/rolling/mrpt_rtti/3.1.2-1.tar.gz";
    name = "3.1.2-1.tar.gz";
    sha256 = "0bdc653a967bcf86ac53fed62449c6bb4b0c7dd2c66831aec57ed107ed579195";
  };
