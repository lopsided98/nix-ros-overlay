...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/ros2bag/0.20.0-1.tar.gz";
    name = "0.20.0-1.tar.gz";
    sha256 = "1526aec61fe54094699d9cc8d0abea431f8e4179dc78f0a78bcd0aa246a0045d";
  };
