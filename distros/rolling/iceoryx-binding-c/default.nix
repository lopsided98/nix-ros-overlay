...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/iceoryx-release/archive/release/rolling/iceoryx_binding_c/2.0.6-1.tar.gz";
    name = "2.0.6-1.tar.gz";
    sha256 = "e6735b0298685c86e518d1b7ca4c509fba7408113b3bae0968371e644277dbb6";
  };
