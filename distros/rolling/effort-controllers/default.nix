...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/effort_controllers/5.2.0-1.tar.gz";
    name = "5.2.0-1.tar.gz";
    sha256 = "5dadd8d86807cfba9962ad9e7d2b9e4d16f2ca3a2b3ff284ebd53e0b59df13ae";
  };
