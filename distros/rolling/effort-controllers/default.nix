...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/effort_controllers/6.6.0-2.tar.gz";
    name = "6.6.0-2.tar.gz";
    sha256 = "676bddea9b5ee3ba7832c6ec860f00f3add51818d31bde3d02134d757aac6170";
  };
