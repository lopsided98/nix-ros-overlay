...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/agni_tf_tools-release/archive/release/rolling/agni_tf_tools/1.0.2-1.tar.gz";
    name = "1.0.2-1.tar.gz";
    sha256 = "7ff582ca32134f41b468e41cc3718d7726907e6eceeb3b34f81b4495e21e9ec2";
  };
