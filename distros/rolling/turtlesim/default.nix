...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_tutorials-release/archive/release/rolling/turtlesim/1.11.3-1.tar.gz";
    name = "1.11.3-1.tar.gz";
    sha256 = "c0342628682a4b79b96f584e37cf6eee11b60f78e7ef2b90cea8e1997ee9497d";
  };
