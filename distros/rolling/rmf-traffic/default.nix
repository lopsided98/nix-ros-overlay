...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_traffic-release/archive/release/rolling/rmf_traffic/3.7.0-1.tar.gz";
    name = "3.7.0-1.tar.gz";
    sha256 = "e619c214769b38f8ca73bb69ece79e51d720eef67a985d60a9e23f25995f09ca";
  };
