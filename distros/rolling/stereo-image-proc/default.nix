...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/rolling/stereo_image_proc/7.1.0-1.tar.gz";
    name = "7.1.0-1.tar.gz";
    sha256 = "b41778c47c0f0f9368b061ab51e0fc18ddac3bc5f76a48b0903fe0e7715cbb58";
  };
