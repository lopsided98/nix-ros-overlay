...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/rolling/stereo_image_proc/3.0.1-2.tar.gz";
    name = "3.0.1-2.tar.gz";
    sha256 = "986e16a4e34b8213b51a5a8b2f073a587d4eabc20365208d5b2afaf7d5ca3b16";
  };
