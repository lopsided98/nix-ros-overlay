...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/rolling/stereo_image_proc/6.0.7-1.tar.gz";
    name = "6.0.7-1.tar.gz";
    sha256 = "9ca59aeeb139f23a7e8b46b2856422bdb3c1907b2ea6f9f11f30897dca8393a3";
  };
