...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_canopen-release/archive/release/rolling/lely_core_libraries/0.3.1-1.tar.gz";
    name = "0.3.1-1.tar.gz";
    sha256 = "4af3339fc56a6cc5105322552fc65b2d6c2b1bb91eeec12ec6d342cf152f25e0";
  };
