...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/rolling/image_publisher/6.0.7-1.tar.gz";
    name = "6.0.7-1.tar.gz";
    sha256 = "4c7952dc91b32208f5e6c0cf09a357a3679337661f3aa48decbf806e13e5d4bb";
  };
