...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/leo_simulator-release/archive/release/rolling/leo_gz_plugins/2.0.2-2.tar.gz";
    name = "2.0.2-2.tar.gz";
    sha256 = "c8654c6a469cba155764122136a6d4bfbb0c3006d297b1e3e5f943e3d55d2d7d";
  };
