...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_ogre_vendor/15.1.13-1.tar.gz";
    name = "15.1.13-1.tar.gz";
    sha256 = "ecba7e5fde7498f2d1feee203180dddf6cc4823a874661798b8f33c0da6f159c";
  };
