...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_ogre_vendor/15.1.16-1.tar.gz";
    name = "15.1.16-1.tar.gz";
    sha256 = "bb888bdf215d9d121d9bd5930b05490581629d76551197e0ccd6cf044d8fc380";
  };
