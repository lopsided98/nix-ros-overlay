...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/rolling/image_transport_plugins/6.2.4-1.tar.gz";
    name = "6.2.4-1.tar.gz";
    sha256 = "c98b0ab8cea1b474ea8601ed817bb625934da4b3a178fe75f209a8421e23288c";
  };
