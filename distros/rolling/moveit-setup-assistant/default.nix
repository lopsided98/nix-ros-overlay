...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_setup_assistant/2.8.0-2.tar.gz";
    name = "2.8.0-2.tar.gz";
    sha256 = "424b952af14cdcff1d1a1fefafed0047fb1cee47eed22545cd789cdc75124fc0";
  };
