...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_setup_assistant/2.7.4-1.tar.gz";
    name = "2.7.4-1.tar.gz";
    sha256 = "5494a4a3142266b42c825dcc4eff8ca576a51cdb94e57c61dd393cb87b1db2e2";
  };
