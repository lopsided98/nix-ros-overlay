...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/rolling/autoware_utils_logging/1.4.2-2.tar.gz";
    name = "1.4.2-2.tar.gz";
    sha256 = "71ea42bbf2a79c19283207e5904fe73a5b09bb3a025ff5831a5c7c26673878c4";
  };
