...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/flexbe_behavior_engine-release/archive/release/rolling/flexbe_input/4.0.3-1.tar.gz";
    name = "4.0.3-1.tar.gz";
    sha256 = "5479df975a1bc0fcaa8b5835572392a285d9b2f0e76bdc5bbb4421d37e769f5e";
  };
