...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_canopen-release/archive/release/rolling/canopen_core/0.3.2-1.tar.gz";
    name = "0.3.2-1.tar.gz";
    sha256 = "00921fcf1182a39d1bf54ac94d2becfac27dbda879c117b427e334d8d6108b97";
  };
