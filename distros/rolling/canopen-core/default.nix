...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_canopen-release/archive/release/rolling/canopen_core/0.3.1-1.tar.gz";
    name = "0.3.1-1.tar.gz";
    sha256 = "0ac703f199b1ba75a94807db14473038431ccf65452719cd3780fef843f268de";
  };
