...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/clips_executive-release/archive/release/rolling/cx_config_plugin/0.1.3-1.tar.gz";
    name = "0.1.3-1.tar.gz";
    sha256 = "8441ad8e49abbc73f700585f2a4195b566a67f80404021dcd552dbe8e446b9dc";
  };
