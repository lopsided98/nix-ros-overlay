...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gz_sim_vendor-release/archive/release/rolling/gz_sim_vendor/0.4.3-1.tar.gz";
    name = "0.4.3-1.tar.gz";
    sha256 = "cd186a66875a35be64efea061f460d0de26756b31c34c7b0f015688b0a162168";
  };
  ...
  meta = {
    description = "Vendor package for: gz-sim 10.1.0
