...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/pose_broadcaster/5.2.0-1.tar.gz";
    name = "5.2.0-1.tar.gz";
    sha256 = "dab45e7c8179a2171d60bd223ab3f79701f6f3e5fa11298a1dde2390dab75d89";
  };
