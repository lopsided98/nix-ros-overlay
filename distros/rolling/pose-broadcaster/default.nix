...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/pose_broadcaster/4.17.0-1.tar.gz";
    name = "4.17.0-1.tar.gz";
    sha256 = "1d3a739bebfc67dbd5fb1da0ae9dcc8edf09cb31bc0cddc555591dbdf31f4103";
  };
