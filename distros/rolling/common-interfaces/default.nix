...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/common_interfaces-release/archive/release/rolling/common_interfaces/5.9.2-2.tar.gz";
    name = "5.9.2-2.tar.gz";
    sha256 = "225f8c465b71f22bfef2dcbd42ca047e960bdad56675ca8336bf65f684d4e16e";
  };
