...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/find_object_2d-release/archive/release/rolling/find_object_2d/0.7.2-1.tar.gz";
    name = "0.7.2-1.tar.gz";
    sha256 = "888cf6c7139de17df9cecb4e2d46e9dd610a42bbd73756135117879411c40b91";
  };
