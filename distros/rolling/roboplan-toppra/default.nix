...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/roboplan-release/archive/release/rolling/roboplan_toppra/0.7.0-1.tar.gz";
    name = "0.7.0-1.tar.gz";
    sha256 = "5a3c2053efc00bf2eb31e8692fee7499e101a5b9e75bc1671fab5736d4786462";
  };
