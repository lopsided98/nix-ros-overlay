...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/dynamixel_workbench-release/archive/release/rolling/dynamixel_workbench_toolbox/2.2.3-1.tar.gz";
    name = "2.2.3-1.tar.gz";
    sha256 = "7b9580eb5d194225c191c503071d32c6cb86122283561ff2908030b90203f0be";
  };
