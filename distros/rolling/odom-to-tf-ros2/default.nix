...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/odom_to_tf_ros2-release/archive/release/rolling/odom_to_tf_ros2/1.0.6-1.tar.gz";
    name = "1.0.6-1.tar.gz";
    sha256 = "5d4f9362aa3246a4cfa3b69540e07762a53db30f3dbe4771f0fde0037c2ff23c";
  };
