...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_visualization-release/archive/release/rolling/rmf_visualization_fleet_states/2.5.1-2.tar.gz";
    name = "2.5.1-2.tar.gz";
    sha256 = "aabd0f4b976a88ea543201c570f9f467b38ad6f22e2eb50437804d7521c9b182";
  };
