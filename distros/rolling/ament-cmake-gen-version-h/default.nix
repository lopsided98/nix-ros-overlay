...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_gen_version_h/2.8.7-1.tar.gz";
    name = "2.8.7-1.tar.gz";
    sha256 = "879ced9c8e7f7e81057c3e3b83800822872e1859c2b54e71cf84312708a120ac";
  };
