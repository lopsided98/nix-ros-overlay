...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_gen_version_h/2.9.2-1.tar.gz";
    name = "2.9.2-1.tar.gz";
    sha256 = "1fe284a110d14d0e7d2e4cc8ba3c515fe9d1df10684fc5795505d518a01d30e6";
  };
