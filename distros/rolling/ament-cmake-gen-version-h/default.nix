...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_gen_version_h/2.8.3-1.tar.gz";
    name = "2.8.3-1.tar.gz";
    sha256 = "3b7c3594e3b47b392667ed751346d88da4102533d6addfc871d5a447ea9c9d60";
  };
