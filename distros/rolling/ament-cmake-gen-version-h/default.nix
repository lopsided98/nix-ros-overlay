...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_gen_version_h/2.8.2-1.tar.gz";
    name = "2.8.2-1.tar.gz";
    sha256 = "f8adabe0a88bd57ba733caf602f6f23fa1fa3806fee090cecbded68cf476c95e";
  };
