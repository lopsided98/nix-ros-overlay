...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_gen_version_h/2.3.2-1.tar.gz";
    name = "2.3.2-1.tar.gz";
    sha256 = "b9ac49325cd472e7b3e925380f43c8e9df00e205dd77238421aab3b29f83e4ee";
  };
