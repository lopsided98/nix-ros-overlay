...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_gen_version_h/2.6.1-1.tar.gz";
    name = "2.6.1-1.tar.gz";
    sha256 = "75b86b72f2d8c2cea38ff69a500fc3f03a68f7c5f56581e0c98780a47e713aea";
  };
