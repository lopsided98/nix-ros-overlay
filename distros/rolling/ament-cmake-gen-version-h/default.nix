...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_gen_version_h/2.8.4-1.tar.gz";
    name = "2.8.4-1.tar.gz";
    sha256 = "a582d679145880270406ecafd8ba3f7d00ebcd3556cf7b70dd6a93a968e1f7ef";
  };
