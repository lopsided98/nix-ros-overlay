...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/topic_based_hardware-release/archive/release/rolling/joint_state_topic_hardware_interface/1.0.0-1.tar.gz";
    name = "1.0.0-1.tar.gz";
    sha256 = "308bfe1ce412e151345768bfc57ca5696a7a8fe0f8329efb1dbd7a35fc2c983a";
  };
