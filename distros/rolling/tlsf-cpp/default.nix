...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/realtime_support-release/archive/release/rolling/tlsf_cpp/0.19.1-1.tar.gz";
    name = "0.19.1-1.tar.gz";
    sha256 = "11433ffb6f51a94b78588b4e0d83fc2fc0a81f2baab04bcb2dd87513becc4c5f";
  };
