...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/chained_filter_controller/6.2.0-1.tar.gz";
    name = "6.2.0-1.tar.gz";
    sha256 = "0ac3c1edeca7ef411202d3a4d99580667cc7f9fe290cd70fbf769d61fa5666e7";
  };
