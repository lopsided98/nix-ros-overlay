...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl_lifecycle/10.2.5-1.tar.gz";
    name = "10.2.5-1.tar.gz";
    sha256 = "acefc67ce3d728c90c57bc788775e089fdb696e720180914e661f6a7a9c46fcc";
  };
