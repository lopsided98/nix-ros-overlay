...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl_lifecycle/10.4.3-2.tar.gz";
    name = "10.4.3-2.tar.gz";
    sha256 = "5bdf0063b40e19b05adbe600e791cf2dda63d0332edcc202c18c4fd73cff3c25";
  };
