...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl_lifecycle/10.3.1-1.tar.gz";
    name = "10.3.1-1.tar.gz";
    sha256 = "a66fb77678f91055ff522647974c279d85956534a2a470e781d7feb04e4dae20";
  };
