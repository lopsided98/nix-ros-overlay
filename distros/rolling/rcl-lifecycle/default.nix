...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl_lifecycle/10.2.7-1.tar.gz";
    name = "10.2.7-1.tar.gz";
    sha256 = "c51f8a430c944da9bb5f762c0f6479f9907e68cbe4400a1e0a940a9e2735a984";
  };
