...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libnav/2.15.1-2.tar.gz";
    name = "2.15.1-2.tar.gz";
    sha256 = "5e7d1bf58c8fa9ad051e076e7d30dd44347dafc1690c28bfc85bb2fec10360ca";
  };
