...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libnav/2.14.10-1.tar.gz";
    name = "2.14.10-1.tar.gz";
    sha256 = "573d8b4e723937656a5965ff8a9bd5d79a4d51a7658c8e4279da7a8cde513bf8";
  };
