...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libnav/2.15.16-1.tar.gz";
    name = "2.15.16-1.tar.gz";
    sha256 = "fd77ae119fddee8dfcf76641129e95849ca645099a130844ee2cba0bae36cb37";
  };
