...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libnav/2.15.14-2.tar.gz";
    name = "2.15.14-2.tar.gz";
    sha256 = "f8caa4423ba9ffd6729473f4b015758c80905bfda5db8b062c03191206011f05";
  };
