...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libmath/2.15.16-1.tar.gz";
    name = "2.15.16-1.tar.gz";
    sha256 = "a091da7f1da5bedec078cec9410bd439e61bf4e866b00919eb1d0b1c64c21799";
  };
