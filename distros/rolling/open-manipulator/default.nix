...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/rolling/open_manipulator/4.0.6-1.tar.gz";
    name = "4.0.6-1.tar.gz";
    sha256 = "cb2e51b8b4b227154256372ca3a6feb8a9f6e8d8dc6e142dd47013ff3776fb24";
  };
