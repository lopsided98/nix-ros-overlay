...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/rolling/open_manipulator/4.0.5-1.tar.gz";
    name = "4.0.5-1.tar.gz";
    sha256 = "18d6137e346d19229ef45ab31b517b8d5c29a27f88c4720f0fca5e3dcc3176fb";
  };
