...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_cmake_pep257/0.20.2-1.tar.gz";
    name = "0.20.2-1.tar.gz";
    sha256 = "1629be597fb0d001ac82992161800f580bf645563863946c5dce2bc3684bcb22";
  };
