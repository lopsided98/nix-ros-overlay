...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros_bridge-release/archive/release/rolling/rosbag2rawlog/3.0.0-1.tar.gz";
    name = "3.0.0-1.tar.gz";
    sha256 = "e19026583af03490a2ad307e0913ba57a61b91f25c3494649485e0fa98c31ca1";
  };
