...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt-release/archive/release/rolling/rqt_gui/1.10.1-1.tar.gz";
    name = "1.10.1-1.tar.gz";
    sha256 = "49c7ad09ecd2bb2a2aa85764c2f51ece240d5e8dada238371f47e7084b40137c";
  };
