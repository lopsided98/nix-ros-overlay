...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/joint_state_broadcaster/4.12.1-1.tar.gz";
    name = "4.12.1-1.tar.gz";
    sha256 = "b7be201ee99eecc7cc0bea0f415377b76fd430bd9cfad7f6edb4d05c157bc5ea";
  };
