...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/joint_state_broadcaster/4.7.0-1.tar.gz";
    name = "4.7.0-1.tar.gz";
    sha256 = "d177d683e1152c957e3ea817edd7f1ec8286060de4ec2615a5199971756f4d21";
  };
