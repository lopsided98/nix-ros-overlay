...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/joint_state_broadcaster/6.6.0-2.tar.gz";
    name = "6.6.0-2.tar.gz";
    sha256 = "74901f3f9df7bb9f70ff00f410345eae3a972364baa6f8facd367d40a4e782bc";
  };
