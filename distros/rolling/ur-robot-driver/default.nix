...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/rolling/ur_robot_driver/4.0.0-1.tar.gz";
    name = "4.0.0-1.tar.gz";
    sha256 = "9cfbd845cf140a542fc58403efefd325c470d14fe07d5685104c34dd2d604294";
  };
