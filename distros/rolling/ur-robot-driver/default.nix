...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/rolling/ur_robot_driver/2.4.8-1.tar.gz";
    name = "2.4.8-1.tar.gz";
    sha256 = "7098ad27ed9d0edcdf65e735fc111cbfadfad913c193d50aa6e53fcccf842850";
  };
