...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/rolling/ur_robot_driver/7.1.0-1.tar.gz";
    name = "7.1.0-1.tar.gz";
    sha256 = "1b7fe32e1766b024452c02e1695bf2358caf3a51fd64794204bcc394d073c07d";
  };
