...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/rolling/ur_robot_driver/2.4.5-1.tar.gz";
    name = "2.4.5-1.tar.gz";
    sha256 = "3fecd232d9aa9583cc90a8868853736e0a5b6d88c1187eb64c6f6ab1141db025";
  };
