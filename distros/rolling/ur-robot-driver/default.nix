...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/rolling/ur_robot_driver/2.4.7-1.tar.gz";
    name = "2.4.7-1.tar.gz";
    sha256 = "f588c62c0f78fac2f4cd34d7ca7d3edc68e96dff62e0c9a6f3be5b6a2a6337b3";
  };
