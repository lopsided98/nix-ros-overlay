...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/rolling/ur_robot_driver/4.0.3-1.tar.gz";
    name = "4.0.3-1.tar.gz";
    sha256 = "f40eda7b457ea71d382ffda23b7edfa6e92f9846867596b0fc88899de1fab3c0";
  };
