...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/rolling/ur_robot_driver/4.5.0-1.tar.gz";
    name = "4.5.0-1.tar.gz";
    sha256 = "ca8b32da5cfdbd34a263c4d0db96e64ba0a62c35387e57b6a438f7ccd59ed301";
  };
