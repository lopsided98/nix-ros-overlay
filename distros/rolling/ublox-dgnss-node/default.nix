...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/rolling/ublox_dgnss_node/0.7.0-1.tar.gz";
    name = "0.7.0-1.tar.gz";
    sha256 = "81d121b3e41ad198701c3c985a844f79110ed777f56285d5f26c2dea60c01b77";
  };
