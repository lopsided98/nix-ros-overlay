...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/rolling/ublox_dgnss_node/0.7.2-1.tar.gz";
    name = "0.7.2-1.tar.gz";
    sha256 = "f0c56d2a09bff585c3a3b88097a0bdc0348cfb3f7a914c47aaf4699d77cb41a7";
  };
