...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/rolling/yasmin_ros/4.2.4-1.tar.gz";
    name = "4.2.4-1.tar.gz";
    sha256 = "262a82f86f0af54d193bca44fa65de401bb0c67143c1cbfaaa826fe222df39d4";
  };
