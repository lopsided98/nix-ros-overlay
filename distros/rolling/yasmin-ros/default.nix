...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/rolling/yasmin_ros/4.2.3-1.tar.gz";
    name = "4.2.3-1.tar.gz";
    sha256 = "083162c1f905e84d765f9614a1fb51010cb9c62f95b8977e44b8a4719be9ddaf";
  };
