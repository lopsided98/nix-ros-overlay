...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/rolling/yasmin_ros/6.1.1-1.tar.gz";
    name = "6.1.1-1.tar.gz";
    sha256 = "8b4cc38697dd38cf924632d57baf83651e4ff74090649e31a054e8c7b082f5a5";
  };
