...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/controller_interface/6.0.1-1.tar.gz";
    name = "6.0.1-1.tar.gz";
    sha256 = "a3886bbfc0d033f35f5d6526396e83a44302b21c0224ef2ab863b82adc99c90f";
  };
