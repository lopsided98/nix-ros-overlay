...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/controller_interface/4.9.0-1.tar.gz";
    name = "4.9.0-1.tar.gz";
    sha256 = "831a6187de85782e73b9a1c313fe703357c8cf1913ef9599fa6128d420915ead";
  };
