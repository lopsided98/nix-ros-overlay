...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/controller_interface/6.7.1-1.tar.gz";
    name = "6.7.1-1.tar.gz";
    sha256 = "e0c01fe60757bef0b446a0a451e4982475eb63f744a9ec05de21ec0b398680f3";
  };
