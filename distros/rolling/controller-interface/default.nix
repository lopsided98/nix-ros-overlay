...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/controller_interface/6.0.2-1.tar.gz";
    name = "6.0.2-1.tar.gz";
    sha256 = "70ac881ffddd808c7e00dd5d84ca5ed9cf3312bde6382b63a120acef08b7daf3";
  };
