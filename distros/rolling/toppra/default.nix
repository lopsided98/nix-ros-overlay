...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/toppra-release/archive/release/rolling/toppra/0.6.9-1.tar.gz";
    name = "0.6.9-1.tar.gz";
    sha256 = "3934ab3a36a4a43f46850211774e7d3fa40fa6ba18fbedab33ce3b8c7e00cacc";
  };
