...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz_bridge/3.0.2-1.tar.gz";
    name = "3.0.2-1.tar.gz";
    sha256 = "ac4a06b68e44fa7ea865aaf5d031cc354d85f94089c4c44bf346c60d77f9109a";
  };
