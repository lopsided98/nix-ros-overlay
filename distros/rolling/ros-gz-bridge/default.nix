...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz_bridge/3.0.8-1.tar.gz";
    name = "3.0.8-1.tar.gz";
    sha256 = "29d687ff8a8aa736893cbc3c6b986af360bf8b25fdf9329058dabf03293e2454";
  };
