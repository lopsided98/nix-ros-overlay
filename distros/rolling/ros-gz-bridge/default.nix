...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz_bridge/2.1.4-1.tar.gz";
    name = "2.1.4-1.tar.gz";
    sha256 = "70a6bdd8e654ad794500771f0d2566d8d24c1703675ae150b5c9a0ceadfdafa8";
  };
