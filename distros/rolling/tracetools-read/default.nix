...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_tracing-release/archive/release/rolling/tracetools_read/8.10.1-2.tar.gz";
    name = "8.10.1-2.tar.gz";
    sha256 = "3530d4bb6540c31fc4de46ef3cda02cc546996952543a3b91c38f19d6c33f1e8";
  };
