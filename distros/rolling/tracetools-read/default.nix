...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_tracing-release/archive/release/rolling/tracetools_read/8.10.0-1.tar.gz";
    name = "8.10.0-1.tar.gz";
    sha256 = "1a2f4c53ae7bb1716316ac8ce7aa26fd57356232f65e699c06d919fb10f65e5e";
  };
