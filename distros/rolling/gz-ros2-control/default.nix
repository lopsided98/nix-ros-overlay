...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ign_ros2_control-release/archive/release/rolling/gz_ros2_control/3.0.5-1.tar.gz";
    name = "3.0.5-1.tar.gz";
    sha256 = "eafdcb8be3edb5141bef4f436c09199c70c12cc887fb39258a4e9885feec2daf";
  };
