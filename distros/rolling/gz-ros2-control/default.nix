...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ign_ros2_control-release/archive/release/rolling/gz_ros2_control/2.0.8-1.tar.gz";
    name = "2.0.8-1.tar.gz";
    sha256 = "290fd4267d90d58ab5d9749f627b793ceca1355ca60cf600dba62c14bd265bba";
  };
