...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/rolling/autoware_utils_tf/1.7.2-1.tar.gz";
    name = "1.7.2-1.tar.gz";
    sha256 = "778199c69144875dcaed99e41c208991697958ec604d2d5dcccf7afc2810d876";
  };
