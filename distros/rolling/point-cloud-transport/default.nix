...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/point_cloud_transport-release/archive/release/rolling/point_cloud_transport/5.3.2-1.tar.gz";
    name = "5.3.2-1.tar.gz";
    sha256 = "c411376d8256537b8818f285dc4ace499d961cc60d8c44ea78557fc4073438d1";
  };
