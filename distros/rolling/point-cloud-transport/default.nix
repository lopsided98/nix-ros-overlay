...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/point_cloud_transport-release/archive/release/rolling/point_cloud_transport/5.2.2-1.tar.gz";
    name = "5.2.2-1.tar.gz";
    sha256 = "58259e7f023e6d72fa94400f7c813d67b65105109520dced20214edbe6854b27";
  };
