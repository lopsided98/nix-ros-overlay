...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/point_cloud_transport-release/archive/release/rolling/point_cloud_transport/5.3.1-1.tar.gz";
    name = "5.3.1-1.tar.gz";
    sha256 = "1e1232f561c8e25c1658aa9f472888a71868b696798ba662c405b8c7bee17285";
  };
