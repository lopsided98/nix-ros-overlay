...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/force_torque_sensor_broadcaster/6.2.0-1.tar.gz";
    name = "6.2.0-1.tar.gz";
    sha256 = "61205a282a0a8eeb4fbd358bb9c5b4f466eed3b85f7305c3c9c299d2bb01d493";
  };
