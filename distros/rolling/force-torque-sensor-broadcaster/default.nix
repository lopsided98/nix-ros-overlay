...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/force_torque_sensor_broadcaster/4.17.0-1.tar.gz";
    name = "4.17.0-1.tar.gz";
    sha256 = "608359030d9b0a1cad9d171bf3c8d0469e2145e3a44a3dab6f83be1b88b6bcbb";
  };
