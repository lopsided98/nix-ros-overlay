...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/force_torque_sensor_broadcaster/5.2.0-1.tar.gz";
    name = "5.2.0-1.tar.gz";
    sha256 = "4849da912ed3a6f54425dab8d08e2060946c944c8226d31c428284cf39982405";
  };
