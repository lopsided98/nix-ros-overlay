...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/force_torque_sensor_broadcaster/4.9.0-1.tar.gz";
    name = "4.9.0-1.tar.gz";
    sha256 = "29bbdeae53b7421c5b473e2c8aa2c5b3e097d33b9c20955b57a8c54d46ad80f2";
  };
