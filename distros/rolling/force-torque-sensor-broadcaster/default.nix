...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/force_torque_sensor_broadcaster/3.6.0-1.tar.gz";
    name = "3.6.0-1.tar.gz";
    sha256 = "8ca7d0798ef15be2e4da2587bbacab89a328472469403822fb7561eab1fa9bdb";
  };
