...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/force_torque_sensor_broadcaster/3.7.0-1.tar.gz";
    name = "3.7.0-1.tar.gz";
    sha256 = "ab336c8fab13398b61470f083fc3279df38c4b586f449327bdf007cfb3093443";
  };
