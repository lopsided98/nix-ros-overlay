...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/py_trees_ros_viewer-release/archive/release/rolling/py_trees_ros_viewer/0.3.0-1.tar.gz";
    name = "0.3.0-1.tar.gz";
    sha256 = "ca4ad7f4d8ca44d5e850ba5c0fc6926ceb207010d5d44917ee7611a254089d3b";
  };
