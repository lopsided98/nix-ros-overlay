...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_robot_monitor-release/archive/release/rolling/rqt_robot_monitor/1.0.5-2.tar.gz";
    name = "1.0.5-2.tar.gz";
    sha256 = "36ac6591484eaa73c8f9fd2ad701d6d5607fc34e3dd9506755d6787f6ca82648";
  };
