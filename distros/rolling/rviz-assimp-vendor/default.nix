...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_assimp_vendor/15.1.7-1.tar.gz";
    name = "15.1.7-1.tar.gz";
    sha256 = "72cd6c27f063f1a56efd60f6887a82667289bf688f726b131fac5e3d2a748709";
  };
