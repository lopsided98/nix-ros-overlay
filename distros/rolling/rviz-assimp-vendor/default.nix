...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_assimp_vendor/14.1.0-1.tar.gz";
    name = "14.1.0-1.tar.gz";
    sha256 = "53fba79ad5be645db2f887c81f80aa5c6fa235769447137b37b082c8263cbafc";
  };
