...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_assimp_vendor/15.1.1-1.tar.gz";
    name = "15.1.1-1.tar.gz";
    sha256 = "3a923569f5f94dbf6f5dbb959dc43e6552ae4a6dc14a9fb32607997ac8fe0b9e";
  };
