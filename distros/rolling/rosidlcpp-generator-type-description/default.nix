...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidlcpp-release/archive/release/rolling/rosidlcpp_generator_type_description/0.2.1-1.tar.gz";
    name = "0.2.1-1.tar.gz";
    sha256 = "07cc63f3b1e7f8d980022554fcf1c9ee2f886747b88318dd48d2cb0aa272a142";
  };
