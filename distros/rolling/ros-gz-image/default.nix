...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz_image/3.0.7-1.tar.gz";
    name = "3.0.7-1.tar.gz";
    sha256 = "8fc215353189d9ebcf23643edb50583b5216df987dfa75621123beac2b3bc948";
  };
