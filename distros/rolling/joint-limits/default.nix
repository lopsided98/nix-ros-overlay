...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/joint_limits/6.7.0-2.tar.gz";
    name = "6.7.0-2.tar.gz";
    sha256 = "708371ed9c474f569bad46acebec3e4fdbab59da13f593ec36b90f5a5cb0dce2";
  };
