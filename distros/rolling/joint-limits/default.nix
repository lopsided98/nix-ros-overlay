...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/joint_limits/6.0.1-1.tar.gz";
    name = "6.0.1-1.tar.gz";
    sha256 = "bf0a8b868428ecc746042c38ca401fbaebdb86be061419514ea0780c00feabe3";
  };
