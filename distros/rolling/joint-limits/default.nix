...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/joint_limits/6.3.1-1.tar.gz";
    name = "6.3.1-1.tar.gz";
    sha256 = "9186f646a1821ec6de2139529d9af192458bc4c5d25caf98ae40498ab3e14943";
  };
