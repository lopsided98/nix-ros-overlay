...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/joint_limits/6.2.0-1.tar.gz";
    name = "6.2.0-1.tar.gz";
    sha256 = "418bb70d310ec68f5eaf03af57f269a6d8cb8eb459cb8f1087f500254c36622c";
  };
