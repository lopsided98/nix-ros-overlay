...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/joint_limits/6.7.1-1.tar.gz";
    name = "6.7.1-1.tar.gz";
    sha256 = "fe30595ef126badedfe527c14b140cc30f9857bbae7011d6fdd8575cbce04834";
  };
