...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/joint_limits/4.21.0-1.tar.gz";
    name = "4.21.0-1.tar.gz";
    sha256 = "2fd3957cdaea3837cb34c9f5844c9671c36f85ec2bf28519be0d74888097939a";
  };
