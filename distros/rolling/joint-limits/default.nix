...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/joint_limits/6.3.2-1.tar.gz";
    name = "6.3.2-1.tar.gz";
    sha256 = "709710a23af2feabf2a48ffc053effe660eb5b90f56c5ceb1df6c1fc32b7ae70";
  };
