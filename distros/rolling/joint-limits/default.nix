...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/joint_limits/4.22.0-1.tar.gz";
    name = "4.22.0-1.tar.gz";
    sha256 = "55c73cc14b172fe4fa44c30579618683b3f38c75142e60ec6439df53318c9695";
  };
