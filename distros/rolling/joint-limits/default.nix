...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/joint_limits/4.9.0-1.tar.gz";
    name = "4.9.0-1.tar.gz";
    sha256 = "5bba7e51ee26108ecfd88f10d4a0aab409585b329e84ec1f4276e73f268f5085";
  };
