...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/joint_limits/5.7.0-1.tar.gz";
    name = "5.7.0-1.tar.gz";
    sha256 = "aa0028ab488c4978394a0bb1dfa347875bcc8f6b653ed702e97a3285239a1193";
  };
