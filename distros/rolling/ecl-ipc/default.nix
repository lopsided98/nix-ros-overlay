...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_ipc/1.2.1-5.tar.gz";
    name = "1.2.1-5.tar.gz";
    sha256 = "1a97dace9ed5378000c437b295aad695a2ce185fdff82c462f556130f4a2c41f";
  };
