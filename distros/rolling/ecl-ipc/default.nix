...
buildRosPackage {
  pname = "ros-rolling-ecl-ipc";
  version = "1.2.1-r1";

  src = fetchurl {
    url = "https://github.com/yujinrobot-release/ecl_core-release/archive/release/rolling/ecl_ipc/1.2.1-1.tar.gz";
    name = "1.2.1-1.tar.gz";
    sha256 = "a52e551ac1dd6dca575ff4892fd79e45656488e785014bfceeaddf230cede909";
  };
