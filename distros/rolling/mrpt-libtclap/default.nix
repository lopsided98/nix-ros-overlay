...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libtclap/2.14.10-1.tar.gz";
    name = "2.14.10-1.tar.gz";
    sha256 = "dd16a6744f6ae747eaa8816fd04a1038adde6500f9ae2971b9732c2540940c23";
  };
