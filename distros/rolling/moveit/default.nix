...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit/2.14.1-2.tar.gz";
    name = "2.14.1-2.tar.gz";
    sha256 = "acf905639ede630a625b1fd01eb6dc2557624d00ca7e7fe92b9accda058be5c5";
  };
