...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/qt_gui_core-release/archive/release/rolling/qt_gui_app/3.0.3-1.tar.gz";
    name = "3.0.3-1.tar.gz";
    sha256 = "629dc952c2af890d3e30ec67661dedc3ea9ed030e5a5879cff8272893997fe2c";
  };
