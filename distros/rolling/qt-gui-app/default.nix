...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/qt_gui_core-release/archive/release/rolling/qt_gui_app/2.7.4-1.tar.gz";
    name = "2.7.4-1.tar.gz";
    sha256 = "1277cca1a9f01e2f778faff7a7f8bddc4f10d3cafaadcf9d0987180faa5b184a";
  };
