...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rc_genicam_driver_ros2-release/archive/release/rolling/rc_genicam_driver/0.3.0-3.tar.gz";
    name = "0.3.0-3.tar.gz";
    sha256 = "e9541f4fcf4d0468195f3ce2b6b6a059bac3d4c2804095a91fcfea33db5beab9";
  };
