...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mavlink-gbp-release/archive/release/rolling/mavlink/2025.12.12-1.tar.gz";
    name = "2025.12.12-1.tar.gz";
    sha256 = "1ea8749111156a24e405bef67f6d6d9145ca4642e382cff6177476521a1b84fc";
  };
