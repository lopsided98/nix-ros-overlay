...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mavlink-gbp-release/archive/release/rolling/mavlink/2026.3.3-1.tar.gz";
    name = "2026.3.3-1.tar.gz";
    sha256 = "8ea40e625fee711319b07298199a037396f6a520c1acee2e0d1ba0b2006cfc8e";
  };
