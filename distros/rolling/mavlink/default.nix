...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mavlink-gbp-release/archive/release/rolling/mavlink/2023.6.6-1.tar.gz";
    name = "2023.6.6-1.tar.gz";
    sha256 = "67da924b00bf6721241e97656cc6091c93371fbb37a446a3451ad56826a2d276";
  };
