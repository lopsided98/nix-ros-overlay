...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_flake8/0.20.4-1.tar.gz";
    name = "0.20.4-1.tar.gz";
    sha256 = "6ea1a1bbbf2c40760b59a96ea6c67e14d6d95be00be2015e07f5c8bc47f7bd96";
  };
