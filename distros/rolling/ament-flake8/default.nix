...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_flake8/0.21.2-1.tar.gz";
    name = "0.21.2-1.tar.gz";
    sha256 = "1ff12eb0a9818eb89101fbc739d6147c40dc668e286e0096cb93402c96771e29";
  };
