...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/diagnostics-release/archive/release/rolling/diagnostic_common_diagnostics/4.4.4-1.tar.gz";
    name = "4.4.4-1.tar.gz";
    sha256 = "bf398614ce3593cd29309c50962c842bf526245b3902d2d2f897da76597e620f";
  };
