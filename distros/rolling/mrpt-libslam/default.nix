...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libslam/2.15.16-1.tar.gz";
    name = "2.15.16-1.tar.gz";
    sha256 = "69363b25637eee1362e41cfc19645f731f3824122d38230d3047bc73e26d9ecc";
  };
