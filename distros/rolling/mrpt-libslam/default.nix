...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libslam/2.15.14-2.tar.gz";
    name = "2.15.14-2.tar.gz";
    sha256 = "3aae522c0298f2a980a367df6a9f366e9c505a574a5840a485aeb92b39e80edf";
  };
