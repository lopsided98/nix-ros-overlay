...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_common-release/archive/release/rolling/image_transport/5.2.1-1.tar.gz";
    name = "5.2.1-1.tar.gz";
    sha256 = "197d2482fb1938df7b3854a7dc50e4888113772ec18493da6e0ceaac8d21d0fd";
  };
