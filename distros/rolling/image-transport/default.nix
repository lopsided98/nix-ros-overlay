...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_common-release/archive/release/rolling/image_transport/7.0.4-1.tar.gz";
    name = "7.0.4-1.tar.gz";
    sha256 = "11238ede056c881c55b716648fa804addf47054443cb890cdad75814f4145eff";
  };
