...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/event_camera_tools-release/archive/release/rolling/event_camera_tools/3.1.2-2.tar.gz";
    name = "3.1.2-2.tar.gz";
    sha256 = "4402b226eff85239659ce23154783c8f846f66ea672f723d5b7c2361b7e160c7";
  };
