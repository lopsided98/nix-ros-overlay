...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/event_camera_tools-release/archive/release/rolling/event_camera_tools/3.1.5-1.tar.gz";
    name = "3.1.5-1.tar.gz";
    sha256 = "21e3776123d19b1f6390745b900ac272fc5fcdc0b7abde4a23fb4f1817752ef4";
  };
