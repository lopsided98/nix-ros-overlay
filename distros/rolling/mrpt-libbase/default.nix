...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libbase/2.15.16-1.tar.gz";
    name = "2.15.16-1.tar.gz";
    sha256 = "5c47f252f1795e29b5dcb7db6aa96e8b28055efec051290b3286af88de4078bd";
  };
