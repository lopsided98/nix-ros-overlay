...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libbase/2.14.10-1.tar.gz";
    name = "2.14.10-1.tar.gz";
    sha256 = "b4d9fd6e56355bd24f7cac6841a704089fa1043fd297c0435913c35c776790be";
  };
