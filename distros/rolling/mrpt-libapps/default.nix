...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libapps/2.15.8-1.tar.gz";
    name = "2.15.8-1.tar.gz";
    sha256 = "71e1ae06cef4b0d4d9bdd2a7a2bd684a0dd10f9c599f0e46df9cb3e960dc0daa";
  };
