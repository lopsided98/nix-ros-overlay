...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libapps/2.14.5-1.tar.gz";
    name = "2.14.5-1.tar.gz";
    sha256 = "c6fb74424f279caac087fcd961ba00da1a94034dda5b3141e3cb6a4b275e30bb";
  };
