...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libapps/2.14.16-1.tar.gz";
    name = "2.14.16-1.tar.gz";
    sha256 = "ef4f046eff043e4c11703a48a22fc7f13b784b777b13b3927e24e1197fa6ad93";
  };
