...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libapps/2.13.7-3.tar.gz";
    name = "2.13.7-3.tar.gz";
    sha256 = "00eda51de5e3a03da1542aa6ec5d85a35c8c2728f92a0c157ccb693337424b98";
  };
