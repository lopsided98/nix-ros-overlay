...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libapps/2.15.11-1.tar.gz";
    name = "2.15.11-1.tar.gz";
    sha256 = "32bb77787edaf12b7c5f90ce4e9dfce98518267efd34795ab406e8caaec088e3";
  };
