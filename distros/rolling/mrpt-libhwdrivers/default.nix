...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libhwdrivers/2.15.16-1.tar.gz";
    name = "2.15.16-1.tar.gz";
    sha256 = "d828549e18b018e0f0e3f8acbfaff246a585d46fb0ba0cf3beafd529aa3a0436";
  };
