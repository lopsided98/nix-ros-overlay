...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libhwdrivers/2.14.10-1.tar.gz";
    name = "2.14.10-1.tar.gz";
    sha256 = "64e8889b8b506f3ba79b642a9e24fb7aa16548da7a1016f0c33ce4281a3b3e39";
  };
