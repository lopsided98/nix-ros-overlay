...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli_common_extensions-release/archive/release/rolling/ros2cli_common_extensions/0.6.0-1.tar.gz";
    name = "0.6.0-1.tar.gz";
    sha256 = "a2643bac05aefcbb7bd10594302afee7179838ca8fb56ceec0373277b62042d1";
  };
