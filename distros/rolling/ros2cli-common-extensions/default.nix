...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli_common_extensions-release/archive/release/rolling/ros2cli_common_extensions/0.3.0-1.tar.gz";
    name = "0.3.0-1.tar.gz";
    sha256 = "1e73e12a33b9139a1fe14dc7117a05339fbaef8f5b95c07571b0e2446df8af94";
  };
