...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/pilz_industrial_motion_planner/2.9.0-2.tar.gz";
    name = "2.9.0-2.tar.gz";
    sha256 = "bf6f50f3d12b549073d2d2ee3a425068ea895631ffba01d4fc17fe1cb1638555";
  };
