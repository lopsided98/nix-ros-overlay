...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/object_recognition_msgs-release/archive/release/rolling/object_recognition_msgs/2.0.0-2.tar.gz";
    name = "2.0.0-2.tar.gz";
    sha256 = "7369fcfc8ae8c8e49f726df74896b499611d700585df5caab37a875dc41d46f3";
  };
