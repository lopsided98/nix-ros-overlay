...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_rendering/12.2.0-1.tar.gz";
    name = "12.2.0-1.tar.gz";
    sha256 = "6c3e63818d5c199a68f0d40f2140339152cb1a9724abf266688d4f4a0d26e22d";
  };
