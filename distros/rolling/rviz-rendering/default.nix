...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_rendering/14.1.0-1.tar.gz";
    name = "14.1.0-1.tar.gz";
    sha256 = "a994ffa644b8070e310f3877b8f25af0ba79e0485ec3157d050b0da59f87cc2e";
  };
