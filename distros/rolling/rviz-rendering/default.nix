...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_rendering/15.1.1-1.tar.gz";
    name = "15.1.1-1.tar.gz";
    sha256 = "da73b6569aa8d3c138cda43b979d1a78c0d0cb961d376365b730fb014a552d77";
  };
