...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_rendering/15.1.4-1.tar.gz";
    name = "15.1.4-1.tar.gz";
    sha256 = "0d9e96c881aef264c1af129ba203fa990fe733369f0f0d89d9d1805c8aac0df3";
  };
