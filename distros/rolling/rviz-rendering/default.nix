...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_rendering/15.1.7-1.tar.gz";
    name = "15.1.7-1.tar.gz";
    sha256 = "3d48a2cbf3e8f2d4ae1a9f072ea03513d8a5babda51372604e8ab27bab969456";
  };
