...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_rendering/14.2.6-1.tar.gz";
    name = "14.2.6-1.tar.gz";
    sha256 = "817b616c32cf98844e2f98120ea7fe41b5aaee1cb0ce5a2fd1fdfe8572343eea";
  };
