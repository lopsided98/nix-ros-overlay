...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fuse-release/archive/release/rolling/fuse_optimizers/1.3.1-2.tar.gz";
    name = "1.3.1-2.tar.gz";
    sha256 = "f5aeba6cf0d729fee830f43e0316f8ac5473e10b8b3b9fe0d9171697bff5f1a3";
  };
