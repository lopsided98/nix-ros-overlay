...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_tracing-release/archive/release/rolling/tracetools/8.10.1-2.tar.gz";
    name = "8.10.1-2.tar.gz";
    sha256 = "fb8ad63e4dedf3e85527d173eff4064b85b93e573debaa565cf9dccf557f89ad";
  };
