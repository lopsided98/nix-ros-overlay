...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/cras_ros_utils-release/archive/release/rolling/cras_lint/3.0.2-1.tar.gz";
    name = "3.0.2-1.tar.gz";
    sha256 = "c6a6b6cb0c43398a10ebb0a9a68e7b679f33a74de95add3bbcba03b5e642e472";
  };
