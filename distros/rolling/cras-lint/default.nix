...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/cras_ros_utils-release/archive/release/rolling/cras_lint/3.0.1-1.tar.gz";
    name = "3.0.1-1.tar.gz";
    sha256 = "be684ed2de20c90b5f31186edbc8839c0fb9a800c73185588fc53256a0d2167e";
  };
