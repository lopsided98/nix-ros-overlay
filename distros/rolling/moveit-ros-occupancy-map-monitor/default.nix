...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_ros_occupancy_map_monitor/2.7.3-1.tar.gz";
    name = "2.7.3-1.tar.gz";
    sha256 = "af7e95268ab9197081aa19360a35bf33eb1445b2bc7d231f116521b33de64140";
  };
