...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/rolling/ur_moveit_config/7.1.0-1.tar.gz";
    name = "7.1.0-1.tar.gz";
    sha256 = "a766717f4b0f6faf8165e49ceb6f229e5981f2c4b3eadf0747924f59c3637bb5";
  };
