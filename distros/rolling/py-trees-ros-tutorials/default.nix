...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/py_trees_ros_tutorials-release/archive/release/rolling/py_trees_ros_tutorials/2.4.0-3.tar.gz";
    name = "2.4.0-3.tar.gz";
    sha256 = "8cebf35778fa07ca043ddef0c33fb7a345d10930122af18881bc16b56fd1fd38";
  };
