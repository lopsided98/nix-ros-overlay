...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_cpplint/0.21.2-1.tar.gz";
    name = "0.21.2-1.tar.gz";
    sha256 = "75008d5c201fac43367e3116b94d64b1af244931663a670d2f17b05d9fe55f81";
  };
