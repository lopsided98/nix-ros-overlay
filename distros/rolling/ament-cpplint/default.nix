...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_cpplint/0.20.2-1.tar.gz";
    name = "0.20.2-1.tar.gz";
    sha256 = "fa9dc4e3691ec46a5a1e0af81a85ad732018fd747f37a4088da335ad6f06f220";
  };
