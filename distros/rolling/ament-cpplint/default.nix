...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_cpplint/0.20.4-1.tar.gz";
    name = "0.20.4-1.tar.gz";
    sha256 = "02329fdf6675d0ffe048d382ebba6bdf510588367322a89df856b5fde9b10015";
  };
