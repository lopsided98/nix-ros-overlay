...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_cpplint/0.20.1-1.tar.gz";
    name = "0.20.1-1.tar.gz";
    sha256 = "f2b5480ca76208a0b6eddc6685bfaa3cb1d64d8a5e2b1ea0752ed20809bcfb56";
  };
