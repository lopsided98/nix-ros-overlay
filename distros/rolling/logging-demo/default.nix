...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/rolling/logging_demo/0.37.5-1.tar.gz";
    name = "0.37.5-1.tar.gz";
    sha256 = "24367cec4e2142b43827caffb4efe90a6b03e49fdcbba61bfccf2f81a137ef67";
  };
