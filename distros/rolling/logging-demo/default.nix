...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/rolling/logging_demo/0.37.4-1.tar.gz";
    name = "0.37.4-1.tar.gz";
    sha256 = "42bd22bcfda4fb4ce01ef8fbf7b9786a00a560d60675fb47b16d665ef83cff76";
  };
