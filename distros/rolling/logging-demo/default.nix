...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/rolling/logging_demo/0.37.6-1.tar.gz";
    name = "0.37.6-1.tar.gz";
    sha256 = "3fc4d8ce388ae7b76edf332d61703061d5148bbd7c92f18550f9a7a364827070";
  };
