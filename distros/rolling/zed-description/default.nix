...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/zed-ros2-description-release/archive/release/rolling/zed_description/0.1.2-1.tar.gz";
    name = "0.1.2-1.tar.gz";
    sha256 = "dd0002247518c1fc7c034286f7973eb5cf2c3a34ce8c9bfacaa046cbb71e6bff";
  };
