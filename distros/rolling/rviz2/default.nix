...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz2/15.1.3-1.tar.gz";
    name = "15.1.3-1.tar.gz";
    sha256 = "3c94806bdf7e0882df314d75d3d2e7f5f8e3865de7e0d741029cf22a97cf2cdf";
  };
