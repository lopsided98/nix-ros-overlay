...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz2/15.1.11-1.tar.gz";
    name = "15.1.11-1.tar.gz";
    sha256 = "170b7233396d4572a8c9616e2339670f74c001b1d91731dfdea8a5352795dfdb";
  };
