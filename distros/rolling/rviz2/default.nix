...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz2/14.1.0-1.tar.gz";
    name = "14.1.0-1.tar.gz";
    sha256 = "ace79e7a58b0f760c640089f8afe96e61e0fa1a06c7001d5ef6cca5c8cc20dcb";
  };
