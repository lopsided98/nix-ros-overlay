...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz2/15.1.13-1.tar.gz";
    name = "15.1.13-1.tar.gz";
    sha256 = "223d71754beee92fbc3084bcec66bfc4c9e9826803de48ac448339616902d7db";
  };
