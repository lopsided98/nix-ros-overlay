...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt-release/archive/release/rolling/rqt_gui_py/2.0.3-1.tar.gz";
    name = "2.0.3-1.tar.gz";
    sha256 = "1ca4503f5e710744853a3bb81b0c2a6e693bf9ffe152dac296050ab30c7a32cf";
  };
