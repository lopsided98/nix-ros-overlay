...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt-release/archive/release/rolling/rqt_gui_py/1.10.3-1.tar.gz";
    name = "1.10.3-1.tar.gz";
    sha256 = "c16ffc24ea221d51129f8ba153cda19d752908b56e46cd5a29a95880e5068f5b";
  };
