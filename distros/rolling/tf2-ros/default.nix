...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_ros/0.32.0-1.tar.gz";
    name = "0.32.0-1.tar.gz";
    sha256 = "a7d0eb9d5cc3fd8b77c1f74e2b253a6f2adebcfaf580d57b4a690e9d078dde89";
  };
