...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_ros/0.43.0-1.tar.gz";
    name = "0.43.0-1.tar.gz";
    sha256 = "d02794c0c72eb3e4266c542cf4e215ce3b11304a08cb436e2680585e5f990d88";
  };
