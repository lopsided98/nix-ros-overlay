...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_ros/0.43.1-1.tar.gz";
    name = "0.43.1-1.tar.gz";
    sha256 = "dd402c76d766cb50d5f1aa9633d015cb84af1b48e8b2cee8530c13359afd59b6";
  };
