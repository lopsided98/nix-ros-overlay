...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_ros/0.38.0-1.tar.gz";
    name = "0.38.0-1.tar.gz";
    sha256 = "4e39e51aee9b866068fc625d8c66d34ff7d6f32fa6a75c1c2381192a91a32cd7";
  };
