...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_ros/0.42.2-1.tar.gz";
    name = "0.42.2-1.tar.gz";
    sha256 = "f4d0fd1588c6c388da2e9acec468b95476fc88a8f8374e535c829665a04d60cc";
  };
