...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/rolling/yasmin/3.5.1-1.tar.gz";
    name = "3.5.1-1.tar.gz";
    sha256 = "e6fc1632af5e85dba8605b20f0d33154800854fdda4370e4ebfc3751f24891ee";
  };
