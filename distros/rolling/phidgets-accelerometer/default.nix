...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/rolling/phidgets_accelerometer/2.3.4-1.tar.gz";
    name = "2.3.4-1.tar.gz";
    sha256 = "85bf49a309769ae370d26584280811a69ecaee9ccd2ecb431c887489ef146232";
  };
