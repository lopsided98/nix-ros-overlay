...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/ros2_controllers/6.3.0-1.tar.gz";
    name = "6.3.0-1.tar.gz";
    sha256 = "ab61f3b44b8c7a45deafc24219d4780920aa2de7cd34d3dfd3615affac4fb9f4";
  };
