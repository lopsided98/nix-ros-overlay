...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/ros2_controllers/4.6.0-2.tar.gz";
    name = "4.6.0-2.tar.gz";
    sha256 = "ac00069f3f622571c93ae75ef021e867ac5bbc920b6b383db3a3b2512e4d537c";
  };
