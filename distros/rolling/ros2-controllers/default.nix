...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/ros2_controllers/4.2.0-1.tar.gz";
    name = "4.2.0-1.tar.gz";
    sha256 = "2d9c65de19652056bda5bba8eac526356acc019495f9870fd4e71933b80288f3";
  };
