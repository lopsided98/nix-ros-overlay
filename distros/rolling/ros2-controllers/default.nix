...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/ros2_controllers/4.9.0-1.tar.gz";
    name = "4.9.0-1.tar.gz";
    sha256 = "99278f69357373fc93f280f37e6a03e8929d343d579ab10f70382d71d7c84fe2";
  };
