...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/ros2_controllers/4.7.0-1.tar.gz";
    name = "4.7.0-1.tar.gz";
    sha256 = "1e7440c69108870a7e4f06a890409d76ca4e120a910bd66fde4a1618686f106f";
  };
