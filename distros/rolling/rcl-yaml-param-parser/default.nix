...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl_yaml_param_parser/10.3.2-1.tar.gz";
    name = "10.3.2-1.tar.gz";
    sha256 = "0fa180257523623dc45635eed30f612dcdc23b18b896b5a45542cafd5b9b475b";
  };
