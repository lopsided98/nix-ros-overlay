...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl_yaml_param_parser/10.4.1-1.tar.gz";
    name = "10.4.1-1.tar.gz";
    sha256 = "fb58b39281c8f781c9084bf2506c697014e8171c090a1bb1604ef55416f9aa6a";
  };
