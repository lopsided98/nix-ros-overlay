...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl_yaml_param_parser/10.2.6-1.tar.gz";
    name = "10.2.6-1.tar.gz";
    sha256 = "570db6c0158becee1458ec27e7ed2585a22ae589dd97a9106b82a3acd10dcbf7";
  };
