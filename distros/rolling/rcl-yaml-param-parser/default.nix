...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl_yaml_param_parser/10.2.1-1.tar.gz";
    name = "10.2.1-1.tar.gz";
    sha256 = "eeefb7426ea3b293f3163b017101910fa995b929bcb286fcbebc2e59a898feb4";
  };
