...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl_yaml_param_parser/10.2.5-1.tar.gz";
    name = "10.2.5-1.tar.gz";
    sha256 = "2aade212be83b340736d2ee26d88bf2c9ec7d6ad2b9df488f001a5ac07bc6749";
  };
