...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl_yaml_param_parser/10.2.7-1.tar.gz";
    name = "10.2.7-1.tar.gz";
    sha256 = "632fdada4946159330805c95e5fb3cb4790f2005e11bb8b8af0947e4e3bcfcc4";
  };
