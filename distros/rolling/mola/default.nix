...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola/1.6.1-1.tar.gz";
    name = "1.6.1-1.tar.gz";
    sha256 = "81a371d247a5c968e60b5200fc21ee972172253feebfb8041937cbcfbda3ed3b";
  };
