...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola/1.4.1-1.tar.gz";
    name = "1.4.1-1.tar.gz";
    sha256 = "a458e4c0a56683666c24256ead70261d1e8bc89996edfddae72038d4bb311412";
  };
