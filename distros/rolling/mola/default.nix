...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola/2.7.0-2.tar.gz";
    name = "2.7.0-2.tar.gz";
    sha256 = "fa3b2c796f15767eb5db05ae0be2e2e89cded1613a2ebf8ecda11f00d402863e";
  };
