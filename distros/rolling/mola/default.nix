...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola/1.0.5-1.tar.gz";
    name = "1.0.5-1.tar.gz";
    sha256 = "0a86816353891eb970765f0cef655ae0eeeb72e70288b39c6878e62795bbd8a9";
  };
