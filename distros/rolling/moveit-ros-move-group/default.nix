...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_ros_move_group/2.7.3-1.tar.gz";
    name = "2.7.3-1.tar.gz";
    sha256 = "1f0b7445f93d0dab2875b864d35a523cc4d856d403a7f0a03f3e84601e54279a";
  };
