...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/robstride_ros2-release/archive/release/rolling/robstride_driver/0.2.0-1.tar.gz";
    name = "0.2.0-1.tar.gz";
    sha256 = "65d8451ac17a0d0f2bdca1d5af9944acee477e33e8a3f4d051a398e5b042af65";
  };
