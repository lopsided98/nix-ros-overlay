...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_kinematics/2.9.0-2.tar.gz";
    name = "2.9.0-2.tar.gz";
    sha256 = "a2dbdedbec9a8ed6f7dbcc1bf6945550405acef3189ce506ed1e5467feaa83e6";
  };
