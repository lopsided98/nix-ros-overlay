...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/moveit/moveit2-release/archive/release/rolling/moveit_kinematics/2.6.0-1.tar.gz";
    name = "2.6.0-1.tar.gz";
    sha256 = "2fc2e92c1b283802525a5e5ec4b47ed6301b978eeddf071378f8ec00c8d7b55a";
  };
  ...
  propagatedBuildInputs = [ class-loader eigen generate-parameter-library moveit-common moveit-core moveit-msgs orocos-kdl-vendor pluginlib python3Packages.lxml tf2 tf2-kdl urdfdom ];
