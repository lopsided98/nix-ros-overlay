...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidlcpp-release/archive/release/rolling/rosidlcpp_generator_core/0.2.0-1.tar.gz";
    name = "0.2.0-1.tar.gz";
    sha256 = "a94fc2a8d2600140ed7fffac2c0956b16685b34ecb83f91bf214b3b6867417e9";
  };
