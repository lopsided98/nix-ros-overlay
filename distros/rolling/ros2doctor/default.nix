...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2doctor/0.23.0-1.tar.gz";
    name = "0.23.0-1.tar.gz";
    sha256 = "8ae2afb95fb55774f4b8af980aeac0db4a16aee4c218c25a06174d916940ad2a";
  };
