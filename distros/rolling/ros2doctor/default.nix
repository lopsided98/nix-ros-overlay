...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2doctor/0.42.0-1.tar.gz";
    name = "0.42.0-1.tar.gz";
    sha256 = "31f9645bf3925a548075da05b8b238d22b0915db05592043986ef3b1460453d6";
  };
