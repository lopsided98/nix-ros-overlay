...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2doctor/0.41.0-1.tar.gz";
    name = "0.41.0-1.tar.gz";
    sha256 = "2216ba696a3600d84dba7d660fb549c8d60b6d134f66c0ea1b47dc39ddb70e82";
  };
