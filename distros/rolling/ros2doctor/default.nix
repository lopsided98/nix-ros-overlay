...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2doctor/0.41.1-1.tar.gz";
    name = "0.41.1-1.tar.gz";
    sha256 = "dbca6e538bf49178ed1d25dd123a43bca8709e129268aca3b2268349bdb7af40";
  };
