...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2doctor/0.39.1-1.tar.gz";
    name = "0.39.1-1.tar.gz";
    sha256 = "b61d892973c95167df7bfa4cbd58ed080af4ad2581dc9391c712c5427aa90f01";
  };
