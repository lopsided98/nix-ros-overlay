...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2doctor/0.40.2-1.tar.gz";
    name = "0.40.2-1.tar.gz";
    sha256 = "4f1ae4b7e37f50cd6779a191c6c325cf66fcdda782dc5bd6b097da3f4515272a";
  };
