...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/imu_sensor_broadcaster/4.9.0-1.tar.gz";
    name = "4.9.0-1.tar.gz";
    sha256 = "bb4f31b1aaede15e4bfc9f187e3d3e5171d3fb3f388635f71758ecf8335e6a67";
  };
