...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/imu_sensor_broadcaster/6.3.0-1.tar.gz";
    name = "6.3.0-1.tar.gz";
    sha256 = "0c0d8c656c4fa10ba776ae23ad6c64686ad04534102dd15ceede14e7f5d97389";
  };
