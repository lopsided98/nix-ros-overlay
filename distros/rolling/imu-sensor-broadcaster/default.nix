...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/imu_sensor_broadcaster/4.4.0-1.tar.gz";
    name = "4.4.0-1.tar.gz";
    sha256 = "afdcd38bc1dc20571417b7ee1b1c61e20663f1ce5070e4376592980f89366f91";
  };
