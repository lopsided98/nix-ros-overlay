...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/imu_sensor_broadcaster/3.7.0-1.tar.gz";
    name = "3.7.0-1.tar.gz";
    sha256 = "0de9e2c411246d55e8e0bc2545c9682aa4a6fb13460545abf49b1301dbcc4dc7";
  };
