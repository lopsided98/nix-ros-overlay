...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/imu_sensor_broadcaster/4.2.0-1.tar.gz";
    name = "4.2.0-1.tar.gz";
    sha256 = "069954429b08250606a0f94f41aa9df9eb45d58a422fa67df25387c8a7b6df50";
  };
