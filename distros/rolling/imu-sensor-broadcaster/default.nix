...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/imu_sensor_broadcaster/4.7.0-1.tar.gz";
    name = "4.7.0-1.tar.gz";
    sha256 = "6a5232109db4b0f242e892d0c191e26bef2eadcb18288f3b56f33caf6a23b4de";
  };
