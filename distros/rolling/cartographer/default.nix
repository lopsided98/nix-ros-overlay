...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/cartographer-release/archive/release/rolling/cartographer/2.0.9004-1.tar.gz";
    name = "2.0.9004-1.tar.gz";
    sha256 = "f8d3da63ecd85abc340b906040752fd5e5fcf2bd94f5ba7b10c47e2453a48956";
  };
