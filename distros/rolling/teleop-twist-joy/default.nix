...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/teleop_twist_joy-release/archive/release/rolling/teleop_twist_joy/2.6.1-1.tar.gz";
    name = "2.6.1-1.tar.gz";
    sha256 = "3cc3b900f1e61251289d6f2d06c22f20446c68ab71cdcdb1bd860ec32d70399e";
  };
