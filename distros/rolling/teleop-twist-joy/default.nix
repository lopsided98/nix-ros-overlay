...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/teleop_twist_joy-release/archive/release/rolling/teleop_twist_joy/2.6.4-1.tar.gz";
    name = "2.6.4-1.tar.gz";
    sha256 = "574db98420cef6e2408a75149aade1052404dbb1c813e34d4e35c55dfe16867e";
  };
