...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/rolling/webots_ros2_driver/2023.0.3-1.tar.gz";
    name = "2023.0.3-1.tar.gz";
    sha256 = "7d39998e8039ce5dd79a5d320eb301a261939e6c04cb42824d04f8c9cd82de71";
  };
