...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/rolling/webots_ros2_driver/2023.0.0-3.tar.gz";
    name = "2023.0.0-3.tar.gz";
    sha256 = "06c2eef595e5765c73b6e66494c33fff173358e2f6e05907a96b5878cc783b0d";
  };
