...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/rolling/webots_ros2_driver/2025.0.1-2.tar.gz";
    name = "2025.0.1-2.tar.gz";
    sha256 = "81d3bd3de14d0d88990b5fbd0241a9ac0b33c15c4061c1c53d2a67af140592d1";
  };
