...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/examples-release/archive/release/rolling/launch_testing_examples/0.21.5-1.tar.gz";
    name = "0.21.5-1.tar.gz";
    sha256 = "178a0c9bd00bf9d541e47935de4167ae223c80f05c43645acf6328ac623411e5";
  };
