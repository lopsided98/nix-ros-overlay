...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/examples-release/archive/release/rolling/launch_testing_examples/0.21.4-1.tar.gz";
    name = "0.21.4-1.tar.gz";
    sha256 = "dd8c0051e57908b1db3ef888a76d4aacaccf47c41ffdb5471584a001a9695cb9";
  };
