...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_canopen-release/archive/release/rolling/canopen_master_driver/0.3.0-1.tar.gz";
    name = "0.3.0-1.tar.gz";
    sha256 = "0cd0d6a9e5c103804c8932f0aeb7a544e2995a96728e947a5507bbfc1dcf319c";
  };
