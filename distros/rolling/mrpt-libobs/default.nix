...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libobs/2.14.10-1.tar.gz";
    name = "2.14.10-1.tar.gz";
    sha256 = "e46a46522e7906fb04f06085d9a615fb1fefe46b086eca4887b7d1c3e155bc96";
  };
