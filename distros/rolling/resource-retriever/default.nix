...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/resource_retriever-release/archive/release/rolling/resource_retriever/3.4.1-1.tar.gz";
    name = "3.4.1-1.tar.gz";
    sha256 = "89441e9c99c4e477d527f5c34937b491346e6aa331a125f4f246a33c6cd9ed34";
  };
