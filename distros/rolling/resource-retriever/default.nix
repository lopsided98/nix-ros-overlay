...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/resource_retriever-release/archive/release/rolling/resource_retriever/3.9.2-1.tar.gz";
    name = "3.9.2-1.tar.gz";
    sha256 = "6dd133564fdf074d54d098b52b0ff05b5ef2c793a479d29af22d9d6243ce55e0";
  };
