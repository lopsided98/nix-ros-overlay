...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/rolling/swri_geometry_util/3.7.5-1.tar.gz";
    name = "3.7.5-1.tar.gz";
    sha256 = "182bfddce7bc5e8b62b82ce191be03d2827259a77616c44d9dbc645f4aad808b";
  };
