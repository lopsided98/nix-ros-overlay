...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/rolling/launch_ros/0.30.0-1.tar.gz";
    name = "0.30.0-1.tar.gz";
    sha256 = "92f17732a981255907fc891963ee59ea61c828c3e8efe918c4e21435851b08d8";
  };
