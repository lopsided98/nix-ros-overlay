...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/robstride_ros2-release/archive/release/rolling/robstride_examples/0.2.0-1.tar.gz";
    name = "0.2.0-1.tar.gz";
    sha256 = "a9b260b908ab7f03d82c5476763514a363a5cc100b3b0659ff9d1155e16edc91";
  };
