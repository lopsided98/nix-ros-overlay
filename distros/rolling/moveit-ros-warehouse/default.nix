...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_ros_warehouse/2.8.0-2.tar.gz";
    name = "2.8.0-2.tar.gz";
    sha256 = "63673f4cc2b6884dfe2aa58896e258005e73781992018dc7093935039ae486c6";
  };
