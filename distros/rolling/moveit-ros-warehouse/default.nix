...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_ros_warehouse/2.9.0-2.tar.gz";
    name = "2.9.0-2.tar.gz";
    sha256 = "9b41b7c51e3f507de33000da4027ef595ca4d6ac50e3b5bab4bdf8ec1100ebe4";
  };
