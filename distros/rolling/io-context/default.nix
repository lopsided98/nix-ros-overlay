...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/transport_drivers-release/archive/release/rolling/io_context/1.2.0-4.tar.gz";
    name = "1.2.0-4.tar.gz";
    sha256 = "e8c5c667ae59737916f31f204373f2d0e6255c6db58d5825733b18fdbeb7a8f3";
  };
