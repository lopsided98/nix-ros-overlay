...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/rolling/mrpt_navigation/2.4.0-2.tar.gz";
    name = "2.4.0-2.tar.gz";
    sha256 = "a073e67fd24b74576cb8f93288bd01896a913c1842591537104aab959302bbbc";
  };
