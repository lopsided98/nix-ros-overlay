...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_metric_maps/1.7.0-1.tar.gz";
    name = "1.7.0-1.tar.gz";
    sha256 = "854dcf2d15a92bdee2d3185b00bf4dbeda23d1aaa38e28eed9ba6d37a939f1bf";
  };
