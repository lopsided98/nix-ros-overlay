...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_metric_maps/1.0.5-1.tar.gz";
    name = "1.0.5-1.tar.gz";
    sha256 = "12b725a87a5259c1cd8a3582485cdb293d5020bbc223a8923b865efd83dd5df6";
  };
