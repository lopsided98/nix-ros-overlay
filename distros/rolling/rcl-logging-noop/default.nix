...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl_logging-release/archive/release/rolling/rcl_logging_noop/3.4.1-1.tar.gz";
    name = "3.4.1-1.tar.gz";
    sha256 = "2be4aa555b8a4dbba60596f49a71485fb1b7cf46dc3afaa68c99abbbf257da49";
  };
