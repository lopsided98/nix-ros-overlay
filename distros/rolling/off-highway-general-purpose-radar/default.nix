...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/off_highway_sensor_drivers-release/archive/release/rolling/off_highway_general_purpose_radar/1.3.0-2.tar.gz";
    name = "1.3.0-2.tar.gz";
    sha256 = "4d1d1459cc74990f428ad6cbba5378b7219ad9f16af177ddaee1f4231b9e1b26";
  };
