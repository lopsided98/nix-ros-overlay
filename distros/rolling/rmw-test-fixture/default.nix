...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake_ros-release/archive/release/rolling/rmw_test_fixture/0.15.3-1.tar.gz";
    name = "0.15.3-1.tar.gz";
    sha256 = "99c40ca391143535e2e4e996d783e9c3f68e13a2de88fd7b2fbf9c9962ef0543";
  };
