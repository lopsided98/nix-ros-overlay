...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_servo/2.8.0-2.tar.gz";
    name = "2.8.0-2.tar.gz";
    sha256 = "5b30c8b35b338e0472e69cdab47a1f86e1100d8682905df14ec72f884c1a7eb1";
  };
