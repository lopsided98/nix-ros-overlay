...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ffmpeg_encoder_decoder-release/archive/release/rolling/ffmpeg_encoder_decoder/3.0.1-2.tar.gz";
    name = "3.0.1-2.tar.gz";
    sha256 = "5287c8bac3726df688276badbcd9e53667ccdfb137e4136aed8549032c9502cd";
  };
