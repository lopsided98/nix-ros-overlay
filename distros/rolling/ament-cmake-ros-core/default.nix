...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake_ros-release/archive/release/rolling/ament_cmake_ros_core/0.15.3-1.tar.gz";
    name = "0.15.3-1.tar.gz";
    sha256 = "c026e5434e66573143b3fde2a76eab50b40683eee1a37771c017dbe464c994f7";
  };
