...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/inverse_dynamics_solver-release/archive/release/rolling/ur10_inverse_dynamics_solver/6.0.1-1.tar.gz";
    name = "6.0.1-1.tar.gz";
    sha256 = "3f755214504c944428ca5f663effc0d385f3f6644ee0421ef91ab6ffbf7d79f5";
  };
