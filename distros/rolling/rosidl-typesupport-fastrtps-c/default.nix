...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_typesupport_fastrtps-release/archive/release/rolling/rosidl_typesupport_fastrtps_c/3.9.5-2.tar.gz";
    name = "3.9.5-2.tar.gz";
    sha256 = "bb81f7dd5f1c9e86d570cc1d2b97e8a36dc1d804eee598fbd46137a284eee581";
  };
