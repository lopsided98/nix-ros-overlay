...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/rolling/phidgets_motors/2.3.1-1.tar.gz";
    name = "2.3.1-1.tar.gz";
    sha256 = "5ea2225e6d727ccdf04835f99fd68ea4b07e2ae68e35da3c9527f1371fa5a9a0";
  };
