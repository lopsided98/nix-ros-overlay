...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/rolling/phidgets_motors/2.4.0-2.tar.gz";
    name = "2.4.0-2.tar.gz";
    sha256 = "5f9e970c09afdba11a09b8feb25c3de33603dd35e8b5b37151ff51b1379c61ee";
  };
