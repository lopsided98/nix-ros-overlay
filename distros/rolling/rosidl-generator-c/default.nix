...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_generator_c/5.1.2-1.tar.gz";
    name = "5.1.2-1.tar.gz";
    sha256 = "01bb6bcaa481fba53b0a6ec9db316c25de98a6273c53f096d159848f95619f48";
  };
