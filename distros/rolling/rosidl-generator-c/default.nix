...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_generator_c/3.4.0-1.tar.gz";
    name = "3.4.0-1.tar.gz";
    sha256 = "83a6a2a2e3e256411b2d0b0081b5a26a04484cfaf77a831edfb7e02beb7cc6d4";
  };
