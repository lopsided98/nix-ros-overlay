...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_generator_c/5.2.0-2.tar.gz";
    name = "5.2.0-2.tar.gz";
    sha256 = "3bff9251fbc9b962b6b9c0addadaf4181bc74fb56dccac819e818126001468cd";
  };
