...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_generator_c/5.1.1-1.tar.gz";
    name = "5.1.1-1.tar.gz";
    sha256 = "01edafdea65c02debbeaee74bf26d720fd958360f8878746a3c0a10d1da78469";
  };
