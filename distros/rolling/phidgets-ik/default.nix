...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/rolling/phidgets_ik/2.4.0-2.tar.gz";
    name = "2.4.0-2.tar.gz";
    sha256 = "8c76f7ee69f38859f71368c9507b76858edb2aec30ec84e0d944421708dd6e2a";
  };
