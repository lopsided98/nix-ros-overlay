...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_compression/0.20.0-1.tar.gz";
    name = "0.20.0-1.tar.gz";
    sha256 = "c6200464f33b92c154bef1122a14d6fe9c0e7868fa5cb75cd358d5c49f88e23e";
  };
