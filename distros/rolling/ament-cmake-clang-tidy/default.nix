...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_cmake_clang_tidy/0.17.0-1.tar.gz";
    name = "0.17.0-1.tar.gz";
    sha256 = "e16d4c4e1508ccbc3342f5fd59bf0f21e290c74a93924ee27ec635ac4f23b8ac";
  };
