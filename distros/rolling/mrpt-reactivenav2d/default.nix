...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/rolling/mrpt_reactivenav2d/2.2.4-1.tar.gz";
    name = "2.2.4-1.tar.gz";
    sha256 = "13c3e915a4cfd13a4e363585046f7ab58a09065015c3c6298a81769196506bee";
  };
