...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2/0.39.0-1.tar.gz";
    name = "0.39.0-1.tar.gz";
    sha256 = "68a5dff60a0b68dae57d32bb36cb0af3bcc9d50c107207116769c9fa13aca388";
  };
