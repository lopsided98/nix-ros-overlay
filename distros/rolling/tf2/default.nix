...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2/0.43.1-1.tar.gz";
    name = "0.43.1-1.tar.gz";
    sha256 = "a02878edbbcf0c51b2729802693cfcf217498580d75f0a4528dd1046d368327b";
  };
