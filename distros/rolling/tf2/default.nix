...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2/0.45.1-1.tar.gz";
    name = "0.45.1-1.tar.gz";
    sha256 = "7477ecc7f39a8f23b151b3f6ed0fcbe2ab693dd9c2a96568ef9b5b0889a4acc2";
  };
