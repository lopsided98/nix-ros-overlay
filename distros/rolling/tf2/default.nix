...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2/0.37.1-1.tar.gz";
    name = "0.37.1-1.tar.gz";
    sha256 = "bc4ddd21f41708574b4ad07dab3b653988306435006dc8666b2f7a4cce65388d";
  };
