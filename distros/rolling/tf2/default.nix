...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2/0.38.0-1.tar.gz";
    name = "0.38.0-1.tar.gz";
    sha256 = "e0e9dc617abf95b83d7d7b908ae8f12fc486d65c1d97ea6d32dc0e0278ccfad2";
  };
