...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2/0.45.6-1.tar.gz";
    name = "0.45.6-1.tar.gz";
    sha256 = "0052459662e6bd9ae43eceb5be654869f1c0b0aa4fe98fb156ee024330c292a3";
  };
