...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2/0.45.4-1.tar.gz";
    name = "0.45.4-1.tar.gz";
    sha256 = "f4fa4b3f20451c4049336b8b54bef564992cdd516f736f961af488a612f8852d";
  };
