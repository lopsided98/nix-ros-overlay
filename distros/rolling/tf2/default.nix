...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2/0.46.1-1.tar.gz";
    name = "0.46.1-1.tar.gz";
    sha256 = "fbbcdbdfc30fac11a03ef4d36976614a658c6b78e8bca87dcc3dc7a75a6ed123";
  };
