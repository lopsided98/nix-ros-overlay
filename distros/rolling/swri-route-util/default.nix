...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/rolling/swri_route_util/3.8.1-1.tar.gz";
    name = "3.8.1-1.tar.gz";
    sha256 = "cdcf9ec064ca91512208842dae50e36d2138bf8352985116e5de6c3dd9cf02f9";
  };
