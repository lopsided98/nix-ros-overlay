...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/tricycle_controller/6.6.0-2.tar.gz";
    name = "6.6.0-2.tar.gz";
    sha256 = "f30fb331c2cc64dabfdefdb016f4250938d8b66eda044edcf6315df33b5561be";
  };
