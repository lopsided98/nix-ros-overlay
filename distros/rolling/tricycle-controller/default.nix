...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/tricycle_controller/6.2.0-1.tar.gz";
    name = "6.2.0-1.tar.gz";
    sha256 = "c0236a330cac81e2ac7ac152630a795788e2fade2439ab5f11fb4ed72fe784ac";
  };
