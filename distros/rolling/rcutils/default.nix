...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcutils-release/archive/release/rolling/rcutils/6.1.1-1.tar.gz";
    name = "6.1.1-1.tar.gz";
    sha256 = "a20fdbe75fa1f11e59b211324203e39fb562133245719b53069944086a1232f5";
  };
