...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/rolling/ur_calibration/2.4.7-1.tar.gz";
    name = "2.4.7-1.tar.gz";
    sha256 = "6d0888e006ef799d6dc74b0a02742fd2d85b0ae7cc170ff2becf12888d001c62";
  };
