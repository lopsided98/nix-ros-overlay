...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/rolling/ur_calibration/4.0.0-1.tar.gz";
    name = "4.0.0-1.tar.gz";
    sha256 = "ae4f5ceb51606ab7fe8223348475ae570b821480ca85b81af92c0c09847f8292";
  };
