...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/rolling/ur_calibration/4.3.0-1.tar.gz";
    name = "4.3.0-1.tar.gz";
    sha256 = "b1f1075846dd363d18c3e9bc93a9e478e9041187ec35afbb796a194966e65513";
  };
