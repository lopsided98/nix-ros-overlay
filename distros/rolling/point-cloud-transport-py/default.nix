...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/point_cloud_transport-release/archive/release/rolling/point_cloud_transport_py/5.3.1-1.tar.gz";
    name = "5.3.1-1.tar.gz";
    sha256 = "5c338ccdfe3f62f1a5c6760ddb1208dd8e41a6334cb8f55536f09db7cf3bc841";
  };
