...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/point_cloud_transport-release/archive/release/rolling/point_cloud_transport_py/5.0.1-1.tar.gz";
    name = "5.0.1-1.tar.gz";
    sha256 = "253377a91797b7483305e663ecdce64982e2b37cf7d386e6ff75bb719e845d51";
  };
