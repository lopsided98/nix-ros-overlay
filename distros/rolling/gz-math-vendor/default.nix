...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gz_math_vendor-release/archive/release/rolling/gz_math_vendor/0.5.1-1.tar.gz";
    name = "0.5.1-1.tar.gz";
    sha256 = "6a295618818dd45b973002477b906718f02c5bfa667a3d9680d3f8df2847ca02";
  };
