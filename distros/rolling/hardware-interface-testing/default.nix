...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/hardware_interface_testing/6.7.1-1.tar.gz";
    name = "6.7.1-1.tar.gz";
    sha256 = "a6b656d4d6512065bcfcca7ba739923a67db6f087986b3daab0a8b8bf6c7ec0b";
  };
