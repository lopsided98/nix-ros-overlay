...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/hardware_interface_testing/5.7.0-1.tar.gz";
    name = "5.7.0-1.tar.gz";
    sha256 = "1abf63ee0e03d937e2c5df264dba40cb8466159fe4c5b527b19a91bb58b745bc";
  };
