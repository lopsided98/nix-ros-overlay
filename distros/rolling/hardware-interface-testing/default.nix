...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/hardware_interface_testing/6.2.0-1.tar.gz";
    name = "6.2.0-1.tar.gz";
    sha256 = "74c1af2d5dff4c59c9511740b36bc1367d28ef0705846fb3514ae0e35cd8fe25";
  };
