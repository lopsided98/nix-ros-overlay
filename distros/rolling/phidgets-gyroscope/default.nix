...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/rolling/phidgets_gyroscope/2.3.4-1.tar.gz";
    name = "2.3.4-1.tar.gz";
    sha256 = "5bd207dcc77f6d7a1b4ae1ee743c4f87a81a28728647e2751a36b1ab05b7060a";
  };
