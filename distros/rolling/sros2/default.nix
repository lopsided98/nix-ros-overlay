...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/sros2-release/archive/release/rolling/sros2/0.16.1-1.tar.gz";
    name = "0.16.1-1.tar.gz";
    sha256 = "8b8527c6f7067a39f12ea9dd1010270c15789a93c4e8f3132b2fa30448c202af";
  };
