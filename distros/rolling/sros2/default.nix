...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/sros2-release/archive/release/rolling/sros2/0.16.2-1.tar.gz";
    name = "0.16.2-1.tar.gz";
    sha256 = "26edd92f81d162f5bad305c778f0fcab6c0c12ce7cb53b89380ba58104917949";
  };
