...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_converters/1.2.1-5.tar.gz";
    name = "1.2.1-5.tar.gz";
    sha256 = "b4ad06cbbefbbf2e33e356939730cf4a8b3bcd8e91f7bdbfdd5f59129b97f836";
  };
