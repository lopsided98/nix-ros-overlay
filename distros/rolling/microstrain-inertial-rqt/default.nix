...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/microstrain_inertial-release/archive/release/rolling/microstrain_inertial_rqt/4.7.0-1.tar.gz";
    name = "4.7.0-1.tar.gz";
    sha256 = "a0ccbb8e46d514deaebac5b359a12a542ac1bfe65186b8d949fd3b08077b483a";
  };
