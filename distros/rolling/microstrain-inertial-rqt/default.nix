...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/microstrain_inertial-release/archive/release/rolling/microstrain_inertial_rqt/3.0.1-1.tar.gz";
    name = "3.0.1-1.tar.gz";
    sha256 = "2a0d9e061bf83e8382e369253c48d8097bfb520980fce6dd0647174b9bd4333e";
  };
