...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_canopen-release/archive/release/rolling/canopen_proxy_driver/0.3.2-1.tar.gz";
    name = "0.3.2-1.tar.gz";
    sha256 = "b5bb05cc744f985ae4dc9945d10110c796dbc07d48c2f3beba2be5bc65bc8f3c";
  };
