...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_transport/0.19.0-1.tar.gz";
    name = "0.19.0-1.tar.gz";
    sha256 = "77230dd9e960c5f470c22ee526685a76004dd6e6a121605328afb4ef8ec810d1";
  };
