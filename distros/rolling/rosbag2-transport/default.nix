...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_transport/0.26.1-1.tar.gz";
    name = "0.26.1-1.tar.gz";
    sha256 = "ec642eada73fabafb4a3394eaff50bd5f099d1b7317147eecca2860ed7405467";
  };
