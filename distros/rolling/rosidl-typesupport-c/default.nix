...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_typesupport-release/archive/release/rolling/rosidl_typesupport_c/3.4.1-1.tar.gz";
    name = "3.4.1-1.tar.gz";
    sha256 = "07a2f4e889885101bb6043289b0ea1389271be6bb6dda671db7f5606261bca71";
  };
