...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_typesupport-release/archive/release/rolling/rosidl_typesupport_c/3.4.2-2.tar.gz";
    name = "3.4.2-2.tar.gz";
    sha256 = "77adad5a1c6781de5bd6226a187531f9575adbaba474abfa35b8ce82b593c2a3";
  };
