...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/microstrain_inertial-release/archive/release/rolling/microstrain_inertial_driver/3.2.1-2.tar.gz";
    name = "3.2.1-2.tar.gz";
    sha256 = "c00456eef347505ff6e27f154f32606dddce86127ef8f1236df674832f11964e";
  };
