...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/microstrain_inertial-release/archive/release/rolling/microstrain_inertial_driver/2.7.1-1.tar.gz";
    name = "2.7.1-1.tar.gz";
    sha256 = "59144b6e43323359929321caa5487a9966075a4d5516e013e00c292b58b1296d";
  };
