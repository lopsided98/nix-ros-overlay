...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_visualization-release/archive/release/rolling/rmf_visualization_navgraphs/2.3.1-1.tar.gz";
    name = "2.3.1-1.tar.gz";
    sha256 = "cb44a83747a2a2aabb234393850b34a332667fe14904d5f62ec1605eaade5262";
  };
