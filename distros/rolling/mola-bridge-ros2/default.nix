...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_bridge_ros2/2.7.0-2.tar.gz";
    name = "2.7.0-2.tar.gz";
    sha256 = "31406ed930463dc3b1501968b3d9cfcad875b140315916541c5eb540937d7f90";
  };
