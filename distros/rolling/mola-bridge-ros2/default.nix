...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_bridge_ros2/1.0.4-1.tar.gz";
    name = "1.0.4-1.tar.gz";
    sha256 = "b55b9e479c2731efe30d4e71d747d3ec5f36645f3833da45e95599ab8b9f6ad7";
  };
