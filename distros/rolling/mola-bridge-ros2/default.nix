...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_bridge_ros2/1.8.1-1.tar.gz";
    name = "1.8.1-1.tar.gz";
    sha256 = "30316809180c90dc475ee4db9a6e65891b73ce9c23138cb4258894c72016e2c7";
  };
