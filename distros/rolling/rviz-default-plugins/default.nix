...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_default_plugins/15.2.2-2.tar.gz";
    name = "15.2.2-2.tar.gz";
    sha256 = "5adc4def6fec89ab950184d71307383bc1659e107edb8e166d4c774fb678de2d";
  };
