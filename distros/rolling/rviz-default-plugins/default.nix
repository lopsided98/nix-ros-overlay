...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_default_plugins/15.1.13-1.tar.gz";
    name = "15.1.13-1.tar.gz";
    sha256 = "5ef6b6cf88ae0c1646698723caffa6b990c8081a16354c58c593dc69a0f9d579";
  };
