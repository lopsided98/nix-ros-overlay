...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_default_plugins/15.1.14-1.tar.gz";
    name = "15.1.14-1.tar.gz";
    sha256 = "7e6a78b49e923df034f5095ea4e7df120b05c8f15f1b0b0f543f4a5b6d6e8e44";
  };
