...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_default_plugins/15.1.3-1.tar.gz";
    name = "15.1.3-1.tar.gz";
    sha256 = "1009b7864705ba7ec2ab3ad7b104e7a7e0493c6b8557772dc0c38e4bd9c15536";
  };
