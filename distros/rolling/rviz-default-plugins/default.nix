...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_default_plugins/15.1.1-1.tar.gz";
    name = "15.1.1-1.tar.gz";
    sha256 = "5fef32a8a80b2beea55bc0bf3c51cfa0f49bda4106f5d522bdead774ab5513d8";
  };
