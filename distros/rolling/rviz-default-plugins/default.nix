...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_default_plugins/15.1.6-1.tar.gz";
    name = "15.1.6-1.tar.gz";
    sha256 = "09722e0090df65f87b8e16fe3f68e2a357aff1a28fe95cd5ff84efa3e3a73a90";
  };
