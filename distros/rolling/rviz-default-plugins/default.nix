...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_default_plugins/15.1.7-1.tar.gz";
    name = "15.1.7-1.tar.gz";
    sha256 = "3eae65a24d102396fa259d96a9a7ed315c7b691e1f0a18ffc9aa88b03c3a3987";
  };
