...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_default_plugins/15.1.15-1.tar.gz";
    name = "15.1.15-1.tar.gz";
    sha256 = "28feab89e8cd35c8c97b01a3af7190e36b0f604914733c057fc9dcae63c4fc08";
  };
