...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_default_plugins/15.1.18-1.tar.gz";
    name = "15.1.18-1.tar.gz";
    sha256 = "b92273223466258acd7f6d21e1ae74214b7a64ff07ae264f2b291c9a837e7fcb";
  };
