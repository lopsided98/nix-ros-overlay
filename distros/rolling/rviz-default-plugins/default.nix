...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_default_plugins/15.1.11-1.tar.gz";
    name = "15.1.11-1.tar.gz";
    sha256 = "bcd9804366beef59658fac22cfdfe8dc9d09baf2022f32fa2903fee6afe75970";
  };
