...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_default_plugins/16.0.3-1.tar.gz";
    name = "16.0.3-1.tar.gz";
    sha256 = "f4625e70c9920b370fd4085e93e6c3b2bc67801baed9a72f0c164ad2318c3244";
  };
