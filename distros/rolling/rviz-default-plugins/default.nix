...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_default_plugins/15.1.16-1.tar.gz";
    name = "15.1.16-1.tar.gz";
    sha256 = "a2ce1f789d5301efff067c198a0626dd0b3c89735cbf837668a7c28c596c24e6";
  };
