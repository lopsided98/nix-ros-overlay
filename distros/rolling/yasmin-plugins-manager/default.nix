...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/rolling/yasmin_plugins_manager/6.1.1-1.tar.gz";
    name = "6.1.1-1.tar.gz";
    sha256 = "f39d2954c85bebb3c4177ffe062fd3a9a51de800f704411122d2ca39f141fcae";
  };
