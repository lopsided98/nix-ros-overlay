...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_visualization-release/archive/release/rolling/rmf_visualization_schedule/2.3.1-1.tar.gz";
    name = "2.3.1-1.tar.gz";
    sha256 = "7de5b9a4483483c71047fc3681c27b4fbb9a77cc0356b6ff8d9d5311cb525339";
  };
