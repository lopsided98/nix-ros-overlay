...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_visualization-release/archive/release/rolling/rmf_visualization_schedule/2.5.1-2.tar.gz";
    name = "2.5.1-2.tar.gz";
    sha256 = "b1904c1a42f38e9a7e260c36b39f25000f476de7202a98afc9666be799b9e166";
  };
