...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/rolling/phidgets_digital_outputs/2.3.1-1.tar.gz";
    name = "2.3.1-1.tar.gz";
    sha256 = "803e1ae77a2e46f38575a5b19ea4668fc280797cbee05ededd9ff75b17329fcd";
  };
