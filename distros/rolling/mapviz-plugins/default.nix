...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/rolling/mapviz_plugins/2.5.7-1.tar.gz";
    name = "2.5.7-1.tar.gz";
    sha256 = "5b112eb7fc0d46b516295062266c1c8499379ffa15129316ad5aa7ce30a151f2";
  };
