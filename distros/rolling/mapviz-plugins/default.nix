...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/rolling/mapviz_plugins/2.4.7-1.tar.gz";
    name = "2.4.7-1.tar.gz";
    sha256 = "749f5e59cd47b7086b8e8e663669e064c4132968213845836a00cec613f453d3";
  };
