...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/rolling/mapviz_plugins/2.4.6-1.tar.gz";
    name = "2.4.6-1.tar.gz";
    sha256 = "81dab2601b24b650d94cbcc76646f2ba969ea4a2cbed6b13cc75619f81ef5672";
  };
