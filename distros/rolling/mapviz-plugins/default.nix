...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/rolling/mapviz_plugins/2.5.6-1.tar.gz";
    name = "2.5.6-1.tar.gz";
    sha256 = "c6b0e28d46a97d668bde712e4af1e00fe668779563eca1cee1b835fa09bb37b5";
  };
