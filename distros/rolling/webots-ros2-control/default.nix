...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/rolling/webots_ros2_control/2025.0.1-1.tar.gz";
    name = "2025.0.1-1.tar.gz";
    sha256 = "0e8f1dfaba6c5c9a38423a3a4f42b83f877692eb19325dcbe3ecb8138d7aff5c";
  };
