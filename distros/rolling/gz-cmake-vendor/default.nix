...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gz_cmake_vendor-release/archive/release/rolling/gz_cmake_vendor/0.4.2-1.tar.gz";
    name = "0.4.2-1.tar.gz";
    sha256 = "fd02f1a39fa604f0c98b6d21882c3b33fcee92118c3d8d5cd1e5b4c0ce195b04";
  };
  ...
  meta = {
    description = "Vendor package for: gz-cmake 5.0.1
