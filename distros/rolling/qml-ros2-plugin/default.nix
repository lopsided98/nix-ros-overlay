...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/qml_ros2_plugin-release/archive/release/rolling/qml_ros2_plugin/1.0.1-1.tar.gz";
    name = "1.0.1-1.tar.gz";
    sha256 = "b558d6f4c7406e52c006cf29e1477918772161d97b1cc471ecd3b595cbe33f39";
  };
