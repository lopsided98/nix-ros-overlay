...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_lint_cmake/0.20.4-1.tar.gz";
    name = "0.20.4-1.tar.gz";
    sha256 = "988d45c4cc085fc3a556c24d84a926bb5f924a089f749d2a7467b51b43633402";
  };
