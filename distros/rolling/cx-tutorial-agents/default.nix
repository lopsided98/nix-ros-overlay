...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/clips_executive-release/archive/release/rolling/cx_tutorial_agents/0.1.3-1.tar.gz";
    name = "0.1.3-1.tar.gz";
    sha256 = "a09e0ede18bbbe2fbaefdd2a9ae6ceed0cfc0d757eb8e77973704b0f97a25ecc";
  };
