...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclc-release/archive/release/rolling/rclc_parameter/6.3.0-1.tar.gz";
    name = "6.3.0-1.tar.gz";
    sha256 = "c00a19e7b55fd8b89b7320a4af0d5ab421a7b65c4c8dbcb4594d505ebaa6b15d";
  };
