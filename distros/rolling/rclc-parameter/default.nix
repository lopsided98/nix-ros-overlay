...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclc-release/archive/release/rolling/rclc_parameter/6.3.0-2.tar.gz";
    name = "6.3.0-2.tar.gz";
    sha256 = "8b9f9976631f44cf8535a8d7f883bbcb966417de78e9dae955642da4724110d3";
  };
