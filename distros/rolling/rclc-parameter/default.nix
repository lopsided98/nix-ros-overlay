...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclc-release/archive/release/rolling/rclc_parameter/6.2.1-1.tar.gz";
    name = "6.2.1-1.tar.gz";
    sha256 = "0fa10505ba8859f78514f8527372aa0c25d3e773f560fb67f2b2b36f2afd4fbe";
  };
