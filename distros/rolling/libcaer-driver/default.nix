...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/libcaer_driver-release/archive/release/rolling/libcaer_driver/1.5.5-1.tar.gz";
    name = "1.5.5-1.tar.gz";
    sha256 = "28042d644449143c854c9397315684eb1ce5827ab7b4770ae6880bc595babf42";
  };
