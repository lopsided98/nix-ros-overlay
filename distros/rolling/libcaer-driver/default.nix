...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/libcaer_driver-release/archive/release/rolling/libcaer_driver/1.5.6-1.tar.gz";
    name = "1.5.6-1.tar.gz";
    sha256 = "05ce29254b5d2b564da6667120258c45c1618c1479a55f8de652d54df80ceb3e";
  };
