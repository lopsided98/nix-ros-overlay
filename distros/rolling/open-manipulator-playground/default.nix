...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/rolling/open_manipulator_playground/4.0.6-1.tar.gz";
    name = "4.0.6-1.tar.gz";
    sha256 = "a256c2cce239900092b24c0b23ed9d93f57509d3e74767a5d2b1abf31df69171";
  };
