...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/rolling/multires_image/2.6.2-3.tar.gz";
    name = "2.6.2-3.tar.gz";
    sha256 = "91ef0f9579079d5d522434dd25db1497c90e6fe511bbd595924af0861e3cb81a";
  };
