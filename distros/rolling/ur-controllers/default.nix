...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/rolling/ur_controllers/4.0.0-1.tar.gz";
    name = "4.0.0-1.tar.gz";
    sha256 = "12f76940a7dc8ccc6209958b5626491698cee3381c98726a632edfa72165b38d";
  };
