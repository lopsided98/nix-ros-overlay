...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/rolling/ur_controllers/4.3.0-1.tar.gz";
    name = "4.3.0-1.tar.gz";
    sha256 = "d518085deeb91b533b130606e6e6a7ba14c545997f7496165a8d29198816eb52";
  };
