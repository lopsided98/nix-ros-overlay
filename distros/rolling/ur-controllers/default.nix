...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/rolling/ur_controllers/4.4.0-1.tar.gz";
    name = "4.4.0-1.tar.gz";
    sha256 = "16aeb258475637bb37fc8ebfe0db055eed3b4a0eded161bb6ee58acfcdd6ec30";
  };
