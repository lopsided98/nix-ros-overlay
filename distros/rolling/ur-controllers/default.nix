...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/rolling/ur_controllers/2.4.5-1.tar.gz";
    name = "2.4.5-1.tar.gz";
    sha256 = "a93f9c85985a3a50c1f79a432b24256b2b8f822bde792d1b54f38b48d5ba7e17";
  };
