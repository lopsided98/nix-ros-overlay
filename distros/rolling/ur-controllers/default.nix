...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/rolling/ur_controllers/7.1.0-1.tar.gz";
    name = "7.1.0-1.tar.gz";
    sha256 = "8e2dc1db1e52df87fdb5c6e74ba76c8ef24acf9c59129cd37916c70a54f6dbfd";
  };
