...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_int2dds-release/archive/release/rolling/rmw_int2dds_cpp/0.1.5-1.tar.gz";
    name = "0.1.5-1.tar.gz";
    sha256 = "2559b00108bed653376ca4ef5fb39835dc290fda2a56586e81b4e47f96e19f26";
  };
