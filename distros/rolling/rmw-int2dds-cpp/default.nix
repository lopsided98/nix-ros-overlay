...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_int2dds-release/archive/release/rolling/rmw_int2dds_cpp/0.1.7-1.tar.gz";
    name = "0.1.7-1.tar.gz";
    sha256 = "f0d27b9277aa8c70580ce803c855fd97d8ee96b49f32d3dd1ec10aa33ad17174";
  };
