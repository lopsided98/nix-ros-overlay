...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_cppcheck/0.20.4-1.tar.gz";
    name = "0.20.4-1.tar.gz";
    sha256 = "3419bc5dcac51bc494ff70970539a734c955c2e4351f2e54db28de425e005f79";
  };
