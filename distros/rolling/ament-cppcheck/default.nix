...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_cppcheck/0.21.2-1.tar.gz";
    name = "0.21.2-1.tar.gz";
    sha256 = "fd2a9ddc026390f41ef7b799cd3a04512c51ed190523f4f1c5541d8023ad5ea6";
  };
