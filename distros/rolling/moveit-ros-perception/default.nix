...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_ros_perception/2.7.3-1.tar.gz";
    name = "2.7.3-1.tar.gz";
    sha256 = "6d8abbbb5ec8ad0e709975a448113cb4166c50caa41cc3b300e298e167ee0dc0";
  };
