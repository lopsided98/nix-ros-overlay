...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mavros-release/archive/release/rolling/mavros/2.6.0-2.tar.gz";
    name = "2.6.0-2.tar.gz";
    sha256 = "a15c22b83eae787f10f9c664b40bf7b5ab40bbb5b8a08ab18d5fb116d3f62ef1";
  };
