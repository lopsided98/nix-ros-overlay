...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mavros-release/archive/release/rolling/mavros/2.10.0-1.tar.gz";
    name = "2.10.0-1.tar.gz";
    sha256 = "fdadaa953c73d6f9fb5b40d268dd049903cf7b3eb4c98669953121f88babbabf";
  };
