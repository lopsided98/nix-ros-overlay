...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mavros-release/archive/release/rolling/mavros/2.14.0-2.tar.gz";
    name = "2.14.0-2.tar.gz";
    sha256 = "ba3483f2aaf2be28021c04dba8d9767cd6045dccede24e4e91d9c110bbac713e";
  };
