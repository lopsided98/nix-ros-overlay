...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mavros-release/archive/release/rolling/mavros/2.4.0-2.tar.gz";
    name = "2.4.0-2.tar.gz";
    sha256 = "4d56882b9e4458955d9349bee238d8eeb285db24b7dc99d1b740d4958b84067c";
  };
