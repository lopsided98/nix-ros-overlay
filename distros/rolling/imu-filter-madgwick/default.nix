...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/imu_tools-release/archive/release/rolling/imu_filter_madgwick/2.2.3-1.tar.gz";
    name = "2.2.3-1.tar.gz";
    sha256 = "b16646ae8075c575d201d69deb6c7bef86bc2aa82dfcabcc1293127880e2294f";
  };
