...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/off_highway_sensor_drivers-release/archive/release/rolling/off_highway_radar/1.3.0-2.tar.gz";
    name = "1.3.0-2.tar.gz";
    sha256 = "bf178f5464db3d3d37ea075aff9229be8bfd6b6014160ee11dd1af29f461f17f";
  };
