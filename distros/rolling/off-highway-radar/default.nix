...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/off_highway_sensor_drivers-release/archive/release/rolling/off_highway_radar/1.1.0-2.tar.gz";
    name = "1.1.0-2.tar.gz";
    sha256 = "a4c3afc3c5d3f94e6f405b6e5c736942891002477f51c031284d8d564a1d1bb2";
  };
