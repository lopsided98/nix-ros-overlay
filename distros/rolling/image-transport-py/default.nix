...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_common-release/archive/release/rolling/image_transport_py/6.4.5-1.tar.gz";
    name = "6.4.5-1.tar.gz";
    sha256 = "9133415d182e02cbe6661d86b0a5f41ecb90a38ea95ba7d5ee8d90cdcde6fc1e";
  };
