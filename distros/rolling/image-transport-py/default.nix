...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_common-release/archive/release/rolling/image_transport_py/6.4.7-1.tar.gz";
    name = "6.4.7-1.tar.gz";
    sha256 = "847ad39c115eb90caf0c60d422eef2e06bfd1b05115eac23ede25449f33a201a";
  };
