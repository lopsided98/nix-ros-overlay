...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/controller_manager_msgs/6.0.2-1.tar.gz";
    name = "6.0.2-1.tar.gz";
    sha256 = "eed38fa5d847ea2329c95d0f6766e1b160246a53c12dfed5b888bf3acb8ef6ba";
  };
