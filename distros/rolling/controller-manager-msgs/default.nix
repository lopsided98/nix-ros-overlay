...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/controller_manager_msgs/6.7.1-1.tar.gz";
    name = "6.7.1-1.tar.gz";
    sha256 = "b9608e2a19c2043f0b7aca7ae612fb0279369e7ba4eb3292ecee89b19450b224";
  };
