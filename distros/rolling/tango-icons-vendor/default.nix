...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/tango_icons_vendor-release/archive/release/rolling/tango_icons_vendor/0.5.1-1.tar.gz";
    name = "0.5.1-1.tar.gz";
    sha256 = "da9175b7e268913d541a913676f724c6752a92c86919c595e4638a4694a2ed7f";
  };
