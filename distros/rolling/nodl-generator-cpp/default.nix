...
buildRosPackage {
  pname = "ros-rolling-nodl-generator-cpp";
  version = "2.0.3-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/nodl-release/archive/release/rolling/nodl_generator_cpp/2.0.3-1.tar.gz";
    name = "2.0.3-1.tar.gz";
    sha256 = "3900c7d6699dc8d991073a0f68c163b291a4c933b4d0f44907597c47ab000fae";
  };
