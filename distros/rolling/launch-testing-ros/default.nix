...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/rolling/launch_testing_ros/0.29.6-1.tar.gz";
    name = "0.29.6-1.tar.gz";
    sha256 = "e5294857f61b99533df8793f54669908d9e5c9ebf258dffb7fe8fb19a4611e79";
  };
