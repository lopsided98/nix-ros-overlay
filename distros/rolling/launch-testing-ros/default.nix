...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/rolling/launch_testing_ros/0.29.7-1.tar.gz";
    name = "0.29.7-1.tar.gz";
    sha256 = "5af7c62b534136511144202ddffa536b28e7baf9759a30ea5a501b3e7fe7963c";
  };
