...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/rolling/launch_testing_ros/0.30.1-1.tar.gz";
    name = "0.30.1-1.tar.gz";
    sha256 = "0c5f4d03ec51800706a3c4a04b8066925836fa91b875f41a40c4ca0d5cfdc356";
  };
