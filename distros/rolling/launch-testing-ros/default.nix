...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/rolling/launch_testing_ros/0.29.5-1.tar.gz";
    name = "0.29.5-1.tar.gz";
    sha256 = "14df52d70b0dada7f0fe918422c758ae6d30d741e83b194b8ffa97248f3a4cf8";
  };
