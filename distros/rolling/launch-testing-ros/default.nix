...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/rolling/launch_testing_ros/0.29.2-1.tar.gz";
    name = "0.29.2-1.tar.gz";
    sha256 = "c68737277be340ff288e54b43e4922229e46debefad931f5be27ac35343e4b31";
  };
