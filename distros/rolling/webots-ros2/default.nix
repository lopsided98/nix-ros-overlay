...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/rolling/webots_ros2/2025.0.1-1.tar.gz";
    name = "2025.0.1-1.tar.gz";
    sha256 = "7d4675c651f711576fbb90f1b725774726b3bd0ff5013285fae6ebba6288b8f4";
  };
