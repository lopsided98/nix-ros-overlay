...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclc-release/archive/release/rolling/rclc_lifecycle/6.3.0-1.tar.gz";
    name = "6.3.0-1.tar.gz";
    sha256 = "aad5e4f7db0ce45c73d9217703db7109a51db55edec6ce2cbba371fdf84d7c21";
  };
