...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclc-release/archive/release/rolling/rclc_lifecycle/6.2.1-1.tar.gz";
    name = "6.2.1-1.tar.gz";
    sha256 = "740f089438cd5044470b21dab8da1ef3e5450bfac134b3e388e2fe6e2b26bae7";
  };
