...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_sigslots/1.2.1-5.tar.gz";
    name = "1.2.1-5.tar.gz";
    sha256 = "0907fc9fc649d3a84a643cfd8442be169467ced7e61827c378c0b0fb96a97d85";
  };
