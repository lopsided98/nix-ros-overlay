...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/graph_monitor-release/archive/release/rolling/rosgraph_monitor/0.2.2-2.tar.gz";
    name = "0.2.2-2.tar.gz";
    sha256 = "7c626a3b0e60c5731c55c3633485dd10513021f288a45c94336e986649b5172a";
  };
