...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2service/0.42.0-1.tar.gz";
    name = "0.42.0-1.tar.gz";
    sha256 = "ed47876d75eccdbd758413d9778204c27fcbabe1245f65efdc8381f571aaa7b1";
  };
