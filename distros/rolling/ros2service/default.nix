...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2service/0.32.0-1.tar.gz";
    name = "0.32.0-1.tar.gz";
    sha256 = "2e12025b84a06f9c6ae5734e3775250f28c21e8d46effc02d975d196983eefc6";
  };
