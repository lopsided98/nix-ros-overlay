...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2service/0.41.0-1.tar.gz";
    name = "0.41.0-1.tar.gz";
    sha256 = "c7b36f74de4ed56cbe0a62479e9a0540bf91d059a2d96816b0f916c4c85620fe";
  };
