...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2service/0.40.2-1.tar.gz";
    name = "0.40.2-1.tar.gz";
    sha256 = "d9b837afc459f474ee2f5621a76c0ac3f6c920b3cfb139b23204fb93f070f246";
  };
