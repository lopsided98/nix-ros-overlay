...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch-release/archive/release/rolling/launch/3.5.1-1.tar.gz";
    name = "3.5.1-1.tar.gz";
    sha256 = "403f398150a82ca5a299a9c8357b4275393bbbd4d4e68b8a87e4fdd1fd048cf3";
  };
