...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch-release/archive/release/rolling/launch/3.4.2-1.tar.gz";
    name = "3.4.2-1.tar.gz";
    sha256 = "526c6e4fad812103e3ea6ab0c52c5afac3df559d1c29655e1b59c860994016ca";
  };
