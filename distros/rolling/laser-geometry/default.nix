...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/laser_geometry-release/archive/release/rolling/laser_geometry/2.11.3-5.tar.gz";
    name = "2.11.3-5.tar.gz";
    sha256 = "95597871ee4a584a4c94259a7440015d7f05b5d610f3105d34b85979a74116dc";
  };
