...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/event_camera_py-release/archive/release/rolling/event_camera_py/3.0.0-1.tar.gz";
    name = "3.0.0-1.tar.gz";
    sha256 = "fec2ee8a8f3d5c33544cc9b67fbe340ddc7c02058960356d4cc5fdd6b2f665dc";
  };
