...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/event_camera_py-release/archive/release/rolling/event_camera_py/3.0.0-2.tar.gz";
    name = "3.0.0-2.tar.gz";
    sha256 = "6e1fde818100e84badb925ebd436fbbce201b171d422cfd6deb36eeafd312b57";
  };
