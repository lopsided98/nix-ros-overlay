...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_simulation-release/archive/release/rolling/rmf_building_sim_gz_plugins/2.3.1-1.tar.gz";
    name = "2.3.1-1.tar.gz";
    sha256 = "a2c31f62b685de0efed8780d771c50299100753f4c5ccdf1a949a7f579208d00";
  };
