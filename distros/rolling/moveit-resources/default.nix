...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit_resources-release/archive/release/rolling/moveit_resources/3.1.1-1.tar.gz";
    name = "3.1.1-1.tar.gz";
    sha256 = "17ecceff8f0073067c65ac2e5fd30e87d4a06b9e347c221390fa870452a9e1e6";
  };
