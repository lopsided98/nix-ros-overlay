...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_test_datasets-release/archive/release/rolling/mola_test_datasets/0.4.2-1.tar.gz";
    name = "0.4.2-1.tar.gz";
    sha256 = "7c4b108a61ebc52f2a7402c38c400475b9f11d098f0e0d47992e65d3ce4f733e";
  };
