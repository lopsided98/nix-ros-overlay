...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/swri_console-release/archive/release/rolling/swri_console/2.0.5-1.tar.gz";
    name = "2.0.5-1.tar.gz";
    sha256 = "a8207f227209fcb92009a2af213b67d46a02cefbbcfad1650846d54f2343c3f7";
  };
