...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/controller_manager/6.0.2-1.tar.gz";
    name = "6.0.2-1.tar.gz";
    sha256 = "df3cfe50daebd3f84cbf2bfbde904fe01a3bda2d7d06fe3e83ad51fd92909564";
  };
