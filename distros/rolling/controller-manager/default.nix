...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/controller_manager/6.3.1-1.tar.gz";
    name = "6.3.1-1.tar.gz";
    sha256 = "4651fe7b6b6ab646ace12c1be3c6059c39677b77082ac8a48362632c31fe2908";
  };
