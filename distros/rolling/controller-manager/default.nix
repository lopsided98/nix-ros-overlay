...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/controller_manager/4.3.0-1.tar.gz";
    name = "4.3.0-1.tar.gz";
    sha256 = "3919c63e655480dd2bfc285a3b546463bed52592df7ed08f59e615b3567fc805";
  };
