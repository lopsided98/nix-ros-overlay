...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/controller_manager/6.7.1-1.tar.gz";
    name = "6.7.1-1.tar.gz";
    sha256 = "be34c16e96745405e9acda375d4c72f7494f866a62a52d7e8107466660c33a6b";
  };
