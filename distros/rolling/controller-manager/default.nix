...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/controller_manager/6.0.1-1.tar.gz";
    name = "6.0.1-1.tar.gz";
    sha256 = "eb62203d1482fab5399d20326ae64580731fea64129773254d72964851d88b40";
  };
