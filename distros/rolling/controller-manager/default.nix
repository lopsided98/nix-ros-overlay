...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/controller_manager/4.11.0-1.tar.gz";
    name = "4.11.0-1.tar.gz";
    sha256 = "64836e6ea042f70fdf5bbea222372c9ef220d38ef1c9622bd77cc7219b5988b8";
  };
