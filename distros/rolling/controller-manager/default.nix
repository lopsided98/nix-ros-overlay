...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/controller_manager/4.2.0-1.tar.gz";
    name = "4.2.0-1.tar.gz";
    sha256 = "da24f5ed24aafae60a9bb3cd710b7af01aada900d4d507552dc90d62d00042d8";
  };
