...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/controller_manager/4.21.0-1.tar.gz";
    name = "4.21.0-1.tar.gz";
    sha256 = "b051b75a4b57bd794616f29f1fa8367cd0bf90dc7f2f16199a73e88212329d42";
  };
