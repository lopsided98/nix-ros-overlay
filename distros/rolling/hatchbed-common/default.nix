...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/hatchbed_common-release/archive/release/rolling/hatchbed_common/0.1.8-1.tar.gz";
    name = "0.1.8-1.tar.gz";
    sha256 = "212647a7b82f6877023df80a74026bdb069cf48a11be26b9bb1615369cbb0906";
  };
