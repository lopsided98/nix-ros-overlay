...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fastrtps-release/archive/release/rolling/fastrtps/2.10.1-1.tar.gz";
    name = "2.10.1-1.tar.gz";
    sha256 = "8c5d1c05ce3a89c74b647f51850baf5d052c93edfbe955bab0c90877c91fab41";
  };
