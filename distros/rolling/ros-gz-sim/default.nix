...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz_sim/4.0.1-1.tar.gz";
    name = "4.0.1-1.tar.gz";
    sha256 = "9f9fb01aed205d6e4a42b7aa0d64de804536e3ee2ced6f34cb4b4dc149ef7a05";
  };
