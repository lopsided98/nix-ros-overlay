...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz_sim/3.0.5-1.tar.gz";
    name = "3.0.5-1.tar.gz";
    sha256 = "c566f04818b6c997e2d743156237ff4e4c2418a19514517a275556b58564bb32";
  };
