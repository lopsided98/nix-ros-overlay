...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/rolling/webots_ros2_tesla/2023.0.3-1.tar.gz";
    name = "2023.0.3-1.tar.gz";
    sha256 = "44c7a1df1f00908c9e4cf1ccec48d44b7a5fa1dc2d6d89cd910a3243c218a49c";
  };
