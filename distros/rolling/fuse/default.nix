...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fuse-release/archive/release/rolling/fuse/1.2.3-1.tar.gz";
    name = "1.2.3-1.tar.gz";
    sha256 = "fc86bc800d843fe2940e46b8b455f10e677258fccf558336cfc14c8a0fb3a67f";
  };
