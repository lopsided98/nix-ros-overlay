...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/position_controllers/6.2.0-1.tar.gz";
    name = "6.2.0-1.tar.gz";
    sha256 = "091b4295b3bc8663303aa866f1ee09d67ea502a7d7ff870d5d0401c5caf849bf";
  };
