...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/position_controllers/6.3.0-1.tar.gz";
    name = "6.3.0-1.tar.gz";
    sha256 = "7acd6a1d2461adabca7a109e3d4092715df2f8bfb8571a5e1cf0426a1521ab84";
  };
