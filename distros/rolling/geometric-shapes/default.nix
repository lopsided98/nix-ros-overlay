...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometric_shapes-release/archive/release/rolling/geometric_shapes/2.1.3-4.tar.gz";
    name = "2.1.3-4.tar.gz";
    sha256 = "88d5dc729f2568a7eed187a49a5e4bcc5cd1767a7d40518755f22a8fee604a56";
  };
