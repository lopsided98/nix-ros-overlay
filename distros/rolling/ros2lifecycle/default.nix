...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2lifecycle/0.23.0-1.tar.gz";
    name = "0.23.0-1.tar.gz";
    sha256 = "f0210b5a4ce1fbdecc834ff610b8ccc7495335f28ef130f014299b7ca127ef38";
  };
