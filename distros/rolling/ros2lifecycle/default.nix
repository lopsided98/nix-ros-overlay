...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2lifecycle/0.26.0-1.tar.gz";
    name = "0.26.0-1.tar.gz";
    sha256 = "7023c20bbb266f70adf7002d33866c06da6993ee484fec609a6269417ef25567";
  };
