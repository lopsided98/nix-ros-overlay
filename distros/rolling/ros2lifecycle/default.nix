...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2lifecycle/0.39.1-1.tar.gz";
    name = "0.39.1-1.tar.gz";
    sha256 = "28d04771a49c906376f4eaffdbbda7730b0d2d58416d9269c605cfa6b8a603a4";
  };
