...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2lifecycle/0.40.6-2.tar.gz";
    name = "0.40.6-2.tar.gz";
    sha256 = "ac49efb6baaf21fcae44e73dd2c553aab0b7f67af8a0f7473c27786c8826a1a6";
  };
