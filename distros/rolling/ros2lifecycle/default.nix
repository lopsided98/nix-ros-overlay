...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2lifecycle/0.41.0-1.tar.gz";
    name = "0.41.0-1.tar.gz";
    sha256 = "859f9a7e3f5863dd8fc4a165f33d48e00299ab0e520f6f474c2ca9c7b676a20a";
  };
