...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2lifecycle/0.40.4-1.tar.gz";
    name = "0.40.4-1.tar.gz";
    sha256 = "809dca41eb02e02da921f4cb1db510420d143b579f78ba08a77f60aca6fab869";
  };
