...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_reconfigure-release/archive/release/rolling/rqt_reconfigure/1.8.2-1.tar.gz";
    name = "1.8.2-1.tar.gz";
    sha256 = "6af9370e49389dc14f598ec8f5a74ab8bfabed2280f5c4635ba0199903871afe";
  };
