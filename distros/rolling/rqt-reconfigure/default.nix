...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_reconfigure-release/archive/release/rolling/rqt_reconfigure/2.0.3-1.tar.gz";
    name = "2.0.3-1.tar.gz";
    sha256 = "b585d38e7620f7c300b505fa685fe8df3f83871cd07648b822a037bf1114dc48";
  };
