...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/common_interfaces-release/archive/release/rolling/sensor_msgs/5.10.0-1.tar.gz";
    name = "5.10.0-1.tar.gz";
    sha256 = "791fad3e726f4c670bbf4cee6a4d0b5b89b4160b5cfd05d7c18291ee3525c8bf";
  };
