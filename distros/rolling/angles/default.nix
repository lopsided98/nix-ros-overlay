...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/angles-release/archive/release/rolling/angles/1.16.1-2.tar.gz";
    name = "1.16.1-2.tar.gz";
    sha256 = "979e4d76bbb502ec095deac2a7f99a8c28db1d72a3d6798eb93af144932a1be2";
  };
