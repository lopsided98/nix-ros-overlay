...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/rolling/ublox_dgnss/0.5.8-1.tar.gz";
    name = "0.5.8-1.tar.gz";
    sha256 = "71060e322ab147c5f7acfbd8db00951ff4d797cf9c4024b02adea3c73e40f6d9";
  };
