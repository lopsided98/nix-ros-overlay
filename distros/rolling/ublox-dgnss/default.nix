...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/rolling/ublox_dgnss/0.7.2-1.tar.gz";
    name = "0.7.2-1.tar.gz";
    sha256 = "4cfa9963acc7b8d4fdd4989138f16125cdf8a94723b31f0b243a1d9e0b04ac4a";
  };
