...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/rolling/ublox_dgnss/0.7.0-1.tar.gz";
    name = "0.7.0-1.tar.gz";
    sha256 = "a69c765b87b079c70db61a0f962614e6378067bb0a73a4aa32a3b51821650f6c";
  };
