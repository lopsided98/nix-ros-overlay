...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/system_modes-release/archive/release/rolling/system_modes_examples/0.9.0-4.tar.gz";
    name = "0.9.0-4.tar.gz";
    sha256 = "df5b92b765d71f0cd07b68e7adbad3c1d307fb8cc7d1dec3534fa14a117afe29";
  };
