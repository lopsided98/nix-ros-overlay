...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_rendering_tests/14.2.2-1.tar.gz";
    name = "14.2.2-1.tar.gz";
    sha256 = "c47378adbc885d45b5771bdf33c12673ece6173d31dea3910693fe7d1e84c617";
  };
