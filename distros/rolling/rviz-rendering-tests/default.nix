...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_rendering_tests/15.1.3-1.tar.gz";
    name = "15.1.3-1.tar.gz";
    sha256 = "b02eb0e30c3ac87258bab7c205f72c9b91302330ac912284ff35a472e9286001";
  };
