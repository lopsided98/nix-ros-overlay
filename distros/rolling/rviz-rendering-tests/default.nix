...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_rendering_tests/12.3.1-1.tar.gz";
    name = "12.3.1-1.tar.gz";
    sha256 = "6fa9965415e5f3dc5cbd6e7ecdb6e23b23794572ff419304cace903e1c991d98";
  };
