...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_rendering_tests/14.1.0-1.tar.gz";
    name = "14.1.0-1.tar.gz";
    sha256 = "bbb5334504da90234517047094b0fe70ca01c52daa5a7573a328bad378229a0e";
  };
