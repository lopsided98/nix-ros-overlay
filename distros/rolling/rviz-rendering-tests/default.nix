...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_rendering_tests/15.1.13-1.tar.gz";
    name = "15.1.13-1.tar.gz";
    sha256 = "304abaee1ebdd12ffbf421b40baf7f0d91c6e8eed67db0753999f0a2e7b70baf";
  };
