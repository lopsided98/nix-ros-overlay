...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_typesupport_introspection_c/5.1.1-1.tar.gz";
    name = "5.1.1-1.tar.gz";
    sha256 = "3a6bc82076808052abae37632830bb18d1fc607dec3aec5a60752f3961bf23d0";
  };
