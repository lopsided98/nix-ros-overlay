...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_typesupport_introspection_c/4.6.0-1.tar.gz";
    name = "4.6.0-1.tar.gz";
    sha256 = "b123ca24a5a3df60a6f94b8cdc2461c058f3c6a0112dd4ae9abe27514d39cd07";
  };
