...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_typesupport_introspection_c/4.9.3-1.tar.gz";
    name = "4.9.3-1.tar.gz";
    sha256 = "0b5c38714a16b0d03d2fb46f16eb77ad73d30625f45a99ae225c7f9fb5a0a207";
  };
