...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_typesupport_introspection_c/5.0.1-1.tar.gz";
    name = "5.0.1-1.tar.gz";
    sha256 = "387019d2e5cb8f6a3f1ae61932ac86592a3b0b3640cd046ace8c41de2594d0da";
  };
