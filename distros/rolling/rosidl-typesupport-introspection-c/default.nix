...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_typesupport_introspection_c/5.1.3-1.tar.gz";
    name = "5.1.3-1.tar.gz";
    sha256 = "a6db15ad8f5af3c41ee926579085bafb5a869cecba9fea5f48a50e949da4d6f6";
  };
