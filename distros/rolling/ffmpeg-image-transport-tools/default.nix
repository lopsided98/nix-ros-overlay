...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ffmpeg_image_transport_tools-release/archive/release/rolling/ffmpeg_image_transport_tools/2.1.2-1.tar.gz";
    name = "2.1.2-1.tar.gz";
    sha256 = "d4eacb3aa4f5faddb869dc1a9963e310d68e3b0fe3b1e230e9ff674649ab3b05";
  };
