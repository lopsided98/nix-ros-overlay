...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/rolling/automatika_ros_sugar/0.6.1-2.tar.gz";
    name = "0.6.1-2.tar.gz";
    sha256 = "a79f8da25afa1fdd024993bb41e78427b882d3f4bb103fdf69a282ef30ab2262";
  };
