...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/rolling/automatika_ros_sugar/0.6.1-1.tar.gz";
    name = "0.6.1-1.tar.gz";
    sha256 = "d8a9823cc875f04386b7dc644f95d0213f42c46a49571dc85333298e3a9ff276";
  };
