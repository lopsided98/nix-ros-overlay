...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/rolling/automatika_ros_sugar/0.4.3-1.tar.gz";
    name = "0.4.3-1.tar.gz";
    sha256 = "4548baa3ea13a9780e46c79b2f2dbfca41e5aa7b59f1e2ff1fe8b894a928a86a";
  };
