...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/rolling/automatika_ros_sugar/0.6.0-1.tar.gz";
    name = "0.6.0-1.tar.gz";
    sha256 = "ec4c7e8e0eefdfeddd5dfe54345b2179c6cec99e350e785d553cb5ad2e7952ec";
  };
