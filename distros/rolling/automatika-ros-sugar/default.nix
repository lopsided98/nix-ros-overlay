...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/rolling/automatika_ros_sugar/0.4.2-1.tar.gz";
    name = "0.4.2-1.tar.gz";
    sha256 = "3f829a262ee9bf4868ab83e29ffdb795c74ad06c06b85c47482d2344587ef4a4";
  };
