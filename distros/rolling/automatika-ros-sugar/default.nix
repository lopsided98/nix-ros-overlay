...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/rolling/automatika_ros_sugar/0.4.1-1.tar.gz";
    name = "0.4.1-1.tar.gz";
    sha256 = "c91bc36d8f0da675395dac11baeed69a16cd2b95194c3ca33bb83fd27812eb35";
  };
