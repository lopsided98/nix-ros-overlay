...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/rolling/topic_monitor/0.38.0-1.tar.gz";
    name = "0.38.0-1.tar.gz";
    sha256 = "bdf90eda407bcea9cd8b98c0d692a883c675617e097b7d034d034d004e18cc70";
  };
