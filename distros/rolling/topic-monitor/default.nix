...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/rolling/topic_monitor/0.37.4-1.tar.gz";
    name = "0.37.4-1.tar.gz";
    sha256 = "93cb45a1be4d513929e89dbbbc4f277e0be93054a771e7fb4b8ccb81f5ec8bcc";
  };
