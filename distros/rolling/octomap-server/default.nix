...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/octomap_mapping-release/archive/release/rolling/octomap_server/2.3.1-1.tar.gz";
    name = "2.3.1-1.tar.gz";
    sha256 = "38997c3ed79e3dfbb0b2a6e96a4918abaa58be9d71a8cb03e494bd0019dfa196";
  };
