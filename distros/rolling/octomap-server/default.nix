...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/octomap_mapping-release/archive/release/rolling/octomap_server/2.3.1-2.tar.gz";
    name = "2.3.1-2.tar.gz";
    sha256 = "717d9a990f5a709de35e5698dcf10b5c74cfa652acc0ab2e3c22cf70d4385f61";
  };
