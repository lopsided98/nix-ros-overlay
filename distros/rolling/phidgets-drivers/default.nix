...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/rolling/phidgets_drivers/2.3.4-1.tar.gz";
    name = "2.3.4-1.tar.gz";
    sha256 = "5c458cd2da72bf2eea15187a936858f1a0e15542e292be117135d2935a59a018";
  };
