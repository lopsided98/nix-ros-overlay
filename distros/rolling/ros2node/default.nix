...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2node/0.42.0-1.tar.gz";
    name = "0.42.0-1.tar.gz";
    sha256 = "ab851d05c6089a30141d2788f3d6b7a5bdaa33d794b6eadd2a6ccd34c7f7672d";
  };
