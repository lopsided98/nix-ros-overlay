...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2node/0.32.0-1.tar.gz";
    name = "0.32.0-1.tar.gz";
    sha256 = "4f3868bfd8d284e903a2272032a5f9ef6d6ffe2d550c834c99116e8b6a9a348e";
  };
