...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2node/0.26.0-1.tar.gz";
    name = "0.26.0-1.tar.gz";
    sha256 = "159ffce4e0cc4fcde614d1ef5944ffe210e65066fd42d1b4f4b4ea5779bf26ba";
  };
