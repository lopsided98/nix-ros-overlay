...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2node/0.41.1-1.tar.gz";
    name = "0.41.1-1.tar.gz";
    sha256 = "825f615db3890932a88841bdd2449c07f1faceacc25d5bc22c2e2ab99fe02331";
  };
