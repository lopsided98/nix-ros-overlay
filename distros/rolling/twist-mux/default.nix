...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/twist_mux-release/archive/release/rolling/twist_mux/4.3.0-2.tar.gz";
    name = "4.3.0-2.tar.gz";
    sha256 = "ff9e6d842901f06aad299eb0bc136de8e16940cd8a725fa0f8b019cc7572de70";
  };
