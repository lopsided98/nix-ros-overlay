...
{ lib, buildRosPackage, fetchurl, _unresolved_nodl_python, ament-copyright, ament-flake8, ament-lint-auto, ament-mypy, ament-pep257, ament-pycodestyle, python3Packages, ros-testing, ros2cli, ros2nodl, ros2run, sros2, test-msgs }:
buildRosPackage {
  pname = "ros-rolling-nodl-to-policy";
  version = "1.0.0-r5";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/nodl_to_policy-release/archive/release/rolling/nodl_to_policy/1.0.0-5.tar.gz";
    name = "1.0.0-5.tar.gz";
    sha256 = "90ecd0ebf484b5f58875e191df1eba15f1ad59953bb5a399115eaebfecae68f7";
  };
