...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/system_modes-release/archive/release/rolling/system_modes/0.9.0-6.tar.gz";
    name = "0.9.0-6.tar.gz";
    sha256 = "91ef84039bb6869445ba2aa54ff786ae90f2836215fb5c49fe713cc4439112f4";
  };
