...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_typesupport_introspection_cpp/5.1.0-1.tar.gz";
    name = "5.1.0-1.tar.gz";
    sha256 = "4127960d98cbd748c92480321420ef3305c31ab14bd01860a117dce761b0a1a2";
  };
