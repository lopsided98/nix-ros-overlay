...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_typesupport_introspection_cpp/5.1.1-1.tar.gz";
    name = "5.1.1-1.tar.gz";
    sha256 = "ad17bd5a0affbca3e785145fe3028df020e5b7faa1e7d80e08ca86a3ca83ee82";
  };
