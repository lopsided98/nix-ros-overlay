...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_typesupport_introspection_cpp/5.1.4-2.tar.gz";
    name = "5.1.4-2.tar.gz";
    sha256 = "3de275a82a34f8a7f7d60379aac1adf27accf3e2734208c20ba31c6e319c8bdc";
  };
