...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_typesupport_introspection_cpp/4.9.3-1.tar.gz";
    name = "4.9.3-1.tar.gz";
    sha256 = "7755a76c2bcc998a4b20faee297fb602f011f0013422cb350f7c169a6f575120";
  };
