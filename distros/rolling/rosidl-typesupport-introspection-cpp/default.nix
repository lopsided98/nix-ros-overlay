...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_typesupport_introspection_cpp/4.8.0-1.tar.gz";
    name = "4.8.0-1.tar.gz";
    sha256 = "1095176be42698abc10b19802d405e87a8a4278e20357988bd0cce8cb4da34c6";
  };
