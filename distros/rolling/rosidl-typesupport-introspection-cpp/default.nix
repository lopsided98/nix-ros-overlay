...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_typesupport_introspection_cpp/4.6.0-1.tar.gz";
    name = "4.6.0-1.tar.gz";
    sha256 = "0c6ff18e025cf1e0d80184ae7f3defb63fcf940388223baccbf14b8f38de6f80";
  };
