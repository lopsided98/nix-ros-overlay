...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_typesupport_introspection_cpp/5.1.3-1.tar.gz";
    name = "5.1.3-1.tar.gz";
    sha256 = "64b858ad96b5bc75d32213fcd80481cc78c7de7abea463bd461d322cc1ed2a92";
  };
