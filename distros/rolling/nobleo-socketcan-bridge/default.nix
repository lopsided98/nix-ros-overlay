...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/nobleo_socketcan_bridge-release/archive/release/rolling/nobleo_socketcan_bridge/1.0.4-1.tar.gz";
    name = "1.0.4-1.tar.gz";
    sha256 = "f74c901ab582f24984dcad2f4141eb091c83022618c9674fa56d00088491305a";
  };
