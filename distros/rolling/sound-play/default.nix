...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/audio_common-release/archive/release/rolling/sound_play/0.4.1-1.tar.gz";
    name = "0.4.1-1.tar.gz";
    sha256 = "5b01ff58828692a66d5eabf728cff6e57608fd451d48e6f47f25ff46e12b96de";
  };
