...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_generator_cpp/4.6.0-1.tar.gz";
    name = "4.6.0-1.tar.gz";
    sha256 = "e7e76430e55db4c59e6141a61fb99f9496fde213d298831f1400b223dd2739cd";
  };
