...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_generator_cpp/5.1.4-2.tar.gz";
    name = "5.1.4-2.tar.gz";
    sha256 = "56481c8319f007a890982f05b1dcfda69fe2d609d63da79bd046da4274477115";
  };
