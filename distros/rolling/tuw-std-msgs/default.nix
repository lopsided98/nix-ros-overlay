...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/tuw_msgs-release/archive/release/rolling/tuw_std_msgs/0.2.3-1.tar.gz";
    name = "0.2.3-1.tar.gz";
    sha256 = "f4ac3fe990c6f045d4d581ff92b1db6b5079e2c3aaded5c35f35c1f645091ae5";
  };
