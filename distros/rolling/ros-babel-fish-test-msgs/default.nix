...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_babel_fish-release/archive/release/rolling/ros_babel_fish_test_msgs/5.26.90-1.tar.gz";
    name = "5.26.90-1.tar.gz";
    sha256 = "c5e4aee69284afe59c770d3f3922f85798bef01cca0dabbc6ff3ead84dd0918d";
  };
