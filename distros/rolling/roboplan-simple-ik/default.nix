...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/roboplan-release/archive/release/rolling/roboplan_simple_ik/0.6.1-1.tar.gz";
    name = "0.6.1-1.tar.gz";
    sha256 = "912e95aae60e42b050a1a2cda1a36d303c2f6b16d2eb5be778cd37f8a800636c";
  };
