...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_adapi_msgs-release/archive/release/rolling/autoware_adapi_v1_msgs/1.9.1-1.tar.gz";
    name = "1.9.1-1.tar.gz";
    sha256 = "f33fa94311b9bf7f4afb378142d74386856f66ea0c2f09de8f01b39e19ab692d";
  };
