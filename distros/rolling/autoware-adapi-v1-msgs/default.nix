...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_adapi_msgs-release/archive/release/rolling/autoware_adapi_v1_msgs/1.9.0-2.tar.gz";
    name = "1.9.0-2.tar.gz";
    sha256 = "2119448e9aab154370b6090724f4951a83ee949e60ae3decacdbf20f55eabe0b";
  };
