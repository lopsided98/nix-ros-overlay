...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/control_msgs-release/archive/release/rolling/control_msgs/6.10.0-1.tar.gz";
    name = "6.10.0-1.tar.gz";
    sha256 = "e7a2af108cf1acc896e419a03b86c23150fe61bd96a5c42cdd4795cee724b8a5";
  };
