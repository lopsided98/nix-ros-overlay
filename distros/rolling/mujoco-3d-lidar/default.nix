...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mujoco_ros2_control-release/archive/release/rolling/mujoco_3d_lidar/0.1.1-1.tar.gz";
    name = "0.1.1-1.tar.gz";
    sha256 = "82e5818fab718120b7f35ab732699648fbf1769062c78372c290365397d853b1";
  };
