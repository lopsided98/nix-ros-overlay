...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/aruco_opencv-release/archive/release/rolling/aruco_opencv/4.1.1-1.tar.gz";
    name = "4.1.1-1.tar.gz";
    sha256 = "690d9928a71a122029680af803ec6f89e78c36ae9221cecb548fbb0afc115247";
  };
