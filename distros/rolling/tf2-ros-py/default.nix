...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_ros_py/0.45.3-1.tar.gz";
    name = "0.45.3-1.tar.gz";
    sha256 = "d063f286c750442f02c4a4dc48a3ceecd2afaf38605340510d3e2d58a5bb44d9";
  };
