...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt2-release/archive/release/rolling/mrpt2/2.13.1-1.tar.gz";
    name = "2.13.1-1.tar.gz";
    sha256 = "749e204d828bb4b74cabcdfc6b6d5901538069bec41bbee0b7d171298d3ff0da";
  };
