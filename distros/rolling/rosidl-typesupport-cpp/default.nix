...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_typesupport-release/archive/release/rolling/rosidl_typesupport_cpp/3.5.0-1.tar.gz";
    name = "3.5.0-1.tar.gz";
    sha256 = "5b2ba0bb1064184d0cda95853a98684d697fdc339fc451677fccabb7107ced3b";
  };
