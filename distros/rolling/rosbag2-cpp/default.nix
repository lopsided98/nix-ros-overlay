...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_cpp/0.26.1-1.tar.gz";
    name = "0.26.1-1.tar.gz";
    sha256 = "7fb13f2d233b2dfc3a5b78edcbd1e29d3a8faa644dc4769a96bcde9f277a1cb5";
  };
