...
buildRosPackage {
  pname = "ros-rolling-ros-ign-bridge";
  version = "0.245.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_ign_bridge/0.245.0-1.tar.gz";
    name = "0.245.0-1.tar.gz";
    sha256 = "5c39845a6315b658a7bd092c85168aee6cbc0911ef986b8b1d497b5dbde3f8cd";
  };
