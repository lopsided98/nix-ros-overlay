...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/rolling/mrpt_sensorlib/0.2.0-1.tar.gz";
    name = "0.2.0-1.tar.gz";
    sha256 = "6bbc0e7ab328984bad9b05aa3b6858e07e609d259ef0c1865ce9d23dd77b60d8";
  };
