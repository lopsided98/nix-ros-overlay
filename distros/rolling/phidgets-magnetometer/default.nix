...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/rolling/phidgets_magnetometer/2.3.1-1.tar.gz";
    name = "2.3.1-1.tar.gz";
    sha256 = "6941a311949b1761f98d41441507c3611a727271a26ef039c63b0dea8944378d";
  };
