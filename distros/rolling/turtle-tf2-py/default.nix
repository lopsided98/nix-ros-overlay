...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry_tutorials-release/archive/release/rolling/turtle_tf2_py/0.3.6-4.tar.gz";
    name = "0.3.6-4.tar.gz";
    sha256 = "ba0bed699e2e30640949df091526050d2609b28e56543c44d9daacfa42ba25b1";
  };
