...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_storage_sqlite3/0.20.0-1.tar.gz";
    name = "0.20.0-1.tar.gz";
    sha256 = "ffca0acdc1e6336cd3212405f070521ceea7f276bf02d253a56e20714ee69bcf";
  };
