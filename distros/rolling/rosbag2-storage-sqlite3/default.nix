...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_storage_sqlite3/0.19.0-1.tar.gz";
    name = "0.19.0-1.tar.gz";
    sha256 = "a07ed125e8457c837645abbcff6d859026f629fbad5f95ec0555d0b6cee42a55";
  };
