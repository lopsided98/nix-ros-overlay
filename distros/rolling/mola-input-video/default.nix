...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_input_video/1.9.1-1.tar.gz";
    name = "1.9.1-1.tar.gz";
    sha256 = "6960e7ed80bb01a500019e57c0ed1521a1ddcdd5485c1a19ac0f82ed6d9c07da";
  };
