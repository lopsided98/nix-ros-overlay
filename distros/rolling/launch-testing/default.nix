...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch-release/archive/release/rolling/launch_testing/3.9.7-1.tar.gz";
    name = "3.9.7-1.tar.gz";
    sha256 = "c053d285513f9c0491309e68ffb8db370fbd291b8dedc4413eea10f3237005d5";
  };
