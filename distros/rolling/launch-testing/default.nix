...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch-release/archive/release/rolling/launch_testing/3.9.6-1.tar.gz";
    name = "3.9.6-1.tar.gz";
    sha256 = "dc117fca2aa3d8bba86be0124ebea66c5bfc05f65dafa1a90d7821ffcaf5f719";
  };
