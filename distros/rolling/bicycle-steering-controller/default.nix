...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/bicycle_steering_controller/4.17.0-1.tar.gz";
    name = "4.17.0-1.tar.gz";
    sha256 = "fc13e513faa9cb1aee8c8ba1739be1a6fe442f291bab6c320f0fee0a352e28bc";
  };
