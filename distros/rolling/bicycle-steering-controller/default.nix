...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/bicycle_steering_controller/4.6.0-2.tar.gz";
    name = "4.6.0-2.tar.gz";
    sha256 = "fd0a7281ad3649abf1e21acad1b3b59bc15b21a55044d7593bfd3def94c8e58d";
  };
