...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/bicycle_steering_controller/4.7.0-1.tar.gz";
    name = "4.7.0-1.tar.gz";
    sha256 = "bf0099f9e38a9f313c0f04babc3ea765f6375f3d773ac48fd35960f3dfa95820";
  };
