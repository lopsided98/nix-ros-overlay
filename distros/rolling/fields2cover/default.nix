...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fields2cover-release/archive/release/rolling/fields2cover/2.0.0-17.tar.gz";
    name = "2.0.0-17.tar.gz";
    sha256 = "5e101d628a23f41d11b6d71ef933fd766302b17d32b4e3cc4623a0fda026d4af";
  };
