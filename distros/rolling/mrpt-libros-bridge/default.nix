...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros_bridge-release/archive/release/rolling/mrpt_libros_bridge/3.5.2-2.tar.gz";
    name = "3.5.2-2.tar.gz";
    sha256 = "2dcca63ccb8fd887b253e73087f87c693874fee2faabf0056c47e4c20a00812f";
  };
