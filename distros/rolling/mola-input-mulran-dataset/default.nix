...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_input_mulran_dataset/2.2.1-1.tar.gz";
    name = "2.2.1-1.tar.gz";
    sha256 = "f9f09d10e909fab0f250e55d5aae77abbb9d9581ca7a8a1398c1eaacb5c5a51b";
  };
