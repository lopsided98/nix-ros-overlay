...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_input_mulran_dataset/1.6.1-1.tar.gz";
    name = "1.6.1-1.tar.gz";
    sha256 = "08756d6705da82da952d77b0859958cb46e194152977b12cdcb99819a9f1f346";
  };
