...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_input_mulran_dataset/1.9.0-1.tar.gz";
    name = "1.9.0-1.tar.gz";
    sha256 = "710066950199ea13ef5d4eeb8fe3404c908f13476039bdc97488a03301feb646";
  };
