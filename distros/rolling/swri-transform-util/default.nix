...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/rolling/swri_transform_util/3.7.4-1.tar.gz";
    name = "3.7.4-1.tar.gz";
    sha256 = "18b33199be1cb371bb00fdca7890c0439c62962b1aac7755c236ed64e6e3e154";
  };
