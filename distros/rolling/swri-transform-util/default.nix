...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/rolling/swri_transform_util/3.8.4-1.tar.gz";
    name = "3.8.4-1.tar.gz";
    sha256 = "eddbd60ca4c5cbe55e1d286866112cbb21ed7af13caac34f81b57121c6e94cb8";
  };
