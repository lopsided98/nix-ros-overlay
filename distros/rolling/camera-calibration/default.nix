...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/rolling/camera_calibration/7.1.0-1.tar.gz";
    name = "7.1.0-1.tar.gz";
    sha256 = "943f7296f021b54dced85473dd34d8a404ec05693474c595de51c56b805e3183";
  };
