...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/classic_bags-release/archive/release/rolling/classic_bags/0.4.0-2.tar.gz";
    name = "0.4.0-2.tar.gz";
    sha256 = "fdee201c8f02e512398577c8552e146eff3494fa5558088814888167a30280ed";
  };
