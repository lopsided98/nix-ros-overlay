...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/compass-release/archive/release/rolling/magnetic_model/4.0.1-1.tar.gz";
    name = "4.0.1-1.tar.gz";
    sha256 = "402a61d84ce7c497cb2fa50ae4f1cabb4af4bbc1e6ee9668541bd1b88c72c930";
  };
