...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/random_numbers-release/archive/release/rolling/random_numbers/2.0.4-1.tar.gz";
    name = "2.0.4-1.tar.gz";
    sha256 = "4f7b063c91456618fc13f01f92edaddf30f60150e676c03b0ff1ecd3e1232334";
  };
