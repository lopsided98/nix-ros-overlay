...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_connextdds-release/archive/release/rolling/rmw_connextdds/1.2.3-1.tar.gz";
    name = "1.2.3-1.tar.gz";
    sha256 = "370090015fd74cfcd4aa503cbf9a5f869a942615a4caed24f14cc592689d0eae";
  };
