...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_connextdds-release/archive/release/rolling/rmw_connextdds/0.13.0-1.tar.gz";
    name = "0.13.0-1.tar.gz";
    sha256 = "06c868eb365c1a74b73ba557d8a3590170132dc6e10258141642c779dec92015";
  };
