...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_connextdds-release/archive/release/rolling/rmw_connextdds/1.2.5-1.tar.gz";
    name = "1.2.5-1.tar.gz";
    sha256 = "92b9ff179f8662e5919b085a2a010111fbadc1080dd6702621391f9b60b78321";
  };
