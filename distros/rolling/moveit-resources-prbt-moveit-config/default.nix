...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_resources_prbt_moveit_config/2.8.0-2.tar.gz";
    name = "2.8.0-2.tar.gz";
    sha256 = "87e4d595d8b3a2a8ca8fc415985a854190700d65150fe072a8a28203ae37d58a";
  };
