...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_canopen-release/archive/release/rolling/canopen_tests/0.2.7-1.tar.gz";
    name = "0.2.7-1.tar.gz";
    sha256 = "4b75f8586d1b912f0806969be173aff71b2d59e0ae61b780559efe1708d57667";
  };
