...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_canopen-release/archive/release/rolling/canopen_tests/0.3.2-1.tar.gz";
    name = "0.3.2-1.tar.gz";
    sha256 = "ed00c414ff5b4f28d378f8534dda4409561d2fe06238b381596a05402ea7355b";
  };
