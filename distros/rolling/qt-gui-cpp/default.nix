...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/qt_gui_core-release/archive/release/rolling/qt_gui_cpp/2.7.4-1.tar.gz";
    name = "2.7.4-1.tar.gz";
    sha256 = "dff4b133138cb1a45a05c587dbb1c2529694f279d038b692cb5a437baac16a48";
  };
