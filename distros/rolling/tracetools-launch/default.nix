...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_tracing-release/archive/release/rolling/tracetools_launch/8.2.0-1.tar.gz";
    name = "8.2.0-1.tar.gz";
    sha256 = "bcabfb52148757deef8c5cc282778f60f1341461c8a1deb4ad3107373b9e979e";
  };
