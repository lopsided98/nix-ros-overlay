...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_tracing-release/archive/release/rolling/tracetools_launch/8.0.0-1.tar.gz";
    name = "8.0.0-1.tar.gz";
    sha256 = "0cc4261d7cdac98d1a63c42c77e8de9b375645b71e37bbd3d740f1d1eddf491d";
  };
