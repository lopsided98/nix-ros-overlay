...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/pid_controller/4.12.0-1.tar.gz";
    name = "4.12.0-1.tar.gz";
    sha256 = "30cbdb7a18b5bfe3aac123cf06bb3b7fc9e8104f8ffeaf1641ce4b8506f9b62f";
  };
