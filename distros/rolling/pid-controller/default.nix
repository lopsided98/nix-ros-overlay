...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/pid_controller/4.17.0-1.tar.gz";
    name = "4.17.0-1.tar.gz";
    sha256 = "16fa6580e0e5b16437ed2f166871fa7ae8b06631b7a08c0d831deb6c855f7466";
  };
