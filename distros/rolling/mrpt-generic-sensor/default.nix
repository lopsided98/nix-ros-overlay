...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/rolling/mrpt_generic_sensor/0.2.1-1.tar.gz";
    name = "0.2.1-1.tar.gz";
    sha256 = "50bf578e0d4141cd96239d43a7a211f85dc20bf53e5c3ad3bb7d0f01eb702e00";
  };
