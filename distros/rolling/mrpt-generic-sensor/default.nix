...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/rolling/mrpt_generic_sensor/0.1.0-1.tar.gz";
    name = "0.1.0-1.tar.gz";
    sha256 = "0b1ec3257500dac830191ebd51e0033423b1078f5645ebd718eac7aae25b7407";
  };
