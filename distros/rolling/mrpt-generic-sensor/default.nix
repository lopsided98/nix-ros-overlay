...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/rolling/mrpt_generic_sensor/0.2.4-1.tar.gz";
    name = "0.2.4-1.tar.gz";
    sha256 = "45334dc7818d7217e658f840d7b5745477d0031985aed7e75d6fbfe1542b5cf6";
  };
