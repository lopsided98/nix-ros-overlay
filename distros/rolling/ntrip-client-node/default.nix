...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/rolling/ntrip_client_node/0.5.8-1.tar.gz";
    name = "0.5.8-1.tar.gz";
    sha256 = "0b8acc8e32e766a5912fb89f4a1813e860f6440e42f32884a23e783ce569e30d";
  };
