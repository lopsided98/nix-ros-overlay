...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/rolling/ntrip_client_node/0.6.1-1.tar.gz";
    name = "0.6.1-1.tar.gz";
    sha256 = "d0f88f475a616e1dc1f93a170dc6c80740300478f11079a211fb1f1173e631d8";
  };
