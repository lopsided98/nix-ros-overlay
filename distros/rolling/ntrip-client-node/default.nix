...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/rolling/ntrip_client_node/0.7.0-1.tar.gz";
    name = "0.7.0-1.tar.gz";
    sha256 = "e78d72581af14834c21237558e0aeec83e9b39e87abb849ccd949101dfc9a49d";
  };
