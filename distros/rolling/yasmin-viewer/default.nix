...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/rolling/yasmin_viewer/4.2.3-1.tar.gz";
    name = "4.2.3-1.tar.gz";
    sha256 = "2e22a1d0d5d51f2c6debf1ce293e34fec73e3af413c9120e2aa0961720b436e3";
  };
