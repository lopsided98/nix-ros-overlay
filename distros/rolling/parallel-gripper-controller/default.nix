...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/parallel_gripper_controller/6.2.0-1.tar.gz";
    name = "6.2.0-1.tar.gz";
    sha256 = "f32c09bf2ca68619ce687ffb887b2deb9575185707df4a50de3aa1bf142d9262";
  };
