...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libgui/2.15.16-1.tar.gz";
    name = "2.15.16-1.tar.gz";
    sha256 = "937c7753d768108344db55261d056e8449c8b830a428f02cdd2eb3c0fef6f1fa";
  };
