...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw-release/archive/release/rolling/rmw_security_common/7.11.2-1.tar.gz";
    name = "7.11.2-1.tar.gz";
    sha256 = "50abd9082ce8377ad222e40351d13c93209c915aab8570f45eac9fcb586ed99a";
  };
