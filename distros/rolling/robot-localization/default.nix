...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/robot_localization-release/archive/release/rolling/robot_localization/3.5.0-2.tar.gz";
    name = "3.5.0-2.tar.gz";
    sha256 = "a2becc6a97274cc05d42737677015020bf754f33d81ef142851d07871254f702";
  };
