...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rc_genicam_api-release/archive/release/rolling/rc_genicam_api/2.8.1-1.tar.gz";
    name = "2.8.1-1.tar.gz";
    sha256 = "0dc92b68d67fe1acec7db5e973a68055a3a385103ba7c74d1fe7df8a9105bb88";
  };
