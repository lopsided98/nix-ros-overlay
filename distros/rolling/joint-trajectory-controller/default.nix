...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/joint_trajectory_controller/4.12.0-1.tar.gz";
    name = "4.12.0-1.tar.gz";
    sha256 = "fffb4034a5b3be5b582a2d706bc39408f60f1439ae7f9fb3b83cad300fbefe2e";
  };
