...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/joint_trajectory_controller/6.6.0-2.tar.gz";
    name = "6.6.0-2.tar.gz";
    sha256 = "eea340f96584827ba700aa378cb42d5fbc8d9848f96720a45c45bb6ddacf0aac";
  };
