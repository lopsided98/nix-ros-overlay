...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/ros2controlcli/6.3.1-1.tar.gz";
    name = "6.3.1-1.tar.gz";
    sha256 = "8436904db3bce1f2b9ba4316540fc900c93def582cc69e5d4838127a0b0602b2";
  };
