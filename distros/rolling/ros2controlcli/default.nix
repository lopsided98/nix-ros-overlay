...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/ros2controlcli/6.0.1-1.tar.gz";
    name = "6.0.1-1.tar.gz";
    sha256 = "0f725511ceb6323fe697ed0f46d7c61e8c04ce3e004dda33569411a1c63ac88f";
  };
