...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/ros2controlcli/6.0.2-1.tar.gz";
    name = "6.0.2-1.tar.gz";
    sha256 = "faa6eac9821e3f77ed79af6d62e52ca29cbe73e4c916af3caa1c65bad9cfd673";
  };
