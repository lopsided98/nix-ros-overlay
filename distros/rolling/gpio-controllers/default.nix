...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/gpio_controllers/6.3.0-1.tar.gz";
    name = "6.3.0-1.tar.gz";
    sha256 = "eed4d1e266695def4f79f28930bc1956f281269d898aee3c27c2207005df35bf";
  };
