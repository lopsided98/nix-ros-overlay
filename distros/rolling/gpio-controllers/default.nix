...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/gpio_controllers/4.17.0-1.tar.gz";
    name = "4.17.0-1.tar.gz";
    sha256 = "113a1e4ed014ee0ee56100340f5925b3ca73b1c9bc26b9a5bf7054d52b0a0803";
  };
