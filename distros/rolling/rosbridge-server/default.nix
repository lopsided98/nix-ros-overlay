...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/rolling/rosbridge_server/4.0.0-1.tar.gz";
    name = "4.0.0-1.tar.gz";
    sha256 = "b258f398e4f94eea56ba52ac8eafa158eadb214c04dcadbe6f1436df87e946ea";
  };
