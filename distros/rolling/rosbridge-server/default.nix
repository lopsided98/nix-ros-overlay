...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/rolling/rosbridge_server/3.0.0-1.tar.gz";
    name = "3.0.0-1.tar.gz";
    sha256 = "dbc8d4fa3760d333f3cfa09dca535315cc8b998c6cd596ce3055d235f2a076a6";
  };
