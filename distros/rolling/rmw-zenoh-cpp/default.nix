...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_zenoh-release/archive/release/rolling/rmw_zenoh_cpp/0.10.0-1.tar.gz";
    name = "0.10.0-1.tar.gz";
    sha256 = "70f86940a2b04b2f4d20642b4baf913e6ca6afa705dd740b514d23550ebc8238";
  };
