...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_zenoh-release/archive/release/rolling/rmw_zenoh_cpp/0.8.0-1.tar.gz";
    name = "0.8.0-1.tar.gz";
    sha256 = "263d4a48f100efc1c12d8351fe7b68b7af1b03a8d3ef3b8a09d079db2473ebd8";
  };
