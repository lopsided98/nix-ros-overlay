...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2interface/0.41.1-1.tar.gz";
    name = "0.41.1-1.tar.gz";
    sha256 = "d8598957b9cef94c6a93cebd903ed9a2fa6c69943e4be92f8a1abb17e15d34bd";
  };
