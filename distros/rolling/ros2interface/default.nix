...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2interface/0.40.4-1.tar.gz";
    name = "0.40.4-1.tar.gz";
    sha256 = "69bef0f97c596c4ae660d82b60cf462549360ad41e0e458a0aae1ed1cd632691";
  };
