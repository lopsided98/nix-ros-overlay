...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2interface/0.26.0-1.tar.gz";
    name = "0.26.0-1.tar.gz";
    sha256 = "f55d667542784f8b2560c750f83756b06301eab79aaf682782c36220d77f49fb";
  };
