...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2interface/0.39.2-1.tar.gz";
    name = "0.39.2-1.tar.gz";
    sha256 = "0b8c346606e0ee380024f6ce84f8febcc903084d43aa6de43dba73f189146231";
  };
