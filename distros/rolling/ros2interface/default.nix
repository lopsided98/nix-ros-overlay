...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2interface/0.32.0-1.tar.gz";
    name = "0.32.0-1.tar.gz";
    sha256 = "5eaf5211544542e17cb0d949e07e006dd6ce21a29f633e0785e4f6ca917cff49";
  };
