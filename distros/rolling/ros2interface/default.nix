...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2interface/0.42.0-1.tar.gz";
    name = "0.42.0-1.tar.gz";
    sha256 = "cf71e6fac1aa4ba24961ee760943b752987d804d60c4e2bd0fa4dd136a5036af";
  };
