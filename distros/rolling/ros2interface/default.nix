...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2interface/0.39.1-1.tar.gz";
    name = "0.39.1-1.tar.gz";
    sha256 = "3d1cadaa6dcd31e07a9b0faf9359e24a611ac316841e1c065cabadca5ac4d4e2";
  };
