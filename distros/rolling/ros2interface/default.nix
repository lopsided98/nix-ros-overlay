...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2interface/0.41.0-1.tar.gz";
    name = "0.41.0-1.tar.gz";
    sha256 = "91c679df14cd014e52e9db4b617576a57a0443f8cb08f6e2946654fa1b5b5116";
  };
