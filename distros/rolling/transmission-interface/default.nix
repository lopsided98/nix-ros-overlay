...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/transmission_interface/6.0.2-1.tar.gz";
    name = "6.0.2-1.tar.gz";
    sha256 = "3d44e5d8aca9209e19c7822ebd509db71e61c07f159c1a11d1a85ae6d1e1ede0";
  };
