...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/rolling/transmission_interface/6.7.1-1.tar.gz";
    name = "6.7.1-1.tar.gz";
    sha256 = "0a0925f70737b809613e92bcecb888eed3d3539dfe49abad6f11fcdc0983add5";
  };
