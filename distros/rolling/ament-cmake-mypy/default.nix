...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_cmake_mypy/0.20.4-1.tar.gz";
    name = "0.20.4-1.tar.gz";
    sha256 = "e32551432eec1bf3327a455ae90f6f0aaff4b19d8a9ed25ee1ff317a7747208a";
  };
