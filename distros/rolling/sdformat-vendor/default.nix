...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/sdformat_vendor-release/archive/release/rolling/sdformat_vendor/0.3.3-2.tar.gz";
    name = "0.3.3-2.tar.gz";
    sha256 = "2f796dbd662a5d5724bf98a088d85546ff3d9386f7c526850e9aef56754e4a23";
  };
