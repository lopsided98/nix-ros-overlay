...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/sdformat_vendor-release/archive/release/rolling/sdformat_vendor/0.4.0-1.tar.gz";
    name = "0.4.0-1.tar.gz";
    sha256 = "5c67e06d92426744c20436ca62fea3c9a576ca612f1a1637805b0c796bb17fc6";
  };
