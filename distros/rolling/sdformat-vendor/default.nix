...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/sdformat_vendor-release/archive/release/rolling/sdformat_vendor/0.1.1-1.tar.gz";
    name = "0.1.1-1.tar.gz";
    sha256 = "b78b59abd453dadbe685a4cc51a344841b43f153047731990eec817f98a8bc76";
  };
  ...
  meta = {
    description = "Vendor package for: sdformat14 14.2.0
