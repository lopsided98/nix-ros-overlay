...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/rolling/tile_map/2.5.6-1.tar.gz";
    name = "2.5.6-1.tar.gz";
    sha256 = "7eb3f4100c961ac8c828e09ad52759e5f9a26b0dde4939f44a9706ea21943070";
  };
