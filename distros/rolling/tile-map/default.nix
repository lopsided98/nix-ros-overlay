...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/rolling/tile_map/2.6.1-1.tar.gz";
    name = "2.6.1-1.tar.gz";
    sha256 = "a50b6beb470c5e40356702c432d1df09abce17414999f751ff4b30adf333fe70";
  };
