...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/rolling/autoware_utils_system/1.7.2-1.tar.gz";
    name = "1.7.2-1.tar.gz";
    sha256 = "311042c5402435b86e443c8565e3f3e130209e09aa298dd777f9b68c1f1ab7c5";
  };
