...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/rolling/autoware_utils_system/1.4.2-2.tar.gz";
    name = "1.4.2-2.tar.gz";
    sha256 = "45690c2d4a539cc259d64bdca4687da79c4863a89c655a8eff12102f634628f6";
  };
