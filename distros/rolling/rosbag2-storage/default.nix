...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_storage/0.33.1-2.tar.gz";
    name = "0.33.1-2.tar.gz";
    sha256 = "a9a27dcef6f77421cae5be3b9b5fdd09d50bbd3aeace6707f957f7e525478991";
  };
