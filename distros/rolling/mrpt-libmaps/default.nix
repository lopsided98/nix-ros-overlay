...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libmaps/2.15.16-1.tar.gz";
    name = "2.15.16-1.tar.gz";
    sha256 = "c2110786e936218cf9252f40dea342b62506ad54d9a5823d30625d67fff310ba";
  };
