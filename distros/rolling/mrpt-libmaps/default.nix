...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libmaps/2.14.10-1.tar.gz";
    name = "2.14.10-1.tar.gz";
    sha256 = "f06f30f47fce416cf433ae41ddd3a534f21773d9696626bcbda353df89a91f05";
  };
