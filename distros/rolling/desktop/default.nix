...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/variants-release/archive/release/rolling/desktop/0.13.0-2.tar.gz";
    name = "0.13.0-2.tar.gz";
    sha256 = "ebd991af189343a060079c9e0b56b9e4a8f7a6cb469040320306c0523716a256";
  };
