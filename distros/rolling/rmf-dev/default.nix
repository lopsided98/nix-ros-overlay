...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_variants-release/archive/release/rolling/rmf_dev/0.0.1-1.tar.gz";
    name = "0.0.1-1.tar.gz";
    sha256 = "8a506462a9780cb0af5cdbfe1db8fd4a636d52eed0754fe24a0d97d579020415";
  };
