...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/rolling/autoware_utils_pcl/1.4.2-2.tar.gz";
    name = "1.4.2-2.tar.gz";
    sha256 = "413dca03addacfed99e0d90ad5d4344da35bfe55e8612e0ea12aeaa8f3c7fe30";
  };
