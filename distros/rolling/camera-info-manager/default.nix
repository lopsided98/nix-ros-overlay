...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_common-release/archive/release/rolling/camera_info_manager/6.3.0-1.tar.gz";
    name = "6.3.0-1.tar.gz";
    sha256 = "5f2b56c6b4aec99204ca8f1502b500fe0f9f10db822fa7088e09559b294485ef";
  };
