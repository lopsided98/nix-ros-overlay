...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_common-release/archive/release/rolling/camera_info_manager/5.1.2-1.tar.gz";
    name = "5.1.2-1.tar.gz";
    sha256 = "50facadd6fbbeeba3213c39a529613e71b33e4652874072a9cef689da26fc50f";
  };
