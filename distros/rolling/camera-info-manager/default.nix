...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_common-release/archive/release/rolling/camera_info_manager/6.4.2-1.tar.gz";
    name = "6.4.2-1.tar.gz";
    sha256 = "0c4d79fba3990807e1454efbf77092838707439cd49df12d443c83fca002512b";
  };
