...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_common-release/archive/release/rolling/camera_info_manager/6.4.7-1.tar.gz";
    name = "6.4.7-1.tar.gz";
    sha256 = "2f9082eb4a1baef03b52020c5caa0482b6c28236a05e8fc541d4da195e5ffa6b";
  };
