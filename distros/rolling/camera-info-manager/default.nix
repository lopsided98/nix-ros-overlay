...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_common-release/archive/release/rolling/camera_info_manager/6.4.7-2.tar.gz";
    name = "6.4.7-2.tar.gz";
    sha256 = "78552aed6dcf45e219bde22e4efaf0660656abc3154e989e4c8a59fd4810fda8";
  };
