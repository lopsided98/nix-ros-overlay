...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2topic/0.26.0-1.tar.gz";
    name = "0.26.0-1.tar.gz";
    sha256 = "a3687311a6bfea6f4b6758dcbd1efe57dca6963a116ae3f9963d9fe22052ca07";
  };
