...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2topic/0.23.0-1.tar.gz";
    name = "0.23.0-1.tar.gz";
    sha256 = "53551a5a8c295cb2eddebc1772637b0476d4e4f148fedbe0d1de4e0c9535bbf8";
  };
