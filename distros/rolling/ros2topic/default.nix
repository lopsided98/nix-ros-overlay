...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2topic/0.39.1-1.tar.gz";
    name = "0.39.1-1.tar.gz";
    sha256 = "b6572dd61cb12f4131e78c9e5b0c103d758d6314d4d81c64e4ce11c82ad50bec";
  };
