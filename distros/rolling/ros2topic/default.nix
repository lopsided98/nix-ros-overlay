...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2topic/0.40.2-1.tar.gz";
    name = "0.40.2-1.tar.gz";
    sha256 = "93ec7f35491f199e64108c4dd9da758d30572a5647d11de106671e2c368ed4c9";
  };
