...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gc_spl-release/archive/release/rolling/rcgcrd_spl_4_conversion/4.0.0-1.tar.gz";
    name = "4.0.0-1.tar.gz";
    sha256 = "d5c318daa468ffa702a84540232b0a3eb0279d80bb03703fd532ff3c02ea8c3f";
  };
