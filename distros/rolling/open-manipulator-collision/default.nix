...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/rolling/open_manipulator_collision/4.0.6-1.tar.gz";
    name = "4.0.6-1.tar.gz";
    sha256 = "54780ef2231827f6ead1318d56e83cb8b39289497ff22c92be89e22bc904d90d";
  };
