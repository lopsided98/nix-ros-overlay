...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclpy-release/archive/release/rolling/rclpy/3.10.0-1.tar.gz";
    name = "3.10.0-1.tar.gz";
    sha256 = "99eda76c4d6ead4983c7a5953b7fa8a8d7911566e71285baa9f1d19a88d2a22f";
  };
