...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclpy-release/archive/release/rolling/rclpy/10.0.5-1.tar.gz";
    name = "10.0.5-1.tar.gz";
    sha256 = "89a880818e5e0026c48d3ed217bd176ca451307602e23f7efa1d5c73b305fa81";
  };
