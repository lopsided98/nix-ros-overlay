...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclpy-release/archive/release/rolling/rclpy/10.0.9-2.tar.gz";
    name = "10.0.9-2.tar.gz";
    sha256 = "57ac092f3346c1860a7ee460220ed464ed652cb90fb88b4394129bde1fb73dfa";
  };
