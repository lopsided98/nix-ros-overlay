...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclpy-release/archive/release/rolling/rclpy/7.3.0-1.tar.gz";
    name = "7.3.0-1.tar.gz";
    sha256 = "88e73ee3cfc154b59154a7c276b1b2aea725a41fa2d2b622cf370f85ad178b7a";
  };
