...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclpy-release/archive/release/rolling/rclpy/4.2.0-1.tar.gz";
    name = "4.2.0-1.tar.gz";
    sha256 = "b22275947ed6438a028be4452fdbd16eeec5d921d4753d691c743fc5bf8ec7ba";
  };
