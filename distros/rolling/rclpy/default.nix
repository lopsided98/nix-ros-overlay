...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclpy-release/archive/release/rolling/rclpy/10.0.7-1.tar.gz";
    name = "10.0.7-1.tar.gz";
    sha256 = "c3ed0868d61e74ffcba864add74423ee34d6452a7b5422b688dbcff3809041cc";
  };
