...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclpy-release/archive/release/rolling/rclpy/11.0.2-1.tar.gz";
    name = "11.0.2-1.tar.gz";
    sha256 = "77a53c555a3779d890d441c82de93b9a6bad555c39b213d0037262320403fbd9";
  };
