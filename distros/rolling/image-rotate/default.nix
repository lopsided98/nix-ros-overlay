...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/rolling/image_rotate/8.0.0-1.tar.gz";
    name = "8.0.0-1.tar.gz";
    sha256 = "ba48c03d59eb586dde85c480c855f4d1a1a8aee0c6c77de6594dc9a6fd4c8fab";
  };
