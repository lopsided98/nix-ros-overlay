...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/kdl_parser-release/archive/release/rolling/kdl_parser/2.8.2-1.tar.gz";
    name = "2.8.2-1.tar.gz";
    sha256 = "f22ded43425259e2d52c8e5670db7b72705213c74f62af0798c6019738572f76";
  };
