...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_eigen_kdl/0.45.6-1.tar.gz";
    name = "0.45.6-1.tar.gz";
    sha256 = "bcf45fce15eea130ee68928b60556198ce62cd898bd0c7bd3c87a43241dc6e49";
  };
