...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_eigen_kdl/0.45.7-1.tar.gz";
    name = "0.45.7-1.tar.gz";
    sha256 = "ceb2a4c2c3596b78ef5af1208fd362dba910eb58827b1a09fe73cb5ef3e975cd";
  };
