...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_performance_benchmarking_msgs/0.33.1-2.tar.gz";
    name = "0.33.1-2.tar.gz";
    sha256 = "c4510ab681d01fa2f1d6de6fa779e1575209b4059e173fc69e85fe378573ea41";
  };
