...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_performance_benchmarking_msgs/0.35.0-1.tar.gz";
    name = "0.35.0-1.tar.gz";
    sha256 = "2a1de5e229c5f86c14956db02d69a84279871d2395b86d59ba0fb4537e0993e9";
  };
