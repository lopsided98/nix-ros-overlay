...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_bullet/0.46.4-1.tar.gz";
    name = "0.46.4-1.tar.gz";
    sha256 = "5adcb5eaf05fdce0b2f54dd66313f5fc62ba7cac0bd0a8c8a757ba11be1df2e9";
  };
