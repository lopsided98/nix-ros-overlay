...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/cras_ros_utils-release/archive/release/rolling/cras_topic_tools/4.0.2-1.tar.gz";
    name = "4.0.2-1.tar.gz";
    sha256 = "27c50b1372abebbf3107f0097325d8df35eed7a476edf8d94d0f96326085e414";
  };
