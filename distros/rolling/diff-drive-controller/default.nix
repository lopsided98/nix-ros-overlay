...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/diff_drive_controller/4.7.0-1.tar.gz";
    name = "4.7.0-1.tar.gz";
    sha256 = "c16ce704bccdf84807d185cb8659354bbe2639af37475225178fdefb0102f0c2";
  };
