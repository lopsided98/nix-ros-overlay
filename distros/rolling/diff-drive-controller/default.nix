...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/diff_drive_controller/6.3.0-1.tar.gz";
    name = "6.3.0-1.tar.gz";
    sha256 = "2d641d56d727c5236044e459f1a54c59bd8aa222817ec4f58d5fcef43220e34e";
  };
