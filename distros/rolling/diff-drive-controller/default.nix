...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/diff_drive_controller/4.6.0-2.tar.gz";
    name = "4.6.0-2.tar.gz";
    sha256 = "e77c28a9c7036eed9fbf4051ef9e32ff537a567fb685beed6d14b3ad01184f66";
  };
