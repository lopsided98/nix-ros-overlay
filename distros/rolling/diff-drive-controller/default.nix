...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/diff_drive_controller/4.2.0-1.tar.gz";
    name = "4.2.0-1.tar.gz";
    sha256 = "059fb9ce963b5f6c86b435465a47d8f5f2dc61a0648417c890c36bd71f304a82";
  };
