...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/rolling/mrpt_tps_astar_planner/2.4.0-2.tar.gz";
    name = "2.4.0-2.tar.gz";
    sha256 = "d80842a426e03ba0e9fc7bd51a71d5c9dc3e77152dd9a285a133b31136aca775";
  };
