...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/rolling/autoware_utils_visualization/1.4.2-2.tar.gz";
    name = "1.4.2-2.tar.gz";
    sha256 = "8023fd9a6d565f90cd3b5a7707a52cb5380d24f9b328463938bd32763b606197";
  };
