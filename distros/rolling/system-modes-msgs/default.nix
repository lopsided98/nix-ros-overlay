...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/system_modes-release/archive/release/rolling/system_modes_msgs/0.9.0-6.tar.gz";
    name = "0.9.0-6.tar.gz";
    sha256 = "63c6cf44b701d276091837aa972445afb5d4705366f900061ffb9a892ed8f3fc";
  };
