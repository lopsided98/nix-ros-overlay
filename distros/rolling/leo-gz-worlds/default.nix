...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/leo_simulator-release/archive/release/rolling/leo_gz_worlds/2.0.2-2.tar.gz";
    name = "2.0.2-2.tar.gz";
    sha256 = "d143a8e55b791b18a58af59d8649ab1550b007fd30ff2c67510bbdcf6f1f8ff0";
  };
