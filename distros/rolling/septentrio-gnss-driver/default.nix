...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/septentrio_gnss_driver_ros2-release/archive/release/rolling/septentrio_gnss_driver/1.4.8-3.tar.gz";
    name = "1.4.8-3.tar.gz";
    sha256 = "5d5ee80c2bdb5435d2eb85ec46f152aabf7b1df117e009e6b0499441cfb5a51e";
  };
