...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/septentrio_gnss_driver_ros2-release/archive/release/rolling/septentrio_gnss_driver/1.4.2-1.tar.gz";
    name = "1.4.2-1.tar.gz";
    sha256 = "f2ded09f919cb78be201ec0340d76c134d44f90309ac7645315af1c608160665";
  };
