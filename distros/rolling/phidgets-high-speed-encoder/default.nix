...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/rolling/phidgets_high_speed_encoder/2.3.4-1.tar.gz";
    name = "2.3.4-1.tar.gz";
    sha256 = "431e8e390de03eeb328fda3efedfbfc038c3adf82bb68e4d1a049f191a37566e";
  };
