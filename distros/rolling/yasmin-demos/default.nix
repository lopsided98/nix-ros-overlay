...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/rolling/yasmin_demos/4.0.2-1.tar.gz";
    name = "4.0.2-1.tar.gz";
    sha256 = "26bbe66a49d2195dbffafd2307c3074538627525af473a1027027747cb407feb";
  };
