...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/rolling/yasmin_demos/4.2.4-1.tar.gz";
    name = "4.2.4-1.tar.gz";
    sha256 = "375ae254a0674cb4ff8b800beeb5583bd584d2899587bed4c197c96006c6eaad";
  };
