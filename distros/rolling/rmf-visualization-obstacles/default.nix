...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_visualization-release/archive/release/rolling/rmf_visualization_obstacles/2.4.2-1.tar.gz";
    name = "2.4.2-1.tar.gz";
    sha256 = "713c624a5440123b0afaca84db8abc89be8668bfd7c8833f3820540b4af91812";
  };
