...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_visualization-release/archive/release/rolling/rmf_visualization_obstacles/2.5.1-1.tar.gz";
    name = "2.5.1-1.tar.gz";
    sha256 = "acc66ee42523aa922a50c0e120790aeb4b59df967f147db18f19d44e293a3a04";
  };
