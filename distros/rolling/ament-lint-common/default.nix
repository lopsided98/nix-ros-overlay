...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_lint_common/0.20.4-1.tar.gz";
    name = "0.20.4-1.tar.gz";
    sha256 = "8b232ce3b096bb1ecf7566fd2fb3af5a0a5811ad04d51cd15d5b893aa047871a";
  };
