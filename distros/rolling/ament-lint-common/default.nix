...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_lint_common/0.21.2-1.tar.gz";
    name = "0.21.2-1.tar.gz";
    sha256 = "881b21ee006fe184662a9c42ccd641f2c5f8d09869fd70b285f4579efc40b941";
  };
