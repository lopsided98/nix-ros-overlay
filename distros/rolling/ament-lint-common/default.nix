...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_lint_common/0.17.0-1.tar.gz";
    name = "0.17.0-1.tar.gz";
    sha256 = "fb70def395470849d573721228cdd3a5377478a60f3e6858c729c203864d6251";
  };
