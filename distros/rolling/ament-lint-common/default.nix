...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_lint_common/0.20.5-3.tar.gz";
    name = "0.20.5-3.tar.gz";
    sha256 = "e87985b8240d6247fb55da7e1b1b04673e4c72a796a9c458f4eca682e94abe45";
  };
