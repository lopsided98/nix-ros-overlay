...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_lint_common/0.15.0-1.tar.gz";
    name = "0.15.0-1.tar.gz";
    sha256 = "a3d54dfa04d93a97adfc7f07621d5c733d9a5625c27636c654369b9a88ab83ed";
  };
