...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gz_physics_vendor-release/archive/release/rolling/gz_physics_vendor/0.5.2-1.tar.gz";
    name = "0.5.2-1.tar.gz";
    sha256 = "cdd527d8ff6ca60a6968cfdfa06a0f8f96c7fa411ee11bd7c65990491fc46699";
  };
