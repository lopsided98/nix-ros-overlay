...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gz_physics_vendor-release/archive/release/rolling/gz_physics_vendor/0.4.3-1.tar.gz";
    name = "0.4.3-1.tar.gz";
    sha256 = "294283b2070b7cc9b7cf2034204e2b96c140a7c1afa116b8333eaa08356466d2";
  };
