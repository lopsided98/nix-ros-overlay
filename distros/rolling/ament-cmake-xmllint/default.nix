...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_cmake_xmllint/0.20.4-1.tar.gz";
    name = "0.20.4-1.tar.gz";
    sha256 = "4e206e404377556795cef0181c0892b915ddc5797976665d586a0fe068a1c156";
  };
