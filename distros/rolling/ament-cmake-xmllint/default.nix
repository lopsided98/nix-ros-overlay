...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_cmake_xmllint/0.20.3-1.tar.gz";
    name = "0.20.3-1.tar.gz";
    sha256 = "5999bfb63574f883f6361bcb01fabcb3116ca55d48a18d832614223d5e99cdef";
  };
