...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_cmake_xmllint/0.17.0-1.tar.gz";
    name = "0.17.0-1.tar.gz";
    sha256 = "0a78fe21ef307da1edcc2df24c3fb4f10e7e75fd1bb73bb598612b4e032fdeda";
  };
