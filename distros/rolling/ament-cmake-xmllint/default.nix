...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_cmake_xmllint/0.20.1-1.tar.gz";
    name = "0.20.1-1.tar.gz";
    sha256 = "a2ff60fc315f2d87f3aa95a75c07bab6975922b87f85aa0be0d150d61bdb5a61";
  };
