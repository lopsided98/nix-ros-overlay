...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/realsense-ros-release/archive/release/rolling/realsense2_camera_msgs/4.56.4-3.tar.gz";
    name = "4.56.4-3.tar.gz";
    sha256 = "ecbe0a9c29761f1844e3ca91cd35219694665968cf30b5d65ad9dbebf7f0e396";
  };
