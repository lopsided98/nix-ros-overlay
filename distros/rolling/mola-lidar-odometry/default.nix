...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_lidar_odometry-release/archive/release/rolling/mola_lidar_odometry/0.7.3-1.tar.gz";
    name = "0.7.3-1.tar.gz";
    sha256 = "a51c23664307b5b82027fd315d4547ed360c3984bf9c3b1dcf11b7b2428b14e0";
  };
