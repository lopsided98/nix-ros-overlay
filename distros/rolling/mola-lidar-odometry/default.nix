...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_lidar_odometry-release/archive/release/rolling/mola_lidar_odometry/1.0.0-1.tar.gz";
    name = "1.0.0-1.tar.gz";
    sha256 = "f216324375e3d2be682fe7b1551f30b30c3bf53ee5fc0f2a4dd6ad4607e7ff94";
  };
