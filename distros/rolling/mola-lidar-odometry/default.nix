...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_lidar_odometry-release/archive/release/rolling/mola_lidar_odometry/1.3.0-1.tar.gz";
    name = "1.3.0-1.tar.gz";
    sha256 = "998c0c38804f43c1e7b95c50c3ebc0968c767ae0bb1f13fd146818be1a1d6fd8";
  };
