...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/rolling/mapviz/2.6.3-4.tar.gz";
    name = "2.6.3-4.tar.gz";
    sha256 = "16adf4631fff96097e7285685c63c625467ee405618624381a9010528debb7d7";
  };
