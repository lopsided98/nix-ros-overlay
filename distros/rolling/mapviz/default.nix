...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/rolling/mapviz/2.4.7-1.tar.gz";
    name = "2.4.7-1.tar.gz";
    sha256 = "b3cccbe1087eae04c1feb55eac021462fc4fa87003abed9c8cb3de4063a4d6cb";
  };
