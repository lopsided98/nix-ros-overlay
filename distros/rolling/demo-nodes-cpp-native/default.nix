...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/rolling/demo_nodes_cpp_native/0.37.5-1.tar.gz";
    name = "0.37.5-1.tar.gz";
    sha256 = "439afd8500b4095516a683ab4a8648526a8e192048d4ac1c312c662609330ced";
  };
