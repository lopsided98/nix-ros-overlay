...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/rolling/ros2launch/0.23.0-1.tar.gz";
    name = "0.23.0-1.tar.gz";
    sha256 = "c4e3b0b888c4ea09d19cc26fc9d66848ea446109812d0629211e4fc3f1a7d47f";
  };
