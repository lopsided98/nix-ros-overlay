...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/rolling/ros2launch/0.30.1-1.tar.gz";
    name = "0.30.1-1.tar.gz";
    sha256 = "51734e0af462ad3d16be2e49604aa193e5f82d60ce166c7966de8b46ee1c8f46";
  };
