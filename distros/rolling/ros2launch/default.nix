...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/rolling/ros2launch/0.29.2-1.tar.gz";
    name = "0.29.2-1.tar.gz";
    sha256 = "83d7b2909c027a5399b83197ce958e915af88773ca16757be2517add91a07a59";
  };
