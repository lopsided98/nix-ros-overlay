...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/rolling/ros2launch/0.30.0-1.tar.gz";
    name = "0.30.0-1.tar.gz";
    sha256 = "3fbc82b22528b2dc430ac4581d2225272d42d44520aa92264fabd00bbcecd507";
  };
