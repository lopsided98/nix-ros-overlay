...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/rolling/ros2launch/0.29.5-1.tar.gz";
    name = "0.29.5-1.tar.gz";
    sha256 = "1c173f176afab29325a046297dfc0987e61af7337e9aad352800265852f3b3ed";
  };
