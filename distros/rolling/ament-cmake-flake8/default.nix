...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_cmake_flake8/0.14.0-1.tar.gz";
    name = "0.14.0-1.tar.gz";
    sha256 = "782414a7f8215046ebe7fa2e7ea15886a16cdbeb65339f59bfa71f4c429fdcf5";
  };
