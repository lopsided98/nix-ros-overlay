...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_cmake_flake8/0.20.2-1.tar.gz";
    name = "0.20.2-1.tar.gz";
    sha256 = "743a0fdad79b3f641556cab7f23eb31f9e0c01331c336cc4f6ea11629765c0d7";
  };
