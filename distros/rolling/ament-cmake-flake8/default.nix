...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_cmake_flake8/0.17.0-1.tar.gz";
    name = "0.17.0-1.tar.gz";
    sha256 = "67edcd326abe3fadeb369a7578e7289a018435cecc6a670ce99105fb0f2dd718";
  };
