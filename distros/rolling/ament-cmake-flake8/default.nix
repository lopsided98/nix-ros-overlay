...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_cmake_flake8/0.15.0-1.tar.gz";
    name = "0.15.0-1.tar.gz";
    sha256 = "8a299267c24cb4461ec4cabae70600be83d52113eb10990971b790756a4d30fd";
  };
