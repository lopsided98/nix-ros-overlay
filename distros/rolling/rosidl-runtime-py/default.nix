...
{ lib, buildRosPackage, fetchurl, _unresolved_rosidl_buffer_py, ament-copyright, ament-flake8, ament-pep257, ament-xmllint, python3Packages, rosidl-parser, std-msgs, std-srvs, test-msgs }:
buildRosPackage {
  ...
  propagatedBuildInputs = [ _unresolved_rosidl_buffer_py python3Packages.numpy python3Packages.pyyaml rosidl-parser ];
