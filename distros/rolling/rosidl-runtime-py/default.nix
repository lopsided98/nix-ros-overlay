...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_runtime_py-release/archive/release/rolling/rosidl_runtime_py/0.13.0-1.tar.gz";
    name = "0.13.0-1.tar.gz";
    sha256 = "c3ef5d8320703114f3819ea6dede9d4ea9df662b5066ecf7ef1da139f10d3478";
  };
