...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/gps_sensor_broadcaster/6.3.0-1.tar.gz";
    name = "6.3.0-1.tar.gz";
    sha256 = "a0c527b97f2e3d86874abfb65fc1f4bab35089b0ba34fc7447567e8c8a031de3";
  };
