...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_formatters/1.2.1-5.tar.gz";
    name = "1.2.1-5.tar.gz";
    sha256 = "a53825cdd0fd650868a54e443be27816b2755bb674a3b526f5c9096b6c9f6c10";
  };
