...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_rust-release/archive/release/rolling/rosidl_generator_rs/0.4.10-1.tar.gz";
    name = "0.4.10-1.tar.gz";
    sha256 = "2abd22c79a869272cc92f496db4318708678add092becad6bdb2e38dbf587efe";
  };
