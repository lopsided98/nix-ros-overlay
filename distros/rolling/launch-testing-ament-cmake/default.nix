...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch-release/archive/release/rolling/launch_testing_ament_cmake/3.9.3-1.tar.gz";
    name = "3.9.3-1.tar.gz";
    sha256 = "5bd387d1bbc703969e93440623df331a52ae847a22a796fa9a499095c4304eba";
  };
