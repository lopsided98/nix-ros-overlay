...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-navigation/nav2_minimal_turtlebot_simulation-release/archive/release/rolling/nav2_minimal_tb4_sim/1.0.0-1.tar.gz";
    name = "1.0.0-1.tar.gz";
    sha256 = "9293904e382435a921ad735f518828ad62c64d5d34e21c76fdd4abcae876ec7a";
  };
