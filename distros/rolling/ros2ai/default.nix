...
buildRosPackage {
  pname = "ros-rolling-ros2ai";
  version = "0.1.3-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2ai-release/archive/release/rolling/ros2ai/0.1.3-1.tar.gz";
    name = "0.1.3-1.tar.gz";
    sha256 = "4013dfd61b56206a627c82c7fd030669cd219029cfedecbb1c4dcba72f8c94aa";
  };
