...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_pytest/2.7.0-1.tar.gz";
    name = "2.7.0-1.tar.gz";
    sha256 = "ac0e7d014e5a5bbf4ae8b5cb12528c993d913aa7668f22fc5b8cdd518fd3f18c";
  };
