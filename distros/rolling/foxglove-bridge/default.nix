...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/foxglove_bridge-release/archive/release/rolling/foxglove_bridge/3.4.3-1.tar.gz";
    name = "3.4.3-1.tar.gz";
    sha256 = "e6bec24d4548e3fb9b6c8aaad25df96571247ab9b25d591a554a32e9eac03cb6";
  };
