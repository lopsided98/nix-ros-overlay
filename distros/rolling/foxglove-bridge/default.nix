...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/foxglove_bridge-release/archive/release/rolling/foxglove_bridge/3.2.2-1.tar.gz";
    name = "3.2.2-1.tar.gz";
    sha256 = "304fa85ac5364b31375a28586a66202ab61488fa13ef820a454603429aa7181a";
  };
