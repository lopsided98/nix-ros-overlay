...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/foxglove_bridge-release/archive/release/rolling/foxglove_bridge/3.2.6-1.tar.gz";
    name = "3.2.6-1.tar.gz";
    sha256 = "17313f53ae8ef8e65bba58cf34d6dd467a7a66fde96d167c56bc3c1e699ba736";
  };
