...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/foxglove_bridge-release/archive/release/rolling/foxglove_msgs/3.2.2-1.tar.gz";
    name = "3.2.2-1.tar.gz";
    sha256 = "4b2fac6fb2592fdbe258e7ee2a42ecabb50b1d776a6fefb1f5545901868a1b7a";
  };
