...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/compass-release/archive/release/rolling/magnetometer_pipeline/4.0.1-1.tar.gz";
    name = "4.0.1-1.tar.gz";
    sha256 = "8a7bce00fa314438e0974e5f954e70c2d18edde15d9eb9c03a2e986bc7115761";
  };
