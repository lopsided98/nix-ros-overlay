...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/rolling/pendulum_control/0.37.4-1.tar.gz";
    name = "0.37.4-1.tar.gz";
    sha256 = "ecb0404cececc033d52b60375b1ad96e6d009b61b5dd0d30b17974391084b020";
  };
