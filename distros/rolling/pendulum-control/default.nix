...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/rolling/pendulum_control/0.37.6-1.tar.gz";
    name = "0.37.6-1.tar.gz";
    sha256 = "f28e8a9dba5221ffe94ec426655057651dffce5e160613f8f4efed4eff0bbd75";
  };
