...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/rolling/pendulum_control/0.25.0-1.tar.gz";
    name = "0.25.0-1.tar.gz";
    sha256 = "b9cb7500e24ff52c1ca07c6f8951cf84206906d716dab558e186e38e06bae468";
  };
