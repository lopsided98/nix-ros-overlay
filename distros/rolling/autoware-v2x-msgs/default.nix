...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_msgs-release/archive/release/rolling/autoware_v2x_msgs/1.11.0-1.tar.gz";
    name = "1.11.0-1.tar.gz";
    sha256 = "244355b6588eac7b70748ab3f6a43db32e2e3c23c1160add7cde3f04f34ce703";
  };
