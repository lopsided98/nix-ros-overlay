...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_ros_robot_interaction/2.7.3-1.tar.gz";
    name = "2.7.3-1.tar.gz";
    sha256 = "76af72e1414df767bd9f1d620f69b197c1be7e21be068b68cd80e55c7c54cb5a";
  };
