...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/rolling/image_proc/8.0.1-1.tar.gz";
    name = "8.0.1-1.tar.gz";
    sha256 = "004ebe4dbafe20b9c67d6605f0e3b6a1ca7193c45a17ecaaa5471739079a060b";
  };
