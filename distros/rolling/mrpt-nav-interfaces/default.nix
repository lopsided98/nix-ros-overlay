...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/rolling/mrpt_nav_interfaces/2.2.4-1.tar.gz";
    name = "2.2.4-1.tar.gz";
    sha256 = "73fb91dd7a7afaf22b1200a56a55bdd1329f750fb2f27ea6fa826b54029825bd";
  };
