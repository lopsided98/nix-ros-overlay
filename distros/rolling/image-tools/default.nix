...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/rolling/image_tools/0.37.6-1.tar.gz";
    name = "0.37.6-1.tar.gz";
    sha256 = "67fecbd13227f2f7c96d5d2c09683aac43488319c2252f08213c80f5ac337a58";
  };
  ...
  propagatedBuildInputs = [ example-interfaces opencv opencv.cxxdev rclcpp rclcpp-components sensor-msgs std-msgs ];
