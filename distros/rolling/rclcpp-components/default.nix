...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/rolling/rclcpp_components/31.0.1-1.tar.gz";
    name = "31.0.1-1.tar.gz";
    sha256 = "a7fd44abaa1970059e6cce72654e37d57a2b53108fa61588b06d987b7d5fdb3f";
  };
