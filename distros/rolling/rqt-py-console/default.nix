...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_py_console-release/archive/release/rolling/rqt_py_console/2.0.1-1.tar.gz";
    name = "2.0.1-1.tar.gz";
    sha256 = "2d3a80567580e43f89a7b0dbc326cb2dc11b847edbdd9c17924e9881ba107c8c";
  };
