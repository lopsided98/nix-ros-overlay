...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/forward_command_controller/6.2.0-1.tar.gz";
    name = "6.2.0-1.tar.gz";
    sha256 = "05d786f16c7fa44992921b9d5fcfde8ffb644f152b8041b745664764003d7490";
  };
