...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/forward_command_controller/4.9.0-1.tar.gz";
    name = "4.9.0-1.tar.gz";
    sha256 = "e025d2d203b75ac6bbf4b7f82e5b1079f47eac2b79b3b5a37e367ce0bf2b627a";
  };
