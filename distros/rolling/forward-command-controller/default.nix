...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/forward_command_controller/5.2.0-1.tar.gz";
    name = "5.2.0-1.tar.gz";
    sha256 = "dac2fc6634f4845ebcbe6d27bf5eb62ce8974e401bf9d470ca2b83c26df51588";
  };
