...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/forward_command_controller/4.6.0-2.tar.gz";
    name = "4.6.0-2.tar.gz";
    sha256 = "143d945bc0e53ce4d533513a12fb96241d559e9a862fa53e64e2c589e00f06b0";
  };
