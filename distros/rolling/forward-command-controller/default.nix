...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/forward_command_controller/5.3.0-1.tar.gz";
    name = "5.3.0-1.tar.gz";
    sha256 = "f7ad1ab830119770a85a4f28fcb78d2b892ac846385bb32df2bfb00b1cbb98e6";
  };
