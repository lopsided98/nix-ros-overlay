...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_canopen-release/archive/release/rolling/canopen_ros2_controllers/0.2.7-1.tar.gz";
    name = "0.2.7-1.tar.gz";
    sha256 = "fc2fceff810d799cc8b591050789615c69b12b51d70cb222ebe4bb0853c124ed";
  };
