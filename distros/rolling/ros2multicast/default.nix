...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2multicast/0.40.3-1.tar.gz";
    name = "0.40.3-1.tar.gz";
    sha256 = "c657e719498c17d285a7f1af154a024e44c4e7e502da15f4dfe4bd7a4b878643";
  };
