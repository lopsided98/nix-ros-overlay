...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2multicast/0.41.1-1.tar.gz";
    name = "0.41.1-1.tar.gz";
    sha256 = "06607f05ed18c53fe753edcce28fa40f51bea18c08c69959160d410004d07fcd";
  };
