...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libopengl/2.14.10-1.tar.gz";
    name = "2.14.10-1.tar.gz";
    sha256 = "bb862a4b526e063e883f66f9c54b42d1127a32013689ae19e945f3aff40bb0ce";
  };
