...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_sensor_msgs/0.45.7-2.tar.gz";
    name = "0.45.7-2.tar.gz";
    sha256 = "1d445dd5c55eb3fb256f9beff4b94f95bf52e07af6aae688ac8d8c8e20fe43a1";
  };
