...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_sensor_msgs/0.46.3-1.tar.gz";
    name = "0.46.3-1.tar.gz";
    sha256 = "b6f17dffef4ea5a709a3713af2d4373fcec0da4036e9250b3deac7d1c04eba49";
  };
