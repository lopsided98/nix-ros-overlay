...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_sensor_msgs/0.30.0-1.tar.gz";
    name = "0.30.0-1.tar.gz";
    sha256 = "82fa563f55b14f47002c71927d760087eb942f6327081dcc7ed28e50bac29bd1";
  };
