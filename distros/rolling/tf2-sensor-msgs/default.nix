...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_sensor_msgs/0.45.7-1.tar.gz";
    name = "0.45.7-1.tar.gz";
    sha256 = "814e7861d65e582188763d28d76e41a1241252c23f08a26b6fd65da3b8aedf26";
  };
