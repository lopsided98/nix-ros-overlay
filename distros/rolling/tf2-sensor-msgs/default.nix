...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_sensor_msgs/0.43.1-1.tar.gz";
    name = "0.43.1-1.tar.gz";
    sha256 = "b088f0a55a16f8c4d7c2b770d970bcd5c24f977db14dea0588d5a8d76c87c949";
  };
