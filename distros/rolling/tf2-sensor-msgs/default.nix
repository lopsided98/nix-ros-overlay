...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_sensor_msgs/0.32.0-1.tar.gz";
    name = "0.32.0-1.tar.gz";
    sha256 = "fac850273c187795e13e7b11a4bb436f600ff77a1e16793114fd31a342baa39c";
  };
