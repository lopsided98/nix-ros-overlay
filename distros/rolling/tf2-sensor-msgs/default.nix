...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_sensor_msgs/0.45.6-1.tar.gz";
    name = "0.45.6-1.tar.gz";
    sha256 = "a8c74c427ccea19da69f8f1d5d76c39a3b1d8a83979654d8c1e2d27054ce3e6a";
  };
