...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt-release/archive/release/rolling/rqt_gui_cpp/1.10.2-1.tar.gz";
    name = "1.10.2-1.tar.gz";
    sha256 = "b3560d6390a7295cf0a8ddcf86071d26dd84393f4183c519981d65a7e6361b84";
  };
