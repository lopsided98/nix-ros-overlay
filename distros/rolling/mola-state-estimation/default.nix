...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_state_estimation-release/archive/release/rolling/mola_state_estimation/1.8.1-1.tar.gz";
    name = "1.8.1-1.tar.gz";
    sha256 = "49482a200e22d2a98610d4c9c00d052bae969173d54d05d0fe5d1279e393a535";
  };
