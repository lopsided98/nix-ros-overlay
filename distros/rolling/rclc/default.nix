...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclc-release/archive/release/rolling/rclc/6.2.1-1.tar.gz";
    name = "6.2.1-1.tar.gz";
    sha256 = "f28449012a08802726a8493ea7287138bbb94603c85a01ffb0547e1ff634145c";
  };
