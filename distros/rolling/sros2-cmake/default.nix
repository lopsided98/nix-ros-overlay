...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/sros2-release/archive/release/rolling/sros2_cmake/0.16.4-1.tar.gz";
    name = "0.16.4-1.tar.gz";
    sha256 = "4d22cbc88a2d7a199fd5f7ea4298774dcbb0376045c7fc4777067f21fe9ff0dd";
  };
