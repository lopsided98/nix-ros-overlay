...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/sros2-release/archive/release/rolling/sros2_cmake/0.17.0-1.tar.gz";
    name = "0.17.0-1.tar.gz";
    sha256 = "56f728f195a40b8000ab2e0766d14552ee21d8a602d8cb1ff73badea4c3cfcc8";
  };
