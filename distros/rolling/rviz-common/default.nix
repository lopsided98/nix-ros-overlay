...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_common/12.3.1-1.tar.gz";
    name = "12.3.1-1.tar.gz";
    sha256 = "5375abd1c3cf7849c5389d51a9d956adf0727dc0aba357ee0969c752aad041e7";
  };
