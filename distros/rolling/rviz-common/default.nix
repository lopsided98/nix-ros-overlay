...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_common/15.1.2-1.tar.gz";
    name = "15.1.2-1.tar.gz";
    sha256 = "4d9d433bb826d56b308adef4d088848559c971492d4375928e0d0b3d37505e7d";
  };
