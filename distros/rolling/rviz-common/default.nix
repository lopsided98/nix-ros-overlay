...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_common/13.3.1-1.tar.gz";
    name = "13.3.1-1.tar.gz";
    sha256 = "24cdc78b0361f77e845824121fdea3eb5194e0de14c682ecc8186aab5e9ab8e7";
  };
