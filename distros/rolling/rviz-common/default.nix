...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_common/15.1.15-1.tar.gz";
    name = "15.1.15-1.tar.gz";
    sha256 = "69dce6eae6be12bbd2b93bc5f20f01ab1d3e64e32fb5a6f2536ee5620dfff79f";
  };
