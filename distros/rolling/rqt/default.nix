...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt-release/archive/release/rolling/rqt/1.10.3-1.tar.gz";
    name = "1.10.3-1.tar.gz";
    sha256 = "a3492c728ae5efbe7915d56d2d268e872bc09a3b3eed56831e064bfe8f58b6df";
  };
