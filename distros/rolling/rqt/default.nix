...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt-release/archive/release/rolling/rqt/2.0.3-1.tar.gz";
    name = "2.0.3-1.tar.gz";
    sha256 = "06eeec6cdd03133801451ffa6e40d089173c1a6b92b9ff2285083082427ecbeb";
  };
