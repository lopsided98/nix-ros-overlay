...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2run/0.23.0-1.tar.gz";
    name = "0.23.0-1.tar.gz";
    sha256 = "b4a10f142b911e05c4e3c60fc053eda6dbed56a54180b507f2a8fea56ff4f146";
  };
