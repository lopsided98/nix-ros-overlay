...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2run/0.40.3-1.tar.gz";
    name = "0.40.3-1.tar.gz";
    sha256 = "6f9a3bb7ce680f49cd312da9708450297eeabbd2ab5dcc151d6cf0ce7a38802b";
  };
