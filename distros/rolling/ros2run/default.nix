...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2run/0.26.0-1.tar.gz";
    name = "0.26.0-1.tar.gz";
    sha256 = "b8957be64956b5dfcb2ee46eda4b1152c5b50181f77555ea120727d9a3d0a26d";
  };
