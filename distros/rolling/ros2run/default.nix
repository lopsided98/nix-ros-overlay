...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2run/0.41.0-1.tar.gz";
    name = "0.41.0-1.tar.gz";
    sha256 = "1acadbfc69a4223d1440fce613e3d5223d547736a0ce3d36b1d02f0d7a0ff024";
  };
