...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2run/0.40.4-1.tar.gz";
    name = "0.40.4-1.tar.gz";
    sha256 = "c461d90e04ab436997461b97d01834442ec3c715530a72edb998890806dfad52";
  };
