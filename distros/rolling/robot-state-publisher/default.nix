...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/robot_state_publisher-release/archive/release/rolling/robot_state_publisher/3.5.5-2.tar.gz";
    name = "3.5.5-2.tar.gz";
    sha256 = "817c9f1360e987556771623d5f35c5e88713e253f4b31557a5f6ea076fb1bcf0";
  };
