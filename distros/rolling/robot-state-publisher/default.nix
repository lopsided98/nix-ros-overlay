...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/robot_state_publisher-release/archive/release/rolling/robot_state_publisher/3.5.2-1.tar.gz";
    name = "3.5.2-1.tar.gz";
    sha256 = "603def3880ed118c86f55dbb75c0b34e3576bc3e034f2c5fe3bf7aa7671c1606";
  };
