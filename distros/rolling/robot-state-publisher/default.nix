...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/robot_state_publisher-release/archive/release/rolling/robot_state_publisher/3.6.0-1.tar.gz";
    name = "3.6.0-1.tar.gz";
    sha256 = "e0051263e301e5d1b24dea03a32ade3ecffec6c93b3baa6daa7d8d5058a739bd";
  };
