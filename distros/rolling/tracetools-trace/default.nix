...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_tracing-release/archive/release/rolling/tracetools_trace/9.0.0-1.tar.gz";
    name = "9.0.0-1.tar.gz";
    sha256 = "a0b4eef8e75b11df3caa7129489700073bce0f8c709bbb68d93d216a12924379";
  };
