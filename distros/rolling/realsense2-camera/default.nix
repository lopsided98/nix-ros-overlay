...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/realsense-ros-release/archive/release/rolling/realsense2_camera/4.56.4-2.tar.gz";
    name = "4.56.4-2.tar.gz";
    sha256 = "283f28716ea5403374f6061ea812880643526ed392b2ef630893cbd61a8be246";
  };
