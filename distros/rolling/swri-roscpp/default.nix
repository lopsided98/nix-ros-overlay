...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/rolling/swri_roscpp/3.8.1-1.tar.gz";
    name = "3.8.1-1.tar.gz";
    sha256 = "18f4206ab3c584fab1abd405325ef125dce66963d1308896fadbcd536cfa63fc";
  };
