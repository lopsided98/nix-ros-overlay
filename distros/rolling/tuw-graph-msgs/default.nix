...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/tuw_msgs-release/archive/release/rolling/tuw_graph_msgs/0.2.5-1.tar.gz";
    name = "0.2.5-1.tar.gz";
    sha256 = "cfe58df094aba92bd1a7d12d0bd5417cfb1c71e630daa3182a92359c6ace060d";
  };
