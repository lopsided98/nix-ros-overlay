...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/tuw_msgs-release/archive/release/rolling/tuw_graph_msgs/0.2.6-1.tar.gz";
    name = "0.2.6-1.tar.gz";
    sha256 = "eaf5fea3c8e136ae667baae12eae56a987e592fc1f7abbcc1dc0262e95875e8d";
  };
