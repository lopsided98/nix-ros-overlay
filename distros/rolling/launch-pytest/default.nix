...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch-release/archive/release/rolling/launch_pytest/3.9.5-1.tar.gz";
    name = "3.9.5-1.tar.gz";
    sha256 = "ab5cafcd49c333abec51031d41d4824173df9f8dff605874d2298a430845c788";
  };
