...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/rolling/open_manipulator_moveit_config/4.0.7-1.tar.gz";
    name = "4.0.7-1.tar.gz";
    sha256 = "fb75476ad2b6a9bc2c39dcc1e4bc6fda78fbee5c14671dc972053b60223e17d5";
  };
