...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/metavision_driver-release/archive/release/rolling/metavision_driver/3.0.0-2.tar.gz";
    name = "3.0.0-2.tar.gz";
    sha256 = "f4877e7874b58de38fa625bd7c4395ea7f7e83de8896d4a532f8403089ceb363";
  };
