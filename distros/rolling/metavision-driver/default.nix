...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/metavision_driver-release/archive/release/rolling/metavision_driver/1.0.8-2.tar.gz";
    name = "1.0.8-2.tar.gz";
    sha256 = "53488996e0b29506ae6f05a0bc3f03ebe05556f67263de4fa4b60b459cfaa98f";
  };
