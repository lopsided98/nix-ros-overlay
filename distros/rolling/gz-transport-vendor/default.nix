...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gz_transport_vendor-release/archive/release/rolling/gz_transport_vendor/0.1.1-1.tar.gz";
    name = "0.1.1-1.tar.gz";
    sha256 = "1a9c665f203ded448770c42cd8683d227e41f9edc479ac8643b9905bfcc90a49";
  };
  ...
  meta = {
    description = "Vendor package for: gz-transport13 13.3.0
