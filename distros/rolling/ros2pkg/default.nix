...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2pkg/0.26.0-1.tar.gz";
    name = "0.26.0-1.tar.gz";
    sha256 = "659010f81bdbbb473fd67db1d50f487cbf82bbc0e54e4f27268f93c6486442d2";
  };
