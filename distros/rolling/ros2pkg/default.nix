...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2pkg/0.23.0-1.tar.gz";
    name = "0.23.0-1.tar.gz";
    sha256 = "0742e74e7545ff35ba5ff43f25de7a11ab933e621990030985fe3818e0a58f0d";
  };
