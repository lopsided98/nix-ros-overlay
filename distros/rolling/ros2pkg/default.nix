...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2pkg/0.41.0-1.tar.gz";
    name = "0.41.0-1.tar.gz";
    sha256 = "54ac7c789b36bce7492629906d9446a91c39d9b29857ce4f24c926d2a64e8f59";
  };
