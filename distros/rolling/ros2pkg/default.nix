...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2pkg/0.41.1-1.tar.gz";
    name = "0.41.1-1.tar.gz";
    sha256 = "e841681e6004ec80245043f679ea4c890dcefab28ae8fbe3a88c0f2f4b7254b8";
  };
