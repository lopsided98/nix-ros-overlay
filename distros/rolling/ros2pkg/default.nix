...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2pkg/0.40.4-1.tar.gz";
    name = "0.40.4-1.tar.gz";
    sha256 = "1029f0898cbc556fca09809c5f3aa4bee34be8de3f6af11cadb3052143f0e652";
  };
