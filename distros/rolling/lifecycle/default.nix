...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/rolling/lifecycle/0.37.4-1.tar.gz";
    name = "0.37.4-1.tar.gz";
    sha256 = "657286a94164a0a8e29e10ea3cad1c1d0de3882dc053f5b8bb1a34dee87ca7a1";
  };
