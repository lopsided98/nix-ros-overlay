...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/cras_ros_utils-release/archive/release/rolling/cras_cpp_common/3.0.2-2.tar.gz";
    name = "3.0.2-2.tar.gz";
    sha256 = "44500b6bd3eb7ec4acf5ac4d2deef65a5707fdde7467eb129b0747df884e7b4c";
  };
