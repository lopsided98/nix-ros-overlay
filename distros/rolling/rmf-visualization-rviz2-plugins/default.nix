...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_visualization-release/archive/release/rolling/rmf_visualization_rviz2_plugins/2.4.2-1.tar.gz";
    name = "2.4.2-1.tar.gz";
    sha256 = "819d3e75ff2eb418b35cd2819077b732c4253a681215f7e70135967c535e82ca";
  };
