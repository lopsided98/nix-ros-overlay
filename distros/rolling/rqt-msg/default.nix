...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_msg-release/archive/release/rolling/rqt_msg/2.0.2-1.tar.gz";
    name = "2.0.2-1.tar.gz";
    sha256 = "eb8d4c0e68fe314895e1d222b080577c6b912a4d06e1d8d13bd40099107d8938";
  };
