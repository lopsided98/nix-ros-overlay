...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_msg-release/archive/release/rolling/rqt_msg/1.7.2-1.tar.gz";
    name = "1.7.2-1.tar.gz";
    sha256 = "04b65c60fb307ba5880dfa2bb54d36abf6cbe59f5307f5173c1c544ab9cd59a7";
  };
