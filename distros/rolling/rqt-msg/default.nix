...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_msg-release/archive/release/rolling/rqt_msg/2.0.3-1.tar.gz";
    name = "2.0.3-1.tar.gz";
    sha256 = "c58aac361ee85a35357c00901d0d6469b71c45e50193520f05c2afee258e1262";
  };
