...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_launcher/2.8.0-1.tar.gz";
    name = "2.8.0-1.tar.gz";
    sha256 = "4369ba32a8e33049589acb1c786ab30582c48e9542d4c2b5a5e643696971fcdf";
  };
