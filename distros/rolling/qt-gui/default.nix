...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/qt_gui_core-release/archive/release/rolling/qt_gui/2.7.4-1.tar.gz";
    name = "2.7.4-1.tar.gz";
    sha256 = "ca1f0a0ea462a9dd0a2e612d838d50a0551db44d789d80b790200b792de32a6d";
  };
