...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/qt_gui_core-release/archive/release/rolling/qt_gui/2.3.2-1.tar.gz";
    name = "2.3.2-1.tar.gz";
    sha256 = "686272ba5c2d8f4eba7a34fe7648b7394aff772776abca31539de942bcb5dcc5";
  };
