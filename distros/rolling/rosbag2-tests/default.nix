...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_tests/0.19.0-1.tar.gz";
    name = "0.19.0-1.tar.gz";
    sha256 = "a7f7a824cea73902eded146da38720f079bdec4db29ba79a9b858b59a6813d59";
  };
