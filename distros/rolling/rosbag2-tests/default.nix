...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_tests/0.20.0-1.tar.gz";
    name = "0.20.0-1.tar.gz";
    sha256 = "943688ca1bb79a07168840994183bd956754b45b99f560e0d63b992eef696ccb";
  };
