...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/rolling/open_manipulator_description/4.1.2-1.tar.gz";
    name = "4.1.2-1.tar.gz";
    sha256 = "b953d29e27dace017059de2005c2a83b7a15fbb49f118ded56c5aeaee803b2aa";
  };
