...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/rolling/open_manipulator_description/4.0.5-1.tar.gz";
    name = "4.0.5-1.tar.gz";
    sha256 = "3712dd5154e61a28e4d9a95435020889ff69bfd645778a3ce92facd0801fecc9";
  };
