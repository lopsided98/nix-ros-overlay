...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_mypy/0.20.3-1.tar.gz";
    name = "0.20.3-1.tar.gz";
    sha256 = "fa9d97579884fc9ebe16c76d27d8781c7db3ebf11cd432522a2a6ab412859723";
  };
