...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/clips_executive-release/archive/release/rolling/clips_executive/0.1.3-2.tar.gz";
    name = "0.1.3-2.tar.gz";
    sha256 = "b334f07a529bfd95c290e492fe5e81a419a8f835f14677ef972cdbc298ca5cdd";
  };
