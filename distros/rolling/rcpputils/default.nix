...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcpputils-release/archive/release/rolling/rcpputils/2.11.0-1.tar.gz";
    name = "2.11.0-1.tar.gz";
    sha256 = "9f9bb6809a08036d753d84dbef2e195a17a00e5b48c1a15238635380e1324a33";
  };
