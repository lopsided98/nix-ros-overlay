...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/rolling/image_view/7.1.0-1.tar.gz";
    name = "7.1.0-1.tar.gz";
    sha256 = "2771d5512f558bbd9b7ac0b03e2f13db9a062b1397cfc70bfd47355cfc497fd1";
  };
