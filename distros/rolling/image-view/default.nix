...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/rolling/image_view/8.0.1-1.tar.gz";
    name = "8.0.1-1.tar.gz";
    sha256 = "eaabcb92511097f3c2ded3cc33eebc92b9d30c7dad6a168b260d68d08c42d6ff";
  };
