...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/rolling/depth_image_proc/6.0.0-2.tar.gz";
    name = "6.0.0-2.tar.gz";
    sha256 = "232245e9ec002ebd931f86709134767ce54198084270e1e180c58872538c4313";
  };
