...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/rolling/depth_image_proc/8.0.1-1.tar.gz";
    name = "8.0.1-1.tar.gz";
    sha256 = "385033efca919259d0f63ce91b6cdc4beeec8f725767f8c7fe7e34da5d189882";
  };
