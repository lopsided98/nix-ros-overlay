...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/rolling/depth_image_proc/7.1.0-1.tar.gz";
    name = "7.1.0-1.tar.gz";
    sha256 = "c37594335fe5c0520ccb706023aa0274efa5df0a8546b42ef0396b1b5c1c1f6d";
  };
