...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/rolling/rosbag2_storage_mcap/0.34.0-1.tar.gz";
    name = "0.34.0-1.tar.gz";
    sha256 = "15809f8b9b755e02b91f14eac7174420f5dfa1c4f90dd1d111e3621b43c15e06";
  };
