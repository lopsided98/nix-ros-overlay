...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_utils-release/archive/release/rolling/rmf_utils/1.6.1-1.tar.gz";
    name = "1.6.1-1.tar.gz";
    sha256 = "58ff9bb2b94d5419a592b954336a767693d466c2fd6fbad943279c5577295c94";
  };
