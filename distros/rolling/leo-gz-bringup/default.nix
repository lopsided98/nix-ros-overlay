...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/leo_simulator-release/archive/release/rolling/leo_gz_bringup/2.0.2-2.tar.gz";
    name = "2.0.2-2.tar.gz";
    sha256 = "d707423e8078bf0387adfab45aea6ca395324373732603043819c7be20b6834d";
  };
