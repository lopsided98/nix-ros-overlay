...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mvsim-release/archive/release/rolling/mvsim/0.14.0-1.tar.gz";
    name = "0.14.0-1.tar.gz";
    sha256 = "457495573bc483808307ea28311b059c8d61284e40d65fb7a1a765e87b4e30a5";
  };
