...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mvsim-release/archive/release/rolling/mvsim/0.7.0-1.tar.gz";
    name = "0.7.0-1.tar.gz";
    sha256 = "681f7672c3d7dfcc64ac54906ba434751c084098c92a9ba8f44474b892c134a1";
  };
