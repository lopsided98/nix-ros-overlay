...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mvsim-release/archive/release/rolling/mvsim/0.16.0-1.tar.gz";
    name = "0.16.0-1.tar.gz";
    sha256 = "9a671c4faeb3d2b8a22e91f09ceea2595e376c4c88206ceb0c674d2a0405f438";
  };
