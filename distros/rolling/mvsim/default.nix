...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mvsim-release/archive/release/rolling/mvsim/0.10.0-1.tar.gz";
    name = "0.10.0-1.tar.gz";
    sha256 = "e7acb4e1412bda60df82f5d1f7b4acc4e9833d5637125d3daa80e56a3ec811dc";
  };
