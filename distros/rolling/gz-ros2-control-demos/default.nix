...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ign_ros2_control-release/archive/release/rolling/gz_ros2_control_demos/3.0.1-1.tar.gz";
    name = "3.0.1-1.tar.gz";
    sha256 = "4a8c809dba7684e3d2d92ce0ab2fd62f3a0b8e6e5fa31f936b941faba0293e72";
  };
