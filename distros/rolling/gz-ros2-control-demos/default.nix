...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ign_ros2_control-release/archive/release/rolling/gz_ros2_control_demos/2.0.1-1.tar.gz";
    name = "2.0.1-1.tar.gz";
    sha256 = "bf71c242e1728a774cb6f8344ac0f61427ce211a615aee7529ff65515926911d";
  };
