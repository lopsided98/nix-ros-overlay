...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ign_ros2_control-release/archive/release/rolling/gz_ros2_control_demos/3.0.2-1.tar.gz";
    name = "3.0.2-1.tar.gz";
    sha256 = "cce39bc4454026e27454531ba4b639373f9c606883b00cb45466688ac1eed5e2";
  };
