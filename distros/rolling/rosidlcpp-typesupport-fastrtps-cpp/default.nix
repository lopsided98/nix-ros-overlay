...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidlcpp-release/archive/release/rolling/rosidlcpp_typesupport_fastrtps_cpp/0.2.1-1.tar.gz";
    name = "0.2.1-1.tar.gz";
    sha256 = "775f0bed0e52f6acfc83b1c42dd8d80de4e24f73e5c896ef9102026f210fd0e4";
  };
