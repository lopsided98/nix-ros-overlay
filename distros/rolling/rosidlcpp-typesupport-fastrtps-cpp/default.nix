...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidlcpp-release/archive/release/rolling/rosidlcpp_typesupport_fastrtps_cpp/0.2.0-1.tar.gz";
    name = "0.2.0-1.tar.gz";
    sha256 = "a440bc6b15c0ab98107dce42c09fc0c62460181da35416ff3359daca8caed7ec";
  };
