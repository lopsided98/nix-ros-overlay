...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/camera_ros-release/archive/release/rolling/camera_ros/0.5.2-1.tar.gz";
    name = "0.5.2-1.tar.gz";
    sha256 = "63005b430fa0be71728fa0fe2c027d2744fc112f3fea84faea5745b5e7fa8bce";
  };
