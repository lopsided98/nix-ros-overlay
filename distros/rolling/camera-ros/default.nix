...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/camera_ros-release/archive/release/rolling/camera_ros/0.5.1-1.tar.gz";
    name = "0.5.1-1.tar.gz";
    sha256 = "535710506439d86395fda0baaae1f2b92af36540a5701712605eaf0afb78e60d";
  };
