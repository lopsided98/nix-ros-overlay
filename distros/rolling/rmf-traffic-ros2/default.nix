...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_ros2-release/archive/release/rolling/rmf_traffic_ros2/2.12.0-2.tar.gz";
    name = "2.12.0-2.tar.gz";
    sha256 = "9e82ccbc7a60aa06da9df96f4686395f635d67c71ed3ddefff5d4008851b96ab";
  };
