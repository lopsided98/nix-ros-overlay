...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_ros2-release/archive/release/rolling/rmf_traffic_ros2/2.12.0-1.tar.gz";
    name = "2.12.0-1.tar.gz";
    sha256 = "a2ffb92aadf84074368334f2a7b6d19032b0c47354a0681055552ace8d748f93";
  };
