...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_cmake_cppcheck/0.20.1-1.tar.gz";
    name = "0.20.1-1.tar.gz";
    sha256 = "6f5256fab7725e1b7826d07a0e4f865d18bcaacb8a94793b90dc6471ab127ab3";
  };
