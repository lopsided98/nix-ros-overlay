...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2action/0.30.1-1.tar.gz";
    name = "0.30.1-1.tar.gz";
    sha256 = "56c9b6911ce23e7bf1ac1fc8ebdf20f851fbfab9fceac4fcaaeedf67f06c5481";
  };
