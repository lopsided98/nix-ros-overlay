...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2action/0.40.6-2.tar.gz";
    name = "0.40.6-2.tar.gz";
    sha256 = "06a80ec968132426cbde6c22dab76ad456516e576548d14fed69240b42d017f7";
  };
