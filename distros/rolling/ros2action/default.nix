...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2action/0.32.0-1.tar.gz";
    name = "0.32.0-1.tar.gz";
    sha256 = "95a40abdfafe3d58b6756ab5453cdd061ab9aecd49a1982f90a0b4de5586552f";
  };
