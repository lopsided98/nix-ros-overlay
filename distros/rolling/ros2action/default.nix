...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2action/0.41.1-1.tar.gz";
    name = "0.41.1-1.tar.gz";
    sha256 = "b8fde5a77cbe55b6871cc5f84755d1c749edc995acc6e86825a0be160c19911b";
  };
