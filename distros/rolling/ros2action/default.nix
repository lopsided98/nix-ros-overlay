...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2action/0.42.0-1.tar.gz";
    name = "0.42.0-1.tar.gz";
    sha256 = "be27a51bef700f80de61e63173417df61b53a4766cf03011d1a904638cb90894";
  };
