...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_typesupport_fastrtps-release/archive/release/rolling/rosidl_typesupport_fastrtps_cpp/3.9.3-1.tar.gz";
    name = "3.9.3-1.tar.gz";
    sha256 = "d5e8ed6641048e6a614333b297f6cb3fe023ecdef7d6c155d7b3a72df545e02b";
  };
