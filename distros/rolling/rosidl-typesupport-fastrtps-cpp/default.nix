...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_typesupport_fastrtps-release/archive/release/rolling/rosidl_typesupport_fastrtps_cpp/3.6.0-1.tar.gz";
    name = "3.6.0-1.tar.gz";
    sha256 = "e4975f17d07b90f5965ed0078cff1b49543315487359cb4502c00d44d5a47ebf";
  };
