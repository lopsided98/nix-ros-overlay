...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_zenoh-release/archive/release/rolling/zenoh_cpp_vendor/0.10.1-1.tar.gz";
    name = "0.10.1-1.tar.gz";
    sha256 = "b6d7f4f8c64a52103d09811b362627a5282f150b6e0af6c375ad10f0d8d82c20";
  };
