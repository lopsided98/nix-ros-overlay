...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/rolling/om_gravity_compensation_controller/4.0.7-1.tar.gz";
    name = "4.0.7-1.tar.gz";
    sha256 = "fce87a166fb404e6cbc04f1023ba044e6b0eb7c1fa6bf276612d2f14605c1b9b";
  };
