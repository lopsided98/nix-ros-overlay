...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw-release/archive/release/rolling/rmw/7.11.2-1.tar.gz";
    name = "7.11.2-1.tar.gz";
    sha256 = "742ff57edcb69b5c0d79a89771f34c6588b4f526806e29526c6e10409b3fc634";
  };
