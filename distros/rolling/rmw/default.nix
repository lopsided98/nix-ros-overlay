...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw-release/archive/release/rolling/rmw/7.11.1-1.tar.gz";
    name = "7.11.1-1.tar.gz";
    sha256 = "a7bf1eaa0a8a0f874ac099b40d90acc4dbefb7ede5f3be432ade8d70b6347083";
  };
