...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_tools/0.46.2-1.tar.gz";
    name = "0.46.2-1.tar.gz";
    sha256 = "f433c5cc370e73d5dab387ecbfaca4ce583d6babe9064b03c335328ad304dd29";
  };
