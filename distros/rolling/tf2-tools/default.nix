...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_tools/0.45.3-1.tar.gz";
    name = "0.45.3-1.tar.gz";
    sha256 = "935b47bd6187a19dc3d934dd044b19d668769e14b8622429e6bbe08835862418";
  };
