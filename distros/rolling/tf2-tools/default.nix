...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_tools/0.46.0-1.tar.gz";
    name = "0.46.0-1.tar.gz";
    sha256 = "dcdde06c56db1a7b16653273b8256b53bc28bc2744fdea56e937179a45d73393";
  };
