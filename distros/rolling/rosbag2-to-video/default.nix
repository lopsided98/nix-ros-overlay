...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2_to_video-release/archive/release/rolling/rosbag2_to_video/1.0.1-2.tar.gz";
    name = "1.0.1-2.tar.gz";
    sha256 = "915ae6450d79cecaab2dab47a57f069c63ae7ad4cfdfb12672bcdd2e7e5bd86d";
  };
