...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_visual_testing_framework/15.1.6-1.tar.gz";
    name = "15.1.6-1.tar.gz";
    sha256 = "40266e95003c64e6e8e814ed14bd4c60d1f2545d609199b3fd73b065b9f5413e";
  };
