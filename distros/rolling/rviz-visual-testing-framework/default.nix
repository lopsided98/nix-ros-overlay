...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_visual_testing_framework/15.1.7-1.tar.gz";
    name = "15.1.7-1.tar.gz";
    sha256 = "2dc0b6f697609f6bab0142e55e7a84cdd9fc2841885de531d0fd4a5a928d34d2";
  };
