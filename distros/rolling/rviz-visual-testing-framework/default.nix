...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_visual_testing_framework/15.1.1-1.tar.gz";
    name = "15.1.1-1.tar.gz";
    sha256 = "0015cdea680a0b452d5e17ddfb0a1ac7241f30b69491d66e8ee3f0fa0f76c731";
  };
