...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_visual_testing_framework/14.2.2-1.tar.gz";
    name = "14.2.2-1.tar.gz";
    sha256 = "e6e2d98079dcc7888cc40eb46f3f7700fb92d0842c0e809ba3e1eff3e473e818";
  };
