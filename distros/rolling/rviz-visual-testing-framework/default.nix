...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_visual_testing_framework/13.3.1-1.tar.gz";
    name = "13.3.1-1.tar.gz";
    sha256 = "024a0822087c76d90fbed420e13f3760a9db7ac1af0ffd0758b26576247405cc";
  };
