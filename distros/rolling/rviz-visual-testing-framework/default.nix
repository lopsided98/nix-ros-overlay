...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/rolling/rviz_visual_testing_framework/15.1.2-1.tar.gz";
    name = "15.1.2-1.tar.gz";
    sha256 = "aa5f78dd549bd43aac8062f006b4b89e818240c92d8bb447fd39ee10997802c8";
  };
