...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/robstride_ros2-release/archive/release/rolling/robstride_ros2/0.2.0-1.tar.gz";
    name = "0.2.0-1.tar.gz";
    sha256 = "452a530aaae0b507c4ef4ebf2d62c19d3433e518d451bfc1d9c57ec8450e59f0";
  };
