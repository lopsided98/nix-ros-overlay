...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/rolling/mola_input_rosbag2/1.7.0-1.tar.gz";
    name = "1.7.0-1.tar.gz";
    sha256 = "1930361eb4e714975e7873ce3a2995ace25c965ce9bd7111d9f97e0bc9203ae4";
  };
