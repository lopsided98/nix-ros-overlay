...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz_sim_demos/3.0.5-1.tar.gz";
    name = "3.0.5-1.tar.gz";
    sha256 = "ea9b8a21f52e5082c67c3f30fa877d0b6817583ca1874195d278de8159d3235a";
  };
