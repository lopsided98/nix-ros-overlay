...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz_sim_demos/3.0.8-1.tar.gz";
    name = "3.0.8-1.tar.gz";
    sha256 = "9f4f3a9599e74a0f233685193eae214562e54041bc9ae02d964a6cfea79dd234";
  };
