...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/rolling/ros_gz_sim_demos/3.0.2-1.tar.gz";
    name = "3.0.2-1.tar.gz";
    sha256 = "8b3e30ecce205173f8d9cf4526da17290b34c8b33feb730d23d463559c3f073c";
  };
