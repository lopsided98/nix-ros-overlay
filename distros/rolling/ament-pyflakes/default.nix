...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_pyflakes/0.21.2-1.tar.gz";
    name = "0.21.2-1.tar.gz";
    sha256 = "6e69600a0e21e8d9a78f1458a5c1515eccf3170d920593ee402d8cfd0f5ac5ea";
  };
