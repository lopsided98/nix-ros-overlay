...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/kinematics_interface-release/archive/release/rolling/kinematics_interface/2.4.2-1.tar.gz";
    name = "2.4.2-1.tar.gz";
    sha256 = "621dc657cd8be99ea0a70805210f8e7472e7638e8591e35f72323f1776534392";
  };
