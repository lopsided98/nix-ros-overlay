...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gz_launch_vendor-release/archive/release/rolling/gz_launch_vendor/0.3.1-2.tar.gz";
    name = "0.3.1-2.tar.gz";
    sha256 = "d15c73f773a72e8bc8de3ee346a74e6dd5e32874504f55eb3c8dad29721543a3";
  };
