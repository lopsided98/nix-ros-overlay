...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/rolling/webots_ros2_mavic/2023.0.3-1.tar.gz";
    name = "2023.0.3-1.tar.gz";
    sha256 = "c4ed13a448be13c7ec3b06d2385900e0f6f043b3ed37ea7bdd61320bb43942f3";
  };
