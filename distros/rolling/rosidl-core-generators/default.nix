...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_core-release/archive/release/rolling/rosidl_core_generators/0.2.0-1.tar.gz";
    name = "0.2.0-1.tar.gz";
    sha256 = "79cc94f835b03cc849dd22bb05f03a54ef25d97e3c852f1ec0e443c1477d2587";
  };
