...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_core-release/archive/release/rolling/rosidl_core_generators/0.1.1-1.tar.gz";
    name = "0.1.1-1.tar.gz";
    sha256 = "22dec4b5df79a973bc7cba74f294509dff2d1527c0a171aaaa06e67e0ad6ba59";
  };
