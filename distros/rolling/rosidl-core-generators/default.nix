...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_core-release/archive/release/rolling/rosidl_core_generators/0.4.1-1.tar.gz";
    name = "0.4.1-1.tar.gz";
    sha256 = "ce67b7b292b5df0aed3a5a57341e758e568ceffd12929e0a0c8e827872abe4ce";
  };
