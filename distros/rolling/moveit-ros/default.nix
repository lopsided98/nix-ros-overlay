...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_ros/2.8.0-2.tar.gz";
    name = "2.8.0-2.tar.gz";
    sha256 = "5c16b26614e65d7290556eba4059b1c99664faba4a263517467a2852b34f9fa2";
  };
