...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_ros/2.14.1-2.tar.gz";
    name = "2.14.1-2.tar.gz";
    sha256 = "99a246b10b4d94ac73721129a37cb7d040fe90bca09d8ff4f9931c7b990a11d2";
  };
