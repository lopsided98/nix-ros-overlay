...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_topic-release/archive/release/rolling/rqt_topic/2.1.0-2.tar.gz";
    name = "2.1.0-2.tar.gz";
    sha256 = "4b88daadddccd7f3394022e779a177bbafcf2c15a8a60cc700926d93ffb0ad30";
  };
