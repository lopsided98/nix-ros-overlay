...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2param/0.40.6-2.tar.gz";
    name = "0.40.6-2.tar.gz";
    sha256 = "6b316edce034cd9e79767b160c773a35d70026517a28d2d1241225576e81a9f6";
  };
