...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2param/0.40.2-1.tar.gz";
    name = "0.40.2-1.tar.gz";
    sha256 = "1adbeb0319b37d8b2b387d332c39662c9051e787cd6e8727e41fbc0797e9b335";
  };
