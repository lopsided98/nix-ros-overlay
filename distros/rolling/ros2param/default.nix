...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2param/0.41.1-1.tar.gz";
    name = "0.41.1-1.tar.gz";
    sha256 = "ec85a812a2fa15d3af6051c1dc23301f4c4423b524310124954be17a966b4978";
  };
