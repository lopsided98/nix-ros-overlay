...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_cyclonedds-release/archive/release/rolling/rmw_cyclonedds_cpp/3.0.0-1.tar.gz";
    name = "3.0.0-1.tar.gz";
    sha256 = "470f2f11178027df1c819560a4040aaf8dc3a7d580d23bb945aa3409d60a6108";
  };
