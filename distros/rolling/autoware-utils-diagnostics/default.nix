...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/rolling/autoware_utils_diagnostics/1.4.2-3.tar.gz";
    name = "1.4.2-3.tar.gz";
    sha256 = "a4b5a8dbde62a648cd959927adc8fe675384ca537c906742049483a1744a5e7b";
  };
