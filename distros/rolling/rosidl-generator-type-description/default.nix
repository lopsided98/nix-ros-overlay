...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_generator_type_description/4.6.0-1.tar.gz";
    name = "4.6.0-1.tar.gz";
    sha256 = "9d85fecc2b414bd1e57605889fa76dadcba1107cd78c9b344327d4b9ee830b97";
  };
