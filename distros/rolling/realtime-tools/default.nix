...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/realtime_tools-release/archive/release/rolling/realtime_tools/5.2.0-1.tar.gz";
    name = "5.2.0-1.tar.gz";
    sha256 = "d8ba83aab943fb3991cd755b4b18c874c20aa564e3ea2e90054e71de0825bb01";
  };
