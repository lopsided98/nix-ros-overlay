...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/openeb_vendor-release/archive/release/rolling/openeb_vendor/1.0.2-1.tar.gz";
    name = "1.0.2-1.tar.gz";
    sha256 = "69241dd9d0706a45370fc5c1f3f989b4b6ea7a3351a1a3bcb88b50502db267b2";
  };
