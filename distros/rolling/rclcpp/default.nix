...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/rolling/rclcpp/30.1.5-1.tar.gz";
    name = "30.1.5-1.tar.gz";
    sha256 = "7ff0c4274da09260bf54bc3db87332472ba96ba2bd3a57fdf031f308caaa845a";
  };
