...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/rolling/rclcpp/28.1.0-1.tar.gz";
    name = "28.1.0-1.tar.gz";
    sha256 = "d4bbfae77b1f38afbf7347f3d82b6d25d363575a4d16a660127de3ed16301717";
  };
