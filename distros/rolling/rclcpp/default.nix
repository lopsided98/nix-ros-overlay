...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/rolling/rclcpp/28.3.0-1.tar.gz";
    name = "28.3.0-1.tar.gz";
    sha256 = "8bb93cc38078eb430e7aa732f85a555fba5465bcf02fe6e1f4ca8b42c6b6dfa6";
  };
