...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/rolling/rclcpp/30.1.4-1.tar.gz";
    name = "30.1.4-1.tar.gz";
    sha256 = "e653ceb1c3db48352b32db3f302a5733554857d7849c36903b1806d80550cbc4";
  };
