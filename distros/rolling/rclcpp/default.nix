...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/rolling/rclcpp/19.3.0-1.tar.gz";
    name = "19.3.0-1.tar.gz";
    sha256 = "f8de30ddef961b058a571563801d1dbb6a4d510c0379d177b37fce0f6809f564";
  };
