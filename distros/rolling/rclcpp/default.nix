...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/rolling/rclcpp/33.1.0-1.tar.gz";
    name = "33.1.0-1.tar.gz";
    sha256 = "3c93cd111436eeac4f52c6346a507bc0344c553e6d9735d22c49491d273551ae";
  };
