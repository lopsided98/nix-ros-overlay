...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/rolling/rclcpp/29.6.1-1.tar.gz";
    name = "29.6.1-1.tar.gz";
    sha256 = "22560a40015d7fab31a5ca0ce3c14fbf29dc73b325528a8939d30d10cb44a9da";
  };
