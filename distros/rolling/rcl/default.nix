...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl/10.2.6-1.tar.gz";
    name = "10.2.6-1.tar.gz";
    sha256 = "4b7c50e1e6f3c35de45c63c7b569445b62ac1a5fb18db365450f01aa086e1107";
  };
