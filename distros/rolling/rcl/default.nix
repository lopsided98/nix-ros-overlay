...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl/10.3.2-1.tar.gz";
    name = "10.3.2-1.tar.gz";
    sha256 = "170a008e13fc6764625b0a566a1ba39d4f174ea85a446f8916fa22816a7f1867";
  };
