...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl/10.3.1-1.tar.gz";
    name = "10.3.1-1.tar.gz";
    sha256 = "c4d2cc9851fc8f9c832fa3750bafc5a9b15b58924f79ed64eb08a967f6c00e0b";
  };
