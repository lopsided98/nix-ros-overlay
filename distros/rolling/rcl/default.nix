...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl/10.2.7-1.tar.gz";
    name = "10.2.7-1.tar.gz";
    sha256 = "d80f43e8023a4320e225f27c4c2f3c158d3d1f7afc025c39ba93cbd5fd4af1e3";
  };
