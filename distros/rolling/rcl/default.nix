...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl/10.4.1-1.tar.gz";
    name = "10.4.1-1.tar.gz";
    sha256 = "5acd0e61503cd1aa92bbfc5545bd4fdf68f0b0aab2c65fbe9bfe53c36e4916b5";
  };
