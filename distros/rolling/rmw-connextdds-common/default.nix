...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_connextdds-release/archive/release/rolling/rmw_connextdds_common/1.2.5-1.tar.gz";
    name = "1.2.5-1.tar.gz";
    sha256 = "5c8a2e7b937aad45eb40f68f5ee37e50534bed60547a7fcb8cdeda88a53ad533";
  };
