...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_connextdds-release/archive/release/rolling/rmw_connextdds_common/1.2.2-1.tar.gz";
    name = "1.2.2-1.tar.gz";
    sha256 = "fae419d213607418660e418ba85f1f4af021d2153d118917d2f8cbf53f8379ea";
  };
