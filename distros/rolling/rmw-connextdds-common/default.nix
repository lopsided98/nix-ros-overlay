...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_connextdds-release/archive/release/rolling/rmw_connextdds_common/1.2.3-1.tar.gz";
    name = "1.2.3-1.tar.gz";
    sha256 = "87c268d1aa7371ea5be37103fde9e895c000e066b059f5942afc21248cc81a49";
  };
