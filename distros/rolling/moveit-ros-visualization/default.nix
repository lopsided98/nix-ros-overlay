...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_ros_visualization/2.9.0-2.tar.gz";
    name = "2.9.0-2.tar.gz";
    sha256 = "ffb601c9aa27500f8597bc6236054b6d510b6341fecd8b70ba5374dd457a1dec";
  };
