...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_ros_visualization/2.8.0-2.tar.gz";
    name = "2.8.0-2.tar.gz";
    sha256 = "2dc8d624b90097d8d688161a5f7c2fc3762cd24a252fd9f1a55ec8a4ce297d2e";
  };
