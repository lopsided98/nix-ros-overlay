...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gazebo_ros2_control-release/archive/release/rolling/gazebo_ros2_control/0.7.0-1.tar.gz";
    name = "0.7.0-1.tar.gz";
    sha256 = "f6f3f825e5c65b9d48a4f4c6ca7636dd7bad886d65fe1f22625bb30ffdfec0e6";
  };
