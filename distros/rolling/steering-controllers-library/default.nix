...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/steering_controllers_library/4.4.0-1.tar.gz";
    name = "4.4.0-1.tar.gz";
    sha256 = "b09ae46f0158945ebace62c547a6efc135a88941da09f4117bb1485a11fb42ac";
  };
