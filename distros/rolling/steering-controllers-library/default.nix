...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/steering_controllers_library/6.3.0-1.tar.gz";
    name = "6.3.0-1.tar.gz";
    sha256 = "0ac76b3f689a3d193cf510ebbe5c2550f89fd1083933ae9a1b3d11e0c43450a4";
  };
