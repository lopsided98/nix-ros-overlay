...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/steering_controllers_library/4.6.0-2.tar.gz";
    name = "4.6.0-2.tar.gz";
    sha256 = "386366881ae8bd64c65642a5af4d5f03c4f3f258db69892c345312a272881c9c";
  };
