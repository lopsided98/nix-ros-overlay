...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/steering_controllers_library/4.17.0-1.tar.gz";
    name = "4.17.0-1.tar.gz";
    sha256 = "f54c9ba4c37c0747e5e8001efabb5820e545755f163e0909c9abd2b5bc434d7c";
  };
