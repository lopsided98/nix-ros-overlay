...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/libcamera-release/archive/release/rolling/libcamera/0.5.2-3.tar.gz";
    name = "0.5.2-3.tar.gz";
    sha256 = "67e514717564ede340fe4c305f270cd8bb7c0b8bbf6460ef78c6a70e0b518249";
  };
