...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/libcamera-release/archive/release/rolling/libcamera/0.7.1-2.tar.gz";
    name = "0.7.1-2.tar.gz";
    sha256 = "821d41da8c092e1998b1e350ad0277cb90b19512c2e6a6c56e68b77135ad486b";
  };
