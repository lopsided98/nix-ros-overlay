...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/rolling/mrpt_map_server/2.2.4-1.tar.gz";
    name = "2.2.4-1.tar.gz";
    sha256 = "13072695c4e58dbdd3878028b350abcf9dc2c86cccd7e992711708fb7d486d00";
  };
