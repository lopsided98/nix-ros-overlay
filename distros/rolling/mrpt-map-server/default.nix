...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/rolling/mrpt_map_server/2.4.0-2.tar.gz";
    name = "2.4.0-2.tar.gz";
    sha256 = "fbff95c98214e4ed53a289049a6570e79530b49780a88fbda59c083ca8da2ad0";
  };
