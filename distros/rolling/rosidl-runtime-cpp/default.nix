...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/rolling/rosidl_runtime_cpp/5.1.2-1.tar.gz";
    name = "5.1.2-1.tar.gz";
    sha256 = "c135f1ff7df4378b7fcc7c0879fbdc39aa5ee25885f9e13f510b3f127f72fbcc";
  };
