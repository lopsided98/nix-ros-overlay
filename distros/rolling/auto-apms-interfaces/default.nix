...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoapms-release/archive/release/rolling/auto_apms_interfaces/1.4.2-1.tar.gz";
    name = "1.4.2-1.tar.gz";
    sha256 = "11ec304b0f1a78aa885cdabe9884c9710cf9ccb721059b65aa96fda70946747d";
  };
