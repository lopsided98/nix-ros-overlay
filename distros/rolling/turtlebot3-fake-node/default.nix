...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/turtlebot3_simulations-release/archive/release/rolling/turtlebot3_fake_node/2.3.7-1.tar.gz";
    name = "2.3.7-1.tar.gz";
    sha256 = "3c1fa9ce149fa5acd974edb9878becca6ba545175fb215e26d0537a3c8666b94";
  };
