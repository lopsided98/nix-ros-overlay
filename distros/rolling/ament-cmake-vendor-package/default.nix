...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_vendor_package/2.8.5-1.tar.gz";
    name = "2.8.5-1.tar.gz";
    sha256 = "7d79cf28380565cb8fd4acc56545c907fc53d11f048f7a6a69a5b6e3b3c8db2f";
  };
