...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_vendor_package/2.8.6-1.tar.gz";
    name = "2.8.6-1.tar.gz";
    sha256 = "7b067501823d31b714599ef702ccd3e03654c613e571c781b155925724272248";
  };
