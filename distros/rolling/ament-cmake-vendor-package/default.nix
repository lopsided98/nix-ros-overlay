...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_vendor_package/2.8.7-2.tar.gz";
    name = "2.8.7-2.tar.gz";
    sha256 = "ecb2aa4c5c8d33fa087042a58e6b305c9ba93413b27d7f4efd69f96110537e25";
  };
