...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_vendor_package/2.8.3-1.tar.gz";
    name = "2.8.3-1.tar.gz";
    sha256 = "8fa659321e67e5da5ce6d9e21897b13e9c40345146ee393cca439b57fdf5e081";
  };
