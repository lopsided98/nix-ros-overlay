...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_python-release/archive/release/rolling/rosidl_generator_py/0.22.0-1.tar.gz";
    name = "0.22.0-1.tar.gz";
    sha256 = "074504bed4615d9e929acb2ac0f0675ba3123b1b40204e77c486b5d7a3670a5b";
  };
