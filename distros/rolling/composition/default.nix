...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/rolling/composition/0.37.5-1.tar.gz";
    name = "0.37.5-1.tar.gz";
    sha256 = "204bb88d4ce96ba6bdab58cf4caa3d4114ed3606a9e7782e50368a99be5cf9bf";
  };
