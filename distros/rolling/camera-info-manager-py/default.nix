...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_common-release/archive/release/rolling/camera_info_manager_py/6.4.7-1.tar.gz";
    name = "6.4.7-1.tar.gz";
    sha256 = "884422e22bb0d961d4c0edda77d7f77933327a150db1c2305c8d51e4368570ad";
  };
