...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/tricycle_steering_controller/4.9.0-1.tar.gz";
    name = "4.9.0-1.tar.gz";
    sha256 = "4c1498148018516285e64e69257122e7e914ff898e4d1cd15757e9a3d1814990";
  };
