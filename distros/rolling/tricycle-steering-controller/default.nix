...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/rolling/tricycle_steering_controller/6.6.0-2.tar.gz";
    name = "6.6.0-2.tar.gz";
    sha256 = "fd6a72370aaefef18e1d5e7f604dc6cbb752ce7ed800f069ee9772cd3a9799b9";
  };
