...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fastdds-release/archive/release/rolling/fastdds/3.4.1-1.tar.gz";
    name = "3.4.1-1.tar.gz";
    sha256 = "bbb7c1b96813c030d6c297d624154739ceeff5f47a810dee6ed6aec5e92780bb";
  };
