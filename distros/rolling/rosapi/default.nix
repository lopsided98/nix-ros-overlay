...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/rolling/rosapi/4.0.0-1.tar.gz";
    name = "4.0.0-1.tar.gz";
    sha256 = "e06530a6846284b2fd08eb1cfdcdedda2f2241adc35a83b8a593be44ce60d983";
  };
