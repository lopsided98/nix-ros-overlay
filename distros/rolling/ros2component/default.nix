...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2component/0.40.6-2.tar.gz";
    name = "0.40.6-2.tar.gz";
    sha256 = "c87b77e77c01a465e6e9b59cff8e07418f85134b0cbd86547dd525c09ded0a31";
  };
