...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2component/0.42.0-1.tar.gz";
    name = "0.42.0-1.tar.gz";
    sha256 = "16be4159183d7ae6bd00481d61858ead0dddfbd377031bcbcee19d7be62a95e7";
  };
