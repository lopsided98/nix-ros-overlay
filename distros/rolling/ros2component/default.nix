...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2component/0.41.1-1.tar.gz";
    name = "0.41.1-1.tar.gz";
    sha256 = "705062810d15c88074d64bf51846b210e24ef88e2e969ab751ecfc7945331077";
  };
