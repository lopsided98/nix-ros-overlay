...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2component/0.30.1-1.tar.gz";
    name = "0.30.1-1.tar.gz";
    sha256 = "50a4ecec89b0dce60945a4b181485bea8aab3ae0639daa9872d2afb110bb4b40";
  };
