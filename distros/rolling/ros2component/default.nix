...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2component/0.39.1-1.tar.gz";
    name = "0.39.1-1.tar.gz";
    sha256 = "5f80b67a26bb8574742c968bb7b68e5b15b0462705dc99e024aaded3010a43ef";
  };
