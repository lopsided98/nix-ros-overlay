...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2component/0.41.0-1.tar.gz";
    name = "0.41.0-1.tar.gz";
    sha256 = "efbc1a79bf2a841f26e6ac8f2398e9c9ecda6278fea779302826ffbc5ba8deef";
  };
