...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/point_cloud_msg_wrapper-release/archive/release/rolling/point_cloud_msg_wrapper/1.0.7-5.tar.gz";
    name = "1.0.7-5.tar.gz";
    sha256 = "34b4fd4c76679886fe09515ad4a76a48ecc851a6d5cd1c83b69aaa0ff05c27b8";
  };
