...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt-release/archive/release/rolling/rqt_py_common/1.10.3-1.tar.gz";
    name = "1.10.3-1.tar.gz";
    sha256 = "bc46e6c00b01239497d0134faa1c8d3415f0a8ea96597b98b4a5bc03d269d2d7";
  };
