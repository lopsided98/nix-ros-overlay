...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt-release/archive/release/rolling/rqt_py_common/1.10.2-1.tar.gz";
    name = "1.10.2-1.tar.gz";
    sha256 = "f1f3096758e5b47b839376560199d7f2ed6fef82e2d7738284cdba67a90dfcce";
  };
