...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/play_motion2-release/archive/release/rolling/play_motion2/1.8.4-2.tar.gz";
    name = "1.8.4-2.tar.gz";
    sha256 = "c17acfff15476aa07980b79b53353be8efcc5cf4d46a3fc3e393a230c9960e1d";
  };
