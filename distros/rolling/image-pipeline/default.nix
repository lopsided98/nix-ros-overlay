...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/rolling/image_pipeline/8.0.1-1.tar.gz";
    name = "8.0.1-1.tar.gz";
    sha256 = "bcf3edae1071225d53a397c72334f5f96b30cbbb0c39fd280b410d1680159dcc";
  };
