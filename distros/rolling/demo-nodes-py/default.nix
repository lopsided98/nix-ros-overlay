...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/rolling/demo_nodes_py/0.38.0-1.tar.gz";
    name = "0.38.0-1.tar.gz";
    sha256 = "52adb0cee57676714e86402e3751892d05b4d75636ae7434fcaef74fd3c76f4a";
  };
