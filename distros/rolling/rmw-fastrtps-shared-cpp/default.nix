...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/rolling/rmw_fastrtps_shared_cpp/9.6.0-1.tar.gz";
    name = "9.6.0-1.tar.gz";
    sha256 = "88035cf208903649a7c121a90e909afd90af28b9a47a9ad249a8c47b25fd5204";
  };
