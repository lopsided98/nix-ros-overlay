...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/rolling/rmw_fastrtps_shared_cpp/7.0.0-1.tar.gz";
    name = "7.0.0-1.tar.gz";
    sha256 = "c63cc02ea1be304db5e83c494faa15d2240fbcc2c3b959d3f902e75520d7fb1c";
  };
