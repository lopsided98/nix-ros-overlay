...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_sensors-release/archive/release/rolling/mrpt_sensor_imu_taobotics/0.2.4-1.tar.gz";
    name = "0.2.4-1.tar.gz";
    sha256 = "4a7fc290cabe9a760ff21d375d7a171c6d9b4c491cf84ea313e36a9a69820576";
  };
