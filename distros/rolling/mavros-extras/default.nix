...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mavros-release/archive/release/rolling/mavros_extras/2.4.0-2.tar.gz";
    name = "2.4.0-2.tar.gz";
    sha256 = "071fbf9dfe5f86cbe6c5c4d00604b8e42ca442016eaa54e605645417da96454c";
  };
