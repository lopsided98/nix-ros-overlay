...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mavros-release/archive/release/rolling/mavros_extras/2.14.0-2.tar.gz";
    name = "2.14.0-2.tar.gz";
    sha256 = "3174d9c2ef056a747a070b63ccdeebae9250206627e9b3f79cb3df986516bc2a";
  };
