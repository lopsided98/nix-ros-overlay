...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/generate_parameter_library-release/archive/release/rolling/parameter_traits/0.3.3-1.tar.gz";
    name = "0.3.3-1.tar.gz";
    sha256 = "c9195aa4ff4ca6c531b174a5aea9751ba50cd8c2bbb7557c64b190644c234a78";
  };
