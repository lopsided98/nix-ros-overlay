...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_publisher-release/archive/release/rolling/rqt_publisher/1.10.1-1.tar.gz";
    name = "1.10.1-1.tar.gz";
    sha256 = "930323e062b3fa5a05649d1ba393603c4544afd7260fafd625106adcde453b93";
  };
