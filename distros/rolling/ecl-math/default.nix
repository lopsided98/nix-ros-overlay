...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_math/1.2.1-3.tar.gz";
    name = "1.2.1-3.tar.gz";
    sha256 = "a978ba17595ba7b370c092ccace4decbf672e8806400f56859d7664ad0eff4b6";
  };
