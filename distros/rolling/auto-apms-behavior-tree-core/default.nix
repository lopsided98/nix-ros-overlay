...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoapms-release/archive/release/rolling/auto_apms_behavior_tree_core/1.4.2-1.tar.gz";
    name = "1.4.2-1.tar.gz";
    sha256 = "3d4241a5d006e728a2c00ad1b55aba9f2a212fadfc54238930a5c8753a2563d7";
  };
