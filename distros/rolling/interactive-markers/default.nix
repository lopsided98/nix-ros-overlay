...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/interactive_markers-release/archive/release/rolling/interactive_markers/2.8.3-2.tar.gz";
    name = "2.8.3-2.tar.gz";
    sha256 = "e769f0be8b2c413d2a5e657ba1fd560ea45ea34fee53752ad5332cdcbed67868";
  };
