...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/interactive_markers-release/archive/release/rolling/interactive_markers/2.6.1-1.tar.gz";
    name = "2.6.1-1.tar.gz";
    sha256 = "ed5166f0f4853149987eed9615c6e73cdc1343894c4aea64a7f4e83f4808a9dc";
  };
