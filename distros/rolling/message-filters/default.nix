...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_message_filters-release/archive/release/rolling/message_filters/7.3.3-1.tar.gz";
    name = "7.3.3-1.tar.gz";
    sha256 = "a3fcab072b12f9a7e5721d6df9959995a64ba0fe3a3440a0c102160840ba385b";
  };
