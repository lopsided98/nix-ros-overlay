...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_message_filters-release/archive/release/rolling/message_filters/7.3.8-1.tar.gz";
    name = "7.3.8-1.tar.gz";
    sha256 = "14030ec032d7e7f0e07a7044dc7013d275d70b3570c9b7163a272aae4edc47c1";
  };
