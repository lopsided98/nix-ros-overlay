...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_message_filters-release/archive/release/rolling/message_filters/7.3.4-1.tar.gz";
    name = "7.3.4-1.tar.gz";
    sha256 = "2d7cc67dff5e4e136af59822d25402cfeabda35cd47cb905b5149dd94433a2aa";
  };
