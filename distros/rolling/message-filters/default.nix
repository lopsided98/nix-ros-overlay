...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_message_filters-release/archive/release/rolling/message_filters/7.3.7-1.tar.gz";
    name = "7.3.7-1.tar.gz";
    sha256 = "d8fe4a87f78f3623060e56094c841dc08a0036f9b9d467b9412c06ba6d0189ed";
  };
