...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_message_filters-release/archive/release/rolling/message_filters/8.0.1-1.tar.gz";
    name = "8.0.1-1.tar.gz";
    sha256 = "5ff50de2e82cafb80c6ed32f74cb4f3652864a774b8f4431e11288af18eca400";
  };
