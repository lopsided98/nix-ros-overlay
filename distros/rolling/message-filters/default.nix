...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_message_filters-release/archive/release/rolling/message_filters/8.0.2-1.tar.gz";
    name = "8.0.2-1.tar.gz";
    sha256 = "b05b56262ee7fa94d92eee4f8c7401f8679041c5d7e51cb685bf1b87fc4bf079";
  };
