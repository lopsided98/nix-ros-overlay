...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_message_filters-release/archive/release/rolling/message_filters/7.3.2-1.tar.gz";
    name = "7.3.2-1.tar.gz";
    sha256 = "a443799c3143c2372a6284d64a0a981563064ece8f19d42f8c060271b7b3fa93";
  };
