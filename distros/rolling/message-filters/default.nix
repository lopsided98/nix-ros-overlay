...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_message_filters-release/archive/release/rolling/message_filters/8.0.4-1.tar.gz";
    name = "8.0.4-1.tar.gz";
    sha256 = "114af7bfe3135545fd293ed0bcb03bf34947b3b698534163f628d85b56b96482";
  };
