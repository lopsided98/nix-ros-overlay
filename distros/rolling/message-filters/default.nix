...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_message_filters-release/archive/release/rolling/message_filters/8.0.3-1.tar.gz";
    name = "8.0.3-1.tar.gz";
    sha256 = "4aafbb1768ece7bffff093e0c40d4dfa5cfd14f942c40c21d3d5989281d682a0";
  };
