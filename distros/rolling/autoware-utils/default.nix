...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/rolling/autoware_utils/1.4.2-2.tar.gz";
    name = "1.4.2-2.tar.gz";
    sha256 = "ac56f7b41320dea6159e6ea1d4a97d4d9e74be46b9406113c9b19917a08d1105";
  };
