...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_canopen-release/archive/release/rolling/canopen_ros2_control/0.3.0-1.tar.gz";
    name = "0.3.0-1.tar.gz";
    sha256 = "b7f33dcd0489b98bbc6f4c115bb53ad91cc6cbf9f1b9ac35029c319aceb81c90";
  };
