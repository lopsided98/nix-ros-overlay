...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_uncrustify/0.21.2-1.tar.gz";
    name = "0.21.2-1.tar.gz";
    sha256 = "0b006ede5c2282dc242cb70959ee115496d575a16ff4560f09cdccee80b741e8";
  };
