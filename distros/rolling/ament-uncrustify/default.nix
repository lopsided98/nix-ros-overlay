...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_uncrustify/0.20.3-1.tar.gz";
    name = "0.20.3-1.tar.gz";
    sha256 = "89a080eaef4eb623da4b1b47edf062c23a3569e3011ae47d95c470a596f5f99c";
  };
