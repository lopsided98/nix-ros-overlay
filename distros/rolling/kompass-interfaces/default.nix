...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/kompass-release/archive/release/rolling/kompass_interfaces/0.4.1-1.tar.gz";
    name = "0.4.1-1.tar.gz";
    sha256 = "1a0c73b8fe149689278c6fa67ed2f5249a61b8a45c7fa5ad1e16ade946eac6d0";
  };
