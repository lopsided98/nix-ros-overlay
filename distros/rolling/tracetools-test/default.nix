...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_tracing-release/archive/release/rolling/tracetools_test/8.8.0-1.tar.gz";
    name = "8.8.0-1.tar.gz";
    sha256 = "ea29056edd58f8d37fd96b2a42f6c5deb849c43deb4094473eb424296983ee2d";
  };
