...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_xmllint/0.21.2-1.tar.gz";
    name = "0.21.2-1.tar.gz";
    sha256 = "18355e36b6ef42cdb517d1b9b6fceaa1f11273953c2df48137e29b5c96d43fe0";
  };
