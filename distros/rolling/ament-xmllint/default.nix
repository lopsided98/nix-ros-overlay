...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_xmllint/0.15.0-1.tar.gz";
    name = "0.15.0-1.tar.gz";
    sha256 = "0cd3a1b8df839153b5a9d694734d8fcafbaaf8485ea01261b92e958ad2cdb014";
  };
