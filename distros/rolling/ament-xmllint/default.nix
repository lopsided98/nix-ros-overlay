...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/rolling/ament_xmllint/0.14.0-1.tar.gz";
    name = "0.14.0-1.tar.gz";
    sha256 = "13a9ea2475adc069dd99097426c7c94acd6c15a41c932ece52dbfc81d0cd28f1";
  };
