...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/rolling/moveit_resources_prbt_ikfast_manipulator_plugin/2.14.1-2.tar.gz";
    name = "2.14.1-2.tar.gz";
    sha256 = "8110aa14a74fbddacc3a87f9f295d5ac82eb574963d733104e52c0f6597b494a";
  };
