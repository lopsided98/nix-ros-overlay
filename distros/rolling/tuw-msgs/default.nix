...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/tuw_msgs-release/archive/release/rolling/tuw_msgs/0.2.6-2.tar.gz";
    name = "0.2.6-2.tar.gz";
    sha256 = "4fce9fd3793c1cfc027cdaa22e5db97f2d2460a343f6dd048a7b227a4c1a5247";
  };
