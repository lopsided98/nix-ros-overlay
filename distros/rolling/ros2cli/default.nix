...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/rolling/ros2cli/0.30.1-1.tar.gz";
    name = "0.30.1-1.tar.gz";
    sha256 = "a4b215e7bc98c25e42c8f19e02704223866febc2e9dc46c0eeb63cde2b64b8ef";
  };
