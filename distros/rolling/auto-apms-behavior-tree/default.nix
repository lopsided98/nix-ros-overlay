...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoapms-release/archive/release/rolling/auto_apms_behavior_tree/1.4.2-1.tar.gz";
    name = "1.4.2-1.tar.gz";
    sha256 = "854458580048280264a29e139e380cd2578e3a6518efdb0d43c0bcb26b22fbbe";
  };
