...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_py/0.45.4-1.tar.gz";
    name = "0.45.4-1.tar.gz";
    sha256 = "a95fd246d431537ddfcb802936528a6c7197f39859732316b21ca201f3a0405a";
  };
