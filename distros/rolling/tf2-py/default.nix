...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/rolling/tf2_py/0.46.4-1.tar.gz";
    name = "0.46.4-1.tar.gz";
    sha256 = "0b800280038c3cad387a67b38540740e10da811b1a92c57486f949dd454bdf3f";
  };
