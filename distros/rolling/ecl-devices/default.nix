...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/rolling/ecl_devices/1.2.1-4.tar.gz";
    name = "1.2.1-4.tar.gz";
    sha256 = "2895477e02e65ecc72edf5ff8672f3cf4013990f5fa2c091a71a4bc7a468db5a";
  };
