...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_google_benchmark/2.8.6-1.tar.gz";
    name = "2.8.6-1.tar.gz";
    sha256 = "29ca29e1098c8d776f853970b7bc28d35b8d7ec577feff2bdea32c2d9a293bb1";
  };
