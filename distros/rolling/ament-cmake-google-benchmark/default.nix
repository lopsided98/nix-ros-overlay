...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_google_benchmark/2.8.7-1.tar.gz";
    name = "2.8.7-1.tar.gz";
    sha256 = "97e402bdd9f3f3a1b64266e53386cf88adb42dd4f5cea6b0fc6d1e334ccc98ec";
  };
