...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_google_benchmark/2.9.2-1.tar.gz";
    name = "2.9.2-1.tar.gz";
    sha256 = "202f0a2bbf9319111d53b616f9a1ba75ff4031a8a28b11ca2e47deae7cf0436f";
  };
