...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/zed-ros2-interfaces-release/archive/release/rolling/zed_msgs/5.2.1-1.tar.gz";
    name = "5.2.1-1.tar.gz";
    sha256 = "c6fcef1a7da7da21c033f0d7ac6ae13300da9a87d5e2b909c4432d097f5b19b4";
  };
