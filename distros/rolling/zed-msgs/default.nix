...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/zed-ros2-interfaces-release/archive/release/rolling/zed_msgs/5.1.1-1.tar.gz";
    name = "5.1.1-1.tar.gz";
    sha256 = "fb5a4be4a90d899fb4ea3fcfa45e123e4729d4c338775290e22fef7fed8ad643";
  };
