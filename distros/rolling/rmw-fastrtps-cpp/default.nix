...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/rolling/rmw_fastrtps_cpp/7.0.0-1.tar.gz";
    name = "7.0.0-1.tar.gz";
    sha256 = "709de3a0933a61ff504be83858c76c2332ba38b683ec12fc256881c69f190a22";
  };
