...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_bag-release/archive/release/rolling/rqt_bag_plugins/2.3.5-1.tar.gz";
    name = "2.3.5-1.tar.gz";
    sha256 = "a9928ffdea677add32d1f8a3f4547620ea0738bedc7a85e84b865f483e2cb625";
  };
