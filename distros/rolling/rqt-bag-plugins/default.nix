...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_bag-release/archive/release/rolling/rqt_bag_plugins/2.2.2-1.tar.gz";
    name = "2.2.2-1.tar.gz";
    sha256 = "2b872609d2f71cc3b9d13eef40e779b56bf00c1ca4378447ca4596f86f817869";
  };
