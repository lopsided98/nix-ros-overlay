...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_bag-release/archive/release/rolling/rqt_bag_plugins/2.3.4-1.tar.gz";
    name = "2.3.4-1.tar.gz";
    sha256 = "3c7fca5077a7c6d2a87014d5b24ee62002e9af78c73923227e0695378077acaf";
  };
