...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit_task_constructor-release/archive/release/rolling/moveit_task_constructor_capabilities/0.1.4-1.tar.gz";
    name = "0.1.4-1.tar.gz";
    sha256 = "d9373885fc96eea3cc3d8bf6ce7a4f93282b197fb2f38ed688bae6b3b8d867db";
  };
