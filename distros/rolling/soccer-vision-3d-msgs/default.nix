...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/soccer_interfaces-release/archive/release/rolling/soccer_vision_3d_msgs/1.0.0-2.tar.gz";
    name = "1.0.0-2.tar.gz";
    sha256 = "531db403e50f014b7460beae4be68ecfb2fcdec8f463e0c152932e75a1333ab2";
  };
