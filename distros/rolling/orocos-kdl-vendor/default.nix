...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/orocos_kdl_vendor-release/archive/release/rolling/orocos_kdl_vendor/0.8.0-2.tar.gz";
    name = "0.8.0-2.tar.gz";
    sha256 = "96100ccd230eecc829343746b96472f8722985c8951d24b8af2fa10f2da6b99f";
  };
