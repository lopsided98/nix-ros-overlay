...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/rolling/ffw_bringup/1.1.14-1.tar.gz";
    name = "1.1.14-1.tar.gz";
    sha256 = "e4a095fc08375fbefc996dd8dee3c881ba0d14551f9a4cc0eec37ad5050a2d86";
  };
