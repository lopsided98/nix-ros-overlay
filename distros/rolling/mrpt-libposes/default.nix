...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/rolling/mrpt_libposes/2.15.16-1.tar.gz";
    name = "2.15.16-1.tar.gz";
    sha256 = "04f0453139fea40f2f328c830c428d3e20c8f4824d37e9bd00e6ee7d9edf0a19";
  };
