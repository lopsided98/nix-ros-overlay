...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_target_dependencies/1.5.3-2.tar.gz";
    name = "1.5.3-2.tar.gz";
    sha256 = "ff41403250e0794585aae6800750af9621f617c9e98e0796acea14853ebed478";
  };
