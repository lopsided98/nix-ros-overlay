...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_target_dependencies/2.8.3-1.tar.gz";
    name = "2.8.3-1.tar.gz";
    sha256 = "69699e1e10ad6d5e00072f752896a52ed65c2689f11e5426084ac127b7daea7d";
  };
