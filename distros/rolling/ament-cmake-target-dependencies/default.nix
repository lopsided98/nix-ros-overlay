...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_target_dependencies/2.8.4-1.tar.gz";
    name = "2.8.4-1.tar.gz";
    sha256 = "72bf620657f51d37f3ab4e7bb42c71438e923e508c1dcef0ca53b9d1a19f9cb9";
  };
