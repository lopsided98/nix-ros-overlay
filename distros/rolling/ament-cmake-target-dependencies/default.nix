...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_target_dependencies/2.7.0-1.tar.gz";
    name = "2.7.0-1.tar.gz";
    sha256 = "c76ac928fba211bb7c60dc8b9cbf23c0aa762f2a66509d1cbeb5f9301d3f0f45";
  };
