...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake_target_dependencies/1.5.2-1.tar.gz";
    name = "1.5.2-1.tar.gz";
    sha256 = "c6cef3e177c9b1b1e0ee35c615895dc35e8d7891552102a6084ec9b30eff446d";
  };
