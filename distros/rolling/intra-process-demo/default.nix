...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/rolling/intra_process_demo/0.38.0-1.tar.gz";
    name = "0.38.0-1.tar.gz";
    sha256 = "e7a1ad16411c413e923c862363bc75da0ddcceb846fc5a2d33a718c56d4f4557";
  };
