...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/rolling/webots_ros2_tiago/2025.0.1-1.tar.gz";
    name = "2025.0.1-1.tar.gz";
    sha256 = "b60d9850ee22856fc682ccd4ff5cdda343b6af669978edb72ec153725c9bc284";
  };
