...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake/2.8.4-1.tar.gz";
    name = "2.8.4-1.tar.gz";
    sha256 = "180649978e31a721d7981daa1db0db5d9606f48b1e4a1cb71ed9008381f624cd";
  };
