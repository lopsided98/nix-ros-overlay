...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake/2.8.2-1.tar.gz";
    name = "2.8.2-1.tar.gz";
    sha256 = "58d4cb1801b84fc52c8db7926559a517bdbf5449196886be08f59c14f51a4a6f";
  };
