...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake/2.8.1-1.tar.gz";
    name = "2.8.1-1.tar.gz";
    sha256 = "246deaeae93accbae6c1f98b777b5f0d86033dcfba30bb5e8e9c6ef8f3ae5353";
  };
