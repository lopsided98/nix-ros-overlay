...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake/1.5.3-2.tar.gz";
    name = "1.5.3-2.tar.gz";
    sha256 = "6256a50921d8c855fd0c5cf674e8e79bf9c1e87f00605ddef2daf1a77d0c14e2";
  };
