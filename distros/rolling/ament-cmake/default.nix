...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/rolling/ament_cmake/2.8.3-1.tar.gz";
    name = "2.8.3-1.tar.gz";
    sha256 = "ef8c2b145dd117b3e98bfc01d3d5f3197697796e74913215b03320734cf5c9ff";
  };
