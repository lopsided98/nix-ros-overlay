...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/pal_statistics-release/archive/release/rolling/pal_statistics/2.7.0-2.tar.gz";
    name = "2.7.0-2.tar.gz";
    sha256 = "6ac342ef181ba8a6ee6fb1f1a6b7491e2647b0672eb059fb73d9b63ac520aa77";
  };
