...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidlcpp-release/archive/release/rolling/rosidlcpp_typesupport_cpp/0.2.1-1.tar.gz";
    name = "0.2.1-1.tar.gz";
    sha256 = "25fc1a493025258d1e86b5791df77816c7507d657cd21ad3d63c015ea73e59b5";
  };
