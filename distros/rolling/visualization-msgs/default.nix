...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/common_interfaces-release/archive/release/rolling/visualization_msgs/5.9.2-2.tar.gz";
    name = "5.9.2-2.tar.gz";
    sha256 = "94788cb373d8c58c9bfeca68d3d3c9b61aeef9b0b823d1cbd13f82b885e01e52";
  };
