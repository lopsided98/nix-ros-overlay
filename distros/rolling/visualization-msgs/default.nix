...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/common_interfaces-release/archive/release/rolling/visualization_msgs/5.3.4-1.tar.gz";
    name = "5.3.4-1.tar.gz";
    sha256 = "77df8a5e59273fce0fdb2e09d3dfa4f4e6598b3995f87db8e01b611e072493fe";
  };
