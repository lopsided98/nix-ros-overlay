...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl_action/10.2.6-1.tar.gz";
    name = "10.2.6-1.tar.gz";
    sha256 = "5f1b7272161f22833ef6e45618670f73d31e1b8d2eed160f70f1e52100562810";
  };
