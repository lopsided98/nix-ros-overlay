...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl_action/10.3.1-1.tar.gz";
    name = "10.3.1-1.tar.gz";
    sha256 = "1d3b19eb7cc3eaa721dd1cb8e0d5e091269a7ecbbbc153eac1d0cdedb6c83258";
  };
