...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl_action/10.4.1-1.tar.gz";
    name = "10.4.1-1.tar.gz";
    sha256 = "7183a264ed12ed35b936ae4f84987bcfdb301000c70357d87f732198e27f6f44";
  };
