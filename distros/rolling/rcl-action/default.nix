...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/rolling/rcl_action/10.3.0-1.tar.gz";
    name = "10.3.0-1.tar.gz";
    sha256 = "70105d9105454e3c274a120bb61e1f74995bd144aed1261caf7cec4bdb1b6597";
  };
