...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/pluginlib-release/archive/release/kilted/pluginlib/5.6.1-1.tar.gz";
    name = "5.6.1-1.tar.gz";
    sha256 = "8fec449b7379734ff6a49ede53dc2b20ce1c78d9d730a83116b219cfc77c26b0";
  };
