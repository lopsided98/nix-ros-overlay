...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/kilted/launch_testing_ros/0.28.4-1.tar.gz";
    name = "0.28.4-1.tar.gz";
    sha256 = "22175302592af674a3d370975e2b6ad72357f5ecde054571431ba4af1e0af524";
  };
