...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/kilted/launch_testing_ros/0.28.7-1.tar.gz";
    name = "0.28.7-1.tar.gz";
    sha256 = "7ede5b740ec0e4ced9e2386721e650f862b838cd1e431827b7ba907f6cf82ffe";
  };
