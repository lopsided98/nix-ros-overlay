...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/kilted/ur_calibration/4.0.0-1.tar.gz";
    name = "4.0.0-1.tar.gz";
    sha256 = "580004d45ada84c51db172b2a6c67440bfffbe75b963402b8c16617928ad08d6";
  };
