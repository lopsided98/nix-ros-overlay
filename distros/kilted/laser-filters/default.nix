...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/laser_filters-release/archive/release/kilted/laser_filters/2.2.3-1.tar.gz";
    name = "2.2.3-1.tar.gz";
    sha256 = "51ef73ac010aa4717303f74003d8e2a43c4f0e2ce08b6242bc6ad89b88428778";
  };
