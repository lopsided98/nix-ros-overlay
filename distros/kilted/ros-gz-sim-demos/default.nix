...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/kilted/ros_gz_sim_demos/2.1.18-1.tar.gz";
    name = "2.1.18-1.tar.gz";
    sha256 = "f03df0230bde199fa621ae514e093220567bf10db47820e413e2b5446b077b0f";
  };
