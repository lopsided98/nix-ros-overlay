...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fuse-release/archive/release/kilted/fuse_optimizers/1.2.2-1.tar.gz";
    name = "1.2.2-1.tar.gz";
    sha256 = "55b0da9c9b876e99b1e950f81d262e23263ddab690f0f58530ee84df6eb45ad0";
  };
