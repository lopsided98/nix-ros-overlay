...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/kilted/ament_flake8/0.19.3-2.tar.gz";
    name = "0.19.3-2.tar.gz";
    sha256 = "60b0272dffb37baa2a1e1e72d215b77556999e3e52312e0a8c28082342dc8382";
  };
