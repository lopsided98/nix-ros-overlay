...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mp2p_icp-release/archive/release/kilted/mp2p_icp/2.7.0-1.tar.gz";
    name = "2.7.0-1.tar.gz";
    sha256 = "3813bbcd667c29902886d43cd3ad4b14ce13bb4e0e20f71a333433cfc3c8525a";
  };
