...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/event_image_reconstruction_fibar-release/archive/release/kilted/event_image_reconstruction_fibar/3.0.4-1.tar.gz";
    name = "3.0.4-1.tar.gz";
    sha256 = "f4b8e81ff28075b076558eeb8ed09597db7c14b163342da75f883a3b596d89df";
  };
