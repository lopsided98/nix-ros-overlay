...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/kilted/moveit_ros_planning/2.14.3-1.tar.gz";
    name = "2.14.3-1.tar.gz";
    sha256 = "097da17a305cd5f96aec2b51d134e2a35b2977ca463c244c27d1860e864b9e8b";
  };
