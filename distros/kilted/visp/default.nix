...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/visp-release/archive/release/kilted/visp/3.7.0-2.tar.gz";
    name = "3.7.0-2.tar.gz";
    sha256 = "74c8399d2f77673153c856af5fd70868b601b7b461dd6fc191b9ae845e608473";
  };
