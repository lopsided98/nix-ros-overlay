...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/hardware_interface/5.2.0-1.tar.gz";
    name = "5.2.0-1.tar.gz";
    sha256 = "ae10e38ee00e4870ff127c5c8c94652100193369e6cd9dee9f9a4be0896f9c74";
  };
