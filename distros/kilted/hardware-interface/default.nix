...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/hardware_interface/5.7.0-1.tar.gz";
    name = "5.7.0-1.tar.gz";
    sha256 = "dbef31f303966bfdb504225c28714211fe6c0c7a01356e4642ed55cc08326ddc";
  };
