...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/hardware_interface/5.11.3-1.tar.gz";
    name = "5.11.3-1.tar.gz";
    sha256 = "b15975875480cd00630276c6061c0d4b9d03e5960fccf599cb802348e22aa90d";
  };
