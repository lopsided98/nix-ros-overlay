...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/hardware_interface/5.9.0-1.tar.gz";
    name = "5.9.0-1.tar.gz";
    sha256 = "d00384cc53f3d63dbcd2c3151af602c5666681beab21e35b1ddcd329615306cd";
  };
