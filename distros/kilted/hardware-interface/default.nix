...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/hardware_interface/5.8.0-1.tar.gz";
    name = "5.8.0-1.tar.gz";
    sha256 = "c7006b98ce04cca9f53254d1b78f76dce40b548e3832c71a5d72f1d158e940b7";
  };
