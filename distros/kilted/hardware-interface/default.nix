...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/hardware_interface/5.18.1-1.tar.gz";
    name = "5.18.1-1.tar.gz";
    sha256 = "1a172dc4086cd18d84643297e5b5e8037b205d1d871123a42fa2b398dae30df7";
  };
