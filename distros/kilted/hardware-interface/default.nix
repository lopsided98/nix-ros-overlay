...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/hardware_interface/5.5.0-1.tar.gz";
    name = "5.5.0-1.tar.gz";
    sha256 = "32ef754127983509a2fbf903b8bee2bb72e2de15c2e510e883d018cffcfe2a49";
  };
