...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/hardware_interface/5.16.0-1.tar.gz";
    name = "5.16.0-1.tar.gz";
    sha256 = "2a4f4d4f159d4af75e9d7b5b1749a485fa55d3c3690decd4eb9b41d31a861e92";
  };
