...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/hardware_interface/5.15.0-1.tar.gz";
    name = "5.15.0-1.tar.gz";
    sha256 = "e3c0c83706e83684d0c5da534777e81c34e778c3b7b3211c3422be00c21edc5e";
  };
