...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/hardware_interface/5.17.0-1.tar.gz";
    name = "5.17.0-1.tar.gz";
    sha256 = "b34666447c3e6b264efaf7ed8082d0405b9092a3c6b2d3c56ea0d004f486a3bb";
  };
