...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/kilted/yasmin_factory/4.2.2-1.tar.gz";
    name = "4.2.2-1.tar.gz";
    sha256 = "f7d3fd4fa23ed953a82852effeee60a648025ed8689e6ade7eebe28163d29cd5";
  };
