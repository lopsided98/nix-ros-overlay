...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/kilted/yasmin_factory/4.2.3-1.tar.gz";
    name = "4.2.3-1.tar.gz";
    sha256 = "a49b27cbb2eab1e3cbcae539012003c97ccbc535e303e56fecb2618d497307bb";
  };
