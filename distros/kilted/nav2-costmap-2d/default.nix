...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/navigation2-release/archive/release/kilted/nav2_costmap_2d/1.4.0-1.tar.gz";
    name = "1.4.0-1.tar.gz";
    sha256 = "c0e915266771e5a49ba9c8779bf91877ca47bcbf39a0117a4ed0f0e93e43de08";
  };
  ...
  propagatedBuildInputs = [ angles geometry-msgs laser-geometry map-msgs message-filters nav-msgs nav2-msgs nav2-util nav2-voxel-grid pluginlib rclcpp rclcpp-lifecycle rmw sensor-msgs std-msgs std-srvs tf2 tf2-geometry-msgs tf2-ros tf2-sensor-msgs visualization-msgs ];
