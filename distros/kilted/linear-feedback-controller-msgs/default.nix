...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/linear-feedback-controller-msgs-release/archive/release/kilted/linear_feedback_controller_msgs/1.2.2-2.tar.gz";
    name = "1.2.2-2.tar.gz";
    sha256 = "4ba1696a77fe6bb26f0921896fa6bfefc2056e47e506dab4a4439b37d78a0569";
  };
