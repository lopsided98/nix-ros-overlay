...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_canopen-release/archive/release/kilted/canopen_proxy_driver/0.3.1-1.tar.gz";
    name = "0.3.1-1.tar.gz";
    sha256 = "8a7fba3bbf7119a8aed41696dd3729c88e70ad3b5cf40ca8e4cfe43492fdeb4f";
  };
