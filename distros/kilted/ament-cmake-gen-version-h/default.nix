...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/kilted/ament_cmake_gen_version_h/2.7.3-2.tar.gz";
    name = "2.7.3-2.tar.gz";
    sha256 = "d1695f3903775c653e4313bedb5847d595ef1218617075a6663902adcfba7589";
  };
