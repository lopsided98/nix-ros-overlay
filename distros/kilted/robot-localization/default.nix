...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/robot_localization-release/archive/release/kilted/robot_localization/3.9.2-3.tar.gz";
    name = "3.9.2-3.tar.gz";
    sha256 = "db95ad36b6c05f37eb3991eb46ae0849626e9432341cdbd6ce9db4f791063e0b";
  };
