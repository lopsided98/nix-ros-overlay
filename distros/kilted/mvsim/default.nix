...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mvsim-release/archive/release/kilted/mvsim/1.5.0-1.tar.gz";
    name = "1.5.0-1.tar.gz";
    sha256 = "2871d28f1ab91bc4c8ba020b241fbd511a09c74c4ebff442d2d1e7034491446e";
  };
