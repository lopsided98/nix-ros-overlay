...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2service/0.38.3-2.tar.gz";
    name = "0.38.3-2.tar.gz";
    sha256 = "968a3dce2eaba217aa1f40ab253bd34769b93e49bfcf17f44566f03920b8b749";
  };
