...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/kilted/depth_image_proc/6.0.11-1.tar.gz";
    name = "6.0.11-1.tar.gz";
    sha256 = "68c1fce7548b259b3676cc7b368d4e59e2f3bdb961c7928597c4ea45ac1994d3";
  };
