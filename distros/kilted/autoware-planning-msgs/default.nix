...
buildRosPackage {
  pname = "ros-kilted-autoware-planning-msgs";
  version = "1.7.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_msgs-release/archive/release/kilted/autoware_planning_msgs/1.7.0-1.tar.gz";
    name = "1.7.0-1.tar.gz";
    sha256 = "f70e638e2d03dc5be9bc02ad4a2a1a4708cd39f5b973c8b2090443b2ec70bb6f";
  };
