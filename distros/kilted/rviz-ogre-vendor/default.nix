...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_ogre_vendor/15.0.15-1.tar.gz";
    name = "15.0.15-1.tar.gz";
    sha256 = "a0423daf979362aad8c9ae5f009684ff22fe7d7f7e9b1bb180e9bed1d1fea486";
  };
