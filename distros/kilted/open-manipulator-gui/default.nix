...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/kilted/open_manipulator_gui/4.0.5-1.tar.gz";
    name = "4.0.5-1.tar.gz";
    sha256 = "e4bbc7c3d829dca6b10bfdfb804793a9ffe428cace8ae27bf7bcf283dea4a46f";
  };
