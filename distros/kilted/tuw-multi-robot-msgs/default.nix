...
buildRosPackage {
  pname = "ros-kilted-tuw-multi-robot-msgs";
  version = "0.2.5-r2";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/tuw_msgs-release/archive/release/kilted/tuw_multi_robot_msgs/0.2.5-2.tar.gz";
    name = "0.2.5-2.tar.gz";
    sha256 = "170533a92c70bbcec0a8ea6bbac4fba9cb0b008907c8375c92a963cfb7b818da";
  };
