...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libhwdrivers/2.14.10-1.tar.gz";
    name = "2.14.10-1.tar.gz";
    sha256 = "5980d2ff88158e312cb292b6c26992a296083de616e07574307db40ae4ce8a1d";
  };
