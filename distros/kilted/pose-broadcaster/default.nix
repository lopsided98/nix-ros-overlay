...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/pose_broadcaster/5.9.0-1.tar.gz";
    name = "5.9.0-1.tar.gz";
    sha256 = "4435605d0d9470ed003362c1e84a5f9f170d1135fae1a5dad975913872cf7aca";
  };
