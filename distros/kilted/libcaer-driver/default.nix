...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/libcaer_driver-release/archive/release/kilted/libcaer_driver/1.5.2-1.tar.gz";
    name = "1.5.2-1.tar.gz";
    sha256 = "27f7b851e1e7b5db11c3175a460acfb66e797fd602a911166d21e26ccda5434c";
  };
