...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/kilted/mrpt_pointcloud_pipeline/2.2.4-1.tar.gz";
    name = "2.2.4-1.tar.gz";
    sha256 = "50348ba893f87cfe822ad7e0af5a678232e0e9be982a854117cb88187e5f11a7";
  };
