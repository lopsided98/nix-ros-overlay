...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/kilted/om_spring_actuator_controller/4.0.5-1.tar.gz";
    name = "4.0.5-1.tar.gz";
    sha256 = "39dd55fa3a82783d1b32cad5501d15d9a4a0dc293ba7a8e1cfdc50debd526137";
  };
