...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/kilted/om_spring_actuator_controller/4.0.6-1.tar.gz";
    name = "4.0.6-1.tar.gz";
    sha256 = "53ee3268829b3167b73122a1c23688e95d06b119dc1a93f4ed9715a3adc3761a";
  };
