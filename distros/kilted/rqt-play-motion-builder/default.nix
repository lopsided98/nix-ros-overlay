...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/play_motion_builder-release/archive/release/kilted/rqt_play_motion_builder/1.4.1-1.tar.gz";
    name = "1.4.1-1.tar.gz";
    sha256 = "a27fca44d1cc4526a98186f1ddcd306521ca69b6c4b75cc3cdb640c1495c899d";
  };
