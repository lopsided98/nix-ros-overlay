...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ign_ros2_control-release/archive/release/kilted/gz_ros2_control_demos/2.0.10-1.tar.gz";
    name = "2.0.10-1.tar.gz";
    sha256 = "898c3ff222bb1d99f035463598329b60ac9fac238bf95f21c566f558fcdcf7da";
  };
