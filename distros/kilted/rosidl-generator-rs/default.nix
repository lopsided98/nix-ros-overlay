...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_rust-release/archive/release/kilted/rosidl_generator_rs/0.4.12-1.tar.gz";
    name = "0.4.12-1.tar.gz";
    sha256 = "76dc559a827cb586607d7b32cdd87f3dc587cc087bf9024b78a4f80fba63f61f";
  };
