...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_rust-release/archive/release/kilted/rosidl_generator_rs/0.4.10-1.tar.gz";
    name = "0.4.10-1.tar.gz";
    sha256 = "cce580e29b24fa90b07bde5480f6af66d65f187cc499b89da64df66d660ab814";
  };
