...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit_msgs-release/archive/release/kilted/moveit_msgs/2.7.1-1.tar.gz";
    name = "2.7.1-1.tar.gz";
    sha256 = "86cc0027ec403bba0f559d46aa390dbcc605519ff978f07f517159f4ee758b07";
  };
