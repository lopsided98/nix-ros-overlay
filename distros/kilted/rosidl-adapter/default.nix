...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/kilted/rosidl_adapter/4.9.6-1.tar.gz";
    name = "4.9.6-1.tar.gz";
    sha256 = "12aeddd6afbea9cf295ae4cc39f344a15ed474ad86fcae384fd76df423e7d64b";
  };
