...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/kilted/rosbridge_library/3.0.2-1.tar.gz";
    name = "3.0.2-1.tar.gz";
    sha256 = "1c0a33678cb356e3de2c679027ebc1ee9dd788de8ac0cf9b428faaee16308747";
  };
