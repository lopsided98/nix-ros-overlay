...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/kilted/multires_image/2.6.1-1.tar.gz";
    name = "2.6.1-1.tar.gz";
    sha256 = "5d0db42d0fd1dc8e63138e148af2ff48982ceffb903d429a32a08742c2a6be54";
  };
