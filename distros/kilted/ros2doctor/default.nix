...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2doctor/0.38.2-1.tar.gz";
    name = "0.38.2-1.tar.gz";
    sha256 = "31038546b7a776c5a071ed5a7f7ff3b204b3427bbc6387d5611eb794d7cf1b86";
  };
  ...
  propagatedBuildInputs = [ ament-index-python python3Packages.catkin-pkg python3Packages.psutil python3Packages.rosdistro rclpy ros-environment ros2cli std-msgs ];
