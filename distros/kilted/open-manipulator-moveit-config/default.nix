...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/kilted/open_manipulator_moveit_config/4.0.6-1.tar.gz";
    name = "4.0.6-1.tar.gz";
    sha256 = "6bb827665758c8692ed1c9d38b7586fad96e72d59921809b661b82c552d80d56";
  };
