...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/kilted/open_manipulator_moveit_config/4.1.2-1.tar.gz";
    name = "4.1.2-1.tar.gz";
    sha256 = "fe6f4922cbe590ef0e95b56dc8fda937cf03fbe4401b6c01d8451fd06d831373";
  };
