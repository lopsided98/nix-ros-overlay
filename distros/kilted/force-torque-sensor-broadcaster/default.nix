...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/force_torque_sensor_broadcaster/5.13.1-1.tar.gz";
    name = "5.13.1-1.tar.gz";
    sha256 = "bc7af9a12bb6f59b8432b5c223abd31ea82b1b891bcd653d83068f6f17df12b4";
  };
