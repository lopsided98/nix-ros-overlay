...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/force_torque_sensor_broadcaster/5.9.0-1.tar.gz";
    name = "5.9.0-1.tar.gz";
    sha256 = "ecacf154df5abfbf0cb53aaa66abbc46ac12325c12fddf04288e266114f447bd";
  };
