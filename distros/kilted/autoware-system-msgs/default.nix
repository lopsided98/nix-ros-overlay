...
buildRosPackage {
  pname = "ros-kilted-autoware-system-msgs";
  version = "1.7.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_msgs-release/archive/release/kilted/autoware_system_msgs/1.7.0-1.tar.gz";
    name = "1.7.0-1.tar.gz";
    sha256 = "9b922b8c17f2ab4524238f1420de69af94ecf9c44dcc614ff8113fe2271ed6de";
  };
