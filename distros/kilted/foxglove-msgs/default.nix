...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/foxglove_bridge-release/archive/release/kilted/foxglove_msgs/3.2.3-1.tar.gz";
    name = "3.2.3-1.tar.gz";
    sha256 = "c1c7fcfe893ec62378bf15d8b4c2b3bff53318cec9d81a765f1921e5bb434691";
  };
