...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/openeb_vendor-release/archive/release/kilted/openeb_vendor/2.0.3-1.tar.gz";
    name = "2.0.3-1.tar.gz";
    sha256 = "f7761a513eddf01cdb50e1adcb5eb4c728111ec812c20d69847db577526b3b72";
  };
