...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_zenoh-release/archive/release/kilted/rmw_zenoh_cpp/0.6.8-1.tar.gz";
    name = "0.6.8-1.tar.gz";
    sha256 = "3247045fd1ba379b963bc1cd60346306d18101b957189e02cd25503e1e527d3b";
  };
