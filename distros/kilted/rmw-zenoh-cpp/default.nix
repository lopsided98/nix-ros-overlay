...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_zenoh-release/archive/release/kilted/rmw_zenoh_cpp/0.6.7-1.tar.gz";
    name = "0.6.7-1.tar.gz";
    sha256 = "7d7e42985ef0f088b675ff69bdfb0991f7acda371c63f623092644084032be8e";
  };
