...
buildRosPackage {
  pname = "ros-kilted-ecl-linear-algebra";
  version = "1.2.1-r5";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/kilted/ecl_linear_algebra/1.2.1-5.tar.gz";
    name = "1.2.1-5.tar.gz";
    sha256 = "1a7164959c3b9abf7cd86d10baeb4ceb2037354ddf5749a4516695a355b086e1";
  };
