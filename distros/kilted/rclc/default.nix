...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclc-release/archive/release/kilted/rclc/6.2.3-1.tar.gz";
    name = "6.2.3-1.tar.gz";
    sha256 = "d42b83c4dc3ecc95a4497a01fee2d88f5b92f6f90b821af8913f6b9807da0ee4";
  };
