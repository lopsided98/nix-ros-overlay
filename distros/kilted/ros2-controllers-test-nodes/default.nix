...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/ros2_controllers_test_nodes/5.2.0-1.tar.gz";
    name = "5.2.0-1.tar.gz";
    sha256 = "c267024306468cd198b44ec3559ab30df005fca45f289c619e3fe26d17b9a74e";
  };
