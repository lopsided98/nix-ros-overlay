...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/ros2_controllers_test_nodes/5.5.0-2.tar.gz";
    name = "5.5.0-2.tar.gz";
    sha256 = "d2ec54a04cd215a28279dfbdcd156c62658b3698ec7a889d4dd7ee2f64b3eea0";
  };
