...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/kilted/tf2_geometry_msgs/0.41.6-1.tar.gz";
    name = "0.41.6-1.tar.gz";
    sha256 = "4dcce8bf901ed19c3c337a5e110cfbb68795b1b3e4c536762cd29de3908b2dfb";
  };
