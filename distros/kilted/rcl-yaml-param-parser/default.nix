...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/kilted/rcl_yaml_param_parser/10.1.4-1.tar.gz";
    name = "10.1.4-1.tar.gz";
    sha256 = "3dd28b0eacfaf8d1e0b78947e719718138243fca696b8f7fd0ca57d9f0c5a0b0";
  };
