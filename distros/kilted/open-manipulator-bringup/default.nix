...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/kilted/open_manipulator_bringup/4.0.1-1.tar.gz";
    name = "4.0.1-1.tar.gz";
    sha256 = "bdf584b0cf947003024dde2a6f116df01020b42d2ca4c01e05cdde2b81d76f1d";
  };
