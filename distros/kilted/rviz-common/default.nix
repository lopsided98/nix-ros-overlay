...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_common/15.0.11-1.tar.gz";
    name = "15.0.11-1.tar.gz";
    sha256 = "8c9351f13286cfd1697d268e58fb2778d036d581050bb51a9cf0ddb35a4080da";
  };
