...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_common/15.0.10-1.tar.gz";
    name = "15.0.10-1.tar.gz";
    sha256 = "346820990a2810c23454ca8278746e059f3f8098b43741448796b75459a1463b";
  };
