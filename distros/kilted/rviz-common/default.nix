...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_common/15.0.15-1.tar.gz";
    name = "15.0.15-1.tar.gz";
    sha256 = "f50d533195842582a7fceb9cc202153267b6ca58248bd60d2989b5fa9302a644";
  };
