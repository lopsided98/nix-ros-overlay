...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_common/15.0.9-1.tar.gz";
    name = "15.0.9-1.tar.gz";
    sha256 = "c98d7ca18447ebb31e50720b2ff6d48364ddf112fafc39a69bade3bbb3861955";
  };
