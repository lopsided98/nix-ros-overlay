...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_common/15.0.12-1.tar.gz";
    name = "15.0.12-1.tar.gz";
    sha256 = "5b3cd702a7c9a8e164b07a4a6823c5529d8419efbc712361d62c80add65016f7";
  };
