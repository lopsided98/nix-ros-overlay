...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_common/15.0.14-1.tar.gz";
    name = "15.0.14-1.tar.gz";
    sha256 = "d099ccf7256bcc0b8fc60da6b95d0493e56af9964b4bc01445c7e849ae375740";
  };
