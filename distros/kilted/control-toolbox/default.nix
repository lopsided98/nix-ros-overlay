...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/control_toolbox-release/archive/release/kilted/control_toolbox/5.10.1-1.tar.gz";
    name = "5.10.1-1.tar.gz";
    sha256 = "f6fee66524c2ee508d0839ca2311867b3dd6b46cfe52df9ddc7ae165c0b13bd7";
  };
