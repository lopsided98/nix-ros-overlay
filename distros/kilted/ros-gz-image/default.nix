...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/kilted/ros_gz_image/2.1.18-1.tar.gz";
    name = "2.1.18-1.tar.gz";
    sha256 = "4164f45410ae125ea25298283976f4c3cfc7c46eefa3bee623815c04e4f4a57a";
  };
