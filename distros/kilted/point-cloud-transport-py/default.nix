...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/point_cloud_transport-release/archive/release/kilted/point_cloud_transport_py/5.1.5-1.tar.gz";
    name = "5.1.5-1.tar.gz";
    sha256 = "5536fa8179839c9a7d6ecab9dbd30c97b7f4e93913d80751e59f1609eb207871";
  };
