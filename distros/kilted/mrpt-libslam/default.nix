...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libslam/2.14.11-1.tar.gz";
    name = "2.14.11-1.tar.gz";
    sha256 = "54967f7be851932cc44b8e5ad44837ea40e103ecec2161fc14b1140deffb0293";
  };
