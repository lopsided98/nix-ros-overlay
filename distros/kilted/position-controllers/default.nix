...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/position_controllers/5.9.0-1.tar.gz";
    name = "5.9.0-1.tar.gz";
    sha256 = "671fcac5f46b7f017aa6bf9162ee530e96950919b914dc351b0d8196f0cab312";
  };
