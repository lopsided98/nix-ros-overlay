...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/position_controllers/5.12.0-1.tar.gz";
    name = "5.12.0-1.tar.gz";
    sha256 = "004eaf27c640bb52a0711dae805fd3bd33307a3f6f21da9c65c4bdd247aa0168";
  };
