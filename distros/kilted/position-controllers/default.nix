...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/position_controllers/5.11.0-1.tar.gz";
    name = "5.11.0-1.tar.gz";
    sha256 = "a51c842a7528661a7e2b488f121ea05e5f52f9dae9cec167f51f2c0335872916";
  };
