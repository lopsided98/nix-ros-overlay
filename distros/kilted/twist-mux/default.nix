...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/twist_mux-release/archive/release/kilted/twist_mux/4.5.0-1.tar.gz";
    name = "4.5.0-1.tar.gz";
    sha256 = "8515da4b4412e04bc989dfe9056d39f7ddd2368cdba92941318652753a0c06dc";
  };
