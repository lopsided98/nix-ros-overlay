...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_implementation-release/archive/release/kilted/rmw_implementation/3.0.6-1.tar.gz";
    name = "3.0.6-1.tar.gz";
    sha256 = "d30c5cb80972b8bc7311da276402ca33e24b3d0ace1421a625e02925c9b613db";
  };
