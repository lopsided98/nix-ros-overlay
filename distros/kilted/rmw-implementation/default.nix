...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_implementation-release/archive/release/kilted/rmw_implementation/3.0.5-1.tar.gz";
    name = "3.0.5-1.tar.gz";
    sha256 = "15f9857093c6a0bcff545fd9aafcfd31360719506a4fa1f7a91c3c921043917e";
  };
