...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_lidar_odometry-release/archive/release/kilted/mola_lidar_odometry/1.2.2-1.tar.gz";
    name = "1.2.2-1.tar.gz";
    sha256 = "248b9010e1072b5f4a7bb5e8e2781d2c93c55038af4759a006c7bee01fa94598";
  };
