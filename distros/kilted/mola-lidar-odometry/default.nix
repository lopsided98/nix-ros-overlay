...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_lidar_odometry-release/archive/release/kilted/mola_lidar_odometry/3.0.0-1.tar.gz";
    name = "3.0.0-1.tar.gz";
    sha256 = "1cda0ec2ce7a17976ea3fa3c2a6bdf1bff40ea48bed7eac0fbfa137040732c1f";
  };
