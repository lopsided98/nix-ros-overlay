...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_lidar_odometry-release/archive/release/kilted/mola_lidar_odometry/1.0.0-1.tar.gz";
    name = "1.0.0-1.tar.gz";
    sha256 = "0e790e6c4ae283d36f35af7f93434bada923ac1b9c3ed3dbbbb4536c16549a2a";
  };
