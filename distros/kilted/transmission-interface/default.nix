...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/transmission_interface/5.8.0-1.tar.gz";
    name = "5.8.0-1.tar.gz";
    sha256 = "19c911350958fb08018868e32342ea03ed14843a0947e1717361190de06cfbb5";
  };
