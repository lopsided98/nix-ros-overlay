...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/transmission_interface/5.11.3-1.tar.gz";
    name = "5.11.3-1.tar.gz";
    sha256 = "4a4fab476afb697a8d87007bab6954a739b383e650d199feefa2bd62292366b8";
  };
