...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/ros2_controllers/5.2.0-1.tar.gz";
    name = "5.2.0-1.tar.gz";
    sha256 = "978595e32733d270eaa0cd20f336980d744835580209609186ba2b2eb788ac05";
  };
