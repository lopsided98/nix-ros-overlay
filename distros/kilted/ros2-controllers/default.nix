...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/ros2_controllers/5.13.0-1.tar.gz";
    name = "5.13.0-1.tar.gz";
    sha256 = "3692812c236287725f6975b017ed8e13b6a66aebf0e5871a964ad2b9010b69c2";
  };
