...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/ros2_controllers/5.9.0-1.tar.gz";
    name = "5.9.0-1.tar.gz";
    sha256 = "6a25e47340714bf42fb0a5c8d18b29ea17ab55ac86138e59005629a7a1d942e3";
  };
