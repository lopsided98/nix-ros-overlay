...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/librealsense2-release/archive/release/kilted/librealsense2/2.56.4-1.tar.gz";
    name = "2.56.4-1.tar.gz";
    sha256 = "099efe5d2b29253f3733c6d6b2d5538cde9bb91cc91729ed02b8e827488eb547";
  };
