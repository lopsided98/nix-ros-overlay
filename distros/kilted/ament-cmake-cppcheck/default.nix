...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/kilted/ament_cmake_cppcheck/0.19.2-2.tar.gz";
    name = "0.19.2-2.tar.gz";
    sha256 = "1335c0d16a325a1493e4e352fdf1bbfb1c456b789162013777e91c94686682a2";
  };
