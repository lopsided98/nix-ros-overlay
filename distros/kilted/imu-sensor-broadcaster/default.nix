...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/imu_sensor_broadcaster/5.16.0-1.tar.gz";
    name = "5.16.0-1.tar.gz";
    sha256 = "353f293d470adbb5930820f813abdefaa0d220190fd966b959fc3630e9b89e31";
  };
