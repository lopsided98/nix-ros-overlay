...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/imu_sensor_broadcaster/5.9.0-1.tar.gz";
    name = "5.9.0-1.tar.gz";
    sha256 = "5da71292f6edb902e254a1967df329639e2c68c63b31abe6532b6b48f65d525a";
  };
