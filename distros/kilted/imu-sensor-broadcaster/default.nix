...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/imu_sensor_broadcaster/5.11.0-1.tar.gz";
    name = "5.11.0-1.tar.gz";
    sha256 = "ca6681cae348683696c9ff1548cddc36eb3bf109474a31f17f4222aa6a32ff19";
  };
