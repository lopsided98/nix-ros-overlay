...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/kilted/examples_tf2_py/0.41.10-1.tar.gz";
    name = "0.41.10-1.tar.gz";
    sha256 = "7d34f4bebe48f6c23a7681b7d614668039fb6654dcb7dd2f2b84935fd5040599";
  };
