...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_babel_fish-release/archive/release/kilted/ros_babel_fish/3.25.111-1.tar.gz";
    name = "3.25.111-1.tar.gz";
    sha256 = "eb5206245f99484e6b5442ddaa6e1e6ae10da1ef124b3de0ffe54a98e79ebc60";
  };
