...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidlcpp-release/archive/release/kilted/rosidlcpp_generator_core/0.2.1-1.tar.gz";
    name = "0.2.1-1.tar.gz";
    sha256 = "e181d1f181b579e6f8a7506bff30a99c94a89059ee3cd09f368a479c21930fe4";
  };
