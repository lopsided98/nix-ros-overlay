...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2multicast/0.38.5-1.tar.gz";
    name = "0.38.5-1.tar.gz";
    sha256 = "c23c2cb26da8f6391a5d7b037934402f9fea60798bd42db905ae6a90f64b7460";
  };
