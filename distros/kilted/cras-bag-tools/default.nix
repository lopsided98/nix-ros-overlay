...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/cras_ros_utils-release/archive/release/kilted/cras_bag_tools/4.0.2-1.tar.gz";
    name = "4.0.2-1.tar.gz";
    sha256 = "b9d04e4455d73fe2159a29c89175b7d00756fc51cbec4b2efb2e10adfb52a5c9";
  };
