...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fuse-release/archive/release/kilted/fuse_core/1.2.4-1.tar.gz";
    name = "1.2.4-1.tar.gz";
    sha256 = "b427dc704a9bd0d79b87848f38ca79b94da5590a441995fe5c8e96b92a10e184";
  };
