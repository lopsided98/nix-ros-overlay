...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fuse-release/archive/release/kilted/fuse_core/1.2.2-1.tar.gz";
    name = "1.2.2-1.tar.gz";
    sha256 = "f263d7d37ffe0c044b54aa97b822943f8a40be270659b646c87996b66b9b0256";
  };
