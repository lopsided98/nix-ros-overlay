...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/simple_grasping-release/archive/release/kilted/simple_grasping/0.6.0-1.tar.gz";
    name = "0.6.0-1.tar.gz";
    sha256 = "b7fe3790519f1b9702880605a7d42213d514113ee659c6e96795cdf55a532cfa";
  };
