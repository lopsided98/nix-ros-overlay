...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/controller_manager_msgs/5.5.0-1.tar.gz";
    name = "5.5.0-1.tar.gz";
    sha256 = "cc3e46425cbdf8b75d89c77e87916e8bb42d8e91c08b255306f375db6b4ea900";
  };
