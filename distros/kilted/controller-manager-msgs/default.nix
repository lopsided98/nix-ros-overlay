...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/controller_manager_msgs/5.8.1-1.tar.gz";
    name = "5.8.1-1.tar.gz";
    sha256 = "4a3a86a683015006ffdd90b8868e5ac2ebe766fce2e4f032ce9f5efa217b4916";
  };
