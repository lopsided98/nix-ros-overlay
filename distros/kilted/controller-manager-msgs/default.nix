...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/controller_manager_msgs/5.2.0-1.tar.gz";
    name = "5.2.0-1.tar.gz";
    sha256 = "a65cf4decd640f5dcc4dd3d02524e7be990b1f2c4b44aa12d6e200224bafd909";
  };
