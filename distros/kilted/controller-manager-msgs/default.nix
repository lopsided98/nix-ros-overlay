...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/controller_manager_msgs/5.8.0-1.tar.gz";
    name = "5.8.0-1.tar.gz";
    sha256 = "e35cf6c95476f195f00f566f36ca40c9c2a09feb2df47a2b3355023b600c718e";
  };
