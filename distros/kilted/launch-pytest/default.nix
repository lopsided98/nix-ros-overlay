...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch-release/archive/release/kilted/launch_pytest/3.8.7-1.tar.gz";
    name = "3.8.7-1.tar.gz";
    sha256 = "079d3141a9426dd8c28f1ddebc92be0e745a0923f0641706734a7f2a895d6cfe";
  };
