...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch-release/archive/release/kilted/launch_pytest/3.8.4-1.tar.gz";
    name = "3.8.4-1.tar.gz";
    sha256 = "0c7725d82d480275dffb3ae84c27367ec29067a380bf876014e0204124135488";
  };
