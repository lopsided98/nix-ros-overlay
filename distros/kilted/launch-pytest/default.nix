...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch-release/archive/release/kilted/launch_pytest/3.8.8-1.tar.gz";
    name = "3.8.8-1.tar.gz";
    sha256 = "d8311d9c630913305535e267b4990180b0d708092f9376aa7a97e62bfc92b0c0";
  };
