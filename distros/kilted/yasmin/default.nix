...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/kilted/yasmin/4.2.4-1.tar.gz";
    name = "4.2.4-1.tar.gz";
    sha256 = "12b4712a9049b99e5775ba1336480853572fd225801b58dbe871788f3ecaec73";
  };
