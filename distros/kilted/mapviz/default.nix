...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/kilted/mapviz/2.6.2-1.tar.gz";
    name = "2.6.2-1.tar.gz";
    sha256 = "c268ae199b8e0db474ec5624ed56aca230b0bcdc585a0542168fb5cddf1743f1";
  };
