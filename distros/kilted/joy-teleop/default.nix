...
buildRosPackage {
  pname = "ros-kilted-joy-teleop";
  version = "2.0.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/teleop_tools-release/archive/release/kilted/joy_teleop/2.0.0-1.tar.gz";
    name = "2.0.0-1.tar.gz";
    sha256 = "79939a6db3f33c425debf0a95798f661fdceff9891c8849f184cb9b87325f72d";
  };
