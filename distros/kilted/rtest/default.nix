...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rtest-release/archive/release/kilted/rtest/0.2.4-1.tar.gz";
    name = "0.2.4-1.tar.gz";
    sha256 = "73a877da22d53d4b78a1796bd8b783794f8e972f8702bed614e58fdcda473e3f";
  };
