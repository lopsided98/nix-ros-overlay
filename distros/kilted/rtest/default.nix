...
{ lib, buildRosPackage, fetchurl, action-msgs, ament-clang-tidy, ament-cmake, ament-cmake-copyright, ament-cmake-ros, ament-lint-auto, ament-lint-common, boost, gmock, gmock-vendor, rcl, rcl-action, rclcpp, rclcpp-action, ros-environment }:
buildRosPackage {
  ...
  buildInputs = [ ament-cmake ament-cmake-ros boost gmock ros-environment ];
