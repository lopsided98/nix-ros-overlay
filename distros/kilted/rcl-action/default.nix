...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/kilted/rcl_action/10.1.4-1.tar.gz";
    name = "10.1.4-1.tar.gz";
    sha256 = "a7d1c52279ff8781e80da6cd4ba3632508d707403a1f9a82771c59e6efd3a906";
  };
