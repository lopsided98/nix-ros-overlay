...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rko_lio-release/archive/release/kilted/rko_lio/0.3.0-1.tar.gz";
    name = "0.3.0-1.tar.gz";
    sha256 = "bd2e4728e6e50bcb3fd173d71fe3f75cac6a9684467ce8c5f08b6789a7f72f8f";
  };
