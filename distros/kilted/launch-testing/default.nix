...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch-release/archive/release/kilted/launch_testing/3.8.7-1.tar.gz";
    name = "3.8.7-1.tar.gz";
    sha256 = "1cba929b66fdbd2ce0543fbd2504256d8fdf6df696c7f038d7f996e4acfcb94a";
  };
