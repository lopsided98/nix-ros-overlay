...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/kilted/ament_cmake/2.7.4-1.tar.gz";
    name = "2.7.4-1.tar.gz";
    sha256 = "14e85e41b3474cd9b331cc10b78ddcad4809841dee52865780f655e9119f80c3";
  };
