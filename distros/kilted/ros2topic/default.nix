...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2topic/0.38.4-1.tar.gz";
    name = "0.38.4-1.tar.gz";
    sha256 = "015eada104eb28f5efb72908c24f158d503e6e011b4a5498402eab05d99b06eb";
  };
