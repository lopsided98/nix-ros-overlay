...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2topic/0.38.2-1.tar.gz";
    name = "0.38.2-1.tar.gz";
    sha256 = "8723dd14c320b6a80bbef94dfe0eef098bafedadded6a3874ed894549badccd0";
  };
