...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/common_interfaces-release/archive/release/kilted/sensor_msgs/5.5.3-1.tar.gz";
    name = "5.5.3-1.tar.gz";
    sha256 = "e65a10fcba9b882b7ed450c7fd9968caed9ba5a850ed481be79363087bd92b52";
  };
