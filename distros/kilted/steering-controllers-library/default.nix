...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/steering_controllers_library/5.9.0-1.tar.gz";
    name = "5.9.0-1.tar.gz";
    sha256 = "9527686b076414bba107c6cbfd4ead9a49636644d67c58318193b5993c36e083";
  };
