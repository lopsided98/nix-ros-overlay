...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit_resources-release/archive/release/kilted/dual_arm_panda_moveit_config/3.1.0-2.tar.gz";
    name = "3.1.0-2.tar.gz";
    sha256 = "b6a8ab75953996156dcdace883d3f622b1c432ba8e66e43770ac82a074481968";
  };
