...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/kilted/tf2_ros_py/0.41.10-1.tar.gz";
    name = "0.41.10-1.tar.gz";
    sha256 = "57fa0c322100375919fcdcf2bec930a2d8541c4038d2f8c544c06de86762cfff";
  };
