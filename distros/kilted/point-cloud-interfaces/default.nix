...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/point_cloud_transport_plugins-release/archive/release/kilted/point_cloud_interfaces/5.0.4-1.tar.gz";
    name = "5.0.4-1.tar.gz";
    sha256 = "f26bbddf163d85e9f2b734d049350208c108af42696e0f85fd71ca52e951d937";
  };
