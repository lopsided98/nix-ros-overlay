...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_assimp_vendor/15.0.15-1.tar.gz";
    name = "15.0.15-1.tar.gz";
    sha256 = "143132bd0dc59fe7d3e07f3602853fd5da032313bfcd0d9cb07717fb7ca753ca";
  };
