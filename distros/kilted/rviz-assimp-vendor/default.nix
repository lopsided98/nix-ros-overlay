...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_assimp_vendor/15.0.10-1.tar.gz";
    name = "15.0.10-1.tar.gz";
    sha256 = "48b01da8c184b37508bcfd95b625d2d3c8986e5ca42bcc250496ff552511260e";
  };
