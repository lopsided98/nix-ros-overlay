...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_assimp_vendor/15.0.3-1.tar.gz";
    name = "15.0.3-1.tar.gz";
    sha256 = "6218c6f09748ec219a0d8b8655f138fe6fb7cdf73731336213392b1828e2c0de";
  };
