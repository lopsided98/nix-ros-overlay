...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_rendering_tests/15.0.8-1.tar.gz";
    name = "15.0.8-1.tar.gz";
    sha256 = "8e241a368ea5c9dbda5ba38178535e8c08b54e18aba476d490739249b1eaaf16";
  };
