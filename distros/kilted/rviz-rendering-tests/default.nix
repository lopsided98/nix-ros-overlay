...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_rendering_tests/15.0.4-1.tar.gz";
    name = "15.0.4-1.tar.gz";
    sha256 = "5ec3c3eb55870d7f61664cc10af9a49d1b0dd5b7c1e5942da4e0d2f0c214cdaa";
  };
