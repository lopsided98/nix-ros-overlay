...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_rendering_tests/15.0.15-1.tar.gz";
    name = "15.0.15-1.tar.gz";
    sha256 = "10fc144df3aaad56c5a6d537ad8f7619677b0a41c7b7a567f9fddf63d6475e81";
  };
