...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/cras_ros_utils-release/archive/release/kilted/cras_lint/3.0.0-2.tar.gz";
    name = "3.0.0-2.tar.gz";
    sha256 = "0d85ceb8f1091e1a1bc50e4fa4b724e9bef65aa37dd30488bd81afc6b1c3bda1";
  };
