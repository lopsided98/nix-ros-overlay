...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/cras_ros_utils-release/archive/release/kilted/cras_cpp_common/4.0.2-1.tar.gz";
    name = "4.0.2-1.tar.gz";
    sha256 = "7bfc0000e31c82a0b6ad84bfa710ceb634e1478fe59465e6556a6fe8073c46e4";
  };
