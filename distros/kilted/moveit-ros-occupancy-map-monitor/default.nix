...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/kilted/moveit_ros_occupancy_map_monitor/2.14.3-1.tar.gz";
    name = "2.14.3-1.tar.gz";
    sha256 = "5524926a779907be8c56456e97cb6fa0ccdd6ba3ef5b1d5013e685713810fc37";
  };
