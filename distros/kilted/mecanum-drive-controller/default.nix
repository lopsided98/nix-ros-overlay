...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/mecanum_drive_controller/5.15.1-1.tar.gz";
    name = "5.15.1-1.tar.gz";
    sha256 = "a5f33307a68ed415ef32ec80496d404a38f4fc166f69ed316cce2d226fc3e1d7";
  };
