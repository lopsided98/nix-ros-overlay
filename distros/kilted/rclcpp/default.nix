...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/kilted/rclcpp/29.5.5-1.tar.gz";
    name = "29.5.5-1.tar.gz";
    sha256 = "5a03d546cc53642254bc6ee9b651a9fc52e738580bfe8edce5e388cbe5f894a7";
  };
