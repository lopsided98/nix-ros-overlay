...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/dynamixel_sdk-release/archive/release/kilted/dynamixel_sdk_examples/4.0.3-1.tar.gz";
    name = "4.0.3-1.tar.gz";
    sha256 = "25bfcc0e7d2a8a280763d4bbebbdeab44c7ef76f67eb24fbc4efe71ae58bfddb";
  };
