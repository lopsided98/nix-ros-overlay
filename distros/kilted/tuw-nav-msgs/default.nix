...
buildRosPackage {
  pname = "ros-kilted-tuw-nav-msgs";
  version = "0.2.5-r2";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/tuw_msgs-release/archive/release/kilted/tuw_nav_msgs/0.2.5-2.tar.gz";
    name = "0.2.5-2.tar.gz";
    sha256 = "cc6c2ad6d990fe901ebb95a17311be6940ed26e41bc3ff2c298a083a9acb6468";
  };
