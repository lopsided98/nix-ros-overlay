...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mavlink-gbp-release/archive/release/kilted/mavlink/2025.5.5-1.tar.gz";
    name = "2025.5.5-1.tar.gz";
    sha256 = "7dad995b738a87f8b8a096efa52ff0bb6b0942261993c30262e30a293413bcbf";
  };
