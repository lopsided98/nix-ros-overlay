...
buildRosPackage {
  pname = "ros-kilted-nodl-observe";
  version = "2.0.3-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/nodl-release/archive/release/kilted/nodl_observe/2.0.3-1.tar.gz";
    name = "2.0.3-1.tar.gz";
    sha256 = "e34515e7285dd628c5a5840dd6b44f01db1491de1608bd32d3615ff7fcb74a28";
  };
