...
buildRosPackage {
  pname = "ros-kilted-rosbag2-compression";
  version = "0.32.0-r2";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/kilted/rosbag2_compression/0.32.0-2.tar.gz";
    name = "0.32.0-2.tar.gz";
    sha256 = "1c944251cca309275d4111c7398b3b02c6968fdc74d775822df26cee4f07d814";
  };
