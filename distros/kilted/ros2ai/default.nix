...
buildRosPackage {
  pname = "ros-kilted-ros2ai";
  version = "0.1.3-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2ai-release/archive/release/kilted/ros2ai/0.1.3-3.tar.gz";
    name = "0.1.3-3.tar.gz";
    sha256 = "32388f543c12a37b29a62078ed1151fb2e26884cd35b3b3d40335e6394de0816";
  };
