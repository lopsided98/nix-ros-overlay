...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidlcpp-release/archive/release/kilted/rosidlcpp_typesupport_c/0.2.1-1.tar.gz";
    name = "0.2.1-1.tar.gz";
    sha256 = "644b94df03389e63e688d4cb5213bc7643d4fa5b2028cf52a81a31abce34f1be";
  };
