...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_visual_testing_framework/15.0.12-1.tar.gz";
    name = "15.0.12-1.tar.gz";
    sha256 = "371bb2814edc6041468fd88be4e81654eff16a1e261aa126c157549fe2b62063";
  };
