...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/sick_scan_xd-release/archive/release/kilted/sick_scan_xd/3.8.0-1.tar.gz";
    name = "3.8.0-1.tar.gz";
    sha256 = "9bbac0295388eda1f2806a80575bf3b67f4b48fce0308396442ca73a78a0b124";
  };
