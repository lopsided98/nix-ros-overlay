...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/kilted/open_manipulator_collision/4.0.5-1.tar.gz";
    name = "4.0.5-1.tar.gz";
    sha256 = "9ef60fa15b474d3f087c99a3b7551e79486a750f050d5f6d3b2d403fc4b143cd";
  };
