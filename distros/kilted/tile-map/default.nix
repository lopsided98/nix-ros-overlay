...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/kilted/tile_map/2.5.6-1.tar.gz";
    name = "2.5.6-1.tar.gz";
    sha256 = "dafd8cb386ba18e1664c810d8ffc8c8d60d4f6d48caa5d5b694673257f714588";
  };
