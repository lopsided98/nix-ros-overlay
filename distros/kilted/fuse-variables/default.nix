...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fuse-release/archive/release/kilted/fuse_variables/1.2.4-1.tar.gz";
    name = "1.2.4-1.tar.gz";
    sha256 = "7cbbd66229e1354b44091036974b495ea415d9210f6a5e951e696375d76852eb";
  };
