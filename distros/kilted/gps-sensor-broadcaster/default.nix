...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/gps_sensor_broadcaster/5.5.0-2.tar.gz";
    name = "5.5.0-2.tar.gz";
    sha256 = "4e399848c963731ac8a010f845131b3fec28563bbd2f87019907cce47a85c954";
  };
