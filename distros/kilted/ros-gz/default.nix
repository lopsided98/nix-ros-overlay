...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/kilted/ros_gz/2.1.15-1.tar.gz";
    name = "2.1.15-1.tar.gz";
    sha256 = "fb93675f177cc50f36f442539524adecb53af61492cb5aab675ac90d18132700";
  };
