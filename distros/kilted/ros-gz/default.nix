...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/kilted/ros_gz/2.1.18-1.tar.gz";
    name = "2.1.18-1.tar.gz";
    sha256 = "57a7e12ef19b9ebb776ddb49636f2ed9b472a21c7261bb41da3cdbb29779a024";
  };
