...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/control_msgs-release/archive/release/kilted/control_msgs/6.2.0-1.tar.gz";
    name = "6.2.0-1.tar.gz";
    sha256 = "0239fb959dee1c6ffcccc99153dc423dd022ad5646c39d46d05bea283f90d2bd";
  };
