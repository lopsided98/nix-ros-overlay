...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/pose_cov_ops-release/archive/release/kilted/pose_cov_ops/0.3.13-2.tar.gz";
    name = "0.3.13-2.tar.gz";
    sha256 = "aee0702853d8964a5b2bb1943e9810220fce0302d145be8749d3281db56e120c";
  };
