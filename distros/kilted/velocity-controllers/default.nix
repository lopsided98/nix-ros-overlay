...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/velocity_controllers/5.2.0-1.tar.gz";
    name = "5.2.0-1.tar.gz";
    sha256 = "1f17b80f39e4aa0e90c1c0663a375e02208d394ed3c5a96010652d015b23d913";
  };
