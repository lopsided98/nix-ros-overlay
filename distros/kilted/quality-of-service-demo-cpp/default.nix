...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/kilted/quality_of_service_demo_cpp/0.36.0-1.tar.gz";
    name = "0.36.0-1.tar.gz";
    sha256 = "fc163b663839aa88dec67eeb0640dfa64e71c592fd403ff7498ad6273a412a31";
  };
