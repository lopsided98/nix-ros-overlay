...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/EasyNavigation/easynav_plugins-release/archive/release/kilted/easynav_mppi_controller/0.4.1-1.tar.gz";
    name = "0.4.1-1.tar.gz";
    sha256 = "0e9161edb7fa01b280ac1fc36bc8513dff04d3bb9964832d7c14430c5a81cc23";
  };
