...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/luxonis/depthai-ros-release/archive/release/kilted/depthai_bridge/3.0.1-1.tar.gz";
    name = "3.0.1-1.tar.gz";
    sha256 = "87ab44f21177f6558533fb65e894f7cc3d5a5ff9e83b5048a1dcb1cf9ab64017";
  };
