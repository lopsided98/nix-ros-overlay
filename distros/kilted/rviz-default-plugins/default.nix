...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_default_plugins/15.0.9-1.tar.gz";
    name = "15.0.9-1.tar.gz";
    sha256 = "bf9c555949a015fad97a811f14fe6da91d775085f3d617600207a119c5c09933";
  };
