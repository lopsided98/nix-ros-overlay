...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_default_plugins/15.0.2-1.tar.gz";
    name = "15.0.2-1.tar.gz";
    sha256 = "79876e1152187448c61e0e5cf71bdbcbe316e40e96e50ac4d4b44f437ecbd47b";
  };
