...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_default_plugins/15.0.8-1.tar.gz";
    name = "15.0.8-1.tar.gz";
    sha256 = "aeeccefb18df65d17110cb0d2807de1dd781c3bfdeb1a4f15af13e7ff72f401a";
  };
