...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_default_plugins/15.0.10-1.tar.gz";
    name = "15.0.10-1.tar.gz";
    sha256 = "491e347340883c1308d4c20c8cfcddd097c4e5e04f3f09bfd632ff08bcbb7bf2";
  };
