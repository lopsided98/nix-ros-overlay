...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_default_plugins/15.0.4-1.tar.gz";
    name = "15.0.4-1.tar.gz";
    sha256 = "8e44758778c3ca4a730d545c63e596bd00f66138c44cf587053ff1976364bad9";
  };
