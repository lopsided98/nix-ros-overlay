...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/microstrain_inertial-release/archive/release/kilted/microstrain_inertial_driver/4.7.0-1.tar.gz";
    name = "4.7.0-1.tar.gz";
    sha256 = "8a38bd16721f104dba3fbd45da3300ef63c2042fb832e29dde82917dd91ce71d";
  };
