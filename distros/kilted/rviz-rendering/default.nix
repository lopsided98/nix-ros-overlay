...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_rendering/15.0.14-1.tar.gz";
    name = "15.0.14-1.tar.gz";
    sha256 = "336ca6b69f65101fb927d5c1a58b3be6a6a815887018e8ff499c497b325e82ff";
  };
