...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz_rendering/15.0.4-1.tar.gz";
    name = "15.0.4-1.tar.gz";
    sha256 = "42b10db4f118c0e32f8ac62339f71adbf385bd60a218007a8836814a914d4a56";
  };
