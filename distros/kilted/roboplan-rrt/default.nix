...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/roboplan-release/archive/release/kilted/roboplan_rrt/0.7.0-1.tar.gz";
    name = "0.7.0-1.tar.gz";
    sha256 = "5a92892bde0ac4425d2739f89c1cf25efdbcc2b454b86896f6e3ff446b5c1fb0";
  };
