...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/kilted/swri_opencv_util/3.8.5-1.tar.gz";
    name = "3.8.5-1.tar.gz";
    sha256 = "354b91d055b50eb4f39a405778f580918b851073a92c36fbda64dce227379321";
  };
