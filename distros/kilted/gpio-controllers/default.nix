...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/gpio_controllers/5.9.0-1.tar.gz";
    name = "5.9.0-1.tar.gz";
    sha256 = "189a390c90d69d8f751bd6cf1c3d24ed4af6aae3666d6c82f8e7609e0fdef84e";
  };
