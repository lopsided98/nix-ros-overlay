...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/gpio_controllers/5.5.0-2.tar.gz";
    name = "5.5.0-2.tar.gz";
    sha256 = "4b56644e8111d27d16ac1c661e7dc6dfb63cb680660dc34e3b0b2c9b6c9e0e06";
  };
