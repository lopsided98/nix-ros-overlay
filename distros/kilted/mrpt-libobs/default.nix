...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libobs/2.14.11-1.tar.gz";
    name = "2.14.11-1.tar.gz";
    sha256 = "775c77c2a701a0f29a754a81312bb6acb6d5896f25478918c9252864380fe2ac";
  };
