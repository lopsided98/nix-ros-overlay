...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/apriltag_detector-release/archive/release/kilted/apriltag_detector_umich/3.0.2-1.tar.gz";
    name = "3.0.2-1.tar.gz";
    sha256 = "8da5b9af5918ab7ac7e972ae0102be81f2c2c3c7a22b424fde39dd31aaa14382";
  };
