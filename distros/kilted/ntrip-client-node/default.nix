...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/kilted/ntrip_client_node/0.6.1-1.tar.gz";
    name = "0.6.1-1.tar.gz";
    sha256 = "ca3d48183bf090ad6c4f544f9da6ba4ab138b4566ebdde3976608131a5c13b25";
  };
