...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ublox_dgnss-release/archive/release/kilted/ntrip_client_node/0.5.5-5.tar.gz";
    name = "0.5.5-5.tar.gz";
    sha256 = "0b784ecb8967513f66cc060e1ced6b284a1693913e6f367648cf61814b041ae9";
  };
