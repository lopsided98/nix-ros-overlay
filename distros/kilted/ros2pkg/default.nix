...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2pkg/0.38.5-1.tar.gz";
    name = "0.38.5-1.tar.gz";
    sha256 = "865ba3d32048cc432caf092de9563851f7c04bd049f58e37b64ae009baa7a8b3";
  };
