...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2pkg/0.38.4-1.tar.gz";
    name = "0.38.4-1.tar.gz";
    sha256 = "cd5c953d474ed5bbb9a0cccaea9c88d0a97fc61fd978cd663f71af2659ed5452";
  };
