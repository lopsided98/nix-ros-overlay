...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2pkg/0.38.3-2.tar.gz";
    name = "0.38.3-2.tar.gz";
    sha256 = "d2ea150cd7467a42d3650ee4f7e11c14c7f62d3e20bd52b6cf58bcb78b6f3da7";
  };
