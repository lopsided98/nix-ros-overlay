...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2lifecycle/0.38.5-1.tar.gz";
    name = "0.38.5-1.tar.gz";
    sha256 = "6c5218e5ae1d8d56350c468ff3a0016cd554fe96c9972fa9db29ed37b4b2758f";
  };
