...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2lifecycle/0.38.2-1.tar.gz";
    name = "0.38.2-1.tar.gz";
    sha256 = "85cf6c2f71d88f14ada3b00864bc0522a0f790f6a86be07eedb8d9de2663009e";
  };
