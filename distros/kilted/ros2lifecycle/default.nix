...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2lifecycle/0.38.4-1.tar.gz";
    name = "0.38.4-1.tar.gz";
    sha256 = "cd642af7073f286746b7422ecebe64ca28839a1a8da4d30a317f87c6c6401b03";
  };
