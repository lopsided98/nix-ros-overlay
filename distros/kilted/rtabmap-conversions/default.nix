...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/introlab/rtabmap_ros-release/archive/release/kilted/rtabmap_conversions/0.22.0-1.tar.gz";
    name = "0.22.0-1.tar.gz";
    sha256 = "6f93ace26f56633d94ef6b455b91c970a2acfc8d66913ed3165db1a1a18b79d6";
  };
