...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidlcpp-release/archive/release/kilted/rosidlcpp_typesupport_fastrtps_cpp/0.2.1-1.tar.gz";
    name = "0.2.1-1.tar.gz";
    sha256 = "522e7dd2b19ff84424ed912476560e56f3134fc948c4e1910fd6fb0fdb4f1159";
  };
