...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/foxglove_bridge-release/archive/release/kilted/foxglove_bridge/3.4.3-1.tar.gz";
    name = "3.4.3-1.tar.gz";
    sha256 = "1f9fc9fa8101f83ad09ebd89bcf7c2ea6c424f724b46dd8a44aadd1de7700d77";
  };
