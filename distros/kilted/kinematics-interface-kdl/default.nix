...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/kinematics_interface-release/archive/release/kilted/kinematics_interface_kdl/2.4.2-1.tar.gz";
    name = "2.4.2-1.tar.gz";
    sha256 = "4b83493e0fa7208a033e65e3c5ed5ea2837cbb4659a25dc76687cd884c8b01e2";
  };
