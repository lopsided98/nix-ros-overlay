...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/turtlebot3-release/archive/release/kilted/turtlebot3_node/2.3.6-1.tar.gz";
    name = "2.3.6-1.tar.gz";
    sha256 = "bc133b997d87699f0bc1c83de33e2e5ad40068a38e0e6c4af2dcf1761db7a23c";
  };
