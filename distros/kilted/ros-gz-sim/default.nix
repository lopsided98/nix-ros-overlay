...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/kilted/ros_gz_sim/2.1.13-1.tar.gz";
    name = "2.1.13-1.tar.gz";
    sha256 = "eb4aca914b3d4ff92ae2a585fd2c49b0f8954a14521ac357f505a48b51e9bc2a";
  };
