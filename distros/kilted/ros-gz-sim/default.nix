...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/kilted/ros_gz_sim/2.1.8-1.tar.gz";
    name = "2.1.8-1.tar.gz";
    sha256 = "51959dac57806b33fadbf2db2ce25b5f07008eda0b3cfdc5ac32d2b37eb84716";
  };
