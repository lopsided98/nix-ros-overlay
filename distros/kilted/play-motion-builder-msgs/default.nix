...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/play_motion_builder-release/archive/release/kilted/play_motion_builder_msgs/1.4.1-1.tar.gz";
    name = "1.4.1-1.tar.gz";
    sha256 = "45aa151a59fb210366dcb23589d604590726a7e638e0b0a24bdaade00b2fddf6";
  };
