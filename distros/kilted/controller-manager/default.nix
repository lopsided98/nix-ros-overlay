...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/controller_manager/5.15.0-1.tar.gz";
    name = "5.15.0-1.tar.gz";
    sha256 = "fe70f69a0bd53941135300131f333ddc3e0a6baa0ec87de5cbdbf0f8210279b1";
  };
