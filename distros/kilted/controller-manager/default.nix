...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/controller_manager/5.14.1-1.tar.gz";
    name = "5.14.1-1.tar.gz";
    sha256 = "f93c9c1454064b9203a0a56705ea06e0a3323135891fc9e700b2cc67011b68bc";
  };
