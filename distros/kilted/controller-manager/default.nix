...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/controller_manager/5.9.0-1.tar.gz";
    name = "5.9.0-1.tar.gz";
    sha256 = "b6d825ee6a22305b7871a6925af014d4b38579b34ed35a7be8fa2708f7df24cf";
  };
