...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/realsense-ros-release/archive/release/kilted/realsense2_camera/4.58.4-1.tar.gz";
    name = "4.58.4-1.tar.gz";
    sha256 = "df4f4006b33375b197c5c353dcf419dcd62b99b2d9742bbcbd3bf4cd4f4d265a";
  };
