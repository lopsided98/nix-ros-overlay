...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2action/0.38.5-1.tar.gz";
    name = "0.38.5-1.tar.gz";
    sha256 = "b35b9d9f6901371ebeb8d247b0e16fd72807a1776d5023a06d12e206a952b584";
  };
