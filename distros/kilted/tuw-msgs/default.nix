...
buildRosPackage {
  pname = "ros-kilted-tuw-msgs";
  version = "0.2.5-r2";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/tuw_msgs-release/archive/release/kilted/tuw_msgs/0.2.5-2.tar.gz";
    name = "0.2.5-2.tar.gz";
    sha256 = "7b0b7ab47c46fb34514fe29d352c361d0a6c6001a0439c3483715edbb728d756";
  };
