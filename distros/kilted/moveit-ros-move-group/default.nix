...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/kilted/moveit_ros_move_group/2.14.3-1.tar.gz";
    name = "2.14.3-1.tar.gz";
    sha256 = "4f46760b3e4be67468a550312be36c0f24471bf7f7afa3b004a08a2b0e58b71b";
  };
