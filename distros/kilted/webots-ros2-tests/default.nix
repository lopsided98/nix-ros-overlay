...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/kilted/webots_ros2_tests/2025.0.1-1.tar.gz";
    name = "2025.0.1-1.tar.gz";
    sha256 = "17d0cd4ee57c0d58c22091bbf17a5add086f9a7d24728f524724fbce6885d299";
  };
