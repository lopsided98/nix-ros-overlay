...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/pid_controller/5.16.0-1.tar.gz";
    name = "5.16.0-1.tar.gz";
    sha256 = "c5328c28f3d257d8ccdf4cec6697c69f186bbb1286ac4c292c218a47ca51a07a";
  };
