...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/pid_controller/5.13.0-1.tar.gz";
    name = "5.13.0-1.tar.gz";
    sha256 = "5d8a9c919c93e25e885a377e789ea6f03e7cb90ded1b1e7212855f10d17f5afb";
  };
