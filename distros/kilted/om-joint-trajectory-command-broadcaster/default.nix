...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/kilted/om_joint_trajectory_command_broadcaster/3.2.2-1.tar.gz";
    name = "3.2.2-1.tar.gz";
    sha256 = "3eba5be43483b39df279b547d9c71c608b78e4ff75e84e08f5f709f680afe654";
  };
