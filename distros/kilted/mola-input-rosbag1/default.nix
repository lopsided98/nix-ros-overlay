...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_input_rosbag1-release/archive/release/kilted/mola_input_rosbag1/0.3.0-1.tar.gz";
    name = "0.3.0-1.tar.gz";
    sha256 = "1844b97f268325cbe323903dd4ff25d5d8a70100652c1423f00779558b0b88fb";
  };
