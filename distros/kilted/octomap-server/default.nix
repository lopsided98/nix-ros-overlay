...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/octomap_mapping-release/archive/release/kilted/octomap_server/2.3.1-1.tar.gz";
    name = "2.3.1-1.tar.gz";
    sha256 = "3133923de4d40f21355f5667517b2428da4624e031670fb270ecc615decd1149";
  };
