...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz2/15.0.11-1.tar.gz";
    name = "15.0.11-1.tar.gz";
    sha256 = "c58077ab25663bedb1471cc8e2f104ec55d360f4c3370859e9c3c7cda6894336";
  };
