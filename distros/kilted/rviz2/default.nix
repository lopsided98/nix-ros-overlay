...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/kilted/rviz2/15.0.15-1.tar.gz";
    name = "15.0.15-1.tar.gz";
    sha256 = "484dbf75d5f357eafd332e1c479ebfc7520b19d2cd169403a641ea5f190e020a";
  };
