...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/introlab/rtabmap_ros-release/archive/release/kilted/rtabmap_util/0.22.0-1.tar.gz";
    name = "0.22.0-1.tar.gz";
    sha256 = "413bfa7893586e55809e6f8fa1e20a59f1bd5dce3f5a16b607753acd05369359";
  };
