...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/generate_parameter_library-release/archive/release/kilted/parameter_traits/0.6.0-1.tar.gz";
    name = "0.6.0-1.tar.gz";
    sha256 = "0143c0dfe45e29099ba53b97978f7d2f76891c55eb77e48975c88467fde8ef18";
  };
