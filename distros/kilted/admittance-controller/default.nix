...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/admittance_controller/5.16.0-1.tar.gz";
    name = "5.16.0-1.tar.gz";
    sha256 = "662868cbeae5ebbd2355c9f8c3ba7bb051b8d1012f34437f176f70794bc7838c";
  };
