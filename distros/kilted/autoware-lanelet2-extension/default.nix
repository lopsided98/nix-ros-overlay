...
buildRosPackage {
  pname = "ros-kilted-autoware-lanelet2-extension";
  version = "0.7.0-r2";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_lanelet2_extension-release/archive/release/kilted/autoware_lanelet2_extension/0.7.0-2.tar.gz";
    name = "0.7.0-2.tar.gz";
    sha256 = "60837d3ed1f8cd4ba738078546eddf78986da22f5fec7c8f6d248311999696d8";
  };
