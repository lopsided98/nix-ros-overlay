...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/kilted/swri_image_util/3.7.5-1.tar.gz";
    name = "3.7.5-1.tar.gz";
    sha256 = "f71cd891bd0f56843e898f9866f2feb7cbe8627ef30f281bf581057729c2c3de";
  };
