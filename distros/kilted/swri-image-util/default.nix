...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/kilted/swri_image_util/3.8.1-1.tar.gz";
    name = "3.8.1-1.tar.gz";
    sha256 = "8d8fb288987c4367480b84a94304ebae3f480291fb05603d904654ee173606b0";
  };
