...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/realtime_tools-release/archive/release/kilted/realtime_tools/4.3.0-1.tar.gz";
    name = "4.3.0-1.tar.gz";
    sha256 = "2245d82040493359b9cc3c5806cae489c81a3019c100a2f13a65d0d927a9f5ba";
  };
