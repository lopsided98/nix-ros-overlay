...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/ros2controlcli/5.17.0-1.tar.gz";
    name = "5.17.0-1.tar.gz";
    sha256 = "d5d916336555ac528a9e3b27d84902591e4394c292af96da03ee42ac4fa3d892";
  };
