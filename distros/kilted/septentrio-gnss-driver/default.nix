...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/septentrio_gnss_driver_ros2-release/archive/release/kilted/septentrio_gnss_driver/1.4.5-1.tar.gz";
    name = "1.4.5-1.tar.gz";
    sha256 = "75e00286a16ef6111506e59faa65ed0a2cc0af47cbc1a4e5d8cefd71f7ea9433";
  };
