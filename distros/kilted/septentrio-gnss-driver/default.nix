...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/septentrio_gnss_driver_ros2-release/archive/release/kilted/septentrio_gnss_driver/1.4.3-1.tar.gz";
    name = "1.4.3-1.tar.gz";
    sha256 = "920c61a56dbe26ac5850e1548a75a9bc068a6137305c6f609e85d91927e69d54";
  };
