...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/kilted/om_gravity_compensation_controller/4.1.2-1.tar.gz";
    name = "4.1.2-1.tar.gz";
    sha256 = "0ad700bdd811456a5fe296f734efc56fc9cf848b0a88601ef0630bc8275f1a7c";
  };
