...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libnav/2.14.11-1.tar.gz";
    name = "2.14.11-1.tar.gz";
    sha256 = "0f89fc7279d6bebae58ade46e8fdebf23be5b6499fbd861b914ae9aced7f6db8";
  };
