...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libnav/2.14.10-1.tar.gz";
    name = "2.14.10-1.tar.gz";
    sha256 = "d92e89f87c1811836810019148465768e568501e9f89927b20df8bd2d636f736";
  };
