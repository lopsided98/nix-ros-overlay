...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/kilted/rclcpp_action/29.5.4-1.tar.gz";
    name = "29.5.4-1.tar.gz";
    sha256 = "6b7d952cda7bc9c7673093e4b24c67c4ae8486ffbd37272b54622d21a0010d98";
  };
