...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/kilted/rclcpp_action/29.5.6-1.tar.gz";
    name = "29.5.6-1.tar.gz";
    sha256 = "06a8a860209a6050151efcb092220269371ee336b407d2efc65037f386b5274d";
  };
