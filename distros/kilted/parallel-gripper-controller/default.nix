...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/parallel_gripper_controller/5.2.0-1.tar.gz";
    name = "5.2.0-1.tar.gz";
    sha256 = "0c550e6f30761e4ab9f0b6f2ed831282ecc4b3126705e9d024e042d8ff04e7a1";
  };
