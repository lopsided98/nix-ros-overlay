...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/parallel_gripper_controller/5.9.0-1.tar.gz";
    name = "5.9.0-1.tar.gz";
    sha256 = "e73edbef848382056b46a02f74dccd63518be9ca49eb2bc6c0da49d7b7f61d87";
  };
