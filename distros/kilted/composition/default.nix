...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/kilted/composition/0.36.4-1.tar.gz";
    name = "0.36.4-1.tar.gz";
    sha256 = "0e11febd696482fb27ce0bf15613ba18ce82286ab32e27706e670b6081db8f1d";
  };
