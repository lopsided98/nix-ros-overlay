...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/kilted/composition/0.36.0-1.tar.gz";
    name = "0.36.0-1.tar.gz";
    sha256 = "508c832f5fec339a6a4b30a222ad5f7e02811ee5265deaec28afa42daeeba357";
  };
