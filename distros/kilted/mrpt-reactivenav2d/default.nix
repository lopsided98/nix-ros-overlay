...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/kilted/mrpt_reactivenav2d/2.2.3-1.tar.gz";
    name = "2.2.3-1.tar.gz";
    sha256 = "573ba80d93236e61fb8b34b584af4fcb4aea273f1380b61ec7e6628647d453da";
  };
