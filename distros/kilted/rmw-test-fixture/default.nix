...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake_ros-release/archive/release/kilted/rmw_test_fixture/0.14.4-1.tar.gz";
    name = "0.14.4-1.tar.gz";
    sha256 = "f69ab7b5198e07d26cb4acbbe6b72c5b1b8c2c4322ec49f30f48d527b13aa18f";
  };
