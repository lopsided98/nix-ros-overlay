...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/kilted/moveit_ros_tests/2.13.2-2.tar.gz";
    name = "2.13.2-2.tar.gz";
    sha256 = "ece370dab92e79c26676b5d82fa3dc820281e0e81d85b82b4b14516432ae5c44";
  };
