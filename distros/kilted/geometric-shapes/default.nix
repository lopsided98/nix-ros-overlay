...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometric_shapes-release/archive/release/kilted/geometric_shapes/2.3.2-2.tar.gz";
    name = "2.3.2-2.tar.gz";
    sha256 = "50b924bae9648875e07d7c40d9da5d8f1839b6b4529fc344e559c12c8c6dbad6";
  };
