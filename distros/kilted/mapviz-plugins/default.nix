...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/kilted/mapviz_plugins/2.5.6-1.tar.gz";
    name = "2.5.6-1.tar.gz";
    sha256 = "85083bca1d2da6eacc614b1c8c31ffec198fd340743132924d8e55fe0deeb4fa";
  };
