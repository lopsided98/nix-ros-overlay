...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/kilted/mapviz_plugins/2.4.8-1.tar.gz";
    name = "2.4.8-1.tar.gz";
    sha256 = "c280d9bb106fe72e8c55a59ee70c369eaa7dd4e5a7dbb8eee7181d5fef3a75e1";
  };
