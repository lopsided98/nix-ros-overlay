...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/kilted/mapviz_plugins/2.6.1-1.tar.gz";
    name = "2.6.1-1.tar.gz";
    sha256 = "753a963080b98e610003f787a8369e181d8a2b545a920aa815918c38ec4e0664";
  };
