...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libmaps/2.14.11-1.tar.gz";
    name = "2.14.11-1.tar.gz";
    sha256 = "b8228a8f439e2a683985255434a035c109c6e93f5d3035230000d4c102c288bc";
  };
