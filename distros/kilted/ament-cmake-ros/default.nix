...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake_ros-release/archive/release/kilted/ament_cmake_ros/0.14.4-1.tar.gz";
    name = "0.14.4-1.tar.gz";
    sha256 = "bc61c47d10703b6961191532fc32697a5bd7d9b827b6ac23acddf63c720acb56";
  };
