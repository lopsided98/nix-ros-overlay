...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/aruco_opencv-release/archive/release/kilted/aruco_opencv/6.1.1-1.tar.gz";
    name = "6.1.1-1.tar.gz";
    sha256 = "ca97be4b91d561dbf5335c3c9153f717db5b484a636eafd011fd36de80e8b69d";
  };
