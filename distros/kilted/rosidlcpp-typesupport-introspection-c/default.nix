...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidlcpp-release/archive/release/kilted/rosidlcpp_typesupport_introspection_c/0.2.1-1.tar.gz";
    name = "0.2.1-1.tar.gz";
    sha256 = "1fc360c386a2b9569e6f192bad1ada8ec859c22cbdc9c0f9bc0a4235874fd979";
  };
