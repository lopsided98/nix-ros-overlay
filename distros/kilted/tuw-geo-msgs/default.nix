...
buildRosPackage {
  pname = "ros-kilted-tuw-geo-msgs";
  version = "0.2.5-r2";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/tuw_msgs-release/archive/release/kilted/tuw_geo_msgs/0.2.5-2.tar.gz";
    name = "0.2.5-2.tar.gz";
    sha256 = "a3da85167882037c9c0c08f26e7503755b93fa31b9e42ae61208cabbfb173b70";
  };
