...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/turtlebot3-release/archive/release/kilted/turtlebot3/2.3.6-1.tar.gz";
    name = "2.3.6-1.tar.gz";
    sha256 = "826d97b1e72f155383b4b036726a16c0f5303c4e7fb0a4d8b95ca04052d466ac";
  };
