...
buildRosPackage {
  pname = "ros-kilted-rmf-visualization-fleet-states";
  version = "2.4.2-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmf_visualization-release/archive/release/kilted/rmf_visualization_fleet_states/2.4.2-1.tar.gz";
    name = "2.4.2-1.tar.gz";
    sha256 = "602dbf0988073ca31dc77c5999cc57edde807100d8b6587ce179f11b2e035e49";
  };
