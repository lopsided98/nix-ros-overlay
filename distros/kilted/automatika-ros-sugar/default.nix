...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/kilted/automatika_ros_sugar/0.3.1-1.tar.gz";
    name = "0.3.1-1.tar.gz";
    sha256 = "66d2a93dee1e662110a81f2a6d405986fc260be1f88e1fcda70af2c08d0dfb5c";
  };
