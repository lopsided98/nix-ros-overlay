...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/kilted/automatika_ros_sugar/0.4.3-1.tar.gz";
    name = "0.4.3-1.tar.gz";
    sha256 = "d14e445e5753e3ae9c9ae9984b027d221ac02f0363fb656b1fb57c9432f4cdfa";
  };
