...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/automatika_ros_sugar-release/archive/release/kilted/automatika_ros_sugar/0.4.2-1.tar.gz";
    name = "0.4.2-1.tar.gz";
    sha256 = "bf0bf47a60a6dbbd3e3905d5846550fd519e7d3ee3f28b81c28e0180b44f3dc2";
  };
