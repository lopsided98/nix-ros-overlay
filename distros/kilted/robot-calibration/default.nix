...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/robot_calibration-release/archive/release/kilted/robot_calibration/0.10.1-1.tar.gz";
    name = "0.10.1-1.tar.gz";
    sha256 = "e9dfac8c3bacabb7b94ab805050c125a2d14f9a365a5862e733121449246ee7f";
  };
