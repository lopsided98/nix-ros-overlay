...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/kilted/yasmin_demos/3.5.1-1.tar.gz";
    name = "3.5.1-1.tar.gz";
    sha256 = "b716a117b9b912371e2b8ef5277950cb07e52d3e4406aebc64cccd2db193be2e";
  };
