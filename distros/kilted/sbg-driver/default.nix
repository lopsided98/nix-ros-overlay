...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SBG-Systems/sbg_ros2-release/archive/release/kilted/sbg_driver/3.4.0-1.tar.gz";
    name = "3.4.0-1.tar.gz";
    sha256 = "551dbe99e320853290ab787f84165c488e0f46e9bddfbc58539ded6c3f06e627";
  };
