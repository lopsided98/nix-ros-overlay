...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/nodl-release/archive/release/kilted/ament_nodl/2.0.3-1.tar.gz";
    name = "2.0.3-1.tar.gz";
    sha256 = "c38ad10e9f1c3290efe2f1076e275297649b3e13e2b29345bcd6255b5451f17a";
  };
