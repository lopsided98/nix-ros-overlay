...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2component/0.38.5-1.tar.gz";
    name = "0.38.5-1.tar.gz";
    sha256 = "3d1031467fb69293d0c696ffc512e838b2a95615a63001e0038307dfdbfe2a7a";
  };
