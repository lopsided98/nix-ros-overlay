...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2component/0.38.4-1.tar.gz";
    name = "0.38.4-1.tar.gz";
    sha256 = "060691de4f2092097524256fc7c74b20316ba0496e2fc5f3c22090a3ece39bfe";
  };
