...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2component/0.38.2-1.tar.gz";
    name = "0.38.2-1.tar.gz";
    sha256 = "5d34e87e092fb903b64fff7c41e69617d53bfce5ca3711053cfb0416643cd74b";
  };
