...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/etsi_its_messages-release/archive/release/kilted/etsi_its_coding/3.4.0-1.tar.gz";
    name = "3.4.0-1.tar.gz";
    sha256 = "831a1ee407513cb6f7c5565fc162669d6f67f6abda11a46f9fd3bd81207e669a";
  };
