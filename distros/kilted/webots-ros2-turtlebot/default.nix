...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/kilted/webots_ros2_turtlebot/2025.0.1-1.tar.gz";
    name = "2025.0.1-1.tar.gz";
    sha256 = "cf0bf9a42eccb242f98bf6646e3da82c5f80d1db753389d85d09af9d903ea336";
  };
