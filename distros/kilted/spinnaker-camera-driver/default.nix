...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/flir_camera_driver-release/archive/release/kilted/spinnaker_camera_driver/3.0.2-1.tar.gz";
    name = "3.0.2-1.tar.gz";
    sha256 = "ee83b36c464ee652bf7d7a62c15b0051c28f70ff906485a234d20030a70d2f7d";
  };
