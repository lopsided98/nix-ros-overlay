...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/kilted/mola_launcher/1.8.1-1.tar.gz";
    name = "1.8.1-1.tar.gz";
    sha256 = "45d248979e08216a770a94b709d59c616f7b547c0e9ae01fb2b336f8144b5920";
  };
