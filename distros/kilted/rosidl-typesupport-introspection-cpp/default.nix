...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/kilted/rosidl_typesupport_introspection_cpp/4.9.7-1.tar.gz";
    name = "4.9.7-1.tar.gz";
    sha256 = "0a740952b533af1165073ef5a0bd03ba135351eb1c343bff822c997c0e13de96";
  };
