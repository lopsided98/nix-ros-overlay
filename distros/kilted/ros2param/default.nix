...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2param/0.38.5-1.tar.gz";
    name = "0.38.5-1.tar.gz";
    sha256 = "d754be522612bb69e8a64e59d8f340560b9ed2da2a53f5c885262084e7fbe432";
  };
