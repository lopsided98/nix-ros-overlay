...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2cli/0.38.4-1.tar.gz";
    name = "0.38.4-1.tar.gz";
    sha256 = "c0c19dd550e267383fcf7ef91e3648dece74984d52b2ef3a8a1c61c9deec8603";
  };
