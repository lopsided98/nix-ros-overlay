...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/kilted/ur_controllers/4.0.0-1.tar.gz";
    name = "4.0.0-1.tar.gz";
    sha256 = "f82de079567674892b0001beb0ad507778e11254fa2908cb05c1bfd1929da1e9";
  };
