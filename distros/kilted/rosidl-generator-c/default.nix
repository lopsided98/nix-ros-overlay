...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/kilted/rosidl_generator_c/4.9.8-1.tar.gz";
    name = "4.9.8-1.tar.gz";
    sha256 = "b6ab579cc2babc5ccb98ea2ce4eba979ec8efcdfaa5f614a1f697b917c60c82e";
  };
