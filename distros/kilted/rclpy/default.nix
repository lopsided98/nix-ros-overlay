...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclpy-release/archive/release/kilted/rclpy/9.1.4-1.tar.gz";
    name = "9.1.4-1.tar.gz";
    sha256 = "06adf8857d22e9c53ae975aa4ba34a47c783b611f1403066f07d0bf164089a10";
  };
