...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclpy-release/archive/release/kilted/rclpy/9.1.5-1.tar.gz";
    name = "9.1.5-1.tar.gz";
    sha256 = "05083ccdb0b4506304006886193edf0076515236de4e091d6eb4a64ad45a7ad6";
  };
