...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclpy-release/archive/release/kilted/rclpy/9.1.1-1.tar.gz";
    name = "9.1.1-1.tar.gz";
    sha256 = "347e671e08952e8b51ba7b4590a87584f9cd10455840aaca41bff72bf0e13664";
  };
