...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/kilted/swri_cli_tools/3.7.5-1.tar.gz";
    name = "3.7.5-1.tar.gz";
    sha256 = "62865beeefd828ea1d95a1f43a7ad883c8287b479bf938e52c7f13ea1c40384b";
  };
