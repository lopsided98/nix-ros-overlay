...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/clips_executive-release/archive/release/kilted/cx_tf2_pose_tracker_plugin/0.1.3-1.tar.gz";
    name = "0.1.3-1.tar.gz";
    sha256 = "ac103348c0062062cee5f6b88010b313937b48e08460dfb2675d3c918048dab7";
  };
