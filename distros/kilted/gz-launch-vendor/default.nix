...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gz_launch_vendor-release/archive/release/kilted/gz_launch_vendor/0.2.2-1.tar.gz";
    name = "0.2.2-1.tar.gz";
    sha256 = "faaed98a625e36659ea09105da9b84ee241f48835c033a6fe780caa894d277ca";
  };
  ...
  meta = {
    description = "Vendor package for: gz-launch8 8.0.2
