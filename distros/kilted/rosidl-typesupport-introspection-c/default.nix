...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/kilted/rosidl_typesupport_introspection_c/4.9.8-1.tar.gz";
    name = "4.9.8-1.tar.gz";
    sha256 = "b808565de299dc7a4c4231c8320d0ba2b4806abbf0bf4d5f229256eabc252779";
  };
