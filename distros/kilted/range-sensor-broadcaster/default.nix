...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/range_sensor_broadcaster/5.17.0-1.tar.gz";
    name = "5.17.0-1.tar.gz";
    sha256 = "ed55dc07c165e81edadd8e8efadbc81b9b046240a4f7a662ce9757c98e6f37da";
  };
