...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/range_sensor_broadcaster/5.16.0-1.tar.gz";
    name = "5.16.0-1.tar.gz";
    sha256 = "1201b767eb2079ec4826f3342dfb9bc35974fdcc55142015f08d0b428bd2f33b";
  };
