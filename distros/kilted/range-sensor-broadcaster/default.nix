...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/range_sensor_broadcaster/5.5.0-2.tar.gz";
    name = "5.5.0-2.tar.gz";
    sha256 = "2a44767c5064fcc23a0423923631d5ccbb680b41d8d16562505b9ae7da3ef375";
  };
