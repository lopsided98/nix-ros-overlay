...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/range_sensor_broadcaster/5.10.0-1.tar.gz";
    name = "5.10.0-1.tar.gz";
    sha256 = "0c3c26f6cb56ffb9dfef6dbe1b1b354655927608271b5b6a745b7424603a8cdb";
  };
