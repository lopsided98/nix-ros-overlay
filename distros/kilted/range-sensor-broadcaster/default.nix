...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/range_sensor_broadcaster/5.2.0-1.tar.gz";
    name = "5.2.0-1.tar.gz";
    sha256 = "97af43317c7685854a4d9d3332a6689bbc116272eac8139099be41e018cc29b7";
  };
