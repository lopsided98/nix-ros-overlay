...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/yasmin-release/archive/release/kilted/yasmin_ros/3.5.1-1.tar.gz";
    name = "3.5.1-1.tar.gz";
    sha256 = "e227d131982512375b02d670cecfed9e32647eb690c89a1295551bebb892b486";
  };
