...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/fields2cover-release/archive/release/kilted/fields2cover/2.1.1-1.tar.gz";
    name = "2.1.1-1.tar.gz";
    sha256 = "cacfc071cc69a91b10316e4c384424687c20ff52ffcc00cebbebfcb50ab8a18c";
  };
