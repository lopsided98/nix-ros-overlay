...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/microstrain_inertial-release/archive/release/kilted/microstrain_inertial_examples/4.7.0-1.tar.gz";
    name = "4.7.0-1.tar.gz";
    sha256 = "2114e7f744ea8e106dcc62fa33c9deda4b4852d4e7a08ae4c36300f4b3929620";
  };
