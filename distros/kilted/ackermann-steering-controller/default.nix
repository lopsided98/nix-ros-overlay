...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/ackermann_steering_controller/5.16.0-1.tar.gz";
    name = "5.16.0-1.tar.gz";
    sha256 = "c0d85137e36ef7fe1d1b6432a0cbfc869c7046ebad1f1f0c10acd28168aa7733";
  };
