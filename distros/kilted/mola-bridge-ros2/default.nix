...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/kilted/mola_bridge_ros2/1.8.1-1.tar.gz";
    name = "1.8.1-1.tar.gz";
    sha256 = "ac42be1d8ed5a4993aa2916343ea000f4a553bd7e5f879746df935764ac9ab50";
  };
