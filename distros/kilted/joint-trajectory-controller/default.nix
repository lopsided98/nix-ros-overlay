...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/joint_trajectory_controller/5.5.0-2.tar.gz";
    name = "5.5.0-2.tar.gz";
    sha256 = "431e94e5477194c609ed21413b6ba4cc8163cad8eaa20f2071b8a124e64e9767";
  };
