...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/joint_trajectory_controller/5.13.0-1.tar.gz";
    name = "5.13.0-1.tar.gz";
    sha256 = "c772f6cf622baaafc372266bdaf431ca00137cbe434bd4c30d65c5f4bdab24dc";
  };
