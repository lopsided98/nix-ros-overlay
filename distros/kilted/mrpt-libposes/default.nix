...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libposes/2.14.10-1.tar.gz";
    name = "2.14.10-1.tar.gz";
    sha256 = "844fd5ab5ebbcad44684f45f39d3fa388ec07e04b1eaac1e2bb34e2016484cf0";
  };
