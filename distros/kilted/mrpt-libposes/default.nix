...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libposes/2.14.11-1.tar.gz";
    name = "2.14.11-1.tar.gz";
    sha256 = "0f7c2a0abcc1ecd2ad0c3774e5c3cb3b956b75c9b5ebd38cf2ab56e671f91a95";
  };
