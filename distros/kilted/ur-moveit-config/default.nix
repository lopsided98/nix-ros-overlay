...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/kilted/ur_moveit_config/4.0.0-1.tar.gz";
    name = "4.0.0-1.tar.gz";
    sha256 = "a09ecf43450b6c12e0febccbe93a72428dbb45d9ac0c3a227a51356e648a7d70";
  };
