...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/state_interfaces_broadcaster/5.13.1-1.tar.gz";
    name = "5.13.1-1.tar.gz";
    sha256 = "d547b049985ff1e781bde777b24165ef958df03b9f8c7fe7eeaf77ddcaca78c0";
  };
