...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/kilted/open_manipulator_playground/4.0.6-1.tar.gz";
    name = "4.0.6-1.tar.gz";
    sha256 = "c997e734d586d3e423b114e4aa5acc8df0806ec8c7079e300829068c2d74e370";
  };
