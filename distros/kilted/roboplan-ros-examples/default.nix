...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/roboplan_ros-release/archive/release/kilted/roboplan_ros_examples/0.7.0-1.tar.gz";
    name = "0.7.0-1.tar.gz";
    sha256 = "c41a9df5c8c576042348789f850376aef387d078ef174f2cad0baf8281054c94";
  };
