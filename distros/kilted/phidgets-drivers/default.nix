...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/phidgets_drivers-release/archive/release/kilted/phidgets_drivers/2.3.4-1.tar.gz";
    name = "2.3.4-1.tar.gz";
    sha256 = "06d68c4a480907092e87a9ac002b7f0067179ee2605662eedcd16dd6652d1b44";
  };
