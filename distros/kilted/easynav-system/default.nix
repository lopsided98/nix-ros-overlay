...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/EasyNavigation/EasyNavigation-release/archive/release/kilted/easynav_system/0.4.1-1.tar.gz";
    name = "0.4.1-1.tar.gz";
    sha256 = "c89ec3102ad33f5d770706feedc185f75cd753338847db68b4c70c450497dce3";
  };
