...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/diff_drive_controller/5.9.0-1.tar.gz";
    name = "5.9.0-1.tar.gz";
    sha256 = "f5e9dda89b416871f383452f4d2e3a4b19be487680f8bd10282a1c9bd88b8aa3";
  };
