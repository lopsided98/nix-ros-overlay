...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/controller_interface/5.8.1-1.tar.gz";
    name = "5.8.1-1.tar.gz";
    sha256 = "7a5a1780ed95e7bd7a70cd41854de00aceb07db710fd37900265157cc55eeeb8";
  };
