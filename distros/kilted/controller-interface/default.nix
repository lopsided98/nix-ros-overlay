...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/controller_interface/5.18.0-1.tar.gz";
    name = "5.18.0-1.tar.gz";
    sha256 = "2a9be1323957d172dbab5721ae517f852080b9f3a96545c3997a7d0b80801747";
  };
