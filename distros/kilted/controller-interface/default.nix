...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/controller_interface/5.8.2-1.tar.gz";
    name = "5.8.2-1.tar.gz";
    sha256 = "1439b6f623820ab95a5ec1aed2f6d3127606628ce089a43c4025ed40e9711baf";
  };
