...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/kilted/swri_transform_util/3.7.5-1.tar.gz";
    name = "3.7.5-1.tar.gz";
    sha256 = "028b862b7a6f1df9bb9836725f8aede339f6e5f9802f0490361a51c14e01b3fb";
  };
