...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/kilted/swri_transform_util/3.8.7-1.tar.gz";
    name = "3.8.7-1.tar.gz";
    sha256 = "2f914f7f8b77df2d9a5e2ed67e30033c8e61ad27593d1988b736e4a384f9ba59";
  };
