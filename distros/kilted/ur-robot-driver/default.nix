...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/kilted/ur_robot_driver/4.0.0-1.tar.gz";
    name = "4.0.0-1.tar.gz";
    sha256 = "39af4c0b87565be4164f4b1a1c8e7e79d379a0f5b790f008d7690e057bb5ad1c";
  };
