...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/kilted/ur_robot_driver/4.0.3-1.tar.gz";
    name = "4.0.3-1.tar.gz";
    sha256 = "ff758c3bc0f91cc7fc3504b1e3872cd47e1425b85722de33eb07ede827efc43e";
  };
