...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/joint_limits/5.18.1-1.tar.gz";
    name = "5.18.1-1.tar.gz";
    sha256 = "e7bcedd50b4a6bc0a2c0cb0b2fc8ac0298a184413c4ecc160220a6a98ccbc173";
  };
