...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/joint_limits/5.15.0-1.tar.gz";
    name = "5.15.0-1.tar.gz";
    sha256 = "3ce21cdf863a04c93ee23793f0fab042b8e5ce695fd9635a4d363c8bde7d2354";
  };
