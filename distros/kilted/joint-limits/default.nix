...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/joint_limits/5.8.0-1.tar.gz";
    name = "5.8.0-1.tar.gz";
    sha256 = "ec96c3f99945122ef7a69f4ad0ddb50eeaaed44dbc23249749b27fc888d6ce48";
  };
