...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/kilted/joint_limits/5.16.0-1.tar.gz";
    name = "5.16.0-1.tar.gz";
    sha256 = "e6d99182ad60606816a8bfe5f5c42ca9787cca489acc0b549c4b1b96b7903457";
  };
