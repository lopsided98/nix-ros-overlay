...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/kilted/moveit_ros_robot_interaction/2.14.3-1.tar.gz";
    name = "2.14.3-1.tar.gz";
    sha256 = "d85803c1d8a9c60afb7b355ffc99e58345a8418b5907b9a22711be48340a3ae9";
  };
