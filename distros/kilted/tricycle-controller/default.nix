...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/tricycle_controller/5.11.0-1.tar.gz";
    name = "5.11.0-1.tar.gz";
    sha256 = "dc7415d4c7b01877d50a4751f8a0721cdce703fc81da7f01be42e6afdedbd005";
  };
