...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/kilted/mrpt_tps_astar_planner/2.2.3-1.tar.gz";
    name = "2.2.3-1.tar.gz";
    sha256 = "a0d9817766569ebca677b99a7ab01964f5e0166eb26995dff0b9bb7541434bab";
  };
