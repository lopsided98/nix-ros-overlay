...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/kilted/mrpt_tps_astar_planner/2.2.1-2.tar.gz";
    name = "2.2.1-2.tar.gz";
    sha256 = "d547db8ff717cacb4b791b6883890c3e57a39c0fc7da031a2685e5c954c54242";
  };
