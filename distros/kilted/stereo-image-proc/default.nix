...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/kilted/stereo_image_proc/6.0.11-1.tar.gz";
    name = "6.0.11-1.tar.gz";
    sha256 = "55f064ba6ad1938430cbec6560c9df4da4016b68e2faa7141f61274ecd8af964";
  };
