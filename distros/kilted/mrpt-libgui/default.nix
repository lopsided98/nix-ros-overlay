...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/kilted/mrpt_libgui/2.14.11-1.tar.gz";
    name = "2.14.11-1.tar.gz";
    sha256 = "101546c31b10f4b219256fcebaec4f2847e81a661f38c0648fcd109f9b9311f1";
  };
