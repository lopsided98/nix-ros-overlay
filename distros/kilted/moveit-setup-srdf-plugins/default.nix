...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/kilted/moveit_setup_srdf_plugins/2.14.3-1.tar.gz";
    name = "2.14.3-1.tar.gz";
    sha256 = "a6f1d36827f1d515e6678b700f14eb0170a5bac85ec9e01793a9ff5420af0ea4";
  };
