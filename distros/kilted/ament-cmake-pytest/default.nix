...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/kilted/ament_cmake_pytest/2.7.3-2.tar.gz";
    name = "2.7.3-2.tar.gz";
    sha256 = "a61f1ff97586037bd5425dcbf30aa458c5a56d95d2fb99e1f729e9831a0c81fb";
  };
