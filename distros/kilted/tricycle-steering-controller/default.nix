...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/kilted/tricycle_steering_controller/5.13.0-1.tar.gz";
    name = "5.13.0-1.tar.gz";
    sha256 = "9ad69fee72a232330a65cac542180ea9286c246abdf39fa7aba1a0ef5b79289b";
  };
