...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/kilted/ros2launch/0.28.7-1.tar.gz";
    name = "0.28.7-1.tar.gz";
    sha256 = "a66e6845199a969a4440a7ee787771b93f902bc0dc629e86677e3f0be2362eb8";
  };
