...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2interface/0.38.5-1.tar.gz";
    name = "0.38.5-1.tar.gz";
    sha256 = "f126d773f393b8d2aaf47702cfb65bf82c2042db516a6d7295a61393703e2231";
  };
