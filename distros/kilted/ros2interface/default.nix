...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2interface/0.38.4-1.tar.gz";
    name = "0.38.4-1.tar.gz";
    sha256 = "0bedab21ad1706463de64bede46503cf48dc41c4da93b87dbe79c2f922bca0a4";
  };
