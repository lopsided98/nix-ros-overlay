...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/kilted/ros2interface/0.38.2-1.tar.gz";
    name = "0.38.2-1.tar.gz";
    sha256 = "e759f713454a338efe7fcbf41c6d8a18be97837b5df8eb52cb5d374db5237a78";
  };
