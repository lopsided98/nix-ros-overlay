...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/kilted/tf2/0.41.10-1.tar.gz";
    name = "0.41.10-1.tar.gz";
    sha256 = "5813cb362a757b3d9beac638e8a8407b03a892c3132fce56c9cf2a0022343069";
  };
