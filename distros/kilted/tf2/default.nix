...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/kilted/tf2/0.41.1-1.tar.gz";
    name = "0.41.1-1.tar.gz";
    sha256 = "0f0ef8a80e53bccd9d59a83774025defd994bc1c24a8dd31c2e9b93f59549479";
  };
