...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_gnss_to_markers-release/archive/release/kilted/mola_gnss_to_markers/0.2.0-1.tar.gz";
    name = "0.2.0-1.tar.gz";
    sha256 = "7dbbbb19652800c331f613a6faa4e4691fee1cee8a9068069bf984aa6786a08f";
  };
