...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/qt_gui_core-release/archive/release/kilted/qt_gui/2.9.3-1.tar.gz";
    name = "2.9.3-1.tar.gz";
    sha256 = "238b43574838c84780219409fda268bd81e2e645943ee1040fb8d69843bbb460";
  };
