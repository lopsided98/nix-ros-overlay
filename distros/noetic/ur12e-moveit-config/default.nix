...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-industrial-release/universal_robot-release/archive/release/noetic/ur12e_moveit_config/1.5.0-1.tar.gz";
    name = "1.5.0-1.tar.gz";
    sha256 = "5f3a1ea966de48e7f5b413dcea88c0046f70ff42c7e0c02105beee9e958749f5";
  };
