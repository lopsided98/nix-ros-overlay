...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/at-wat/neonavigation-release/archive/release/noetic/map_organizer/0.12.2-1.tar.gz";
    name = "0.12.2-1.tar.gz";
    sha256 = "ef2e47ffbd8a611329ea393dd7929785610ba48795342fbcbb645d425143da4a";
  };
