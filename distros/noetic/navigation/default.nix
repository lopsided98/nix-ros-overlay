...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/navigation-release/archive/release/noetic/navigation/1.17.0-1.tar.gz";
    name = "1.17.0-1.tar.gz";
    sha256 = "27045546f60c681c91d93cae02490237d784c2b68684c4acebe0566ab3103442";
  };
