...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/at-wat/neonavigation-release/archive/release/noetic/planner_cspace/0.10.0-1.tar.gz";
    name = "0.10.0-1.tar.gz";
    sha256 = "0103e9e10643588ad1c815711499313248ec7ac128ebb122dbc63d69b76de431";
  };
