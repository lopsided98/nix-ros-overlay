...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/at-wat/neonavigation-release/archive/release/noetic/planner_cspace/0.17.7-1.tar.gz";
    name = "0.17.7-1.tar.gz";
    sha256 = "9b7d922011b68857620f98fef53a9642331bda06f2f732be888fa299ed24ef0f";
  };
