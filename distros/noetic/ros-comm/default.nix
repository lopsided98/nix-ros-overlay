...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/ros_comm/1.15.14-1.tar.gz";
    name = "1.15.14-1.tar.gz";
    sha256 = "130bcd19b55abb09873aba6ab1ddde4d1eaf8c02891ae9ce2516e6011ddf04c6";
  };
