...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/stack-of-tasks/pinocchio-ros-release/archive/release/noetic/pinocchio/2.6.11-1.tar.gz";
    name = "2.6.11-1.tar.gz";
    sha256 = "171a20ac7e6c8b9771918349d24376b488b4c36a9e783eca8c3809c4afdd501a";
  };
