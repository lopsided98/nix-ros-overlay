...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/mavlink/mavros-release/archive/release/noetic/mavros/1.12.2-1.tar.gz";
    name = "1.12.2-1.tar.gz";
    sha256 = "803b15739ae216f793b5f9ca34cc7cf2e001d32fc6336703d847153a631b29a8";
  };
