...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/mavlink/mavros-release/archive/release/noetic/mavros/1.18.0-1.tar.gz";
    name = "1.18.0-1.tar.gz";
    sha256 = "b27cc9f4e866cf12437337454df41ce4eafa3806ea2f8f7e30b3e26c06d11370";
  };
