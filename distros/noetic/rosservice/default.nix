...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosservice/1.15.14-1.tar.gz";
    name = "1.15.14-1.tar.gz";
    sha256 = "5f80275476285a1caee3c75b1cde1ddea423ff4d91a7da1f1b2517edad4fefbd";
  };
