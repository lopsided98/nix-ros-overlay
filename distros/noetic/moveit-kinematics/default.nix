...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/moveit-release/archive/release/noetic/moveit_kinematics/1.1.7-1.tar.gz";
    name = "1.1.7-1.tar.gz";
    sha256 = "ee3f495e031d75fac4f62561adb918a57d30c076538a6ec1bbcec1cc65585448";
  };
