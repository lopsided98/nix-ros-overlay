...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_controllers-release/archive/release/noetic/ros_controllers/0.22.0-1.tar.gz";
    name = "0.22.0-1.tar.gz";
    sha256 = "fd63dfcc5e48c5a3a644ab233fc3d76d72d6c4347894179194650cfe055b5ac3";
  };
