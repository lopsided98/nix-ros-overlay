...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_driver-release/archive/release/noetic/cob_undercarriage_ctrl/0.7.4-1.tar.gz";
    name = "0.7.4-1.tar.gz";
    sha256 = "6cd06c61c257a17242b50bec1d7c0df909448848473737104990f18b1085e2c8";
  };
