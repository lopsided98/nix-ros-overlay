...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/rm-controls/rm_control-release/archive/release/noetic/rm_control/0.1.16-1.tar.gz";
    name = "0.1.16-1.tar.gz";
    sha256 = "d1f96c6f76b8f56d04f32194b0abed800cd9231b4f31cffc462d21f1b138a003";
  };
