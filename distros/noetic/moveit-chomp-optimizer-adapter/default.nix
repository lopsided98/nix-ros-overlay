...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/moveit-release/archive/release/noetic/moveit_chomp_optimizer_adapter/1.1.7-1.tar.gz";
    name = "1.1.7-1.tar.gz";
    sha256 = "a2f963678dbe205cf397772541785423ba266148712800fc32ffc2ca73cb038f";
  };
