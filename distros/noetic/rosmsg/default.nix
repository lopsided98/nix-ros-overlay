...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosmsg/1.17.2-1.tar.gz";
    name = "1.17.2-1.tar.gz";
    sha256 = "b14a6c75eeb10152e3944b49b7a1424435035c9c8d0439fdc1e4fdf193b6290d";
  };
