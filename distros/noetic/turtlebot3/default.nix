...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ROBOTIS-GIT-release/turtlebot3-release/archive/release/noetic/turtlebot3/1.2.4-1.tar.gz";
    name = "1.2.4-1.tar.gz";
    sha256 = "a5a93bf3e6c1f8b05519a164d34fddd9ba63d84b4654c539274ba92a1605f9f7";
  };
