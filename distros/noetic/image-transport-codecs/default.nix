...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://gitlab.fel.cvut.cz/cras/ros-release/ros-utils/-/archive/release/noetic/image_transport_codecs/2.3.5-1/archive.tar.gz";
    name = "archive.tar.gz";
    sha256 = "8ac8eec63c2999e1fb9be6391abc97c7c4bf82243133a53c4a24c22c5a552eb8";
  };
