...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://gitlab.fel.cvut.cz/cras/ros-release/ros-utils/-/archive/release/noetic/image_transport_codecs/2.2.0-1/archive.tar.gz";
    name = "archive.tar.gz";
    sha256 = "4803367443260800a9a674fa3a77e0d70d92c932a65e56960a08cddd24252890";
  };
