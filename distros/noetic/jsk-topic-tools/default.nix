...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/tork-a/jsk_common-release/archive/release/noetic/jsk_topic_tools/2.2.14-1.tar.gz";
    name = "2.2.14-1.tar.gz";
    sha256 = "33c5210efa7c7b1570921efbec2a331d6b3a501494af8be201f0f3c1b49157d9";
  };
