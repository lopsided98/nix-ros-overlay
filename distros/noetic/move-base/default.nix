...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/navigation-release/archive/release/noetic/move_base/1.17.0-1.tar.gz";
    name = "1.17.0-1.tar.gz";
    sha256 = "3771ac893fd340da15f6ec2ab496d372dda21a1b949f36237ab3511c62c37b4c";
  };
