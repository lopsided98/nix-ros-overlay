...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/diagnostics-release/archive/release/noetic/diagnostic_analysis/1.10.0-1.tar.gz";
    name = "1.10.0-1.tar.gz";
    sha256 = "0d8a8bb22a174cf116a3230e56c536fa9045320cd423964570069f825aec99f9";
  };
