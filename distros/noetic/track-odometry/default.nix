...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/at-wat/neonavigation-release/archive/release/noetic/track_odometry/0.10.1-1.tar.gz";
    name = "0.10.1-1.tar.gz";
    sha256 = "d5c36a74c694ad78794fddd2c3d8deb74f8b6dbfc99536dc3638fd72e40ec760";
  };
