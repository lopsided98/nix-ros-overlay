...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/at-wat/neonavigation-release/archive/release/noetic/track_odometry/0.17.7-1.tar.gz";
    name = "0.17.7-1.tar.gz";
    sha256 = "37678909cb1987d4cff30e2d483003d716785502ce92db80b69c7c1b36c05b1a";
  };
