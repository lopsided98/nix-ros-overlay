...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/Kawasaki-Robotics/khi_robot-release/archive/release/noetic/khi_rs007l_moveit_config/1.4.0-2.tar.gz";
    name = "1.4.0-2.tar.gz";
    sha256 = "5d9e390e9f644fafb1cdb23d3d41ca9b000ab825d618f11e4891fcd879f783a3";
  };
