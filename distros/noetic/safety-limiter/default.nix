...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/at-wat/neonavigation-release/archive/release/noetic/safety_limiter/0.10.0-1.tar.gz";
    name = "0.10.0-1.tar.gz";
    sha256 = "2356d670a5639e1b0cf8d7ef08561760c1d61cb4fddd55bb1b7b7ae71cff8ac4";
  };
