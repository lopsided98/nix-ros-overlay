...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rostest/1.15.15-1.tar.gz";
    name = "1.15.15-1.tar.gz";
    sha256 = "61517f06d9743acb1f14ce403c2b782aff47a4c6fb43c71ee833d425e76a8c4a";
  };
