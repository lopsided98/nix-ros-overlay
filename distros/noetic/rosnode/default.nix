...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosnode/1.17.4-1.tar.gz";
    name = "1.17.4-1.tar.gz";
    sha256 = "cf785d069285e527fc1a7bd363018644c4c2342f35ad6783348d5b0ef7e17aa8";
  };
