...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_command_tools-release/archive/release/noetic/cob_helper_tools/0.6.18-1.tar.gz";
    name = "0.6.18-1.tar.gz";
    sha256 = "4103053117b901074ba06ecc68051c4b69d2b3ae719bf3b614dccee99f9b0930";
  };
