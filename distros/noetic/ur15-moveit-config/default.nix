...
buildRosPackage {
  pname = "ros-noetic-ur15-moveit-config";
  version = "1.5.0-r1";

  src = fetchurl {
    url = "https://github.com/ros-industrial-release/universal_robot-release/archive/release/noetic/ur15_moveit_config/1.5.0-1.tar.gz";
    name = "1.5.0-1.tar.gz";
    sha256 = "01e3eb3cae95da887cae26b9b1e662d1544f4c5a59326d47f8c113d29a4bd73e";
  };
  ...
  meta = {
    description = "An automatically generated package with all the configuration and launch files for using the ur15 with the MoveIt Motion Planning Framework";
