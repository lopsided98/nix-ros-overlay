...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosbag_storage/1.17.2-1.tar.gz";
    name = "1.17.2-1.tar.gz";
    sha256 = "310e41e31aaec3419492b493e64a9aec2c9d5025070b76b37390b08ec6b3f057";
  };
