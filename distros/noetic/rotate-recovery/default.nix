...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/navigation-release/archive/release/noetic/rotate_recovery/1.17.0-1.tar.gz";
    name = "1.17.0-1.tar.gz";
    sha256 = "bb5bb12dcdfae2fdb8c8dec4ec3a4c5616e381e991b2a96943c87a99782279ed";
  };
