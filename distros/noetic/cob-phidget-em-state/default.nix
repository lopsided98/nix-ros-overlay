...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_driver-release/archive/release/noetic/cob_phidget_em_state/0.7.4-1.tar.gz";
    name = "0.7.4-1.tar.gz";
    sha256 = "78fad50b59576933d16df811c12178833e642f2251d02bf7d48f76cbb4d3b8dc";
  };
