...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosparam/1.17.2-1.tar.gz";
    name = "1.17.2-1.tar.gz";
    sha256 = "241999f6faa926bde9eae5ea1f8574649aecd4de3f467dbfc155696b97e17df8";
  };
