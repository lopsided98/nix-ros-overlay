...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosparam/1.17.4-1.tar.gz";
    name = "1.17.4-1.tar.gz";
    sha256 = "ae21ae77c55409acb018048793bef50d3628efb73bcffe56779a4009096e8e40";
  };
