...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosbag/1.17.2-1.tar.gz";
    name = "1.17.2-1.tar.gz";
    sha256 = "1a472ab475ba24d5659c0b21a6ef34611a9b26879fbebfffe92b675867d3d207";
  };
