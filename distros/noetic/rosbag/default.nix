...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rosbag/1.17.4-1.tar.gz";
    name = "1.17.4-1.tar.gz";
    sha256 = "ce2aa7c01eaa01f0ead042c152605066faf5b180e01c2449f383b735b83263b6";
  };
