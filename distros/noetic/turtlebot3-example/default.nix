...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ROBOTIS-GIT-release/turtlebot3-release/archive/release/noetic/turtlebot3_example/1.2.4-1.tar.gz";
    name = "1.2.4-1.tar.gz";
    sha256 = "e8efb5c89466f561f79bfd79ea92d1f201722b681d2d4153e5449b783003a765";
  };
