...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/moveit-release/archive/release/noetic/moveit_ros_planning_interface/1.1.14-1.tar.gz";
    name = "1.1.14-1.tar.gz";
    sha256 = "3e60141baa68376ab338fc4a92cc60ab31537cfee514d8c74fa454c686dd4c25";
  };
