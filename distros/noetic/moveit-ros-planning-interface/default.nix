...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/moveit-release/archive/release/noetic/moveit_ros_planning_interface/1.1.7-1.tar.gz";
    name = "1.1.7-1.tar.gz";
    sha256 = "be0f8cb3250498be47e26b205209a2e099cddd5af1e6df23f1155d44234d6d8d";
  };
