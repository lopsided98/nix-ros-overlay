...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/DataspeedInc-release/dbw_mkz_ros-release/archive/release/noetic/dbw_mkz_description/1.6.5-1.tar.gz";
    name = "1.6.5-1.tar.gz";
    sha256 = "2e17bc82be57094391d9c32d241cfcdeb2496c186a5ed3e1289534d08a562854";
  };
