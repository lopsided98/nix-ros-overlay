...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ual-arm-ros-pkg-release/mvsim-release/archive/release/noetic/mvsim/0.9.3-1.tar.gz";
    name = "0.9.3-1.tar.gz";
    sha256 = "d084ed53def670ab3b7233ed5b49b3422f419b060d23677401148c97338f8073";
  };
