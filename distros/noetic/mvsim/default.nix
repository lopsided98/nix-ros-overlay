...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ual-arm-ros-pkg-release/mvsim-release/archive/release/noetic/mvsim/0.13.0-1.tar.gz";
    name = "0.13.0-1.tar.gz";
    sha256 = "454e2cdc3aa5f8497ad2733318f0080c47f608bdfd24a5f88828db0e91382643";
  };
