...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rospy/1.17.2-1.tar.gz";
    name = "1.17.2-1.tar.gz";
    sha256 = "b6b766ae933fbaaaa6f9f0e0f041a62f8d286715d6f7c38273a901412f5e3437";
  };
