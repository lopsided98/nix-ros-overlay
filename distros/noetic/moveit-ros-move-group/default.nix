...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/moveit-release/archive/release/noetic/moveit_ros_move_group/1.1.7-1.tar.gz";
    name = "1.1.7-1.tar.gz";
    sha256 = "561e1a76e2049e15ab34f5d8592734ba520e60eb25e9a704ba76b68fd7515664";
  };
