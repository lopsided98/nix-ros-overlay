...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_driver-release/archive/release/noetic/cob_generic_can/0.7.4-1.tar.gz";
    name = "0.7.4-1.tar.gz";
    sha256 = "7d8b13ffd3c9d8f1f38629832af19e33b450fb0ca623d0939615977231c88aac";
  };
