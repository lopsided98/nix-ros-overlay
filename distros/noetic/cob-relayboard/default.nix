...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_driver-release/archive/release/noetic/cob_relayboard/0.7.4-1.tar.gz";
    name = "0.7.4-1.tar.gz";
    sha256 = "643c6d9944a1e18b637747af6541946949f98f558bcacc4bc65ebfce8cf86821";
  };
