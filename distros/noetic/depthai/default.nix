...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/luxonis/depthai-core-release/archive/release/noetic/depthai/2.26.0-1.tar.gz";
    name = "2.26.0-1.tar.gz";
    sha256 = "9fb122757358c0684b24b802d62bb50cd78da0693e9ecf63c8d82ee7c1e8e7aa";
  };
