...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_driver-release/archive/release/noetic/cob_base_drive_chain/0.7.4-1.tar.gz";
    name = "0.7.4-1.tar.gz";
    sha256 = "9fb55f693b8e6e6f6823f639ef82def64b55e9380e9f0fb742f5d5d188064565";
  };
