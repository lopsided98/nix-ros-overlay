...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/jackal-release/archive/release/noetic/jackal_control/0.8.6-1.tar.gz";
    name = "0.8.6-1.tar.gz";
    sha256 = "c11f3523ad2b13789ab33fa175b15befddb2f8691a8d53493eeadaf5dabc0ec1";
  };
