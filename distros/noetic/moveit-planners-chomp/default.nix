...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/moveit-release/archive/release/noetic/moveit_planners_chomp/1.1.7-1.tar.gz";
    name = "1.1.7-1.tar.gz";
    sha256 = "38cb7af272c023f3ac7ebea9d406b011059b4e330f636d5c1692ff9951c6f9ed";
  };
