...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipab-slmc/exotica-release/archive/release/noetic/exotica_examples/6.0.1-1.tar.gz";
    name = "6.0.1-1.tar.gz";
    sha256 = "e4dfacecf0e909ad0d4a1aeaf484f9a008aeb19e341fca400448957195d29e2f";
  };
