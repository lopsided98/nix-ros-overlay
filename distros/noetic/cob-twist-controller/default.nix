...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_control-release/archive/release/noetic/cob_twist_controller/0.8.12-1.tar.gz";
    name = "0.8.12-1.tar.gz";
    sha256 = "83f033c54856d01ceb321fd0ae93864669e15119d80e9b1a15a7f4495d6b3c68";
  };
