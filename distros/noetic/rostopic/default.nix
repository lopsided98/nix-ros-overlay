...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/rostopic/1.15.11-1.tar.gz";
    name = "1.15.11-1.tar.gz";
    sha256 = "e6e71dbb5c8d5b6fd2a465b6b09b10dad596649a44a71ab12b365cee58a5ef2d";
  };
