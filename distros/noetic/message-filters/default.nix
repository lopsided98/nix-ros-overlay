...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/message_filters/1.17.4-1.tar.gz";
    name = "1.17.4-1.tar.gz";
    sha256 = "e922e1d03f47c3f1f32f595a2a13c2f633cdd7a9e81f6f4c3ea1a0658a587348";
  };
