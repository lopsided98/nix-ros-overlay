...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/roslaunch/1.15.14-1.tar.gz";
    name = "1.15.14-1.tar.gz";
    sha256 = "397e3816427fabec5692ab243964e67a2475d9d62721846cee2dde03ee862790";
  };
