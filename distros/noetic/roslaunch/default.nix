...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/noetic/roslaunch/1.17.2-1.tar.gz";
    name = "1.17.2-1.tar.gz";
    sha256 = "45d97dccd9351f2ab101ef357da7cd050475d07229248dcd4eac78db8d767edc";
  };
