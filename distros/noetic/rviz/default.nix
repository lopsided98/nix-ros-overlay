...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/rviz-release/archive/release/noetic/rviz/1.14.21-1.tar.gz";
    name = "1.14.21-1.tar.gz";
    sha256 = "3b67cc307bed02390cf4450d53ef27c1cc84f47476086082665219c9109b5344";
  };
