...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/moveit-release/archive/release/noetic/moveit_runtime/1.1.7-1.tar.gz";
    name = "1.1.7-1.tar.gz";
    sha256 = "dcc756cd0e271e587d682564117bcbb30387cb4ad1a0c4921ed8ac3d35de9c77";
  };
