...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/tork-a/jsk_3rdparty-release/archive/release/kinetic/mini_maxwell/2.1.17-1.tar.gz";
    name = "2.1.17-1.tar.gz";
    sha256 = "cbe0f75df880a5195109273e778419a8c533656fa94cb6814e39a7ba89f0fce9";
  };
