...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/at-wat/neonavigation-release/archive/release/kinetic/planner_cspace/0.10.0-1.tar.gz";
    name = "0.10.0-1.tar.gz";
    sha256 = "78878b0ce14393092ea087780d93f1a6e0839b2271b9ea8d297421dac7713660";
  };
