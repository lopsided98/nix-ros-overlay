...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/at-wat/neonavigation-release/archive/release/kinetic/planner_cspace/0.10.1-1.tar.gz";
    name = "0.10.1-1.tar.gz";
    sha256 = "490338f55bf34e698cfdf9f7251a5dbdfc7a887d1d0011480debda6b88f30d4b";
  };
