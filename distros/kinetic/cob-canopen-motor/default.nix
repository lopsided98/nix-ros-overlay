...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_driver-release/archive/release/kinetic/cob_canopen_motor/0.7.4-1.tar.gz";
    name = "0.7.4-1.tar.gz";
    sha256 = "9635dc8c7cb26752629e434b247eb7efac2b61fcfe5d93dd19c0cfe5bedf871c";
  };
