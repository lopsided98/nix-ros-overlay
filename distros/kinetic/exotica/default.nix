...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipab-slmc/exotica-release/archive/release/kinetic/exotica/6.1.1-1.tar.gz";
    name = "6.1.1-1.tar.gz";
    sha256 = "4ece0e70782ae6e17144003c4116a3185df09f5bf24ebe1c38c452a3cb382cc5";
  };
