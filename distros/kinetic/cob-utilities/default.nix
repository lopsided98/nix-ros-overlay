...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_driver-release/archive/release/kinetic/cob_utilities/0.7.3-1.tar.gz";
    name = "0.7.3-1.tar.gz";
    sha256 = "7e9cfdf1f994c9c0f311f15210ec13ab6d368ef6d21ed4e553107a204f258fdb";
  };
