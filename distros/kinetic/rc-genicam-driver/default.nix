...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/roboception-gbp/rc_genicam_driver_ros-release/archive/release/kinetic/rc_genicam_driver/0.2.0-1.tar.gz";
    name = "0.2.0-1.tar.gz";
    sha256 = "c5a9b0dcb8566c663e161790e5e81ae254ee9e9bcdadfce8edc9f78c9a68b10b";
  };
