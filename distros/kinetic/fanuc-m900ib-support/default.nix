...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-industrial-release/fanuc-release/archive/release/kinetic/fanuc_m900ib_support/0.5.1-1.tar.gz";
    name = "0.5.1-1.tar.gz";
    sha256 = "78f8ba102ae297fb5aa9b4aa08ceff596ccf8b13ff7eec405ea0c2bb092de9fe";
  };
