...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_driver-release/archive/release/kinetic/cob_sound/0.7.3-1.tar.gz";
    name = "0.7.3-1.tar.gz";
    sha256 = "f823a65be5223207b0d75bd53a34bdc936d3274974910d085f11e37430035c38";
  };
