...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_command_tools-release/archive/release/kinetic/cob_teleop/0.6.21-2.tar.gz";
    name = "0.6.21-2.tar.gz";
    sha256 = "48cdaf0fd95dd810cb1a545e8ab5445217b835d889c72da224c7cf1f1ad1a238";
  };
