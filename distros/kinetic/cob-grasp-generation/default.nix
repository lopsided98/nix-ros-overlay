...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_manipulation-release/archive/release/kinetic/cob_grasp_generation/0.7.4-1.tar.gz";
    name = "0.7.4-1.tar.gz";
    sha256 = "0253c14de529a238fbdd1a6a16f1fc831e57c68e71db470ac2c479628136a454";
  };
