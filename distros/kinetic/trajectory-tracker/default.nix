...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/at-wat/neonavigation-release/archive/release/kinetic/trajectory_tracker/0.10.1-1.tar.gz";
    name = "0.10.1-1.tar.gz";
    sha256 = "d57c944feebfbd01a4cbd6f482967ad7e808a4b65946725a31b4052687e7cfa8";
  };
