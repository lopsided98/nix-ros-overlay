...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_navigation-release/archive/release/kinetic/cob_navigation/0.6.11-1.tar.gz";
    name = "0.6.11-1.tar.gz";
    sha256 = "1c362e8c5370dbc8c26c2687cb1491ca8c2b052426b0288e903e86d3e5050f21";
  };
