...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipab-slmc/exotica-release/archive/release/kinetic/exotica_ilqg_solver/6.0.2-1.tar.gz";
    name = "6.0.2-1.tar.gz";
    sha256 = "8d9d2bda42f10e8940fa767601de0699233ee402d7270504628961a9dbef97b6";
  };
