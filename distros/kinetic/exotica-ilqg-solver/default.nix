...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipab-slmc/exotica-release/archive/release/kinetic/exotica_ilqg_solver/6.1.1-1.tar.gz";
    name = "6.1.1-1.tar.gz";
    sha256 = "8ac393db2977069e6ffc53ac466911c54ca659178b0582051f2c26a7ba4aee80";
  };
