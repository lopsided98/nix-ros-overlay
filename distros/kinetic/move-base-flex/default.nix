...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/uos-gbp/move_base_flex-release/archive/release/kinetic/move_base_flex/0.3.4-1.tar.gz";
    name = "0.3.4-1.tar.gz";
    sha256 = "f3ab06cc0cacbf1019da94b07f7eaa11655440dea8e3822ae6425ff17642b0a0";
  };
