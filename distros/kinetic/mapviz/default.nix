...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/swri-robotics-gbp/mapviz-release/archive/release/kinetic/mapviz/1.4.1-1.tar.gz";
    name = "1.4.1-1.tar.gz";
    sha256 = "51c9e718578adc08ef198cfd88eb05314403ed305c53c82a684c99060423d209";
  };
