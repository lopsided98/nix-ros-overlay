...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_driver-release/archive/release/kinetic/cob_phidget_power_state/0.7.4-1.tar.gz";
    name = "0.7.4-1.tar.gz";
    sha256 = "518349299e7f1cc4bb09f609c39c97cfa0da4c7d7b2f13b64e2be91ff53bd78b";
  };
