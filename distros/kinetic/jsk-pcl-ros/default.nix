...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/tork-a/jsk_recognition-release/archive/release/kinetic/jsk_pcl_ros/1.2.15-1.tar.gz";
    name = "1.2.15-1.tar.gz";
    sha256 = "5eda847395d78c83fb93a47d1a4f2c288dda62b580ada92c3e769fef9e249034";
  };
