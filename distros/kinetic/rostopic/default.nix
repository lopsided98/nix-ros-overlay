...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/kinetic/rostopic/1.12.15-1.tar.gz";
    name = "1.12.15-1.tar.gz";
    sha256 = "0c4d2cc662fb947e557d5fcd3a30c1bf7a987e66b8e5cd80555f52f8e6c86750";
  };
