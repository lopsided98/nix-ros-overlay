...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/uos-gbp/move_base_flex-release/archive/release/kinetic/mbf_costmap_nav/0.3.4-1.tar.gz";
    name = "0.3.4-1.tar.gz";
    sha256 = "516c326e34bb99ac9c4a4a880576839e99d39461b8d1a75df7010c2a3808f3b8";
  };
