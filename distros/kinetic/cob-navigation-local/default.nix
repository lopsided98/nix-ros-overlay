...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_navigation-release/archive/release/kinetic/cob_navigation_local/0.6.11-1.tar.gz";
    name = "0.6.11-1.tar.gz";
    sha256 = "6e69ccfd7fb076053e9851c83429f6a94d18b212e20a9fa0e55ee2831c19f3da";
  };
