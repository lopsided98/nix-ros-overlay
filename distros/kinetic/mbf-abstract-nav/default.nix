...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/uos-gbp/move_base_flex-release/archive/release/kinetic/mbf_abstract_nav/0.3.4-1.tar.gz";
    name = "0.3.4-1.tar.gz";
    sha256 = "096ac0057923c951965f34ac9fe7d84403eac68d693081217cd59399e45bb2c6";
  };
