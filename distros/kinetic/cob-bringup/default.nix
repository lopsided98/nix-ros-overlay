...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_robots-release/archive/release/kinetic/cob_bringup/0.7.4-1.tar.gz";
    name = "0.7.4-1.tar.gz";
    sha256 = "ae7b49f2cd4fdebd93f406e8ebdde10554cda160a6056558963580d5e32a371b";
  };
