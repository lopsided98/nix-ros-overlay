...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_control-release/archive/release/kinetic/cob_control/0.7.12-1.tar.gz";
    name = "0.7.12-1.tar.gz";
    sha256 = "33e6f266d06f2832e4da9834530880c41490f568c163d5fea313ed1d83d3e939";
  };
