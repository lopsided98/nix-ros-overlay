...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/RobotWebTools-release/rosbridge_suite-release/archive/release/melodic/rosbridge_library/0.11.11-1.tar.gz";
    name = "0.11.11-1.tar.gz";
    sha256 = "6b501a4fa8fdf6672106a6627301c3cba6841f370028d940eaa9c1157f04c67b";
  };
