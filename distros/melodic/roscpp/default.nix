...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/melodic/roscpp/1.14.9-1.tar.gz";
    name = "1.14.9-1.tar.gz";
    sha256 = "368a3995fd494cd44e54b7787da30f6c1ae04840d0e11530137812bffe939e41";
  };
