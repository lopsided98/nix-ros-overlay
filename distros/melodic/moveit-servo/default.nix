...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/moveit-release/archive/release/melodic/moveit_servo/1.0.7-1.tar.gz";
    name = "1.0.7-1.tar.gz";
    sha256 = "22fd82dd07ab6dc9d929e365d215df57a801da51618e1288d9dcdeb0152fcb25";
  };
