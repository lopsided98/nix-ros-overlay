...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/LORD-MicroStrain/microstrain_inertial-release/archive/release/melodic/microstrain_inertial_rqt/3.0.0-2.tar.gz";
    name = "3.0.0-2.tar.gz";
    sha256 = "41dbe10018cfcc8cd902d1d9aa6830dc9c79d571f58b4870955e85ab23d5fc3b";
  };
