...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://bitbucket.org/qbrobotics/qbdevice-ros-release/get/release/melodic/qb_device_driver/3.0.5-2.tar.gz";
    name = "3.0.5-2.tar.gz";
    sha256 = "a46ac74de73d49ed33f2cab3036c3fddcdceb83cfca9e4dfb5efbeb0ed41a099";
  };
