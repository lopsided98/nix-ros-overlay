...
buildRosPackage {
  pname = "ros-melodic-khi-rs013n-moveit-config";
  version = "1.4.0-r2";

  src = fetchurl {
    url = "https://github.com/Kawasaki-Robotics/khi_robot-release/archive/release/melodic/khi_rs013n_moveit_config/1.4.0-2.tar.gz";
    name = "1.4.0-2.tar.gz";
    sha256 = "283e7fab2794dec5215c72afa25b166b95f8dd464e489dae56b6a4da22c938ce";
  };
