...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/clearpath-gbp/husky-release/archive/release/melodic/husky_robot/0.4.4-1.tar.gz";
    name = "0.4.4-1.tar.gz";
    sha256 = "a5b3d49856c33fa12f2d8cf5dcc3c1ffde599daba9ad100dba67a44f4492d135";
  };
