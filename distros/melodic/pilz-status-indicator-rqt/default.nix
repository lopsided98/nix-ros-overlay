...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/PilzDE/pilz_robots-release/archive/release/melodic/pilz_status_indicator_rqt/0.5.17-1.tar.gz";
    name = "0.5.17-1.tar.gz";
    sha256 = "4a2fd6c952d31fdc7f9f04f819a71e1ccb2460c3e9ffe83f92fd32f46fd26801";
  };
