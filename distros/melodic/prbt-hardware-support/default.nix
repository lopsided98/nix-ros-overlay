...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/PilzDE/pilz_robots-release/archive/release/melodic/prbt_hardware_support/0.5.18-1.tar.gz";
    name = "0.5.18-1.tar.gz";
    sha256 = "e364c28cecdd5e376e83972ae02c57e8bfe592baf8169835582ad0e2a543dd5d";
  };
