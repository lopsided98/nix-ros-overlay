...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/at-wat/neonavigation-release/archive/release/melodic/costmap_cspace/0.10.1-1.tar.gz";
    name = "0.10.1-1.tar.gz";
    sha256 = "45fe07883c2d5a7ef35a40bcf7b2a16d953fb295216ff9b75078c6ca15395ff0";
  };
