...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/at-wat/neonavigation-release/archive/release/melodic/costmap_cspace/0.14.0-1.tar.gz";
    name = "0.14.0-1.tar.gz";
    sha256 = "c727728de560f77b3817661c120a5648c84308a1a192a22d96d00da27bd7edd5";
  };
