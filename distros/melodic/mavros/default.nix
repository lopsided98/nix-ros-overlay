...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/mavlink/mavros-release/archive/release/melodic/mavros/1.1.0-1.tar.gz";
    name = "1.1.0-1.tar.gz";
    sha256 = "07d32fcbf6b84e67e048e0744bff5605f54565237734992614fc298fbd68070b";
  };
