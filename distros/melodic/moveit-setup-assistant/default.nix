...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/moveit-release/archive/release/melodic/moveit_setup_assistant/1.0.7-1.tar.gz";
    name = "1.0.7-1.tar.gz";
    sha256 = "c9c53625d0c41191315325a708443b1b230272522b6cf971a8489346cca5fce8";
  };
