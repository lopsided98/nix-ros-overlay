...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/at-wat/neonavigation-release/archive/release/melodic/map_organizer/0.10.0-1.tar.gz";
    name = "0.10.0-1.tar.gz";
    sha256 = "ac2229a61221e4d96bdb5ac64891c5aab6a0bfd6c3d9993b242f0fd325b44358";
  };
