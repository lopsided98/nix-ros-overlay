...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/tork-a/jsk_control-release/archive/release/melodic/jsk_footstep_planner/0.1.16-1.tar.gz";
    name = "0.1.16-1.tar.gz";
    sha256 = "25adf6434c5afc97e8a5a743999333eda0f42e9347200f0a80112b023a710a9d";
  };
