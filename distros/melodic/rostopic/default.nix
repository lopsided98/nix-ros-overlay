...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/melodic/rostopic/1.14.9-1.tar.gz";
    name = "1.14.9-1.tar.gz";
    sha256 = "c57c72d1f94daee8c07dc5234e20dca4f0107a7480ed55ca431b095c34f6aff2";
  };
