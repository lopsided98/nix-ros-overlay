...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/at-wat/neonavigation-release/archive/release/melodic/planner_cspace/0.12.2-1.tar.gz";
    name = "0.12.2-1.tar.gz";
    sha256 = "5110dc30ff7316dd43cf3496b476cb8362f21df428882fb63461cdbfe68e14e4";
  };
