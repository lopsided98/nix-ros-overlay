...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/at-wat/neonavigation-release/archive/release/melodic/planner_cspace/0.10.0-1.tar.gz";
    name = "0.10.0-1.tar.gz";
    sha256 = "ed3e025c1825430383769582ff66c22113cbdbf835a849f56843fa0e666b17f5";
  };
