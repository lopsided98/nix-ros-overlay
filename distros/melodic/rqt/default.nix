...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/rqt-release/archive/release/melodic/rqt/0.5.3-1.tar.gz";
    name = "0.5.3-1.tar.gz";
    sha256 = "cdb608104bcac2220bd050b0fb084d9322ce02b615b567f2c1de46f46c5e7547";
  };
