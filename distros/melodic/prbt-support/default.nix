...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/PilzDE/pilz_robots-release/archive/release/melodic/prbt_support/0.5.19-1.tar.gz";
    name = "0.5.19-1.tar.gz";
    sha256 = "4aecd0d562bf67374eaae345e283f317a821fdb8582e2e3f47a123ec8fea7b41";
  };
