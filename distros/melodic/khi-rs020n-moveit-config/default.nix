...
buildRosPackage {
  pname = "ros-melodic-khi-rs020n-moveit-config";
  version = "1.4.0-r2";

  src = fetchurl {
    url = "https://github.com/Kawasaki-Robotics/khi_robot-release/archive/release/melodic/khi_rs020n_moveit_config/1.4.0-2.tar.gz";
    name = "1.4.0-2.tar.gz";
    sha256 = "385d6cd7f86fca40c1e55fdede0b03fe108ab2fde603311558ba3e5dd45d9d6c";
  };
