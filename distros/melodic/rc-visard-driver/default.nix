...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/roboception-gbp/rc_visard-release/archive/release/melodic/rc_visard_driver/3.0.1-1.tar.gz";
    name = "3.0.1-1.tar.gz";
    sha256 = "1f0c127db716a17192ca678c120854798dd71ac005a7b208d16694bc6d38734c";
  };
