...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ipa320/cob_driver-release/archive/release/melodic/cob_undercarriage_ctrl/0.7.3-1.tar.gz";
    name = "0.7.3-1.tar.gz";
    sha256 = "20a47bec8f779ad3c8751c95a375bde6e01774135b190e3f4559d32c2f77b6a7";
  };
