...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/introlab/rtabmap_ros-release/archive/release/melodic/rtabmap_ros/0.20.23-1.tar.gz";
    name = "0.20.23-1.tar.gz";
    sha256 = "d0f628af1ace11afa775bcb858494fbf98aec245e69a324751e72d4cd0917cf6";
  };
