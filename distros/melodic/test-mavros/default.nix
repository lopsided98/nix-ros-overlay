...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/mavlink/mavros-release/archive/release/melodic/test_mavros/1.1.0-1.tar.gz";
    name = "1.1.0-1.tar.gz";
    sha256 = "51f56e333d4acf784b7ac4d733291709d8254c13bee3834e0f1b0062b4d6fced";
  };
