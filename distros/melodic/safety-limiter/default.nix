...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/at-wat/neonavigation-release/archive/release/melodic/safety_limiter/0.14.0-1.tar.gz";
    name = "0.14.0-1.tar.gz";
    sha256 = "44bc004f69914a5e6e435945435ffd49b1470cf0393d8503b85036f3f7271a9d";
  };
