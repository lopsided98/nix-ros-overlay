...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/at-wat/neonavigation-release/archive/release/melodic/safety_limiter/0.10.0-1.tar.gz";
    name = "0.10.0-1.tar.gz";
    sha256 = "50032aba85abc0a78ccd79722ee4eae35e6f97f51121419ae68c3feaaccfc4df";
  };
