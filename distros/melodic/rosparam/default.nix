...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/ros_comm-release/archive/release/melodic/rosparam/1.14.12-1.tar.gz";
    name = "1.14.12-1.tar.gz";
    sha256 = "ed181c920a4c102a43462fde11f936ae5ef50462d0d98dc57395328909279000";
  };
