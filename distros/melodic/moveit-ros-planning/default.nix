...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/moveit-release/archive/release/melodic/moveit_ros_planning/1.0.11-1.tar.gz";
    name = "1.0.11-1.tar.gz";
    sha256 = "5ebd50c9121fb9f374206223ccd44c532d41144e98a663369ccd514bca7f3564";
  };
