...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros-gbp/moveit-release/archive/release/melodic/moveit_ros_planning/1.0.7-1.tar.gz";
    name = "1.0.7-1.tar.gz";
    sha256 = "b3c300b7a3d7cb1d2cf34b808f72f33895cae3838f7e481b0453a507d0799736";
  };
