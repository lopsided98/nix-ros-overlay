...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/DataspeedInc-release/dbw_mkz_ros-release/archive/release/melodic/dbw_mkz_description/1.6.0-1.tar.gz";
    name = "1.6.0-1.tar.gz";
    sha256 = "b72cc4aebee0cc33b9c9461d0fecf3e12d2711411355e23b46c9a9b58e3de8ef";
  };
