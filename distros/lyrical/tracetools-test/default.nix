...
buildRosPackage {
  pname = "ros-lyrical-tracetools-test";
  version = "8.10.2-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_tracing-release/archive/release/lyrical/tracetools_test/8.10.2-1.tar.gz";
    name = "8.10.2-1.tar.gz";
    sha256 = "caaad34a95377e0a1ae46df89df00a75ae65fd13ecfcdd091c8e22fdf416a0fd";
  };
