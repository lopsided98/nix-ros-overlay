...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt3-release/archive/release/lyrical/mrpt_img/3.0.4-1.tar.gz";
    name = "3.0.4-1.tar.gz";
    sha256 = "98d3ff1e8cbace3f49ba65edbb3f6446feb1ee32c88e07a72313b042f810abd8";
  };
