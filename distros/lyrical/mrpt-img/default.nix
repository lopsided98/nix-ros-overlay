...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt3-release/archive/release/lyrical/mrpt_img/3.1.0-1.tar.gz";
    name = "3.1.0-1.tar.gz";
    sha256 = "5cf4245de2ce2cf5b080450b981cfe406adae436f06dfe71a89b78336b0245f7";
  };
