...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt3-release/archive/release/lyrical/mrpt_img/3.1.2-2.tar.gz";
    name = "3.1.2-2.tar.gz";
    sha256 = "c9c82ada00f021c92f2234960e02fea1ad00debe3e4a20020e3900dc6b322a75";
  };
