...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt3-release/archive/release/lyrical/mrpt_img/3.1.4-1.tar.gz";
    name = "3.1.4-1.tar.gz";
    sha256 = "c501cacb7bf9db3ed7d582b3bbb8cc7585b90ef77c84ff6834be346928087cfe";
  };
