...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/navigation2-release/archive/release/lyrical/nav2_costmap_2d/1.5.2-2.tar.gz";
    name = "1.5.2-2.tar.gz";
    sha256 = "6116089f28bfd325fe91085bb0863c08f0491d7d4fe69e09aa4d6091cd2db9ee";
  };
