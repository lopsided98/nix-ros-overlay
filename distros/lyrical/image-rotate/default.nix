...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/lyrical/image_rotate/7.1.7-1.tar.gz";
    name = "7.1.7-1.tar.gz";
    sha256 = "b47a0dc2f623fb0d3eea716735fa972a82515f5f02b883c2db66a8ea4dfed8aa";
  };
