...
buildRosPackage {
  pname = "ros-lyrical-mbf-abstract-core";
  version = "1.2.1-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/move_base_flex-release/archive/release/lyrical/mbf_abstract_core/1.2.1-1.tar.gz";
    name = "1.2.1-1.tar.gz";
    sha256 = "1db1092b12f24f8d2f0a99089eefa4e7b06a19cdb5fc9224c6d978d3bd93a8a7";
  };
