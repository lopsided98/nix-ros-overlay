...
buildRosPackage {
  pname = "ros-lyrical-mrpt-tps-astar-planner";
  version = "2.4.0-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_navigation-release/archive/release/lyrical/mrpt_tps_astar_planner/2.4.0-3.tar.gz";
    name = "2.4.0-3.tar.gz";
    sha256 = "7d9198b38ef33515ea389953eef98103e75983da1f38f96c8580399a4bb96ed2";
  };
