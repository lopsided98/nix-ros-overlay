...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/lyrical/controller_interface/6.8.0-1.tar.gz";
    name = "6.8.0-1.tar.gz";
    sha256 = "9f44ecc0812277f043c17d52a7cac06a4a1855ccfbab52ba666f00ac6b17c392";
  };
