...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_connextdds-release/archive/release/lyrical/rmw_connextdds/1.2.8-1.tar.gz";
    name = "1.2.8-1.tar.gz";
    sha256 = "7ccba81475fb89bd2f7bfb937646d56512eecf2b380e96a94fa341044390f6fa";
  };
