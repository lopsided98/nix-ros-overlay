...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/lyrical/mrpt_libmaps/2.15.16-1.tar.gz";
    name = "2.15.16-1.tar.gz";
    sha256 = "0dd99df0e9dc4ff585eb49776a04e3ef63d167012c5511d8e1981c4be1df1c28";
  };
