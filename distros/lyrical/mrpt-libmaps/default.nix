...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/lyrical/mrpt_libmaps/2.15.14-3.tar.gz";
    name = "2.15.14-3.tar.gz";
    sha256 = "74b813b724461433791c989ebddced032bfd8f1fd57a5a7e36c1d01bd9b795fd";
  };
