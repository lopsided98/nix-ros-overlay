...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/lyrical/mola_metric_maps/3.3.0-1.tar.gz";
    name = "3.3.0-1.tar.gz";
    sha256 = "d8254c43eecd8e27fc09d3e94150c4929f51fd3b9c7e18626db375e144e7cff0";
  };
