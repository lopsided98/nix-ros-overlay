...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/lyrical/mola_metric_maps/2.7.0-3.tar.gz";
    name = "2.7.0-3.tar.gz";
    sha256 = "0c2432d7d95cdf71620d0ae00a40fcb1355b2232a85e196f4a638b9b99e2f7d5";
  };
