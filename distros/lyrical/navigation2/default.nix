...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/navigation2-release/archive/release/lyrical/navigation2/1.5.2-2.tar.gz";
    name = "1.5.2-2.tar.gz";
    sha256 = "ceee1cdc0ef7120f186af95b6fa02f980781ddab9280eb28fe553f03d3d27908";
  };
