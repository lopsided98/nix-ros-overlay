...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mp2p_icp-release/archive/release/lyrical/mp2p_icp_viz/2.14.1-1.tar.gz";
    name = "2.14.1-1.tar.gz";
    sha256 = "6f7abba5d6a227465ebff3dc04653e4831f2a923c1e5f4958bb21006c312f91d";
  };
