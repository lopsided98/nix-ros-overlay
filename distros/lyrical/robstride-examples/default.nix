...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/robstride_ros2-release/archive/release/lyrical/robstride_examples/0.2.0-1.tar.gz";
    name = "0.2.0-1.tar.gz";
    sha256 = "f9682dbe8e3832c55a0d383cce9555e837e0f276fdaa4394b4c0b76bcabf07a8";
  };
