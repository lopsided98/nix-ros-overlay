...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/navigation2-release/archive/release/lyrical/nav2_ros_common/1.5.1-1.tar.gz";
    name = "1.5.1-1.tar.gz";
    sha256 = "fdaeb11c9822928a9a0f97b5a3c9c99a324235dbf6decdf4b01241bbf543d87d";
  };
