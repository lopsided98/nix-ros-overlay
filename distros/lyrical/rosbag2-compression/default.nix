...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/lyrical/rosbag2_compression/0.33.4-1.tar.gz";
    name = "0.33.4-1.tar.gz";
    sha256 = "61bf384ae2a39daf7a5a8ae3707a3610331f593ba8ac533cdbff50b846b46f99";
  };
