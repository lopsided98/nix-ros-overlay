...
buildRosPackage {
  pname = "ros-lyrical-rplidar-driver";
  version = "1.4.1-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/rplidar_driver-release/archive/release/lyrical/rplidar_driver/1.4.1-1.tar.gz";
    name = "1.4.1-1.tar.gz";
    sha256 = "c75136bbda029e1698b277dcf0133dd4b3ccbfc239bde14fc8b559b334375ade";
  };
