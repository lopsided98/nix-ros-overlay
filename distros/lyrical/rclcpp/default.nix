...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/lyrical/rclcpp/32.0.3-1.tar.gz";
    name = "32.0.3-1.tar.gz";
    sha256 = "b3d1c1ef05c01c5ae8ba057c7c10dc1628c85eebd2216b6e4ed0cce344c1d96f";
  };
