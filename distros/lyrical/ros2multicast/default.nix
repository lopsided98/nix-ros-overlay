...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/lyrical/ros2multicast/0.40.8-1.tar.gz";
    name = "0.40.8-1.tar.gz";
    sha256 = "cc5dfa54093baf7f4c794bfd2fa7ae898004eb29d1a4225672a71272320b90a5";
  };
