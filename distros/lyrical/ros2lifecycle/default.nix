...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/lyrical/ros2lifecycle/0.40.7-1.tar.gz";
    name = "0.40.7-1.tar.gz";
    sha256 = "76afff135b47cc90059ffb4cc701cd2cf5d6f0020fa9a5e718d180784c967cd1";
  };
