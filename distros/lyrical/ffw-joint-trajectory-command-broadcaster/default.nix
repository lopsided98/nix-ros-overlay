...
buildRosPackage {
  pname = "ros-lyrical-ffw-joint-trajectory-command-broadcaster";
  version = "1.1.14-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/lyrical/ffw_joint_trajectory_command_broadcaster/1.1.14-3.tar.gz";
    name = "1.1.14-3.tar.gz";
    sha256 = "f0f591f2a6ed6dbc03e5bad28ae88f5aabf00139220b7a1a4b0ce5b8bd207f7f";
  };
