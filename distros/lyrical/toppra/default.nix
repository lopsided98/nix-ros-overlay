...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/toppra-release/archive/release/lyrical/toppra/0.6.9-1.tar.gz";
    name = "0.6.9-1.tar.gz";
    sha256 = "ff7caef875fc43943dfc737ff4805b6fa39838e5730accf997af57f575b65c88";
  };
