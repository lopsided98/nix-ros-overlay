...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/openeb_vendor-release/archive/release/lyrical/openeb_vendor/2.0.3-1.tar.gz";
    name = "2.0.3-1.tar.gz";
    sha256 = "d77177e92d3ee7af319fae8ad0fbf8243953089c90199ccbd902a6cb1375bb20";
  };
