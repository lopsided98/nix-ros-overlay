...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/lyrical/ros2param/0.40.7-1.tar.gz";
    name = "0.40.7-1.tar.gz";
    sha256 = "ec8444c0437c03f4e2b45a2b248444baea48240588866761a599894ef04354da";
  };
