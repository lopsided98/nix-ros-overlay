...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/lyrical/swri_cli_tools/3.11.0-1.tar.gz";
    name = "3.11.0-1.tar.gz";
    sha256 = "d5b323299d61d40710479136d7539cccd4a8820028f3760256dd8424c3d5ab12";
  };
