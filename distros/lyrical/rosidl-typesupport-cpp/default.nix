...
buildRosPackage {
  pname = "ros-lyrical-rosidl-typesupport-cpp";
  version = "3.4.2-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_typesupport-release/archive/release/lyrical/rosidl_typesupport_cpp/3.4.2-3.tar.gz";
    name = "3.4.2-3.tar.gz";
    sha256 = "bac3a0479cdcaafe8d6f25f90fafee4938531da0410f224b920ecb642b88f23e";
  };
