...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/lyrical/rcl_action/10.4.5-1.tar.gz";
    name = "10.4.5-1.tar.gz";
    sha256 = "344ec2bec1b1a827e254e9916ceecbbbc6816f03840901397c295e06d029553e";
  };
