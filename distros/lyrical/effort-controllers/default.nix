...
buildRosPackage {
  pname = "ros-lyrical-effort-controllers";
  version = "6.6.0-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/lyrical/effort_controllers/6.6.0-3.tar.gz";
    name = "6.6.0-3.tar.gz";
    sha256 = "40ab7c0e2a5df2b8ac88853630865381c41856272163cb0bc7446f1df47f1d66";
  };
