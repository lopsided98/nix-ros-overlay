...
buildRosPackage {
  pname = "ros-lyrical-ecl-lite";
  version = "1.2.0-r6";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_lite-release/archive/release/lyrical/ecl_lite/1.2.0-6.tar.gz";
    name = "1.2.0-6.tar.gz";
    sha256 = "adb2022cb57f2abde014d7a81166ac9e48024be83009338f03d9c33659ad4682";
  };
