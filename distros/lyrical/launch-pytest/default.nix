...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch-release/archive/release/lyrical/launch_pytest/3.9.8-1.tar.gz";
    name = "3.9.8-1.tar.gz";
    sha256 = "f39f4ba85def842a7253d9d0513b754af9a672c5098af85392cc21987d30e817";
  };
