...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mapviz-release/archive/release/lyrical/multires_image/4.0.3-1.tar.gz";
    name = "4.0.3-1.tar.gz";
    sha256 = "0fd0b54379252dd6919113bdcca2f511345531c39e0f541a131efb37f4d1a5ca";
  };
