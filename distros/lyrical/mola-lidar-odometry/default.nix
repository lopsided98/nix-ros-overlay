...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_lidar_odometry-release/archive/release/lyrical/mola_lidar_odometry/3.0.0-1.tar.gz";
    name = "3.0.0-1.tar.gz";
    sha256 = "85a8b2481c9fcbbed9479e9fd1dbbbd730e1f44bffd6c73c399410605ced1639";
  };
