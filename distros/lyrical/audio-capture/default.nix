...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/audio_common-release/archive/release/lyrical/audio_capture/0.4.1-1.tar.gz";
    name = "0.4.1-1.tar.gz";
    sha256 = "72f1ab7d6bed6c316dde4956aea935d56c9f7fd640b38d97de1f7e1f1b07c1b8";
  };
