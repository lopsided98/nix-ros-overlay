...
buildRosPackage {
  pname = "ros-lyrical-webots-ros2-tests";
  version = "2025.0.1-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/lyrical/webots_ros2_tests/2025.0.1-3.tar.gz";
    name = "2025.0.1-3.tar.gz";
    sha256 = "ab7f990d47bfd9f2b387e840feeb44348e5cd3354a8bffe2d2970571a2fcc65f";
  };
