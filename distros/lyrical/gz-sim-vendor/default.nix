...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gz_sim_vendor-release/archive/release/lyrical/gz_sim_vendor/0.4.6-1.tar.gz";
    name = "0.4.6-1.tar.gz";
    sha256 = "2e49a8df8ce1644dc9c849257ed735d0c8e998a266f0826b75744e3ab0f4ce57";
  };
