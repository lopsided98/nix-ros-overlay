...
buildRosPackage {
  pname = "ros-lyrical-rosbag2-tests";
  version = "0.33.3-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/lyrical/rosbag2_tests/0.33.3-1.tar.gz";
    name = "0.33.3-1.tar.gz";
    sha256 = "7264231766f74d16a9ba8dd854ee91afa8c14a5fda5746882e7ea0b971fcb971";
  };
