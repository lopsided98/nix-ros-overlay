...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/libcaer_driver-release/archive/release/lyrical/libcaer_driver/1.5.6-1.tar.gz";
    name = "1.5.6-1.tar.gz";
    sha256 = "617aa69547373af4cef03a0be424e3cdaefc6e34b45d6fef454dea2298561445";
  };
