...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mujoco_ros2_control-release/archive/release/lyrical/mujoco_ros2_control_plugins/0.1.2-1.tar.gz";
    name = "0.1.2-1.tar.gz";
    sha256 = "da576e8d79b3864f3370148f065fc010e16bf2353d80838e56b012c83ef286eb";
  };
