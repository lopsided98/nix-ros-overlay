...
buildRosPackage {
  pname = "ros-lyrical-kinova-gen3-6dof-robotiq-2f-85-moveit-config";
  version = "0.2.5-r4";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_kortex-release/archive/release/lyrical/kinova_gen3_6dof_robotiq_2f_85_moveit_config/0.2.5-4.tar.gz";
    name = "0.2.5-4.tar.gz";
    sha256 = "3b4935a53ec7465326ee9a94cd3f9b71ea0ff9db477ac64a3af062556ba8fe5b";
  };
