...
buildRosPackage {
  pname = "ros-lyrical-polygon-utils";
  version = "1.3.0-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/polygon_ros-release/archive/release/lyrical/polygon_utils/1.3.0-3.tar.gz";
    name = "1.3.0-3.tar.gz";
    sha256 = "fe8ea6195edd5ca27598581a12f306cbd11c52ad158720fc56539f0d95eaed70";
  };
