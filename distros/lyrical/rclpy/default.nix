...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclpy-release/archive/release/lyrical/rclpy/10.0.11-1.tar.gz";
    name = "10.0.11-1.tar.gz";
    sha256 = "6ec421fc14e167a56cc50903a12a00cd39dafbf3084513503447c9bc494da135";
  };
