...
buildRosPackage {
  pname = "ros-lyrical-webots-ros2-driver";
  version = "2025.0.1-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/lyrical/webots_ros2_driver/2025.0.1-3.tar.gz";
    name = "2025.0.1-3.tar.gz";
    sha256 = "5a0f00683d0cfb01af1baa3e409006185aba1dc4a0a48acda8db3f93628418eb";
  };
