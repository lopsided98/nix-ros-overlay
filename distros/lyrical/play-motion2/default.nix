...
buildRosPackage {
  pname = "ros-lyrical-play-motion2";
  version = "1.8.4-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/play_motion2-release/archive/release/lyrical/play_motion2/1.8.4-3.tar.gz";
    name = "1.8.4-3.tar.gz";
    sha256 = "c174982461d47787b8d96e65d519c9f3609ee495f03c964f0bd7b26713334c79";
  };
