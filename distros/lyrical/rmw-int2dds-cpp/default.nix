...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_int2dds-release/archive/release/lyrical/rmw_int2dds_cpp/0.1.4-1.tar.gz";
    name = "0.1.4-1.tar.gz";
    sha256 = "bffd6eb3a121738412881b26945cb0f2096f270da669bf41d9c911d5542d0e38";
  };
