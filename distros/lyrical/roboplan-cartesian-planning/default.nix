...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/roboplan-release/archive/release/lyrical/roboplan_cartesian_planning/0.5.0-1.tar.gz";
    name = "0.5.0-1.tar.gz";
    sha256 = "09296aa075871a1b08dee8ddc516c78cce01e943e7d103f5b4a860acfb41f983";
  };
