...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/cras_ros_utils-release/archive/release/lyrical/cras_cpp_common/3.0.2-3.tar.gz";
    name = "3.0.2-3.tar.gz";
    sha256 = "d2970fd315dcae130b570552ce2f763f4a42adab77e289f90c94952a5c5f3146";
  };
