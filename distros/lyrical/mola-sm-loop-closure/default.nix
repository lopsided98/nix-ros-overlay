...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_sm_loop_closure-release/archive/release/lyrical/mola_sm_loop_closure/1.2.2-1.tar.gz";
    name = "1.2.2-1.tar.gz";
    sha256 = "a800a078e143b548f8298df29800b7ac0a6e28294683706b5d343a8e92a5e98e";
  };
