...
buildRosPackage {
  pname = "ros-lyrical-kobuki-velocity-smoother";
  version = "0.15.1-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/kobuki_velocity_smoother-release/archive/release/lyrical/kobuki_velocity_smoother/0.15.1-3.tar.gz";
    name = "0.15.1-3.tar.gz";
    sha256 = "604ff711a2b420e56a2dcdcca165438f0a20cb73a92aaf4b3d5416e2ee98590b";
  };
