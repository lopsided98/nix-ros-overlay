...
buildRosPackage {
  pname = "ros-lyrical-plansys2-executor";
  version = "3.1.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_planning_system-release/archive/release/lyrical/plansys2_executor/3.1.0-1.tar.gz";
    name = "3.1.0-1.tar.gz";
    sha256 = "4dd6d884e3d2f54a92223fd0fe01eec5f5edefbbed0d2d7663bd297fcb067c3b";
  };
