...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/lyrical/mrpt_libnav/2.15.14-3.tar.gz";
    name = "2.15.14-3.tar.gz";
    sha256 = "b337e988b5b32c107a5755529d56296fcfda9d53090d32f43fe8ec6418fcfd23";
  };
