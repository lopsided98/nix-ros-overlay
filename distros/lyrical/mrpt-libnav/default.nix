...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/lyrical/mrpt_libnav/2.15.16-1.tar.gz";
    name = "2.15.16-1.tar.gz";
    sha256 = "f7bffba593c37b0698f60b0f07206ab6fed439314d7708185aa474c57033227d";
  };
