...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mavros-release/archive/release/lyrical/mavros_extras/2.15.1-1.tar.gz";
    name = "2.15.1-1.tar.gz";
    sha256 = "266cbf9ed4731d95c766843f9db6d6ef53ff3bc759b6219487a84652e4a20dc7";
  };
