...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mavros-release/archive/release/lyrical/mavros_extras/2.15.0-1.tar.gz";
    name = "2.15.0-1.tar.gz";
    sha256 = "cc682141b08a0b48fdb9f414616d7a6f885a5e6bb021b86d503f6633a9ee27ba";
  };
