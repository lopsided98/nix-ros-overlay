...
buildRosPackage {
  pname = "ros-lyrical-autoware-utils-tf";
  version = "1.4.2-r4";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/lyrical/autoware_utils_tf/1.4.2-4.tar.gz";
    name = "1.4.2-4.tar.gz";
    sha256 = "3616319f4fbe709997e7fbb952af47890cc715e1f3011c80a917aa6f332a378c";
  };
