...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/septentrio_gnss_driver_ros2-release/archive/release/lyrical/septentrio_gnss_driver/1.4.8-2.tar.gz";
    name = "1.4.8-2.tar.gz";
    sha256 = "2f66bb7de1d11a670de51eca4c29b46a39437c1e31328c5fcdebdf85e36fde09";
  };
