...
buildRosPackage {
  pname = "ros-lyrical-ffw-robot-manager";
  version = "1.1.14-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/lyrical/ffw_robot_manager/1.1.14-3.tar.gz";
    name = "1.1.14-3.tar.gz";
    sha256 = "58565a739e17031de9c35202f34453d03fd839d5733d2716d00d242d28a480de";
  };
