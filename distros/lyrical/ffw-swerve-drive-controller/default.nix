...
buildRosPackage {
  pname = "ros-lyrical-ffw-swerve-drive-controller";
  version = "1.1.14-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ai_worker-release/archive/release/lyrical/ffw_swerve_drive_controller/1.1.14-3.tar.gz";
    name = "1.1.14-3.tar.gz";
    sha256 = "7fc620a1d3abf663b86caa678d4ad3c72cf562c424ad56c1059dfa22a08d67b5";
  };
