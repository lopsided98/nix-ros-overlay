...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mujoco_ros2_control-release/archive/release/lyrical/mujoco_ros2_control/0.1.1-1.tar.gz";
    name = "0.1.1-1.tar.gz";
    sha256 = "db1ae659b8ed5fa4d2d7fd3305ff9a19c592ed453a122ec1dd078c9f08c7c5f6";
  };
