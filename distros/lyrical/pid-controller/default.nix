...
buildRosPackage {
  pname = "ros-lyrical-pid-controller";
  version = "6.6.0-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/lyrical/pid_controller/6.6.0-3.tar.gz";
    name = "6.6.0-3.tar.gz";
    sha256 = "3bfa334fe328b312acdabfcdd42b10bc5911e758f8b0e465a66dc6ff3d6e389f";
  };
