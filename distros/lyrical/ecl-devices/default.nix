...
buildRosPackage {
  pname = "ros-lyrical-ecl-devices";
  version = "1.2.1-r6";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/lyrical/ecl_devices/1.2.1-6.tar.gz";
    name = "1.2.1-6.tar.gz";
    sha256 = "f42dc24c019ff8028be9111d73fc4229f85711518b14827b412583f8f54b56e9";
  };
