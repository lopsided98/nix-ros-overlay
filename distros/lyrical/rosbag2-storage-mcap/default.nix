...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/lyrical/rosbag2_storage_mcap/0.33.4-1.tar.gz";
    name = "0.33.4-1.tar.gz";
    sha256 = "d27a07649165de88e403c0c2e42ac2757c126cb5eafbeabcf0af0150799b585b";
  };
