...
buildRosPackage {
  pname = "ros-lyrical-gscam";
  version = "2.0.4-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/gscam-release/archive/release/lyrical/gscam/2.0.4-3.tar.gz";
    name = "2.0.4-3.tar.gz";
    sha256 = "6f69087c9b7010f78cefdd36cbb94f0a4716c4087990642cc6c393fc528f6d09";
  };
