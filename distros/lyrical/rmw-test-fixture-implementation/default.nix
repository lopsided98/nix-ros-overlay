...
buildRosPackage {
  pname = "ros-lyrical-rmw-test-fixture-implementation";
  version = "0.15.8-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake_ros-release/archive/release/lyrical/rmw_test_fixture_implementation/0.15.8-1.tar.gz";
    name = "0.15.8-1.tar.gz";
    sha256 = "cc320dd52385ae905a5f2040649c898616d4eadb608bfc8074acdaba864fc53d";
  };
