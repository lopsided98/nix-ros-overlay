...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/navigation2-release/archive/release/lyrical/nav2_loopback_sim/1.5.1-1.tar.gz";
    name = "1.5.1-1.tar.gz";
    sha256 = "c9b224dc82212a6cd5aa6816c5a60fdca433e39e2f7fe1911f5485be46adc15e";
  };
