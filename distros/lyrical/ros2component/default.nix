...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/lyrical/ros2component/0.40.9-1.tar.gz";
    name = "0.40.9-1.tar.gz";
    sha256 = "663e13734c73e5a21f7e3cf3a2df444753275f0f58d3cce9e8e12f85a4d85dca";
  };
