...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_babel_fish-release/archive/release/lyrical/ros_babel_fish_test_msgs/4.26.90-1.tar.gz";
    name = "4.26.90-1.tar.gz";
    sha256 = "5825cfcda7a94f135c51427f0ea1986db32ca4f22eb1ce8edafebb8bf989b0c0";
  };
