...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gz_math_vendor-release/archive/release/lyrical/gz_math_vendor/0.4.3-3.tar.gz";
    name = "0.4.3-3.tar.gz";
    sha256 = "eda278801cb949e0898eaea67459e3fdb589595ff9f8e600d6f3941249ba2df8";
  };
