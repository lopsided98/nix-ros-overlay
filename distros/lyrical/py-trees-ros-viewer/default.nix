...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/py_trees_ros_viewer-release/archive/release/lyrical/py_trees_ros_viewer/0.2.5-4.tar.gz";
    name = "0.2.5-4.tar.gz";
    sha256 = "edc8ceb70f0639398f1a3dd88f1bfebb7eb325bc85b0fa11b836abc96c3c12c9";
  };
