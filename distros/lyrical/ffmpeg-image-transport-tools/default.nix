...
buildRosPackage {
  pname = "ros-lyrical-ffmpeg-image-transport-tools";
  version = "3.0.1-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ffmpeg_image_transport_tools-release/archive/release/lyrical/ffmpeg_image_transport_tools/3.0.1-3.tar.gz";
    name = "3.0.1-3.tar.gz";
    sha256 = "b279019a955d2a3f39692464846372a64d6d3ee419495c3413110c698b47cdfb";
  };
