...
buildRosPackage {
  pname = "ros-lyrical-xacro";
  version = "2.1.1-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/xacro-release/archive/release/lyrical/xacro/2.1.1-3.tar.gz";
    name = "2.1.1-3.tar.gz";
    sha256 = "3001f981226bd0a1bf7f43511575be0ac5c73b9e6b818cdf9a2563e851b1ee5b";
  };
