...
buildRosPackage {
  pname = "ros-lyrical-kinova-gen3-7dof-robotiq-2f-85-moveit-config";
  version = "0.2.5-r4";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_kortex-release/archive/release/lyrical/kinova_gen3_7dof_robotiq_2f_85_moveit_config/0.2.5-4.tar.gz";
    name = "0.2.5-4.tar.gz";
    sha256 = "88e5760040bcb68829691c22798d743ec6bb979f59d270dea4f056890d047b0c";
  };
