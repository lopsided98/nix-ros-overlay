...
buildRosPackage {
  pname = "ros-lyrical-ecl-time";
  version = "1.2.1-r6";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/lyrical/ecl_time/1.2.1-6.tar.gz";
    name = "1.2.1-6.tar.gz";
    sha256 = "a289298437677ac528f305209c95edd237161dfdb99ba5f0ac3815b9c2a867c5";
  };
