...
buildRosPackage {
  pname = "ros-lyrical-open-manipulator-moveit-config";
  version = "4.1.2-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/open_manipulator-release/archive/release/lyrical/open_manipulator_moveit_config/4.1.2-3.tar.gz";
    name = "4.1.2-3.tar.gz";
    sha256 = "f37ba499d730f24c1e9e541334fd6341c407cb39f902a63cdaf16062e7c1735c";
  };
