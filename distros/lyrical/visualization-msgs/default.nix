...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/common_interfaces-release/archive/release/lyrical/visualization_msgs/5.9.3-1.tar.gz";
    name = "5.9.3-1.tar.gz";
    sha256 = "5399f1ce4a6e710495e9ccd26b40a2a920cf995795193bcca0d8a51df613b1ce";
  };
