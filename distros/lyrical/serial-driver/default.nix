...
buildRosPackage {
  pname = "ros-lyrical-serial-driver";
  version = "1.2.0-r5";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/transport_drivers-release/archive/release/lyrical/serial_driver/1.2.0-5.tar.gz";
    name = "1.2.0-5.tar.gz";
    sha256 = "b57ddb78af8f68e59925d1c7975c0e68ff60b1ae53780a956f4282899a08a49c";
  };
