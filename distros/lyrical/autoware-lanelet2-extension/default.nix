...
buildRosPackage {
  pname = "ros-lyrical-autoware-lanelet2-extension";
  version = "0.7.2-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_lanelet2_extension-release/archive/release/lyrical/autoware_lanelet2_extension/0.7.2-3.tar.gz";
    name = "0.7.2-3.tar.gz";
    sha256 = "db5c3a237850daa8ab3ae745e38aaa449bfb7dc4340caefd27c98ad572c1cf28";
  };
