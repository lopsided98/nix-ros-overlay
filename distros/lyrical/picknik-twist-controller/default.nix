...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/picknik_controllers-release/archive/release/lyrical/picknik_twist_controller/0.0.4-4.tar.gz";
    name = "0.0.4-4.tar.gz";
    sha256 = "8f171784a0c178f05c914d15459e4ad99731ccfbb210796ef14f204edf511f9c";
  };
