...
buildRosPackage {
  pname = "ros-lyrical-ecl-converters";
  version = "1.2.1-r6";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/lyrical/ecl_converters/1.2.1-6.tar.gz";
    name = "1.2.1-6.tar.gz";
    sha256 = "4e05eb254463029d66942fa6980511473ba9f4de7406eeded7842cb505c97d02";
  };
