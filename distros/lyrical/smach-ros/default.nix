...
buildRosPackage {
  pname = "ros-lyrical-smach-ros";
  version = "3.0.3-r4";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/executive_smach-release/archive/release/lyrical/smach_ros/3.0.3-4.tar.gz";
    name = "3.0.3-4.tar.gz";
    sha256 = "2d1740e996893961df388f3a472b82ead5559523263c7378efc0186dec33d19a";
  };
