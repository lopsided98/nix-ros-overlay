...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/lyrical/tricycle_steering_controller/6.7.0-1.tar.gz";
    name = "6.7.0-1.tar.gz";
    sha256 = "b5c81858a5f21a509e26389404eeb7c8b2c6cc55ec6bcbe74a96b6b47dbaf2e8";
  };
