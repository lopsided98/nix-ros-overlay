...
buildRosPackage {
  pname = "ros-lyrical-laser-geometry";
  version = "2.11.3-r6";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/laser_geometry-release/archive/release/lyrical/laser_geometry/2.11.3-6.tar.gz";
    name = "2.11.3-6.tar.gz";
    sha256 = "8d2a55a3b8297b3538b6897d9fe2fde341e420754e3d1cea21d5400afff650fb";
  };
