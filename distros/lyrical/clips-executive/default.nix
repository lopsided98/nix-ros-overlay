...
buildRosPackage {
  pname = "ros-lyrical-clips-executive";
  version = "0.1.3-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/clips_executive-release/archive/release/lyrical/clips_executive/0.1.3-3.tar.gz";
    name = "0.1.3-3.tar.gz";
    sha256 = "acefb34e2e69ed613922564c40679e2e7880987f6081b5f6e44e50e7544ddc06";
  };
