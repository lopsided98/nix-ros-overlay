...
buildRosPackage {
  pname = "ros-lyrical-laser-filters";
  version = "2.3.2-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/laser_filters-release/archive/release/lyrical/laser_filters/2.3.2-3.tar.gz";
    name = "2.3.2-3.tar.gz";
    sha256 = "328273c6bff6bdd3aa317a09e56f7cc4f8635721fbb482b15f4909e2f878c54d";
  };
