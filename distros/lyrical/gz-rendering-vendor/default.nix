...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gz_rendering_vendor-release/archive/release/lyrical/gz_rendering_vendor/0.4.3-3.tar.gz";
    name = "0.4.3-3.tar.gz";
    sha256 = "26e11f7ecc7f87bbcb0d6f97aeaf92bb6c0c68261a0f4c3dccd915b92adde82a";
  };
