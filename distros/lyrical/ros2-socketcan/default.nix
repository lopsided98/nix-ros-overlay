...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_socketcan-release/archive/release/lyrical/ros2_socketcan/1.4.0-1.tar.gz";
    name = "1.4.0-1.tar.gz";
    sha256 = "473f529ac94bada4aea8bb253c3ee2ef8d6ccf9526d265a40161692328fd53d0";
  };
