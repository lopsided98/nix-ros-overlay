...
buildRosPackage {
  pname = "ros-lyrical-ros2topic";
  version = "0.40.7-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/lyrical/ros2topic/0.40.7-1.tar.gz";
    name = "0.40.7-1.tar.gz";
    sha256 = "3656ac8f548dc7ff2947c4510956120510235388a26abed23ee5aa600b06a9aa";
  };
