...
buildRosPackage {
  pname = "ros-lyrical-off-highway-general-purpose-radar";
  version = "1.3.0-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/off_highway_sensor_drivers-release/archive/release/lyrical/off_highway_general_purpose_radar/1.3.0-3.tar.gz";
    name = "1.3.0-3.tar.gz";
    sha256 = "108322299472d5403d091638202c85423ab41a4e61466da9e4b6dc340b56498b";
  };
