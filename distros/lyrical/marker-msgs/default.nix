...
buildRosPackage {
  pname = "ros-lyrical-marker-msgs";
  version = "0.0.8-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/marker_msgs-release/archive/release/lyrical/marker_msgs/0.0.8-3.tar.gz";
    name = "0.0.8-3.tar.gz";
    sha256 = "0522a0f153029f1b10039023a7996f6baa8ac7ba55f768d081fd26775647654b";
  };
