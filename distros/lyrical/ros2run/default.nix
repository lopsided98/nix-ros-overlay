...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/lyrical/ros2run/0.40.9-1.tar.gz";
    name = "0.40.9-1.tar.gz";
    sha256 = "c252b96f723768f1510676f963405aab34355498e08d3463883c691b4124f763";
  };
