...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/lyrical/ros2interface/0.40.8-1.tar.gz";
    name = "0.40.8-1.tar.gz";
    sha256 = "444c1c64fded1bac5e1154f2a1fb23aee2a6abdefca592524e92dd78724faf45";
  };
