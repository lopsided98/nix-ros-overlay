...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/lyrical/ros2interface/0.40.9-1.tar.gz";
    name = "0.40.9-1.tar.gz";
    sha256 = "97afb1e172611e01ceededc982040e6c0810a212a657b5458f6067354997c46a";
  };
