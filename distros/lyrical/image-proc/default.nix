...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/lyrical/image_proc/7.1.6-1.tar.gz";
    name = "7.1.6-1.tar.gz";
    sha256 = "40b90faa7340f0ac8b8b09fe393e04688ab6d03b125f00957ecc74104d8806b7";
  };
