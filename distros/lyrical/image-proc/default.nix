...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/lyrical/image_proc/7.1.7-1.tar.gz";
    name = "7.1.7-1.tar.gz";
    sha256 = "d27bec88fd311d256bf617e9bfa3ddda32fb72f30fa18ac6d3db6a53b301b444";
  };
