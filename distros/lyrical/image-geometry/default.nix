...
buildRosPackage {
  pname = "ros-lyrical-image-geometry";
  version = "4.1.0-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/vision_opencv-release/archive/release/lyrical/image_geometry/4.1.0-3.tar.gz";
    name = "4.1.0-3.tar.gz";
    sha256 = "01832e35438504c96f4bfc457b071d8bf04dfb06a754ec8b248192e39feff993";
  };
