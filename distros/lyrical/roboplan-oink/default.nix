...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/roboplan-release/archive/release/lyrical/roboplan_oink/0.7.0-1.tar.gz";
    name = "0.7.0-1.tar.gz";
    sha256 = "50abc10643e9853e17a4dbd8a861483035b03a81d31fd60b88537b291152c8a0";
  };
