...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz-release/archive/release/lyrical/rviz_common/15.2.4-1.tar.gz";
    name = "15.2.4-1.tar.gz";
    sha256 = "1009e2d6d4970df63b5431cb9c54908e650dc4c7eed00750f87adc735a5f35cb";
  };
