...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_pipeline-release/archive/release/lyrical/image_publisher/7.1.7-1.tar.gz";
    name = "7.1.7-1.tar.gz";
    sha256 = "e5b36d73a9dcd4cc095ca32271bb94bbbe8de5f1384b3d8585e1121b8b95a784";
  };
