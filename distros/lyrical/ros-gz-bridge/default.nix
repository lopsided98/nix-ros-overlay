...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/lyrical/ros_gz_bridge/3.0.10-1.tar.gz";
    name = "3.0.10-1.tar.gz";
    sha256 = "5cb10030d80913871032e54469aa7f839546b29abec0a3393534ba48342712fb";
  };
