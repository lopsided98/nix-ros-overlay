...
buildRosPackage {
  pname = "ros-lyrical-class-loader";
  version = "2.9.4-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/class_loader-release/archive/release/lyrical/class_loader/2.9.4-3.tar.gz";
    name = "2.9.4-3.tar.gz";
    sha256 = "d4a374e45f31ef520fd308385e103e6a499ceeafc058ae865fc57099f444333b";
  };
