...
buildRosPackage {
  pname = "ros-lyrical-ecl-ipc";
  version = "1.2.1-r6";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/lyrical/ecl_ipc/1.2.1-6.tar.gz";
    name = "1.2.1-6.tar.gz";
    sha256 = "2808414df0a5027c87f11519a1bca237475e0bdff3337a60377167139013c0cb";
  };
