...
buildRosPackage {
  pname = "ros-lyrical-velocity-controllers";
  version = "6.6.0-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/lyrical/velocity_controllers/6.6.0-3.tar.gz";
    name = "6.6.0-3.tar.gz";
    sha256 = "ccfe69a464034c3c29cc2e5b744654423be21bdf5fa317716b8e0e3bc68cd886";
  };
