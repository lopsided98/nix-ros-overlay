...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt3-release/archive/release/lyrical/mrpt_random/3.1.2-2.tar.gz";
    name = "3.1.2-2.tar.gz";
    sha256 = "feddd0a81004bbffcb49cd059b6702bfbf37f3e50ad1cc0bb4edf0afbed7fa37";
  };
