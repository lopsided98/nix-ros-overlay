...
buildRosPackage {
  pname = "ros-lyrical-ros2acceleration";
  version = "0.5.1-r5";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2acceleration-release/archive/release/lyrical/ros2acceleration/0.5.1-5.tar.gz";
    name = "0.5.1-5.tar.gz";
    sha256 = "1a1908830248eaba5d5b61e6e0b61d71fffa36566825cfbf9e6971a21e25316a";
  };
