...
buildRosPackage {
  pname = "ros-lyrical-performance-test";
  version = "2.3.0-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/performance_test-release/archive/release/lyrical/performance_test/2.3.0-3.tar.gz";
    name = "2.3.0-3.tar.gz";
    sha256 = "e3cb19727cb4b5ce97bce706179e83e7e77ad796c8b51b64663cf4867ae064a8";
  };
