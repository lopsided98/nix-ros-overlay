...
buildRosPackage {
  pname = "ros-lyrical-ecl-geometry";
  version = "1.2.1-r6";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/lyrical/ecl_geometry/1.2.1-6.tar.gz";
    name = "1.2.1-6.tar.gz";
    sha256 = "f52ee9858d372a12e3e267dff4cee081dfc3397b827fbd5799d504cb90013b07";
  };
