...
buildRosPackage {
  pname = "ros-lyrical-examples-rclpy-minimal-action-client";
  version = "0.21.5-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/examples-release/archive/release/lyrical/examples_rclpy_minimal_action_client/0.21.5-3.tar.gz";
    name = "0.21.5-3.tar.gz";
    sha256 = "aee9d233da36167267d7e58598bb95096070e52832e15eb4bdc02cd8d25627d8";
  };
