...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/lyrical/ros2node/0.40.9-1.tar.gz";
    name = "0.40.9-1.tar.gz";
    sha256 = "06b27361edf0a2c45fa27ef11491dfe347a2aee4e811e0de3da694c292822655";
  };
