...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/foxglove_bridge-release/archive/release/lyrical/foxglove_msgs/3.4.3-1.tar.gz";
    name = "3.4.3-1.tar.gz";
    sha256 = "0cb9d120854580645965f156bfc1f7dfb5a2459a77ee5fcd8fe53480be3192a1";
  };
