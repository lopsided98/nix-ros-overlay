...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/lazytatzv/libbno055_linux-release/archive/release/lyrical/libbno055_linux/1.7.2-1.tar.gz";
    name = "1.7.2-1.tar.gz";
    sha256 = "a32f7fb1c3db1800c240d1392e224657b517f933199ecee4999b4be296731b7d";
  };
