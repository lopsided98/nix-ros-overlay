...
buildRosPackage {
  pname = "ros-lyrical-mecanum-drive-controller";
  version = "6.6.0-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/lyrical/mecanum_drive_controller/6.6.0-3.tar.gz";
    name = "6.6.0-3.tar.gz";
    sha256 = "f23252d7de93367ca7c5e7d911a5d18825a90e0ffc31cc7e59daca456c0083ec";
  };
