...
buildRosPackage {
  pname = "ros-lyrical-webots-ros2-epuck";
  version = "2025.0.1-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/lyrical/webots_ros2_epuck/2025.0.1-3.tar.gz";
    name = "2025.0.1-3.tar.gz";
    sha256 = "e861c22473e85bcf4270112ce485ec8cc2e0df07a5a37bfbfa85e4fbb11b934f";
  };
