...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/gz_sensors_vendor-release/archive/release/lyrical/gz_sensors_vendor/0.3.3-1.tar.gz";
    name = "0.3.3-1.tar.gz";
    sha256 = "d47c611cfb227d9409b24b909f6209596bf7e8586a1dfe53da06073fcbfe4874";
  };
