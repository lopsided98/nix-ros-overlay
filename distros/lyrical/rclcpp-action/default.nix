...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclcpp-release/archive/release/lyrical/rclcpp_action/32.0.2-1.tar.gz";
    name = "32.0.2-1.tar.gz";
    sha256 = "c337e0519d8ad26f93d32fa78526cb147b35e804d43602e19772c461182ff27f";
  };
