...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/lyrical/image_transport_plugins/6.2.6-1.tar.gz";
    name = "6.2.6-1.tar.gz";
    sha256 = "377bc0f0a57aba2247a514a606bfcc58c0888178781d6a85e7ec3c520f1247f3";
  };
