...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/launch_ros-release/archive/release/lyrical/launch_testing_ros/0.29.9-1.tar.gz";
    name = "0.29.9-1.tar.gz";
    sha256 = "9e9b8bf85980f739ea2acfd06574f4eb9301ddbe45a724eb328396d34b7d883e";
  };
