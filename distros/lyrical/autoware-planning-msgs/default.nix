...
buildRosPackage {
  pname = "ros-lyrical-autoware-planning-msgs";
  version = "1.11.0-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_msgs-release/archive/release/lyrical/autoware_planning_msgs/1.11.0-3.tar.gz";
    name = "1.11.0-3.tar.gz";
    sha256 = "93aa8db06643ed253c907adc4c613225035f87e973ec57ac73bec6fca369cfb5";
  };
