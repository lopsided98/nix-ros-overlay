...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ur_msgs-release/archive/release/lyrical/ur_msgs/2.6.0-1.tar.gz";
    name = "2.6.0-1.tar.gz";
    sha256 = "c73dbcde5d0cfc3ae14d0eb5cae5efe0c243fdea906e4ead9e5ec2a911f0cfb1";
  };
