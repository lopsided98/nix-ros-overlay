...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/marti_common-release/archive/release/lyrical/swri_transform_util/3.11.0-1.tar.gz";
    name = "3.11.0-1.tar.gz";
    sha256 = "f0af75d0aafb6ce1179196e712370e491e8a23d919ccfe9477e7fa9da74fb630";
  };
