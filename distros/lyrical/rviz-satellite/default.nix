...
buildRosPackage {
  pname = "ros-lyrical-rviz-satellite";
  version = "4.3.1-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz_satellite-release/archive/release/lyrical/rviz_satellite/4.3.1-1.tar.gz";
    name = "4.3.1-1.tar.gz";
    sha256 = "c17fe1091b3150bd5247680d0d00751ba7c6f96186bfe611e5411a833cecd31b";
  };
