...
buildRosPackage {
  pname = "ros-lyrical-rosbag2-to-video";
  version = "1.0.1-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2_to_video-release/archive/release/lyrical/rosbag2_to_video/1.0.1-3.tar.gz";
    name = "1.0.1-3.tar.gz";
    sha256 = "4ffc9214abfc0ce3d28e3aa32807ca7a7c93536f0ee9d8b8138371c9a9c97838";
  };
