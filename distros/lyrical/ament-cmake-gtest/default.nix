...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/lyrical/ament_cmake_gtest/2.8.8-1.tar.gz";
    name = "2.8.8-1.tar.gz";
    sha256 = "aafb7febb2f079f10d6ea5170c0edfd1aa7fb8281006f50c8e108cc2ca7ee8cc";
  };
