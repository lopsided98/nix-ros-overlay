...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/lyrical/mrpt_libopengl/2.15.20-1.tar.gz";
    name = "2.15.20-1.tar.gz";
    sha256 = "869e538c743a90d8b6b150f758b565ee63af200b0a1843f031de3c1d88a3cb2e";
  };
