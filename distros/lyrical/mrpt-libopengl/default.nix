...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/lyrical/mrpt_libopengl/2.15.16-1.tar.gz";
    name = "2.15.16-1.tar.gz";
    sha256 = "540e1b7b21b633c674abf04e127279a4d5cdcd8078b61d29b112fdeaefb6bcf2";
  };
