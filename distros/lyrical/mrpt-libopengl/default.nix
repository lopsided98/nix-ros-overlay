...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/lyrical/mrpt_libopengl/2.15.19-1.tar.gz";
    name = "2.15.19-1.tar.gz";
    sha256 = "03c5a48cf4090a9144f0bc655dec5a6139b380a2c4563d4b4a1a18393483980d";
  };
