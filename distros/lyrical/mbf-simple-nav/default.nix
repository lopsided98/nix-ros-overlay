...
buildRosPackage {
  pname = "ros-lyrical-mbf-simple-nav";
  version = "1.2.1-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/move_base_flex-release/archive/release/lyrical/mbf_simple_nav/1.2.1-1.tar.gz";
    name = "1.2.1-1.tar.gz";
    sha256 = "13077ddd4c87a7046c48f2eddf96c0ed92137774542b6c21143b115223eb86c8";
  };
