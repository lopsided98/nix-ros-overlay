...
buildRosPackage {
  pname = "ros-lyrical-event-camera-py";
  version = "3.0.0-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/event_camera_py-release/archive/release/lyrical/event_camera_py/3.0.0-3.tar.gz";
    name = "3.0.0-3.tar.gz";
    sha256 = "060a219bfe9e4102c3c274e2b7af0c81c83f8ed5931b6370e2992a06ba1e2b26";
  };
