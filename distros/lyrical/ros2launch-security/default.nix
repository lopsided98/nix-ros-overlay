...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2launch_security-release/archive/release/lyrical/ros2launch_security/1.0.2-1.tar.gz";
    name = "1.0.2-1.tar.gz";
    sha256 = "3b6f9262d9daf6bedbd42739759d6d3eb344d300fe4673e9c542dfbc9cb4a0f9";
  };
