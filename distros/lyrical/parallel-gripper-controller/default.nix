...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/lyrical/parallel_gripper_controller/6.9.0-1.tar.gz";
    name = "6.9.0-1.tar.gz";
    sha256 = "ad73bb3f825c0f89fafbb0893f60ede8afa807a573c1fee5f0f61918107de097";
  };
