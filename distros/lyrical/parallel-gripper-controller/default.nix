...
buildRosPackage {
  pname = "ros-lyrical-parallel-gripper-controller";
  version = "6.7.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/lyrical/parallel_gripper_controller/6.7.0-1.tar.gz";
    name = "6.7.0-1.tar.gz";
    sha256 = "6c4b9f6ba6ceb4a86143813bbfc56d69f54a9958392d8fc7b81a50517201d8b6";
  };
