...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/lyrical/parallel_gripper_controller/6.6.0-3.tar.gz";
    name = "6.6.0-3.tar.gz";
    sha256 = "667da27bcf36a26dcbbcedd5a36e1dd3298f8d9239b51b4b7ac734df5ebd72bb";
  };
