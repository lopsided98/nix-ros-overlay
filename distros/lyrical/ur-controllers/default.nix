...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/Universal_Robots_ROS2_Driver-release/archive/release/lyrical/ur_controllers/6.1.0-1.tar.gz";
    name = "6.1.0-1.tar.gz";
    sha256 = "990c5fbceb9cf992c3a2b0e0b301832c01ab2fbaa7b97c3ac33383aac13b002d";
  };
