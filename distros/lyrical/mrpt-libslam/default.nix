...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/lyrical/mrpt_libslam/2.15.14-3.tar.gz";
    name = "2.15.14-3.tar.gz";
    sha256 = "45e0c88dd735bef3d6c5b3181322db724ea554a73423baf68d03fa262a7ccb77";
  };
