...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mrpt_ros-release/archive/release/lyrical/mrpt_libslam/2.15.16-1.tar.gz";
    name = "2.15.16-1.tar.gz";
    sha256 = "614a54900a697c0ffed933fc54d933f408bd0fa0b5486110176ac5a45904f5b4";
  };
