...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rmw_connextdds-release/archive/release/lyrical/rmw_connextdds_common/1.2.8-1.tar.gz";
    name = "1.2.8-1.tar.gz";
    sha256 = "68d461c23c416de7e7136728f749bd8108940e263c2c1721d38d5238a0d73aa9";
  };
