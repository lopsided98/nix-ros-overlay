...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola_test_datasets-release/archive/release/lyrical/mola_test_datasets/0.5.0-1.tar.gz";
    name = "0.5.0-1.tar.gz";
    sha256 = "7ba46e1103498ad1e680694e6f8b65cb8691ff130c4724f2df5fe8a43195928c";
  };
  ...
  meta = {
    ...
    license = with lib.licenses; [ bsd3 bsd3 cc-by-nc-sa-30 cc-by-30 cc-by-30 cc-by-nc-sa-40 ];
  };
}
