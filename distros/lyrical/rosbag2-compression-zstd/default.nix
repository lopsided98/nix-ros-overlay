...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/lyrical/rosbag2_compression_zstd/0.33.2-1.tar.gz";
    name = "0.33.2-1.tar.gz";
    sha256 = "337a9f1431ae1625ce0bcacdee27c34b9850732cbfd51afa44563a384960d90f";
  };
