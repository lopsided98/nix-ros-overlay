...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/lyrical/ros2doctor/0.40.9-1.tar.gz";
    name = "0.40.9-1.tar.gz";
    sha256 = "f7865f1fc57a09974bab30715ebd3a4f93e760876868171c8557988be466b77a";
  };
