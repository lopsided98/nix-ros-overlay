...
buildRosPackage {
  pname = "ros-lyrical-tuw-graph-msgs";
  version = "0.2.6-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/tuw_msgs-release/archive/release/lyrical/tuw_graph_msgs/0.2.6-3.tar.gz";
    name = "0.2.6-3.tar.gz";
    sha256 = "c569135662dd695a6066c909e08057ded4bf131489c7048a4e59cd1dffb4bd3a";
  };
