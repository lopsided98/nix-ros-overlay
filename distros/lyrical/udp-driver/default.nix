...
buildRosPackage {
  pname = "ros-lyrical-udp-driver";
  version = "1.2.0-r5";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/transport_drivers-release/archive/release/lyrical/udp_driver/1.2.0-5.tar.gz";
    name = "1.2.0-5.tar.gz";
    sha256 = "33fad86e8892941436c5258899e9eecc088229b24e6639764a736f3e174edaa0";
  };
