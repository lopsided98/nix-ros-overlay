...
buildRosPackage {
  pname = "ros-lyrical-autoware-utils-uuid";
  version = "1.4.2-r4";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/autoware_utils-release/archive/release/lyrical/autoware_utils_uuid/1.4.2-4.tar.gz";
    name = "1.4.2-4.tar.gz";
    sha256 = "066aa080b64ffdd5527f925a51801c734bcc44d477587b7abc40d90a9d4ee839";
  };
