...
buildRosPackage {
  pname = "ros-lyrical-human-description";
  version = "2.0.2-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/human_description-release/archive/release/lyrical/human_description/2.0.2-3.tar.gz";
    name = "2.0.2-3.tar.gz";
    sha256 = "3d2d662fa6167a8956c2ddaa405d5795bed95698b1223dd43d4124fd3e268b50";
  };
