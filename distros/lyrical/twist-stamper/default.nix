...
buildRosPackage {
  pname = "ros-lyrical-twist-stamper";
  version = "0.0.5-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/twist_stamper-release/archive/release/lyrical/twist_stamper/0.0.5-3.tar.gz";
    name = "0.0.5-3.tar.gz";
    sha256 = "7c5682f512b79e1548b1932e101fe7ff85b1d82bc7befa7c54bd85607ce88f44";
  };
