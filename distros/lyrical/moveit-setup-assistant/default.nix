...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/moveit_setup_assistant/2.14.1-3.tar.gz";
    name = "2.14.1-3.tar.gz";
    sha256 = "58b2bb639ccf7e9405bf3b8fbd32bf411833ad6fcfe0caf9defe37be560ca138";
  };
