...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rviz_2d_overlay_plugins-release/archive/release/lyrical/rviz_2d_overlay_plugins/1.4.2-1.tar.gz";
    name = "1.4.2-1.tar.gz";
    sha256 = "a3a44e59646e3d500c1330f665dd1c4058b03c6b6779da24fdaebaa4428b3996";
  };
