...
buildRosPackage {
  pname = "ros-lyrical-desktop";
  version = "0.13.0-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/variants-release/archive/release/lyrical/desktop/0.13.0-3.tar.gz";
    name = "0.13.0-3.tar.gz";
    sha256 = "db8b584438b7f3805e258aa51d901b531e2e5b2bea81a123028ffd9e0644f022";
  };
