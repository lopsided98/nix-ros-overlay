...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mujoco_ros2_control-release/archive/release/lyrical/mujoco_ros2_control_demos/0.1.1-1.tar.gz";
    name = "0.1.1-1.tar.gz";
    sha256 = "4f0360c19b12bc462e9e40315f648ead1572a66139023c0335600ba44128085a";
  };
