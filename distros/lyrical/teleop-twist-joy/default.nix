...
buildRosPackage {
  pname = "ros-lyrical-teleop-twist-joy";
  version = "2.6.5-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/teleop_twist_joy-release/archive/release/lyrical/teleop_twist_joy/2.6.5-3.tar.gz";
    name = "2.6.5-3.tar.gz";
    sha256 = "426e397fe88c2e5adefce0ed9cf3ad6a3efbc0d0d8caccac5f676ae83d145215";
  };
