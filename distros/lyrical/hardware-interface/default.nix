...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/lyrical/hardware_interface/6.10.1-1.tar.gz";
    name = "6.10.1-1.tar.gz";
    sha256 = "c50f3a65eb32705153ef8ff77e20f35ee46663087ac8ac5d9131a87c96616ad1";
  };
