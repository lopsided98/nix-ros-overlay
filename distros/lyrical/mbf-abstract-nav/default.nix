...
buildRosPackage {
  pname = "ros-lyrical-mbf-abstract-nav";
  version = "1.2.1-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/move_base_flex-release/archive/release/lyrical/mbf_abstract_nav/1.2.1-1.tar.gz";
    name = "1.2.1-1.tar.gz";
    sha256 = "dd8aa1357d8363be3e467c2cd3c290c4f84d2f1fc6239c8d332af0da44e3a0c6";
  };
