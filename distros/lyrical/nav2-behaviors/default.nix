...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/navigation2-release/archive/release/lyrical/nav2_behaviors/1.5.2-2.tar.gz";
    name = "1.5.2-2.tar.gz";
    sha256 = "4dd413e5d648e187409050739f3b74dc79873a0b2ec5522a91306ea4d221d164";
  };
