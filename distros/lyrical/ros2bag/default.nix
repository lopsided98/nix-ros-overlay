...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/lyrical/ros2bag/0.33.3-1.tar.gz";
    name = "0.33.3-1.tar.gz";
    sha256 = "f541603e33078e12a0bee2d20d4f3a78b1affee8340f9d1406f4fd650b44eb0c";
  };
