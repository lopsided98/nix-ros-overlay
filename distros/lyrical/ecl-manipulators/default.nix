...
buildRosPackage {
  pname = "ros-lyrical-ecl-manipulators";
  version = "1.2.1-r6";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/lyrical/ecl_manipulators/1.2.1-6.tar.gz";
    name = "1.2.1-6.tar.gz";
    sha256 = "8da5b5b97e58003e935bfa4f3f3b2ae1db8ae2d2f54b4a6a47d79a796045a9a7";
  };
