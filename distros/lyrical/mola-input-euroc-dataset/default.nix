...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/lyrical/mola_input_euroc_dataset/2.7.0-3.tar.gz";
    name = "2.7.0-3.tar.gz";
    sha256 = "273ea838f97055e9d928b673caef93d9ae2fc44efc0582b6d140cae847b2a222";
  };
