...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/navigation2-release/archive/release/lyrical/nav2_navfn_planner/1.5.2-2.tar.gz";
    name = "1.5.2-2.tar.gz";
    sha256 = "343827777ff2418e2c123dae9774aac157e148cb9b98e501ef563d09b13117d7";
  };
