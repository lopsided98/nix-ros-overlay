...
buildRosPackage {
  pname = "ros-lyrical-rosidl-core-generators";
  version = "0.4.3-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_core-release/archive/release/lyrical/rosidl_core_generators/0.4.3-3.tar.gz";
    name = "0.4.3-3.tar.gz";
    sha256 = "64e44132168781b95074e2e165ba3bae7ba9e85d19eb320a815488830b28971d";
  };
