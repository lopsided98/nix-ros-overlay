...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mavros-release/archive/release/lyrical/mavros/2.14.0-3.tar.gz";
    name = "2.14.0-3.tar.gz";
    sha256 = "bee7f03a6cd10ec6c743c4a4e31c4583a9a03cddd7713cbdb9f0a64182fa6cb0";
  };
