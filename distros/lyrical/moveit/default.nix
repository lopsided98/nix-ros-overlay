...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/moveit/2.14.1-3.tar.gz";
    name = "2.14.1-3.tar.gz";
    sha256 = "cb4cdd8119e77caaea6f1dc2af79413209347c8d9c79e3cfe70ef52de09470bb";
  };
