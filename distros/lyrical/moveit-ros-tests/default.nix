...
buildRosPackage {
  pname = "ros-lyrical-moveit-ros-tests";
  version = "2.14.1-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/moveit2-release/archive/release/lyrical/moveit_ros_tests/2.14.1-3.tar.gz";
    name = "2.14.1-3.tar.gz";
    sha256 = "2390a8b830f315f4e3854ddc3ffa9606231ddc9140b95db963d776c6893a2e9e";
  };
