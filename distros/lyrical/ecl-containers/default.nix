...
buildRosPackage {
  pname = "ros-lyrical-ecl-containers";
  version = "1.2.1-r6";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ecl_core-release/archive/release/lyrical/ecl_containers/1.2.1-6.tar.gz";
    name = "1.2.1-6.tar.gz";
    sha256 = "0b505eedce645b3d5dd0ff164c8e7d73657cb64457073eda6c351d45c23dd8d5";
  };
