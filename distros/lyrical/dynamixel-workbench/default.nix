...
buildRosPackage {
  pname = "ros-lyrical-dynamixel-workbench";
  version = "2.2.5-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/dynamixel_workbench-release/archive/release/lyrical/dynamixel_workbench/2.2.5-3.tar.gz";
    name = "2.2.5-3.tar.gz";
    sha256 = "b3fefad4f740eb7f621de043a5746821952e967ae7908eeac57a1e3b3275cfea";
  };
