...
buildRosPackage {
  pname = "ros-lyrical-plansys2-domain-expert";
  version = "3.1.0-r1";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_planning_system-release/archive/release/lyrical/plansys2_domain_expert/3.1.0-1.tar.gz";
    name = "3.1.0-1.tar.gz";
    sha256 = "80543f14105dc2fb313240506c61332b05747a2ceb7276513680e386484b0d2c";
  };
