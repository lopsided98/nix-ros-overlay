...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros_ign-release/archive/release/lyrical/ros_gz_sim/3.0.10-1.tar.gz";
    name = "3.0.10-1.tar.gz";
    sha256 = "761d06a103d0819718c3d6df1ca4e5fe04750eb214a91f2d9fc0a553e7ccef0c";
  };
