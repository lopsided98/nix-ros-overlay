...
buildRosPackage {
  pname = "ros-lyrical-lanelet2-validation";
  version = "1.2.1-r8";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/lanelet2-release/archive/release/lyrical/lanelet2_validation/1.2.1-8.tar.gz";
    name = "1.2.1-8.tar.gz";
    sha256 = "63bf48968a4f4b24f9d698b73d95421201d449cdbb2de5f7b232d7c63c947eed";
  };
