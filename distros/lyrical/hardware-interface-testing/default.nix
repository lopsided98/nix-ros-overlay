...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_control-release/archive/release/lyrical/hardware_interface_testing/6.7.0-3.tar.gz";
    name = "6.7.0-3.tar.gz";
    sha256 = "3467d989ed15eb078dd175cf66c6e1d08119dd83c04cadef13e749aa5b1b9515";
  };
