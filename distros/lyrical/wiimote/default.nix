...
buildRosPackage {
  pname = "ros-lyrical-wiimote";
  version = "3.3.0-r4";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/joystick_drivers-release/archive/release/lyrical/wiimote/3.3.0-4.tar.gz";
    name = "3.3.0-4.tar.gz";
    sha256 = "4ca07eebdc19bc33668d23810104f5d55ff4df648fea9d5dfa834462cd92b582";
  };
