...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/mola-release/archive/release/lyrical/mola_input_mulran_dataset/2.7.0-3.tar.gz";
    name = "2.7.0-3.tar.gz";
    sha256 = "57820726186fd2b2bcc12c3de50d9298e473729d63cd89812e1aa13ae27ddd81";
  };
