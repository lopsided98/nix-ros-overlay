...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/python_qt_binding-release/archive/release/lyrical/python_qt_binding/2.5.5-1.tar.gz";
    name = "2.5.5-1.tar.gz";
    sha256 = "cc93f3114228be8cf8ccb66f2c859388e383cd2933de841fd09d5b7d1d9a2746";
  };
