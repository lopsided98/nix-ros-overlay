...
buildRosPackage {
  pname = "ros-lyrical-cartographer-ros";
  version = "2.0.9003-r3";

  src = fetchurl {
    url = "https://github.com/ros2-gbp/cartographer_ros-release/archive/release/lyrical/cartographer_ros/2.0.9003-3.tar.gz";
    name = "2.0.9003-3.tar.gz";
    sha256 = "191e5283d457406a0e78f426e6faefb4b3aaf74515dd5c889f6ca40ce6ae367c";
  };
