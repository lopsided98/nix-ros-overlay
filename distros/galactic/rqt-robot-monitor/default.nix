...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_robot_monitor-release/archive/release/galactic/rqt_robot_monitor/1.0.4-2.tar.gz";
    name = "1.0.4-2.tar.gz";
    sha256 = "81161e8aeb5313bcc6197f3733d1943e4eff27fd5cfcd809819938b83178b38c";
  };
