...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/galactic/rosbag2_performance_benchmarking/0.9.2-1.tar.gz";
    name = "0.9.2-1.tar.gz";
    sha256 = "6074458e80fa282dd28914c94dcffce5c6f4c9aab3592d460a3e5ab13d3536c4";
  };
