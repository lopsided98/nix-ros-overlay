...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/galactic/ros2pkg/0.13.4-1.tar.gz";
    name = "0.13.4-1.tar.gz";
    sha256 = "6bdb6cc2a6691b0174067237ad6bb8b7c3aa7f8991e0775c012ae29eae33cd91";
  };
