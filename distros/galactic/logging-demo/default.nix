...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/demos-release/archive/release/galactic/logging_demo/0.14.3-1.tar.gz";
    name = "0.14.3-1.tar.gz";
    sha256 = "f706366ff87f8091d33e6c92c61fdcc4e0ffc6939cdee3c0852fd05c3fadaf10";
  };
