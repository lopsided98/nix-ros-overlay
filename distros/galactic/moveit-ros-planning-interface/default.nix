...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/moveit/moveit2-release/archive/release/galactic/moveit_ros_planning_interface/2.3.2-2.tar.gz";
    name = "2.3.2-2.tar.gz";
    sha256 = "8c8374623198e98dc3918ac9ddf8616dd08a56245b680b43c93ae569c109dcb8";
  };
