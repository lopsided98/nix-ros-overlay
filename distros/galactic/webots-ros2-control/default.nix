...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/galactic/webots_ros2_control/2022.1.0-2.tar.gz";
    name = "2022.1.0-2.tar.gz";
    sha256 = "6166c21e515ce35a696fbc05526e32373a218028fc77e7868da98e1c10b5dadf";
  };
