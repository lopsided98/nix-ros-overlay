...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/galactic/webots_ros2_mavic/2022.1.0-2.tar.gz";
    name = "2022.1.0-2.tar.gz";
    sha256 = "c1755a76721c81bba652b9b667cced330664e1d8cbbfe376954ada82ae93802a";
  };
