...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/galactic/webots_ros2_driver/2022.1.0-2.tar.gz";
    name = "2022.1.0-2.tar.gz";
    sha256 = "40fdae6a6f580c4b8f0151a78a5c06458079fa118b7af991ea341959820c649c";
  };
