...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/galactic/webots_ros2_tiago/2022.1.0-1.tar.gz";
    name = "2022.1.0-1.tar.gz";
    sha256 = "a6189544931f041ee3a0c2521478d2a88c45c36c6f761e03febe5707027d642e";
  };
