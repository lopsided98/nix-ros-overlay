...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/yujinrobot-release/ecl_core-release/archive/release/galactic/ecl_time/1.2.0-1.tar.gz";
    name = "1.2.0-1.tar.gz";
    sha256 = "4b17df096ce131b5075032b2c4c8d4878b584e701777d4b306cdf864f855df8d";
  };
