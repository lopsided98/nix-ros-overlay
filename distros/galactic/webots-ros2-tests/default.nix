...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/galactic/webots_ros2_tests/2022.1.0-2.tar.gz";
    name = "2022.1.0-2.tar.gz";
    sha256 = "ca27cff7fa507a0b966b466695deeb68d6c661c45764592a8c827c36fb258ca5";
  };
