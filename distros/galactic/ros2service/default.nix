...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/galactic/ros2service/0.13.5-1.tar.gz";
    name = "0.13.5-1.tar.gz";
    sha256 = "bd6715ef7a7b317997d09f16e568961cd3a5577875399155edcdf1c9d48c4801";
  };
