...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/moveit/moveit2-release/archive/release/galactic/moveit_ros_visualization/2.3.2-2.tar.gz";
    name = "2.3.2-2.tar.gz";
    sha256 = "6dd1e48f6f050309d855a6ba7ba2ea8cd24682db407df5c7f8802c6bd1b48ee8";
  };
