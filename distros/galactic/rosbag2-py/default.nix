...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/galactic/rosbag2_py/0.9.2-1.tar.gz";
    name = "0.9.2-1.tar.gz";
    sha256 = "c659395d8f747796cfb4563abeadac956f3d3f13a905fcee91d610fb217f652f";
  };
