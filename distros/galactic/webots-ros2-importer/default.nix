...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/galactic/webots_ros2_importer/1.2.3-1.tar.gz";
    name = "1.2.3-1.tar.gz";
    sha256 = "6ace23620ea34980301f0aa6d5f00b8b999c5701a56b260dbab806eb3a5a7142";
  };
