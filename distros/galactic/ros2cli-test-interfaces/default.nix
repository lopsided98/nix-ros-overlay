...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/galactic/ros2cli_test_interfaces/0.13.4-1.tar.gz";
    name = "0.13.4-1.tar.gz";
    sha256 = "3c690fa7412b317311a57abe257fb76607ad7b1d9b957abde77498e7336d501b";
  };
