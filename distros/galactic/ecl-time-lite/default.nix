...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/yujinrobot-release/ecl_lite-release/archive/release/galactic/ecl_time_lite/1.1.0-1.tar.gz";
    name = "1.1.0-1.tar.gz";
    sha256 = "b9cbf4ace0c67ee072f37ae16e1d51d154d55552e2d651cfe15a685e343f3834";
  };
