...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/galactic/webots_ros2_universal_robot/2022.1.0-2.tar.gz";
    name = "2022.1.0-2.tar.gz";
    sha256 = "cfe94467ede3269d46a415df9c2add0de3dcc495233927bb196305d06835db71";
  };
