...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2_controllers-release/archive/release/galactic/velocity_controllers/1.5.0-1.tar.gz";
    name = "1.5.0-1.tar.gz";
    sha256 = "1dc04877e01f742c7aca5c01b0debe1ea5417b471a4c27c908081db32fab24b0";
  };
