...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/joystick_drivers-release/archive/release/galactic/joy/3.0.0-5.tar.gz";
    name = "3.0.0-5.tar.gz";
    sha256 = "13d8538dba3dabeefd35552b6ae02fa9e60b1f4ec2cfed070d4b3860ef478c97";
  };
