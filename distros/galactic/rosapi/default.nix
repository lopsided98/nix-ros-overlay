...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/galactic/rosapi/1.0.5-1.tar.gz";
    name = "1.0.5-1.tar.gz";
    sha256 = "b11eda59783ea384737d2baf84d1936886cdab4e0fb4b5807d88c06e4e48c021";
  };
