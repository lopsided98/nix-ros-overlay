...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/oKermorgant/slider_publisher-release/archive/release/galactic/slider_publisher/2.2.0-1.tar.gz";
    name = "2.2.0-1.tar.gz";
    sha256 = "b1498ea49232c8b63256dadfbf1ea62eec6727e9507e83d8bb0938e6303febc6";
  };
