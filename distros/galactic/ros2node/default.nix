...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/galactic/ros2node/0.13.4-1.tar.gz";
    name = "0.13.4-1.tar.gz";
    sha256 = "4fc3f5ad85b60cad7c4df02b42a4f7822a0de4ca54efdc9ef8d802933598236e";
  };
