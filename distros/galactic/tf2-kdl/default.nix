...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/galactic/tf2_kdl/0.17.5-1.tar.gz";
    name = "0.17.5-1.tar.gz";
    sha256 = "dd07770075499e7317cd3ceb01e0636f6e5bfd0b6aeea6e2aa6e643fbc4aeb40";
  };
