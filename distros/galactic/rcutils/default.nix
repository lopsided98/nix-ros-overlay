...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcutils-release/archive/release/galactic/rcutils/4.0.4-1.tar.gz";
    name = "4.0.4-1.tar.gz";
    sha256 = "a0f0894ebd4f47b3906583ab4e3a9b9575e792a513b74d138486ad791184905c";
  };
