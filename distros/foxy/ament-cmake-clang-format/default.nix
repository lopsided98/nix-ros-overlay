...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/foxy/ament_cmake_clang_format/0.9.5-1.tar.gz";
    name = "0.9.5-1.tar.gz";
    sha256 = "2053c5a07609451e0cd5d687d51e33e349f2875c748b5d5af7a4a486e515a288";
  };
