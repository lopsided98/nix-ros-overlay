...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/foxy/webots_ros2_universal_robot/2022.1.0-2.tar.gz";
    name = "2022.1.0-2.tar.gz";
    sha256 = "a67bc2dd34a265c44da994bb8bb26e28e6aba33195b70c615bc0c8f5074e282e";
  };
