...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/foxy/ament_cmake_cppcheck/0.9.5-1.tar.gz";
    name = "0.9.5-1.tar.gz";
    sha256 = "011ad1e74771359197ac56a32b179f16ea297398002185f34c658b32a90e08c8";
  };
