...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/swri-robotics-gbp/novatel_gps_driver-release/archive/release/foxy/novatel_gps_driver/4.1.0-1.tar.gz";
    name = "4.1.0-1.tar.gz";
    sha256 = "cd9171fc6729a842caed9d6b12293be2a892f172e9dcf5a34861657d2a935fe3";
  };
