...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/IntelligentRoboticsLabs/ros2_planning_system-release/archive/release/foxy/plansys2_lifecycle_manager/1.0.5-1.tar.gz";
    name = "1.0.5-1.tar.gz";
    sha256 = "ed8c895a1d7dee913ad5ecccee3bbac6e75734f092dd5ca6b8190b88931a38b2";
  };
