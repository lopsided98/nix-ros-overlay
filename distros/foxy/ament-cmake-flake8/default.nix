...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/foxy/ament_cmake_flake8/0.9.5-1.tar.gz";
    name = "0.9.5-1.tar.gz";
    sha256 = "9475e32f531ab297a9b8906cbd6efc3580ac24e220b208b95607ef8082f67a46";
  };
