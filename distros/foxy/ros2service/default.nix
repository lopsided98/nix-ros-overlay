...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/foxy/ros2service/0.9.11-1.tar.gz";
    name = "0.9.11-1.tar.gz";
    sha256 = "9025ead908d73a6122de2995d6ac469e14b1569e09299274a7f68ca4eacf603e";
  };
