...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/foxy/ros2interface/0.9.8-1.tar.gz";
    name = "0.9.8-1.tar.gz";
    sha256 = "cdff7fab0f4f65015d8bb0ea6b465b04105f9aa8b7c141d50c5cb008f7de89b1";
  };
