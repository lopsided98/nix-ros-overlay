...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/foxy/rosbag2_transport/0.3.4-1.tar.gz";
    name = "0.3.4-1.tar.gz";
    sha256 = "25e351efa9e57d0814985db0c60113bcd0f8cfa3b3c58a035708319bb6d90284";
  };
