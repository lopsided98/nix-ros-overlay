...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/foxy/ament_cmake_pep257/0.9.5-1.tar.gz";
    name = "0.9.5-1.tar.gz";
    sha256 = "5e39b3a5f96e2508ced01b05523bd6d5ddf12695d17799f1318ad33619a4bd9f";
  };
