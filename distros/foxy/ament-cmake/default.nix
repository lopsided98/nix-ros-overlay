...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/foxy/ament_cmake/0.9.6-1.tar.gz";
    name = "0.9.6-1.tar.gz";
    sha256 = "7123c1c315755f57c939634b75e32f0b301d3a2c425952477eea5ecfa0f9b801";
  };
