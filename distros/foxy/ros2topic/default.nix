...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros2cli-release/archive/release/foxy/ros2topic/0.9.5-1.tar.gz";
    name = "0.9.5-1.tar.gz";
    sha256 = "f85e80749e188a2377c5d842394bccd3381b10f69282217d4378e44027b803b5";
  };
