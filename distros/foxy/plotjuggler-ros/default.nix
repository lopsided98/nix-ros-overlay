...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/PlotJuggler/plotjuggler-ros-plugins-release/archive/release/foxy/plotjuggler_ros/1.0.3-8.tar.gz";
    name = "1.0.3-8.tar.gz";
    sha256 = "bf860ca65e4ce4cb97bbdca03555d075c480f857554e9204195c7ad29a364a7e";
  };
