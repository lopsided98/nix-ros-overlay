...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/mavlink/mavlink-gbp-release/archive/release/foxy/mavlink/2020.9.10-1.tar.gz";
    name = "2020.9.10-1.tar.gz";
    sha256 = "57ae1ac1a18c5ee0bbf03cb3a66a6445d48d06bdb8bdfe9232edc2990bf15af2";
  };
