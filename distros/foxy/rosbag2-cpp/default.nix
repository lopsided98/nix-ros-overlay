...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/foxy/rosbag2_cpp/0.3.2-1.tar.gz";
    name = "0.3.2-1.tar.gz";
    sha256 = "95a5b8baef88e2c6df534457cac1157722fc08f1366af0c02becd7bc3fb00471";
  };
