...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/webots_ros2-release/archive/release/foxy/webots_ros2_msgs/2022.1.0-2.tar.gz";
    name = "2022.1.0-2.tar.gz";
    sha256 = "a16c3979ac89643573abc4e840850ae71f1544e7ce0d5467f4579535ddb56bbc";
  };
