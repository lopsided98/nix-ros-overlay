...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/pinocchio-release/archive/release/foxy/pinocchio/2.6.11-1.tar.gz";
    name = "2.6.11-1.tar.gz";
    sha256 = "4eb134f21b28eeeaab9478b8c0b82ab7267d408edfcb1d746a5e152573babca6";
  };
