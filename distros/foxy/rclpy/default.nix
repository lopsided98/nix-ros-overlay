...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rclpy-release/archive/release/foxy/rclpy/1.0.2-1.tar.gz";
    name = "1.0.2-1.tar.gz";
    sha256 = "51be8e963ac350a3ebb90808a5640b1dc3f6378bf26ab79fd290a845565e8d27";
  };
