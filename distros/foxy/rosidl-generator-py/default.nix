...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl_python-release/archive/release/foxy/rosidl_generator_py/0.9.4-1.tar.gz";
    name = "0.9.4-1.tar.gz";
    sha256 = "7b2ce2fbe7bb6db49eb79fd76ce9fbd5b80fcfdc10740ed2972b42170e0ce554";
  };
