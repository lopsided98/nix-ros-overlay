...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_robot_monitor-release/archive/release/foxy/rqt_robot_monitor/1.0.2-1.tar.gz";
    name = "1.0.2-1.tar.gz";
    sha256 = "db9dc5efd47c039902ee124deb1b720e66c7f6bbf493ad877e8141ee5e34c109";
  };
