...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rqt_robot_monitor-release/archive/release/foxy/rqt_robot_monitor/1.0.3-1.tar.gz";
    name = "1.0.3-1.tar.gz";
    sha256 = "969834f73c55ea9897cb70dfe3d06276137e65a54acc7973e3dc24edeab4e5be";
  };
