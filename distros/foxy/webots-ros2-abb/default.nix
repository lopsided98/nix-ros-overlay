...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/cyberbotics/webots_ros2-release/archive/release/foxy/webots_ros2_abb/1.0.3-1.tar.gz";
    name = "1.0.3-1.tar.gz";
    sha256 = "7949bf3392a6c2b29127e0144f99788e7649709439b7dd6305a878f5a3f79cea";
  };
