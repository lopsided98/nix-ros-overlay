...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/cyberbotics/webots_ros2-release/archive/release/foxy/webots_ros2_abb/1.0.0-1.tar.gz";
    name = "1.0.0-1.tar.gz";
    sha256 = "81b711d5a37f1611a92f0139958d412098dad682292394bc682a44dae2c28fd0";
  };
