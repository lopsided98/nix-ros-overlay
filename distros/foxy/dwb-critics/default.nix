...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/foxy/dwb_critics/0.4.7-1.tar.gz";
    name = "0.4.7-1.tar.gz";
    sha256 = "d72f0a735b80663b18fcf0b56d9e7177aca18b61756e814a42fae454010eca30";
  };
