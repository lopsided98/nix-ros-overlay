...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/SteveMacenski/navigation2-release/archive/release/foxy/nav2_bringup/0.4.7-1.tar.gz";
    name = "0.4.7-1.tar.gz";
    sha256 = "f595d765dbe02de952ade8ec2c222283f5927ca0ba11b6c635944bd55a8eb600";
  };
