...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rcl-release/archive/release/foxy/rcl/1.1.7-1.tar.gz";
    name = "1.1.7-1.tar.gz";
    sha256 = "77913879f86721446a55ed96289bebb95614f967a389e3188cf2e83ce34d9133";
  };
