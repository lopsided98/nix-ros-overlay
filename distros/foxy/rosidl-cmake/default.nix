...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosidl-release/archive/release/foxy/rosidl_cmake/1.0.1-1.tar.gz";
    name = "1.0.1-1.tar.gz";
    sha256 = "d3432d23ac821e7448e228b2c543ed5bf8cefb0cdbcbf86b71ef5da4ef5aa64b";
  };
