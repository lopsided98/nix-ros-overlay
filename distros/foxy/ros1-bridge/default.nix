...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros1_bridge-release/archive/release/foxy/ros1_bridge/0.9.7-1.tar.gz";
    name = "0.9.7-1.tar.gz";
    sha256 = "411dea07770d9ed868e2c7411d8241f861c35f1bdbdd893627b73e3dad8e18d4";
  };
