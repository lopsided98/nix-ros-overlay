...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ros1_bridge-release/archive/release/foxy/ros1_bridge/0.9.4-1.tar.gz";
    name = "0.9.4-1.tar.gz";
    sha256 = "b7e5c0bbc023fb48802465ee62ad208e60f9e76d79d9cab474a119cde26c6bea";
  };
