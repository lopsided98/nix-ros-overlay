...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/foxy/rosbag2_converter_default_plugins/0.3.4-1.tar.gz";
    name = "0.3.4-1.tar.gz";
    sha256 = "c135b86dc07354083ae02f9ef5c32e111f4288061b5f2456738c4ecf66a8f0a8";
  };
