...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/rosbag2-release/archive/release/foxy/rosbag2_converter_default_plugins/0.3.5-1.tar.gz";
    name = "0.3.5-1.tar.gz";
    sha256 = "d6d421d0af87d2d9a8331bff5c8181f91cedf8f222e2e6f5b3d6151d3b5a050e";
  };
