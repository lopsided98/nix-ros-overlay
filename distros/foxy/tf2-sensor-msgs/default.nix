...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/foxy/tf2_sensor_msgs/0.13.4-1.tar.gz";
    name = "0.13.4-1.tar.gz";
    sha256 = "9a73bdf621df92cbfc26eaddb0800a46fa26d597fb89261660927d69341141ba";
  };
