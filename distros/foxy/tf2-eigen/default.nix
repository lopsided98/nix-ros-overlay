...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/geometry2-release/archive/release/foxy/tf2_eigen/0.13.4-1.tar.gz";
    name = "0.13.4-1.tar.gz";
    sha256 = "a7f493e9cca81dcc310a9d0cd9328b72bbf6d0ffbd106269ab17ce97ea16edeb";
  };
