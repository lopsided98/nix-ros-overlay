...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/foxy/ament_cmake_clang_tidy/0.9.5-1.tar.gz";
    name = "0.9.5-1.tar.gz";
    sha256 = "b7a9c094aa14f608f574cfcfdebf11a0ddff6cce33f08c0a6cab08faf8d0f918";
  };
