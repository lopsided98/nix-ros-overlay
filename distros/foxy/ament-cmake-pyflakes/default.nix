...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/ros2-gbp/ament_lint-release/archive/release/foxy/ament_cmake_pyflakes/0.9.5-1.tar.gz";
    name = "0.9.5-1.tar.gz";
    sha256 = "b2af6810ee2cd8ae078aad27933c00ad0de1ea403a2d5c0fb82ebaeb2dab47c8";
  };
