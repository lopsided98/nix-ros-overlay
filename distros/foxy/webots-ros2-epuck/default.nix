...
buildRosPackage {
  ...
  src = fetchurl {
    url = "https://github.com/cyberbotics/webots_ros2-release/archive/release/foxy/webots_ros2_epuck/1.0.0-1.tar.gz";
    name = "1.0.0-1.tar.gz";
    sha256 = "8cb43eea28ae83b58f4c1209a5da4ae1a26360104e88f65fa33e8f0a68711c4d";
  };
